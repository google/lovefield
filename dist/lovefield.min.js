...
function t(a,b){function c(){}c.prototype=b.prototype;a.Ib=b.prototype;a.prototype=new c;a.prototype.constructor=a;a.Kg=function(a,c,f){for(var h=Array(arguments.length-2),k=2;k<arguments.length;k++)h[k-2]=arguments[k];return b.prototype[c].apply(a,h)}};function ra(a){if(Error.captureStackTrace)Error.captureStackTrace(this,ra);else{var b=Error().stack;b&&(this.stack=b)}a&&(this.message=String(a))}t(ra,Error);ra.prototype.name="CustomError";var sa=String.prototype.trim?function(a){return a.trim()}:function(a){return a.replace(/^[\s\xa0]+|[\s\xa0]+$/g,"")};
function ta(a){var b=0,c=sa(String(ua)).split(".");a=sa(String(a)).split(".");for(var d=Math.max(c.length,a.length),e=0;0==b&&e<d;e++){var f=c[e]||"",h=a[e]||"",k=/(\d*)(\D*)/g,n=/(\d*)(\D*)/g;do{var A=k.exec(f)||["","",""],O=n.exec(h)||["","",""];if(0==A[0].length&&0==O[0].length)break;b=va(0==A[1].length?0:parseInt(A[1],10),0==O[1].length?0:parseInt(O[1],10))||va(0==A[2].length,0==O[2].length)||va(A[2],O[2])}while(0==b)}return b}function va(a,b){return a<b?-1:a>b?1:0};function wa(a,b,c){this.gg=c;this.Lf=a;this.Ag=b;this.pd=0;this.kd=null}wa.prototype.get=function(){var a;0<this.pd?(this.pd--,a=this.kd,this.kd=a.next,a.next=null):a=this.Lf();return a};wa.prototype.put=function(a){this.Ag(a);this.pd<this.gg&&(this.pd++,a.next=this.kd,this.kd=a)};var xa=Array.prototype,ya=xa.indexOf?function(a,b,c){return xa.indexOf.call(a,b,c)}:function(a,b,c){c=null==c?0:0>c?Math.max(0,a.length+c):c;if(ia(a))return ia(b)&&1==b.length?a.indexOf(b,c):-1;for(;c<a.length;c++)if(c in a&&a[c]===b)return c;return-1},za=xa.forEach?function(a,b,c){xa.forEach.call(a,b,c)}:function(a,b,c){for(var d=a.length,e=ia(a)?a.split(""):a,f=0;f<d;f++)f in e&&b.call(c,e[f],f,a)},Aa=xa.map?function(a,b,c){return xa.map.call(a,b,c)}:function(a,b,c){for(var d=a.length,e=Array(d),
...
b.onreadystatechange=function(){b.onreadystatechange=null;b.parentNode.removeChild(b);b=null;a();a=null};document.documentElement.appendChild(b)}:function(a){p.setTimeout(a,0)}};function Pa(){this.yd=this.mc=null}var Ra=new wa(function(){return new Qa},function(a){a.reset()},100);Pa.prototype.add=function(a,b){var c=Ra.get();c.set(a,b);this.yd?this.yd.next=c:this.mc=c;this.yd=c};Pa.prototype.remove=function(){var a=null;this.mc&&(a=this.mc,this.mc=this.mc.next,this.mc||(this.yd=null),a.next=null);return a};function Qa(){this.next=this.scope=this.Pd=null}Qa.prototype.set=function(a,b){this.Pd=a;this.scope=b;this.next=null};
Qa.prototype.reset=function(){this.next=this.scope=this.Pd=null};function Sa(a,b){Ta||Ua();Va||(Ta(),Va=!0);Wa.add(a,b)}var Ta;function Ua(){if(p.Promise&&p.Promise.resolve){var a=p.Promise.resolve(void 0);Ta=function(){a.then(Xa)}}else Ta=function(){var a=Xa;!ja(p.setImmediate)||p.Window&&p.Window.prototype&&p.Window.prototype.setImmediate==p.setImmediate?(Na||(Na=Oa()),Na(a)):p.setImmediate(a)}}var Va=!1,Wa=new Pa;function Xa(){for(var a=null;a=Wa.remove();){try{a.Pd.call(a.scope)}catch(b){Ma(b)}Ra.put(a)}Va=!1};function v(a,b){this.Ua=0;this.lf=void 0;this.$c=this.cc=this.C=null;this.jd=this.Nd=!1;if(a!=ca)try{var c=this;a.call(b,function(a){Ya(c,2,a)},function(a){Ya(c,3,a)})}catch(d){Ya(this,3,d)}}function Za(){this.next=this.context=this.hc=this.Mc=this.child=null;this.Bd=!1}Za.prototype.reset=function(){this.context=this.hc=this.Mc=this.child=null;this.Bd=!1};var $a=new wa(function(){return new Za},function(a){a.reset()},100);function ab(a,b,c){var d=$a.get();d.Mc=a;d.hc=b;d.context=c;return d}
...
v.prototype.then=function(a,b,c){return gb(this,ja(a)?a:null,ja(b)?b:null,c)};v.prototype.then=v.prototype.then;v.prototype.$goog_Thenable=!0;v.prototype.te=function(a,b){return gb(this,null,a,b)};function hb(a,b){a.cc||2!=a.Ua&&3!=a.Ua||ib(a);a.$c?a.$c.next=b:a.cc=b;a.$c=b}
function gb(a,b,c,d){var e=ab(null,null,null);e.child=new v(function(a,h){e.Mc=b?function(c){try{var e=b.call(d,c);a(e)}catch(A){h(A)}}:a;e.hc=c?function(b){try{var e=c.call(d,b);!q(e)&&b instanceof jb?h(b):a(e)}catch(A){h(A)}}:h});e.child.C=a;hb(a,e);return e.child}v.prototype.Fg=function(a){this.Ua=0;Ya(this,2,a)};v.prototype.Gg=function(a){this.Ua=0;Ya(this,3,a)};
function Ya(a,b,c){0==a.Ua&&(a==c&&(b=3,c=new TypeError("Promise cannot resolve to itself")),a.Ua=1,db(c,a.Fg,a.Gg,a)||(a.lf=c,a.Ua=b,a.C=null,ib(a),3!=b||c instanceof jb||kb(a,c)))}function db(a,b,c,d){if(a instanceof v)return hb(a,ab(b||ca,c||null,d)),!0;var e;if(a)try{e=!!a.$goog_Thenable}catch(h){e=!1}else e=!1;if(e)return a.then(b,c,d),!0;e=typeof a;if("object"==e&&null!=a||"function"==e)try{var f=a.then;if(ja(f))return lb(a,f,b,c,d),!0}catch(h){return c.call(d,h),!0}return!1}
function lb(a,b,c,d,e){function f(a){k||(k=!0,d.call(e,a))}function h(a){k||(k=!0,c.call(e,a))}var k=!1;try{b.call(a,h,f)}catch(n){f(n)}}function ib(a){a.Nd||(a.Nd=!0,Sa(a.Qf,a))}function mb(a){var b=null;a.cc&&(b=a.cc,a.cc=b.next,b.next=null);a.cc||(a.$c=null);return b}
v.prototype.Qf=function(){for(var a=null;a=mb(this);){var b=this.Ua,c=this.lf;if(3==b&&a.hc&&!a.Bd)for(var d=void 0,d=this;d&&d.jd;d=d.C)d.jd=!1;if(a.child)a.child.C=null,nb(a,b,c);else try{a.Bd?a.Mc.call(a.context):nb(a,b,c)}catch(e){ob.call(null,e)}$a.put(a)}this.Nd=!1};function nb(a,b,c){2==b?a.Mc.call(a.context,c):a.hc&&a.hc.call(a.context,c)}function kb(a,b){a.jd=!0;Sa(function(){a.jd&&ob.call(null,b)})}var ob=Ma;function jb(a){ra.call(this,a)}t(jb,ra);jb.prototype.name="cancel";
...
var ua=function(){if(Mb&&p.opera){var a;var b=p.opera.version;try{a=b()}catch(c){a=b}return a}a="";(b=Rb())&&(a=b?b[1]:"");return Nb&&(b=(b=p.document)?b.documentMode:void 0,b>parseFloat(a))?String(b):a}(),Sb={};var Tb=Lb()||u("iPod"),Ub=u("iPad");!u("Android")||La()||u("Firefox")||Ka();var Vb=La(),Wb=u("Safari")&&!(La()||u("Coast")||Ka()||u("Edge")||u("Silk")||u("Android"))&&!(Lb()||u("iPad")||u("iPod"));/*
 ...
 limitations under the License.
*/
function Xb(){this.ne=Wb||Ub||Tb;this.Zf=!(this.ne||Nb&&!Sb[10]&&!(Sb[10]=0<=ta(10)));!Nb||Sb[11]||(Sb[11]=0<=ta(11));this.Ig=Vb||Wb;this.kg=q(window.Map)&&q(window.Map.prototype.values)&&q(window.Map.prototype.forEach)&&!this.ne;this.lg=q(window.Set)&&q(window.Set.prototype.values)&&q(window.Set.prototype.forEach)&&!this.ne}var Yb;function Zb(){q(Yb)||(Yb=new Xb);return Yb};function z(){this.o=new Hb;Object.defineProperty(this,"size",{get:function(){return this.o.Ac()}})}z.prototype.clear=function(){this.o.clear()};z.prototype.clear=z.prototype.clear;z.prototype.delete=function(a){return this.o.remove(a)};z.prototype["delete"]=z.prototype.delete;z.prototype.forEach=function(a,b){return this.o.forEach(a,b)};z.prototype.forEach=z.prototype.forEach;z.prototype.get=function(a){return this.o.get(a)};z.prototype.get=z.prototype.get;z.prototype.has=function(a){return this.o.Ma(a)};
z.prototype.has=z.prototype.has;z.prototype.set=function(a,b){return this.o.set(a,b)};z.prototype.set=z.prototype.set;var $b=Zb().kg;function B(){return $b?new window.Map:new z}function ac(a){if(a instanceof z)return Jb(a.o);var b=0,c=Array(a.size);a.forEach(function(a,e){c[b++]=e});return c}function C(a){if(a instanceof z)return a.o.za();var b=0,c=Array(a.size);a.forEach(function(a){c[b++]=a});return c};var bc={};r("lf.TransactionType",bc);bc.READ_ONLY=0;bc.READ_WRITE=1;function cc(a,b){this.vf=a;this.Ra=b||null;this.Y=x()}cc.prototype.ia=function(){return 0==this.vf?this.qc():dc(this)};function dc(a){try{ec(a.Ra)}catch(b){return bb(b)}return fc(a).then(function(a){this.Ra.ia();return a}.bind(a))}function fc(a){gc(a);hc(a);return a.qc()}
function gc(a){a.Ra.rb.forEach(function(a,c){var d=this.Ra.ba().get(c),d=this.H(d.getName(),d.Db.bind(d)),e=C(a.wa).map(function(a){return a.id()});0<e.length&&d.remove(e).te(this.Rd,this);e=C(a.na).map(function(a){return a[1]}).concat(C(a.ta));d.put(e).te(this.Rd,this)},a)}function hc(a){ic(a.Ra).forEach(function(a){var c=this.H(a.getName(),rb),d;c.get([-1]).then(function(a){d=a;return c.remove([])}).then(function(){c.put(d);c.put(a.Fa())},this.Rd.bind(this))},a)}cc.prototype.Rd=function(a){this.Y.reject(a)};function jc(a){this.Bg=a}jc.prototype.toString=g("Bg");var kc=new jc("backstore"),lc=new jc("cache"),mc=new jc("indexstore"),nc=new jc("engine"),oc=new jc("runner"),pc=new jc("observerregistry"),qc=new jc("schema");function rc(a){if("function"==typeof a.za)return a.za();if(ia(a))return a.split("");if(ha(a)){for(var b=[],c=a.length,d=0;d<c;d++)b.push(a[d]);return b}return Ga(a)};function sc(a){this.o=new Hb;a&&this.addAll(a)}function tc(a){var b=typeof a;return"object"==b&&a||"function"==b?"o"+ka(a):b.substr(0,1)+a}m=sc.prototype;m.Ac=function(){return this.o.Ac()};m.add=function(a){this.o.set(tc(a),a)};m.addAll=function(a){a=rc(a);for(var b=a.length,c=0;c<b;c++)this.add(a[c])};m.remove=function(a){return this.o.remove(tc(a))};m.clear=function(){this.o.clear()};m.md=function(){return this.o.md()};m.contains=function(a){return this.o.Ma(tc(a))};m.za=function(){return this.o.za()};
...
m.put=function(a){if(0==a.length)return w();var b=B();a.forEach(function(a){var d;d=a.id()>>9;var e=b.get(d)||null;null===e&&(e=this.mf(this.aa.name,d));zc(e,[a]);b.set(d,e)},this);a=C(b).map(function(a){return this.Sb(function(){return this.aa.put(a.Fa())}.bind(this))},this);return eb(a)};
m.remove=function(a){if(0==a.length)return this.Sb(function(){return this.aa.clear()}.bind(this));var b=B();a.forEach(function(a){var d=a>>9,e=b.get(d)||null;null===e&&(e=this.mf(this.aa.name,d));Ac(e,[a]);b.set(d,e)},this);a=C(b).map(function(a){return this.Sb(function(){return 0==Object.keys(a.s).length?this.aa.delete(a.W()):this.aa.put(a.Fa())}.bind(this))},this);return eb(a)};function Ec(a,b,c){a=a.j(lc);var d=[c<<9,(c+1<<9)-1];b=a.$a(b,d[0],d[1]);c=new xc(c);zc(c,b);return c}
...
m.delete=function(a,b){var c=this.o.get(a,null);if(null===c)return!1;var d=c.delete(b);d&&(--this.size,0==c.size&&this.o.delete(a));return d};m.get=function(a){a=this.o.get(a)||null;return null===a?null:E(a)};m.clear=function(){this.o.clear();this.size=0};m.keys=function(){return ac(this.o)};m.values=function(){var a=[];this.o.forEach(function(b){a.push.apply(a,E(b))});return a};function Uc(a){this.D=a.j(mc);this.i=a.j(qc);this.U=a.j(lc);this.cd=null}function Vc(a,b,c){var d=b.Eb().ng;c.forEach(function(a){d.forEach(function(b){if(null==a.s[b.getName()])throw new F(202,b.m());},this)},a)}function Wc(a,b,c,d){b.Eb().Qd().forEach(function(a){a.timing==d&&Xc(this,a,c)},a)}function Xc(a,b,c){var d=Yc(a,b);c.forEach(function(a){if(Zc(a[0],a[1],b.name)&&(a=a[1].s[b.gb],null!==a&&!d.Ma(a)))throw new F(203,b.name);},a)}
...
function cd(a,b,c){b=ad(a.i.info(),b.getName(),1);if(null===b)return null;var d=new Tc;bd(a,b,c,function(a,b,c){b=b.get(c);0<b.length&&d.Vb(a.Fe,b)});return d}function dd(a,b,c){var d=new Tc;bd(a,c,b,function(a,b,c,k){b.get(c).forEach(function(b){d.set(b,{Od:a,sg:k[1]})})});return d}function bd(a,b,c,d){b.forEach(function(a){var b=this.D.get(a.name),h=Yc(this,a);c.forEach(function(c){Zc(c[0],c[1],h.getName())&&d(a,b,c[0].s[a.ic],c)},this)},a)}
...
function hd(a,b,c){var d={se:[],of:new Tc},e=new Tc;e.Vb(b.getName(),c.map(function(a){return a.id()}));do{var f=new Tc;e.keys().forEach(function(a){var b=this.i.table(a);a=e.get(a).map(function(a){return[this.U.get(a),null]},this);b=cd(this,b,a);null!==b&&(d.se.unshift.apply(d.se,b.keys()),f.$d(b))},a);e=f;d.of.$d(e)}while(0<e.size);return d};function id(a){this.ta=B();this.na=B();this.wa=B();this.w=a}m=id.prototype;m.getName=g("w");m.add=function(a){if(this.wa.has(a.id())){var b=[this.wa.get(a.id()),a];this.na.set(a.id(),b);this.wa.delete(a.id())}else this.ta.set(a.id(),a)};m.modify=function(a){var b=a[1],c=a[0].id();this.ta.has(c)?this.ta.set(c,b):(this.na.has(c)&&(a=[this.na.get(a[0].id())[0],b]),this.na.set(c,a))};
m.delete=function(a){if(this.ta.has(a.id()))this.ta.delete(a.id());else if(this.na.has(a.id())){var b=this.na.get(a.id())[0];this.na.delete(a.id());this.wa.set(a.id(),b)}else this.wa.set(a.id(),a)};m.$d=function(a){a.ta.forEach(function(a){this.add(a)},this);a.na.forEach(function(a){this.modify(a)},this);a.wa.forEach(function(a){this.delete(a)},this)};
...
function Ed(a,b){var c=1<b.length,d=a.map(function(a){return new Fd(a,c)});return new H(d,b)}function Fd(a,b){this.sa=a;this.id=Gd++;this.Wd=b}var Gd=0;function J(a,b){var c=b.Za();return null!==c&&a.sa.s.hasOwnProperty(c)?a.sa.s[c]:a.Wd?a.sa.s[K(b.H())][b.getName()]:a.sa.s[b.getName()]}function Hd(a,b,c){var d=b.Za();if(null!=d)a.sa.s[d]=c;else if(a.Wd){var d=K(b.H()),e=a.sa.s[d];null==e&&(e={},a.sa.s[d]=e);e[b.getName()]=c}else a.sa.s[b.getName()]=c}
function Id(a,b,c,d){function e(a,b){if(a.Wd){var c=a.sa.s,d;for(d in c)f[d]=c[d]}else f[b[0]]=a.sa.s}var f={};e(a,b);e(c,d);a=new y(-1,f);return new Fd(a,!0)};r("lf.bind",function(a){return new Jd(a)});function Jd(a){this.fa=a}r("lf.Binder",Jd);Jd.prototype.xa=g("fa");function Kd(){this.Ve=Ld();var a=Md();this.fc=B();this.fc.set(1,Nd());this.fc.set(2,Od());this.fc.set(4,a);this.fc.set(3,a);this.fc.set(5,Pd())}Kd.Bc=function(){return Kd.Re?Kd.Re:Kd.Re=new Kd};function Qd(a,b,c){return(a.fc.get(b)||null).get(c)||null}function Ld(){function a(a){return a}var b=B();b.set(1,function(a){return null===a?null:a?1:0});b.set(2,function(a){return null===a?null:a.getTime()});b.set(3,a);b.set(4,a);b.set(5,a);return b}
...
ie.prototype.bind=function(a){ie.Ib.bind.call(this,a);null!=this.Qb&&(this.X=a[this.Qb.xa()]);null!=this.Yb&&(this.L=a[this.Yb.xa()]);he(this,a);return this};function ke(a,b){this.Da=a;this.$=b}ke.prototype.ib=g("Da");ke.prototype.ba=g("$");function le(a){var b=D();a.forEach(function(a){a.ba().forEach(b.add.bind(b))});return b};function me(a,b){this.global=a;this.Ka=a.j(kc);this.sd=b.map(function(a){return a.context});this.ef=b.map(function(a){return a.he});this.Id=le(this.ef);this.ue=ne(this);this.cb=x()}function ne(a){return a.sd.some(function(a){return!(a instanceof ie)})?1:0}m=me.prototype;
m.exec=function(){function a(){var f=d.shift();if(f){var h=e[c.length];return f.ib().exec(b,h).then(function(b){c.push(b[0]);return a()})}return w()}var b=0==this.ue?void 0:new kd(this.global,this.Id),c=[],d=this.ef.slice(),e=this.sd;return a().then(function(){return this.Ka.Cb(this.ue,E(this.Id),b).ia()}.bind(this)).then(function(){this.ee(c);return c}.bind(this),function(a){null!=b&&b.Hb();throw a;})};m.I=g("ue");m.ba=g("Id");m.Mb=g("cb");m.W=function(){return ka(this)};m.ee=aa();function oe(a,b){me.call(this,a,b);this.Gb=a.j(pc)}t(oe,me);oe.prototype.getPriority=l(0);oe.prototype.ee=function(a){this.sd.forEach(function(b,c){pe(this.Gb,b,a[c])},this)};function qe(a,b){this.h=a;this.Gb=a.j(pc);this.Ea=a.j(oc);this.ld=new Hc(a);this.rb=b;var c=a.j(qc),d=this.rb.map(function(a){return c.table(a.getName())});this.$=D(d);this.cb=x()}m=qe.prototype;m.exec=function(){this.ld.update(this.rb);this.Pc();return w()};m.I=l(1);m.ba=g("$");m.Mb=g("cb");m.W=function(){return ka(this)};m.getPriority=l(1);m.Pc=function(){var a=re(this.Gb,this.$);0!=a.length&&(a=new oe(this.h,a),se(this.Ea,a))};function te(a){this.h=a;this.Ka=a.j(kc);this.Ea=a.j(oc)}te.prototype.ce=function(a){a=new qe(this.h,a);se(this.Ea,a)};function N(a,b){this.Pa=a;this.l=b;this.Va=B()}r("lf.backstore.FirebaseRawBackStore",N);N.prototype.gd=g("l");N.prototype.hd=function(){throw new F(351);};function ue(a,b){var c=x(),d=a;b.length&&(d=a.child(b));d.once("value",function(a){c.resolve(a.val())},function(a){c.reject(a)});return c.ha}function ve(a,b,c){function d(a){a?e.reject(a):e.resolve()}c=c||!1;var e=x();c?a.set(b,d):a.update(b,d);return e.ha}
...
ze.prototype.remove=function(a){Ce(this,a);return w()};function De(a){return 0==a.va.size?0:ac(a.va).reduce(function(a,c){return a>c?a:c},0)};function Ee(a,b){this.i=a;this.Bf=b;this.Nc=B();this.Na=-1;this.M=B();this.Va=B();this.Fd=null}m=Ee.prototype;
m.Ga=function(a){this.l=this.Bf.child(this.i.name());var b=a||function(){return w()};return ue(this.l,"@db/version").then(function(a){return null===a?ve(this.l,Fe(this),!0).then(function(){var a=new N(0,this.l);return b(a)}.bind(this)):a==this.i.version()?ue(this.l,"@rev/R").then(function(a){this.Na=a;return ue(this.l,"@table")}.bind(this)).then(function(a){for(var b in a)this.Va.set(b,a[b]);a=this.i.ra().map(function(a){return ye(this,a.getName())},this);return eb(a)}.bind(this)).then(function(){Ge(this);
He(this);return w()}.bind(this)):this.fe(a,b).then(function(){return this.Ga()}.bind(this))}.bind(this))};m.fe=function(a,b){var c=new N(a,this.l);return c.Ga(this.i).then(function(){return w()}.bind(this)).then(function(){return b(c)}).then(function(){var a=this.l.child("@db");return ve(a,{version:this.i.version()},!0)}.bind(this))};
function He(a){a.l.off();a.l.on("child_removed",a.pg.bind(a));a.Gd&&(a.Gd.off(),a.Nc.clear());a.Gd=a.l.orderByChild("R").startAt(a.Na+1);a.Gd.on("value",a.ce.bind(a))}function Ge(a){pb=C(a.M).map(function(a){return De(a)}).reduce(function(a,c){return a>c?a:c},0)+1}m.pg=function(a){var b=a.val(),c=this.Nc.get(b.T)||null;null===c&&(c=D(),this.Nc.set(b.T,c));c.add(parseInt(a.key(),10))};
m.ce=function(a){var b=a.child("@rev/R").val();null!=b&&b!=this.Na&&(this.Na=b,a=Ie(this,a),a.forEach(function(a){var b=this.M.get(a.getName()),e=ac(a.wa);0<e.length&&Ce(b,e);var f=C(a.ta);a.na.forEach(function(a){f.push(a[1])});Be(b,f)},this),0<a.length&&this.Jc(a),He(this))};
...
Q.prototype.dump=function(){var a=x(),b=bf(this);df(b);var c={};b.ia().then(function(b){b=b[0].filter(function(a){return"__lf_ver"!=a&&"__WebKitDatabaseInfoTable__"!=a}).map(function(a){return this.dc(a).then(function(b){c[a]=b})},this);eb(b).then(function(){a.resolve(c)})}.bind(this));return a.ha};Q.prototype.dump=Q.prototype.dump;function ef(a,b,c){this.h=a;this.i=b;this.Cg=c||4194304}m=ef.prototype;m.Ga=function(a){if(null==window.openDatabase)throw new F(353);var b=a||function(){return w()};return new v(function(a,d){try{var e=window.openDatabase(this.i.name(),"",this.i.name(),this.Cg);if(null!=e)this.l=e,ff(this,b).then(a,d);else throw new F(354);}catch(f){d(f)}},this)};
function ff(a,b){var c=x(),d=new $e(a.l,1,new kd(a.h,D()));Ze(d,"CREATE TABLE IF NOT EXISTS __lf_ver(id INTEGER PRIMARY KEY, v INTEGER)",[]);Ze(d,"SELECT v FROM __lf_ver WHERE id = 0",[]);d.ia().then(function(a){var d=0;a[1].rows.length&&(d=a[1].rows.item(0).v);d<this.i.version()?this.fe(b,d).then(c.resolve.bind(c)):d>this.i.version()?c.reject(new F(108)):c.resolve()}.bind(a));return c.ha}m.Cb=function(a,b,c){if(null!=this.l)return new $e(this.l,a,c);throw new F(2);};m.close=aa();
m.Cc=function(){throw new F(512);};m.subscribe=function(){throw new F(355);};m.Jc=function(){throw new F(355);};m.fe=function(a,b){var c=x();gf(this).then(function(){a(new Q(this.h,b,this.l)).then(function(){return this.oe()}.bind(this)).then(c.resolve.bind(c))}.bind(this),c.reject.bind(c));return c.ha};
...
m.Ic=function(a){var b=vf(this.qa),c=yf(this.qa);if(0==b.b.length&&0==c.b.length)return null;var d=b.b[0],b=b.B[0],e=c.b[c.b.length-1],c=c.B[c.b.length-1];return 1==a(d,e)?[d,this.ve?[b]:b]:[e,this.ve?[c]:c]};m.Ia=g("ve");m.rc=g("V");m.Zd=function(a,b){return null!=a?-1==this.V.compare(a,b):!1};m.Qa=function(a,b){return null!=a?0==this.V.compare(a,b):!1};m.Fa=function(){for(var a=[],b=vf(this.qa);b;)a.push(new y(b.pa,[b.b,b.B])),b=b.Aa;return a};
...
function Ff(a,b){for(var c=0,d=a.b.length;c<d;){var e=c+d>>1;a.F.Zd(a.b[e],b)?c=e+1:d=e}return c}function wf(a,b){if(!R(a)){var c=Ff(a,b);a.F.Qa(a.b[c],b)&&c++;return wf(a.g[c],b)}return a}
...
m.fill=function(a,b){if(R(this))for(var c=0;c<this.B.length&&0<a.count;++c)if(0<a.offset){if(a.offset-=this.F.Ia()?1:this.B[c].length,0>a.offset)for(var d=this.B[c].length+a.offset;d<this.B[c].length&&0<a.count;++d)b[a.re++]=this.B[c][d],a.count--}else if(this.F.Ia())b[a.re++]=this.B[c],a.count--;else for(d=0;d<this.B[c].length&&0<a.count;++d)b[a.re++]=this.B[c][d],a.count--;else for(c=0;c<this.g.length&&0<a.count;++c)this.g[c].fill(a,b)};
function Af(a,b){for(var c=b.Oa(),d=a.map(function(a){var d=new Bf(a.id(),b);d.b=a.s[0];d.B=a.s[1];d.b.forEach(function(a,e){c.add(a,b.Ia()?1:d.B[e].length)});return d}),e=0;e<d.length-1;++e)Df(d[e],d[e+1]);return 1<d.length?tf(d[0]):d[0]};function Mf(a){this.Kd=0==a?Nf:Of;this.ae=0==a?function(a){return null!=a?a.reverse():null}:function(a){return a||null};this.ge=0==a?Pf:Qf}t(Mf,Gc);function Of(a,b){return a>b?1:a<b?-1:0}function Nf(a,b){return Of(b,a)}function Qf(a,b){return wd(a,b)}function Pf(a,b){return wd(b,a)}m=Mf.prototype;m.sb=function(a,b){var c=this.ae(b),d=[c.c==G,c.A==G];if(!d[0]){var e=this.Kd(a,c.c);d[0]=c.da?1==e:-1!=e}d[1]||(e=this.Kd(a,c.A),d[1]=c.ma?-1==e:1!=e);return d};
m.compare=function(a,b){return this.Kd(a,b)};m.min=function(a,b){return a<b?1:a==b?0:-1};m.max=function(a,b){return a>b?1:a==b?0:-1};m.Ud=function(a,b){var c=this.sb(a,b);return c[0]&&c[1]};m.rf=function(a){return a.filter(function(a){return null!==a}).sort(function(a,c){return this.ge(a,c)}.bind(this))};m.Vd=function(a){return this.ae(a).c==G};m.td=function(a){a=this.ae(a);return[a.c,a.A]};m.toString=function(){return this.compare==Nf?"SimpleComparator_DESC":"SimpleComparator_ASC"};function Rf(a){this.La=a.map(function(a){return new Mf(a)})}t(Rf,Gc);function Sf(a,b,c,d){for(var e=0,f=0;f<a.La.length&&0==e;++f)e=d(a.La[f],b[f],c[f]);return e}m=Rf.prototype;m.compare=function(a,b){return Sf(this,a,b,function(a,b,e){return b==G||e==G?0:a.compare(b,e)})};m.min=function(a,b){return Sf(this,a,b,function(a,b,e){return a.min(b,e)})};m.max=function(a,b){return Sf(this,a,b,function(a,b,e){return a.max(b,e)})};
m.sb=function(a,b){for(var c=[!0,!0],d=0;d<this.La.length&&(c[0]||c[1]);++d){var e=this.La[d].sb(a[d],b[d]);c[0]=c[0]&&e[0];c[1]=c[1]&&e[1]}return c};m.Ud=function(a,b){for(var c=!0,d=0;d<this.La.length&&c;++d)c=this.La[d].Ud(a[d],b[d]);return c};
m.rf=function(a){var b=a.filter(function(a){return a.every(ga)});a=Array(this.La.length);for(var c=0;c<a.length;c++)a[c]=b.map(function(a){return a[c]});a.forEach(function(a,b){a.sort(function(a,c){return this.La[b].ge(a,c)}.bind(this))},this);b=Array(b.length);for(c=0;c<b.length;c++)b[c]=a.map(function(a){return a[c]});return b.sort(function(a,b){for(var c=0,h=0;h<this.La.length&&0==c;++h)c=this.La[h].ge(a[h],b[h]);return c}.bind(this))};m.Vd=function(a){return this.La[0].Vd(a[0])};
...
function wg(a,b,c){null===a.be&&(a.be=vg(a.la.H()));var d=new Fd(new y(-1,a.be),!1);return Id(b,c,d,[K(a.la.H())])}
...
function Og(a,b){var c=B();a.entries.forEach(function(a){var e=J(a,b);c.set(e,a)});return new H(C(c),I(a))};function Tg(a,b){this.Da=a;this.$=b}Tg.prototype.ib=g("Da");Tg.prototype.ba=g("$");function Ug(){L.call(this)}t(Ug,L);function Vg(a,b){L.call(this);this.table=a;this.values=b}t(Vg,Ug);function Wg(a,b){Vg.call(this,a,b)}t(Wg,Vg);function Xg(a){L.call(this);this.table=a}t(Xg,Ug);Xg.prototype.toString=function(){return"delete("+this.table.getName()+")"};function Yg(a,b){L.call(this);this.table=a;this.we=b}t(Yg,Ug);
Yg.prototype.toString=function(){var a=[];this.we&&(a=this.we.map(function(a){return a.O.getName()},this));return"update("+this.table.getName()+", ["+a.join(",")+"])"};function Zg(a){L.call(this);this.J=a}t(Zg,Ug);Zg.prototype.toString=function(){return"select("+this.J.toString()+")"};function $g(a){L.call(this);this.table=a}t($g,Ug);$g.prototype.toString=function(){var a="table_access("+this.table.getName();null===this.table.Za()||(a+=" as "+this.table.Za());return a+")"};
...
function Rh(a){a.a.f.forEach(function(a){if(a instanceof T&&!Uh(a.Jb,a.I()))throw new F(527,a.m());},a)}function Vh(a,b){if(null==a.a.c)throw new F(b);}W.prototype.c=function(a){if(this.Le)throw new F(515);this.Le=!0;null==this.a.c&&(this.a.c=[]);this.a.c.push.apply(this.a.c,Array.prototype.slice.call(arguments));return this};W.prototype.from=W.prototype.c;W.prototype.u=function(a){Vh(this,548);if(this.xd)throw new F(516);this.xd=!0;Wh(this,a);return this};W.prototype.where=W.prototype.u;
function Wh(a,b){if(null!=a.a.u){var c=Oh(b,a.a.u);a.a.u=c}else a.a.u=b}W.prototype.ag=function(a,b){Vh(this,542);if(this.xd)throw new F(547);this.a.c.push(a);Wh(this,b);return this};W.prototype.innerJoin=W.prototype.ag;W.prototype.fg=function(a,b){Vh(this,542);if(!(b instanceof tg))throw new F(541);if(this.xd)throw new F(547);this.a.c.push(a);null==this.a.yb&&(this.a.yb=D());var c=b;K(a)!=K(b.la.H())&&(c=b.reverse());this.a.yb.add(c.W());Wh(this,c);return this};W.prototype.leftOuterJoin=W.prototype.fg;
...
function ji(a,b,c){var d=D();jg(b).forEach(function(a){d.add(K(a.table))},a);b instanceof $g&&d.add(K(b.table));return wc(d,c)}function ei(a){return a instanceof Zg&&!(a.J instanceof rg)}function ii(a){a=Td(a,0);return a instanceof ah||a instanceof hh};function ki(a,b){Yh.call(this,a);this.Ub=b;this.hf=this.Ze=this.qf=this.bf=this.Ce=this.Oe=this.pf=this.Ie=this.sf=null}t(ki,Yh);
ki.prototype.dd=function(){li(this);2<=this.a.c.length&&(this.Ie=new ah);this.pf=null!=this.a.u?new Zg(this.a.u.Kb()):null;this.a.N&&(this.bf=new ch(this.a.N));null!=this.a.L&&0<this.a.L&&(this.qf=new gh(this.a.L));null!=this.a.X&&(this.Ze=new fh(this.a.X));null!=this.a.ja&&(this.Oe=new eh(this.a.ja));mi(this);this.hf=new bh(this.a.f||[],this.a.ja||null);var a=ni(this);return(new ai(a,this.a,this.Ub)).gc()};
function ni(a){for(var b=[a.Ze,a.qf,a.hf,a.bf,a.Ce,a.Oe,a.pf,a.Ie],c=null,d=null,e=0;e<b.length;e++){var f=b[e];null!==f&&(null===d?d=f:Vd(b[c],f),c=e)}a.sf.forEach(function(a){Vd(b[c],a)});return d}function li(a){a.sf=a.a.c.map(function(a){return new $g(a)},a)}function mi(a){var b=a.a.f.filter(function(a){return a instanceof T});null!=a.a.N&&a.a.N.forEach(function(a){a.O instanceof T&&b.push(a.O)});0<b.length&&(a.Ce=new dh(b))};function oi(){this.pe=[new jh,new mh,new di,new ci];this.Ld=[new jh]}oi.prototype.create=function(a){var b=null;if(a instanceof th)b=new Zh(a);else if(a instanceof qh)b=new bi(a,this.Ld);else if(a instanceof ie)b=new ki(a,this.pe);else if(a instanceof vh)b=new $h(a);else throw new F(513);b=b.gc();return new Tg(b,a.ba())};function pi(a){U.call(this,0,1);this.S=a}t(pi,U);pi.prototype.toString=function(){return"delete("+this.S.getName()+")"};pi.prototype.ea=function(a,b){var c=a[0].entries.map(function(a){return a.sa});b.remove(this.S,c);return[Bd()]};function qi(a,b){U.call(this,0,-1);this.table=b;this.D=a.j(mc)}t(qi,U);qi.prototype.toString=function(){return"get_row_count("+this.table.getName()+")"};qi.prototype.ea=function(){var a=this.D.get(Se(this.table)),b=new H([],[this.table.getName()]),c=Eg(),a=a.Oa().oa;null===b.Ya&&(b.Ya=B());b.Ya.set(c.m(),a);return[b]};function ri(a,b){U.call(this,0,-1);this.U=a.j(lc);this.D=a.j(mc);this.table=b}t(ri,U);ri.prototype.toString=function(){var a="table_access("+this.table.getName();null===this.table.Za()||(a+=" as "+this.table.Za());return a+")"};ri.prototype.ea=function(){var a=this.D.get(Se(this.table)).$a();return[Ed(jf(this.U,a),[K(this.table)])]};function si(a){this.h=a}t(si,ih);si.prototype.nb=function(a,b){this.Z=a;if(!this.Dd(b))return a;var c=kg(a,function(a){return a instanceof ri})[0],d=new qi(this.h,c.table);pg(c,c,d,d);return this.Z};si.prototype.Dd=function(a){return 1==a.f.length&&1==a.c.length&&null==a.u&&null==a.X&&null==a.L&&null==a.ja?(a=a.f[0],a instanceof T&&"COUNT"==a.Jb&&a.child instanceof Dg):!1};function ti(a){U.call(this,0,1);this.Ne=a}t(ti,U);ti.prototype.toString=function(){return"groupBy("+this.Ne.map(function(a){return a.m()}).toString()+")"};ti.prototype.ea=function(a){return ui(this,a[0])};function ui(a,b){var c=new Tc,d=function(a){return this.Ne.map(function(b){return J(a,b)},this).join(",")}.bind(a);b.entries.forEach(function(a){c.set(d(a),a)},a);return c.keys().map(function(a){return new H(c.get(a),I(b))},a)};function vi(a,b,c){U.call(this,0,0);this.D=a.j(mc);this.U=a.j(lc);this.J=b;this.Pb=c;this.Ad="eq"==this.J.G?0:2;this.Pe=null}t(vi,U);var wi=["hash","index_nested_loop","nested_loop"];vi.prototype.toString=function(){return"join(type: "+(this.Pb?"outer":"inner")+", impl: "+wi[this.Ad]+", "+this.J.toString()+")"};
vi.prototype.ea=function(a){switch(this.Ad){case 0:return[xg(this.J,a[0],a[1],this.Pb)];case 1:return[yg(this.J,a[0],a[1],this.Pe,this.U)];default:var b=this.J,c=a[0];a=a[1];var d=this.Pb,e=[c,a];d||(e=ug(b,c,a));c=e[0];a=e[1];for(var e=[],f=I(c),h=I(a),k=c.entries.length,n=a.entries.length,A=n+256-1>>8,O=0;O<A;){for(var da=0;da<k;da++){var Ab=!1,Yf=J(c.entries[da],b.ga);if(null!==Yf)for(var Ai=Math.min(O+1<<8,n),Rc=O<<8;Rc<Ai;Rc++)if(b.vc(Yf,J(a.entries[Rc],b.la))){var Ab=!0,Bi=Id(c.entries[da],
f,a.entries[Rc],h);e.push(Bi)}d&&!Ab&&e.push(wg(b,c.entries[da],f))}O++}b=I(c).concat(I(a));return[new H(e,b)]}};function xi(a,b){a.Ad=1;var c=a.D.get(b.xa().m());a.Pe={Xf:b,mg:b==a.J.ga?a.J.la:a.J.ga,index:c}};function yi(a){U.call(this,0,-1);this.jf=a}t(yi,U);yi.prototype.toString=function(){return"no_op_step("+I(this.jf[0]).join(",")+")"};yi.prototype.ea=g("jf");function zi(){}t(zi,ih);zi.prototype.nb=function(a,b){this.Z=a;if(!this.Dd(b))return a;kg(a,function(a){return a instanceof vi}).forEach(this.wg,this);return this.Z};zi.prototype.Dd=function(a){return 1<a.c.length};
zi.prototype.wg=function(a){if("eq"==a.J.G&&!a.Pb){var b=function(b){if(!(b instanceof ri))return null;b=K(b.table)==K(a.J.la.H())?a.J.la:a.J.ga;return fa(b.xa())?null:b},c=b(Td(a,0)),b=b(Td(a,1));if(null!==c||null!==b){b=null===b?c:b;xi(a,b);var d=new H([],[K(b.H())]);Xd(a,new yi([d]),b==c?0:1)}}};function Ci(a){a=a.map(function(a){return a.za()});a=Gb.apply(null,a);var b=[];Fb(a,function(a){b.push(a)});return b}function Di(a){this.Ob=a}Di.prototype.ed=function(){return 1==this.Ob.f.length?[ud()]:[this.Ob.f.map(function(){return ud()})]};function Ei(a,b){this.Ob=a;this.Ca=b;this.Hd=this.Xe=null}
...
Ei.prototype.ed=function(a){if(this.Xe==a)return this.Hd;for(var b=Fi(this,a),c=this.Ob.f.length-1;0<=c;c--){var d=this.Ob.f[c];if(null!==(b.get(d.ca.getName())||null))break;b.set(d.ca.getName(),new gg([ud()]))}this.Hd=1==this.Ob.f.length?C(b)[0].za():Ci(Gi(this,b));this.Xe=a;return this.Hd};function Gi(a,b){var c=B(),d=0;a.Ob.f.forEach(function(a){c.set(a.ca.getName(),d);d++});return ac(b).sort(function(a,b){return c.get(a)-c.get(b)}).map(function(a){return b.get(a)})};function Hi(a,b){this.tf=b;this.D=a.j(mc)}function Ii(a,b,c){c=c.filter(a.bg,a);if(0==c.length)return null;a=Ji(a,c);if(0==a.length)return null;if(1==a.length)return a[0];var d=Number.MAX_VALUE;return a.reduce(function(a,c){var h=Ki(c,b);return h<d?(d=h,c):a},null)}
function Ji(a,b){return a.tf.ya().map(function(a){a=new Li(this.D,a);Mi(a,b);return a},a).filter(function(a){if(null===a.Ca)a=!1;else{for(var b=!1,e=!0,f=0;f<a.wb.f.length;f++){var h=a.Ca.has(a.wb.f[f].ca.getName());if(b&&h){e=!1;break}h||(b=!0)}a=e}return a})}Hi.prototype.bg=function(a){var b;if(b=a instanceof ae)be(a),b=null!==a.value&&("between"==a.G||"eq"==a.G||"gt"==a.G||"gte"==a.G||"lt"==a.G||"lte"==a.G);return b?a.O.H()==this.tf:!1};
function Li(a,b){this.D=a;this.wb=b;this.Yf=D(this.wb.f.map(function(a){return a.ca.getName()}));this.Yd=this.Ca=null}function Ni(a){null===a.Yd&&(a.Yd=new Ei(a.wb,a.Ca));return a.Yd}function Mi(a,b){b.forEach(function(a){var b=a.hb()[0].getName();this.Yf.has(b)&&(null===this.Ca&&(this.Ca=new Tc),this.Ca.set(b,a.W()))},a)}function Ki(a,b){var c=Ni(a).ed(b),d=a.D.get(a.wb.m());return c.reduce(function(a,b){return a+d.bd(b)},0)};function Oi(a,b,c,d){U.call(this,0,-1);this.D=a.j(mc);this.index=b;this.We=c;this.me=d;this.Vc=this.Uc=!1}t(Oi,U);Oi.prototype.toString=function(){return"index_range_scan("+this.index.m()+", ?, "+(this.me?"reverse":"natural")+(this.Uc?", limit:?":"")+(this.Vc?", skip:?":"")+")"};Oi.prototype.Sc=function(a){var b=this.toString(),c=this.We.ed(a),b=b.replace("?",c.toString());this.Uc&&(b=b.replace("?",a.X.toString()));this.Vc&&(b=b.replace("?",a.L.toString()));return b};
Oi.prototype.ea=function(a,b,c){a=this.We.ed(c);b=this.D.get(this.index.m());c=(1==a.length&&a[0]instanceof pd&&vd(a[0])?of(b.get(a[0].c),!1,this.Uc?c.X:void 0,this.Vc?c.L:void 0):b.$a(a,this.me,this.Uc?c.X:void 0,this.Vc?c.L:void 0)).map(function(a){return new y(a,{})},this);return[Ed(c,[this.index.Rc])]};function Pi(a){U.call(this,0,1);this.rd=a}t(Pi,U);Pi.prototype.toString=l("select(?)");Pi.prototype.Sc=function(a){a=ee(a,this.rd);return this.toString().replace("?",a.toString())};Pi.prototype.ea=function(a,b,c){return[ee(c,this.rd).eval(a[0])]};function Qi(a,b){U.call(this,0,1);this.U=a.j(lc);this.S=b}t(Qi,U);Qi.prototype.toString=function(){return"table_access_by_row_id("+this.S.getName()+")"};Qi.prototype.ea=function(a){return[Ed(jf(this.U,yd(a[0])),[K(this.S)])]};function Ri(a){this.h=a}t(Ri,ih);Ri.prototype.nb=function(a,b){this.Z=a;kg(a,function(a){return a instanceof ri}).forEach(function(a){var d=Si(a);if(0!=d.length){var e=Ii(new Hi(this.h,a.table),b,d.map(function(a){return ee(b,a.rd)}));if(null!==e){var f=B();d.forEach(function(a){f.set(a.rd,a)},this);this.Z=Ti(this,e,f,a)}}},this);return this.Z};function Si(a){var b=[];for(a=a.getParent();a;)a instanceof Pi&&b.push(a),a=a.getParent();return b}
...
Sj.prototype.exec=function(a){Uj(this,4);var b=[];try{a.forEach(function(a){a.fb();b.push(a.Dc())},this)}catch(c){return Uj(this,7),bb(c)}a=new oh(this.h,b);return se(this.Ea,a).then(function(a){Uj(this,7);return a.map(function(a){return xd(a)})}.bind(this),function(a){Uj(this,7);throw a;}.bind(this))};Sj.prototype.exec=Sj.prototype.exec;Sj.prototype.Df=function(a){Uj(this,1);this.Tc=new Pj(this.h,a);return Qj(this.Tc).then(function(){Uj(this,2)}.bind(this))};Sj.prototype.begin=Sj.prototype.Df;
Sj.prototype.Cf=function(a){Uj(this,3);return Rj(this.Tc,a).then(function(a){Uj(this,2);return a}.bind(this),function(a){Uj(this,7);throw a;}.bind(this))};Sj.prototype.attach=Sj.prototype.Cf;Sj.prototype.ia=function(){Uj(this,5);return this.Tc.ia().then(function(){Uj(this,7)}.bind(this))};Sj.prototype.commit=Sj.prototype.ia;Sj.prototype.Hb=function(){Uj(this,6);return this.Tc.Hb().then(function(){Uj(this,7)}.bind(this))};Sj.prototype.rollback=Sj.prototype.Hb;function X(a){this.h=a;this.i=a.j(qc);this.Sd=!1}r("lf.proc.Database",X);X.prototype.Ga=function(a){this.h.mb(qc,this.i);return Lj(this.h,a).then(function(){this.Sd=!0;this.Ea=this.h.j(oc);return this}.bind(this))};X.prototype.init=X.prototype.Ga;X.prototype.vb=g("i");X.prototype.getSchema=X.prototype.vb;function Vj(a){if(!a.Sd)throw new F(2);}X.prototype.select=function(a){Vj(this);return new W(this.h,1!=arguments.length||null!=arguments[0]?Array.prototype.slice.call(arguments):[])};
X.prototype.select=X.prototype.select;X.prototype.xb=function(){Vj(this);return new Nh(this.h)};X.prototype.insert=X.prototype.xb;X.prototype.Td=function(){Vj(this);return new Nh(this.h,!0)};X.prototype.insertOrReplace=X.prototype.Td;X.prototype.update=function(a){Vj(this);return new Xh(this.h,a)};X.prototype.update=X.prototype.update;X.prototype.delete=function(){Vj(this);return new Mh(this.h)};X.prototype["delete"]=X.prototype.delete;
X.prototype.observe=function(a,b){Vj(this);this.h.j(pc).zd(a,b)};X.prototype.observe=X.prototype.observe;X.prototype.unobserve=function(a,b){Vj(this);this.h.j(pc).ke(a,b)};X.prototype.unobserve=X.prototype.unobserve;X.prototype.Kf=function(){Vj(this);return new Sj(this.h)};X.prototype.createTransaction=X.prototype.Kf;X.prototype.close=function(){try{this.h.j(kc).close()}catch(a){}this.h.clear();this.Sd=!1};X.prototype.close=X.prototype.close;
X.prototype.Sf=function(){Vj(this);var a=new Mj(this.h);return se(this.Ea,a).then(function(a){return xd(a[0])[0]})};X.prototype["export"]=X.prototype.Sf;X.prototype.import=function(a){Vj(this);a=new Nj(this.h,a);return se(this.Ea,a).then(l(null))};X.prototype["import"]=X.prototype.import;function Y(a,b,c,d,e,f){this.S=a;this.w=b;this.Ue=c;this.Se=d;this.wf=e;this.eb=f||null}r("lf.schema.BaseColumn",Y);m=Y.prototype;m.getName=g("w");m.m=function(){return K(this.S)+"."+this.w};m.toString=function(){return this.m()};m.H=g("S");m.I=g("wf");Y.prototype.getType=Y.prototype.I;Y.prototype.Za=g("eb");Y.prototype.ya=function(){null==this.ka&&(this.ka=[],this.H().ya().forEach(function(a){-1!=a.f.map(function(a){return a.ca.getName()}).indexOf(this.w)&&this.ka.push(a)},this));return this.ka};
Y.prototype.xa=function(){if(!q(this.fa)){var a=this.ya().filter(function(a){return 1!=a.f.length?!1:a.f[0].ca.getName()==this.getName()},this);this.fa=0<a.length?a[0]:null}return this.fa};Y.prototype.Fc=g("Se");Y.prototype.isNullable=Y.prototype.Fc;Y.prototype.Gc=g("Ue");Y.prototype.Qa=function(a){return zg(this,a,"eq")};Y.prototype.eq=Y.prototype.Qa;Y.prototype.af=function(a){return zg(this,a,"neq")};Y.prototype.neq=Y.prototype.af;Y.prototype.Zd=function(a){return zg(this,a,"lt")};
Y.prototype.lt=Y.prototype.Zd;Y.prototype.ig=function(a){return zg(this,a,"lte")};Y.prototype.lte=Y.prototype.ig;Y.prototype.Uf=function(a){return zg(this,a,"gt")};Y.prototype.gt=Y.prototype.Uf;Y.prototype.Vf=function(a){return zg(this,a,"gte")};Y.prototype.gte=Y.prototype.Vf;Y.prototype.match=function(a){return zg(this,a,"match")};Y.prototype.match=Y.prototype.match;Y.prototype.Ef=function(a,b){return zg(this,[a,b],"between")};Y.prototype.between=Y.prototype.Ef;
Y.prototype.Wf=function(a){return zg(this,a,"in")};Y.prototype["in"]=Y.prototype.Wf;Y.prototype.dg=function(){return this.Qa(null)};Y.prototype.isNull=Y.prototype.dg;Y.prototype.cg=function(){return this.af(null)};Y.prototype.isNotNull=Y.prototype.cg;Y.prototype.pc=function(a){return new Y(this.S,this.w,this.Ue,this.Se,this.wf,a)};Y.prototype.as=Y.prototype.pc;function Wj(){this.ud=B()}var Xj;Wj.prototype.clear=function(){this.ud.clear()};Wj.prototype.clear=Wj.prototype.clear;Wj.prototype.mb=function(a,b){this.ud.set(a.toString(),b);return b};Wj.prototype.registerService=Wj.prototype.mb;Wj.prototype.j=function(a){var b=this.ud.get(a.toString())||null;if(null===b)throw new F(7,a.toString());return b};Wj.prototype.getService=Wj.prototype.j;Wj.prototype.Xd=function(a){return this.ud.has(a.toString())};Wj.prototype.isRegistered=Wj.prototype.Xd;function Yj(a){this.i=a;this.Ed=new Tc;this.le=new Tc;this.cf=new Tc;this.He=B();this.g=new Tc;this.De=new Tc;this.kf=new Tc;this.Ge=new Tc;Zj(this)}function Zj(a){a.i.ra().forEach(function(a){var c=a.getName();a.Eb().Qd().forEach(function(d){this.cf.set(c,this.i.table(d.Sa));this.g.set(d.Sa,a);0==d.action?(this.le.set(d.Sa,d),this.kf.set(d.Sa,a)):(this.Ed.set(d.Sa,d),this.De.set(d.Sa,a));this.He.set(a.getName()+"."+d.gb,d.Sa);this.Ge.set(d.Sa+"."+d.ic,a.getName())},this)},a)}
function ad(a,b,c){if(null!=c)return 1==c?a.Ed.get(b):a.le.get(b);c=a.Ed.get(b);a=a.le.get(b);return null===c&&null===a?null:(c||[]).concat(a||[])}function uh(a,b){var c=b.get(a);return null===c?[]:c}function wh(a,b){var c=D();b.forEach(function(a){(a=this.He.get(a))&&c.add(a)},a);return E(c).map(function(a){return this.i.table(a)},a)}function sh(a,b,c){return null!=c?0==c?uh(b,a.kf):uh(b,a.De):uh(b,a.g)}
function xh(a,b){var c=D();b.forEach(function(a){(a=this.Ge.get(a))&&a.forEach(function(a){c.add(a)})},a);return E(c).map(function(a){return this.i.table(a)},a)};function ak(a,b,c){this.vg=a;this.ng=b;this.Tf=c}r("lf.schema.Constraint",ak);ak.prototype.fd=g("vg");ak.prototype.getPrimaryKey=ak.prototype.fd;ak.prototype.Qd=g("Tf");ak.prototype.getForeignKeys=ak.prototype.Qd;function bk(a,b,c){var d=a.ref.split(".");if(2!=d.length)throw new F(540,c);this.Fe=b;this.gb=a.local;this.Sa=d[0];this.ic=d[1];this.name=b+"."+c;this.action=a.action;this.timing=a.timing};function Z(a){ck(a);this.Md=Kd.Bc();this.w=a;this.K=B();this.wd=D();this.lc=D();this.Kc=D();this.Ba=null;this.ka=B();this.qd=!1;this.ub=[]}r("lf.schema.TableBuilder",Z);function dk(a){this.name=a.name;this.lb=a.order;this.autoIncrement=a.autoIncrement}var ek=D([0,6]);function ck(a){if(!/^[A-Za-z_][A-Za-z0-9_]*$/.test(a))throw new F(502,a);}function fk(a,b){if(b==a.w)throw new F(546,b);if(a.K.has(b)||a.ka.has(b)||a.lc.has(b))throw new F(503,a.w+"."+b);}
...
function ik(a){if(null!==a.Ba){var b=function(a){return a.name},c=JSON.stringify(a.ka.get(a.Ba).map(b));a.ka.forEach(function(a,e){if(e!=this.Ba){var f=a.map(b);if(JSON.stringify(f)==c)throw new F(544,this.w+"."+e);}},a)}}function jk(a){null===a.Ba||a.ka.get(a.Ba).forEach(function(a){if(this.Kc.has(a.name))throw new F(545,this.w+"."+a.name);},a)}Z.prototype.xf=function(a,b){ck(a);fk(this,a);this.K.set(a,b);ek.has(b)&&this.Ae([a]);return this};Z.prototype.addColumn=Z.prototype.xf;
Z.prototype.zf=function(a,b){var c=this.w;this.Ba="pk"+(c[0].toUpperCase()+c.substring(1));ck(this.Ba);fk(this,this.Ba);c=kk(this,a,!0,void 0,b);gk(this,c);1==c.length&&this.wd.add(c[0].name);this.lc.add(this.Ba);this.ka.set(this.Ba,c);return this};Z.prototype.addPrimaryKey=Z.prototype.zf;
Z.prototype.yf=function(a,b){ck(a);fk(this,a);var c=new bk(b,this.w,a);q(c.action)||(c.action=0);q(c.timing)||(c.timing=0);if(1==c.action&&1==c.timing)throw new F(506);if(!this.K.has(c.gb))throw new F(540,a);this.ub.push(c);this.ze(a,[c.gb],this.wd.has(c.gb));return this};Z.prototype.addForeignKey=Z.prototype.yf;Z.prototype.Af=function(a,b){ck(a);fk(this,a);var c=kk(this,b,!0);lk(this,a,c);1==c.length&&(this.wd.add(c[0].name),mk(this,c[0].name));this.ka.set(a,c);this.lc.add(a);return this};
Z.prototype.addUnique=Z.prototype.Af;function mk(a,b){a.ub.forEach(function(a){a.gb==b&&this.lc.add(a.name.split(".")[1])},a)}Z.prototype.Ae=function(a){a=kk(this,a,!1);nk(this,a);a.forEach(function(a){this.Kc.add(a.name)},this);return this};Z.prototype.addNullable=Z.prototype.Ae;function nk(a,b){ac(a.ka).forEach(function(a){var d=D();this.ka.get(a).forEach(function(a){d.add(a.name)});var e=b.filter(function(a){return d.has(a.name)});if(1<d.size&&0<e.length)throw new F(507,a,e.join(","));},a)}
Z.prototype.ze=function(a,b,c,d){ck(a);fk(this,a);b=kk(this,b,!0,d);lk(this,a,b);c&&this.lc.add(a);this.ka.set(a,b);return this};Z.prototype.addIndex=Z.prototype.ze;function lk(a,b,c){if(1<c.length&&(a=c.filter(function(a){return this.Kc.has(a.name)},a),0<a.length))throw new F(507,b,a.join(","));}Z.prototype.zb=ba("qd");Z.prototype.persistentIndex=Z.prototype.zb;Z.prototype.vb=function(){hk(this);ik(this);jk(this);return new (ok(this))};Z.prototype.getSchema=Z.prototype.vb;
...
rk.prototype.Gf=function(a){a.ub.forEach(function(a){pk(this.qb.get(a.Sa)).forEach(function(c){if(c.gb==a.ic)throw new F(534,a.name);},this)},this)};function uk(a){a.yc||(a.qb.forEach(function(a){tk(this,a);a=a.vb();this.i.M.set(a.getName(),a)},a),C(a.qb).forEach(a.Gf,a),vk(a),a.qb.clear(),a.yc=!0)}function wk(a,b,c){b.xe||(b.xe=!0,b.de=!0,b.Ke.forEach(function(a){a=c.get(a);if(!a.xe)wk(this,a,c);else if(a.de&&b!=a)throw new F(533);},a));b.de=!1}
function vk(a){var b=B();a.i.M.forEach(function(a,d){b.set(d,new xk(d))},a);a.qb.forEach(function(a,d){a.ub.forEach(function(a){b.get(a.Sa).Ke.add(d)})});C(b).forEach(function(a){wk(this,a,b)},a)}function xk(a){this.de=this.xe=!1;this.Ke=D();this.Rc=a}rk.prototype.vb=function(){this.yc||uk(this);return this.i};rk.prototype.getSchema=rk.prototype.vb;rk.prototype.Me=function(){var a=new jc("ns_"+this.i.name()),b;Xj||(Xj=new Wj);b=Xj;var c=null;b.Xd(a)?c=b.j(a):(c=new Wj,b.mb(a,c));return c};
rk.prototype.getGlobal=rk.prototype.Me;rk.prototype.connect=function(a){var b=this.Me();b.Xd(qc)||b.mb(qc,this.vb());return(new X(b)).Ga(a)};rk.prototype.connect=rk.prototype.connect;rk.prototype.Jf=function(a){if(this.qb.has(a))throw new F(503,a);if(this.yc)throw new F(535);this.qb.set(a,new Z(a));return this.qb.get(a)};rk.prototype.createTable=rk.prototype.Jf;rk.prototype.qe=function(a){if(this.yc)throw new F(535);this.i.qe(a);return this};rk.prototype.setPragma=rk.prototype.qe;
function sk(a,b){this.w=a;this.Pa=b;this.M=B();this.gf={Nf:!1}}r("lf.schema.DatabaseSchema",sk);sk.prototype.name=g("w");sk.prototype.name=sk.prototype.name;sk.prototype.version=g("Pa");sk.prototype.version=sk.prototype.version;sk.prototype.ra=function(){return C(this.M)};sk.prototype.tables=sk.prototype.ra;sk.prototype.table=function(a){if(!this.M.has(a))throw new F(101,a);return this.M.get(a)};sk.prototype.table=sk.prototype.table;sk.prototype.info=function(){this.Qe||(this.Qe=new Yj(this));return this.Qe};
sk.prototype.ff=g("gf");sk.prototype.pragma=sk.prototype.ff;sk.prototype.qe=ba("gf");r("lf.schema.create",function(a,b){return new rk(a,b)});v.prototype.catch=v.prototype.te;v.prototype["catch"]=v.prototype.catch;}.bind(window))()
