...
lf.proc.OrderByIndexPass.prototype.applyTableAccessFullOptimization_=function(a){var b=a,c=lf.proc.OrderByIndexPass.findTableAccessFullStep_(a.getChildAt(0));if(!goog.isNull(c)){var b=a.orderBy[0],d=b.column.getIndices()[0],b=new lf.proc.IndexRangeScanStep(d,[lf.index.KeyRange.all()],b.order),d=new lf.proc.TableAccessByRowIdStep(c.table);lf.tree.removeNode(a);b=lf.tree.replaceNodeWithChain(c,b,d)}return b};
