...
m.delete=function(a,b){var c=this.o.get(a,null);if(null===c)return!1;var d=c.delete(b);d&&(--this.size,0==c.size&&this.o.delete(a));return d};m.get=function(a){a=this.o.get(a)||null;return null===a?null:D(a)};m.clear=function(){this.o.clear();this.size=0};m.keys=function(){return Vb(this.o)};m.values=function(){var a=[];this.o.forEach(function(b){a.push.apply(a,D(b))});return a};function Sc(a){this.F=a.l(lc);this.g=a.l(pc);this.V=a.l(kc);this.ad=null}function Tc(a,b,c){var d=b.Gb().ng;c.forEach(function(a){d.forEach(function(b){if(null==a.s[b.getName()])throw new E(202,b.m());},this)},a)}function Vc(a,b,c,d){b.Gb().Sd().forEach(function(a){a.timing==d&&Wc(this,a,c)},a)}function Wc(a,b,c){var d=Xc(a,b);c.forEach(function(a){if(Yc(a[0],a[1],b.name)&&(a=a[1].s[b.hb],null!==a&&!d.Ma(a)))throw new E(203,b.name);},a)}
function Xc(a,b){null===a.ad&&(a.ad=z());var c=a.ad.get(b.name)||null;null===c&&(c=a.g.table(b.Sa)[b.mc].Aa(),c=a.F.get(c.m()),a.ad.set(b.name,c));return c}function Yc(a,b,c){return(null===a?null!==b:null===b)||a.Hb(c)!=b.Hb(c)}function Zc(a,b,c,d){b=$c(a.g.info(),b.getName(),0);null!==b&&(b=b.filter(function(a){return a.timing==d}),0!=b.length&&ad(a,b,c,function(a,b,c){if(b.Ma(c))throw new E(203,a.name);}))}
...
m.ld=function(){return 0==this.va.size&&0==this.za.size&&0==this.ma.size};function jd(a,b){this.aa=z();b.forEach(function(a){this.aa.set(a.getName(),a)},this);this.g=a.l(pc);this.V=a.l(kc);this.F=a.l(lc);this.xa=new Sc(a);this.jd=new Gc(a);this.ub=z()}function hc(a){var b=[];Vb(a.ub).map(function(a){return this.aa.get(a)},a).forEach(function(a){a.Cb()&&(a.Ba().forEach(function(a){b.push(this.F.get(a.m()))},this),b.push(this.F.get(a.getName()+".#")))},a);return b}m=jd.prototype;m.ca=g("aa");
...
m.remove=function(a,b){kd(this,a);nd(this,a,b);fd(this.xa,a,b,0);for(var c=0;c<b.length;c++)ld(this,a,[b[c],null])};function md(a,b,c){b=$c(a.g.info(),b.getName(),1);if(null!==b){var d=cd(a.xa,c,b);d.keys().forEach(function(a){d.get(a).forEach(function(b){var c=this.g.table(b.Pd.Ee),d=this.V.get(a),n=c.ib(d.Ga());n.s[b.Pd.hb]=b.sg.s[b.Pd.mc];ld(this,c,[d,n])},this)},a)}}
...
M.prototype.wb=function(){throw new E(351);};M.prototype.createRow=M.prototype.wb;M.prototype.Fc=g("Pa");M.prototype.getVersion=M.prototype.Fc;M.prototype.gc=function(a){var b=x();a=this.Va.get(a);this.j.orderByChild("T").equalTo(a).once("value",function(a){var d=[];a.forEach(function(a){d.push(a.val().P)});b.resolve(d)});return b.da};M.prototype.dump=function(){var a={},b=Vb(this.Va).map(function(b){return this.gc(b).then(function(d){a[b]=d})}.bind(this));return fb(b).then(function(){return a})};
...
ef.prototype.uc=function(){var a=null,b=this.S.reject.bind(this.S),c=function(a,b){this.S.reject(b)}.bind(this),d=[],e=function(b,h){if(null!==a){var k=h;null!=a.transform&&null!=h&&(k=a.transform(h));d.push(k);a.S.resolve(k)}0<this.Kd.length?(a=k=this.Kd.shift(),b.executeSql(k.Dg,k.tg,e,c)):this.S.resolve(d)}.bind(this);0==this.te?this.j.readTransaction(e,b):this.j.transaction(e,b);return this.S.da};function P(a,b,c){this.j=c;this.i=a;this.Pa=b}r("lf.backstore.WebSqlRawBackStore",P);P.prototype.ed=g("j");P.prototype.getRawDBInstance=P.prototype.ed;P.prototype.fd=function(){throw new E(356);};P.prototype.getRawTransaction=P.prototype.fd;function gf(a){return new ef(a.j,1,new jd(a.i,C()))}P.prototype.vc=function(a){var b=gf(this);df(b,"DROP TABLE "+a,[]);return b.ia()};P.prototype.dropTable=P.prototype.vc;
...
P.prototype.sc=function(a,b,c){var d=Me(c);return hf(this,a,function(a){a.value[b]=d;return a})};P.prototype.addTableColumn=P.prototype.sc;P.prototype.wc=function(a,b){return hf(this,a,function(a){delete a.value[b];return a})};P.prototype.dropTableColumn=P.prototype.wc;P.prototype.Mc=function(a,b,c){return hf(this,a,function(a){a.value[c]=a.value[b];delete a.value[b];return a})};P.prototype.renameTableColumn=P.prototype.Mc;P.prototype.wb=function(a){var b={},c;for(c in a)b[c]=Me(a[c]);return Zb(b)};
P.prototype.createRow=P.prototype.wb;P.prototype.Fc=g("Pa");P.prototype.getVersion=P.prototype.Fc;function jf(a){df(a,'SELECT tbl_name FROM sqlite_master WHERE type="table"',[],function(a){for(var c=Array(a.rows.length),d=0;d<c.length;++d)c[d]=a.rows.item(d).tbl_name;return c})}
...
function mf(a,b){var c=x(),d=new ef(a.j,1,new jd(a.i,C()));df(d,"CREATE TABLE IF NOT EXISTS __lf_ver(id INTEGER PRIMARY KEY, v INTEGER)",[]);df(d,"SELECT v FROM __lf_ver WHERE id = 0",[]);d.ia().then(function(a){var d=0;a[1].rows.length&&(d=a[1].rows.item(0).v);d<this.g.version()?this.ee(b,d).then(c.resolve.bind(c)):d>this.g.version()?c.reject(new E(108)):c.resolve()}.bind(a));return c.da}m.Eb=function(a,b,c){if(null!=this.j)return new ef(this.j,a,c);throw new E(2);};m.close=aa();
m.Dc=function(){throw new E(512);};m.subscribe=function(){throw new E(355);};m.Ic=function(){throw new E(355);};m.ee=function(a,b){var c=x();nf(this).then(function(){a(new P(this.i,b,this.j)).then(function(){return this.ne()}.bind(this)).then(c.resolve.bind(c))}.bind(this),c.reject.bind(c));return c.da};
function nf(a){var b=a.g.ra(),c=new ef(a.j,1,new jd(a.i,C())),d=new ef(a.j,1,new jd(a.i,C()));df(c,"INSERT OR REPLACE INTO __lf_ver VALUES (0, ?)",[a.g.version()]);jf(c);return c.ia().then(function(a){var c=a[1];c.filter(function(a){return-1!=a.indexOf("__d__")}).forEach(function(a){df(d,"DROP TABLE "+a,[])});var h=[],k=[],n=[];b.map(function(a){-1==c.indexOf(a.getName())&&h.push(a.getName());a.Cb&&(a.Ba().forEach(function(a){a=ff(a.m());h.push(a);k.push(a)}),a=ff(Xe(a)),h.push(a),n.push(a))});h.forEach(function(a){df(d,
...
function Kf(a,b){b&&(b.ob=a);a&&(a.ta=b)}function xf(a,b){for(var c=b.length,d=0,e=Df(a),f=e;0<c;){var h=768<=c?511:257<=c&&511>=c?c:257,k=b.slice(d,d+h);e.b=k.map(function(a){return a.key});e.B=k.map(function(a){return a.value});d+=h;c-=h;0<c&&(h=Df(e.D),Kf(e,h),e=h)}return f}function Lf(a){var b=a[0],c=Df(b.D);c.lb=b.lb+1;c.h=a;for(b=0;b<a.length;++b)a[b].C=c,0<b&&c.b.push(a[b].b[0]);return c}
function yf(a){var b=a,c=[];do c.push(b),b=b.ta;while(b);if(512>=c.length)b=Lf(c);else{var d=c.length,e=0,b=Df(a.D);for(b.lb=a.lb+2;0<d;){a=768<=d?511:257<=d&&511>=d?d:257;var f=c.slice(e,e+a),h=Lf(f);h.C=b;b.h.length&&(b.b.push(f[0].b[0]),Kf(b.h[b.h.length-1],h));b.h.push(h);e+=a;d-=a}}return b}m.get=function(a){var b=Mf(this,a);if(Q(this)){var c=zf;this.D.Qa(this.b[b],a)&&(c=c.concat(this.B[b]));return c}b=this.D.Qa(this.b[b],a)?b+1:b;return this.h[b].get(a)};
...
m.Ab=function(a,b,c){var d=Mf(this,a);if(Q(this)){if(this.D.Qa(this.b[d],a)){if(c)this.D.Oa().remove(a,this.D.Ja()?1:this.B[d].length),this.B[d]=this.D.Ja()?b:[b];else{if(this.D.Ja())throw new E(201);if(!sf(this.B[d],b))throw new E(109);}this.D.Oa().add(a,1);return this}this.b.splice(d,0,a);this.B.splice(d,0,this.D.Ja()?b:[b]);this.D.Oa().add(a,1);512==this.b.length?(d=Df(this.D),a=Df(this.D),a.lb=1,a.b=[this.b[256]],a.h=[this,d],a.C=this.C,this.C=a,d.b=this.b.splice(256),d.B=this.B.splice(256),d.C=
a,Kf(d,this.ta),Kf(this,d),d=a):d=this;return d}d=this.D.Qa(this.b[d],a)?d+1:d;a=this.h[d].Ab(a,b,c);Q(a)||1!=a.b.length||(this.b.splice(d,0,a.b[0]),a.h[1].C=this,a.h[0].C=this,this.h.splice(d,1,a.h[1]),this.h.splice(d,0,a.h[0]));return 512==this.b.length?Rf(this):this};function Rf(a){var b=Df(a.D),c=Df(a.D);b.C=a.C;b.lb=a.lb+1;b.b=[a.b[256]];b.h=[a,c];a.b.splice(256,1);c.C=b;c.lb=a.lb;c.b=a.b.splice(256);c.h=a.h.splice(257);c.h.forEach(function(a){a.C=c});a.C=b;Kf(c,a.ta);Kf(a,c);return b}
...
m.$a=function(a,b,c){function d(a){return a[0]?a[1]?0:1:-1}var e=this.D.fc(),f=0,h=this.b.length-1,k=this.b,n=d(e.vb(k[f],a)),B=d(e.vb(k[h],a));if(1!=n&&(-1!=n||-1!=B)){var O=function(a,b){var c=a+b>>1;return c==a?c+1:c},ca=function(b,c,f){if(b>=c)return 0==f?c:-1;var h=d(e.vb(k[b],a));if(0==h)return b;if(1==h)return-1;h=O(b,c);if(h==c)return 0==f?c:-1;var n=d(e.vb(k[h],a));return 0==n?ca(b,h,n):-1==n?ca(h+1,c,f):ca(b+1,h,n)},Cb=function(b,c){if(b>=c)return b;var f=d(e.vb(k[c],a));if(0==f)return c;
...
m.vb=function(a,b){for(var c=[!0,!0],d=0;d<this.wa.length&&(c[0]||c[1]);++d){var e=this.wa[d].vb(a[d],b[d]);c[0]=c[0]&&e[0];c[1]=c[1]&&e[1]}return c};m.Qb=function(a,b){for(var c=!0,d=0;d<this.wa.length&&c;++d)c=this.wa[d].Qb(a[d],b[d]);return c};
...
function Cg(a,b){var c=b||function(a){return a.toString()+"\n"},d="";Xd(a,function(a){for(var b=0;b<Rd(a);b++)d+="-";d+=c(a)});return d};function Dg(a){Yd.call(this);this.Tb=a;this.ab=!1}t(Dg,Yd);m=Dg.prototype;m.Mb=function(){return ug(this,function(a){if(a instanceof Dg){var b=new Dg(a.Tb);b.ab=a.ab;a=a.Z();b.oa=a;return b}return a.Mb()})};m.jb=function(a){var b=a||[];Xd(this,function(a){a!=this&&a.jb(b)}.bind(this));a=C(b);return D(a)};m.vd=function(a){this.ab!=a&&(this.ab=a,this.Tb="and"==this.Tb?"or":"and",L(this).forEach(function(b){return b.vd(a)}))};
m.eval=function(a){var b=L(this).map(function(b){return b.eval(a)});return Eg(this,b)};function Eg(a,b){return"and"==a.Tb?Bd(b):Cd(b)}m.toString=function(){return"combined_pred_"+this.Tb.toString()};function Fg(a,b,c){Yd.call(this);this.ha=a;this.ka=b;this.G=c;this.ae=null;a=Jd.Cc();this.xc=Pd(a,this.ha.H(),this.G);this.eg=a.Ve.get(this.ha.H())||null}t(Fg,Yd);m=Fg.prototype;m.Mb=function(){var a=new Fg(this.ha,this.ka,this.G),b=this.Z();a.oa=b;return a};m.jb=function(a){return null!=a?(a.push(this.ha),a.push(this.ka),a):[this.ha,this.ka]};
...
function J(a){return a.fb||a.w}R.prototype.tc=function(a){var b=new this.constructor(this.w);b.fb=a;b.yg=this.yg;return b};R.prototype.as=R.prototype.tc;R.prototype.createRow=R.prototype.wb;R.prototype.deserializeRow=R.prototype.ib;R.prototype.Ba=g("pa");R.prototype.getIndices=R.prototype.Ba;R.prototype.jb=g("K");R.prototype.getColumns=R.prototype.jb;R.prototype.getConstraint=R.prototype.Gb;R.prototype.Cb=g("qd");R.prototype.persistentIndex=R.prototype.Cb;function Xe(a){return a.w+".#"};function S(a,b){this.child=a;this.Lb=b;this.fb=null}m=S.prototype;m.getName=function(){return this.Lb+"("+this.child.getName()+")"};m.m=function(){return this.Lb+"("+this.child.m()+")"};m.I=function(){return this.child.I()};m.toString=function(){return this.m()};m.H=function(){return this.child.H()};m.Za=g("fb");m.Ba=function(){return[]};m.Aa=l(null);m.kc=l(!1);m.tc=function(a){this.fb=a;return this};S.prototype.as=S.prototype.tc;
...
function $g(a,b){var c=z();a.entries.forEach(function(a){var e=I(a,b);c.set(e,a)});return new G(A(c),H(a))};function eh(a,b){this.Ea=a;this.aa=b}eh.prototype.kb=g("Ea");eh.prototype.ca=g("aa");function fh(){K.call(this)}t(fh,K);function gh(a,b){K.call(this);this.table=a;this.values=b}t(gh,fh);function hh(a,b){gh.call(this,a,b)}t(hh,gh);function ih(a){K.call(this);this.table=a}t(ih,fh);ih.prototype.toString=function(){return"delete("+this.table.getName()+")"};function jh(a,b){K.call(this);this.table=a;this.ve=b}t(jh,fh);
...
function hi(a,b){if(null!=a.a.u){var c=$h(b,a.a.u);a.a.u=c}else a.a.u=b}V.prototype.ag=function(a,b){gi(this,542);if(this.xd)throw new E(547);this.a.c.push(a);hi(this,b);return this};V.prototype.innerJoin=V.prototype.ag;V.prototype.fg=function(a,b){gi(this,542);if(!(b instanceof Fg))throw new E(541);if(this.xd)throw new E(547);this.a.c.push(a);null==this.a.Bb&&(this.a.Bb=C());var c=b;J(a)!=J(b.ka.I())&&(c=b.reverse());this.a.Bb.add(c.Z());hi(this,c);return this};V.prototype.leftOuterJoin=V.prototype.fg;
...
function Ti(a,b){return a.tf.Ba().map(function(a){a=new Vi(this.F,a);Wi(a,b);return a},a).filter(function(a){if(null===a.Da)a=!1;else{for(var b=!1,e=!0,f=0;f<a.zb.f.length;f++){var h=a.Da.has(a.zb.f[f].ba.getName());if(b&&h){e=!1;break}h||(b=!0)}a=e}return a})}Ri.prototype.bg=function(a){var b;if(b=a instanceof $d)ae(a),b=null!==a.value&&("between"==a.G||"eq"==a.G||"gt"==a.G||"gte"==a.G||"lt"==a.G||"lte"==a.G);return b?a.N.I()==this.tf:!1};
function Vi(a,b){this.F=a;this.zb=b;this.Yf=C(this.zb.f.map(function(a){return a.ba.getName()}));this.Xd=this.Da=null}function Xi(a){null===a.Xd&&(a.Xd=new Oi(a.zb,a.Da));return a.Xd}function Wi(a,b){b.forEach(function(a){var b=a.jb()[0].getName();this.Yf.has(b)&&(null===this.Da&&(this.Da=new Rc),this.Da.set(b,a.Z()))},a)}function Ui(a,b){var c=Xi(a).cd(b),d=a.F.get(a.zb.m());return c.reduce(function(a,b){return a+d.$c(b)},0)};function Yi(a,b,c,d){T.call(this,0,-1);this.F=a.l(lc);this.index=b;this.We=c;this.le=d;this.Tc=this.Sc=!1}t(Yi,T);Yi.prototype.toString=function(){return"index_range_scan("+this.index.m()+", ?, "+(this.le?"reverse":"natural")+(this.Sc?", limit:?":"")+(this.Tc?", skip:?":"")+")"};Yi.prototype.Qc=function(a){var b=this.toString(),c=this.We.cd(a),b=b.replace("?",c.toString());this.Sc&&(b=b.replace("?",a.X.toString()));this.Tc&&(b=b.replace("?",a.L.toString()));return b};
...
function re(a,b,c){b=ka(null!=b.Yc?b.Yc:b).toString();a=a.hc.get(b)||null;null!==a&&Uj(a,c)}function Tj(a){this.Ff=a;this.Jc=C();this.og=[];this.Ye=null;this.Mf=new Oj(a.a,this.og)}Tj.prototype.zd=function(a){this.Jc.has(a)||this.Jc.add(a)};Tj.prototype.je=function(a){return this.Jc.delete(a)};Tj.prototype.Ec=function(){var a=this.Ff;return{context:a.a,ge:Xh(a)}};function Uj(a,b){var c=Qj(a.Mf,a.Ye,b);a.Ye=b;0<c.length&&a.Jc.forEach(function(a){a(c)})};function Vj(a,b){var c=a.l(pc),d=b||{},e=new of(c);a.pb(kc,e);var e=null,f=!1;null!=d.storeType?e=d.storeType:(e=Tb(),e=e.Zf?0:e.Ig?4:1);switch(e){case 0:e=new Te(a,c);break;case 1:e=new $e(c);break;case 5:e=new bf(c);break;case 4:e=new kf(a,c,d.webSqlDbSize);break;case 3:e=new Ge(c,d.firebase);f=!0;break;default:throw new E(300);}a.pb(jc,e);var h=new rg;a.pb(lc,h);return e.Ha(d.onUpgrade).then(function(){var b=new Cj(a);a.pb(mc,b);b=new Kj;a.pb(nc,b);b=new Sj;a.pb(oc,b);return h.Ha(c)}).then(function(){if(f){var b=
...
f=function(a){var b=a.map(function(a){return e(a.ba)});return function(a){return b.map(function(b){return b(a)})}}.bind(a),h={};c.forEach(function(a){var b=a.m();a=1==a.f.length?e(a.f[0].ba):f(a.f);h[b]=a});d.prototype.Hb=function(a){return-1!=a.indexOf("#")?this.id():h.hasOwnProperty(a)?h[a](this.s):null};return d};function zk(a,b){this.g=new Z(a,b);this.tb=z();this.Ac=!1;this.j=null}r("lf.schema.Builder",zk);function Ak(a,b){b.xb.forEach(function(a){var d=a.Sa;if(!this.tb.has(d))throw new E(536,a.name);var d=this.tb.get(d).yb(),e=a.mc;if(!d.hasOwnProperty(e))throw new E(537,a.name);if(b.yb()[a.hb].H()!=d[e].H())throw new E(538,a.name);if(!d[e].Gc())throw new E(539,a.name);},a)}
zk.prototype.Gf=function(a){a.xb.forEach(function(a){xk(this.tb.get(a.Sa)).forEach(function(c){if(c.hb==a.mc)throw new E(534,a.name);},this)},this)};function Bk(a){a.Ac||(a.tb.forEach(function(a){Ak(this,a);a=a.yb();this.g.M.set(a.getName(),a)},a),A(a.tb).forEach(a.Gf,a),Ck(a),a.tb.clear(),a.Ac=!0)}function Dk(a,b,c){b.we||(b.we=!0,b.ce=!0,b.Je.forEach(function(a){a=c.get(a);if(!a.we)Dk(this,a,c);else if(a.ce&&b!=a)throw new E(533);},a));b.ce=!1}
function Ck(a){var b=z();a.g.M.forEach(function(a,d){b.set(d,new Ek(d))},a);a.tb.forEach(function(a,d){a.xb.forEach(function(a){b.get(a.Sa).Je.add(d)})});A(b).forEach(function(a){Dk(this,a,b)},a)}function Ek(a){this.ce=this.we=!1;this.Je=C();this.Pc=a}zk.prototype.yb=function(){this.Ac||Bk(this);return this.g};zk.prototype.getSchema=zk.prototype.yb;zk.prototype.Le=function(){var a=new ic("ns_"+this.g.name()),b;hk||(hk=new gk);b=hk;var c=null;b.Wd(a)?c=b.l(a):(c=new gk,b.pb(a,c));return c};
zk.prototype.getGlobal=zk.prototype.Le;zk.prototype.connect=function(a){if(null!==this.j&&this.j.kd)throw new E(113);if(null===this.j){var b=this.Le();b.Wd(pc)||b.pb(pc,this.yb());this.j=new W(b)}return this.j.Ha(a)};zk.prototype.connect=zk.prototype.connect;zk.prototype.Jf=function(a){if(this.tb.has(a))throw new E(503,a);if(this.Ac)throw new E(535);this.tb.set(a,new Y(a));return this.tb.get(a)};zk.prototype.createTable=zk.prototype.Jf;
zk.prototype.pe=function(a){if(this.Ac)throw new E(535);this.g.pe(a);return this};zk.prototype.setPragma=zk.prototype.pe;function Z(a,b){this.w=a;this.Pa=b;this.M=z();this.gf={Nf:!1}}r("lf.schema.DatabaseSchema",Z);Z.prototype.name=g("w");Z.prototype.name=Z.prototype.name;Z.prototype.version=g("Pa");Z.prototype.version=Z.prototype.version;Z.prototype.ra=function(){return A(this.M)};Z.prototype.tables=Z.prototype.ra;Z.prototype.table=function(a){if(!this.M.has(a))throw new E(101,a);return this.M.get(a)};
