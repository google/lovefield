...
function tf(a,b){for(var c=b.$a(),d=a.map(function(a){var d=new uf(a.id(),b);d.b=a.s()[0];d.A=a.s()[1];d.b[E](function(a,g){c.add(a,b.Ma()?1:d.A[g][B])});return d}),g=0;g<d[B]-1;++g)wf(d[g],d[g+1]);return 1<d[B]?pf(d[0]):d[0]};function zf(a){if(1==a.f[B])return new Af(a.f[0].sb);a=a.f.map(function(a){return a.sb});return new Bf(a)}function Af(a){this.Cd=0==a?Cf:Df;this.cf=0==a?function(a){return null!=a?a[gb]():null}:function(a){return a||null};this.Yg=0==a?Ef:Ff}K(Af,Vd);function Df(a,b){return a>b?1:a<b?-1:0}function Cf(a,b){return Df(b,a)}function Ff(a,b){return ie(a,b)}function Ef(a,b){return ie(b,a)}H=Af[t];
