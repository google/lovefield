...
function jb(a,b,c,d,e){function g(a){k||(k=!0,d.call(e,a))}function h(a){k||(k=!0,c.call(e,a))}var k=!1;try{b.call(a,h,g)}catch(n){g(n)}}function gb(a){a.Ld||(a.Ld=!0,Pa(a.Kf,a))}function kb(a){var b=null;a.bc&&(b=a.bc,a.bc=b.next,b.next=null);a.bc||(a.Zc=null);return b}
...
*/
function y(a,b){this.oa=a;this.s=b||this.Ce()}var nb=0;m=y.prototype;m.id=f("oa");function ob(a){return a.s}m.Ce=function(){return{}};m.nf=f("s");m.Ia=function(){return{id:this.oa,value:this.nf()}};m.Eb=function(a){return"#"==a.substr(-1)?this.oa:null};function pb(a){return new y(a.id,a.value)}function qb(a){return new y(nb++,a||{})}function rb(a){if(null==a)return null;a=new Uint8Array(a);for(var b="",c=0;c<a.length;++c)var d=a[c].toString(16),b=b+(2>d.length?"0"+d:d);return b};function sb(a){this.type=a}function tb(a){y.call(this,-1,a)}t(tb,y);function ub(a,b,c,d){c=c||function(a,b){return a==b};d=d||function(b){return a[b]};for(var e=a.length,g=b.length,h=[],k=0;k<e+1;k++)h[k]=[],h[k][0]=0;for(var n=0;n<g+1;n++)h[0][n]=0;for(k=1;k<=e;k++)for(n=1;n<=g;n++)c(a[k-1],b[n-1])?h[k][n]=h[k-1][n-1]+1:h[k][n]=Math.max(h[k-1][n],h[k][n-1]);for(var B=[],k=e,n=g;0<k&&0<n;)c(a[k-1],b[n-1])?(B.unshift(d(k-1,n-1)),k--,n--):h[k-1][n]>h[k][n-1]?k--:n--;return B}function vb(a){return ya(arguments,function(a,c){return a+c},0)}
...
N.prototype.tb=function(){throw new E(351);};N.prototype.createRow=N.prototype.tb;N.prototype.Cc=f("Oa");N.prototype.getVersion=N.prototype.Cc;N.prototype.cc=function(a){var b=x();a=this.Va.get(a);this.j.orderByChild("T").equalTo(a).once("value",function(a){var d=[];a.forEach(function(a){d.push(a.val().P)});b.resolve(d)});return b.ha};N.prototype.dump=function(){var a={},b=Jb(this.Va).map(function(b){return this.cc(b).then(function(d){a[b]=d})}.bind(this));return cb(b).then(function(){return a})};
...
m.Ac=function(a){var b=this.L.get(a)||null;if(null!==b)return b;throw new E(101,a);};m.close=aa();m.subscribe=ba("Fd");m.Hc=function(a){null!=this.Fd&&this.Fd(a)};function O(a,b,c,d){this.j=b;this.Xa=c;this.Oa=a;this.Xc=d}r("lf.backstore.IndexedDBRawBackStore",O);O.prototype.gd=f("j");O.prototype.getRawDBInstance=O.prototype.gd;O.prototype.hd=f("Xa");O.prototype.getRawTransaction=O.prototype.hd;O.prototype.rc=function(a){return new v(function(b,c){try{this.j.deleteObjectStore(a)}catch(d){c(d);return}b()},this)};O.prototype.dropTable=O.prototype.rc;
function se(a,b,c,d){return new v(function(a,g){var h;try{var k=this.Xa.objectStore(b);h=k.openCursor()}catch(n){g(n);return}h.onsuccess=function(){var b=h.result;b?(c(b),b.continue()):(d(k),a())};h.onerror=g},a)}function te(a){var b=null;return b=a instanceof ArrayBuffer?rb(a):a instanceof Date?a.getTime():a}
...
O.prototype.Nc=function(a,b,c){return ue(this,a,function(a){a.s[c]=a.s[b];delete a.s[b]})};O.prototype.renameTableColumn=O.prototype.Nc;function ve(a,b){var c=[];return new v(function(a,e){var g;try{g=this.Xa.objectStore(b).openCursor()}catch(h){e(h);return}g.onsuccess=function(){var b=g.result;if(b){if(this.Xc){var e;e=rc(b.value).s;for(var h in e)c.push(e[h])}else c.push(b.value);b.continue()}else a(c)}.bind(this);g.onerror=e},a)}O.prototype.tb=function(a){var b={},c;for(c in a)b[c]=te(a[c]);return qb(b)};
...
function vg(a){a.K.forEach(function(a){a=ng(a).reverse();for(var c=1;c<a.length;c++){var d=a[c],e=ng(d).slice(-1)[0],g=d.child instanceof S?jd(this.Ha,d.child):this.Ha;if(null!==g.Ya&&g.Ya.has(d.l()))break;g=xg(d.Ib,g,e);e=this.Ha;null===e.Ya&&(e.Ya=A());e.Ya.set(d.l(),g)}},a)}
...
function vh(a,b){var c=b||!1,d=a.a.clone();if(d instanceof eh)return kh(d,c);if(d instanceof bh){var e="DELETE FROM "+d.c.getName();d.u&&(e+=qh(d.u,c));return e+";"}if(d instanceof gh)return rh(d,c);if(d instanceof Sd)return sh(d,c);throw new E(358,typeof d);};function U(a,b){this.global=a;this.ng=a.i(Vb);this.Ba=a.i(Xb);this.a=b}r("lf.query.BaseBuilder",U);U.prototype.exec=function(){try{this.fb()}catch(a){return $a(a)}return new v(function(a,c){var d=new $g(this.global,[this.Bc()]);be(this.Ba,d).then(function(c){a(hd(c[0]))},c)},this)};U.prototype.exec=U.prototype.exec;U.prototype.Lf=function(){var a=function(a){return a.Rc(this.a)+"\n"}.bind(this);return ag(wh(this).hb(),a)};U.prototype.explain=U.prototype.Lf;
...
function pi(a,b){var c=A();a.za.keys().forEach(function(a){var e=this.za.get(a).map(function(a){return Od(b,a)},this),g=new Pf([ed()]);e.forEach(function(a){var b=null;"between"==a.G?b=new $c(a.value[0],a.value[1],!1,!1):"eq"==a.G?(b=a.value,b=new $c(b,b,!1,!1)):b="gte"==a.G?new $c(a.value,F,!1,!1):"gt"==a.G?new $c(a.value,F,!0,!1):"lte"==a.G?new $c(F,a.value,!1,!1):new $c(F,a.value,!1,!0);a=a.ab?ad(b):[b];a=new Pf(a);g=Sf(g,a)});c.set(a,g)},a);return c}
...
function ti(a,b){return a.mf.va().map(function(a){a=new vi(this.D,a);wi(a,b);return a},a).filter(function(a){if(null===a.za)a=!1;else{for(var b=!1,e=!0,g=0;g<a.wb.f.length;g++){var h=a.za.has(a.wb.f[g].ba.getName());if(b&&h){e=!1;break}h||(b=!0)}a=e}return a})}ri.prototype.Vf=function(a){var b;if(b=a instanceof Kd)Ld(a),b=null!==a.value&&("between"==a.G||"eq"==a.G||"gt"==a.G||"gte"==a.G||"lt"==a.G||"lte"==a.G);return b?a.O.H()==this.mf:!1};
...
function Gi(a,b){T.call(this,0,-1);this.D=a.i(Ub);this.S=b}t(Gi,T);Gi.prototype.toString=function(){return"insert_replace("+this.S.getName()+")"};Gi.prototype.ea=function(a,b,c){Fi(this.S,c.values,this.D);a.Qd(this.S,c.values);return[od(c.values,[this.S.getName()])]};function Hi(){T.call(this,0,1)}t(Hi,T);Hi.prototype.toString=l("limit(?)");Hi.prototype.Rc=function(a){return this.toString().replace("?",a.W.toString())};Hi.prototype.ea=function(a,b,c){b[0].entries.splice(c.W);return b};function Ii(a){T.call(this,0,1);this.M=a}t(Ii,T);m=Ii.prototype;m.toString=function(){return"order_by("+Td(this.M)+")"};m.ea=function(a,b){if(1==b.length){var c;c=b[0];for(var d=null,e=0;e<this.M.length;e++){var g=qg(this.M[e].O);if(null!==c.Ya&&c.Ya.has(g.l())){d=g;break}}c=d;(null===c?b[0]:jd(b[0],c)).entries.sort(this.If.bind(this))}else b.sort(this.pg.bind(this));return b};
...
W.prototype.Mf=function(){Gj(this);var a=new xj(this.g);return be(this.Ba,a).then(function(a){return hd(a[0])[0]})};W.prototype["export"]=W.prototype.Mf;W.prototype.import=function(a){Gj(this);a=new yj(this.g,a);return be(this.Ba,a).then(l(null))};W.prototype["import"]=W.prototype.import;function X(a,b,c,d,e,g){this.S=a;this.w=b;this.Ne=c;this.Le=d;this.qf=e;this.eb=g||null}r("lf.schema.BaseColumn",X);m=X.prototype;m.getName=f("w");m.l=function(){return J(this.S)+"."+this.w};m.toString=function(){return this.l()};m.H=f("S");m.I=f("qf");X.prototype.getType=X.prototype.I;X.prototype.Za=f("eb");X.prototype.va=function(){null==this.ka&&(this.ka=[],this.H().va().forEach(function(a){-1!=a.f.map(function(a){return a.ba.getName()}).indexOf(this.w)&&this.ka.push(a)},this));return this.ka};
X.prototype.ua=function(){if(!q(this.fa)){var a=this.va().filter(function(a){return 1!=a.f.length?!1:a.f[0].ba.getName()==this.getName()},this);this.fa=0<a.length?a[0]:null}return this.fa};X.prototype.Dc=f("Le");X.prototype.isNullable=X.prototype.Dc;X.prototype.Ec=f("Ne");X.prototype.Qa=function(a){return kg(this,a,"eq")};X.prototype.eq=X.prototype.Qa;X.prototype.Ue=function(a){return kg(this,a,"neq")};X.prototype.neq=X.prototype.Ue;X.prototype.Wd=function(a){return kg(this,a,"lt")};
...
function Zj(a){function b(){function b(c){return a.ka.get(c).map(function(a){return{ba:this[a.name],kb:a.kb,autoIncrement:a.autoIncrement}},this)}var d=Jb(a.K).map(function(b){this[b]=new X(this,b,a.xd.has(b),a.Ic.has(b),a.K.get(b));return this[b]},this),e=Jb(a.ka).map(function(d){return new mg(a.w,d,a.jc.has(d),b.call(this,d))},this);R.call(this,a.w,d,e,a.qd);var g=null===a.ya?null:new mg(a.w,a.ya,!0,b.call(this,a.ya)),h=d.filter(function(b){return!a.Ic.has(b.getName())});this.Bf=new Lj(g,h,a.ub);
this.gf=bk(a,d,e)}t(b,R);b.prototype.tb=function(a){return new this.gf(nb++,a)};b.prototype.createRow=b.prototype.tb;b.prototype.Lb=function(a){var b={};this.gb().forEach(function(e){var g=e.getName();e=e.I();var h=a.value[g];if(0==e)if(e=h,null!=e&&""!=e){0!=e.length%2&&(e="0"+e);for(var h=new ArrayBuffer(e.length/2),k=new Uint8Array(h),n=0,B=0;n<e.length;n+=2)k[B++]=parseInt(e.substr(n,2),16);e=h}else e=null;else e=2==e?null!=h?new Date(h):null:h;b[g]=e},this);return new this.gf(a.id,b)};b.prototype.deserializeRow=
b.prototype.Lb;b.prototype.Db=f("Bf");b.prototype.getConstraint=b.prototype.Db;return b}
