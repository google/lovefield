...
lf.cache.Journal.prototype.getIndexScope=function(){var a=[],b=this.scope_.getValues();b.forEach(function(b){if(b.persistentIndex()){var d=b.getIndices();d.forEach(function(b){a.push(b.getNormalizedName())});a.push(b.getName()+".#")}});return a};
lf.cache.Journal.prototype.getIndexRange=function(a,b,c,d,e){var f=this.indexStore_.get(a.getNormalizedName());if(1==b.length)return f.getRange(b[0],c,d,e);goog.asserts.assert(!goog.isDefAndNotNull(d),"Using index for limit/skip not implemented for multi-keyrange queries.");goog.asserts.assert(!goog.isDefAndNotNull(e),"Using index for limit/skip not implemented for multi-keyrange queries.");var g=new goog.structs.Set;b.forEach(function(a){g.addAll(f.getRange(a,c))},this);a=g.getValues();c==lf.Order.DESC&&
a.reverse();return a};lf.cache.Journal.prototype.getTableRows=function(a,b){var c=goog.isDefAndNotNull(b)?b:this.indexStore_.get(a.getRowIdIndexName()).getRange();return this.cache_.get(c)};lf.cache.Journal.prototype.insert=function(a,b){this.assertJournalWritable_();this.checkScope_(a);this.contstraintChecker_.checkNotNullable(a,b);for(var c=0;c<b.length;c++)this.modifyRow_(a,null,b[c])};
