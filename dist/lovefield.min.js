...
!0;throw a;},this))};lf.proc.Database=function(a){this.global_=a;this.schema_=a.getService(lf.service.SCHEMA);this.initialized_=!1};lf.proc.Database.prototype.init=function(a,b){this.global_.registerService(lf.service.SCHEMA,this.schema_);return lf.base.init(this.global_,b||lf.base.BackStoreType.INDEXED_DB,a,!1).then(goog.bind(function(){this.initialized_=!0;return this},this))};
lf.proc.Database.prototype.checkInit_=function(){if(!this.initialized_)throw new lf.Exception(lf.Exception.Type.UNINITIALIZED,"Database is not initialized");};lf.proc.Database.prototype.insert=function(){this.checkInit_();return new lf.query.InsertBuilder(this.global_)};lf.proc.Database.prototype.insertOrReplace=function(){this.checkInit_();return new lf.query.InsertBuilder(this.global_,!0)};
lf.proc.Database.prototype.update=function(a){this.checkInit_();return new lf.query.UpdateBuilder(this.global_,a)};lf.proc.Database.prototype.delete=function(){this.checkInit_();return new lf.query.DeleteBuilder(this.global_)};lf.proc.Database.prototype.close=function(){lf.base.closeDatabase(this.global_);this.global_.clear();this.initialized_=!1};
