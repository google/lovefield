...
(function(){'use strict';function aa(){return function(){}}function ba(a){return function(b){this[a]=b}}function g(a){return function(){return this[a]}}function k(a){return function(){return a}}var m,ca=this;function n(a){return void 0!==a}function ea(){}
...
function qa(a,b){var c=Array.prototype.slice.call(arguments,1);return function(){var b=c.slice();b.push.apply(b,arguments);return a.apply(this,b)}}function q(a,b){a=a.split(".");var c=ca;a[0]in c||!c.execScript||c.execScript("var "+a[0]);for(var d;a.length&&(d=a.shift());)!a.length&&n(b)?c[d]=b:c=c[d]&&Object.prototype.hasOwnProperty.call(c,d)?c[d]:c[d]={}}
...
function Ca(a,b,c){return 2>=arguments.length?Array.prototype.slice.call(a,b):Array.prototype.slice.call(a,b,c)}function Da(a){for(var b=[],c=0;c<a;c++)b[c]=0;return b}function Ea(a){for(var b=[],c=0;c<arguments.length;c++){var d=arguments[c];if("array"==fa(d))for(var e=0;e<d.length;e+=8192)for(var f=Ea.apply(null,Ca(d,e,e+8192)),h=0;h<f.length;h++)b.push(f[h]);else b.push(d)}return b};function Fa(a){var b=[],c=0,d;for(d in a)b[c++]=a[d];return b};var Ga;a:{var Ha=ca.navigator;if(Ha){var Ia=Ha.userAgent;if(Ia){Ga=Ia;break a}}Ga=""}function t(a){return-1!=Ga.indexOf(a)};function Ja(){return t("Safari")&&!(Ka()||t("Coast")||t("Opera")||t("Edge")||t("Silk")||t("Android"))}function Ka(){return(t("Chrome")||t("CriOS"))&&!t("Edge")};function La(a){ca.setTimeout(function(){throw a;},0)}var Ma;
...
function hb(a,b,c,d){var e=ab(null,null,null);e.child=new u(function(a,h){e.Ic=b?function(c){try{var e=b.call(d,c);a(e)}catch(M){h(M)}}:a;e.ic=c?function(b){try{var e=c.call(d,b);!n(e)&&b instanceof kb?h(b):a(e)}catch(M){h(M)}}:h});e.child.D=a;ib(a,e);return e.child}u.prototype.Qg=function(a){this.Ta=0;Ya(this,2,a)};u.prototype.Rg=function(a){this.Ta=0;Ya(this,3,a)};
function Ya(a,b,c){0==a.Ta&&(a===c&&(b=3,c=new TypeError("Promise cannot resolve to itself")),a.Ta=1,db(c,a.Qg,a.Rg,a)||(a.nf=c,a.Ta=b,a.D=null,jb(a),3!=b||c instanceof kb||lb(a,c)))}function db(a,b,c,d){if(a instanceof u)return ib(a,ab(b||ea,c||null,d)),!0;var e;if(a)try{e=!!a.$goog_Thenable}catch(h){e=!1}else e=!1;if(e)return a.then(b,c,d),!0;e=typeof a;if("object"==e&&null!=a||"function"==e)try{var f=a.then;if(ja(f))return mb(a,f,b,c,d),!0}catch(h){return c.call(d,h),!0}return!1}
function mb(a,b,c,d,e){function f(a){l||(l=!0,d.call(e,a))}function h(a){l||(l=!0,c.call(e,a))}var l=!1;try{b.call(a,h,f)}catch(p){f(p)}}function jb(a){a.Rd||(a.Rd=!0,Sa(a.Vf,a))}function nb(a){var b=null;a.dc&&(b=a.dc,a.dc=b.next,b.next=null);a.dc||(a.Vc=null);return b}
u.prototype.Vf=function(){for(var a;a=nb(this);){var b=this.Ta,c=this.nf;if(3==b&&a.ic&&!a.Ed){var d;for(d=this;d&&d.ed;d=d.D)d.ed=!1}if(a.child)a.child.D=null,ob(a,b,c);else try{a.Ed?a.Ic.call(a.context):ob(a,b,c)}catch(e){pb.call(null,e)}$a.put(a)}this.Rd=!1};function ob(a,b,c){2==b?a.Ic.call(a.context,c):a.ic&&a.ic.call(a.context,c)}function lb(a,b){a.ed=!0;Sa(function(){a.ed&&pb.call(null,b)})}var pb=La;function kb(a){ra.call(this,a)}r(kb,ra);kb.prototype.name="cancel";
function gb(a,b,c){this.ha=a;this.resolve=b;this.reject=c};function qb(a,b,c,d){c=c||function(a,b){return a==b};d=d||function(b){return a[b]};for(var e=a.length,f=b.length,h=[],l=0;l<e+1;l++)h[l]=[],h[l][0]=0;for(var p=0;p<f+1;p++)h[0][p]=0;for(l=1;l<=e;l++)for(p=1;p<=f;p++)c(a[l-1],b[p-1])?h[l][p]=h[l-1][p-1]+1:h[l][p]=Math.max(h[l-1][p],h[l][p-1]);for(var M=[],l=e,p=f;0<l&&0<p;)c(a[l-1],b[p-1])?(M.unshift(d(l-1,p-1)),l--,p--):h[l-1][p]>h[l][p-1]?l--:p--;return M}function rb(a){return Aa(arguments,function(a,c){return a+c},0)}
function sb(a){return rb.apply(null,arguments)/arguments.length}function tb(a){var b=arguments.length;if(2>b)return 0;var c=sb.apply(null,arguments);return rb.apply(null,za(arguments,function(a){return Math.pow(a-c,2)}))/(b-1)}function ub(a){return Math.sqrt(tb.apply(null,arguments))};var vb="StopIteration"in ca?ca.StopIteration:{message:"StopIteration",stack:""};function wb(){}wb.prototype.next=function(){throw vb;};wb.prototype.pc=function(){return this};function xb(a){if(a instanceof wb)return a;if("function"==typeof a.pc)return a.pc(!1);if(ha(a)){var b=0,c=new wb;c.next=function(){for(;;){if(b>=a.length)throw vb;if(b in a)return a[b++];b++}};return c}throw Error("Not implemented");}
function yb(a,b){if(ha(a))try{ya(a,b,void 0)}catch(c){if(c!==vb)throw c;}else{a=xb(a);try{for(;;)b.call(void 0,a.next(),void 0,a)}catch(c){if(c!==vb)throw c;}}}function zb(a){if(Ba(arguments,function(a){return!a.length})||!arguments.length)return new wb;var b=new wb,c=arguments,d=Da(c.length);b.next=function(){if(d){for(var a=za(d,function(a,b){return c[b][a]}),b=d.length-1;0<=b;b--){if(d[b]<c[b].length-1){d[b]++;break}if(0==b){d=null;break}d[b]=0}return a}throw vb;};return b};function Ab(a,b){this.l={};this.a=[];this.Ua=this.Eb=0;var c=arguments.length;if(1<c){if(c%2)throw Error("Uneven number of arguments");for(var d=0;d<c;d+=2)this.set(arguments[d],arguments[d+1])}else a&&this.addAll(a)}m=Ab.prototype;m.zc=g("Eb");m.qa=function(){Bb(this);for(var a=[],b=0;b<this.a.length;b++)a.push(this.l[this.a[b]]);return a};function Cb(a){Bb(a);return a.a.concat()}m.Pa=function(a){return Fb(this.l,a)};m.jd=function(){return 0==this.Eb};
...
m.set=function(a,b){Fb(this.l,a)||(this.Eb++,this.a.push(a),this.Ua++);this.l[a]=b};m.addAll=function(a){var b;if(a instanceof Ab)b=Cb(a),a=a.qa();else{b=[];var c=0,d;for(d in a)b[c++]=d;a=Fa(a)}for(c=0;c<b.length;c++)this.set(b[c],a[c])};m.forEach=function(a,b){for(var c=Cb(this),d=0;d<c.length;d++){var e=c[d],f=this.get(e);a.call(b,f,e,this)}};m.clone=function(){return new Ab(this)};
m.pc=function(a){Bb(this);var b=0,c=this.Ua,d=this,e=new wb;e.next=function(){if(c!=d.Ua)throw Error("The map has changed since the iterator was created");if(b>=d.a.length)throw vb;var e=d.a[b++];return a?e:d.l[e]};return e};function Fb(a,b){return Object.prototype.hasOwnProperty.call(a,b)};function Gb(){return t("iPhone")&&!t("iPod")&&!t("iPad")};function Hb(a,b){var c=Ib;return Object.prototype.hasOwnProperty.call(c,a)?c[a]:c[a]=b(a)};var Jb=t("Opera"),Kb=t("Trident")||t("MSIE"),Lb=t("Edge"),Mb=t("Gecko")&&!(-1!=Ga.toLowerCase().indexOf("webkit")&&!t("Edge"))&&!(t("Trident")||t("MSIE"))&&!t("Edge"),Nb=-1!=Ga.toLowerCase().indexOf("webkit")&&!t("Edge"),Ob=t("Macintosh"),Pb=t("Windows"),Qb=t("Android"),Rb=Gb(),Sb=t("iPad"),Tb=t("iPod"),Ub;
a:{var Vb="",Wb=function(){var a=Ga;if(Mb)return/rv\:([^\);]+)(\)|;)/.exec(a);if(Lb)return/Edge\/([\d\.]+)/.exec(a);if(Kb)return/\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(a);if(Nb)return/WebKit\/(\S+)/.exec(a);if(Jb)return/(?:Version)[ \/]?(\S+)/.exec(a)}();Wb&&(Vb=Wb?Wb[1]:"");if(Kb){var Xb,Yb=ca.document;Xb=Yb?Yb.documentMode:void 0;if(null!=Xb&&Xb>parseFloat(Vb)){Ub=String(Xb);break a}}Ub=Vb}var Zb=Ub,Ib={};function $b(a){return Hb(a,function(){return 0<=ua(Zb,a)})};var ac=function(){var a;return Pb?(a=/Windows NT ([0-9.]+)/,(a=a.exec(Ga))?a[1]:"0"):Ob?(a=/10[_.][0-9_.]+/,(a=a.exec(Ga))?a[0].replace(/_/g,"."):"10"):Qb?(a=/Android\s+([^\);]+)(\)|;)/,(a=a.exec(Ga))?a[1]:""):Rb||Sb||Tb?(a=/(?:iPhone|CPU)\s+OS\s+(\S+)/,(a=a.exec(Ga))?a[1].replace(/_/g,"."):""):""}();var bc=Gb()||t("iPod"),cc=t("iPad");/*
...
*/
function dc(){var a;!(a=Ja()&&!$b(10))&&(a=cc||bc)&&(a=!(0<=ua(ac,10)));this.ae=a;this.fg=!(this.ae||Kb&&!$b(10));!Kb||$b(11);this.Ug=Ka()||Ja();this.ug=n(window.Map)&&n(window.Map.prototype.values)&&n(window.Map.prototype.forEach)&&!this.ae;this.vg=n(window.Set)&&n(window.Set.prototype.values)&&n(window.Set.prototype.forEach)&&!this.ae}var ec;function fc(){n(ec)||(ec=new dc);return ec};function w(){this.l=new Ab;Object.defineProperty(this,"size",{get:function(){return this.l.zc()}})}w.prototype.clear=function(){this.l.clear()};w.prototype.clear=w.prototype.clear;w.prototype.delete=function(a){return this.l.remove(a)};w.prototype["delete"]=w.prototype.delete;w.prototype.forEach=function(a,b){return this.l.forEach(a,b)};w.prototype.forEach=w.prototype.forEach;w.prototype.get=function(a){return this.l.get(a)};w.prototype.get=w.prototype.get;w.prototype.has=function(a){return this.l.Pa(a)};
w.prototype.has=w.prototype.has;w.prototype.set=function(a,b){return this.l.set(a,b)};w.prototype.set=w.prototype.set;var gc=fc().ug;function y(){return gc?new window.Map:new w}function hc(a){if(a instanceof w)return Cb(a.l);var b=0,c=Array(a.size);a.forEach(function(a,e){c[b++]=e});return c}function z(a){if(a instanceof w)return a.l.qa();var b=0,c=Array(a.size);a.forEach(function(a){c[b++]=a});return c};/*
...
m.put=function(a){if(0==a.length)return v();var b=y();a.forEach(function(a){var c=a.id()>>9,e=b.get(c)||null;null===e&&(e=this.pf(this.Z.name,c));Lc(e,[a]);b.set(c,e)},this);a=z(b).map(function(a){return this.Tb(function(){return this.Z.put(a.Ja())}.bind(this))},this);return eb(a)};
m.remove=function(a){if(0==a.length)return this.Tb(function(){return this.Z.clear()}.bind(this));var b=y();a.forEach(function(a){var c=a>>9,e=b.get(c)||null;null===e&&(e=this.pf(this.Z.name,c));Mc(e,[a]);b.set(c,e)},this);a=z(b).map(function(a){return this.Tb(function(){return 0==Object.keys(a.m).length?this.Z.delete(a.W()):this.Z.put(a.Ja())}.bind(this))},this);return eb(a)};function Qc(a,b,c){a=a.b(xc);var d=[c<<9,(c+1<<9)-1];b=a.Va(b,d[0],d[1]);c=new Jc(c);Lc(c,b);return c}
function Rc(a,b){return new Jc(b)};function Sc(a){this.V=a.b(xc);this.C=a.b(yc);this.g=a.b(Cc)}Sc.prototype.update=function(a){a.forEach(function(a){Tc(this,a);Vc(this,a)},this)};function Vc(a,b){var c=b.getName();b.xa.forEach(function(a,b){this.V.remove(c,b)},a);b.wa.forEach(function(a){this.V.set(c,a)},a);b.la.forEach(function(a){this.V.set(c,a[1])},a)}function Tc(a,b){var c=a.g.table(b.getName());Wc(b).forEach(function(a){Xc(this,c,a)},a)}
...
m.Y=function(){var a=null;null!=this.ja&&(a=this.ja.Y());return null===a?new A(!1,0,0,0,0):a};function Ge(a,b){Ee.call(this,a,b);this.Ib=a.b(Bc)}r(Ge,Ee);Ge.prototype.getPriority=k(0);Ge.prototype.ge=function(a){this.td.forEach(function(b,c){He(this.Ib,b,a[c])},this)};function Ie(a,b){this.c=a;this.Ib=a.b(Bc);this.Ia=a.b(Ac);this.gd=new Sc(a);this.ib=b;var c=a.b(Cc);a=this.ib.map(function(a){return c.table(a.getName())});this.aa=B(a);this.Db=fb()}m=Ie.prototype;m.exec=function(){this.gd.update(this.ib);this.Mc();return v()};m.G=k(1);m.da=g("aa");m.W=function(){return ka(this)};m.getPriority=k(1);m.Mc=function(){var a=Je(this.Ib,this.aa);0!=a.length&&(a=new Ge(this.c,a),Ke(this.Ia,a))};function Le(a){this.c=a;this.Oa=a.b(wc);this.Ia=a.b(Ac)}Le.prototype.ee=function(a){a=new Ie(this.c,a);Ke(this.Ia,a)};function L(a,b){this.Ua=a;this.i=b;this.Za=y()}q("lf.backstore.FirebaseRawBackStore",L);L.prototype.cd=g("i");L.prototype.dd=function(){throw new D(351);};function Me(a,b){var c=fb(),d=a;b.length&&(d=a.child(b));d.once("value",function(a){c.resolve(a.val())},function(a){c.reject(a)});return c.ha}function Ne(a,b,c){function d(a){a?e.reject(a):e.resolve()}c=c||!1;var e=fb();c?a.set(b,d):a.update(b,d);return e.ha}
L.prototype.Ea=function(a){return Me(this.i,"@rev/R").then(function(a){this.Sa=a;return Me(this.i,"@table")}.bind(this)).then(function(b){var c=0,d;for(d in b)this.Za.set(d,b[d]),b[d]>c&&(c=b[d]);a.oa().forEach(function(a){this.Za.has(a.getName())||(b[a.getName()]=++c)},this);d=this.i.child("@table");return Ne(d,b)}.bind(this))};
function Oe(a,b,c){var d=a.Za.get(b);return null!=d?function(){var a={},b=fb();this.i.orderByChild("T").equalTo(d).once("value",function(d){d.forEach(function(b){var d=c(b.val());a[parseInt(b.key(),10)]=d});b.resolve(a)});return b.ha}.call(a).then(function(a){a["@rev"]={R:++this.Sa};return Ne(this.i,a)}.bind(a)):v()}L.prototype.tc=function(a){return Oe(this,a,k(null)).then(function(){this.Za.delete(a);return Ne(this.i.child("@table/"+a),null,!0)}.bind(this))};L.prototype.dropTable=L.prototype.tc;
L.prototype.qc=function(a,b,c){return Oe(this,a,function(a){var d=a.P;d[b]=c;return{R:this.Sa+1,T:a.T,P:d}}.bind(this))};L.prototype.addTableColumn=L.prototype.qc;L.prototype.uc=function(a,b){return Oe(this,a,function(a){var c=a.P;delete c[b];return{R:this.Sa+1,T:a.T,P:c}}.bind(this))};L.prototype.dropTableColumn=L.prototype.uc;L.prototype.Lc=function(a,b,c){return Oe(this,a,function(a){var d=a.P;d[c]=d[b];delete d[b];return{R:this.Sa+1,T:a.T,P:d}}.bind(this))};L.prototype.renameTableColumn=L.prototype.Lc;
L.prototype.xb=function(){throw new D(351);};L.prototype.createRow=L.prototype.xb;L.prototype.Cc=g("Ua");L.prototype.getVersion=L.prototype.Cc;L.prototype.ec=function(a){var b=fb();a=this.Za.get(a);this.i.orderByChild("T").equalTo(a).once("value",function(a){var c=[];a.forEach(function(a){c.push(a.val().P)});b.resolve(c)});return b.ha};L.prototype.dump=function(){var a={},b=hc(this.Za).map(function(b){return this.ec(b).then(function(c){a[b]=c})}.bind(this));return eb(b).then(function(){return a})};
L.prototype.dump=L.prototype.dump;function Pe(a,b,c){oc.call(this,b,c);this.i=a}r(Pe,oc);Pe.prototype.I=function(a){return this.i.Ac(a)};
...
m.Ea=function(a){this.i=this.Df.child(this.g.name());var b=a||function(){return v()};return Me(this.i,"@db/version").then(function(a){return null===a?Ne(this.i,Xe(this),!0).then(function(){var a=new L(0,this.i);return b(a)}.bind(this)).then(function(){return this.Ea()}.bind(this)):a==this.g.version()?Me(this.i,"@rev/R").then(function(a){this.Sa=a;return Me(this.i,"@table")}.bind(this)).then(function(a){for(var b in a)this.Za.set(b,a[b]);a=this.g.oa().map(function(a){return Qe(this,a.getName())},this);
return eb(a)}.bind(this)).then(function(){Ye(this);Ze(this);return v()}.bind(this)):this.he(a,b).then(function(){return this.Ea()}.bind(this))}.bind(this))};m.he=function(a,b){var c=new L(a,this.i);return c.Ea(this.g).then(function(){return v()}.bind(this)).then(function(){return b(c)}).then(function(){var a=this.i.child("@db");return Ne(a,{version:this.g.version()},!0)}.bind(this))};
...
e.forEach(function(a){vf(d,"CREATE TABLE "+('"'+a+'"')+"(id INTEGER PRIMARY KEY, value TEXT)",[])});return d.ka()})}m.qe=function(){var a=0,b=fb(),c=function(b){var c=new wf(this.i,0);vf(c,"SELECT MAX(id) FROM "+('"'+b+'"'),[]);return c.ka().then(function(b){b=b[0].rows.item(0)["MAX(id)"];a=Math.max(b,a)})}.bind(this),d=this.g.oa().map(function(a){return c(a.getName())});eb(d).then(function(){jc=Math.max(jc,a+1);b.resolve()},function(a){b.reject(a)});return b.ha};function Ef(a){this.l=y();this.$b=y();a.oa().forEach(function(a){this.$b.set(a.getName(),B())},this)}m=Ef.prototype;m.set=function(a,b){this.l.set(b.id(),b);this.$b.get(a).add(b.id())};m.Wb=function(a,b){var c=this.$b.get(a);b.forEach(function(a){this.l.set(a.id(),a);c.add(a.id())},this)};m.get=function(a){return this.l.get(a)||null};function Ff(a,b){return b.map(function(a){return this.get(a)},a)}
...
m.Va=function(a,b,c){function d(a){return a[0]?a[1]?0:1:-1}var e=this.s.jb(),f=0,h=this.a.length-1,l=this.a,p=d(e.wb(l[f],a)),M=d(e.wb(l[h],a));if(1!=p&&(-1!=p||-1!=M)){var ta=function(a,b){b=a+b>>1;return b==a?b+1:b},da=function(b,c,f){if(b>=c)return 0==f?c:-1;var h=d(e.wb(l[b],a));if(0==h)return b;if(1==h)return-1;h=ta(b,c);if(h==c)return 0==f?c:-1;var p=d(e.wb(l[h],a));return 0==p?da(b,h,p):-1==p?da(h+1,c,f):da(b+1,h,p)},Db=function(b,c){if(b>=c)return b;var f=d(e.wb(l[c],a));if(0==f)return c;
if(-1==f)return b;f=ta(b,c);if(f==c)return b;var h=d(e.wb(l[f],a));return 0==h?Db(f,c):1==h?Db(b,f-1):-1};0!=p&&(f=da(f+1,h,M));-1!=f&&(h=Db(f,h),-1!=h&&h>=f&&hg(this,b,c,f,h+1))}};function Rf(a,b,c,d){if(a.s.Ma())!b.reverse&&b.L?b.L--:c[b.count++]=a.B[d];else for(var e=0;e<a.B[d].length&&b.count<c.length;++e)!b.reverse&&b.L?b.L--:c[b.count++]=a.B[d][e]}function hg(a,b,c,d,e){for(;d<e&&(b.reverse||!(b.count>=b.X));++d)Rf(a,b,c,d)}
...
function Bg(a,b,c){var d=a.C.lc.get(b.getName())||[];c.forEach(function(a){d.forEach(function(b){var c=a.nb(b.getName());b.add(c,a.id())})})}function zg(a,b){var c=a.Oa.Fb(0,[b]),d=c.I(b.getName(),b.kb,0).get([]).then(function(a){this.V.Wb(b.getName(),a)}.bind(a));a=b.Da().map(function(a){return Cg(this,a,c)},a).concat(Dg(a,b,c));c.ka();return eb(a.concat(d))}
...
function Wg(a,b,c,d){var e=[b,c];d||(e=Tg(a,b,c));b=e[0];c=e[1];var e=b,f=c,h=a.ga,l=a.ma;d&&(e=c,f=b,h=a.ma,l=a.ga);var p=new dd,M=[];e.entries.forEach(function(a){var b=String(H(a,h));p.set(b,a)});var ta=e.u(),da=f.u();f.entries.forEach(function(a){var b=H(a,l),c=String(b);null!==b&&p.has(c)?p.get(c).forEach(function(b){b=Wd(a,da,b,ta);M.push(b)}):d&&M.push(Vg(this,a,da))}.bind(a));a=b.u().concat(c.u());return new G(M,a)}
function Xg(a,b,c,d,e){function f(a,b){b=new Sd(b,1<ta.length);a=Wd(a,da,b,ta);M.push(a)}var h=d.dg.I(),l=b,p=c;-1!=b.u().indexOf(Ud(h))&&(l=c,p=b);var M=[],ta=p.u(),da=l.u();l.entries.forEach(function(a){var b=this.ng(H(a,d.wg)),b=d.index.get(b);0!=b.length&&(d.index.Ma()?f(a,e.get(b[0])):Ff(e,b).forEach(f.bind(null,a)))},a);a=l.u().concat(p.u());return new G(M,a)};function Yg(a,b,c){return null===b?new re(a,b,c):n(b.j)?new Sg(a,b,c):new re(a,b,c)};var Zg={};q("lf.schema.DataStoreType",Zg);Zg.INDEXED_DB=0;Zg.MEMORY=1;Zg.LOCAL_STORAGE=2;Zg.FIREBASE=3;Zg.WEB_SQL=4;Zg.OBSERVABLE_STORE=5;function $g(a,b,c,d){this.mc=a;this.name=b;this.Dc=c;this.f=d}$g.prototype.j=function(){return this.mc+"."+this.name};function Eg(a){return a.f.some(function(a){return a.ba.hc()})}function Q(a,b,c,d){this.A=a;this.ta=c;this.K=b;this.rd=d;this.Ka=null}q("lf.schema.Table",Q);Q.prototype.getName=g("A");Q.prototype.getName=Q.prototype.getName;
...
V.prototype.exec=function(a){Ik(this,4);var b=[];try{a.forEach(function(a){a.ab();b.push(a.Bc())},this)}catch(c){return Ik(this,7),bb(c)}this.Kb=new Nh(this.c,b);return Ke(this.Ia,this.Kb).then(function(a){Ik(this,7);return a.map(function(a){return Kd(a)})}.bind(this),function(a){Ik(this,7);throw a;}.bind(this))};V.prototype.exec=V.prototype.exec;V.prototype.Ff=function(a){Ik(this,1);this.Kb=new Ek(this.c,a);return Fk(this.Kb).then(function(){Ik(this,2)}.bind(this))};V.prototype.begin=V.prototype.Ff;
V.prototype.Ef=function(a){Ik(this,3);try{a.ab()}catch(b){return Ik(this,7),bb(b)}return Gk(this.Kb,a).then(function(a){Ik(this,2);return a}.bind(this),function(a){Ik(this,7);throw a;}.bind(this))};V.prototype.attach=V.prototype.Ef;V.prototype.ka=function(){Ik(this,5);return this.Kb.ka().then(function(){Ik(this,7)}.bind(this))};V.prototype.commit=V.prototype.ka;V.prototype.Jb=function(){Ik(this,6);return this.Kb.Jb().then(function(){Ik(this,7)}.bind(this))};V.prototype.rollback=V.prototype.Jb;
