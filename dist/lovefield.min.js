...
var Gc=new Sb(function(){return new Fc},function(a){a.reset()},100);function Hc(a,b,c){var d=Gc.get();d.Ib=a;d.ec=b;d.context=c;return d}function Dc(){}function Ic(a){return a instanceof O?a:new O(Dc,a)}function Jc(a){return new O(function(b,c){c(a)})}function Kc(a){return new O(function(b,c){var d=a[A],g=[];if(d)for(var k=function(a,c){d--;g[a]=c;0==d&&b(g)},l=function(a){c(a)},p=0,C;C=a[p];p++)Lc(C,Lb(k,p),l);else b(g)})}
function Mc(){var a,b,c=new O(function(c,g){a=c;b=g});return new Nc(c,a,b)}O[B].then=function(a,b,c){null!=a&&Rb(a,"opt_onFulfilled should be a function.");null!=b&&Rb(b,"opt_onRejected should be a function. Did you pass opt_context as the second argument instead of the third?");return this.Je(Fb(a)?a:null,Fb(b)?b:null,c)};O[B].then=O[B][D];O[B].$goog_Thenable=!0;J=O[B];
...
function Rc(a,b){this.ra=a;this.Kb=b||this.$e()}var Sc=0;J=Rc[B];J.id=I("ra");J.Lg=ub("ra");J.B=I("Kb");J.$e=function(){return{}};J.kg=I("Kb");J.Wa=function(){return{id:this.ra,value:this.kg()}};J.Dc=function(a){return"#"==a.substr(-1)?this.ra:null};function Tc(a){return new Rc(a.id,a[y])}function Uc(a){return new Rc(Sc++,a||{})}function Vc(a){if(null==a)return"";a=new Uint8Array(a);for(var b="",c=0;c<a[A];++c)var d=a[c][r](16),b=b+(2>d[A]?"0"+d:d);return b};
...
J.nh=function(a){return ud(a,this[u],this)};J.zh=function(a){var b=this[Ya]();b.Tf(a);return b};J.c=function(){return this.f.c()};qa(J,function(){return new Q(this)});J.uc=function(a){return this.Y()==sd(a)&&this.cj(a)};
...
function zd(a,b,c){this.O=a;this.Bb=b;this.Xf=c}J=zd[B];J.get=function(a){return 0==a[A]?this.Zd():this.yi(a)[D](L(function(b){return a.map(function(a){var d=b.get(a>>9);N(d,"Containing page is empty");return this.Bb(d.fd()[a])},this)},this))};J.yi=function(a){var b=new P,c=Mc();a=xd(a).map(function(a){return new O(function(c,k){var l;try{l=this.O.get(a)}catch(p){k(p);return}sa(l,k);ya(l,L(function(a){a=yd(a[mb][Sa]);b.set(a.ga(),a);c()},this))},this)},this);Kc(a)[D](function(){c[nb](b)});return c.ua};
J.Zd=function(){return new O(function(a,b){var c=[],d;try{d=this.O.openCursor()}catch(g){b(g);return}sa(d,b);ya(d,L(function(){var b=d[Sa];if(b){var g=yd(b[y]).fd(),p;for(p in g)c[w](this.Bb(g[p]));b.continue()}else a(c)},this))},this)};J.Lb=function(a){return new O(function(b,c){var d;try{d=a()}catch(g){c(g);return}ya(d,b);sa(d,c)},this)};
...
Dd[B].sg=function(a,b){a.Ca().map(function(a){return this.N.get(a.j())},this)[Ia]([this.N.get(a.Db())])[n](function(a){var d=null===b[1]?null:b[1].Dc(a[h]()),g=null===b[0]?null:b[0].Dc(a[h]());null===g&&null!==d?a.add(d,b[1].id()):null===g||null===d?null!==g&&null===d&&a[m](g,b[0].id()):0!=a.sc()[Ra](g,d)&&(a.add(d,b[1].id()),a[m](g,b[0].id()))})};
function R(a,b){wa(this,a);this.message=b};
function Ed(a){this.N=a.m(nd)}Ed[B].Xh=function(a,b){var c=a.bc().fe();return null===c?null:this.Wh(c,b)};Ed[B].Wh=function(a,b){var c=a.j(),d=b.Dc(c),c=this.N.get(c).get(d);return 0==c[A]?null:c[0]};Ed[B].Od=function(a,b){var c=a.bc().wi();b[n](function(a){c[n](function(b){if(null===a.B()[b[h]()])throw new R("ConstraintError","Attempted to insert NULL value to non-nullable field "+b.j());},this)},this)};
...
J.ri=function(){var a=[];this.Ja.c()[n](function(b){b.Mb()&&(b.Ca()[n](function(b){a[w](b.j())}),a[w](b[h]()+".#"))});return a};J.lb=function(a,b){this.oc();this.Rc(a);this.Vc.Od(a,b);for(var c=0;c<b[A];c++)this.nd(a,null,b[c])};
J.nd=function(a,b,c){var d=a[h](),g=this.xb.get(d,null)||new Fd(d);this.xb.set(d,g);var k=[b,c];try{this.ld.sg(a,k)}catch(l){throw this.ve=!0,l;}null===b&&null!==c?(this.la.set(d,[c]),g.add(c)):null!==b&&null!==c?(this.la.set(d,[c]),g.modify(k)):null!==b&&null===c&&(this.la[m](d,[b.id()]),g[jb](b))};za(J,function(a,b){this.oc();this.Rc(a);this.Vc.Od(a,b);for(var c=0;c<b[A];c++){var d=b[c],g=this.la.get([d.id()])[0];this.nd(a,g,d)}});
J.le=function(a,b){this.oc();this.Rc(a);this.Vc.Od(a,b);for(var c=0;c<b[A];c++){var d=b[c],g=null,k=this.Vc.Xh(a,d);null!=k&&(g=this.la.get([k])[0],d.Lg(k));this.nd(a,g,d)}};ja(J,function(a,b){this.oc();this.Rc(a);for(var c=0;c<b[A];c++)this.nd(a,b[c],null)});J.ba=function(){this.oc();this.Dd=!0};J.oc=function(){N(!this.ve,"Attemptted to use journal that needs to be rolled back.");N(!this.Dd,"Attemptted to commit a terminated journal.")};
...
J.reverse=function(){return new Id(this.o,this.g,this.ca,this.W)};J.Mf=function(a){var b=Jd(this.g,a.g,!0,this.W,a.W);if(0==b)return!0;var c=-1==b?this:a;a=1==b?this:a;return null===c.o||c.o>a.g||c.o==a.g&&!c.ca&&!a.W};function Kd(){return new Id(null,null,!1,!1)}J.contains=function(a){var b=null===this.o||a<this.o||a==this.o&&!this.ca;return(null===this.g||a>this.g||a==this.g&&!this.W)&&b};J.uc=function(a){return this.g==a.g&&this.W==a.W&&this.o==a.o&&this.ca==a.ca};
...
function Md(a,b){this.entries=a;this.I=new Q(b);this.yb=null}J=Md[B];J.$i=function(a){return this.I.uc(a.I)};function Nd(a,b){N(a.$i(b),"Intersection/union operations only apply to compatible relations.")}J.T=function(){return this.I.c()};J.ne=function(){return 1<this.I.Y()};J.de=function(){return this[E].map(function(a){return a.pa.B()})};J.Ei=function(){return this[E].map(function(a){return a.pa.id()})};J.Tj=function(a,b){null===this.yb&&(this.yb=new P);this.yb.set(a.j(),b)};
...
function je(){this.rc=this.na=null}je[B].gd=function(a){null===this.na&&null!=this.A&&(this.na=le(this.A));a=this.na.get(a,null);N(null!==a);return a};function le(a){var b=new P;a.jc(function(a){b.set(a.ga(),a)});return b}je[B].Sc=function(a){a.A&&(this.A=a.A.zb());this.rc=a};ma(je[B],function(){N(null==this.rc);return this});je[B].Md=function(a){var b=this.A;null!=b&&b.jc(function(b){b instanceof ie&&b[q](a)})};
...
ma(me[B],function(a){me.Xa[q][F](this,a);null!=this.Hb&&(this.ka=a[this.Hb.jb()]);null!=this.Rb&&(this.ja=a[this.Rb.jb()]);this.Md(a);return this});
...
function se(a,b){this.l=a;this.tb=a.m(qd);this.Ia=a.m(pd);this.ld=new Dd(a);this.xb=b;var c=a.m(rd),d=this.xb.map(function(a){return c[t](a[h]())});this.Ja=new Q(d);this.Ob=Mc()}J=se[B];ha(J,function(){this.ld[rb](this.xb);this.Jc();return Ic()});J.$=vb(1);J.Z=I("Ja");J.yc=I("Ob");J.ga=function(){return Gb(this)};ua(J,vb(1));J.Jc=function(){var a=this.tb.he(this.Ja.c());0!=a[A]&&(a=new re(this.l,a),this.Ia.Pb(a))};
function te(a){this.l=a;this.rb=a.m(ld);this.Ia=a.m(pd)}te[B].ak=function(){this.rb.subscribe(this.te[q](this))};te[B].te=function(a){a=new se(this.l,a);this.Ia.Pb(a)};

function ue(a,b,c){Yc[F](this,c,b);this.D=a}M(ue,Yc);ue[B].V=function(a){return this.D.zc(a)};
...
J.te=function(a){if(a.__revision__==this.hc)return Ic();var b=this.w.fb().map(function(b){b=b[h]();return this.bi(b,a[b])},this)[Ba](function(a){return!a.ya()});this.hc=a.__revision__;b[n](function(b){var d=new ve;this.xe(d,a[b[h]()]);this.I.set(b[h](),d)},this);b[A]&&this.Gc(b);return Ic()};
...
J.oh=function(){var a={};a.__version__=this.w[Ca]();a.__revision__=1;this.w.fb()[n](function(b){b=b[h]();a[b]={__meta__:""};this.I.set(b,new ve)},this);return a};J.Ab=function(a,b){return new ue(this,a,b)};J.zc=function(a){var b=this.I.get(a,null);if(null!==b)return b;throw new R("DataError","Table "+a+" not found");};J.Bi=I("D");pa(J,tb());va(J,ub("Nd"));J.Gc=function(a){null!=this.Nd&&this.Nd(a)};
...
J.sj=function(a,b){var c=b[mb][Sa],d=b[mb][$a],g=new xe(b.oldVersion,c,d,this.Pc);this.Lj(c,d);this.sh(c,d);return a(g)};J.Lj=function(a){for(var b=[],c=0;c<a[Ja][A];++c){var d=a[Ja][gb](c);-1!=d[z](".")&&b[w](d)}b[n](function(b){try{a.deleteObjectStore(b)}catch(c){}})};J.sh=function(a,b){this.w.fb()[n](Lb(this.ph,a,b),this)};J.ph=function(a,b,c){a[Ja][u](c[h]())||a.createObjectStore(c[h](),{keyPath:"id"});c.Mb()&&(c.Ca()[n](function(c){this.tc(a,b,c.j(),"btree")},this),this.tc(a,b,c.Db(),"rowid"))};
J.tc=function(a,b,c,d){a[Ja][u](c)||(a.createObjectStore(c,{keyPath:"id"}),a=b[hb](c),(this.Pc?new zd(a,Tc,Bd):new ze(a,Tc)).put([new Xc(new Wc(d))]))};J.Ab=function(a,b){var c=b.Z().c().map(function(a){return a[h]()});b.ri()[n](function(a){c[w](a)});var d=this.D[$a](c,0==a?"readonly":"readwrite");return new Ae(this.l,d,b,a,this.Pc)};
...
pa(J,function(){this.D[Xa]()});J.zc=function(){throw new R("SyntaxError","IndexedDB tables needs to be acquired from transactions");};va(J,tb());J.Gc=tb();



function Ce(a,b,c){Yc[F](this,c,b);this.O=a;0==b&&this.ia[nb]()}M(Ce,Yc);Ce[B].V=function(a){return this.O.zc(a)};Ce[B].ba=function(){Ce.Xa.ba[F](this);this.ia[nb]();return this.ia.ua};
function De(a){this.w=a;this.I=new P}J=De[B];J.Na=function(){this.w.fb()[n](this.Xi,this);return Ic()};J.zc=function(a){var b=this.I.get(a,null);if(null===b)throw new R("DataError","Table "+a+" does not exist.");return b};J.Ab=function(a,b){return new Ce(this,a,b)};J.Ye=function(a){if(!this.I.s(a)){var b=new ve;this.I.set(a,b);return b}return null};J.Xi=function(a){this.Ye(a[h]());a.Mb()&&(a.Ca()[n](function(a){this.tc(a.j(),"btree")},this),this.tc(a.Db(),"rowid"))};
J.tc=function(a,b){var c=this.Ye(a);null===c||c.put([new Xc(new Wc(b))])};pa(J,tb());va(J,tb());J.Gc=tb();
function Ee(a){De[F](this,a);this.rd=null}M(Ee,De);va(Ee[B],function(a){null===this.rd&&(this.rd=a)});Ee[B].Gc=function(a){null===this.rd||this.rd(a)};
...
Ge[B].ba=function(){Ge.Xa.ba[F](this);var a,b,c=this.ia[cb][q](this.ia),d=function(a,b){this.ia[cb](b)}[q](this),g=L(function(c,l){a=l;if(this.Qd[A]){var p=this.Qd[Fa]();b=p.transform;c.executeSql(p.bk,p.vj,g,d)}else p=a,null!=b&&null!=a&&(p=b(a)),this.ia[nb](p)},this);0==this.lg?this.D.readTransaction(g,c):this.D[$a](g,c);return this.ia.ua};
...
function Je(a,b,c){this.l=a;this.w=b;this.Yj=c||4194304}J=Je[B];J.ad=function(){return new Gd(this.l,[])};J.Na=function(a){if(null==aa.openDatabase)throw new R("NotSupportedError","WebSql not supported by platform.");var b=a||function(){return Ic()};return new O(L(function(a,d){try{var g=aa.openDatabase(this.w[kb](),"",this.w[kb](),this.Yj);if(null!=g)this.D=g,this.fh(b)[D](a,d);else throw new R("NotSupportedError","Unable to open database.");}catch(k){d(k)}},this))};
J.fh=function(a){var b=Mc(),c=new Ge(this.D,this.ad(),1);c.cb("CREATE TABLE IF NOT EXISTS __lf_ver(id INTEGER PRIMARY KEY, v INTEGER)",[]);c.cb("SELECT v FROM __lf_ver WHERE id = 0",[]);c.ba()[D](L(function(c){var g=0;c[bb][A]&&(g=c[bb][gb](0).v);g<this.w[Ca]()?this.tj(a,g)[D](b[nb][q](b)):g>this.w[Ca]()?b[cb](new R("DataError","Attempt to open a newer database with old code")):b[nb]()},this));return b.ua};
J.Ab=function(a,b){if(null!=this.D)return new Ge(this.D,b,a);throw new R("DataError","Attempt to create transaction from uninitialized DB");};pa(J,tb());J.zc=function(){throw new R("SyntaxError","WebSQL tables needs to be acquired from transactions");};J.Hf=function(){throw new R("NotSupportedError","WebSQL does not support change notification");};va(J,function(){this.Hf()});J.Gc=function(){this.Hf()};
J.tj=function(a,b){var c=Mc();this.zj()[D](L(function(){a(new He(this.l,b,this.D))[D](L(function(){return this.Be()},this))[D](c[nb][q](c))},this),c[cb][q](c));return c.ua};
...
function Ve(a,b){b&&(b.nb=a);a&&(a.ta=b)}function Ne(a,b){for(var c=b[A],d=0,g=Qe(a),k=g;0<c;){var l=768<=c?511:257<=c&&511>=c?c:257,p=b[x](d,d+l);g.b=p.map(function(a){return a.key});g.P=p.map(function(a){return a[y]});d+=l;c-=l;0<c&&(l=Qe(g.U),Ve(g,l),g=l)}return k}function We(a){var b=a[0],c=Qe(b.U);c.bb=b.bb+1;c.i=a;for(b=0;b<a[A];++b)a[b].F=c,0<b&&c.b[w](a[b].b[0]);return c}
function Oe(a){var b=a,c=[];do c[w](b),b=b.ta;while(b);if(512>=c[A])b=We(c);else{var d=c[A],g=0,b=Qe(a.U);for(b.bb=a.bb+2;0<d;){a=768<=d?511:257<=d&&511>=d?d:257;var k=c[x](g,g+a),l=We(k);l.F=b;b.i[A]&&(b.b[w](k[0].b[0]),Ve(b.i[b.i[A]-1],l));b.i[w](l);g+=a;d-=a}}return b}J.get=function(a){var b=this.Kc(a);if(this.aa()){var c=Pe;this.U.Fa(this.b[b],a)&&(c=c[Ia](this.P[b]));return c}b=this.U.Fa(this.b[b],a)?b+1:b;return this.i[b].get(a)};
J.s=function(a){var b=this.Kc(a);return this.U.Fa(this.b[b],a)?!0:this.aa()?!1:this.i[b].s(a)};ja(J,function(a,b){this.af(a,-1,b);if(this.xf()){var c=this;1==this.i[A]&&(c=this.i[0],c.F=null);return c}return this});function Xe(a){return a.aa()?a.b[0]:Xe(a.i[0])}J.Zc=function(){this.b=[];for(var a=1;a<this.i[A];++a)this.b[w](Xe(this.i[a]))};
J.af=function(a,b,c){var d=this.Kc(a);if(!this.aa()){var g=this.U.Fa(this.b[d],a)?d+1:d;if(this.i[g].af(a,g,c))this.Zc();else return!1}else if(!this.U.Fa(this.b[d],a))return!1;if(this.b[A]>d&&this.U.Fa(this.b[d],a)){if(xb(c)&&!this.U.Cc()&&this.aa()&&(a=this.P[d],c=fc(a,gc,!1,c),0<=c&&$b(a,c),this.P[d][A]))return!1;this.b[G](d,1);this.aa()&&this.P[G](d,1)}256>this.b[A]&&!this.xf()&&(this.ck()||this.mj(b));return!0};
...
J.lb=function(a,b,c){var d=this.Kc(a);if(this.aa()){if(this.U.Fa(this.b[d],a)){if(c)return this.P[d]=this.U.Cc()?b:[b],this;if(this.U.Cc())throw new R("ConstraintError","Duplicate key not allowed");if(this.P[d])return hc(this.P[d],b),this;this.P[d]=[b]}this.b[G](d,0,a);this.P[G](d,0,this.U.Cc()?b:[b]);return 512==this.b[A]?this.$j():this}d=this.U.Fa(this.b[d],a)?d+1:d;a=this.i[d].lb(a,b,c);a.aa()||1!=a.b[A]||(this.b[G](d,0,a.b[0]),a.i[1].F=this,a.i[0].F=this,this.i[G](d,1,a.i[1]),this.i[G](d,0,a.i[0]));
...
la(J,function(){this.Ra[Ma]();this.sa[Ma]()});J.s=function(a){return null===a?!this.Ra.ya():this.sa.s(a)};J.min=function(){return this.sa.min()};J.max=function(){return this.sa.max()};J.Wa=function(){return[new Rc(-2,this.Ra.c())][Ia](this.sa.Wa())};J.sc=function(){return this.sa.sc()};
...
J.Hj=function(a,b){var c=b.V(a.j(),Tc,1),d=Ye(a);return c.get([])[D](L(function(b){N("btree"==b[0].B().type);if(1<b[A]){if(a.pf()){var c=Re[q](void 0,d,a.j(),a.md),l=b[x](1),p=-1;for(b=0;b<l[A];++b)if(-2==l[b].id()){p=b;break}if(-1==p)throw new R("DataError","Data corruption detected");b=l[p].B();l=l[x](0);l[G](p,1);c=c(l);c=new ef(c);c.Ra[fb](b)}else c=Re(d,a.j(),a.md,b[x](1));this.N.set(c)}},this))};
...
J.uc=function(a){return this.Sa[A]==a.Sa[A]?0==this.Sa[A]||this.Sa[qb](function(b,c){return b.uc(a.Sa[c])}):!1};function nf(a,b){var c=[];a.c().map(function(a){return b.c().map(function(b){var c;if(a.Mf(b)){c=Kd();var l=Jd(a.g,b.g,!0),l=0==l?a.W?a:b:-1!=l?a:b;c.g=l.g;c.W=l.W;null===a.o||null===b.o?b=null===a.o?b:a:(l=Jd(a.o,b.o,!1),b=0==l?a.ca?a:b:-1==l?a:b);c.o=b.o;c.ca=b.ca}else c=null;return c})})[n](function(a){c=c[Ia](a)});return new mf(c[Ba](function(a){return null!==a}))};
function of(a,b){var c=[],d=null,g=null;a.jc(function(a){var l=b(a);null==a[Da]()?g=l:d.ea(l);var p=a[Da]();null!==p&&p.qa()==d.qa()&&(p=c[z](d),-1!=p&&c[G](p,1));1<a.qa()&&c[w](l);d=a.uf()?c[c[A]-1]:l});return g}function pf(a){return qf(a,function(a){return a.uf()})}function rf(a){var b=a[Da](),c=0;null!==b&&(c=b.X()[z](a),b[lb](a));var d=a.X()[x]();d[n](function(d,k){a[lb](d);null===b||b.lc(d,c+k)});return{parent:b,children:d}}
function sf(a,b){a.X()[x]()[n](function(c){a[lb](c);b.ea(c)});a.ea(b)}function tf(a){N(1==a.qa());var b=a.ib(0);N(1==b.qa());rf(a);sf(b,a);return b}function uf(a,b,c){N(1==a.qa());var d=a.ib(0);N(1<d.qa());var g=d.X()[x]();if(!g[ob](function(a){return b(a)}))return a;rf(a);g[n](function(g,l){if(b(g)){var p=c(a);d.zd(l);p.ea(g);d.lc(p,l)}});return d}function vf(a,b,c,d){var g=a[Da]();null!==g&&(a=g.X()[z](a),g.zd(a),g.lc(c,a));b.X()[x]()[n](function(a){b[lb](a);d.ea(a)});return c}
...
function xf(a){ge[F](this);this.Jb=a;this.Pa=!1}M(xf,ge);J=xf[B];J.zb=function(){return of(this,function(a){if(a instanceof xf){var b=new xf(a.Jb);b.Pa=a.Pa;b.De(a.ga());return b}return a.zb()}[q](this))};J.sb=function(a){var b=a||[];this.jc(function(a){a!=this&&a.sb(b)}[q](this));return(new Q(b)).c()};J.Cd=function(a){this.Pa!=a&&(this.Pa=a,this.Jb="and"==this.Jb?"or":"and",this.X()[n](function(b){return b.Cd(a)}))};J.eval=function(a){var b=this.X().map(function(b){return b.eval(a)});return this.ih(b)};
J.ih=function(a){return"and"==this.Jb?Qd(a):Rd(a)};f(J,function(){return"combined_pred_"+this.Jb[r]()});function yf(a,b){return a===b?0!==a||1/a===1/b:a!==a&&b!==b};function zf(){this[Ma]()}var Af=ba[B][Pa],Bf=ba[B][Wa];J=zf[B];J.set=function(a,b){this.Nc(a);var c=!this.Bc(a);this.f[a]=b;if("__proto__"==a||!Cf&&!Af[F](this.f,a)){delete this.f[a];var d=Ub(this.wb,a);if(c=0>d)d=this.wb[A];this.wb[d]=a;this.Ad[d]=b}c&&this.R++};J.get=function(a,b){this.Nc(a);if(this.Bc(a))return this.f[a];var c=Ub(this.wb,a);return 0<=c?this.Ad[c]:b};
ja(J,function(a){this.Nc(a);if(this.Bc(a))return this.R--,delete this.f[a],!0;a=Ub(this.wb,a);return 0<=a?(this.R--,$b(this.wb,a),$b(this.Ad,a),!0):!1});J.addAll=function(a){Vb(a.G(),function(b){this.set(b,a.get(b))},this)};J.ya=function(){return!this.R};J.Y=I("R");J.s=function(a){this.Nc(a);return this.Bc(a)||0<=Ub(this.wb,a)};J.Uc=function(a){return lc(this.f,function(b,c){return this.Bc(c)&&yf(b,a)},this)||0<=Ub(this.Ad,a)};
...
J.Gh=function(a,b){for(var c=[],d=a.T(),g=b.T(),k=0;k<a[E][A];k++)for(var l=0;l<b[E][A];l++)if(this.Yc(a[E][k].M(this.Ga),b[E][l].M(this.Ua))){var p=Vd(a[E][k],d,b[E][l],g);c[w](p)}d=a.T()[Ia](b.T());return new Md(c,d)};
J.Fh=function(a,b){var c=a,d=b,g=this.Ga,k=this.Ua;a[E][A]>b[E][A]&&(c=b,d=a,g=this.Ua,k=this.Ga);var l=new Ef,p=[];c[E][n](function(a){var b=String(a.M(g));l.add(b,a)});var C=c.T(),Ea=d.T();d[E][n](function(a){var b=String(a.M(k));l.s(b)&&l.get(b)[n](function(b){b=Vd(a,Ea,b,C);p[w](b)})});c=a.T()[Ia](b.T());return new Md(p,c)};
function Gf(a,b,c){return null===b?new ie(a,b,c):xb(b.j)?new Ff(a,b,c):new ie(a,b,c)};
var Hf={};K("lf.schema.DataStoreType",Hf,void 0);Hf.INDEXED_DB=0;Hf.MEMORY=1;Hf.LOCAL_STORAGE=2;Hf.FIREBASE=3;Hf.WEB_SQL=4;Hf.OBSERVABLE_STORE=5;function If(a,b,c,d){this.gg=a;wa(this,b);this.md=c;this.h=d}If[B].j=function(){return this.gg+"."+this[kb]};If[B].pf=function(){return this.h[ob](function(a){return a.Va.dc()})};function Jf(a,b,c,d){this.u=a;this.ma=c;this.H=b;this.td=d;this.Za=null}K("lf.schema.Table",Jf,void 0);ia(Jf[B],I("u"));Jf[B].La=I("Za");Jf[B].xa=function(){return this.Za||this.u};
Jf[B].nc=function(a){var b=new this.constructor(this.u);b.Za=a;return b};Jf[B].as=Jf[B].nc;Jf[B].createRow=Jf[B].Xc;Jf[B].deserializeRow=Jf[B].Yb;Jf[B].Ca=I("ma");Jf[B].sb=I("H");Jf[B].getConstraint=Jf[B].bc;Jf[B].Mb=I("td");Jf[B].Db=function(){return this.u+".#"};
function S(a,b){ra(this,a);this.Tb=b;this.Za=null}J=S[B];ia(J,function(){return this.Tb+"("+this[ab][h]()+")"});J.j=function(){return this.Tb+"("+this[ab].j()+")"};J.V=function(){return this[ab].V()};f(J,function(){return this.j()});J.$=function(){return this[ab].$()};J.La=I("Za");J.Ca=function(){return[]};J.dc=vb(!1);J.nc=function(a){this.Za=a;return this};K("lf.fn.AggregatedColumn.prototype.as",S[B].nc,void 0);S[B].ef=function(){for(var a=[this],b=this;b instanceof S;)a[w](b[ab]),b=b[ab];return a};
...
function T(a,b){ee[F](this,"","");this.Oh=b;this.If=a}M(T,ee);J=T[B];J.Z=vb(null);ha(J,function(a,b){switch(this.Oh){case 1:return this.Jh(a,b);case 0:return this.Ih(a,b);default:return this.Lh(a,b)}});f(J,vb("dummy_node"));J.Lc=function(){return this[r]()};J.Pe=function(a){N(-1==this.If||a[A]==this.If)};J.Lh=function(a,b){return new O(L(function(c){c(this.fa(a,[],b))},this))};J.Jh=function(a,b){return this.ib(0)[Ga](a,b)[D](L(function(c){this.Pe(c);return this.fa(a,c,b)},this))};
...
function kg(){T[F](this,2,0)}M(kg,T);f(kg[B],vb("cross_product"));kg[B].fa=function(a,b){for(var c=b[0],d=b[1],g=[],k=c.T(),l=d.T(),p=0;p<c[E][A];p++)for(var C=0;C<d[E][A];C++){var Ea=Vd(c[E][p],k,d[E][C],l);g[w](Ea)}c=c.T()[Ia](d.T());return[new Md(g,c)]};

function lg(a,b){qe[F](this,a,b);this.Ia=a.m(pd);this.tb=a.m(qd)}M(lg,qe);ua(lg[B],vb(2));lg[B].ue=function(a){0==this.$()?this.oj(a):this.Jc()};lg[B].oj=function(a){this.wd[n](function(b,c){b instanceof me&&this.tb.rg(b,a[c])},this)};lg[B].Jc=function(){var a=this.tb.he(this.Z().c());0!=a[A]&&(a=new re(this[Oa],a),this.Ia.Pb(a))};
function mg(){je[F](this)}M(mg,je);qa(mg[B],function(){var a=new mg;a.Sc(this);a.g=this.g;return a});ma(mg[B],function(a){mg.Xa[q][F](this,a);this.Md(a);return this});
function ng(){je[F](this)}M(ng,je);qa(ng[B],function(){var a=new ng;a.Sc(this);a.Oa=this.Oa;this[La]&&ka(a,this[La]instanceof Wd?this[La]:this[La][x]());a.mc=this.mc;a.Ub=this.Ub;return a});ma(ng[B],function(a){ng.Xa[q][F](this,a);this.Ub&&ka(this,this.Ub instanceof Wd?a[this.Ub.jb()]:this.Ub.map(function(b){return b instanceof Wd?a[b.jb()]:b}));return this});
function og(){je[F](this)}M(og,je);qa(og[B],function(){var a=new og;a.Sc(this);na(a,this[t]);a.set=this.set?this.set[x]():this.set;return a});ma(og[B],function(a){og.Xa[q][F](this,a);this.set[n](function(b){-1!=b.Oc&&ta(b,a[b.Oc])});this.Md(a);return this});
...
function V(a,b){this.global=a;this.Ej=a.m(od);this.Ia=a.m(pd);this.a=b}K("lf.query.BaseBuilder",V,void 0);ha(V[B],function(){try{this.$a()}catch(a){return Jc(a)}return new O(function(a,c){var d=new lg(this[Oa],[this.Ac()]);this.Ia.Pb(d)[D](function(c){a(c[0].de())},c)},this)});ha(V[B],V[B][Ga]);V[B].cf=function(){var a=L(function(a){return a.Lc(this.a)+"\n"},this);return wf(this.ee().Cb(),a)};V[B].explain=V[B].cf;ma(V[B],function(a){this.a[q](a);return this});ma(V[B],V[B][q]);
V[B].fk=function(a){return yg(this,a)};V[B].toSql=V[B].fk;J=V[B];J.$a=tb();J.kf=function(){return this.a[Ya]()};J.ed=I("a");J.ee=function(){null==this.Nf&&(this.Nf=this.Ej.zi(this.a));return this.Nf};J.Ac=function(){return{context:this.kf(),we:this.ee()}};J.xi=function(){return{context:this.ed(),we:this.ee()}};
...
J.vd=function(a,b){var c=a;if(this.Xj(a))c=tf(a),this.vd(a,b);else if(this.Wj(a)){var d=[],c=uf(a,b,function(a){a=new Yf(a.za);d[w](a);return a});d[n](function(a){this.vd(a,b)},this)}return c};J.Cj=function(a){var b=new Q([a.za.K.V().xa()]),c=function(a){return this.bf(a,b)}[q](this);return this.vd(a,c)};J.Bj=function(a){var b=new Q([a.za.Ga.V().xa(),a.za.Ua.V().xa()]),c=function(a){return this.bf(a,b)}[q](this);return this.vd(a,c)};
...
function Xg(a){T[F](this,1,1);this.ud=a}M(Xg,T);f(Xg[B],vb("select(?)"));Xg[B].Lc=function(a){a=a.gd(this.ud);return this[r]()[Ha]("?",a[r]())};Xg[B].fa=function(a,b,c){return[c.gd(this.ud).eval(b[0])]};
...
function eh(){T[F](this,1,1)}M(eh,T);f(eh[B],vb("limit(?)"));eh[B].Lc=function(a){return this[r]()[Ha]("?",a.ka[r]())};eh[B].fa=function(a,b,c){b[0][E][G](c.ka);return b};
function fh(a){T[F](this,-1,1);this.J=a}M(fh,T);J=fh[B];f(J,function(){return"order_by("+ne(this.J)+")"});J.fa=function(a,b){if(1==b[A]){var c=this.Vh(b[0]);(null===c?b[0]:b[0].ac(c))[E][pb](this.Bh[q](this))}else b[pb](this.Jj[q](this));return b};J.Vh=function(a){for(var b=null,c=0;c<this.J[A];c++){var d=Lf(this.J[c].K);if(a.Ri(d)){b=d;break}}return b};
...
function jh(){T[F](this,1,1)}M(jh,T);f(jh[B],vb("skip(?)"));jh[B].Lc=function(a){return this[r]()[Ha]("?",a.ja[r]())};jh[B].fa=function(a,b,c){return[new Md(b[0][E][x](c.ja),b[0].T())]};
...
function wh(){this.Qb=this.Ha=this.Ta=this.vc=null}wh[B].yd=function(a){this.vc==a&&(this.vc=null);this.Ta==a&&(this.Ta=null);null===this.Ha||this.Ha[m](a);null===this.Qb||this.Qb[m](a)};wh[B].Vg=function(a,b){var c=null===this.Ha||this.Ha.ya();return 0==b?(null===this.Qb||this.Qb.ya())&&c&&null===this.vc&&null!==this.Ta&&this.Ta==a:3==b?null===this.vc&&null===this.Ta&&null!==this.Ha&&this.Ha[u](a):1==b?null===this.Ta:c&&(null===this.Ta||this.Ta==a)};
wh[B].Li=function(a,b){0==b?(this.Ta=null,this.vc=a):3==b?(null===this.Qb&&(this.Qb=new Q),this.Qb.add(a),null===this.Ha&&(this.Ha=new Q),this.Ha[m](a)):1==b?(null===this.Ha&&(this.Ha=new Q),this.Ha.add(a)):2==b&&(this.Ta=a)};
function xh(){this.Nb=new yh;this.Ec=new vh}J=xh[B];J.Pb=function(a){(2>a[ib]()||2>a[ib]())&&this.Ec.hh(a.Z().c());this.Nb.lb(a);this.Sd();return a.yc().ua};J.Sd=function(){for(var a=this.Nb.c(),b=0;b<a[A];b++){var c=a[b],d=!1;if(d=0==c.$()?this.Vf(c,1,3):this.Vf(c,2,0))this.Nb[m](c),this.Nh(c)}};J.Vf=function(a,b,c){var d=!1,g=a.Z().c();this.Ec.Uf(a.ga(),g,b)&&(d=this.Ec.Uf(a.ga(),g,c));return d};J.Nh=function(a){a[Ga]()[D](L(this.rj,this,a),L(this.qj,this,a))};
J.rj=function(a,b){this.Ec.yd(a.ga(),a.Z().c());a.yc()[nb](b);this.Sd()};J.qj=function(a,b){this.Ec.yd(a.ga(),a.Z().c());a.yc()[cb](b);this.Sd()};function yh(){this.Nb=[]}yh[B].lb=function(a){hc(this.Nb,a,function(a,c){var d=a[ib]()-c[ib]();return 0==d?a.ga()-c.ga():d})};yh[B].c=function(){return this.Nb[x]()};ja(yh[B],function(a){var b=this.Nb;a=Ub(b,a);var c;(c=0<=a)&&$b(b,a);return c});
function zh(a,b){this.Dh=Zd.be();this.Ic=a;this.qd=b;this.H=this.vh()}zh[B].vh=function(){if(0<this.Ic.h[A])return this.Ic.h;var a=[],b=this.Ic.g[x]();null!=this.Ic.ke&&b[w](this.Ic.ke);b[n](function(b){b.sb()[n](function(b){a[w](b)})});return a};zh[B].L=function(a,b){return this.H[qb](function(c){return this.Dh.ae(c.$(),"eq")(a.M(c),b.M(c))},this)};
zh[B].Fg=function(a,b){for(var c=null===a?[]:a[E],d=Zc(c,b[E],L(this.L,this),function(a){return c[a]}),g=[],k=0,l=0;l<c[A];l++){var p=c[l];d[k]==p?k++:(p=this.qd[G](k,1),p=Ah(l,p,0,this.qd),g[w](p))}d=Zc(c,b[E],L(this.L,this),function(a,c){return b[E][c]});for(l=k=0;l<b[E][A];l++)p=b[E][l],d[k]==p?k++:(this.qd[G](l,0,p.pa.B()),p=Ah(l,[],1,this.qd),g[w](p));return g};function Ah(a,b,c,d){return{lk:c,index:a,object:d,qk:b,type:"splice"}};
...
J.he=function(a){var b=new Q;a[n](function(a){b.add(a[h]())});var c=[];this.Zb.c()[n](function(a){a=a.Ac();a[Aa].g[ob](function(a){return b[u](a[h]())})&&c[w](a)});return c};J.rg=function(a,b){var c=this.ge(null!=a.rc?a.rc:a),c=this.Zb.get(c,null);return null!==c?(c.jk(b),!0):!1};function Ch(a){this.Qg=a;this.Hc=new Q;this.pj=[];this.Cf=null;this.yh=new zh(a.ed(),this.pj)}J=Ch[B];J.Hd=function(a){this.Hc[u](a)?Qb("Attempted to register observer twice."):this.Hc.add(a)};J.ye=function(a){return this.Hc[m](a)};
J.Ac=function(){return this.Qg.xi()};J.Ui=function(){return 0<this.Hc.Y()};J.jk=function(a){var b=this.yh.Fg(this.Cf,a);this.Cf=a;0<b[A]&&this.Hc.c()[n](function(a){a(b)})};
function Dh(a,b){var c=a.m(rd),d=b||{},g=d.rk||0,k=new Ke;a.eb(md,k);var k=null,l=!1;switch(g){case 1:k=new De(c);break;case 5:k=new Ee(c);break;case 4:k=new Je(a,c,d.sk);break;case 3:k=new we(c,d.nk);l=!0;break;default:k=new Be(a,c)}a.eb(ld,k);var p=new jf;a.eb(nd,p);return k.Na(d.pk)[D](function(){a.eb(od,new uh(a));var b=new xh;a.eb(pd,b);b=new Bh;a.eb(qd,b);return p.Na(c)})[D](function(){l&&(new te(a)).ak();return(new hf(a)).Na(c)})};

function Eh(a,b){this.l=a;this.rb=a.m(ld);this.Ia=a.m(pd);this.tb=a.m(qd);this.Ja=new Q(b);this.Qa=new Gd(this.l,this.Ja.c());this.Ob=Mc();this.wc=Mc();this.He=Mc()}J=Eh[B];ha(J,function(){this.He[nb]();return this.wc.ua});J.$=vb(1);J.Z=I("Ja");J.yc=I("Ob");J.ga=function(){return Gb(this)};ua(J,vb(2));J.vg=function(){this.Ia.Pb(this);return this.He.ua};
J.Ng=function(a){a=a.Ac();return a.we.Cb()[Ga](this.Qa,a[Aa])[D](function(a){return a[0].de()},L(function(a){this.Qa.vb();var c=new Ec(a[kb]);this.wc[cb](c);throw a;},this))};J.ba=function(){this.rb.Ab(this.$(),this.Qa).ba()[D](L(function(){this.Jc();this.wc[nb]()},this),L(function(a){this.Qa.vb();this.wc[cb](a)},this));return this.Ob.ua};J.vb=function(){this.Qa.vb();this.wc[nb]();return this.Ob.ua};J.Jc=function(){var a=this.tb.he(this.Ja.c());0!=a[A]&&(a=new re(this.l,a),this.Ia.Pb(a))};
function Fh(a){this.l=a;this.Ia=a.m(pd);this.Mc=null;this.va=0}var Gh=new P(0,new Q([1,4]),1,new Q([2]),2,new Q([3,5,6]),3,new Q([2,7]),4,new Q([7]),5,new Q([7]),6,new Q([7]));Fh[B].Ea=function(a){var b=Gh.get(this.va,null);if(null===b||!b[u](a))throw new R("TransactionError","Invalid transaction state transition, from "+this.va+" to "+a+".");this.va=a};
ha(Fh[B],function(a){this.Ea(4);var b=[];try{a[n](function(a){a.$a();b[w](a.Ac())},this)}catch(c){return this.Ea(7),Jc(c)}a=new lg(this.l,b);return this.Ia.Pb(a)[D](L(function(a){this.Ea(7);return a.map(function(a){return a.de()})},this),L(function(a){this.Ea(7);throw a;},this))});K("lf.proc.Transaction.prototype.exec",Fh[B][Ga],void 0);Fh[B].Og=function(a){this.Ea(1);this.Mc=new Eh(this.l,a);return this.Mc.vg()[D](L(function(){this.Ea(2)},this))};
K("lf.proc.Transaction.prototype.begin",Fh[B].Og,void 0);Fh[B].Mg=function(a){this.Ea(3);return this.Mc.Ng(a)[D](L(function(a){this.Ea(2);return a},this),L(function(a){this.Ea(7);throw a;},this))};K("lf.proc.Transaction.prototype.attach",Fh[B].Mg,void 0);Fh[B].ba=function(){this.Ea(5);return this.Mc.ba()[D](L(function(){this.Ea(7)},this))};K("lf.proc.Transaction.prototype.commit",Fh[B].ba,void 0);Fh[B].vb=function(){this.Ea(6);return this.Mc.vb()[D](L(function(){this.Ea(7)},this))};
...
Y[B]["in"]=Y[B].Vi;Y[B].bj=function(){return this.Fa(null)};Y[B].isNull=Y[B].bj;Y[B].aj=function(){return this.Gf(null)};Y[B].isNotNull=Y[B].aj;Y[B].nc=function(a){return new Y(this.C,this.u,this.yf,this.vf,this.ng,a)};Y[B].as=Y[B].nc;
...
Z[B].mi=function(){function a(){function a(c){return b.ma.get(c).map(function(a){return{Va:this[a[kb]],mb:a.mb,autoIncrement:a[Ka]}},this)}var d=b.H.G().map(function(a){this[a]=new Y(this,a,b.qg[u](a),b.pd[u](a),b.H.get(a));return this[a]},this),g=b.ma.G().map(function(d){return new If(b.u,d,b.kc[u](d),a[F](this,d))},this);Jf[F](this,b.u,d,g,b.td);var k=b.ma.s(b.fc)?new If(b.u,b.fc,!0,a[F](this,b.fc)):null,l=d[Ba](function(a){return!b.pd[u](a[h]())}),p=b.kc.c().map(function(d){return new If(b.u,d,
!0,a[F](this,d))},this);this.lh=new Jh(k,l,[],p);this.Yf=b.ii(d,g)}var b=this;M(a,Jf);a[B].Xc=function(a){return new this.Yf(Sc++,a)};a[B].createRow=a[B].Xc;a[B].Yb=function(a){var b={};this.sb()[n](function(g){var k=g[h]();g=g.$();var l=a[y][k];if(0==g)if(null===l)g=l;else if(g=l,""==g)g=null;else{0!=g[A]%2&&(g="0"+g);for(var l=new ArrayBuffer(g[A]/2),p=new Uint8Array(l),C=0,Ea=0;C<g[A];C+=2)p[Ea++]=ga(g.substr(C,2),16);g=l}else g=2==g?null===l?l:new Date(l):l;b[k]=g},this);return new this.Yf(a.id,
...
b?null:b?1:0):b[a[h]()]?1:0}:function(b){return b[a[h]()]}},this),g=L(function(a){var b=a.map(function(a){return d(a.Va)});return function(a){return b.map(function(b){return b(a)})}},this),k={};b[n](function(a){var b=a.j();a=1==a.h[A]?d(a.h[0].Va):g(a.h);k[b]=a});c[B].Dc=function(a){return-1!=a[z]("#")?this.id():k[Wa](a)?k[a](this.B()):null};return c};
function Lh(a,b){this.w=new Mh(a,b);this.ic=new P;this.xc=!1}K("lf.schema.Builder",Lh,void 0);Lh[B].Uh=function(){this.xc||(this.ic.G()[n](function(a){a=this.ic.get(a);this.w.Vj(a.Eb())},this),this.ic[Ma](),this.xc=!0)};Lh[B].Eb=function(){this.xc||this.Uh();return this.w};Lh[B].getSchema=Lh[B].Eb;Lh[B].hf=function(){var a=new kd("ns_"+this.w[kb]()),b;Ih||(Ih=new Hh);b=Ih;var c=null;b.pe(a)?c=b.m(a):(c=new Hh,b.eb(a,c));return c};Lh[B].getGlobal=Lh[B].hf;
Lh[B].connect=function(a){var b=this.hf();b.pe(rd)||b.eb(rd,this.Eb());return(new X(b)).Na(a)};Lh[B].connect=Lh[B].connect;Lh[B].rh=function(a){if(this.ic.s(a)||this.xc)throw new R("SyntaxError","Table is already created or schema is already finalized.");this.ic.set(a,new Z(a));return this.ic.get(a)};Lh[B].createTable=Lh[B].rh;Lh[B].Ee=function(a){if(this.xc)throw new R("SyntaxError","Schema is already finalized.");this.w.Ee(a);return this};Lh[B].setPragma=Lh[B].Ee;
