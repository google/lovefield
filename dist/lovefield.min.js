...
lf.type={};lf.Type={ARRAY_BUFFER:0,BOOLEAN:1,DATE_TIME:2,INTEGER:3,NUMBER:4,STRING:5,OBJECT:6};goog.exportSymbol("lf.Type",lf.Type);lf.type.DEFAULT_VALUES={0:Object.freeze(new ArrayBuffer(0)),1:!1,2:Object.freeze(new Date(0)),3:0,4:0,5:"",6:Object.freeze({})};goog.exportSymbol("lf.type.DEFAULT_VALUES",lf.type.DEFAULT_VALUES);
...
lf.schema.TableBuilder=function(a){this.name_=a;this.columns_=new goog.structs.Map;this.uniqueColumns_=new goog.structs.Set;this.uniqueIndices_=new goog.structs.Set;this.nullable_=new goog.structs.Set;this.pkName_="pk"+lf.schema.TableBuilder.toPascal_(this.name_);this.indices_=new goog.structs.Map;this.persistIndex_=!1};lf.schema.TableBuilder.toPascal_=function(a){return a[0].toUpperCase()+a.substring(1)};lf.schema.TableBuilder.prototype.getSchema=function(){var a=this.generateTableClass_();return new a};
...
b.pkName_,!0,b.indices_.get(b.pkName_)):null,e=this.cols_.filter(function(a){return!b.nullable_.contains(a.getName())}),f=[],g=b.uniqueIndices_.getValues().map(function(a){return new lf.schema.Index(b.name_,a,!0,b.indices_.get(a))});this.constraint_=new lf.schema.Constraint(c,e,f,g);this.rowClass_=lf.schema.TableBuilder.generateRowClass_(this.cols_,a)};goog.inherits(c,lf.schema.Table);c.prototype.deserializeRow=function(a){var b={};this.cols_.forEach(function(c){var g=c.getName();c=c.getType();var h=
a.value[g];b[g]=c==lf.Type.ARRAY_BUFFER?goog.isNull(h)?h:lf.Row.hexToBin(h):c==lf.Type.DATE_TIME?goog.isNull(h)?h:new Date(h):h},this);return new this.rowClass_(a.id,b)};c.prototype.getConstraint=function(){return this.constraint_};return c};
lf.schema.TableBuilder.generateRowClass_=function(a,b){var c=function(c,e){this.columns_=a;this.indices_=b;lf.Row.call(this,c,e)};goog.inherits(c,lf.Row);c.prototype.defaultPayload=function(){var a={};this.columns_.forEach(function(b){a[b.getName()]=lf.type.DEFAULT_VALUES[b.getType()]});return a};c.prototype.toDbPayload=function(){var a={};this.columns_.forEach(function(b){var c=b.getName();b=b.getType();var g=this.payload()[c];a[c]=b==lf.Type.ARRAY_BUFFER?goog.isNull(g)?g:lf.Row.binToHex(g):b==lf.Type.DATE_TIME?
goog.isNull(g)?g:g.getTime():g},this);return a};c.prototype.keyOfIndex=function(a){return c.superClass_.keyOfIndex.call(this,a)};return c};
