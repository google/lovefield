...
m.remove=function(a,b){kd(this,a);nd(this,a,b);fd(this.xa,a,b,0);for(var c=0;c<b.length;c++)ld(this,a,[b[c],null])};function md(a,b,c){b=$c(a.i.info(),b.getName(),1);if(null!==b){var d=cd(a.xa,c,b);d.keys().forEach(function(a){d.get(a).forEach(function(b){var c=this.i.table(b.Pd.Fe),d=this.V.get(a),n=c.Fb(d.Ga());n.s[b.Pd.hb]=b.sg.s[b.Pd.mc];ld(this,c,[d,n])},this)},a)}}
...
Je(this);return w()}.bind(this)):this.fe(a,b).then(function(){return this.Ha()}.bind(this))}.bind(this))};m.fe=function(a,b){var c=new M(a,this.j);return c.Ha(this.i).then(function(){return w()}.bind(this)).then(function(){return b(c)}).then(function(){var a=this.j.child("@db");return xe(a,{version:this.i.version()},!0)}.bind(this))};
function Je(a){a.j.off();a.j.on("child_removed",a.pg.bind(a));a.Hd&&(a.Hd.off(),a.Lc.clear());a.Hd=a.j.orderByChild("R").startAt(a.Na+1);a.Hd.on("value",a.ce.bind(a))}function Ie(a){Xb=A(a.M).map(function(a){return Fe(a)}).reduce(function(a,c){return a>c?a:c},0)+1}m.pg=function(a){var b=a.val(),c=this.Lc.get(b.T)||null;null===c&&(c=C(),this.Lc.set(b.T,c));c.add(parseInt(a.key(),10))};
m.ce=function(a){var b=a.child("@rev/R").val();null!=b&&b!=this.Na&&(this.Na=b,a=Ke(this,a),a.forEach(function(a){var b=this.M.get(a.getName()),e=Vb(a.za);0<e.length&&Ee(b,e);var f=A(a.va);a.ma.forEach(function(a){f.push(a[1])});De(b,f)},this),0<a.length&&this.Ic(a),Je(this))};
...
function mf(a,b){var c=x(),d=new ef(a.j,1,new jd(a.h,C()));df(d,"CREATE TABLE IF NOT EXISTS __lf_ver(id INTEGER PRIMARY KEY, v INTEGER)",[]);df(d,"SELECT v FROM __lf_ver WHERE id = 0",[]);d.ia().then(function(a){var d=0;a[1].rows.length&&(d=a[1].rows.item(0).v);d<this.i.version()?this.fe(b,d).then(c.resolve.bind(c)):d>this.i.version()?c.reject(new E(108)):c.resolve()}.bind(a));return c.da}m.Db=function(a,b,c){if(null!=this.j)return new ef(this.j,a,c);throw new E(2);};m.close=aa();
m.Dc=function(){throw new E(512);};m.subscribe=function(){throw new E(355);};m.Ic=function(){throw new E(355);};m.fe=function(a,b){var c=x();nf(this).then(function(){a(new P(this.h,b,this.j)).then(function(){return this.oe()}.bind(this)).then(c.resolve.bind(c))}.bind(this),c.reject.bind(c));return c.da};
...
m.Zd=function(a,b){return null!=a?-1==this.W.compare(a,b):!1};m.Qa=function(a,b){return null!=a?0==this.W.compare(a,b):!1};m.Ga=function(){for(var a=[],b=Af(this.qa);b;)a.push(new Wb(b.oa,[b.b,b.B])),b=b.ta;return a};function Gf(a,b,c,d){a=new wf(b,a,c);d=Hf(d,a);a.qa=d;return a}function If(a,b){this.oa=a;this.D=b;this.kb=0;this.ta=this.nb=this.C=null;this.b=[];this.B=[];this.g=[]}function Df(a){return new If(Xb++,a)}function Q(a){return 0==a.kb}m=If.prototype;m.next=g("ta");
...
function Mf(a,b){for(var c=0,d=a.b.length;c<d;){var e=c+d>>1;a.D.Zd(a.b[e],b)?c=e+1:d=e}return c}function Bf(a,b){if(!Q(a)){var c=Mf(a,b);a.D.Qa(a.b[c],b)&&c++;return Bf(a.g[c],b)}return a}
...
function Hf(a,b){for(var c=b.Oa(),d=a.map(function(a){var d=new If(a.id(),b);d.b=a.s[0];d.B=a.s[1];d.b.forEach(function(a,e){c.add(a,b.Ja()?1:d.B[e].length)});return d}),e=0;e<d.length-1;++e)Kf(d[e],d[e+1]);return 1<d.length?yf(d[0]):d[0]};function Tf(a){this.Zc=0==a?Uf:Vf;this.ae=0==a?function(a){return null!=a?a.reverse():null}:function(a){return a||null};this.ge=0==a?Yf:Zf}t(Tf,Fc);function Vf(a,b){return a>b?1:a<b?-1:0}function Uf(a,b){return Vf(b,a)}function Zf(a,b){return vd(a,b)}function Yf(a,b){return vd(b,a)}m=Tf.prototype;m.ub=function(a,b){var c=this.ae(b),d=[c.c==F,c.A==F];if(!d[0]){var e=this.Zc(a,c.c);d[0]=c.ea?1==e:-1!=e}d[1]||(e=this.Zc(a,c.A),d[1]=c.la?-1==e:1!=e);return d};
m.compare=function(a,b){return this.Zc(a,b)};m.min=function(a,b){return a<b?1:a==b?0:-1};m.max=function(a,b){return a>b?1:a==b?0:-1};m.Qb=function(a,b){var c=this.ub(a,b);return c[0]&&c[1]};m.rf=function(a){return a.filter(function(a){return null!==a}).sort(function(a,c){return this.ge(a,c)}.bind(this))};m.Vd=function(a){return this.ae(a).c==F};m.td=function(a){a=this.ae(a);return[a.c,a.A]};m.Ld=function(a){return null!==a};m.toString=function(){return this.compare==Uf?"SimpleComparator_DESC":"SimpleComparator_ASC"};
...
U.prototype.bind=function(a){this.a.bind(a);return this};U.prototype.bind=U.prototype.bind;U.prototype.Eg=function(a){return Wh(this,a)};U.prototype.toSql=U.prototype.Eg;U.prototype.gb=aa();function Xh(a){if(null==a.df){var b;b=a.xg;var c=a.a,d=b.hg.create(c);b=b.ug.create(d,c);a.df=b}return a.df}U.prototype.Ec=function(){return{context:this.a.clone(),he:Xh(this)}};function Yh(a){U.call(this,a,new Ch(a.l(pc)))}t(Yh,U);r("lf.query.DeleteBuilder",Yh);Yh.prototype.c=function(a){if(null!=this.a.c)throw new E(515);this.a.c=a;return this};Yh.prototype.from=Yh.prototype.c;Yh.prototype.u=function(a){this.Cd();this.a.u=a;return this};Yh.prototype.where=Yh.prototype.u;Yh.prototype.Cd=function(){if(null==this.a.c)throw new E(548);if(null!=this.a.u)throw new E(516);};Yh.prototype.gb=function(){Yh.eb.gb.call(this);if(null==this.a.c)throw new E(517);};function Zh(a,b){U.call(this,a,new Fh(a.l(pc)));this.a.bc=b||!1}t(Zh,U);r("lf.query.InsertBuilder",Zh);Zh.prototype.gb=function(){Zh.eb.gb.call(this);var a=this.a;if(null==a.Ia||null==a.values)throw new E(518);if(a.bc&&null===a.Ia.Gb().dd())throw new E(519);};Zh.prototype.Ia=function(a){if(null!=this.a.Ia)throw new E(520);this.a.Ia=a;return this};Zh.prototype.into=Zh.prototype.Ia;
Zh.prototype.values=function(a){if(null!=this.a.values)throw new E(521);a instanceof Id||a.some(function(a){return a instanceof Id})?this.a.cc=a:this.a.values=a;return this};Zh.prototype.values=Zh.prototype.values;function $h(a){return ai("and",Array.prototype.slice.call(arguments))}r("lf.op.and",$h);r("lf.op.or",function(a){return ai("or",Array.prototype.slice.call(arguments))});function ai(a,b){var c=new Dg(a);b.forEach(function(a){Ud(c,a)});return c}r("lf.op.not",function(a){a.vd(!0);return a});function V(a,b){U.call(this,a,new ie(a.l(pc)));this.Le=this.xd=!1;this.a.f=b;bi(this);ci(this)}t(V,U);r("lf.query.SelectBuilder",V);V.prototype.gb=function(){V.eb.gb.call(this);var a=this.a;if(null==a.c)throw new E(522);if(q(a.Sb)&&!q(a.X)||q(a.$b)&&!q(a.L))throw new E(523);null!=this.a.ja?di(this):ei(this)};function bi(a){var b=a.a.f.filter(function(a){return a instanceof S&&"DISTINCT"==a.Lb},a);if(0!=b.length&&(1!=b.length||1!=a.a.f.length))throw new E(524);}
...
function ci(a){a.a.f.forEach(function(a){if(a instanceof S&&!fi(a.Lb,a.H()))throw new E(527,a.m());},a)}function gi(a,b){if(null==a.a.c)throw new E(b);}V.prototype.c=function(a){if(this.Le)throw new E(515);this.Le=!0;null==this.a.c&&(this.a.c=[]);this.a.c.push.apply(this.a.c,Array.prototype.slice.call(arguments));return this};V.prototype.from=V.prototype.c;V.prototype.u=function(a){gi(this,548);if(this.xd)throw new E(516);this.xd=!0;hi(this,a);return this};V.prototype.where=V.prototype.u;
...
Y.prototype.yf=function(a,b){mk(a);pk(this,a);var c=new lk(b,this.w,a);q(c.action)||(c.action=0);q(c.timing)||(c.timing=0);if(1==c.action&&1==c.timing)throw new E(506);if(!this.K.has(c.hb))throw new E(540,a);this.wb.push(c);this.ze(a,[c.hb],this.wd.has(c.hb));return this};Y.prototype.addForeignKey=Y.prototype.yf;Y.prototype.Af=function(a,b){mk(a);pk(this,a);var c=uk(this,b,!0);1==c.length&&(this.wd.add(c[0].name),vk(this,c[0].name));this.pa.set(a,c);this.pc.add(a);return this};
Y.prototype.addUnique=Y.prototype.Af;function vk(a,b){a.wb.forEach(function(a){a.hb==b&&this.pc.add(a.name.split(".")[1])},a)}Y.prototype.Ae=function(a){uk(this,a,!1).forEach(function(a){this.md.add(a.name)},this);return this};Y.prototype.addNullable=Y.prototype.Ae;Y.prototype.ze=function(a,b,c,d){mk(a);pk(this,a);b=uk(this,b,!0,d);c&&this.pc.add(a);this.pa.set(a,b);return this};Y.prototype.addIndex=Y.prototype.ze;Y.prototype.Bb=ba("qd");Y.prototype.persistentIndex=Y.prototype.Bb;
