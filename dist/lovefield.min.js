...
else if("function"==b&&"undefined"==typeof a.call)return"object";return b}function ha(a){return null!=a}function ia(a){var b=ga(a);return"array"==b||"object"==b&&"number"==typeof a.length}function ja(a){return"function"==ga(a)}function ka(a){return a[la]||(a[la]=++ma)}var la="closure_uid_"+(1E9*Math.random()>>>0),ma=0;function na(a,b,c){return a.call.apply(a.bind,arguments)}
...
function va(a,b){var c=0;a=ta(String(a)).split(".");b=ta(String(b)).split(".");for(var d=Math.max(a.length,b.length),e=0;0==c&&e<d;e++){var f=a[e]||"",h=b[e]||"";do{f=/(\d*)(\D*)(.*)/.exec(f)||["","","",""];h=/(\d*)(\D*)(.*)/.exec(h)||["","","",""];if(0==f[0].length&&0==h[0].length)break;c=wa(0==f[1].length?0:parseInt(f[1],10),0==h[1].length?0:parseInt(h[1],10))||wa(0==f[2].length,0==h[2].length)||wa(f[2],h[2]);f=f[3];h=h[3]}while(0==c)}return c}function wa(a,b){return a<b?-1:a>b?1:0};var xa=Array.prototype.indexOf?function(a,b,c){return Array.prototype.indexOf.call(a,b,c)}:function(a,b,c){c=null==c?0:0>c?Math.max(0,a.length+c):c;if(ea(a))return ea(b)&&1==b.length?a.indexOf(b,c):-1;for(;c<a.length;c++)if(c in a&&a[c]===b)return c;return-1},ya=Array.prototype.forEach?function(a,b,c){Array.prototype.forEach.call(a,b,c)}:function(a,b,c){for(var d=a.length,e=ea(a)?a.split(""):a,f=0;f<d;f++)f in e&&b.call(c,e[f],f,a)},za=Array.prototype.map?function(a,b,c){return Array.prototype.map.call(a,
b,c)}:function(a,b,c){for(var d=a.length,e=Array(d),f=ea(a)?a.split(""):a,h=0;h<d;h++)h in f&&(e[h]=b.call(c,f[h],h,a));return e},Aa=Array.prototype.reduce?function(a,b,c,d){d&&(b=pa(b,d));return Array.prototype.reduce.call(a,b,c)}:function(a,b,c,d){var e=c;ya(a,function(c,h){e=b.call(d,e,c,h,a)});return e},Ba=Array.prototype.some?function(a,b,c){return Array.prototype.some.call(a,b,c)}:function(a,b,c){for(var d=a.length,e=ea(a)?a.split(""):a,f=0;f<d;f++)if(f in e&&b.call(c,e[f],f,a))return!0;return!1};
function Ca(a,b,c){return 2>=arguments.length?Array.prototype.slice.call(a,b):Array.prototype.slice.call(a,b,c)}function Da(a){for(var b=[],c=0;c<a;c++)b[c]=0;return b}function Ea(a){for(var b=[],c=0;c<arguments.length;c++){var d=arguments[c];if("array"==ga(d))for(var e=0;e<d.length;e+=8192)for(var f=Ea.apply(null,Ca(d,e,e+8192)),h=0;h<f.length;h++)b.push(f[h]);else b.push(d)}return b};function Fa(a,b,c){this.pg=c;this.Of=a;this.Kg=b;this.qd=0;this.fd=null}Fa.prototype.get=function(){if(0<this.qd){this.qd--;var a=this.fd;this.fd=a.next;a.next=null}else a=this.Of();return a};Fa.prototype.put=function(a){this.Kg(a);this.qd<this.pg&&(this.qd++,a.next=this.fd,this.fd=a)};var Ga;a:{var Ha=da.navigator;if(Ha){var Ia=Ha.userAgent;if(Ia){Ga=Ia;break a}}Ga=""}function t(a){return ua(Ga,a)};function Ja(a){var b=[],c=0,d;for(d in a)b[c++]=a[d];return b};function Ka(){return t("Safari")&&!(La()||t("Coast")||t("Opera")||t("Edge")||t("Silk")||t("Android"))}function La(){return(t("Chrome")||t("CriOS"))&&!t("Edge")};function Ma(a){da.setTimeout(function(){throw a;},0)}var Oa;
...
Id.prototype.add=function(a){if(0!=a.length)if(a=this.kc.concat(a),1==a.length)this.kc=a;else{a.sort(Gd);for(var b=[],c=a[0],d=1;d<a.length;++d)if(Cd(c,a[d])){var e=c,f=a[d],h=Ed();e.from!=F&&f.from!=F&&(c=Dd(e.from,f.from,!0),1!=c?(h.from=e.from,h.ea=0!=c?e.ea:e.ea&&f.ea):(h.from=f.from,h.ea=f.ea));e.o!=F&&f.o!=F&&(c=Dd(e.o,f.o,!1),-1!=c?(h.o=e.o,h.na=0!=c?e.na:e.na&&f.na):(h.o=f.o,h.na=f.na));c=h}else b.push(c),c=a[d];b.push(c);this.kc=b}};
function Jd(a,b){var c=[];a.qa().map(function(a){return b.qa().map(function(b){if(Cd(a,b)){var c=Ed();var d=Dd(a.from,b.from,!0),d=0==d?a.ea?a:b:-1!=d?a:b;c.from=d.from;c.ea=d.ea;a.o==F||b.o==F?b=a.o==F?b:a:(d=Dd(a.o,b.o,!1),b=0==d?a.na?a:b:-1==d?a:b);c.o=b.o;c.na=b.na}else c=null;return c})}).forEach(function(a){c=c.concat(a)});return new Id(c.filter(function(a){return null!==a}))};function G(a,b){this.entries=a;this.M=B(b);this.$a=null}G.prototype.u=function(){return C(this.M)};function Kd(a){return a.entries.map(function(a){return a.va.m})}function Ld(a){return a.entries.map(function(a){return a.va.id()})}function Md(a,b){return a.$a.get(b.j())}var Nd=null;function Od(){null===Nd&&(Nd=new G([],[]));return Nd}
...
function se(a){var b=!1;a.value instanceof Xd||(b="array"==ga(a.value)?!a.value.some(function(a){return a instanceof Xd}):!0);if(!b)throw new D(501);}m.eval=function(a){se(this);if("in"==this.F)return te(this,a);var b=a.entries.filter(function(a){return this.vc(H(a,this.J),this.value)!=this.Wa},this);return new G(b,a.u())};
m.bind=function(a){if(this.cc instanceof Xd){var b=this.cc.Ca();if(a.length<=b)throw new D(510);this.value=a[b]}else"array"==ga(this.cc)&&(this.value=this.cc.map(function(b){if(b instanceof Xd){var c=b.Ca();if(a.length<=c)throw new D(510);return a[b.Ca()]}return b}))};function te(a,b){var c=B(a.value),d=function(a){return null===a?!1:c.has(a)!=this.Wa}.bind(a);a=b.entries.filter(function(a){return d(H(a,this.J))},a);return new G(a,b.u())}
...
N.prototype.qc=function(a,b,c){var d=bf(c);return cf(this,a,function(a){a.m[b]=d})};N.prototype.addTableColumn=N.prototype.qc;N.prototype.uc=function(a,b){return cf(this,a,function(a){delete a.m[b]})};N.prototype.dropTableColumn=N.prototype.uc;N.prototype.Lc=function(a,b,c){return cf(this,a,function(a){a.m[c]=a.m[b];delete a.m[b]})};N.prototype.renameTableColumn=N.prototype.Lc;
function df(a,b){var c=[];return new u(function(a,e){try{var d=this.ja.objectStore(b).openCursor()}catch(h){e(h);return}d.onsuccess=function(){var b=d.result;if(b){if(this.Uc){var e=Nc(b.value).m,f;for(f in e)c.push(e[f])}else c.push(b.value);b.continue()}else a(c)}.bind(this);d.onerror=e},a)}N.prototype.xb=function(a){var b={},c;for(c in a)b[c]=bf(a[c]);return lc(b)};N.prototype.createRow=N.prototype.xb;N.prototype.Cc=g("Ua");N.prototype.getVersion=N.prototype.Cc;
N.prototype.dump=function(){for(var a=this.i.objectStoreNames,b=[],c=0;c<a.length;++c){var d=a.item(c);b.push(this.ec(d))}return fb(b).then(function(b){var c={};b.forEach(function(b,d){c[a.item(d)]=b});return c})};N.prototype.dump=N.prototype.dump;N.prototype.ec=function(a){return df(this,a).then(function(a){return a.map(function(a){return a.value})})};function ef(a,b){this.Z=a;this.Gb=b}ef.prototype.get=function(a){if(0==a.length)return null!=this.Z.getAll?ff(this):gf(this);a=a.map(function(a){return new u(function(b,d){try{var c=this.Z.get(a)}catch(f){d(f);return}c.onerror=d;c.onsuccess=function(a){b(this.Gb(a.target.result))}.bind(this)},this)},this);return fb(a)};
...
function fg(a,b){var c;if(a.ya&&511>a.ya.a.length){var d=a.ya;var e=c=0}else a.qb&&(d=a.qb,c=d.a.length,e=P(d)?d.B.length:d.h.length);c=[c,0].concat(a.a);Array.prototype.splice.apply(d.a,c);c=null;P(a)?c=a.B:(c=a.h,c.forEach(function(a){a.D=d}));c=[e,0].concat(c);Array.prototype.splice.apply(P(d)?d.B:d.h,c);Zf(a.qb,a.ya);P(d)||dg(d);-1!=b&&(a.D.a.splice(b,1),a.D.h.splice(b,1))}
...
m.uf=function(a){var b=a.filter(function(a){return a.every(ha)});a=Array(this.pa.length);for(var c=0;c<a.length;c++)a[c]=b.map(function(a){return a[c]});a.forEach(function(a,b){a.sort(function(a,c){return this.pa[b].ie(a,c)}.bind(this))},this);b=Array(b.length);for(c=0;c<b.length;c++)b[c]=a.map(function(a){return a[c]});return b.sort(function(a,b){for(var c=0,d=0;d<this.pa.length&&0==c;++d)c=this.pa[d].ie(a[d],b[d]);return c}.bind(this))};m.Xd=function(a){return this.pa[0].Xd(a[0])};
...
function uj(a,b){S.call(this,0,-1);this.C=a.b(yc);this.U=b}r(uj,S);uj.prototype.toString=function(){return"insert_replace("+this.U.getName()+")"};uj.prototype.ca=function(a,b,c){tj(this.U,c.values,this.C);b.Wd(this.U,c.values);return[Rd(c.values,[this.U.getName()])]};function vj(){S.call(this,0,1)}r(vj,S);vj.prototype.toString=k("limit(?)");vj.prototype.Pc=function(a){return this.toString().replace("?",a.X.toString())};vj.prototype.ca=function(a,b,c){a[0].entries.splice(c.X);return a};function wj(a){S.call(this,0,1);this.N=a}r(wj,S);m=wj.prototype;m.toString=function(){return"order_by("+Be(this.N)+")"};m.ca=function(a){if(1==a.length){var b=a[0];for(var c=null,d=0;d<this.N.length;d++){var e=dh(this.N[d].J);if(null!==b.$a&&b.$a.has(e.j())){c=e;break}}b=c;(null===b?a[0]:Md(a[0],b)).entries.sort(this.Tf.bind(this))}else a.sort(this.Jg.bind(this));return a};
...
m.exec=function(){if(!(this.Oa instanceof jf||this.Oa instanceof rf||this.Oa instanceof Bf))throw new D(300);a:{var a=this.g.oa();for(var b=0;b<a.length;++b)if(0<this.C.get(of(a[b])).Y().ia){a=!1;break a}a=!0}if(!a)throw new D(110);if(this.g.name()!=this.Ba.name||this.g.version()!=this.Ba.version)throw new D(111);if(null==this.Ba.tables)throw new D(112);return Dk(this)};m.G=k(1);m.da=g("aa");m.W=function(){return ka(this)};m.getPriority=k(0);
