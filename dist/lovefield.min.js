...
v.prototype.then=function(a,b,c){return ib(this,ja(a)?a:null,ja(b)?b:null,c)};v.prototype.then=v.prototype.then;v.prototype.$goog_Thenable=!0;v.prototype.ue=function(a,b){return ib(this,null,a,b)};function jb(a,b){a.ec||2!=a.Ua&&3!=a.Ua||kb(a);a.ad?a.ad.next=b:a.ec=b;a.ad=b}
function ib(a,b,c,d){var e=cb(null,null,null);e.child=new v(function(a,h){e.Nc=b?function(c){try{var e=b.call(d,c);a(e)}catch(A){h(A)}}:a;e.lc=c?function(b){try{var e=c.call(d,b);!q(e)&&b instanceof lb?h(b):a(e)}catch(A){h(A)}}:h});e.child.C=a;jb(a,e);return e.child}v.prototype.Gg=function(a){this.Ua=0;Za(this,2,a)};v.prototype.Hg=function(a){this.Ua=0;Za(this,3,a)};
...
function nb(a,b,c,d,e){function f(a){k||(k=!0,d.call(e,a))}function h(a){k||(k=!0,c.call(e,a))}var k=!1;try{b.call(a,h,f)}catch(n){f(n)}}function kb(a){a.Pd||(a.Pd=!0,Ta(a.Rf,a))}function ob(a){var b=null;a.ec&&(b=a.ec,a.ec=b.next,b.next=null);a.ec||(a.ad=null);return b}
v.prototype.Rf=function(){for(var a=null;a=ob(this);){var b=this.Ua,c=this.lf;if(3==b&&a.lc&&!a.Ed)for(var d=void 0,d=this;d&&d.md;d=d.C)d.md=!1;if(a.child)a.child.C=null,pb(a,b,c);else try{a.Ed?a.Nc.call(a.context):pb(a,b,c)}catch(e){qb.call(null,e)}bb.put(a)}this.Pd=!1};function pb(a,b,c){2==b?a.Nc.call(a.context,c):a.lc&&a.lc.call(a.context,c)}function mb(a,b){a.md=!0;Ta(function(){a.md&&qb.call(null,b)})}var qb=Na;function lb(a){ra.call(this,a)}t(lb,ra);lb.prototype.name="cancel";
...
m.delete=function(a,b){var c=this.o.get(a,null);if(null===c)return!1;var d=c.delete(b);d&&(--this.size,0==c.size&&this.o.delete(a));return d};m.get=function(a){a=this.o.get(a)||null;return null===a?null:E(a)};m.clear=function(){this.o.clear();this.size=0};m.keys=function(){return cc(this.o)};m.values=function(){var a=[];this.o.forEach(function(b){a.push.apply(a,E(b))});return a};function Wc(a){this.F=a.j(oc);this.i=a.j(sc);this.V=a.j(nc);this.fd=null}function Xc(a,b,c){var d=b.Fb().og;c.forEach(function(a){d.forEach(function(b){if(null==a.s[b.getName()])throw new F(202,b.m());},this)},a)}function Yc(a,b,c,d){b.Fb().Sd().forEach(function(a){a.timing==d&&Zc(this,a,c)},a)}function Zc(a,b,c){var d=$c(a,b);c.forEach(function(a){if(ad(a[0],a[1],b.name)&&(a=a[1].s[b.hb],null!==a&&!d.Ma(a)))throw new F(203,b.name);},a)}
function $c(a,b){null===a.fd&&(a.fd=B());var c=a.fd.get(b.name)||null;null===c&&(c=a.i.table(b.Sa)[b.mc].za(),c=a.F.get(c.m()),a.fd.set(b.name,c));return c}function ad(a,b,c){return(null===a?null!==b:null===b)||a.Gb(c)!=b.Gb(c)}function bd(a,b,c,d){b=cd(a.i.info(),b.getName(),0);null!==b&&(b=b.filter(function(a){return a.timing==d}),0!=b.length&&dd(a,b,c,function(a,b,c){if(b.Ma(c))throw new F(203,a.name);}))}
...
m.delete=function(a){if(this.ua.has(a.id()))this.ua.delete(a.id());else if(this.na.has(a.id())){var b=this.na.get(a.id())[0];this.na.delete(a.id());this.ya.set(a.id(),b)}else this.ya.set(a.id(),a)};m.ae=function(a){a.ua.forEach(function(a){this.add(a)},this);a.na.forEach(function(a){this.modify(a)},this);a.ya.forEach(function(a){this.delete(a)},this)};
function Mc(a){var b=[];a.ua.forEach(function(a){b.push([null,a])});a.na.forEach(function(a){b.push(a)});a.ya.forEach(function(a){b.push([a,null])});return b}m.toString=function(){return"["+cc(this.ua).toString()+"], ["+cc(this.na).toString()+"], ["+cc(this.ya).toString()+"]"};function ld(a){var b=new kd(a.w);a.ua.forEach(function(a){b.delete(a)});a.ya.forEach(function(a){b.add(a)});a.na.forEach(function(a){b.modify([a[1],a[0]])});return b}
m.pd=function(){return 0==this.ua.size&&0==this.ya.size&&0==this.na.size};function md(a,b){this.$=B();b.forEach(function(a){this.$.set(a.getName(),a)},this);this.i=a.j(sc);this.V=a.j(nc);this.F=a.j(oc);this.wa=new Wc(a);this.od=new Jc(a);this.tb=B()}function kc(a){var b=[];cc(a.tb).map(function(a){return this.$.get(a)},a).forEach(function(a){a.Bb()&&(a.Aa().forEach(function(a){b.push(this.F.get(a.m()))},this),b.push(this.F.get(a.getName()+".#")))},a);return b}m=md.prototype;m.ca=g("$");
m.zb=function(a,b){nd(this,a);Xc(this.wa,a,b);gd(this.wa,a,b,0);for(var c=0;c<b.length;c++)od(this,a,[null,b[c]])};function od(a,b,c){var d=b.getName(),e=a.tb.get(d)||new kd(d);a.tb.set(d,e);try{Nc(a.od,b,c)}catch(h){throw h;}b=c[0];var f=c[1];null===b&&null!==f?(a.V.set(d,f),e.add(f)):null!==b&&null!==f?(a.V.set(d,f),e.modify(c)):null!==b&&null===f&&(a.V.remove(d,b.id()),e.delete(b))}
m.update=function(a,b){nd(this,a);Xc(this.wa,a,b);var c=b.map(function(a){return[this.V.get(a.id()),a]},this);pd(this,a,c);hd(this.wa,a,c,0);c.forEach(function(b){od(this,a,b)},this)};m.Vd=function(a,b){nd(this,a);Xc(this.wa,a,b);for(var c=0;c<b.length;c++){var d=b[c],e=null,f,h=a.Fb().jd();if(null===h)f=null;else{f=this.wa;var h=h.m(),k=d.Gb(h);f=f.F.get(h).get(k);f=0==f.length?null:f[0]}null!=f?(e=this.V.get(f),d.pa=f,hd(this.wa,a,[[e,d]],0)):gd(this.wa,a,[d],0);od(this,a,[e,d])}};
...
function Yd(a,b){var c=a.g&&a.g[b];return c?(c.C=null,a.g.splice(b,1),0==a.g.length&&(a.g=null),c):null}L.prototype.removeChild=function(a){return Yd(this,M(this).indexOf(a))};function Zd(a,b,c){Vd(a,c).C=null;b.C=a;a.g[c]=b}function $d(a,b,c){!1!==b.call(c,a)&&M(a).forEach(function(a){$d(a,b,c)})};function ae(){L.call(this);this.pa=be++}t(ae,L);var be=0;ae.prototype.X=g("pa");function ce(a,b,c){ae.call(this);this.O=a;this.value=b;this.G=c;this.yc=Sd(Md.Ec(),this.O.I(),this.G);this.ab=!1;this.dc=b}t(ce,ae);m=ce.prototype;m.Lb=function(){var a=new ce(this.O,this.value,this.G);a.dc=this.dc;a.yd(this.ab);var b=this.X();a.pa=b;return a};m.ib=function(a){return null!=a?(a.push(this.O),a):[this.O]};m.yd=ba("ab");function de(a){var b=!1;a.value instanceof Ld||(b="array"==ea(a.value)?!a.value.some(function(a){return a instanceof Ld}):!0);if(!b)throw new F(501);}
...
N.prototype.sc=function(a,b,c){return Be(this,a,function(a){var e=a.P;e[b]=c;return{R:this.Na+1,T:a.T,P:e}}.bind(this))};N.prototype.addTableColumn=N.prototype.sc;N.prototype.xc=function(a,b){return Be(this,a,function(a){var d=a.P;delete d[b];return{R:this.Na+1,T:a.T,P:d}}.bind(this))};N.prototype.dropTableColumn=N.prototype.xc;N.prototype.Pc=function(a,b,c){return Be(this,a,function(a){var e=a.P;e[c]=e[b];delete e[b];return{R:this.Na+1,T:a.T,P:e}}.bind(this))};N.prototype.renameTableColumn=N.prototype.Pc;
...
Ee.prototype.remove=function(a){He(this,a);return w()};function Ie(a){return 0==a.xa.size?0:cc(a.xa).reduce(function(a,c){return a>c?a:c},0)};function Je(a,b){this.i=a;this.Cf=b;this.Oc=B();this.Na=-1;this.M=B();this.Va=B();this.Id=null}m=Je.prototype;
...
function Me(a){a.l.off();a.l.on("child_removed",a.qg.bind(a));a.Jd&&(a.Jd.off(),a.Oc.clear());a.Jd=a.l.orderByChild("R").startAt(a.Na+1);a.Jd.on("value",a.de.bind(a))}function Le(a){rb=C(a.M).map(function(a){return Ie(a)}).reduce(function(a,c){return a>c?a:c},0)+1}m.qg=function(a){var b=a.val(),c=this.Oc.get(b.T)||null;null===c&&(c=D(),this.Oc.set(b.T,c));c.add(parseInt(a.key(),10))};
m.de=function(a){var b=a.child("@rev/R").val();null!=b&&b!=this.Na&&(this.Na=b,a=Ne(this,a),a.forEach(function(a){var b=this.M.get(a.getName()),e=cc(a.ya);0<e.length&&He(b,e);var f=C(a.ua);a.na.forEach(function(a){f.push(a[1])});Ge(b,f)},this),0<a.length&&this.Kc(a),Me(this))};
function Ne(a,b){var c=D(),d=B();a.Va.forEach(function(a,b){var h=this.M.get(b),k=new kd(b);if(this.Oc.has(a)){var n=E(this.Oc.get(a));n.forEach(function(a){c.add(a)});Fe(h,n).forEach(function(a){k.delete(a)})}d.set(a,k)}.bind(a));b.forEach(function(a){if("@rev"!=a.key()){var b=parseInt(a.key(),10);if(!c.has(b)){a=a.val();var h=d.get(a.T),k=this.M.get(h.getName());k.getData().has(b)?h.modify([Fe(k,[b])[0],new y(b,a.P)]):h.add(new y(b,a.P))}}}.bind(a));return C(d).filter(function(a){return!a.pd()})}
...
function Qe(a,b,c){function d(a){var b=Dc(a.value),d=b.s,e;for(e in d){var A=tb(d[e]);c(A);d[e]=A.Ga()}a.update(b.Ga())}function e(a){var b=tb(a.value);c(b);a.update(b.Ga())}return Oe(a,b,a.Zc?d:e,aa())}P.prototype.sc=function(a,b,c){var d=Pe(c);return Qe(this,a,function(a){a.s[b]=d})};P.prototype.addTableColumn=P.prototype.sc;P.prototype.xc=function(a,b){return Qe(this,a,function(a){delete a.s[b]})};P.prototype.dropTableColumn=P.prototype.xc;
P.prototype.Pc=function(a,b,c){return Qe(this,a,function(a){a.s[c]=a.s[b];delete a.s[b]})};P.prototype.renameTableColumn=P.prototype.Pc;function Re(a,b){var c=[];return new v(function(a,e){var f;try{f=this.Xa.objectStore(b).openCursor()}catch(h){e(h);return}f.onsuccess=function(){var b=f.result;if(b){if(this.Zc){var e;e=Dc(b.value).s;for(var n in e)c.push(e[n])}else c.push(b.value);b.continue()}else a(c)}.bind(this);f.onerror=e},a)}P.prototype.vb=function(a){var b={},c;for(c in a)b[c]=Pe(a[c]);return ub(b)};
...
m.remove=function(a){return new v(function(b,c){var d=this.ba.count();d.onsuccess=function(d){if(0==a.length||d.target.result==a.length)return this.Ub(function(){return this.ba.clear()}.bind(this)).then(b,c);d=a.map(function(a){return this.Ub(function(){return this.ba.delete(a)}.bind(this))},this);gb(d).then(b,c)}.bind(this);d.onerror=c},this)};function Te(a,b,c,d,e){ec.call(this,c,e);this.h=a;this.Xa=b;this.Zc=d;this.Xa.oncomplete=this.Y.resolve.bind(this.Y);this.Xa.onabort=this.Y.reject.bind(this.Y)}t(Te,ec);Te.prototype.H=function(a,b,c){return this.Zc?(c=null!=c?c:0,a=this.Xa.objectStore(a),new Ec(a,b,0==c?qa(Gc,this.h):Hc)):new Se(this.Xa.objectStore(a),b)};Te.prototype.uc=function(){return this.Y.ha};function Ue(a,b){this.h=a;this.i=b;this.$c=b.ff().Of||!1}m=Ue.prototype;
...
m.wd=function(a){var b=a.map(function(a,b){return this.va[b].wd(a)[0]},this);a=a.map(function(a,b){return this.va[b].wd(a)[1]},this);return[b,a]};m.cd=function(a){return a.every(function(a,c){return this.va[c].cd(a)},this)};function Ef(a){Cf.call(this,a);this.va=a.map(function(a){return new zf(a)})}t(Ef,Cf);function Ff(){this.oa=0}Ff.prototype.add=function(a,b){this.oa+=b};Ff.prototype.remove=function(a,b){this.oa-=b};Ff.prototype.clear=function(){this.oa=0};function Gf(a,b){a.clear();b.forEach(function(a){this.oa+=a.oa},a)};function Hf(a,b,c,d){this.w=a;this.S=b;this.xf=c;this.rb=new Ff;if(d){a=511;a*=a*a;if(d.length>=a)throw new F(6,a);d=If(this,d);this.qa=d=Jf(d)}else this.clear()}var Kf=[];m=Hf.prototype;m.getName=g("w");m.toString=function(){return this.qa.toString()};m.add=function(a,b){this.qa=this.qa.zb(a,b)};m.set=function(a,b){this.qa=this.qa.zb(a,b,!0)};m.remove=function(a,b){this.qa=this.qa.remove(a,b)};m.get=function(a){return this.qa.get(a)};
m.ed=function(a){if(null==a)return this.Oa().oa;if(a instanceof rd){if(td(a))return this.Oa().oa;if(xd(a))return this.get(a.c).length}return this.$a([a]).length};m.Oa=g("rb");m.Cc=function(a,b,c,d){c=Array(a);this.qa.fill({offset:b?this.rb.oa-a-d:d,count:a,se:0},c);return b?c.reverse():c};
m.$a=function(a,b,c,d){var e=Lf(this.qa).b[0];if(!q(e)||0==c)return Kf;b=b||!1;c=null!=c?Math.min(c,this.rb.oa):this.rb.oa;d=d||0;var f=Math.min(Math.max(this.rb.oa-d,0),c);if(0==f)return Kf;if(!q(a)||1==a.length&&a[0]instanceof rd&&td(a[0]))return this.Cc(f,b,c,d);a=this.S.rf(a);var h=Array(b?this.rb.oa:f),k={count:0,W:h.length,reverse:b,L:d},n=this.S instanceof Ef;a.forEach(function(a){for(var b=this.S.wd(a),b=this.S.Wd(a)?e:b[0],b=Mf(this.qa,b),c=k.count,d=0;null!=b&&k.count<k.W;){if(n){for(var f=
b,Vc=a,ab=k,re=h,se=f.D.fc(),te=-1,Da=0;Da<f.b.length;++Da)if(se.Qb(f.b[Da],Vc)){te=Da;break}if(-1!=te)for(Da=te;Da<f.b.length&&ab.count<ab.W;++Da){if(!se.Qb(f.b[Da],Vc))if(se.cd(f.b[Da]))break;else continue;Nf(f,ab,re,Da)}}else b.$a(a,k,h);k.count!=c||0<k.L?(d=0,c=k.count):d++;b=2==d?null:b.next()}},this);h.length>k.count&&h.splice(k.count,h.length-k.count);return b?tf(h,b,c,d):h};m.clear=function(){this.qa=Of(this);this.rb.clear()};m.Ma=function(a){return this.qa.Ma(a)};m.min=function(){return this.Hb(this.S.min.bind(this.S))};
m.max=function(){return this.Hb(this.S.max.bind(this.S))};function Pf(a,b,c){if(!a.S.cd(b.b[c]))if(1<b.b[c].length){if(null===b.b[c][0])return null}else return null;return[b.b[c],a.xf?[b.B[c]]:b.B[c]]}
...
m.Ga=function(){for(var a=[],b=Lf(this.qa);b;)a.push(new y(b.pa,[b.b,b.B])),b=b.sa;return a};function Rf(a,b,c,d){a=new Hf(b,a,c);d=Sf(d,a);a.qa=d;return a}function Tf(a,b){this.pa=a;this.D=b;this.kb=0;this.sa=this.nb=this.C=null;this.b=[];this.B=[];this.g=[]}function Of(a){return new Tf(rb++,a)}function R(a){return 0==a.kb}m=Tf.prototype;m.next=g("sa");
function Uf(a){function b(a){return null!=a?a.pa.toString():"_"}var c=a.pa+"["+a.b.join("|")+"]",d=a.g.map(function(a){return a.pa}).join("|"),e=a.B.join("/"),f=b(a.nb)+"{",f=R(a)?f+e:f+d,f=f+"}"+b(a.C);a.sa&&(a=Uf(a.sa),c=c+"  "+a[0],f=f+"  "+a[1]);return[c,f]}m.toString=function(){var a="",b=Uf(this),a=a+(b[0]+"\n"+b[1]+"\n");this.g.length&&(a+=this.g[0].toString());return a};function Lf(a){return R(a)?a:Lf(a.g[0])}function Qf(a){return R(a)?a:Qf(a.g[a.g.length-1])}
...
function Bg(a,b){var c=b||function(a){return a.toString()+"\n"},d="";$d(a,function(a){for(var b=0;b<Ud(a);b++)d+="-";d+=c(a)});return d};function Cg(a){ae.call(this);this.Tb=a;this.ab=!1}t(Cg,ae);m=Cg.prototype;m.Lb=function(){return tg(this,function(a){if(a instanceof Cg){var b=new Cg(a.Tb);b.ab=a.ab;a=a.X();b.pa=a;return b}return a.Lb()})};m.ib=function(a){var b=a||[];$d(this,function(a){a!=this&&a.ib(b)}.bind(this));a=D(b);return E(a)};m.yd=function(a){this.ab!=a&&(this.ab=a,this.Tb="and"==this.Tb?"or":"and",M(this).forEach(function(b){return b.yd(a)}))};
m.eval=function(a){var b=M(this).map(function(b){return b.eval(a)});return Dg(this,b)};function Dg(a,b){return"and"==a.Tb?Ed(b):Fd(b)}m.toString=function(){return"combined_pred_"+this.Tb.toString()};function Eg(a,b,c){ae.call(this);this.ga=a;this.la=b;this.G=c;this.ce=null;a=Md.Ec();this.yc=Sd(a,this.ga.I(),this.G);this.fg=a.Ve.get(this.ga.I())||null}t(Eg,ae);m=Eg.prototype;m.Lb=function(){var a=new Eg(this.ga,this.la,this.G),b=this.X();a.pa=b;return a};m.ib=function(a){return null!=a?(a.push(this.ga),a.push(this.la),a):[this.ga,this.la]};
m.reverse=function(){var a=this.G;switch(this.G){case "gt":a="lt";break;case "lt":a="gt";break;case "gte":a="lte";break;case "lte":a="gte"}return new Eg(this.la,this.ga,a)};m.eval=function(a){var b=a.entries.filter(function(a){var b=J(a,this.ga);a=J(a,this.la);return this.yc(b,a)},this);return new H(b,I(a))};m.toString=function(){return"join_pred("+this.ga.m()+" "+this.G+" "+this.la.m()+")"};
...
function Nh(a,b){return M(a).map(function(a){return"("+Oh(a,b)+")"}).join("and"==a.Tb?" AND ":" OR ")}function Ph(a){return[a.ga.m(),Lh(a.G),a.la.m()].join(" ")}function Oh(a,b){if(a instanceof ce){var c=a.O.m(),d=Lh(a.G),e=Mh(a.value,a.G,a.O.I(),b);return"="==d&&"NULL"==e?[c,"IS NULL"].join(" "):"<>"==d&&"NULL"==e?[c,"IS NOT NULL"].join(" "):[c,d,e].join(" ")}if(a instanceof Cg)return Nh(a,b);if(a instanceof Eg)return Ph(a);throw new F(357,typeof a);}
function Qh(a,b){var c=Oh(a,b);return c?" WHERE "+c:""}function Rh(a,b){var c="UPDATE "+a.table.getName()+" SET ",c=c+a.set.map(function(a){var b=a.O.m()+" = ";return-1!=a.Yc?b+"?"+a.Yc.toString():b+Jh(a.O.I(),a.value).toString()}).join(", ");a.u&&(c+=Qh(a.u,b));return c+";"}
...
function gi(a,b){if(null!=a.a.u){var c=Zh(b,a.a.u);a.a.u=c}else a.a.u=b}W.prototype.bg=function(a,b){fi(this,542);if(this.Ad)throw new F(547);this.a.c.push(a);gi(this,b);return this};W.prototype.innerJoin=W.prototype.bg;W.prototype.gg=function(a,b){fi(this,542);if(!(b instanceof Eg))throw new F(541);if(this.Ad)throw new F(547);this.a.c.push(a);null==this.a.Ab&&(this.a.Ab=D());var c=b;K(a)!=K(b.la.H())&&(c=b.reverse());this.a.Ab.add(c.X());gi(this,c);return this};W.prototype.leftOuterJoin=W.prototype.gg;
...
function Ui(a,b){this.F=a;this.yb=b;this.Zf=D(this.yb.f.map(function(a){return a.aa.getName()}));this.Zd=this.Da=null}function Wi(a){null===a.Zd&&(a.Zd=new Ni(a.yb,a.Da));return a.Zd}function Vi(a,b){b.forEach(function(a){var b=a.ib()[0].getName();this.Zf.has(b)&&(null===this.Da&&(this.Da=new Uc),this.Da.set(b,a.X()))},a)}function Ti(a,b){var c=Wi(a).hd(b),d=a.F.get(a.yb.m());return c.reduce(function(a,b){return a+d.ed(b)},0)};function Xi(a,b,c,d){U.call(this,0,-1);this.F=a.j(oc);this.index=b;this.We=c;this.ne=d;this.Wc=this.Vc=!1}t(Xi,U);Xi.prototype.toString=function(){return"index_range_scan("+this.index.m()+", ?, "+(this.ne?"reverse":"natural")+(this.Vc?", limit:?":"")+(this.Wc?", skip:?":"")+")"};Xi.prototype.Tc=function(a){var b=this.toString(),c=this.We.hd(a),b=b.replace("?",c.toString());this.Vc&&(b=b.replace("?",a.W.toString()));this.Wc&&(b=b.replace("?",a.L.toString()));return b};
Xi.prototype.ea=function(a,b,c){a=this.We.hd(c);b=this.F.get(this.index.m());c=(1==a.length&&a[0]instanceof rd&&xd(a[0])?tf(b.get(a[0].c),!1,this.Vc?c.W:void 0,this.Wc?c.L:void 0):b.$a(a,this.ne,this.Vc?c.W:void 0,this.Wc?c.L:void 0)).map(function(a){return new y(a,{})},this);return[Gd(c,[this.index.Sc])]};function Yi(a){U.call(this,0,1);this.ud=a}t(Yi,U);Yi.prototype.toString=l("select(?)");Yi.prototype.Tc=function(a){a=ge(a,this.ud);return this.toString().replace("?",a.toString())};Yi.prototype.ea=function(a,b,c){return[ge(c,this.ud).eval(a[0])]};function Zi(a,b){U.call(this,0,1);this.V=a.j(nc);this.U=b}t(Zi,U);Zi.prototype.toString=function(){return"table_access_by_row_id("+this.U.getName()+")"};Zi.prototype.ea=function(a){return[Gd(pf(this.V,Ad(a[0])),[K(this.U)])]};function $i(a){this.h=a}t($i,th);$i.prototype.pb=function(a,b){this.Z=a;vg(a,function(a){return a instanceof Ci}).forEach(function(a){var d=aj(a);if(0!=d.length){var e=Ri(new Qi(this.h,a.table),b,d.map(function(a){return ge(b,a.ud)}));if(null!==e){var f=B();d.forEach(function(a){f.set(a.ud,a)},this);this.Z=bj(this,e,f,a)}}},this);return this.Z};function aj(a){var b=[];for(a=a.getParent();a;)a instanceof Yi&&b.push(a),a=a.getParent();return b}
function bj(a,b,c,d){(null===b.Da?[]:b.Da.values()).map(function(a){return c.get(a)}).forEach(wg);b=new Xi(a.h,b.yb,Wi(b),!1);a=new Zi(a.h,d.table);Xd(a,b);Ag(d,d,a,b);return b.jb()};function cj(a,b){U.call(this,0,-1);this.F=a.j(oc);this.U=b}t(cj,U);cj.prototype.toString=function(){return"insert("+this.U.getName()+")"};cj.prototype.ea=function(a,b,c){dj(this.U,c.values,this.F);b.zb(this.U,c.values);return[Gd(c.values,[this.U.getName()])]};function dj(a,b,c){a=a.Fb().jd();if(null===a?0:a.f[0].autoIncrement){var d=a.f[0].aa.getName();c=c.get(a.m()).max();var e=null===c?0:c[0];b.forEach(function(a){if(0==a.s[d]||null==a.s[d])e++,a.s[d]=e})}}
function ej(a,b){U.call(this,0,-1);this.F=a.j(oc);this.U=b}t(ej,U);ej.prototype.toString=function(){return"insert_replace("+this.U.getName()+")"};ej.prototype.ea=function(a,b,c){dj(this.U,c.values,this.F);b.Vd(this.U,c.values);return[Gd(c.values,[this.U.getName()])]};function fj(){U.call(this,0,1)}t(fj,U);fj.prototype.toString=l("limit(?)");fj.prototype.Tc=function(a){return this.toString().replace("?",a.W.toString())};fj.prototype.ea=function(a,b,c){a[0].entries.splice(c.W);return a};function gj(a){U.call(this,0,1);this.N=a}t(gj,U);m=gj.prototype;m.toString=function(){return"order_by("+le(this.N)+")"};m.ea=function(a){if(1==a.length){var b;b=a[0];for(var c=null,d=0;d<this.N.length;d++){var e=Qg(this.N[d].O);if(null!==b.Ya&&b.Ya.has(e.m())){c=e;break}}b=c;(null===b?a[0]:Bd(a[0],b)).entries.sort(this.Pf.bind(this))}else a.sort(this.Ag.bind(this));return a};
...
m.exec=function(){if(!(this.La instanceof Ue||this.La instanceof $e||this.La instanceof kf))throw new F(300);var a;a:{a=this.i.ra();for(var b=0;b<a.length;++b)if(0<this.F.get(Xe(a[b])).Oa().oa){a=!1;break a}a=!0}if(!a)throw new F(110);if(this.i.name()!=this.xa.name||this.i.version()!=this.xa.version)throw new F(111);if(null==this.xa.tables)throw new F(112);return Xj(this)};m.I=l(1);m.ca=g("$");m.Nb=g("cb");m.X=function(){return ka(this)};m.getPriority=l(0);
...
function ak(a,b){var c=b.Gc();return c.ie.jb().exec(a.Ra,c.context).then(function(a){return zd(a[0])},function(a){this.Ra.Jb();var b=new lb(a.name);this.Ac.reject(b);throw a;}.bind(a))}m.ia=function(){this.La.Db(this.I(),E(this.$),this.Ra).ia().then(function(){this.Qc();this.Ac.resolve()}.bind(this),function(a){this.Ra.Jb();this.Ac.reject(a)}.bind(this));return this.cb.ha};m.Jb=function(){this.Ra.Jb();this.Ac.resolve();return this.cb.ha};
m.Qc=function(){var a=we(this.Ib,this.$);0!=a.length&&(a=new qe(this.h,a),xe(this.Fa,a))};function bk(a){this.h=a;this.Fa=a.j(qc);this.Uc=null;this.Ua=0;0==ck.size&&(ck.set(0,D([1,4])),ck.set(1,D([2])),ck.set(2,D([3,5,6])),ck.set(3,D([2,7])),ck.set(4,D([7])),ck.set(5,D([7])),ck.set(6,D([7])))}r("lf.proc.Transaction",bk);var ck=B();function dk(a,b){var c=ck.get(a.Ua)||null;if(null===c||!c.has(b))throw new F(107,a.Ua,b);a.Ua=b}
bk.prototype.exec=function(a){dk(this,4);var b=[];try{a.forEach(function(a){a.gb();b.push(a.Gc())},this)}catch(c){return dk(this,7),db(c)}a=new zh(this.h,b);return xe(this.Fa,a).then(function(a){dk(this,7);return a.map(function(a){return zd(a)})}.bind(this),function(a){dk(this,7);throw a;}.bind(this))};bk.prototype.exec=bk.prototype.exec;bk.prototype.Ef=function(a){dk(this,1);this.Uc=new Yj(this.h,a);return Zj(this.Uc).then(function(){dk(this,2)}.bind(this))};bk.prototype.begin=bk.prototype.Ef;
bk.prototype.Df=function(a){dk(this,3);return ak(this.Uc,a).then(function(a){dk(this,2);return a}.bind(this),function(a){dk(this,7);throw a;}.bind(this))};bk.prototype.attach=bk.prototype.Df;bk.prototype.ia=function(){dk(this,5);return this.Uc.ia().then(function(){dk(this,7)}.bind(this))};bk.prototype.commit=bk.prototype.ia;bk.prototype.Jb=function(){dk(this,6);return this.Uc.Jb().then(function(){dk(this,7)}.bind(this))};bk.prototype.rollback=bk.prototype.Jb;function X(a){this.h=a;this.i=a.j(sc);this.Ud=!1}r("lf.proc.Database",X);X.prototype.Ha=function(a){this.h.ob(sc,this.i);return Uj(this.h,a).then(function(){this.Ud=!0;this.Fa=this.h.j(qc);return this}.bind(this))};X.prototype.init=X.prototype.Ha;X.prototype.xb=g("i");X.prototype.getSchema=X.prototype.xb;function ek(a){if(!a.Ud)throw new F(2);}X.prototype.select=function(a){ek(this);return new W(this.h,1!=arguments.length||null!=arguments[0]?Array.prototype.slice.call(arguments):[])};
...
X.prototype.Tf=function(){ek(this);var a=new Vj(this.h);return xe(this.Fa,a).then(function(a){return zd(a[0])[0]})};X.prototype["export"]=X.prototype.Tf;X.prototype.import=function(a){ek(this);a=new Wj(this.h,a);return xe(this.Fa,a).then(l(null))};X.prototype["import"]=X.prototype.import;function Y(a,b,c,d,e,f){this.U=a;this.w=b;this.Ue=c;this.Se=d;this.wf=e;this.fb=f||null}r("lf.schema.BaseColumn",Y);m=Y.prototype;m.getName=g("w");m.m=function(){return K(this.U)+"."+this.w};m.toString=function(){return this.m()};m.H=g("U");m.I=g("wf");Y.prototype.getType=Y.prototype.I;Y.prototype.Za=g("fb");Y.prototype.Aa=function(){null==this.ka&&(this.ka=[],this.H().Aa().forEach(function(a){-1!=a.f.map(function(a){return a.aa.getName()}).indexOf(this.w)&&this.ka.push(a)},this));return this.ka};
...
function Ih(a,b){var c=D();b.forEach(function(a){(a=this.Ge.get(a))&&a.forEach(function(a){c.add(a)})},a);return E(c).map(function(a){return this.i.table(a)},a)};function jk(a,b,c){this.wg=a;this.og=b;this.Uf=c}r("lf.schema.Constraint",jk);jk.prototype.jd=g("wg");jk.prototype.getPrimaryKey=jk.prototype.jd;jk.prototype.Sd=g("Uf");jk.prototype.getForeignKeys=jk.prototype.Sd;function kk(a,b,c){var d=a.ref.split(".");if(2!=d.length)throw new F(540,c);this.Fe=b;this.hb=a.local;this.Sa=d[0];this.mc=d[1];this.name=b+"."+c;this.action=a.action;this.timing=a.timing};function Z(a){lk(a);this.Od=Md.Ec();this.w=a;this.K=B();this.zd=D();this.pc=D();this.Lc=D();this.Ca=null;this.ka=B();this.td=!1;this.wb=[]}r("lf.schema.TableBuilder",Z);function mk(a){this.name=a.name;this.mb=a.order;this.autoIncrement=a.autoIncrement}var nk=D([0,6]);function lk(a){if(!/^[A-Za-z_][A-Za-z0-9_]*$/.test(a))throw new F(502,a);}function ok(a,b){if(b==a.w)throw new F(546,b);if(a.K.has(b)||a.ka.has(b)||a.pc.has(b))throw new F(503,a.w+"."+b);}
function pk(a,b){var c=!1;b.forEach(function(a){var b=this.K.get(a.name);c=c||a.autoIncrement;if(a.autoIncrement&&3!=b)throw new F(504);},a);if(c&&1<b.length)throw new F(505);}function qk(a){if(null!==a.Ca){var b=a.ka.get(a.Ca).map(function(a){return a.name}),c=0;if(a.wb.some(function(a,e){c=e;return-1!=b.indexOf(a.hb)},a))throw new F(543,a.wb[c].name);}}
function rk(a){if(null!==a.Ca){var b=function(a){return a.name},c=JSON.stringify(a.ka.get(a.Ca).map(b));a.ka.forEach(function(a,e){if(e!=this.Ca){var f=a.map(b);if(JSON.stringify(f)==c)throw new F(544,this.w+"."+e);}},a)}}function sk(a){null===a.Ca||a.ka.get(a.Ca).forEach(function(a){if(this.Lc.has(a.name))throw new F(545,this.w+"."+a.name);},a)}Z.prototype.yf=function(a,b){lk(a);ok(this,a);this.K.set(a,b);nk.has(b)&&this.Ae([a]);return this};Z.prototype.addColumn=Z.prototype.yf;
Z.prototype.Af=function(a,b){var c=this.w;this.Ca="pk"+(c[0].toUpperCase()+c.substring(1));lk(this.Ca);ok(this,this.Ca);c=tk(this,a,!0,void 0,b);pk(this,c);1==c.length&&this.zd.add(c[0].name);this.pc.add(this.Ca);this.ka.set(this.Ca,c);return this};Z.prototype.addPrimaryKey=Z.prototype.Af;
Z.prototype.zf=function(a,b){lk(a);ok(this,a);var c=new kk(b,this.w,a);q(c.action)||(c.action=0);q(c.timing)||(c.timing=0);if(1==c.action&&1==c.timing)throw new F(506);if(!this.K.has(c.hb))throw new F(540,a);this.wb.push(c);this.ze(a,[c.hb],this.zd.has(c.hb));return this};Z.prototype.addForeignKey=Z.prototype.zf;Z.prototype.Bf=function(a,b){lk(a);ok(this,a);var c=tk(this,b,!0);uk(this,a,c);1==c.length&&(this.zd.add(c[0].name),vk(this,c[0].name));this.ka.set(a,c);this.pc.add(a);return this};
Z.prototype.addUnique=Z.prototype.Bf;function vk(a,b){a.wb.forEach(function(a){a.hb==b&&this.pc.add(a.name.split(".")[1])},a)}Z.prototype.Ae=function(a){a=tk(this,a,!1);wk(this,a);a.forEach(function(a){this.Lc.add(a.name)},this);return this};Z.prototype.addNullable=Z.prototype.Ae;function wk(a,b){cc(a.ka).forEach(function(a){var d=D();this.ka.get(a).forEach(function(a){d.add(a.name)});var e=b.filter(function(a){return d.has(a.name)});if(1<d.size&&0<e.length)throw new F(507,a,e.join(","));},a)}
Z.prototype.ze=function(a,b,c,d){lk(a);ok(this,a);b=tk(this,b,!0,d);uk(this,a,b);c&&this.pc.add(a);this.ka.set(a,b);return this};Z.prototype.addIndex=Z.prototype.ze;function uk(a,b,c){if(1<c.length&&(a=c.filter(function(a){return this.Lc.has(a.name)},a),0<a.length))throw new F(507,b,a.join(","));}Z.prototype.Bb=ba("td");Z.prototype.persistentIndex=Z.prototype.Bb;Z.prototype.xb=function(){qk(this);rk(this);sk(this);return new (xk(this))};Z.prototype.getSchema=Z.prototype.xb;
function yk(a){return a.wb}function tk(a,b,c,d,e){var f=b,f="string"==typeof b[0]?b.map(function(a){return new mk({name:a,order:null!=d?d:1,autoIncrement:e||!1})}):b.map(function(a){return new mk(a)});f.forEach(function(a){if(!this.K.has(a.name))throw new F(508,this.w,a.name);if(c){var b=this.K.get(a.name);if(0==b||6==b)throw new F(509,this.w,a.name);}},a);return f}
function xk(a){function b(){function b(c){return a.ka.get(c).map(function(a){return{aa:this[a.name],mb:a.mb,autoIncrement:a.autoIncrement}},this)}var d=cc(a.K).map(function(b){this[b]=new Y(this,b,a.zd.has(b),a.Lc.has(b),a.K.get(b));return this[b]},this),e=cc(a.ka).map(function(d){return new Mg(a.w,d,a.pc.has(d),b.call(this,d))},this);S.call(this,a.w,d,e,a.td);var f=null===a.Ca?null:new Mg(a.w,a.Ca,!0,b.call(this,a.Ca)),h=d.filter(function(b){return!a.Lc.has(b.getName())});this.If=new jk(f,h,a.wb);
this.nf=zk(a,d,e)}t(b,S);b.prototype.vb=function(a){return new this.nf(rb++,a)};b.prototype.createRow=b.prototype.vb;b.prototype.Eb=function(a){var b={};this.ib().forEach(function(e){var f=e.getName();e=e.I();var h=a.value[f];if(0==e)if(e=h,null!=e&&""!=e){0!=e.length%2&&(e="0"+e);for(var h=new ArrayBuffer(e.length/2),k=new Uint8Array(h),n=0,A=0;n<e.length;n+=2)k[A++]=parseInt(e.substr(n,2),16);e=h}else e=null;else e=2==e?null!=h?new Date(h):null:h;b[f]=e},this);return new this.nf(a.id,b)};b.prototype.deserializeRow=
...
f=function(a){var b=a.map(function(a){return e(a.aa)});return function(a){return b.map(function(b){return b(a)})}}.bind(a),h={};c.forEach(function(a){var b=a.m();a=1==a.f.length?e(a.f[0].aa):f(a.f);h[b]=a});d.prototype.Gb=function(a){return-1!=a.indexOf("#")?this.id():h.hasOwnProperty(a)?h[a](this.s):null};return d};function Ak(a,b){this.i=new Bk(a,b);this.sb=B();this.Bc=!1}r("lf.schema.Builder",Ak);function Ck(a,b){b.wb.forEach(function(a){var d=a.Sa;if(!this.sb.has(d))throw new F(536,a.name);var d=this.sb.get(d).xb(),e=a.mc;if(!d.hasOwnProperty(e))throw new F(537,a.name);if(b.xb()[a.hb].I()!=d[e].I())throw new F(538,a.name);if(!d[e].Ic())throw new F(539,a.name);},a)}
...
function Ek(a){var b=B();a.i.M.forEach(function(a,d){b.set(d,new Gk(d))},a);a.sb.forEach(function(a,d){a.wb.forEach(function(a){b.get(a.Sa).Ke.add(d)})});C(b).forEach(function(a){Fk(this,a,b)},a)}function Gk(a){this.ee=this.xe=!1;this.Ke=D();this.Sc=a}Ak.prototype.xb=function(){this.Bc||Dk(this);return this.i};Ak.prototype.getSchema=Ak.prototype.xb;Ak.prototype.Me=function(){var a=new lc("ns_"+this.i.name()),b;gk||(gk=new fk);b=gk;var c=null;b.Yd(a)?c=b.j(a):(c=new fk,b.ob(a,c));return c};
