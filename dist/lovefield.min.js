...
function se(a,b){var c=1<b[C],d=a.map(function(a){return new te(a,c)});return new me(d,b)}function te(a,b){this.wa=a;this.id=ue++;this.Te=b}var ue=0;te[r].M=function(a){var b=a.cb();return null!==b&&this.wa.w()[sb](b)?this.wa.w()[b]:this.Te?this.wa.w()[a.N().qa()][a[t]()]:this.wa.w()[a[t]()]};te[r].nf=function(a,b){var c=a.cb();if(null!=c)this.wa.w()[c]=b;else if(this.Te){var c=a.N().qa(),d=this.wa.w()[c];null==d&&(d={},this.wa.w()[c]=d);d[a[t]()]=b}else this.wa.w()[a[t]()]=b};
...
H.eval=function(a){this.Kf();if("in"==this.L)return this.Mi(a);var b=a[B][Ga](function(a){return this.Fd(a.M(this.K),this[u])!=this.eb},this);return new me(b,a.Y())};Ba(H,function(a){if(this.oc instanceof we){var b=this.oc.Ab();if(a[C]<=b)throw new P(510);pa(this,a[b])}else"array"==Pb(this.oc)&&pa(this,this.oc.map(function(b){if(b instanceof we){if(a[C]<=b.Ab())throw new P(510);return a[b.Ab()]}return b}))});
H.Mi=function(a){L("in"==this.L,"ValuePredicate#evalAsIn_() called for wrong predicate type.");var b=new O(this[u]),c=J(function(a){return b[tb](a)!=this.eb},this),d=a[B][Ga](function(a){return c(a.M(this.K))},this);return new me(d,a.Y())};f(H,function(){return"value_pred("+this.K.l()+" "+this.L+(this.eb?"(complement)":"")+" "+this[u]+")"});H.ug=function(){this.Kf();return null!==this[u]&&("between"==this.L||"eq"==this.L||"gt"==this.L||"gte"==this.L||"lt"==this.L||"lte"==this.L)};
...
function Ke(a){Ie[q](this,a)}K(Ke,Ie);function Le(a){var b="";a[F](function(c,d){b+=c.K.l()+" ";b+=1==c.tb?"ASC":"DESC";d<a[C]-1&&(b+=", ")});return b}Ke[r].ha=function(){return new O(this.c)};la(Ke[r],function(){var a=new Ke(this.ga);a.Ad(this);this.h&&(a.h=this.h[m]());this.c&&(a.c=this.c[m]());a.ba=this.ba;a.V=this.V;this.O&&(a.O=this.O[m]());this.oa&&(a.oa=this.oa[m]());this.$b&&(a.$b=this.$b);this.jc&&(a.jc=this.jc);a.zc=this.zc;return a});
...
function Ve(a,b,c){pd[q](this,c,b);this.j=a}K(Ve,pd);Ve[r].N=function(a){return this.j.$c(a)};
...
function $e(a,b,c,d,g){pd[q](this,c,d);this.m=a;this.Sa=b;this.wd=g;this.Sa.oncomplete=J(this.ca[Fb],this.ca);this.Sa.onabort=J(this.ca[Ma],this.ca)}K($e,pd);$e[r].N=function(a,b,c){return this.wd?(c=null!=c?c:0,a=this.Sa[vb](a),new Vd(a,b,0==c?$b(Wd,this.m):Xd)):new Ze(this.Sa[vb](a),b)};$e[r].Lc=function(){return this.ca.ka};
...
function bf(a,b,c){pd[q](this,c,b);this.W=a;0==b&&this.ca[Fb]()}K(bf,pd);bf[r].N=function(a){return this.W.$c(a)};bf[r].Lc=function(){this.ca[Fb]();return this.ca.ka};
...
function gf(a,b,c){pd[q](this,b,c);this.j=a;this.I=new Dd;this.ze=[]}K(gf,pd);gf[r].N=function(a,b){var c=this.I.get(a)||null;null===c&&(c=new ff(this,a,b),this.I.set(a,c));return c};gf[r].Qa=function(a,b,c){this.ze[x]({nl:a,Kk:b,transform:c})};
...
function Nf(a){this.m=a;this.Hb=a.o(Hd);this.J=a.o(Jd);this.ua=a.o(Id)}H=Nf[r];H.Ha=function(a){var b=a.ab(),c=J(function(){if(0==b[C])return Xc();var a=b[rb]();return(a.Lb()?this.aj(a):this.bj(a))[z](c)},this);return c()};H.bj=function(a){var b=new he(this.m,[a]);return this.Hb.Tb(0,b).N(a[t](),J(a.sc,a)).get([])[z](J(function(b){this.ua.set(a[t](),b);this.Tk(a,b)},this))};H.Tk=function(a,b){var c=this.J.Tj(a[t]());b[F](function(a){c[F](function(b){var c=a.Zb(b[t]());b.add(c,a.id())})})};
H.aj=function(a){var b=new he(this.m,[a]),c=this.Hb.Tb(0,b),b=c.N(a[t](),a.sc).get([])[z](J(function(b){this.ua.set(a[t](),b)},this)),d=a.za().map(function(a){return this.Uk(a,c)},this)[Sa](this.Vk(a,c));return ad(d[Sa](b))};
H.Uk=function(a,b){var c=b.N(a.l(),jd,1),d=Df(a);return c.get([])[z](J(function(b){L("btree"==b[0].w().type);if(1<b[C]){if(a.og()){var c=wf[E](void 0,d,a.l(),a.dd),l=b[m](1),p=-1;for(b=0;b<l[C];++b)if(-2==l[b].id()){p=b;break}if(-1==p)throw new P(102);b=l[p].w();l=l[m](0);l[A](p,1);c=c(l);c=new Kf(c);c.sb[hb](b)}else c=wf(d,a.l(),a.dd,b[m](1));this.J.set(c)}},this))};
H.Vk=function(a,b){return b.N(a.Vb(),jd,1).get([])[z](J(function(b){L("rowid"==b[0].w().type);1<b[C]&&(b=Mf(a.Vb(),b[m](1)),this.J.set(b))},this))};
...
H.eval=function(a){var b=a[B][Ga](function(a){var b=a.M(this.Oa);a=a.M(this.Ea);return this.Fd(b,a)},this);return new me(b,a.Y())};f(H,function(){return"join_pred("+this.Oa.l()+", "+this.Ea.l()+")"});H.Ff=function(a){return-1!=a.Y()[$a](this.Oa.N().qa())};H.Hh=function(a){return-1!=a.Y()[$a](this.Ea.N().qa())};H.Hi=function(a,b){var c=null,d=null;this.Ff(a)?(this.Hf(a,b),c=a,d=b):(this.Hf(b,a),c=b,d=a);return[c,d]};
H.Hf=function(a,b){L(this.Ff(a),"Mismatch between join predicate left operand and right relation.");L(this.Hh(b),"Mismatch between join predicate right operand and right relation.")};H.Oi=function(a,b,c){var d=[a,b];c||(d=this.Hi(a,b));a=d[0];d=d[1];return"eq"==this.L?this.Pi(a,d,c):this.Qi(a,d,c)};H.zi=function(a){var b={};a.ob()[F](function(a){b[a[t]()]=null});return b};H.Sf=function(a,b){null===this.Ye&&(this.Ye=this.zi(this.Ea.N()));var c=new te(new hd(-1,this.Ye),!1);return ve(a,b,c,[this.Ea.N().qa()])};
H.Qi=function(a,b,c){for(var d=[],g=a.Y(),k=b.Y(),l=0;l<a[B][C];l++){for(var p=!1,y=0;y<b[B][C];y++)if(this.Fd(a[B][l].M(this.Oa),b[B][y].M(this.Ea))){var p=!0,wa=ve(a[B][l],g,b[B][y],k);d[x](wa)}c&&!p&&d[x](this.Sf(a[B][l],g))}a=a.Y()[Sa](b.Y());return new me(d,a)};
H.Pi=function(a,b,c){var d=a,g=b,k=this.Oa,l=this.Ea;if(c||a[B][C]>b[B][C])d=b,g=a,k=this.Ea,l=this.Oa;var p=new hg,y=[];d[B][F](function(a){var b=ha(a.M(k));p.add(b,a)});var wa=d.Y(),qb=g.Y();g[B][F](function(a){var b=ha(a.M(l));p.C(b)?p.get(b)[F](function(b){b=ve(a,qb,b,wa);y[x](b)}):c&&y[x](this.Sf(a,qb))}[E](this));a=a.Y()[Sa](b.Y());return new me(y,a)};
...
function T(a,b){xa(this,a);this.lc=b;this.lb=null}H=T[r];na(H,function(){return this.lc+"("+this[jb][t]()+")"});H.l=function(){return this.lc+"("+this[jb].l()+")"};H.N=function(){return this[jb].N()};f(H,function(){return this.l()});H.Z=function(){return this[jb].Z()};H.cb=G("lb");H.za=function(){return[]};H.Yb=Kb(!1);H.Gc=function(a){this.lb=a;return this};T[r].as=T[r].Gc;T[r].cg=function(){for(var a=[this],b=this;b instanceof T;)a[x](b[jb]),b=b[jb];return a};
function mg(a){this.lb=a||null;this.S=new S("#UnknownTable",[],[],!1)}H=mg[r];na(H,Kb("*"));H.l=function(){return this[t]()};f(H,function(){return this.l()});H.N=G("S");H.Z=Kb(4);H.cb=G("lb");H.za=function(){return[]};H.Yb=Kb(!1);
...
pg[r].Uh=function(){this.H[F](function(a){a=a.cg()[fb]();for(var b=1;b<a[C];b++){var c=a[b],d=c.cg()[m](-1)[0],g=this.Dj(c),k=null;switch(c.lc){case "MIN":k=qg(g,d);break;case "MAX":k=rg(g,d);break;case "DISTINCT":k=sg(g,d);break;case "COUNT":k=tg(g,d);break;case "SUM":k=ug(g,d);break;case "AVG":0<g[B][C]&&(k=ug(g,d)/g[B][C]);break;case "GEOMEAN":k=vg(g,d);break;default:k=wg(g,d)}this.Ja.el(c,k)}},this)};pg[r].Dj=function(a){return a[jb]instanceof T?this.Ja.wc(a[jb]):this.Ja};
function qg(a,b){var c=null;a[B][F](function(a){a=a.M(b);if(null===c||a<c)c=a});return c}function rg(a,b){var c=null;a[B][F](function(a){a=a.M(b);if(null===c||a>c)c=a});return c}function tg(a,b){return b instanceof mg?a[B][C]:a[B][Ka](function(a,d){return a+(Qb(d.M(b))?0:1)},0)}function ug(a,b){return a[B][Ka](function(a,d){return a+d.M(b)},0)}function wg(a,b){var c=a[B].map(function(a){return a.M(b)});return ud[xb](null,c)}
function vg(a,b){var c=0,d=a[B][Ka](function(a,d){var l=d.M(b);return 0!=l?(c++,a+ba.log(l)):a},0);return 0==c?null:ba.pow(ba.E,d/c)}function sg(a,b){var c=new N;a[B][F](function(a){var g=a.M(b);c.set(g,a)});return new me(c.f(),a.Y())};
...
f(Fg[r],function(){var a="project("+this.h[D]();if(null!==this.Wb)var b=this.Wb.map(function(a){return a.l()})[La](", "),a=a+(", groupBy("+b+")");return a+")"});function Gg(a){V[q](this);this.O=a}K(Gg,V);f(Gg[r],function(){return"order_by("+Le(this.O)+")"});function Hg(a){V[q](this);this.h=a}K(Hg,V);f(Hg[r],function(){return"aggregation("+this.h[D]()+")"});function Ig(a){V[q](this);this.h=a}K(Ig,V);f(Ig[r],function(){return"group_by("+this.h[D]()+")"});function Jg(a){V[q](this);this.ba=a}K(Jg,V);
...
H.ce=function(a,b){var c=a;if(this.il(a))c=Xf(a),this.ce(a,b);else if(this.hl(a)){var d=[],c=Yf(a,b,function(a){a=new Cg(a.Da);d[x](a);return a});d[F](function(a){this.ce(a,b)},this)}return c};H.Qk=function(a){var b=new O([a.Da.K.N().qa()]),c=function(a){return this.Xf(a,b)}[E](this);return this.ce(a,c)};H.Pk=function(a){var b=new O([a.Da.Oa.N().qa(),a.Da.Ea.N().qa()]),c=function(a){return this.Xf(a,b)}[E](this);return this.ce(a,c)};
...
function th(a){U[q](this,1,1);this.S=a}K(th,U);f(th[r],function(){return"delete("+this.S[t]()+")"});th[r].na=function(a,b){var c=b[0][B].map(function(a){return a.wa});a[w](this.S,c);return[pe()]};
function uh(a){U[q](this,1,1);this.mg=a}K(uh,U);f(uh[r],function(){return"groupBy("+this.mg.map(function(a){return a.l()})[D]()+")"});uh[r].na=function(a,b){return this.Wh(b[0])};uh[r].Wh=function(a){var b=new hg,c=function(a){return this.mg.map(function(b){return a.M(b)},this)[La](",")}[E](this);a[B][F](function(a){b.add(c(a),a)},this);return b.U().map(function(c){return new me(b.get(c),a.Y())},this)};
...
function Ch(a,b){U[q](this,1,1);this.ua=a.o(Id);this.S=b}K(Ch,U);f(Ch[r],function(){return"table_access_by_row_id("+this.S[t]()+")"});Ch[r].na=function(a,b){return[se(this.ua.get(b[0].Rj()),[this.S.qa()])]};
...
function Fh(a,b){U[q](this,0,-1);this.J=a.o(Jd);this.S=b}K(Fh,U);f(Fh[r],function(){return"insert("+this.S[t]()+")"});Fh[r].na=function(a,b,c){Gh(this.S,c[db],this.J);a.Db(this.S,c[db]);return[se(c[db],[this.S[t]()])]};function Gh(a,b,c){a=a.Jb().Pd();if(null===a?0:a.h[0][ob]){var d=a.h[0].ga[t]();c=c.get(a.l()).max();var g=null===c?0:c[0];b[F](function(a){if(0==a.w()[d]||null==a.w()[d])g++,a.w()[d]=g})}}function Hh(a,b){U[q](this,0,-1);this.J=a.o(Jd);this.S=b}K(Hh,U);
f(Hh[r],function(){return"insert_replace("+this.S[t]()+")"});Hh[r].na=function(a,b,c){Gh(this.S,c[db],this.J);a.Pe(this.S,c[db]);return[se(c[db],[this.S[t]()])]};
...
function Kh(a){U[q](this,-1,1);this.O=a}K(Kh,U);H=Kh[r];f(H,function(){return"order_by("+Le(this.O)+")"});H.na=function(a,b){if(1==b[C]){var c=this.ej(b[0]);(null===c?b[0]:b[0].wc(c))[B][Za](this.Li[E](this))}else b[Za](this.Xk[E](this));return b};H.ej=function(a){for(var b=null,c=0;c<this.O[C];c++){var d=ng(this.O[c].K);if(a.ck(d)){b=d;break}}return b};
H.X=function(a,b){var c=null,d=null,g=null,k=-1;do k++,g=this.O[k].K,c=this.O[k].tb,d=a(g),g=b(g);while(d==g&&k+1<this.O[C]);d=d<g?-1:d>g?1:0;return 1==c?d:-d};H.Xk=function(a,b){return this.X(function(b){return b instanceof T?a.wc(b):a[B][a[B][C]-1].M(b)},function(a){return a instanceof T?b.wc(a):b[B][b[B][C]-1].M(a)})};H.Li=function(a,b){return this.X(function(b){return a.M(b)},function(a){return b.M(a)})};
...
Lh[r].ak=function(){if(1==this.H[C]&&"DISTINCT"==this.H[0].lc){var a=this.Ja.wc(this.H[0])[B].map(function(a){var b=new te(new hd(-1,{}),this.Ja.Se());b.nf(this.H[0],a.M(this.H[0][jb]));return b},this);return new me(a,[])}var b=new te(new hd(-1,{}),this.Ja.Se());this.H[F](function(a){var d=a instanceof T?this.Ja.wc(a):this.Ja[B][0].M(a);b.nf(a,d)},this);return new me([b],this.Ja.Y())};
Lh[r].bk=function(){var a=e(this.Ja[B][C]),b=this.Ja.Se();this.Ja[B][F](function(c,d){a[d]=new te(new hd(c.wa.id(),{}),b);this.H[F](function(b){a[d].nf(b,c.M(b))},this)},this);return new me(a,this.Ja.Y())};function Mh(a,b){var c=a.map(function(a){return(new Lh(a,b)).lg()[B][0]});return new me(c,a[0].Y())};
...
function Qh(a){this.m=a}K(Qh,Mg);Qh[r].Mb=function(a){var b=Rh(a);if(null===b)return a;a=this.Kh(b);a==b&&(a=this.Jh(b));return a.qb()};Qh[r].Kh=function(a){var b=a,c=Sh(a.zb(0));if(null!==c){var d;d=a.O;for(var g=null,k=c[h].za(),l=0;l<k[C]&&null===g;l++)g=Th(k[l],d);d=g;if(null===d)return b;b=new Ah(this.m,d.Cb,new wh(d.Cb),d.Ag);d=new Ch(this.m,c[h]);d.ma(b);Vf(a);b=Zf(c,c,d,b)}return b};
Qh[r].Jh=function(a){var b=a,c=Uh(a.zb(0));if(null!==c){var d=Th(c[mb],a.O);if(null===d)return b;c.kf=d.Ag;b=Vf(a).parent}return b};function Uh(a){a=Uf(a,function(a){return a instanceof Ah},function(a){return 1!=a.xa()});return 0<a[C]?a[0]:null}function Sh(a){a=Uf(a,function(a){return a instanceof Dh},function(a){return 1!=a.xa()});return 0<a[C]?a[0]:null}function Rh(a){a=Uf(a,function(a){return a instanceof Kh});return 0<a[C]?a[0]:null}
...
function Xh(a,b){U[q](this,1,1);this.S=a;this.zl=b}K(Xh,U);f(Xh[r],function(){return"update("+this.S[t]()+")"});Xh[r].na=function(a,b){var c=b[0][B].map(function(a){var b=this.S.sc(a.wa.Ka());this.zl[F](function(a){b.w()[a.K[t]()]=a[u]},this);return b},this);a[Va](this.S,c);return[pe()]};
...
Yh[r].wk=function(a){if(a instanceof Fg)return new Nh(a.h,a.Wb);if(a instanceof Ig)return new uh(a.h);if(a instanceof Hg)return new og(a.h);if(a instanceof Gg)return new Kh(a.O);if(a instanceof Kg)return new Oh;if(a instanceof Jg)return new Jh;if(a instanceof Cg)return new Bh(a.Da.fa());if(a instanceof Eg)return new Pg;if(a instanceof Lg)return new Ih(a.Da,a.yg);if(a instanceof Dg)return new Dh(this.m,a[h]);if(a instanceof Ag)return new th(a[h]);if(a instanceof Bg)return new Xh(a[h],a.wf);if(a instanceof
...
function di(a,b){this.Ni=xe.He();this.gf=a;this.Yd=b;this.H=this.Gi()}di[r].Gi=function(){if(0<this.gf.h[C])return this.gf.h;var a=[];this.gf.c[F](function(b){b.ob()[F](function(b){a[x](b)})});return a};di[r].X=function(a,b){return this.H[Ua](function(c){return this.Ni.Fe(c.Z(),"eq")(a.M(c),b.M(c))},this)};
...
function Y(a,b,c,d,g,k){this.S=a;this.A=b;this.Cg=c;this.wg=d;this.th=g;this.lb=k||null}I("lf.schema.BaseColumn",Y,void 0);H=Y[r];na(H,G("A"));H.l=function(){return this.S.qa()+"."+this.A};f(H,function(){return this.l()});H.N=G("S");H.Z=G("th");Y[r].getType=Y[r].Z;Y[r].cb=G("lb");Y[r].za=function(){null==this.ia&&(this.ia=[],this.N().za()[F](function(a){-1!=a.h.map(function(a){return a.ga[t]()})[$a](this.A)&&this.ia[x](a)},this));return this.ia};Y[r].Yb=G("wg");Y[r].isNullable=Y[r].Yb;Y[r].dd=G("Cg");
...
Y[r].between=Y[r].Sh;Y[r].gk=function(a){return jg(this,a,"in")};Y[r]["in"]=Y[r].gk;Y[r].pk=function(){return this.Va(null)};Y[r].isNull=Y[r].pk;Y[r].nk=function(){return this.Kg(null)};Y[r].isNotNull=Y[r].nk;Y[r].Gc=function(a){return new Y(this.S,this.A,this.Cg,this.wg,this.th,a)};Y[r].as=Y[r].Gc;
