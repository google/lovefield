...
I.Uc=function(){return new N(function(a,b){var c=[],d;try{d=this.V[Fa]()}catch(g){b(g);return}za(d,b);ta(d,K(function(){var b=d[Gb];if(b){var g=Td(b[w]).vc(),p;for(p in g)c[z](this.Rb(g[p]));b[gb]()}else a(c)},this))},this)};I.$b=function(a){return new N(function(b,c){var d;try{d=a()}catch(g){c(g);return}ta(d,b);za(d,c)},this)};
...
function Xd(){};
function Yd(a){this.ta=a.o(Hd);this.J=a.o(Id);this.s=a.o(Md)}ra(Yd[t],function(a){a[G](function(a){this.tl(a);this.ql(a)},this)});Yd[t].ql=function(a){var b=a[u]();a.Vc().f()[G](function(a){this.ta[y](b,[a.id()])},this);a.Tc()[G](function(a){this.ta.set(b,[a])},this);a.Xc()[G](function(a){this.ta.set(b,[a[1]])},this)};Yd[t].tl=function(a){var b=this.s[h](a[u]());a.uj()[G](function(a){this.uh(b,a)},this)};
Yd[t].uh=function(a,b){a.Ea().map(function(a){return this.J.get(a.l())},this)[Sa]([this.J.get(a.Sb())])[G](function(a){var d=null===b[1]?null:b[1].Vb(a[u]()),g=null===b[0]?null:b[0].Vb(a[u]());null===g&&null!==d?a.add(d,b[1].id()):null===g||null===d?null!==g&&null===d&&a[y](g,b[0].id()):0!=a.Lc()[Ab](g,d)&&(a.add(d,b[1].id()),a[y](g,b[0].id()))})};
...
I.Lj=function(){var a=new fe(this.D);this.kb.f()[G](function(b){a[Ya](b)},this);this.nb.f()[G](function(b){a.add(b)},this);this.Oa.f()[G](function(b){a.modify([b[1],b[0]])},this);return a};I.Ma=function(){return this.kb.Ma()&&this.nb.Ma()&&this.Oa.Ma()};
...
I.yj=function(){var a=[];this.sa.f()[G](function(b){b.ac()&&(b.Ea()[G](function(b){a[z](b.l())}),a[z](b[u]()+".#"))});return a};I.Bb=function(a,b){this.Hc();this.xd(a);this.Ua.te(a,b);this.Ua.re(a,b,0);for(var c=0;c<b[D];c++)this.Sd(a,[null,b[c]])};
...
I.contains=function(a){var b=null===this.u||a<this.u||a==this.u&&!this.ba;return(null===this.c||a>this.c||a==this.c&&!this.Y)&&b};I.Pc=function(a){return this.c==a.c&&this.Y==a.Y&&this.u==a.u&&this.ba==a.ba};function ie(a,b,c,d,g){function k(a){return c?a:1==a?-1:1}d=d||!1;g=g||!1;return null===a?null===b?(d?!g:g)?d?k(1):k(-1):0:k(-1):null===b?k(1):a<b?-1:a==b?(d?!g:g)?d?k(1):k(-1):0:1}function ke(a,b){var c=ie(a.c,b.c,!0,a.Y,b.Y);0==c&&(c=ie(a.u,b.u,!1,a.ba,b.ba));return c};
function le(a,b){this.entries=a;this.I=new P(b);this.Ob=null}I=le[t];I.ik=function(a){return this.I.Pc(a.I)};function me(a,b){M(a.ik(b),"Intersection/union operations only apply to compatible relations.")}I.X=function(){return this.I.f()};I.Pe=function(){return 1<this.I.ya()};I.Ee=function(){return this[C].map(function(a){return a.wa.w()})};I.Nj=function(){return this[C].map(function(a){return a.wa.id()})};I.al=function(a,b){null===this.Ob&&(this.Ob=new O);this.Ob.set(a.l(),b)};
...
function He(a){this.ea=a;this.Jc=this.va=null}He[t].Ld=function(a){null===this.va&&null!=this.F&&(this.va=Ie(this.F));a=this.va.get(a,null);M(null!==a);return a};function Ie(a){var b=new O;a.Cc(function(a){b.set(a.da(),a)});return b}He[t].yd=function(a){a.F&&(this.F=a.F.Pb());this.Jc=a};Ba(He[t],function(){M(null==this.Jc);return this});He[t].oe=function(a){var b=this.F;null!=b&&b.Cc(function(b){b instanceof Ge&&b[F](a)})};
...
function Pe(a,b){this.m=a;this.Ib=a.o(Ld);this.Za=a.o(Kd);this.Rd=new Yd(a);this.Eb=b;var c=a.o(Md),d=this.Eb.map(function(a){return c[h](a[u]())});this.sa=new P(d);this.cc=ad()}I=Pe[t];na(I,function(){this.Rd[Va](this.Eb);this.kd();return Wc()});I.Z=Kb(1);I.fa=H("sa");I.Yc=H("cc");I.da=function(){return Vb(this)};Ea(I,Kb(1));I.kd=function(){var a=this.Ib.Je(this.sa.f());0!=a[D]&&(a=new Oe(this.m,a),this.Za.dc(a))};
...
I.he=function(a,b){var c=this.jb.get(a);return null!=c?function(){var a={},g=ad();this.j[cb]("T").equalTo(c)[Ha]("value",function(c){c[G](function(c){var g=b(c.val());a[da(c.key(),10)]=g});g[Fb](a)});return g.ha}[r](this)[A](function(a){a["@rev"]={R:++this.Ya};return Te(this.j,a)}[F](this)):Wc()};I.Nc=function(a){return this.he(a,Kb(null))[A](function(){this.jb[y](a);return Te(this.j[kb]("@table/"+a),null,!0)}[F](this))};Re[t].dropTable=Re[t].Nc;
Re[t].Fc=function(a,b,c){return this.he(a,function(a){var g=a.P;g[b]=c;return{R:this.Ya+1,T:a.T,P:g}}[F](this))};Re[t].addTableColumn=Re[t].Fc;Re[t].Oc=function(a,b){return this.he(a,function(a){var d=a.P;delete d[b];return{R:this.Ya+1,T:a.T,P:d}}[F](this))};Re[t].dropTableColumn=Re[t].Oc;Re[t].jd=function(a,b,c){return this.he(a,function(a){var g=a.P;g[c]=g[b];delete g[b];return{R:this.Ya+1,T:a.T,P:g}}[F](this))};Re[t].renameTableColumn=Re[t].jd;Re[t].Gb=function(){throw new Q(351);};
Re[t].createRow=Re[t].Gb;Re[t].ad=H("Ta");Re[t].getVersion=Re[t].ad;Re[t].rc=function(a){var b=ad();a=this.jb.get(a);this.j[cb]("T").equalTo(a)[Ha]("value",function(a){var d=[];a[G](function(a){d[z](a.val().P)});b[Fb](d)});return b.ha};la(Re[t],function(){var a={},b=this.jb.U().map(function(b){return this.rc(b)[A](function(d){a[b]=d})}[F](this));return $c(b)[A](function(){return a})});la(Re[t],Re[t].dump);
function Ue(a,b,c){od[r](this,c,b);this.j=a}L(Ue,od);Ue[t].M=function(a){return this.j.Zc(a)};
Ue[t].Kc=function(){var a=this.Aj().cg();if(0==a.ya())this.aa[Fb]();else{var b=this.j.Mj()+1;this.j.hh(b);var c={"@rev":{R:b}};a[G](function(a){var g=this.j.jg(a[u]());a.Tc()[G](function(a,d){c[d]={R:b,T:g,P:a.w()}});a.Xc()[G](function(a,d){c[d]={R:b,T:g,P:a[1].w()}});a.Vc()[G](function(a,b){c[b]=null})},this);this.j.Jj()[Va](c,function(c){if(null===c)this.aa[Fb]();else this.j.hh(b-1),c=a.f().map(function(a){return this.j.Xg(a[u]())},this),$c(c)[A](this.aa[La][F](this.aa),this.aa[La][F](this.aa))}[F](this))}return this.aa.ha};
...
function We(a,b){this.s=a;this.Dh=b;this.hd=new O;this.Ya=-1;this.I=new O;this.jb=new O;this.pe=null}I=We[t];I.Mj=H("Ya");I.hh=Jb("Ya");
...
I.Qb=function(a,b){return new Ue(this,a,b)};I.Zc=function(a){var b=this.I.get(a,null);if(null!==b)return b;throw new Q(101,a);};I.Jj=H("j");pa(I,Ib());Ca(I,Jb("pe"));I.fd=function(a){null!=this.pe&&this.pe(a)};
...
function Ye(a,b){this.V=a;this.Rb=b}I=Ye[t];I.get=function(a){if(0==a[D])return this.Uc();a=a.map(function(a){return new N(function(c,d){var g;try{g=this.V.get(a)}catch(k){d(k);return}za(g,d);ta(g,K(function(a){c(this.Rb(a[Pa][Gb]))},this))},this)},this);return $c(a)};I.Uc=function(){return new N(function(a,b){var c=[],d;try{d=this.V[Fa]()}catch(g){b(g);return}za(d,b);ta(d,K(function(){var b=d[Gb];b?(c[z](this.Rb(b[w])),b[gb]()):a(c)},this))},this)};
...
I.Ek=function(a,b){var c=b[Pa][Gb],d=b[Pa][mb],g=new R(b.oldVersion,c,d,this.vd);this.Uk(c,d);this.zi(c,d);return a(g)};I.Uk=function(a){for(var b=[],c=0;c<a[Ia][D];++c){var d=a[Ia][Na](c);-1!=d[$a](".")&&b[z](d)}b[G](function(b){try{a.deleteObjectStore(b)}catch(c){}})};I.zi=function(a,b){this.s.$a()[G]($b(this.wi,a,b),this)};I.wi=function(a,b,c){a[Ia][ub](c[u]())||a.createObjectStore(c[u](),{keyPath:"id"});c.ac()&&(c.Ea()[G](function(c){this.Mc(a,b,c.l(),"btree")},this),this.Mc(a,b,c.Sb(),"rowid"))};
I.Mc=function(a,b,c,d){a[Ia][ub](c)||(a.createObjectStore(c,{keyPath:"id"}),a=b[wb](c),(this.vd?new Ud(a,id,Wd):new Ye(a,id)).put([new md(new ld(d))]))};I.Qb=function(a,b){var c=b.fa().f().map(function(a){return a[u]()});b.yj()[G](function(a){c[z](a)});var d=this.j[mb](c,0==a?"readonly":"readwrite");return new Ze(this.m,d,b,a,this.vd)};
...
pa(I,function(){this.j[Ra]()});I.Zc=function(){throw new Q(511);};Ca(I,Ib());I.fd=Ib();



function af(a,b,c){od[r](this,c,b);this.V=a;0==b&&this.aa[Fb]()}L(af,od);af[t].M=function(a){return this.V.Zc(a)};af[t].Kc=function(){this.aa[Fb]();return this.aa.ha};
function bf(a){this.s=a;this.I=new Cd}I=bf[t];I.Fa=function(){this.s.$a()[G](this.ek,this);return Wc()};I.Zc=function(a){var b=this.I.get(a)||null;if(null===b)throw new Q(101,a);return b};I.Qb=function(a,b){return new af(this,a,b)};I.Qf=function(a){if(!this.I.has(a)){var b=new Ve;this.I.set(a,b);return b}return null};I.ek=function(a){this.Qf(a[u]());a.ac()&&(a.Ea()[G](function(a){this.Mc(a.l(),"btree")},this),this.Mc(a.Sb(),"rowid"))};I.Mc=function(a,b){var c=this.Qf(a);null===c||c.put([new md(new ld(b))])};
pa(I,Ib());Ca(I,Ib());I.fd=Ib();
...
function df(a,b,c){this.Sa=a;this.D=b;this.Rb=c}df[t].get=function(a){var b=this.Rb;this.Sa.Pa("SELECT id, value FROM "+this.D+" "+(0==a[D]?"":"WHERE id IN ("+a[m](",")+")"),[],function(a){for(var d=a[Cb][D],g=e(d),k=0;k<d;++k)g[k]=b({id:a[Cb][Na](k).id,value:JSON.parse(a[Cb][Na](k)[w])});return g});return this.Sa.oa()};
df[t].put=function(a){if(0==a[D])return Wc();var b="INSERT OR REPLACE INTO "+this.D+"(id, value) VALUES (?, ?)";a[G](function(a){this.Sa.Pa(b,[a.id(),JSON.stringify(a.w())])},this);return Wc()};wa(df[t],function(a){this.Sa.Pa("DELETE FROM "+this.D+" "+(0==a[D]?"":"WHERE id IN ("+a[m](",")+")"),[]);return Wc()});
...
ef[t].Kc=function(){var a,b,c=this.aa[La][F](this.aa),d=function(a,b){this.aa[La](b)}[F](this),g=K(function(c,l){a=l;if(this.we[D]){var p=this.we[sb]();b=p.transform;c.executeSql(p.jl,p.Gk,g,d)}else p=a,null!=b&&null!=a&&(p=b(a)),this.aa[Fb](p)},this);0==this.qh?this.j.readTransaction(g,c):this.j[mb](g,c);return this.aa.ha};
function S(a,b,c){this.j=c;this.m=a;this.Ta=b}J("lf.backstore.WebSqlRawBackStore",S,void 0);S[t].Md=H("j");S[t].getRawDBInstance=S[t].Md;S[t].Nd=function(){throw new Q(356);};S[t].getRawTransaction=S[t].Nd;S[t].Cd=function(){return new ef(this.j,new ge(this.m,[]),1)};S[t].Nc=function(a){var b=this.Cd();b.Pa("DROP TABLE "+a,[]);return b.oa()};S[t].dropTable=S[t].Nc;
S[t].rc=function(a){var b=this.Cd();b.Pa("SELECT id, value FROM "+a,[]);return b.oa()[A](function(a){for(var b=a[Cb][D],g=e(b),k=0;k<b;++k)g[k]={id:a[Cb][Na](k).id,value:JSON.parse(a[Cb][Na](k)[w])};return Wc(g)})};S[t].pf=function(a,b){var c=this.Cd(),d="UPDATE "+a+" SET value=? WHERE id=?";return this.rc(a)[A](function(a){a[G](function(a){a=b(a);c.Pa(d,[JSON.stringify(a[w]),a.id])});return c.oa()})};S[t].Fc=function(a,b,c){var d=Xe(c);return this.pf(a,function(a){a[w][b]=d;return a})};
S[t].addTableColumn=S[t].Fc;S[t].Oc=function(a,b){return this.pf(a,function(a){delete a[w][b];return a})};S[t].dropTableColumn=S[t].Oc;S[t].jd=function(a,b,c){return this.pf(a,function(a){a[w][c]=a[w][b];delete a[w][b];return a})};S[t].renameTableColumn=S[t].jd;S[t].Gb=function(a){var b={},c;for(c in a)b[c]=Xe(a[c]);return jd(b)};S[t].createRow=S[t].Gb;S[t].ad=H("Ta");S[t].getVersion=S[t].ad;
...
function pf(a,b,c,d){this.D=a;this.W=b;this.sf=c;this.Mb=new of;if(d){a=511;a*=a*a;if(d[D]>=a)throw new Q(6,a);d=qf(this,d);this.ra=d=rf(d)}else this[x]()}var sf=[];I=pf[t];oa(I,H("D"));f(I,function(){return this.ra[E]()});I.add=function(a,b){this.ra=this.ra.Bb(a,b)};I.set=function(a,b){this.ra=this.ra.Bb(a,b,!0)};wa(I,function(a,b){this.ra=this.ra[y](a,b)});I.get=function(a){return this.ra.get(a)};I.Bd=function(a){if(null==a)return this.ib().Ra;if(a instanceof he){if(a.rg())return this.ib().Ra;if(a.wg())return this.get(a.c)[D]}return this.ob([a])[D]};
I.ib=H("Mb");I.Uc=function(a,b,c){b=ba.min(ba.max(this.Mb.Ra-c,0),b);if(0==b)return[];var d=e(b);this.ra.fill({offset:a?this.Mb.Ra-b-c:c,count:b,nf:0},d);return a?d[fb]():d};
I.ob=function(a,b,c,d){var g=this.ra.Jd().b[0];if(!Mb(g)||0==c)return sf;if(!Mb(a)||1==a[D]&&a[0]instanceof he&&a[0].rg())return this.Uc(b||!1,c||this.Mb.Ra,d||0);var k=(c||0)+(d||0),k=0<k&&!b?k:Number.POSITIVE_INFINITY,l=[];this.W.kh(a)[G](function(a){for(var b=this.W.be(a),b=this.W.Oe(a)?g:b[0],b=this.ra.bg(b),c=0;null!=b&&l[D]<k;)0!=b.ob(a,l)?c=0:c++,b=2==c?null:b[qb]()},this);return nf(l,b,c,d)};ua(I,function(){this.ra=tf(this);this.Mb[x]()});I.A=function(a){return this.ra.A(a)};
I.min=function(){return this.ed(K(this.W.min,this.W))};I.max=function(){return this.ed(K(this.W.max,this.W))};I.ed=function(a){var b=this.ra.Jd(),c=this.ra.ig();if(0==b.b[D]&&0==c.b[D])return[null,null];var d=b.b[0],b=b.C[0],g=c.b[c.b[D]-1],c=c.C[c.b[D]-1];return 1==a(d,g)?[d,this.sf?[b]:b]:[g,this.sf?[c]:c]};I.Ha=H("sf");I.Lc=H("W");I.Te=function(a,b){return null!=a?-1==this.W[Ab](a,b):!1};I.Va=function(a,b){return null!=a?0==this.W[Ab](a,b):!1};
I.Ja=function(){for(var a=[],b=this.ra.Jd();b;)a[z](new gd(b.za,[b.b,b.C])),b=b.Aa;return a};function uf(a,b,c,d){a=new pf(b,a,c);d=vf(d,a);a.ra=d;return a}function wf(a,b){this.za=a;this.B=b;this.qb=0;this.Aa=this.Cb=this.G=null;this.b=[];this.C=[];this.i=[]}function tf(a){return new wf(hd++,a)}I=wf[t];I.ga=function(){return 0==this.qb};I.Ag=function(){return null==this.G};ya(I,H("Aa"));
function xf(a){function b(a){return null!=a?a.za[E]():"_"}var c=a.za+"["+a.b[m]("|")+"]",d=a.i.map(function(a){return a.za})[m]("|"),g=a.C[m]("/"),k=b(a.Cb)+"{",k=a.ga()?k+g:k+d,k=k+"}"+b(a.G);a.Aa&&(a=xf(a.Aa),c=c+"  "+a[0],k=k+"  "+a[1]);return[c,k]}f(I,function(){var a="",b=xf(this),a=a+(b[0]+"\n"+b[1]+"\n");this.i[D]&&(a+=this.i[0][E]());return a});I.Jd=function(){return this.ga()?this:this.i[0].Jd()};I.ig=function(){return this.ga()?this:this.i[this.i[D]-1].ig()};
function yf(a,b){b&&(b.Cb=a);a&&(a.Aa=b)}function qf(a,b){for(var c=b[D],d=0,g=tf(a),k=g;0<c;){var l=768<=c?511:257<=c&&511>=c?c:257,p=b[n](d,d+l);g.b=p.map(function(a){return a.key});g.C=p.map(function(a){return a[w]});d+=l;c-=l;0<c&&(l=tf(g.B),yf(g,l),g=l)}return k}function zf(a){var b=a[0],c=tf(b.B);c.qb=b.qb+1;c.i=a;for(b=0;b<a[D];++b)a[b].G=c,0<b&&c.b[z](a[b].b[0]);return c}
function rf(a){var b=a,c=[];do c[z](b),b=b.Aa;while(b);if(512>=c[D])b=zf(c);else{var d=c[D],g=0,b=tf(a.B);for(b.qb=a.qb+2;0<d;){a=768<=d?511:257<=d&&511>=d?d:257;var k=c[n](g,g+a),l=zf(k);l.G=b;b.i[D]&&(b.b[z](k[0].b[0]),yf(b.i[b.i[D]-1],l));b.i[z](l);g+=a;d-=a}}return b}I.get=function(a){var b=this.ld(a);if(this.ga()){var c=sf;this.B.Va(this.b[b],a)&&(c=c[Sa](this.C[b]));return c}b=this.B.Va(this.b[b],a)?b+1:b;return this.i[b].get(a)};
I.A=function(a){var b=this.ld(a);return this.B.Va(this.b[b],a)?!0:this.ga()?!1:this.i[b].A(a)};wa(I,function(a,b){this.Tf(a,-1,b);if(this.Ag()){var c=this;1==this.i[D]&&(c=this.i[0],c.G=null);return c}return this});function Af(a){return a.ga()?a.b[0]:Af(a.i[0])}I.Ed=function(){this.b=[];for(var a=1;a<this.i[D];++a)this.b[z](Af(this.i[a]))};
I.Tf=function(a,b,c){var d=this.ld(a),g=this.ga();if(!g){var k=this.B.Va(this.b[d],a)?d+1:d;if(this.i[k].Tf(a,k,c))this.Ed();else return!1}else if(!this.B.Va(this.b[d],a))return!1;if(this.b[D]>d&&this.B.Va(this.b[d],a)){if(Mb(c)&&!this.B.Ha()&&g&&(k=this.C[d],c=uc(k,vc,!1,c),0<=c&&oc(k,c)&&this.B.ib()[y](a,1),this.C[d][D]))return!1;this.b[B](d,1);g&&(g=this.B.Ha()?1:this.C[d][D],this.C[B](d,1),this.B.ib()[y](a,g))}256>this.b[D]&&!this.Ag()&&(this.kl()||this.xk(b));return!0};
I.kl=function(){var a=null,b,c,d;if(this.Aa&&256<this.Aa.b[D])a=this.Aa,c=b=0,d=this.b[D]+1;else if(this.Cb&&256<this.Cb.b[D])a=this.Cb,b=this.Cb.b[D]-1,c=this.ga()?b:b+1,d=0;else return!1;this.b[B](d,0,a.b[b]);a.b[B](b,1);b=this.ga()?this.C:this.i;var g=null;this.ga()?g=a.C:(g=a.i,g[c].G=this);b[B](d,0,g[c]);g[B](c,1);a.ga()||(a.Ed(),this.Ed());return!0};
I.xk=function(a){var b,c,d;this.Aa&&511>this.Aa.b[D]?(b=this.Aa,d=c=0):this.Cb&&(b=this.Cb,c=b.b[D],d=b.ga()?b.C[D]:b.i[D]);c=[c,0][Sa](this.b);e[t][B][yb](b.b,c);c=null;this.ga()?c=this.C:(c=this.i,c[G](function(a){a.G=b}));c=[d,0][Sa](c);e[t][B][yb](b.ga()?b.C:b.i,c);yf(this.Cb,this.Aa);b.ga()||b.Ed();-1!=a&&(this.G.b[B](a,1),this.G.i[B](a,1))};
I.Bb=function(a,b,c){var d=this.ld(a);if(this.ga()){if(this.B.Va(this.b[d],a)){if(c)this.B.ib()[y](a,this.B.Ha()?1:this.C[d][D]),this.C[d]=this.B.Ha()?b:[b];else{if(this.B.Ha())throw new Q(201);if(!wc(this.C[d],b))throw new Q(109);}this.B.ib().add(a,1);return this}this.b[B](d,0,a);this.C[B](d,0,this.B.Ha()?b:[b]);this.B.ib().add(a,1);return 512==this.b[D]?this.hl():this}d=this.B.Va(this.b[d],a)?d+1:d;a=this.i[d].Bb(a,b,c);a.ga()||1!=a.b[D]||(this.b[B](d,0,a.b[0]),a.i[1].G=this,a.i[0].G=this,this.i[B](d,
1,a.i[1]),this.i[B](d,0,a.i[0]));return 512==this.b[D]?this.gl():this};I.hl=function(){var a=tf(this.B),b=tf(this.B);b.qb=1;b.b=[this.b[256]];b.i=[this,a];b.G=this.G;this.G=b;a.b=this.b[B](256);a.C=this.C[B](256);a.G=b;yf(a,this.Aa);yf(this,a);return b};I.gl=function(){var a=tf(this.B),b=tf(this.B);a.G=this.G;a.qb=this.qb+1;a.b=[this.b[256]];a.i=[this,b];this.b[B](256,1);b.G=a;b.qb=this.qb;b.b=this.b[B](256);b.i=this.i[B](257);b.i[G](function(a){a.G=b});this.G=a;yf(b,this.Aa);yf(this,b);return a};
I.ld=function(a){for(var b=0,c=this.b[D];b<c;){var d=b+c>>1;this.B.Te(this.b[d],a)?b=d+1:c=d}return b};I.bg=function(a){if(!this.ga()){var b=this.ld(a);this.B.Va(this.b[b],a)&&b++;return this.i[b].bg(a)}return this};
I.ob=function(a,b){function c(b,d){if(b>=d)return b;var p=k(l.ub(ia[d],a));if(0==p)return d;if(-1==p)return b;p=g(b,d);if(p==d)return b;var v=k(l.ub(ia[p],a));return 0==v?c(p,d):1==v?c(b,p-1):-1}function d(b,c,p){if(b>=c)return 0==p?c:-1;var v=k(l.ub(ia[b],a));if(0==v)return b;if(1==v)return-1;v=g(b,c);if(v==c)return 0==p?c:-1;var rb=k(l.ub(ia[v],a));return 0==rb?d(b,v,rb):-1==rb?d(v+1,c,p):d(b+1,v,rb)}function g(a,b){var c=a+b>>1;return c==a?c+1:c}function k(a){return a[0]?a[1]?0:1:-1}var l=this.B.Lc(),
p=0,v=this.b[D]-1,ia=this.b,jb=k(l.ub(ia[p],a)),rb=k(l.ub(ia[v],a));if(1==jb||-1==jb&&-1==rb)return 0;0!=jb&&(p=d(p+1,v,rb));if(-1==p)return 0;v=c(p,v);return-1==v||v<p?0:this.Fh(b,this.C[n](p,v+1))};I.Fh=function(a,b){var c=this.B.Ha()?b:yc(b);a[z][yb](a,c);return c[D]};
I.fill=function(a,b){if(this.ga())for(var c=0;c<this.C[D]&&0<a[bb];++c)if(0<a[xb]){if(a.offset=a[xb]-(this.B.Ha()?1:this.C[c][D]),0>a[xb])for(var d=this.C[c][D]+a[xb];d<this.C[c][D]&&0<a[bb];++d)b[a.nf++]=this.C[c][d],a.count--}else if(this.B.Ha())b[a.nf++]=this.C[c],a.count--;else for(d=0;d<this.C[c][D]&&0<a[bb];++d)b[a.nf++]=this.C[c][d],a.count--;else for(c=0;c<this.i[D]&&0<a[bb];++c)this.i[c].fill(a,b)};
function vf(a,b){for(var c=b.ib(),d=a.map(function(a){var d=new wf(a.id(),b);d.b=a.w()[0];d.C=a.w()[1];d.b[G](function(a,g){c.add(a,b.Ha()?1:d.C[g][D])});return d}),g=0;g<d[D]-1;++g)yf(d[g],d[g+1]);return 1<d[D]?rf(d[0]):d[0]};
...
function If(a){this.qa=a;this.eb=new P;this.md=new of;this.Mb=new of}I=If[t];oa(I,function(){return this.qa[u]()});I.add=function(a,b){if(null===a){if(this.Ha()&&!this.eb.Ma())throw new Q(201);this.eb.add(b);this.md.add(a,1)}else this.qa.add(a,b)};I.set=function(a,b){null===a?(this.eb[x](),this.md[x](),this.add(a,b)):this.qa.set(a,b)};wa(I,function(a,b){if(null===a)b?(this.eb[y](b),this.md[y](a,1)):(this.eb[x](),this.md[x]());else this.qa[y](a,b)});I.get=function(a){return null===a?this.eb.f():this.qa.get(a)};
I.Bd=function(a){return this.qa.Bd(a)};I.ib=function(){this.Mb.rl([this.qa.ib(),this.md]);return this.Mb};I.ob=function(a,b,c,d){b=this.qa.ob(a,b,c,d);return null!=a?b:b[Sa](this.eb.f())};ua(I,function(){this.eb[x]();this.qa[x]()});I.A=function(a){return null===a?!this.eb.Ma():this.qa.A(a)};I.min=function(){return this.qa.min()};I.max=function(){return this.qa.max()};I.Ja=function(){return[new gd(-2,this.eb.f())][Sa](this.qa.Ja())};I.Lc=function(){return this.qa.Lc()};I.Ha=function(){return this.qa.Ha()};
function Jf(a){this.D=a;this.Db=new jf;this.W=new Cf(1)}I=Jf[t];oa(I,H("D"));I.add=function(a){if("number"!=typeof a)throw new Q(103);this.Db.add(a)};I.set=function(a,b){this.add(a,b)};wa(I,function(a){this.Db[Ya](a)});I.get=function(a){return this.A(a)?[a]:[]};I.min=function(){return this.ed(K(this.W.min,this.W))};I.max=function(){return this.ed(K(this.W.max,this.W))};
I.ed=function(a){if(0==this.Db[Hb])return[null,null];var b=kf(this.Db)[Ka](K(function(b,d){return null===b||1==a(d,b)?d:b},this),null);return[b,[b]]};I.Bd=function(){return this.Db[Hb]};I.ob=function(a,b,c,d){var g=a||[je()];a=kf(this.Db)[Ga](function(a){return g[ab](function(b){return this.W.Ne(a,b)},this)},this);return nf(a,b,c,d)};ua(I,function(){this.Db[x]()});I.A=function(a){return this.Db.has(a)};I.Ja=function(){return[new gd(0,kf(this.Db))]};I.Lc=H("W");
...
I.Qk=function(a,b){var c=b.M(a.l(),id,1),d=Bf(a);return c.get([])[A](K(function(b){M("btree"==b[0].w().type);if(1<b[D]){if(a.ng()){var c=uf[F](void 0,d,a.l(),a.cd),l=b[n](1),p=-1;for(b=0;b<l[D];++b)if(-2==l[b].id()){p=b;break}if(-1==p)throw new Q(102);b=l[p].w();l=l[n](0);l[B](p,1);c=c(l);c=new If(c);c.eb[hb](b)}else c=uf(d,a.l(),a.cd,b[n](1));this.J.set(c)}},this))};
I.Rk=function(a,b){return b.M(a.Sb(),id,1).get([])[A](K(function(b){M("rowid"==b[0].w().type);1<b[D]&&(b=Kf(a.Sb(),b[n](1)),this.J.set(b))},this))};


function Mf(){this.V=new O}Mf[t].Fa=function(a){a.$a()[G](function(a){var c=a.Sb();if(null===this.get(c)){var d=new Jf(c);this.V.set(c,d)}a.Ea()[G](function(a){this.V.set(a.l(),Nf(a))},this)},this);return Wc()};function Nf(a){var b=Bf(a),b=new pf(a.l(),b,a.cd);return a.ng()?new If(b):b}Mf[t].get=function(a){return this.V.get(a,null)};Mf[t].set=function(a){return this.V.set(a[u](),a)};Mf[t].Pj=function(a){var b=[],c=a+".";this.V.U()[G](function(a){0==a[$a](c)&&b[z](this.V.get(a))},this);return b};
...
I.Pc=function(a){return this.gb[D]==a.gb[D]?0==this.gb[D]||this.gb[Ua](function(b,c){return b.Pc(a.gb[c])}):!1};function Pf(a,b){var c=[];a.f().map(function(a){return b.f().map(function(b){var c;if(a.Pg(b)){c=je();var l=ie(a.c,b.c,!0),l=0==l?a.Y?a:b:-1!=l?a:b;c.c=l.c;c.Y=l.Y;null===a.u||null===b.u?b=null===a.u?b:a:(l=ie(a.u,b.u,!1),b=0==l?a.ba?a:b:-1==l?a:b);c.u=b.u;c.ba=b.ba}else c=null;return c})})[G](function(a){c=c[Sa](a)});return new Of(c[Ga](function(a){return null!==a}))};
function Qf(a,b){var c=[],d=null,g=null;a.Cc(function(a){var l=b(a);null==a[Bb]()?g=l:d.ka(l);var p=a[Bb]();null!==p&&p.xa()==d.xa()&&(p=c[$a](d),-1!=p&&c[B](p,1));1<a.xa()&&c[z](l);d=a.ug()?c[c[D]-1]:l});return g}function Rf(a){return Sf(a,function(a){return a.ug()})}function Tf(a){var b=a[Bb](),c=0;null!==b&&(c=b.ca()[$a](a),b[ib](a));var d=a.ca()[n]();d[G](function(d,k){a[ib](d);null===b||b.Ec(d,c+k)});return{parent:b,children:d}}
function Uf(a,b){a.ca()[n]()[G](function(c){a[ib](c);b.ka(c)});a.ka(b)}function Vf(a){M(1==a.xa());var b=a.wb(0);M(1==b.xa());Tf(a);Uf(b,a);return b}function Wf(a,b,c){M(1==a.xa());var d=a.wb(0);M(1<d.xa());var g=d.ca()[n]();if(!g[ab](function(a){return b(a)}))return a;Tf(a);g[G](function(g,l){if(b(g)){var p=c(a);d.ce(l);p.ka(g);d.Ec(p,l)}});return d}function Xf(a,b,c,d){var g=a[Bb]();null!==g&&(a=g.ca()[$a](a),g.ce(a),g.Ec(c,a));b.ca()[n]()[G](function(a){b[ib](a);d.ka(a)});return c}
...
var ig={};J("lf.schema.DataStoreType",ig,void 0);ig.INDEXED_DB=0;ig.MEMORY=1;ig.LOCAL_STORAGE=2;ig.FIREBASE=3;ig.WEB_SQL=4;ig.OBSERVABLE_STORE=5;function jg(a,b,c,d){this.of=a;ka(this,b);this.cd=c;this.h=d}jg[t].l=function(){return this.of+"."+this[q]};jg[t].ng=function(){return this.h[ab](function(a){return a.ea.wc()})};function kg(a,b,c,d){this.D=a;this.ua=c;this.H=b;this.Yd=d;this.lb=null}J("lf.schema.Table",kg,void 0);oa(kg[t],H("D"));kg[t].bb=H("lb");kg[t].pa=function(){return this.lb||this.D};
kg[t].Gc=function(a){var b=new this.constructor(this.D);b.lb=a;b.Sk=this.Sk;return b};kg[t].as=kg[t].Gc;kg[t].createRow=kg[t].Gb;kg[t].deserializeRow=kg[t].qc;kg[t].Ea=H("ua");kg[t].xb=H("H");kg[t].getConstraint=kg[t].Hb;kg[t].ac=H("Yd");kg[t].Sb=function(){return this.D+".#"};
function T(a,b){xa(this,a);this.ic=b;this.lb=null}I=T[t];oa(I,function(){return this.ic+"("+this[kb][u]()+")"});I.l=function(){return this.ic+"("+this[kb].l()+")"};I.M=function(){return this[kb].M()};f(I,function(){return this.l()});I.Z=function(){return this[kb].Z()};I.bb=H("lb");I.Ea=function(){return[]};I.wc=Kb(!1);I.Gc=function(a){this.lb=a;return this};T[t].as=T[t].Gc;T[t].ag=function(){for(var a=[this],b=this;b instanceof T;)a[z](b[kb]),b=b[kb];return a};
...
function Mg(){}L(Mg,Kg);Mg[t].Jb=function(a){this.ia=a;this.ab(this.ia);return this.ia};Mg[t].ab=function(a){if(a instanceof Cg)for(;2<a.xa();){for(var b=new Cg,c=0;2>c;c++){var d=a.ce(0);b.ka(d)}a.Ec(b,0)}a.ca()[G](function(a){this.ab(a)},this)};
...
function Og(a,b){Ne[r](this,a,b);this.Za=a.o(Kd);this.Ib=a.o(Ld)}L(Og,Ne);Ea(Og[t],Kb(2));Og[t].Ye=function(a){0==this.Z()?this.zk(a):this.kd()};Og[t].zk=function(a){this.ae[G](function(b,c){b instanceof Je&&this.Ib.th(b,a[c])},this)};Og[t].kd=function(){var a=this.Ib.Je(this.fa().f());0!=a[D]&&(a=new Oe(this[Wa],a),this.Za.dc(a))};
...
function bh(a,b){this.global=a;this.Nk=a.o(Jd);this.Za=a.o(Kd);this.a=b}J("lf.query.BaseBuilder",bh,void 0);na(bh[t],function(){try{this.mb()}catch(a){return Xc(a)}return new N(function(a,c){var d=new Og(this[Wa],[this.$c()]);this.Za.dc(d)[A](function(c){a(c[0].Ee())},c)},this)});na(bh[t],bh[t][Qa]);bh[t].Xf=function(){var a=K(function(a){return a.nd(this.a)+"\n"},this);return Yf(this.Fe().pb(),a)};bh[t].explain=bh[t].Xf;Ba(bh[t],function(a){this.a[F](a);return this});Ba(bh[t],bh[t][F]);
bh[t].nl=function(a){return ah(this,a)};bh[t].toSql=bh[t].nl;I=bh[t];I.mb=Ib();I.hg=function(){return this.a.clone()};I.Kd=H("a");I.Fe=function(){null==this.Rg&&(this.Rg=this.Nk.Hj(this.a));return this.Rg};I.$c=function(){return{context:this.hg(),af:this.Fe()}};I.Dj=function(){return{context:this.Kd(),af:this.Fe()}};
...
function gh(a,b){switch(a){case "COUNT":case "DISTINCT":return!0;case "AVG":case "GEOMEAN":case "STDDEV":case "SUM":return 4==b||3==b;case "MAX":case "MIN":return 4==b||3==b||5==b||2==b}return!1}ma(W[t],function(){var a=new W(this[Wa],this.a.h);a.a=this.a.clone();a.a.Jc=null;return a});ma(W[t],W[t].clone);
...
function zh(a){U[r](this,1,1);this.Zd=a}L(zh,U);f(zh[t],Kb("select(?)"));zh[t].nd=function(a){a=a.Ld(this.Zd);return this[E]()[eb]("?",a[E]())};zh[t].la=function(a,b,c){return[c.Ld(this.Zd).eval(b[0])]};
...
function Hh(){U[r](this,1,1)}L(Hh,U);f(Hh[t],Kb("limit(?)"));Hh[t].nd=function(a){return this[E]()[eb]("?",a.na[E]())};Hh[t].la=function(a,b,c){b[0][C][B](c.na);return b};
...
function Mh(){U[r](this,1,1)}L(Mh,U);f(Mh[t],Kb("skip(?)"));Mh[t].nd=function(a){return this[E]()[eb]("?",a.ja[E]())};Mh[t].la=function(a,b,c){return[new le(b[0][C][n](c.ja),b[0].X())]};
...
function Zh(){this.fc=this.Xa=this.hb=this.Qc=null}Zh[t].releaseLock=function(a){this.Qc==a&&(this.Qc=null);this.hb==a&&(this.hb=null);null===this.Xa||this.Xa[y](a);null===this.fc||this.fc[y](a)};Zh[t].Xh=function(a,b){var c=null===this.Xa||this.Xa.Ma();return 0==b?(null===this.fc||this.fc.Ma())&&c&&null===this.Qc&&null!==this.hb&&this.hb==a:3==b?null===this.Qc&&null===this.hb&&null!==this.Xa&&this.Xa[ub](a):1==b?null===this.hb:c&&(null===this.hb||this.hb==a)};
Zh[t].Tj=function(a,b){0==b?(this.hb=null,this.Qc=a):3==b?(null===this.fc&&(this.fc=new P),this.fc.add(a),null===this.Xa&&(this.Xa=new P),this.Xa[y](a)):1==b?(null===this.Xa&&(this.Xa=new P),this.Xa.add(a)):2==b&&(this.hb=a)};
function $h(){this.bc=new ai;this.dd=new Yh}I=$h[t];I.dc=function(a){(2>a[Db]()||2>a[Db]())&&this.dd.mi(a.fa().f());this.bc.Bb(a);this.xe();return a.Yc().ha};I.xe=function(){for(var a=this.bc.f(),b=0;b<a[D];b++){var c=a[b],d=!1;if(d=0==c.Z()?this.$g(c,1,3):this.$g(c,2,0))this.bc[y](c),this.Ti(c)}};I.$g=function(a,b,c){var d=!1,g=a.fa().f();this.dd.Zg(a.da(),g,b)&&(d=this.dd.Zg(a.da(),g,c));return d};I.Ti=function(a){a[Qa]()[A](K(this.Dk,this,a),K(this.Ck,this,a))};
I.Dk=function(a,b){this.dd.releaseLock(a.da(),a.fa().f());a.Yc()[Fb](b);this.xe()};I.Ck=function(a,b){this.dd.releaseLock(a.da(),a.fa().f());a.Yc()[La](b);this.xe()};function ai(){this.bc=[]}ai[t].Bb=function(a){wc(this.bc,a,function(a,c){var d=a[Db]()-c[Db]();return 0==d?a.da()-c.da():d})};ai[t].f=function(){return this.bc[n]()};wa(ai[t],function(a){var b=this.bc;a=ic(b,a);var c;(c=0<=a)&&oc(b,a);return c});
...
I.Je=function(a){var b=new P;a[G](function(a){b.add(a[u]())});var c=[];this.sc.f()[G](function(a){a=a.$c();a[ob].c[ab](function(a){return b[ub](a[u]())})&&c[z](a)});return c};I.th=function(a,b){var c=this.He(null!=a.Jc?a.Jc:a),c=this.sc.get(c,null);return null!==c?(c.ul(b),!0):!1};function ei(a){this.Sh=a;this.gd=new P;this.Ak=[];this.Fg=null;this.Fi=new bi(a.Kd(),this.Ak)}I=ei[t];I.je=function(a){this.gd[ub](a)?ec("Attempted to register observer twice."):this.gd.add(a)};I.ff=function(a){return this.gd[y](a)};
...
function gi(a,b){this.m=a;this.Fb=a.o(Gd);this.Za=a.o(Kd);this.Ib=a.o(Ld);this.sa=new P(b);this.Wa=new ge(this.m,this.sa.f());this.cc=ad();this.Rc=ad();this.vf=ad()}I=gi[t];na(I,function(){this.vf[Fb]();return this.Rc.ha});I.Z=Kb(1);I.fa=H("sa");I.Yc=H("cc");I.da=function(){return Vb(this)};Ea(I,Kb(2));I.xh=function(){this.Za.dc(this);return this.vf.ha};
I.Ph=function(a){a=a.$c();return a.af.pb()[Qa](this.Wa,a[ob])[A](function(a){return a[0].Ee()},K(function(a){this.Wa.Kb();var c=new Sc(a[q]);this.Rc[La](c);throw a;},this))};I.oa=function(){this.Fb.Qb(this.Z(),this.Wa).oa()[A](K(function(){this.kd();this.Rc[Fb]()},this),K(function(a){this.Wa.Kb();this.Rc[La](a)},this));return this.cc.ha};I.Kb=function(){this.Wa.Kb();this.Rc[Fb]();return this.cc.ha};I.kd=function(){var a=this.Ib.Je(this.sa.f());0!=a[D]&&(a=new Oe(this.m,a),this.Za.dc(a))};
function hi(a){this.m=a;this.Za=a.o(Kd);this.od=null;this.Ka=0}J("lf.proc.Transaction",hi,void 0);var ii=new O(0,new P([1,4]),1,new P([2]),2,new P([3,5,6]),3,new P([2,7]),4,new P([7]),5,new P([7]),6,new P([7]));hi[t].Qa=function(a){var b=ii.get(this.Ka,null);if(null===b||!b[ub](a))throw new Q(107,this.Ka,a);this.Ka=a};
na(hi[t],function(a){this.Qa(4);var b=[];try{a[G](function(a){a.mb();b[z](a.$c())},this)}catch(c){return this.Qa(7),Xc(c)}a=new Og(this.m,b);return this.Za.dc(a)[A](K(function(a){this.Qa(7);return a.map(function(a){return a.Ee()})},this),K(function(a){this.Qa(7);throw a;},this))});na(hi[t],hi[t][Qa]);hi[t].Qh=function(a){this.Qa(1);this.od=new gi(this.m,a);return this.od.xh()[A](K(function(){this.Qa(2)},this))};hi[t].begin=hi[t].Qh;
hi[t].Oh=function(a){this.Qa(3);return this.od.Ph(a)[A](K(function(a){this.Qa(2);return a},this),K(function(a){this.Qa(7);throw a;},this))};hi[t].attach=hi[t].Oh;hi[t].oa=function(){this.Qa(5);return this.od.oa()[A](K(function(){this.Qa(7)},this))};hi[t].commit=hi[t].oa;hi[t].Kb=function(){this.Qa(6);return this.od.Kb()[A](K(function(){this.Qa(7)},this))};hi[t].rollback=hi[t].Kb;
...
function Y(a,b,c,d,g,k){this.O=a;this.D=b;this.Bg=c;this.vg=d;this.sh=g;this.lb=k||null}J("lf.schema.BaseColumn",Y,void 0);I=Y[t];oa(I,H("D"));I.l=function(){return this.O.pa()+"."+this.D};f(I,function(){return this.l()});I.M=H("O");I.Z=H("sh");I.bb=H("lb");I.Ea=function(){null==this.ua&&(this.ua=[],this.M().Ea()[G](function(a){-1!=a.h.map(function(a){return a.ea[u]()})[$a](this.D)&&this.ua[z](a)},this));return this.ua};I.wc=H("vg");I.cd=H("Bg");I.Va=function(a){return hg(this,a,"eq")};Y[t].eq=Y[t].Va;
...
function Z(a){this.D=a;this.H=new Cd;this.rf=new jf;this.pd=new jf;this.Ud=new jf;var b=this.D;this.Ac="pk"+(b[0].toUpperCase()+b.substring(1));this.ua=new Cd;this.Yd=!1;this.oc(a);this.Yf=[]}J("lf.schema.TableBuilder",Z,void 0);function oi(a){ka(this,a[q]);this.rb=a.order;this.autoIncrement=a[pb]}var pi=new jf([0,6]);Z[t].oc=function(a){if(!/^[A-Za-z_][A-Za-z0-9_]*$/.test(a))throw new Q(502,a);if(this.H.has(a)||this.ua.has(a)||this.pd.has(a))throw new Q(503,this.D+"."+a);};
...
Z[t].Kf=function(a,b){if(1<b[D]){var c=b[Ga](function(a){return this.Ud.has(a[q])},this);if(0<c[D])throw new Q(507,a,c[m](","));}};Z[t].ac=Jb("Yd");Z[t].persistentIndex=Z[t].ac;Z[t].zb=function(){return new (this.tj())};Z[t].getSchema=Z[t].zb;Z[t].Wc=H("Yf");
Z[t].Td=function(a,b,c,d){var g=a,g="string"==typeof a[0]?a.map(function(a){return new oi({name:a,order:null!=c?c:1,autoIncrement:d||!1})}):a.map(function(a){return new oi(a)});g[G](function(a){if(!this.H.has(a[q]))throw new Q(508,this.D,a[q]);if(b){var c=this.H.get(a[q]);if(0==c||6==c)throw new Q(509,this.D,a[q]);}},this);return g};
Z[t].tj=function(){function a(){function a(c){return b.ua.get(c).map(function(a){return{ea:this[a[q]],rb:a.rb,autoIncrement:a[pb]}},this)}var d=Dd(b.H).map(function(a){this[a]=new Y(this,a,b.rf.has(a),b.Ud.has(a),b.H.get(a));return this[a]},this),g=Dd(b.ua).map(function(d){return new jg(b.D,d,b.pd.has(d),a[r](this,d))},this);kg[r](this,b.D,d,g,b.Yd);var k=b.ua.has(b.Ac)?new jg(b.D,b.Ac,!0,a[r](this,b.Ac)):null,l=d[Ga](function(a){return!b.Ud.has(a[u]())});this.ri=new mi(k,l,b.Wc());this.dh=b.pj(d,
g)}var b=this;L(a,kg);a[t].Gb=function(a){return new this.dh(hd++,a)};a[t].createRow=a[t].Gb;a[t].qc=function(a){var b={};this.xb()[G](function(g){var k=g[u]();g=g.Z();var l=a[w][k];if(0==g)if(null===l)g=l;else if(g=l,""==g)g=null;else{0!=g[D]%2&&(g="0"+g);for(var l=new ArrayBuffer(g[D]/2),p=new Uint8Array(l),v=0,ia=0;v<g[D];v+=2)p[ia++]=da(g.substr(v,2),16);g=l}else g=2==g?null===l?l:new Date(l):l;b[k]=g},this);return new this.dh(a.id,b)};a[t].deserializeRow=a[t].qc;a[t].Hb=H("ri");a[t].getConstraint=
a[t].Hb;return a};
Z[t].pj=function(a,b){function c(c,d){this.H=a;this.ua=b;gd[r](this,c,d)}L(c,gd);c[t].Sf=function(){var a={};this.H[G](function(b){a[b[u]()]=b.wc()?null:ce[b.Z()]});return a};c[t].ph=function(){var a={};this.H[G](function(b){var c=b[u]();b=b.Z();var d=this.w()[c];a[c]=0==b?null!=d?kd(d):null:2==b?null!=d?d[Eb]():null:d},this);return a};var d=K(function(a){var b=this.H.get(a[u]());return 2==b?function(b){b=b[a[u]()];return a.wc()&&null===b?null:b[Eb]()}:1==b?function(b){return a.wc()?(b=b[a[u]()],
null===b?null:b?1:0):b[a[u]()]?1:0}:function(b){return b[a[u]()]}},this),g=K(function(a){var b=a.map(function(a){return d(a.ea)});return function(a){return b.map(function(b){return b(a)})}},this),k={};b[G](function(a){var b=a.l();a=1==a.h[D]?d(a.h[0].ea):g(a.h);k[b]=a});c[t].Vb=function(a){return-1!=a[$a]("#")?this.id():k[tb](a)?k[a](this.w()):null};return c};
function qi(a,b){this.s=new ri(a,b);this.tb=new O;this.Sc=!1}J("lf.schema.Builder",qi,void 0);I=qi[t];I.di=function(a){a.Wc()[G](function(b){var c=b.fb;if(!this.tb.A(c))throw new Q(536,b[q]);var c=this.tb.get(c).zb(),d=b.zc;if(!c[tb](d))throw new Q(537,b[q]);if(a.zb()[b.pc].Z()!=c[d].Z())throw new Q(538,b[q]);if(!c[d].cd())throw new Q(539,b[q]);},this)};I.ci=function(a){a.Wc()[G](function(a){this.tb.get(a.fb).Wc()[G](function(c){if(c.pc==a.zc)throw new Q(534,a[q]);},this)},this)};
I.$i=function(){this.Sc||(this.tb.f()[G](function(a){this.di(a);this.s.cl(a.zb())},this),this.tb.f()[G](this.ci,this),this.bi(),this.tb[x](),this.Sc=!0)};I.If=function(a,b){a.uf||(a.uf=!0,a.Xe=!0,a.Vf[G](function(c){c=b.get(c);if(!c.uf)this.If(c,b);else if(c.Xe&&a!=c)throw new Q(533);},this));a.Xe=!1};I.bi=function(){var a=new Cd;this.s.I.U()[G](function(b){a.set(b,new si(b))},this);this.tb[G](function(b,c){b.Wc()[G](function(b){a.get(b.fb).Vf.add(c)})});Ed(a)[G](function(b){this.If(b,a)},this)};
function si(a){this.Xe=this.uf=!1;this.Vf=new jf;this.of=a}I.zb=function(){this.Sc||this.$i();return this.s};qi[t].getSchema=qi[t].zb;qi[t].eg=function(){var a=new Fd("ns_"+this.s[q]()),b;ki||(ki=new ji);b=ki;var c=null;b.Re(a)?c=b.o(a):(c=new ji,b.sb(a,c));return c};qi[t].getGlobal=qi[t].eg;qi[t].connect=function(a){var b=this.eg();b.Re(Md)||b.sb(Md,this.zb());return(new X(b)).Fa(a)};qi[t].connect=qi[t].connect;
qi[t].yi=function(a){if(this.tb.A(a))throw new Q(503,a);if(this.Sc)throw new Q(535);this.tb.set(a,new Z(a));return this.tb.get(a)};qi[t].createTable=qi[t].yi;qi[t].mf=function(a){if(this.Sc)throw new Q(535);this.s.mf(a);return this};qi[t].setPragma=qi[t].mf;function ri(a,b){this.D=a;this.Ta=b;this.I=new O;this.Ug={Gi:!1}}J("lf.schema.DatabaseSchema",ri,void 0);ka(ri[t],H("D"));ka(ri[t],ri[t][q]);ri[t].version=H("Ta");ri[t].version=ri[t][vb];ri[t].$a=function(){return this.I.f()};ri[t].tables=ri[t].$a;
