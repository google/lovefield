...
lf.backstore.IndexedDB.prototype.createIndexTable_=function(a,b,c,d){a.objectStoreNames.contains(c)||(a.createObjectStore(c,{keyPath:"id"}),a=b.objectStore(c),a.put(lf.index.IndexMetadataRow.forType(d).serialize()))};
...
lf.backstore.Memory.prototype.initTable_=function(a){this.createTable_(a.getName());if(a.persistentIndex()){var b=a.getIndices();b.forEach(function(a){this.createIndexTable_(a.getNormalizedName(),lf.index.IndexMetadata.Type.BTREE)},this);this.createIndexTable_(a.getRowIdIndexName(),lf.index.IndexMetadata.Type.ROW_ID)}};lf.backstore.Memory.prototype.createIndexTable_=function(a,b){var c=this.createTable_(a);goog.isNull(c)||c.put([lf.index.IndexMetadataRow.forType(b)])};
...
lf.cache.Journal.prototype.getIndexScope=function(){var a=[],b=this.scope_.getValues();b.forEach(function(b){if(b.persistentIndex()){var d=b.getIndices();d.forEach(function(b){a.push(b.getNormalizedName())});a.push(b.getName()+".#")}});return a};lf.cache.Journal.prototype.getIndexRange=function(a,b){var c=new goog.structs.Set,d=this.indexStore_.get(a.getNormalizedName());b.forEach(function(a){c.addAll(d.getRange(a))},this);return c.getValues()};
...
lf.cache.Prefetcher.prototype.reconstructPersistentIndex_=function(a,b){var c=b.getTable(a.getNormalizedName(),lf.Row.deserialize);return c.get([]).then(goog.bind(function(b){goog.asserts.assert(b[0].payload().type==lf.index.IndexMetadata.Type.BTREE);1<b.length&&(b=lf.index.BTree.deserialize(b.slice(1),a.getNormalizedName(),a.isUnique),this.indexStore_.set(b))},this))};
lf.cache.Prefetcher.prototype.reconstructPersistentRowIdIndex_=function(a,b){var c=b.getTable(a.getRowIdIndexName(),lf.Row.deserialize);return c.get([]).then(goog.bind(function(b){goog.asserts.assert(b[0].payload().type==lf.index.IndexMetadata.Type.ROW_ID);1<b.length&&(b=lf.index.RowId.deserialize(a.getRowIdIndexName(),b.slice(1)),this.indexStore_.set(b))},this))};
...
lf.index.MemoryIndexStore.createIndex_=function(a){return new lf.index.BTree(a.getNormalizedName(),a.isUnique)};lf.index.MemoryIndexStore.prototype.get=function(a){return this.store_.get(a,null)};lf.index.MemoryIndexStore.prototype.set=function(a){return this.store_.set(a.getName(),a)};lf.index.MemoryIndexStore.prototype.getTableIndices=function(a){var b=[],c=a+".";this.store_.getKeys().forEach(function(a){0==a.indexOf(c)&&b.push(this.store_.get(a))},this);return b};
...
lf.DiffCalculator.prototype.applyDiff=function(a,b,c){var d=goog.isNull(a)?[]:a.entries,e=goog.math.longestCommonSubsequence(d,b.entries,goog.bind(this.comparator_,this),function(a){return d[a]});a=c?[]:null;for(var f=0,g=0;g<d.length;g++){var h=d[g];e[f]==h?f++:(h=this.observableResults_.splice(g,1),c&&(h=lf.DiffCalculator.createChangeRecord_(g,h,0,this.observableResults_),a.push(h)))}e=goog.math.longestCommonSubsequence(d,b.entries,goog.bind(this.comparator_,this),function(a,c){return b.entries[c]});
for(g=f=0;g<b.entries.length;g++)h=b.entries[g],e[f]==h?f++:(this.observableResults_.splice(g,0,h.row.payload()),c&&(h=lf.DiffCalculator.createChangeRecord_(g,[],1,this.observableResults_),a.push(h)));return a};lf.DiffCalculator.createChangeRecord_=function(a,b,c,d){return{addedCount:c,index:a,object:d,removed:b,type:"splice"}};
...
lf.ObserverRegistry.Entry_=function(a){this.query_=a;this.observers_=new goog.structs.Set;this.observable_=[];this.lastResults_=null;this.lastResultVersion_=-1;this.diffCalculator_=new lf.DiffCalculator(a,this.observable_);this.hasNativeSupport_=lf.ObserverRegistry.Entry_.hasNativeSupport_()};
lf.ObserverRegistry.Entry_.prototype.addObserver=function(a){this.observers_.contains(a)?goog.asserts.fail("Attempted to register observer twice."):(this.hasNativeSupport_&&Array.observe(this.observable_,a),this.observers_.add(a))};lf.ObserverRegistry.Entry_.prototype.removeObserver=function(a){this.hasNativeSupport_&&Array.unobserve(this.observable_,a);return this.observers_.remove(a)};lf.ObserverRegistry.Entry_.prototype.getQuery=function(){return this.query_};
lf.ObserverRegistry.Entry_.prototype.hasObservers=function(){return 0<this.observers_.getCount()};lf.ObserverRegistry.Entry_.prototype.updateResults=function(a){var b=this.diffCalculator_.applyDiff(this.lastResults_,a,!this.hasNativeSupport_);this.lastResults_=a;this.lastResultVersion_=this.query_.currentVersion;this.hasNativeSupport_||this.observers_.getValues().forEach(function(a){a(b)})};
lf.ObserverRegistry.Entry_.hasNativeSupport_=function(){return"function"==typeof Array.observe&&"function"==typeof Array.unobserve};
