...
function Q(a,b){this.code=a;this.message="http://sn.im/2a0j3wn?c="+a;if(1<arguments[D])for(var c=1;c<=ba.min(4,arguments[D]-1);++c)this.message+="&p"+(c-1)+"="+encodeURIComponent(ia(arguments[c][E]()[n](0,64)))}L(Q,fa);
...
I.ib=H("Mb");I.Vc=function(a,b,c){b=ba.min(this.Mb.Ra-c,b);if(0==b)return[];var d=e(b);this.ra.fill({offset:a?this.Mb.Ra-b-c:c,count:b,nf:0},d);return a?d[fb]():d};
...
I.ob=function(a,b){function c(b,d){if(b>=d)return b;var p=k(l.ub(ha[d],a));if(0==p)return d;if(-1==p)return b;p=g(b,d);if(p==d)return b;var v=k(l.ub(ha[p],a));return 0==v?c(p,d):1==v?c(b,p-1):-1}function d(b,c,p){if(b>=c)return 0==p?c:-1;var v=k(l.ub(ha[b],a));if(0==v)return b;if(1==v)return-1;v=g(b,c);if(v==c)return 0==p?c:-1;var rb=k(l.ub(ha[v],a));return 0==rb?d(b,v,rb):-1==rb?d(v+1,c,p):d(b+1,v,rb)}function g(a,b){var c=a+b>>1;return c==a?c+1:c}function k(a){return a[0]?a[1]?0:1:-1}var l=this.C.Mc(),
p=0,v=this.b[D]-1,ha=this.b,jb=k(l.ub(ha[p],a)),rb=k(l.ub(ha[v],a));if(1==jb||-1==jb&&-1==rb)return 0;0!=jb&&(p=d(p+1,v,rb));if(-1==p)return 0;v=c(p,v);return-1==v||v<p?0:this.Fh(b,this.D[n](p,v+1))};I.Fh=function(a,b){var c=this.C.Ha()?b:yc(b);a[z][yb](a,c);return c[D]};
...
I.Mi=function(a,b,c){for(var d=[],g=a.X(),k=b.X(),l=0;l<a[C][D];l++){for(var p=!1,v=0;v<b[C][D];v++)if(this.Dd(a[C][l].S(this.Na),b[C][v].S(this.Ca))){var p=!0,ha=ue(a[C][l],g,b[C][v],k);d[z](ha)}c&&!p&&d[z](this.Pf(a[C][l],g))}a=a.X()[Sa](b.X());return new le(d,a)};
I.Li=function(a,b,c){var d=a,g=b,k=this.Na,l=this.Ca;if(c||a[C][D]>b[C][D])d=b,g=a,k=this.Ca,l=this.Na;var p=new fg,v=[];d[C][G](function(a){var b=ia(a.S(k));p.add(b,a)});var ha=d.X(),jb=g.X();g[C][G](function(a){var b=ia(a.S(l));p.A(b)?p.get(b)[G](function(b){b=ue(a,jb,b,ha);v[z](b)}):c&&v[z](this.Pf(a,jb))}[F](this));a=a.X()[Sa](b.X());return new le(v,a)};
...
function Ng(){U[r](this,2,0)}L(Ng,U);f(Ng[t],Kb("cross_product"));Ng[t].la=function(a,b){for(var c=b[0],d=b[1],g=[],k=c.X(),l=d.X(),p=0;p<c[C][D];p++)for(var v=0;v<d[C][D];v++){var ha=ue(c[C][p],k,d[C][v],l);g[z](ha)}c=c.X()[Sa](d.X());return[new le(g,c)]};
...
Z[t].Td=function(a,b,c,d){var g=a,g="string"==typeof a[0]?a.map(function(a){return new oi({name:a,order:c||1,autoIncrement:d||!1})}):a.map(function(a){return new oi(a)});g[G](function(a){if(!this.H.has(a[q]))throw new Q(508,this.B,a[q]);if(b){var c=this.H.get(a[q]);if(0==c||6==c)throw new Q(509,this.B,a[q]);}},this);return g};
