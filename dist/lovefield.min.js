...
lf.tree.find=function(a,b,c){var d=c||function(){return!1},e=[],f=function(a){b(a)&&e.push(a);d(a)||a.getChildren().forEach(f)};f(a);return e};lf.tree.toString=function(a,b){var c=b||function(a){return a.toString()+"\n"},d="";a.traverse(function(a){for(var b=0;b<a.getDepth();b++)d+="-";d+=c(a)});return d};
