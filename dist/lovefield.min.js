...
b);var c=new lf.ObserverRegistry;e.registerService(lf.service.OBSERVER_REGISTRY,c);return b.init(a)}).then(function(){var b=new lf.cache.Prefetcher(e);return b.init(a)})};lf.base.closeDatabase=function(){var a=lf.Global.get();try{var b=a.getService(lf.service.BACK_STORE);b.close()}catch(c){}};
