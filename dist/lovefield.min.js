...
m.lc=function(a){Gb(this);var b=0,c=this.Na,d=this,e=new Bb;e.next=function(){if(c!=d.Na)throw Error("The map has changed since the iterator was created");if(b>=d.b.length)throw Ab;var e=d.b[b++];return a?e:d.o[e]};return e};function Ib(a,b){return Object.prototype.hasOwnProperty.call(a,b)};/*
 ...
 limitations under the License.
*/
function A(){this.o=new Fb;Object.defineProperty(this,"size",{get:function(){return this.o.yc()}})}A.prototype.clear=function(){this.o.clear()};A.prototype.clear=A.prototype.clear;A.prototype.delete=function(a){return this.o.remove(a)};A.prototype["delete"]=A.prototype.delete;A.prototype.forEach=function(a,b){return this.o.forEach(a,b)};A.prototype.forEach=A.prototype.forEach;A.prototype.get=function(a){return this.o.get(a)};A.prototype.get=A.prototype.get;A.prototype.has=function(a){return this.o.Ka(a)};
...
Rd.prototype.bind=function(a){Rd.Hb.bind.call(this,a);null!=this.Qb&&(this.W=a[this.Qb.ua()]);null!=this.Xb&&(this.N=a[this.Xb.ua()]);Qd(this,a);return this};function Td(a,b){this.Aa=a;this.$=b}Td.prototype.gb=f("Aa");Td.prototype.Z=f("$");function Ud(a){var b=D();a.forEach(function(a){a.Z().forEach(b.add.bind(b))});return b};function Vd(a,b){this.global=a;this.Oa=a.i(Sb);this.sd=b.map(function(a){return a.context});this.Ve=b.map(function(a){return a.de});this.xe=Ud(this.Ve);this.lf=Wd(this);this.bb=x()}function Wd(a){return a.sd.some(function(a){return!(a instanceof Rd)})?1:0}m=Vd.prototype;
m.exec=function(){function a(){var g=d.shift();if(g){var h=e[c.length];return g.gb().exec(b,h).then(function(b){c.push(b[0]);return a()})}return w()}var b=new Vc(this.global,this.xe),c=[],d=this.Ve.slice(),e=this.sd;return a().then(function(){return this.Oa.Cb(this.lf,b).ia()}.bind(this)).then(function(){this.ae(c);return c}.bind(this),function(a){b.Gb();throw a;})};m.I=f("lf");m.Z=f("xe");m.Mb=f("bb");m.V=function(){return ka(this)};m.ae=aa();function Xd(a,b){Vd.call(this,a,b);this.Fb=a.i(Yb)}t(Xd,Vd);Xd.prototype.getPriority=l(0);Xd.prototype.ae=function(a){this.sd.forEach(function(b,c){Yd(this.Fb,b,a[c])},this)};function Zd(a,b){this.h=a;this.Fb=a.i(Yb);this.Ba=a.i(Xb);this.ld=new wc(a);this.pb=b;var c=a.i(Zb),d=this.pb.map(function(a){return c.table(a.getName())});this.$=D(d);this.bb=x()}m=Zd.prototype;m.exec=function(){this.ld.update(this.pb);this.Oc();return w()};m.I=l(1);m.Z=f("$");m.Mb=f("bb");m.V=function(){return ka(this)};m.getPriority=l(1);m.Oc=function(){var a=$d(this.Fb,this.$);0!=a.length&&(a=new Xd(this.h,a),ae(this.Ba,a))};function be(a){this.h=a;this.Oa=a.i(Sb);this.Ba=a.i(Xb)}be.prototype.Zd=function(a){a=new Zd(this.h,a);ae(this.Ba,a)};function M(a,b){this.Na=a;this.j=b;this.Ua=B()}r("lf.backstore.FirebaseRawBackStore",M);M.prototype.gd=f("j");M.prototype.hd=function(){throw new E(351);};function ce(a,b){var c=x(),d=a;b.length&&(d=a.child(b));d.once("value",function(a){c.resolve(a.val())},function(a){c.reject(a)});return c.ga}function de(a,b,c){function d(a){a?e.reject(a):e.resolve()}c=c||!1;var e=x();c?a.set(b,d):a.update(b,d);return e.ga}
M.prototype.Ea=function(a){return ce(this.j,"@rev/R").then(function(a){this.La=a;return ce(this.j,"@table")}.bind(this)).then(function(b){var c=0,d;for(d in b)this.Ua.set(d,b[d]),b[d]>c&&(c=b[d]);a.ra().forEach(function(a){this.Ua.has(a.getName())||(b[a.getName()]=++c)},this);d=this.j.child("@table");return de(d,b)}.bind(this))};
function ee(a,b,c){var d=a.Ua.get(b);return null!=d?function(){var a={},b=x();this.j.orderByChild("T").equalTo(d).once("value",function(d){d.forEach(function(b){var d=c(b.val());a[parseInt(b.key(),10)]=d});b.resolve(a)});return b.ga}.call(a).then(function(a){a["@rev"]={R:++this.La};return de(this.j,a)}.bind(a)):w()}M.prototype.rc=function(a){return ee(this,a,l(null)).then(function(){this.Ua.delete(a);return de(this.j.child("@table/"+a),null,!0)}.bind(this))};M.prototype.dropTable=M.prototype.rc;
M.prototype.mc=function(a,b,c){return ee(this,a,function(a){var e=a.P;e[b]=c;return{R:this.La+1,T:a.T,P:e}}.bind(this))};M.prototype.addTableColumn=M.prototype.mc;M.prototype.sc=function(a,b){return ee(this,a,function(a){var d=a.P;delete d[b];return{R:this.La+1,T:a.T,P:d}}.bind(this))};M.prototype.dropTableColumn=M.prototype.sc;M.prototype.Nc=function(a,b,c){return ee(this,a,function(a){var e=a.P;e[c]=e[b];delete e[b];return{R:this.La+1,T:a.T,P:e}}.bind(this))};M.prototype.renameTableColumn=M.prototype.Nc;
M.prototype.sb=function(){throw new E(351);};M.prototype.createRow=M.prototype.sb;M.prototype.Cc=f("Na");M.prototype.getVersion=M.prototype.Cc;M.prototype.cc=function(a){var b=x();a=this.Ua.get(a);this.j.orderByChild("T").equalTo(a).once("value",function(a){var d=[];a.forEach(function(a){d.push(a.val().P)});b.resolve(d)});return b.ga};M.prototype.dump=function(){var a={},b=Jb(this.Ua).map(function(b){return this.cc(b).then(function(d){a[b]=d})}.bind(this));return cb(b).then(function(){return a})};
...
fe.prototype.oc=function(){var a=this.Ra.pb;if(0==a.size)this.X.resolve();else{var b=this.j.La+1;this.j.La=b;var c={"@rev":{R:b}};a.forEach(function(a,e){var g=this.j.Ua.get(e);a.Ca.forEach(function(a,d){c[d]={R:b,T:g,P:a.s}});a.pa.forEach(function(a,d){c[d]={R:b,T:g,P:a[1].s}});a.Da.forEach(function(a,b){c[b]=null})},this);this.j.j.update(c,function(c){null===c?this.X.resolve():(this.j.La=b-1,c=C(a).map(function(a){return ge(this.j,a.getName())},this),cb(c).then(this.X.reject.bind(this.X),this.X.reject.bind(this.X)))}.bind(this))}return this.X.ga};function he(){this.ta=B()}function ie(a,b){if(0==b.length)return C(a.ta);var c=[];b.forEach(function(a){a=this.ta.get(a)||null;null===a||c.push(a)},a);return c}he.prototype.getData=f("ta");he.prototype.get=function(a){return w(ie(this,a))};function je(a,b){b.forEach(function(a){this.ta.set(a.id(),a)},a)}he.prototype.put=function(a){je(this,a);return w()};function ke(a,b){0==b.length||b.length==a.ta.size?a.ta.clear():b.forEach(function(a){this.ta.delete(a)},a)}
he.prototype.remove=function(a){ke(this,a);return w()};function le(a){return 0==a.ta.size?0:Jb(a.ta).reduce(function(a,c){return a>c?a:c},0)};function me(a,b){this.m=a;this.rf=b;this.Mc=B();this.La=-1;this.L=B();this.Ua=B();this.Fd=null}m=me.prototype;
m.Ea=function(a){this.j=this.rf.child(this.m.name());var b=a||function(){return w()};return ce(this.j,"@db/version").then(function(a){return null===a?de(this.j,ne(this),!0).then(function(){var a=new M(0,this.j);return b(a)}.bind(this)):a==this.m.version()?ce(this.j,"@rev/R").then(function(a){this.La=a;return ce(this.j,"@table")}.bind(this)).then(function(a){for(var b in a)this.Ua.set(b,a[b]);a=this.m.ra().map(function(a){return ge(this,a.getName())},this);return cb(a)}.bind(this)).then(function(){oe(this);
...
function pe(a){a.j.off();a.j.on("child_removed",a.cg.bind(a));a.Gd&&(a.Gd.off(),a.Mc.clear());a.Gd=a.j.orderByChild("R").startAt(a.La+1);a.Gd.on("value",a.Zd.bind(a))}function oe(a){ob=C(a.L).map(function(a){return le(a)}).reduce(function(a,c){return a>c?a:c},0)+1}m.cg=function(a){var b=a.val(),c=this.Mc.get(b.T)||null;null===c&&(c=D(),this.Mc.set(b.T,c));c.add(parseInt(a.key(),10))};
m.Zd=function(a){var b=a.child("@rev/R").val();null!=b&&b!=this.La&&(this.La=b,a=qe(this,a),a.forEach(function(a){var b=this.L.get(a.getName()),e=Jb(a.Da);0<e.length&&ke(b,e);var g=C(a.Ca);a.pa.forEach(function(a){g.push(a[1])});je(b,g)},this),0<a.length&&this.Hc(a),pe(this))};
...
He.prototype.oc=function(){var a=null,b=this.X.reject.bind(this.X),c=function(a,b){this.X.reject(b)}.bind(this),d=[],e=function(b,h){if(null!==a){var k=h;null!=a.transform&&null!=h&&(k=a.transform(h));d.push(k);a.X.resolve(k)}0<this.Id.length?(a=k=this.Id.shift(),b.executeSql(k.pg,k.fg,e,c)):this.X.resolve(d)}.bind(this);0==this.kf?this.j.readTransaction(e,b):this.j.transaction(e,b);return this.X.ga};function O(a,b,c){this.j=c;this.h=a;this.Na=b}r("lf.backstore.WebSqlRawBackStore",O);O.prototype.gd=f("j");O.prototype.getRawDBInstance=O.prototype.gd;O.prototype.hd=function(){throw new E(356);};O.prototype.getRawTransaction=O.prototype.hd;function Je(a){return new He(a.j,new Vc(a.h,D()),1)}O.prototype.rc=function(a){var b=Je(this);Ge(b,"DROP TABLE "+a,[]);return b.ia()};O.prototype.dropTable=O.prototype.rc;
...
O.prototype.createRow=O.prototype.sb;O.prototype.Cc=f("Na");O.prototype.getVersion=O.prototype.Cc;function Le(a){Ge(a,'SELECT tbl_name FROM sqlite_master WHERE type="table"',[],function(a){for(var c=Array(a.rows.length),d=0;d<c.length;++d)c[d]=a.rows.item(d).tbl_name;return c})}
...
m.bd=function(a){if(null==a)return this.Ma().na;if(a instanceof Zc){if(dd(a))return this.Ma().na;if(ed(a))return this.get(a.c).length}return this.Za([a]).length};m.Ma=f("nb");m.xc=function(a,b,c,d){c=Array(a);this.qa.fill({offset:b?this.nb.na-a-d:d,count:a,le:0},c);return b?c.reverse():c};
...
m.Ka=function(a){var b=nf(this,a);return this.F.Qa(this.b[b],a)?!0:P(this)?!1:this.g[b].Ka(a)};m.remove=function(a,b){of(this,a,-1,b);if(null==this.C){var c=this;1==this.g.length&&(c=this.g[0],c.C=null);return c}return this};function pf(a){return P(a)?a.b[0]:pf(a.g[0])}function qf(a){a.b=[];for(var b=1;b<a.g.length;++b)a.b.push(pf(a.g[b]))}
function of(a,b,c,d){var e=nf(a,b),g=P(a);if(!g){var h=a.F.Qa(a.b[e],b)?e+1:e;if(of(a.g[h],b,h,d))qf(a);else return!1}else if(!a.F.Qa(a.b[e],b))return!1;if(a.b.length>e&&a.F.Qa(a.b[e],b)){if(q(d)&&!a.F.Ga()&&g&&(h=a.B[e],d=Se(h,d,void 0),0>d?d=!1:(h.splice(d,1),d=!0),d&&a.F.Ma().remove(b,1),a.B[e].length))return!1;a.b.splice(e,1);g&&(g=a.F.Ga()?1:a.B[e].length,a.B.splice(e,1),a.F.Ma().remove(b,g))}if(256>a.b.length&&null!=a.C){a:{b=null;if(a.xa&&256<a.xa.b.length)b=a.xa,e=d=0,g=a.b.length+1;else if(a.Ab&&
...
m.wb=function(a,b,c){var d=nf(this,a);if(P(this)){if(this.F.Qa(this.b[d],a)){if(c)this.F.Ma().remove(a,this.F.Ga()?1:this.B[d].length),this.B[d]=this.F.Ga()?b:[b];else{if(this.F.Ga())throw new E(201);if(!Ue(this.B[d],b))throw new E(109);}this.F.Ma().add(a,1);return this}this.b.splice(d,0,a);this.B.splice(d,0,this.F.Ga()?b:[b]);this.F.Ma().add(a,1);512==this.b.length?(d=df(this.F),a=df(this.F),a.hb=1,a.b=[this.b[256]],a.g=[this,d],a.C=this.C,this.C=a,d.b=this.b.splice(256),d.B=this.B.splice(256),d.C=
...
m.td=function(a){a=this.Xd(a);return[a.c,a.u]};m.toString=function(){return this.ad==xf?"SimpleComparator_DESC":"SimpleComparator_ASC"};function wf(a){this.Ja=a.map(function(a){return new vf(a)})}t(wf,vc);function Bf(a,b,c,d){for(var e=0,g=0;g<a.Ja.length&&0==e;++g)e=d(a.Ja[g],b[g],c[g]);return e}m=wf.prototype;m.compare=function(a,b){return Bf(this,a,b,function(a,b,e){return a.compare(b,e)})};m.min=function(a,b){return Bf(this,a,b,function(a,b,e){return a.min(b,e)})};
m.max=function(a,b){return Bf(this,a,b,function(a,b,e){return a.max(b,e)})};m.rb=function(a,b){for(var c=[!0,!0],d=0;d<this.Ja.length&&(c[0]||c[1]);++d){var e=this.Ja[d].rb(a[d],b[d]);c[0]=c[0]&&e[0];c[1]=c[1]&&e[1]}return c};m.Rd=function(a,b){for(var c=!0,d=0;d<this.Ja.length&&c;++d)c=this.Ja[d].Rd(a[d],b[d]);return c};
...
Nf.prototype.set=function(a,b){var c=this.ic.get(a)||null;null===c&&(c=[],this.ic.set(a,c));for(var d=null,e=0;e<c.length;e++)if(c[e].getName()==b.getName()){d=e;break}null!==d&&0<c.length?c.splice(d,1,b):c.push(b);this.aa.set(b.getName(),b)};function Of(a){this.hc=[];q(a)&&this.add(a)}Of.prototype.toString=function(){return this.hc.map(function(a){return a.toString()}).join(",")};Of.prototype.Ka=function(a){return this.hc.some(function(b){return b.contains(a)})};Of.prototype.wa=f("hc");
