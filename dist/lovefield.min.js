...
function fd(a,b,c){2==b?a.bc[r](a[ob],c):a.Ac&&a.Ac[r](a[ob],c)}H.Oh=Ib();H.gl=function(){var a;for(a=this;a&&a.Vd;a=a.F)a.Vd=!1};function dd(a,b){a.Vd=!0;Nc(function(){a.Vd&&(a.Oh(b),gd[r](null,b))})}var gd=Gc;function Tc(a){ac[r](this,a)}K(Tc,ac);ja(Tc[t],"cancel");function cd(a,b,c){this.na=a;this.resolve=b;this.reject=c};
...
var N=ca.Map&&ca.Map[t][cb]&&ca.Map[t][F]?function(){return new Map}:function(){return new Dd};function Ed(a){if(a instanceof Dd)return a.g.ia();var b=0,c=e(a[Hb]);a[F](function(a,g){c[b++]=g});return c}function Fd(a){if(a instanceof Dd)return a.g.j();var b=0,c=e(a[Hb]);a[F](function(a){c[b++]=a});return c};
...
function Sd(a){this.jc=new O(a);aa.defineProperty(this,"size",{get:function(){return this.jc.Ma()}})}Sd[t].add=function(a){this.jc.add(a)};Sd[t].add=Sd[t].add;ua(Sd[t],function(){this.jc[w]()});ua(Sd[t],Sd[t][w]);sa(Sd[t],function(a){return this.jc[jb](a)});Sd[t]["delete"]=Sd[t][Xa];Da(Sd[t],function(a,b){this.jc.j()[F](a,b)});Sd[t].has=function(a){return this.jc[tb](a)};Sd[t].has=Sd[t].has;function Td(a){return ca.Set&&ca.Set[t][cb]&&ca.Set[t][F]?new ca.Set(a):new Sd(a)}
...
function ae(){};
function be(a){this.va=a.o(Id);this.H=a.o(Jd);this.s=a.o(Nd)}H=be[t];ra(H,function(a){a[F](function(a){this.Dl(a);this.Al(a)},this)});H.Al=function(a){var b=a[u]();a.Yc().j()[F](function(a){this.va[jb](b,[a.id()])},this);a.Wc()[F](function(a){this.va.set(b,[a])},this);a.$c()[F](function(a){this.va.set(b,[a[1]])},this)};H.Dl=function(a){var b=this.s[h](a[u]());a.Hj()[F](function(a){this.Eh(b,a)},this)};
...
H.yi=function(a,b){var c=this.mg(a);b[F](function(b){if(ie(b[0],b[1],a[q])&&(b=b[1].w()[a.Sb],null!==b&&!c.K(b)))throw new P(203,a[q]);},this)};H.mg=function(a){var b=this.s[h](a.gb)[a.Cc].Fa()[Ga](function(b){return 1==b.f[C]&&b.f[0].ga[u]()==a.Cc})[0];return this.H.get(b.m())};function ie(a,b,c){return(null===a?null!==b:null===b)||a.$b(c)!=b.$b(c)}
...
function je(a){this.kb=new Ad;this.Pa=new Ad;this.nb=new Ad;this.A=a}H=je[t];oa(H,G("A"));H.Wc=G("kb");H.$c=G("Pa");H.Yc=G("nb");H.add=function(a){if(this.nb.K(a.id())){var b=[this.nb.get(a.id()),a];this.Pa.set(a.id(),b);this.nb[jb](a.id())}else this.kb.set(a.id(),a)};H.modify=function(a){var b=a[0],c=a[1];L(b.id()==c.id(),"Row ID mismatch between old/new values.");b=b.id();this.kb.K(b)?this.kb.set(b,c):(this.Pa.K(b)&&(a=[this.Pa.get(a[0].id())[0],c]),this.Pa.set(b,a))};
sa(H,function(a){if(this.kb.K(a.id()))this.kb[jb](a.id());else if(this.Pa.K(a.id())){var b=this.Pa.get(a.id())[0];this.Pa[jb](a.id());this.nb.set(a.id(),b)}else this.nb.set(a.id(),a)});H.Hj=function(){var a=[];this.kb.j()[F](function(b){a[x]([null,b])},this);this.Pa.j()[F](function(b){a[x](b)},this);this.nb.j()[F](function(b){a[x]([b,null])},this);return a};f(H,function(){return"["+this.kb.ia()[D]()+"], ["+this.Pa.ia()[D]()+"], ["+this.nb.ia()[D]()+"]"});
...
function ke(a,b){this.ta=N();b[F](function(a){this.ta.set(a[u](),a)},this);this.va=a.o(Id);this.H=a.o(Jd);this.Ua=new he(a);this.Xd=new be(a);this.hf=this.ne=!1;this.Hb=N()}H=ke[t];H.jg=G("Hb");H.Kj=function(){var a=[];Ed(this.Hb).map(function(a){return this.ta.get(a)},this)[F](function(b){b.Mb()&&(b.Fa()[F](function(b){a[x](this.H.get(b.m()))},this),a[x](this.H.get(b[u]()+".#")))},this);return a};H.ja=G("ta");
...
function Pe(a,b){this.Ea=a;this.ta=b}Pe[t].qb=G("Ea");Pe[t].eg=Kb("plan description");Pe[t].ja=G("ta");function Qe(a){var b=new O;a[F](function(a){b[hb](a.ja())});return b};

function Re(a,b){this.global=a;this.Ib=a.o(Hd);this.fe=b.map(function(a){return a[ob]});this.$g=b.map(function(a){return a.jf});this.Wf=Qe(this.$g);this.Ah=this.Si();this.gc=bd()}H=Re[t];H.Si=function(){return this.fe[$a](function(a){return!(a instanceof Ne)})?1:0};
ma(H,function(){var a=new ke(this[Va],this.Wf.j()),b=[],c=this.$g[n](),d=J(function(){var g=c[rb]();if(g){var k=this.fe[b[C]];return g.qb()[Pa](a,k)[z](function(a){b[x](a[0]);return d()})}return Xc()},this);return d()[z](J(function(){return this.Ib.Ub(this.Ah,a).pa()},this))[z](J(function(){this.ff(b);return b},this),J(function(b){a.Nb();throw b;},this))});H.X=G("Ah");H.ja=G("Wf");H.ad=G("gc");H.fa=function(){return Vb(this)};H.ff=Ib();
...
function Ze(){this.zb=N()}H=Ze[t];H.Qe=function(a){if(0==a[C])return Fd(this.zb);var b=[];a[F](function(a){a=this.zb.get(a)||null;null===a||b[x](a)},this);return b};H.getData=G("zb");H.get=function(a){return Xc(this.Qe(a))};H.kf=function(a){a[F](function(a){this.zb.set(a.id(),a)},this)};H.put=function(a){this.kf(a);return Xc()};H.gh=function(a){0==a[C]||a[C]==this.zb[Hb]?this.zb[w]():a[F](function(a){this.zb[Xa](a)},this)};wa(H,function(a){this.gh(a);return Xc()});
H.Oj=function(){return 0==this.zb[Hb]?0:Ed(this.zb)[Ka](function(a,b){return a>b?a:b},0)};
function $e(a,b){this.s=a;this.Nh=b;this.ie=N();this.Ya=-1;this.I=N();this.jb=N();this.we=null}H=$e[t];H.Zj=G("Ya");H.qh=Jb("Ya");
H.Ga=function(a){this.i=this.Nh[kb](this.s[q]());var b=a||function(){return Xc()};return We(this.i,"@db/version")[z](function(a){return null===a?Xe(this.i,this.Ii(),!0)[z](function(){var a=new Ve(0,this.i);return b(a)}[E](this)):a==this.s[ub]()?We(this.i,"@rev/R")[z](function(a){this.Ya=a;return We(this.i,"@table")}[E](this))[z](function(a){for(var b in a)this.jb.set(b,a[b]);a=this.s.ab().map(function(a){return this.fh(a[u]())},this);return ad(a)}[E](this))[z](function(){this.pk();this.Pg();return Xc()}[E](this)):
...
H.Pc=function(a,b,c,d){a[Ia][tb](c)||(a.createObjectStore(c,{keyPath:"id"}),a=b[vb](c),(this.zd?new Yd(a,jd,$d):new bf(a,jd)).put([new nd(new md(d))]))};H.Ub=function(a,b){var c=Ed(b.ja());b.Lj()[F](function(a){c[x](a)});var d=this.i[mb](c,0==a?"readonly":"readwrite");return new cf(this.l,d,b,a,this.zd)};
H.qf=function(a){function b(){if(0==c[C])return Xc();var a=c[rb]();return l(a)[z](b)}var c=this.s.ab().map(function(a){return a[u]()}),d=this.i,g=0,k=J(function(a){return this.zd?(a=Xd(a[v]),Cc(a.zc())[Ka](function(a,b){return ba.max(a,b)},0)):a.key},this),l=J(function(b){return new M(function(c,l){var fb;try{fb=(a||d[mb]([b]))[vb](b)[Fa](null,"prev")}catch(Hc){l(Hc);return}ta(fb,function(a){(a=a[Oa][Gb])&&(g=ba.max(g,k(a)));c(g)});za(fb,function(){c(g)})},this)},this);return new M(function(a){b()[z](function(){a(g)})})};
...
function of(){this.g=N();this.vh=N()}H=of[t];H.Ud=function(a){var b=this.vh.get(a);Mb(b)||(b=Td(),this.vh.set(a,b));return b};H.set=function(a,b){var c=this.Ud(a);b[F](J(function(a){this.g.set(a.id(),a);c.add(a.id())},this))};H.get=function(a){return a.map(J(function(a){return this.g.get(a)||null},this))};
...
H.pb=function(a,b,c){function d(a){return a[0]?a[1]?0:1:-1}var g=this.C.Oc(),k=0,l=this.b[C]-1,p=this.b,y=d(g.yb(p[k],a)),na=d(g.yb(p[l],a));if(1!=y&&(-1!=y||-1!=na)){var fb=function(a,b){var c=a+b>>1;return c==a?c+1:c},Hc=function(b,c,k){if(b>=c)return 0==k?c:-1;var l=d(g.yb(p[b],a));if(0==l)return b;if(1==l)return-1;l=fb(b,c);if(l==c)return 0==k?c:-1;var y=d(g.yb(p[l],a));return 0==y?Hc(b,l,y):-1==y?Hc(l+1,c,k):Hc(b+1,l,y)},hf=function(b,c){if(b>=c)return b;var k=d(g.yb(p[c],a));if(0==k)return c;
if(-1==k)return b;k=fb(b,c);if(k==c)return b;var l=d(g.yb(p[k],a));return 0==l?hf(k,c):1==l?hf(b,k-1):-1};0!=y&&(k=Hc(k+1,l,na));-1!=k&&(l=hf(k,l),-1!=l&&l>=k&&this.Ph(b,c,k,l+1))}};H.Ph=function(a,b,c,d){for(;c<d&&(a[eb]||!(a[ab]>=a.Z));++c)if(this.C.Na())!a[eb]&&a.O?a.O--:b[a.count++]=this.B[c];else for(var g=0;g<this.B[c][C]&&a[ab]<b[C];++g)!a[eb]&&a.O?a.O--:b[a.count++]=this.B[c][g]};
...
function Of(a){this.l=a;this.Ib=a.o(Hd);this.H=a.o(Jd);this.va=a.o(Id)}H=Of[t];H.Ga=function(a){var b=a.ab(),c=J(function(){if(0==b[C])return Xc();var a=b[rb]();return(a.Mb()?this.jj(a):this.kj(a))[z](c)},this);return c()};H.kj=function(a){var b=new ke(this.l,[a]);return this.Ib.Ub(0,b).M(a[u](),J(a.tc,a)).get([])[z](J(function(b){this.va.set(a[u](),b);this.$k(a,b)},this))};H.$k=function(a,b){var c=this.H.qg(a[u]());b[F](function(a){c[F](function(b){var c=a.$b(b[u]());b.add(c,a.id())})})};
...
function Pf(){this.$=N();this.me=N()}Pf[t].Ga=function(a){a.ab()[F](function(a){var c=[];this.me.set(a[u](),c);var d=a.Wb();if(null===this.get(d)){var g=new Mf(d);c[x](g);this.$.set(d,g)}a.Fa()[F](function(a){var b;b=Df(a);b=new rf(a.m(),b,a.fd);b=a.vg()?new Kf(b):b;c[x](b);this.$.set(a.m(),b)},this)},this);return Xc()};Pf[t].get=function(a){return this.$.get(a)||null};
...
function Wf(a,b){a.ea()[n]()[F](function(c){a[ib](c);b.oa(c)});a.oa(b)}function Xf(a){L(1==a.ya());var b=a.Ab(0);L(1==b.ya());Vf(a);Wf(b,a);return b}function Yf(a,b,c){L(1==a.ya());var d=a.Ab(0);L(1<d.ya());var g=d.ea()[n]();if(!g[$a](function(a){return b(a)}))return a;Vf(a);g[F](function(g,l){if(b(g)){var p=c(a);d.he(l);p.oa(g);d.Gc(p,l)}});return d}function Zf(a,b,c,d){var g=a[Bb]();null!==g&&(a=g.ea()[Za](a),g.he(a),g.Gc(c,a));b.ea()[n]()[F](function(a){b[ib](a);d.oa(a)});return c}
...
function T(a,b){xa(this,a);this.Rb=b;this.lb=null}H=T[t];oa(H,function(){return this.Rb+"("+this[kb][u]()+")"});H.m=function(){return this.Rb+"("+this[kb].m()+")"};H.M=function(){return this[kb].M()};f(H,function(){return this.m()});H.X=function(){return this[kb].X()};H.cb=G("lb");H.Fa=function(){return[]};H.Zb=Kb(!1);H.Ic=function(a){this.lb=a;return this};T[t].as=T[t].Ic;T[t].hg=function(){for(var a=[this],b=this;b instanceof T;)a[x](b[kb]),b=b[kb];return a};
function mg(a){this.lb=a||null;this.S=new S("#UnknownTable",[],[],!1)}H=mg[t];oa(H,Kb("*"));H.m=function(){return this[u]()};f(H,function(){return this.m()});H.M=G("S");H.X=Kb(4);H.cb=G("lb");H.Fa=function(){return[]};H.Zb=Kb(!1);
...
function wg(a,b){var c=0,d=a[B][Ka](function(a,d){var l=d.V(b);if(0==l||null===l)return a;c++;return a+ba.log(l)},0);return 0==c?null:ba.pow(ba.E,d/c)}function tg(a,b){var c=new Ad;a[B][F](function(a){var g=a.V(b);c.set(g,a)});return new pe(c.j(),a.W())};
...
function Qg(){U[r](this,2,0)}K(Qg,U);f(Qg[t],Kb("cross_product"));Qg[t].ha=function(a,b){for(var c=b[0],d=b[1],g=[],k=c.W(),l=d.W(),p=0;p<c[B][C];p++)for(var y=0;y<d[B][C];y++){var na=ye(c[B][p],k,d[B][y],l);g[x](na)}c=c.W()[Ra](d.W());return[new pe(g,c)]};
...
function Sg(a){Le[r](this,a)}K(Sg,Le);Sg[t].ja=function(){var a=new O([this.c]);a[hb](this.ga[zb]().gg(this.c[u]()));return a};la(Sg[t],function(){var a=new Sg(this.ga);a.Cd(this);a.c=this.c;return a});Ba(Sg[t],function(a){Sg.Pb[E][r](this,a);this.ve(a);return this});
function Tg(a){Le[r](this,a)}K(Tg,Le);Tg[t].ja=function(){var a=new O([this.Ha]),b=this.ga[zb]();a[hb](b.Sj(this.Ha[u]()));this.nc&&a[hb](b.gg(this.Ha[u]()));return a};la(Tg[t],function(){var a=new Tg(this.ga);a.Cd(this);a.Ha=this.Ha;this[cb]&&va(a,this[cb]instanceof ze?this[cb]:this[cb][n]());a.nc=this.nc;a.oc=this.oc;return a});Ba(Tg[t],function(a){Tg.Pb[E][r](this,a);this.oc&&va(this,this.oc instanceof ze?a[this.oc.Bb()]:this.oc.map(function(b){return b instanceof ze?a[b.Bb()]:b}));return this});
function Ug(a){Le[r](this,a)}K(Ug,Le);Ug[t].ja=function(){var a=new O([this[h]]),b=this.set.map(function(a){return a.J.m()}),c=this.ga[zb]();a[hb](c.Tj(b));a[hb](c.Ij(b));return a};la(Ug[t],function(){var a=new Ug(this.ga);a.Cd(this);ia(a,this[h]);a.set=this.set?this.set[n]():this.set;return a});Ba(Ug[t],function(a){Ug.Pb[E][r](this,a);this.set[F](function(b){-1!=b.xd&&qa(b,a[b.xd])});this.ve(a);return this});
...
function uh(a){U[r](this,1,1);this.S=a}K(uh,U);f(uh[t],function(){return"delete("+this.S[u]()+")"});uh[t].ha=function(a,b){var c=b[0][B].map(function(a){return a.xa});a[jb](this.S,c);return[se()]};
...
function Dh(a,b){this.H=a;this.Db=b;this.wg=new O;this.wg[hb](this.Db.f.map(function(a){return a.ga[u]()}));this.$e=this.wa=null}H=Dh[t];H.Vj=function(){return null===this.wa?[]:this.wa.j()};H.lg=function(){L(this.wa);null===this.$e&&(this.$e=new Bh(this.Db,this.wa));return this.$e};H.Gi=function(a){a[F](function(a){var c=a.ob()[0][u]();this.wg[tb](c)&&(null===this.wa&&(this.wa=new hg),this.wa.add(c,a.fa()))},this)};
...
function Eh(a,b,c,d){U[r](this,0,-1);this.H=a.o(Jd);this.index=b;this.Kg=c;this.pf=d;this.vd=this.ud=!1}K(Eh,U);f(Eh[t],function(){return"index_range_scan("+this[nb].m()+", ?, "+(this.pf?"reverse":"natural")+(this.ud?", limit:?":"")+(this.vd?", skip:?":"")+")"});Eh[t].rd=function(a){var b=this[D](),c=this.Kg.Nd(a),b=b[db]("?",c[D]());this.ud&&(b=b[db]("?",a.Z[D]()));this.vd&&(b=b[db]("?",a.O[D]()));return b};
Eh[t].ha=function(a,b,c){a=this.Kg.Nd(c);b=this.H.get(this[nb].m());c=(1==a[C]&&a[0]instanceof le&&a[0].Eg()?pf(b.get(a[0].c),!1,this.ud?c.Z:void 0,this.vd?c.O:void 0):b.pb(a,this.pf,this.ud?c.Z:void 0,this.vd?c.O:void 0)).map(function(a){return new hd(a,{})},this);return[ve(c,[this[nb].qd])]};
...
function Ih(a,b){U[r](this,0,-1);this.H=a.o(Jd);this.S=b}K(Ih,U);f(Ih[t],function(){return"insert("+this.S[u]()+")"});Ih[t].ha=function(a,b,c){Jh(this.S,c[cb],this.H);a.Eb(this.S,c[cb]);return[ve(c[cb],[this.S[u]()])]};function Jh(a,b,c){a=a.Kb().Rd();if(null===a?0:a.f[0][pb]){var d=a.f[0].ga[u]();c=c.get(a.m()).max();var g=null===c?0:c[0];b[F](function(a){if(0==a.w()[d]||null==a.w()[d])g++,a.w()[d]=g})}}function Kh(a,b){U[r](this,0,-1);this.H=a.o(Jd);this.S=b}K(Kh,U);
...
Th[t].Sh=function(a){var b=a,c=Xh(a.Ab(0));if(null!==c){var d=Wh(c[nb],a.N);if(null===d)return b;c.pf=d.Hg;b=Vf(a).parent}return b};function Xh(a){a=Uf(a,function(a){return a instanceof Eh},function(a){return 1!=a.ya()});return 0<a[C]?a[0]:null}function Vh(a){a=Uf(a,function(a){return a instanceof wh},function(a){return 1!=a.ya()});return 0<a[C]?a[0]:null}function Uh(a){a=Uf(a,function(a){return a instanceof Nh});return 0<a[C]?a[0]:null}
...
function di(){this.kc=this.Xa=this.ib=this.Tc=null}di[t].releaseLock=function(a){this.Tc==a&&(this.Tc=null);this.ib==a&&(this.ib=null);null===this.Xa||this.Xa[jb](a);null===this.kc||this.kc[jb](a)};di[t].gi=function(a,b){var c=null===this.Xa||this.Xa.fb();return 0==b?(null===this.kc||this.kc.fb())&&c&&null===this.Tc&&null!==this.ib&&this.ib==a:3==b?null===this.Tc&&null===this.ib&&null!==this.Xa&&this.Xa[tb](a):1==b?null===this.ib:c&&(null===this.ib||this.ib==a)};
di[t].ek=function(a,b){0==b?(this.ib=null,this.Tc=a):3==b?(null===this.kc&&(this.kc=new O),this.kc.add(a),null===this.Xa&&(this.Xa=new O),this.Xa[jb](a)):1==b?(null===this.Xa&&(this.Xa=new O),this.Xa.add(a)):2==b&&(this.ib=a)};
function ei(){this.fc=new fi;this.gd=new ci}H=ei[t];H.ic=function(a){(2>a[Db]()||2>a[Db]())&&this.gd.Bi(a.ja().j());this.fc.Eb(a);this.Ee();return a.ad().na};H.Ee=function(){for(var a=this.fc.j(),b=0;b<a[C];b++){var c=a[b],d=!1;if(d=0==c.X()?this.ih(c,1,3):this.ih(c,2,0))this.fc[jb](c),this.fj(c)}};H.ih=function(a,b,c){var d=!1,g=a.ja().j();this.gd.hh(a.fa(),g,b)&&(d=this.gd.hh(a.fa(),g,c));return d};H.fj=function(a){a[Pa]()[z](J(this.Ok,this,a),J(this.Nk,this,a))};
H.Ok=function(a,b){this.gd.releaseLock(a.fa(),a.ja().j());a.ad()[Fb](b);this.Ee()};H.Nk=function(a,b){this.gd.releaseLock(a.fa(),a.ja().j());a.ad()[La](b);this.Ee()};function fi(){this.fc=[]}fi[t].Eb=function(a){wc(this.fc,a,function(a,c){var d=a[Db]()-c[Db]();return 0==d?a.fa()-c.fa():d})};fi[t].j=function(){return this.fc[n]()};wa(fi[t],function(a){var b=this.fc;a=ic(b,a);var c;(c=0<=a)&&oc(b,a);return c});
...
H.Re=function(a){var b=Td();a[F](function(a){b.add(a[u]())});var c=[];this.vc[F](function(a){a=a.cd();a[ob].c[$a](function(a){return b.has(a[u]())})&&c[x](a)});return c};H.Ch=function(a,b){var c=this.Pe(null!=a.Mc?a.Mc:a),c=this.vc.get(c)||null;return null!==c?(c.El(b),!0):!1};function ji(a){this.bi=a;this.ld=Td();this.Lk=[];this.Ng=null;this.Ti=new gi(a.Pd(),this.Lk)}H=ji[t];H.qe=function(a){this.ld.has(a)?ec("Attempted to register observer twice."):this.ld.add(a)};H.of=function(a){return this.ld[Xa](a)};
...
X[t].Ue=function(){this.rc();return new gh(this.l,!0)};X[t].insertOrReplace=X[t].Ue;ra(X[t],function(a){this.rc();return new kh(this.l,a)});ra(X[t],X[t][Ua]);sa(X[t],function(){this.rc();return new fh(this.l)});X[t]["delete"]=X[t][Xa];X[t].observe=function(a,b){this.l.o(Md).qe(a,b)};X[t].observe=X[t].observe;X[t].unobserve=function(a,b){this.l.o(Md).of(a,b)};X[t].unobserve=X[t].unobserve;X[t].Oi=function(){this.rc();return new mi(this.l)};X[t].createTransaction=X[t].Oi;
pa(X[t],function(){try{this.l.o(Hd)[Qa]()}catch(a){}this.l[w]();this.Te=!1});pa(X[t],X[t][Qa]);
function Y(a,b,c,d,g,k){this.S=a;this.A=b;this.Jg=c;this.Dg=d;this.Bh=g;this.lb=k||null}I("lf.schema.BaseColumn",Y,void 0);H=Y[t];oa(H,G("A"));H.m=function(){return this.S.qa()+"."+this.A};f(H,function(){return this.m()});H.M=G("S");H.X=G("Bh");Y[t].getType=Y[t].X;Y[t].cb=G("lb");Y[t].Fa=function(){null==this.la&&(this.la=[],this.M().Fa()[F](function(a){-1!=a.f.map(function(a){return a.ga[u]()})[Za](this.A)&&this.la[x](a)},this));return this.la};Y[t].Zb=G("Dg");Y[t].isNullable=Y[t].Zb;Y[t].fd=G("Jg");
...
function Z(a){this.sc(a);this.A=a;this.G=N();this.yf=Td();this.td=Td();this.kd=Td();this.Ba=null;this.la=N();this.ce=!1;this.Jd=[]}I("lf.schema.TableBuilder",Z,void 0);function ti(a){ja(this,a[q]);this.tb=a.order;this.autoIncrement=a[pb]}var ui=Td([0,6]);H=Z[t];H.sc=function(a){if(!/^[A-Za-z_][A-Za-z0-9_]*$/.test(a))throw new P(502,a);};H.Kc=function(a){if(a==this.A)throw new P(546,a);if(this.G.has(a)||this.la.has(a)||this.td.has(a))throw new P(503,this.A+"."+a);};
...
Z[t].Gj=function(){function a(){function a(c){return b.la.get(c).map(function(a){return{ga:this[a[q]],tb:a.tb,autoIncrement:a[pb]}},this)}var d=Ed(b.G).map(function(a){this[a]=new Y(this,a,b.yf.has(a),b.kd.has(a),b.G.get(a));return this[a]},this),g=Ed(b.la).map(function(d){return new lg(b.A,d,b.td.has(d),a[r](this,d))},this);S[r](this,b.A,d,g,b.ce);var k=null===b.Ba?null:new lg(b.A,b.Ba,!0,a[r](this,b.Ba)),l=d[Ga](function(a){return!b.kd.has(a[u]())});this.Fi=new ri(k,l,b.Zc());this.lh=b.Cj(d,g)}
