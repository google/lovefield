...
goog.html.SafeStyle.checkStyle_(b);return goog.html.SafeStyle.createSafeStyleSecurityPrivateDoNotAccessOrElse(b)};goog.html.SafeStyle.VALUE_RE_=/^[-.%_!# a-zA-Z0-9]+$/;goog.html.SafeStyle.concat=function(a){var b="",c=function(a){goog.isArray(a)?goog.array.forEach(a,c):b+=goog.html.SafeStyle.unwrap(a)};goog.array.forEach(arguments,c);return b?goog.html.SafeStyle.createSafeStyleSecurityPrivateDoNotAccessOrElse(b):goog.html.SafeStyle.EMPTY};goog.html.SafeStyleSheet=function(){this.privateDoNotAccessOrElseSafeStyleSheetWrappedValue_="";this.SAFE_SCRIPT_TYPE_MARKER_GOOG_HTML_SECURITY_PRIVATE_=goog.html.SafeStyleSheet.TYPE_MARKER_GOOG_HTML_SECURITY_PRIVATE_};goog.html.SafeStyleSheet.prototype.implementsGoogStringTypedString=!0;goog.html.SafeStyleSheet.TYPE_MARKER_GOOG_HTML_SECURITY_PRIVATE_={};
...
lf.index.hashCode=function(a){for(var b=0,c=0;c<a.length;++c)b=(b<<5)-b+a.charCodeAt(c),b&=b;return b};lf.index.hashArray=function(a){a=a.map(function(a){return goog.isDefAndNotNull(a)?lf.index.hashCode(a.toString()).toString(32):""});return a.join("_")};lf.index.slice=function(a,b,c){if(a.length&&(goog.isDef(b)||goog.isDef(c))){b=goog.isDef(b)?b:a.length;if(0==b)return[];b=Math.min(a.length,b);c=c||0;c=Math.min(a.length,c);a=a.slice(c,c+b)}return a};
...
lf.index.BTree.prototype.remove=function(a,b){this.root_=this.root_.remove(a,b)};lf.index.BTree.prototype.get=function(a){return this.root_.get(a)};lf.index.BTree.prototype.cost=function(a){return this.getRange(a).length};lf.index.BTree.prototype.getRange=function(a,b,c){var d=null;a&&(goog.isNull(a.from)||(d=this.root_.getContainingLeaf(a.from)));null==d&&(d=this.root_.getLeftMostNode());return lf.index.slice(d.getRange(a),b,c)};lf.index.BTree.prototype.clear=function(){this.root_=lf.index.BTreeNode_.create(this)};
...
lf.index.RowId.prototype.get=function(a){return this.containsKey(a)?[a]:[]};lf.index.RowId.prototype.cost=function(){return this.rows_.getCount()};lf.index.RowId.prototype.getRange=function(a,b,c){a=a||lf.index.KeyRange.all();if(goog.isDefAndNotNull(a.from)&&"number"!=typeof a.from||goog.isDefAndNotNull(a.to)&&"number"!=typeof a.to)throw new lf.Exception(lf.Exception.Type.DATA,"Row id must be numbers");return lf.index.slice(this.rows_.getValues().filter(a.getComparator()),b,c)};
...
lf.index.AATree.prototype.getRange=function(a,b,c){var d=null;goog.isDefAndNotNull(a)?(d=a,goog.isNull(d.from)&&(d.from=this.findMin_().key),goog.isNull(d.to)&&(d.to=this.findMax_().key)):d=new lf.index.KeyRange(this.findMin_().key,this.findMax_().key,!1,!1);a=[];this.traverse_(this.root_,d,a);return lf.index.slice(a,b,c)};lf.index.AATree.prototype.clear=function(){this.root_=this.nullNode_};lf.index.AATree.prototype.containsKey=function(a){return null!=this.search_(this.root_,a)};
...
lf.index.Map.prototype.get=function(a){a=this.map_.get(a);return goog.isDefAndNotNull(a)?a.getValues():[]};lf.index.Map.prototype.cost=function(a){return this.getRange(a).length};lf.index.Map.prototype.getRange=function(a,b,c){var d=[];a=a||lf.index.KeyRange.all();var e=a.getComparator();this.map_.getKeys().sort().forEach(function(a){e(a)&&(d=d.concat(this.get(a)))},this);return lf.index.slice(d,b,c)};lf.index.Map.prototype.clear=function(){return this.map_.clear()};
lf.index.Map.prototype.containsKey=function(a){return this.map_.containsKey(a)};lf.index.Map.prototype.serialize=function(){goog.asserts.fail("Map index serialization is not supported.");return[]};
...
lf.tree={};lf.tree.map=function(a,b){var c=[],d=null,e=null;a.traverse(function(a){var g=b(a);null==a.getParent()?e=g:d.addChild(g);var h=a.getParent(),k=d;!goog.isNull(h)&&(h=h.getChildCount()==k.getChildCount())&&(k=c.indexOf(k),-1!=k&&c.splice(k,1));1<a.getChildCount()&&c.push(g);d=a.isLeaf()?c[c.length-1]:g});return e};lf.tree.getLeafNodes=function(a){var b=[];a.forEachDescendant(function(a){a.isLeaf()&&b.push(a)});return b};
...
lf.query.parseSearchCondition_=function(a){return a instanceof lf.pred.ValuePredicate?lf.query.valuePredicateToSql_(a):a instanceof lf.pred.CombinedPredicate?lf.query.combinedPredicateToSql_(a):""};lf.query.predicateToSql_=function(a){return(a=lf.query.parseSearchCondition_(a))?" WHERE "+a:""};lf.query.deleteToSql_=function(a){var b="DELETE FROM "+a.from.getName();a.where&&(b+=lf.query.predicateToSql_(a.where));return b+=";"};
lf.query.updateToSql_=function(a){var b="UPDATE "+a.table.getName()+" SET ",b=b+a.set.map(function(a){var b=a.column.getNormalizedName()+" = ";return-1!=a.binding?b+"?"+a.binding.toString():b+lf.query.escapeSqlValue_(a.column.getType(),a.value).toString()}).join(", ");a.where&&(b+=lf.query.predicateToSql_(a.where));return b+=";"};
lf.query.toSql=function(a){a=a.query;return a instanceof lf.query.InsertContext?lf.query.insertToSql_(a):a instanceof lf.query.DeleteContext?lf.query.deleteToSql_(a):a instanceof lf.query.UpdateContext?lf.query.updateToSql_(a):"Not implemented"};
...
lf.query.SelectBuilder.prototype.innerJoin=function(a,b){goog.isDefAndNotNull(this.query.from)||(this.query.from=[]);this.query.from.push(a);this.augmentWhereClause_(b);return this};lf.query.SelectBuilder.prototype.limit=function(a){this.assertNotAlreadyCalled_(this.query.limit,"limit");this.assertGreaterThanZero_(a,"limit");this.query.limit=a;return this};
lf.query.SelectBuilder.prototype.skip=function(a){this.assertNotAlreadyCalled_(this.query.skip,"skip");this.assertGreaterThanZero_(a,"skip");this.query.skip=a;return this};lf.query.SelectBuilder.prototype.orderBy=function(a,b){goog.isDefAndNotNull(this.query.orderBy)||(this.query.orderBy=[]);this.query.orderBy.push({column:a,order:goog.isDefAndNotNull(b)?b:lf.Order.ASC});return this};
...
lf.proc.IndexRangeScanPass.replaceWithIndexRangeScanStep_=function(a,b){var c=a.predicate,d=lf.proc.IndexRangeScanPass.getIndexForPredicate_(c);if(goog.isNull(d))return a;c=new lf.proc.IndexRangeScanStep(d,c.toKeyRange(),lf.Order.ASC);d=new lf.proc.TableAccessByRowIdStep(b.table);d.addChild(c);var e=b.getParent();if(e!=a){lf.tree.removeNode(a);var f=e.getChildren().indexOf(b);e.removeChildAt(f);a.addChild(b);e.addChildAt(a,f);goog.asserts.assert(1==a.getChildCount(),"SelectStep should have exactly one child")}return c=
...
lf.proc.OrderByIndexPass.prototype.applyIndexRangeScanStepOptimization_=function(a){var b=a,c=lf.proc.OrderByIndexPass.findIndexRangeScanStep_(a.orderBy[0],a.getChildAt(0));goog.isNull(c)||(c.order=a.orderBy[0].order,b=lf.tree.removeNode(a));return b};lf.proc.OrderByIndexPass.findIndexRangeScanStep_=function(a,b){return b instanceof lf.proc.IndexRangeScanStep&&b.index.columnNames[0]==a.column.getName()?b:1!=b.getChildCount()?null:lf.proc.OrderByIndexPass.findIndexRangeScanStep_(a,b.getChildAt(0))};
lf.proc.OrderByIndexPass.findTableAccessFullStep_=function(a){return a instanceof lf.proc.TableAccessFullStep?a:1!=a.getChildCount()?null:lf.proc.OrderByIndexPass.findTableAccessFullStep_(a.getChildAt(0))};
...
lf.proc.PhysicalPlanFactory.prototype.create=function(a){if(a instanceof lf.proc.InsertOrReplaceNode||a instanceof lf.proc.InsertNode)return this.createPlan_(a);if(a instanceof lf.proc.ProjectNode)return this.createPlan_(a,[new lf.proc.IndexRangeScanPass(this.global_),new lf.proc.OrderByIndexPass]);if(a instanceof lf.proc.DeleteNode||a instanceof lf.proc.UpdateNode)return this.createPlan_(a,[new lf.proc.IndexRangeScanPass(this.global_)]);goog.asserts.fail("Unknown query type.");a=new lf.proc.PhysicalQueryPlanNode;
return new lf.proc.PhysicalQueryPlan(a)};lf.proc.PhysicalPlanFactory.prototype.createPlan_=function(a,b){var c=lf.tree.map(a,goog.bind(this.mapFn_,this));return goog.isDefAndNotNull(b)?(c=new lf.proc.PhysicalPlanRewriter(c,b),new lf.proc.PhysicalQueryPlan(c.generate())):new lf.proc.PhysicalQueryPlan(c)};
