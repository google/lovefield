...
a).then(function(){},goog.bind(function(a){goog.log.error(this.logger_,"onUpgradeNeeded failed: "+a);e(a)},this))},this);f.onsuccess=goog.bind(function(b){this.db_=b.target.result;this.scanRowId_().then(goog.bind(function(b){lf.Row.setNextId(b+1);a(this.db_)},this))},this)},this)};lf.backstore.IndexedDB.prototype.onUpgradeNeeded_=function(a,b){var c=b.target.result,d=b.target.transaction,d=new lf.backstore.IndexedDBRawBackStore(b.oldVersion,c,d,this.bundleMode_);this.createTables_(c);return a(d)};
lf.backstore.IndexedDB.prototype.createTables_=function(a){this.schema_.getTables().forEach(goog.partial(this.createObjectStoresForTable_,a),this)};lf.backstore.IndexedDB.prototype.createObjectStoresForTable_=function(a,b){a.objectStoreNames.contains(b.getName())||a.createObjectStore(b.getName(),{keyPath:"id"});if(b.persistentIndex()){var c=b.getIndices();c.forEach(function(b){b=b.getNormalizedName();a.objectStoreNames.contains(b)||a.createObjectStore(b,{keyPath:"id"})},this)}};
...
lf.backstore.Memory.prototype.createTx=function(a,b){return new lf.backstore.MemoryTx(this,a,b)};lf.backstore.Memory.prototype.createTable_=function(a){this.tables_.containsKey(a)||this.tables_.set(a,new lf.backstore.MemoryTable)};lf.backstore.Memory.prototype.initTable_=function(a){this.createTable_(a.getName());a.persistentIndex()&&(a=a.getIndices(),a.forEach(function(a){this.createTable_(a.getNormalizedName())},this))};lf.backstore.Memory.prototype.close=function(){};
...
lf.index={};lf.index.Index=function(){};
