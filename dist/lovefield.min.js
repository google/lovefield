...
H.ml=function(a,b,c){null!=a&&dc(a,"opt_onFulfilled should be a function.");null!=b&&dc(b,"opt_onRejected should be a function. Did you pass opt_context as the second argument instead of the third?");this.yf(Uc(a||Lb,b||null,c))};H.oh=function(a,b){return this.zf(null,a,b)};H.yf=function(a){this.bk()||2!=this.Ka&&3!=this.Ka||this.eh();this.Pk(a)};
H.zf=function(a,b,c){var d=Uc(null,null,null);va(d,new M(function(g,h){d.ac=a?function(b){try{var d=a[q](c,b);g(d)}catch(y){h(y)}}:g;d.yc=b?function(a){try{var d=b[q](c,a);!Kb(d)&&a instanceof Rc?h(a):g(d)}catch(y){h(y)}}:h}));d[ib].G=this;this.yf(d);return d[ib]};H.pl=function(a){L(1==this.Ka);this.Ka=0;this.Bc(2,a)};H.ql=function(a){L(1==this.Ka);this.Ka=0;this.Bc(3,a)};
H.Bc=function(a,b){0==this.Ka&&(this==b&&(a=3,b=new TypeError("Promise cannot resolve to itself")),this.Ka=1,Yc(b,this.pl,this.ql,this)||(this.ah=b,this.Ka=a,this.G=null,this.eh(),3!=a||b instanceof Rc||bd(this,b)))};
...
function fd(a,b){this.Aa=a;this.cc=b||this.Uf()}var gd=0;H=fd[r];H.id=G("Aa");H.Nh=Hb("Aa");H.w=G("cc");H.Uf=function(){return{}};H.ph=G("cc");H.Ja=function(){return{id:this.Aa,value:this.ph()}};H.Zb=function(a){return"#"==a.substr(-1)?this.Aa:null};function hd(a){return new fd(a.id,a[u])}function id(a){return new fd(gd++,a||{})}function jd(a){if(null==a)return null;a=new Uint8Array(a);for(var b="",c=0;c<a[C];++c)var d=a[c][D](16),b=b+(2>d[C]?"0"+d:d);return b};
...
function Qd(a,b){this.Aa=a;this.cc=b||{}}function Rd(a){var b=new O;a[F](function(a){b.add(a>>9)});return b.f()}H=Qd[r];H.fa=G("Aa");H.xc=G("cc");H.ih=function(a){a[F](function(a){this.cc[a.id()]=a.Ja()},this)};H.Wk=function(a){a[F](function(a){var c=this.cc;a in c&&delete c[a]},this)};H.Ja=function(){return{id:this.Aa,value:JSON.stringify(this.cc)}};function Sd(a){return new Qd(a.id,JSON.parse(a[u]))};
...
H.put=function(a){if(0==a[C])return Vc();var b=new Bd;a[F](function(a){var d;d=a.id()>>9;var g=b.get(d)||null;null===g&&(g=this.bh(this.W[n],d));g.ih([a]);b.set(d,g)},this);a=Dd(b).map(function(a){return this.dc(J(function(){return this.W.put(a.Ja())},this))},this);return Zc(a)};
ua(H,function(a){if(0==a[C])return this.dc(J(function(){return this.W[v]()},this));var b=new Bd;a[F](function(a){var d=a>>9,g=b.get(d)||null;null===g&&(g=this.bh(this.W[n],d));g.Wk([a]);b.set(d,g)},this);a=Dd(b).map(function(a){return this.dc(J(function(){var b;a:{b=a.xc();for(var g in b){b=!1;break a}b=!0}return b?this.W[Xa](a.fa()):this.W.put(a.Ja())},this))},this);return Zc(a)});function Ud(a,b,c){a=a.o(Gd);var d=[c<<9,(c+1<<9)-1];b=a.ob(b,d[0],d[1]);c=new Qd(c);c.ih(b);return c}
...
H.ki=function(a,b){b[F](function(b){if(de(b[0],b[1],a[n])){b=b[1].w()[a.Rb];var d=this.gg(a);if(null!==b&&!d.B(b))throw new P(203,a[n]);}},this)};H.gg=function(a){var b=this.s[k](a.eb)[a.Ac].za()[Fa](function(b){return 1==b.h[C]&&b.h[0].ga[t]()==a.Ac})[0];return this.J.get(b.l())};function de(a,b,c){return(null===a?null!==b:null===b)||a.Zb(c)!=b.Zb(c)}
...
function ee(a){this.jb=new N;this.Oa=new N;this.mb=new N;this.D=a}H=ee[r];ma(H,G("D"));H.Tc=G("jb");H.Xc=G("Oa");H.Vc=G("mb");H.add=function(a){if(this.mb.B(a.id())){var b=[this.mb.get(a.id()),a];this.Oa.set(a.id(),b);this.mb[w](a.id())}else this.jb.set(a.id(),a)};H.modify=function(a){var b=a[0],c=a[1];L(b.id()==c.id(),"Row ID mismatch between old/new values.");b=b.id();this.jb.B(b)?this.jb.set(b,c):(this.Oa.B(b)&&(a=[this.Oa.get(a[0].id())[0],c]),this.Oa.set(b,a))};
qa(H,function(a){if(this.jb.B(a.id()))this.jb[w](a.id());else if(this.Oa.B(a.id())){var b=this.Oa.get(a.id())[0];this.Oa[w](a.id());this.mb.set(a.id(),b)}else this.mb.set(a.id(),a)});H.vj=function(){var a=[];this.jb.f()[F](function(b){a[x]([null,b])},this);this.Oa.f()[F](function(b){a[x](b)},this);this.mb.f()[F](function(b){a[x]([b,null])},this);return a};f(H,function(){return"["+this.jb.U()[D]()+"], ["+this.Oa.U()[D]()+"], ["+this.mb.U()[D]()+"]"});
H.Mj=function(){var a=new ee(this.D);this.jb.f()[F](function(b){a[Xa](b)},this);this.mb.f()[F](function(b){a.add(b)},this);this.Oa.f()[F](function(b){a.modify([b[1],b[0]])},this);return a};H.Va=function(){return this.jb.Va()&&this.mb.Va()&&this.Oa.Va()};
function fe(a,b){this.sa=new N;b[F](function(a){this.sa.set(a[t](),a)},this);this.ta=a.o(Gd);this.J=a.o(Hd);this.Ta=new ce(a);this.Td=new Xd(a);this.bf=this.ie=!1;this.Gb=new N}H=fe[r];H.dg=G("Gb");H.yj=function(){var a=[];this.Gb.U().map(function(a){return this.sa.get(a)},this)[F](function(b){b.Lb()&&(b.za()[F](function(b){a[x](this.J.get(b.l()))},this),a[x](this.J.get(b[t]()+".#")))},this);return a};H.ha=G("sa");
H.zj=function(){var a=[];this.sa.f()[F](function(b){b.Lb()&&(b.za()[F](function(b){a[x](b.l())}),a[x](b[t]()+".#"))});return a};H.Cb=function(a,b){this.Hc();this.xd(a);this.Ta.ve(a,b);this.Ta.te(a,b,0);for(var c=0;c<b[C];c++)this.Ud(a,[null,b[c]])};
H.Ud=function(a,b){var c=a[t](),d=this.Gb.get(c,null)||new ee(c);this.Gb.set(c,d);try{this.Td.uh(a,b)}catch(g){throw this.bf=!0,g;}var h=b[0],l=b[1];null===h&&null!==l?(this.ta.set(c,[l]),d.add(l)):null!==h&&null!==l?(this.ta.set(c,[l]),d.modify(b)):null!==h&&null===l&&(this.ta[w](c,[h.id()]),d[Xa](h))};pa(H,function(a,b){this.Hc();this.xd(a);this.Ta.ve(a,b);for(var c=0;c<b[C];c++){var d=b[c],d=[this.ta.get([d.id()])[0],d];this.Ta.ue(a,[d],0);this.Ud(a,d)}});
H.Oe=function(a,b){this.Hc();this.xd(a);this.Ta.ve(a,b);for(var c=0;c<b[C];c++){var d=b[c],g=null,h=this.Ta.dj(a,d);null!=h?(g=this.ta.get([h])[0],d.Nh(h),this.Ta.ue(a,[[g,d]],0)):this.Ta.te(a,[d],0);this.Ud(a,[g,d])}};ua(H,function(a,b){this.Hc();this.xd(a);this.Ta.Lf(a,b,0);for(var c=0;c<b[C];c++)this.Ud(a,[b[c],null])});H.$h=function(){this.Gb.f()[F](function(a){var b=this.sa.get(a[t]());this.Ta.te(b,a.Tc().f(),1);this.Ta.Lf(b,a.Vc().f(),1);this.Ta.ue(b,a.Xc().f(),1)},this)};
...
function Ke(a,b){this.Ea=a;this.sa=b}Ke[r].pb=G("Ea");Ke[r].Zf=Ib("plan description");Ke[r].ha=G("sa");function Le(a){var b=new O;a[F](function(a){b[gb](a.ha())});return b};
...
H.Ga=function(a){return Re(this.j,"@rev/R")[z](function(a){this.Ya=a;return Re(this.j,"@table")}[E](this))[z](function(b){var c=0,d;for(d in b)this.ib.set(d,b[d]),b[d]>c&&(c=b[d]);a.$a()[F](function(a){this.ib.B(a[t]())||(b[a[t]()]=++c)},this);d=this.j[ib]("@table");return Se(d,b)}[E](this))};
H.je=function(a,b){var c=this.ib.get(a);return null!=c?function(){var a={},g=$c();this.j[bb]("T").equalTo(c)[Ga]("value",function(c){c[F](function(c){var g=b(c.val());a[da(c.key(),10)]=g});g[Db](a)});return g.ja}[q](this)[z](function(a){a["@rev"]={R:++this.Ya};return Se(this.j,a)}[E](this)):Vc()};H.Nc=function(a){return this.je(a,Ib(null))[z](function(){this.ib[w](a);return Se(this.j[ib]("@table/"+a),null,!0)}[E](this))};Qe[r].dropTable=Qe[r].Nc;
...
Qe[r].createRow=Qe[r].Ib;Qe[r].ad=G("Sa");Qe[r].getVersion=Qe[r].ad;Qe[r].tc=function(a){var b=$c();a=this.ib.get(a);this.j[bb]("T").equalTo(a)[Ga]("value",function(a){var d=[];a[F](function(a){d[x](a.val().P)});b[Db](d)});return b.ja};ja(Qe[r],function(){var a={},b=this.ib.U().map(function(b){return this.tc(b)[z](function(d){a[b]=d})}[E](this));return Zc(b)[z](function(){return a})});ja(Qe[r],Qe[r].dump);
...
function Ve(a,b){this.s=a;this.Dh=b;this.hd=new N;this.Ya=-1;this.I=new N;this.ib=new N;this.re=null}H=Ve[r];H.Nj=G("Ya");H.hh=Hb("Ya");
H.Ga=function(a){this.j=this.Dh[ib](this.s[n]());var b=a||function(){return Vc()};return Re(this.j,"@db/version")[z](function(a){return null===a?Se(this.j,this.vi(),!0)[z](function(){var a=new Qe(0,this.j);return b(a)}[E](this)):a==this.s[tb]()?Re(this.j,"@rev/R")[z](function(a){this.Ya=a;return Re(this.j,"@table")}[E](this))[z](function(a){for(var b in a)this.ib.set(b,a[b]);a=this.s.$a().map(function(a){return this.Xg(a[t]())},this);return Zc(a)}[E](this))[z](function(){this.ek();this.Hg();return Vc()}[E](this)):
...
H.jj=function(a){var b=new O,c=new N;this.ib[F](function(a,g){var h=this.I.get(g),l=new ee(g);if(this.hd.B(a)){var p=this.hd.get(a).f();b[gb](p);h.Ke(p)[F](function(a){l[Xa](a)})}c.set(a,l)}[E](this));a[F](function(a){if("@rev"!=a.key()){var g=da(a.key(),10);if(!b[sb](g)){a=a.val();var h=c.get(a.T),l=this.I.get(h[t]());l.getData().B(g)?h.modify([l.Ke([g])[0],new fd(g,a.P)]):h.add(new fd(g,a.P))}}}[E](this));return c.f()[Fa](function(a){return!a.Va()})};
H.Xg=function(a){var b=$c(),c=this.jg(a);this.j[bb]("T").equalTo(c)[Ga]("value",function(c){var g=new Ue,h=[];c[F](function(a){h[x](new fd(da(a.key(),10),a.val().P))});g.df(h);this.I.set(a,g);b[Db]()}[E](this));return b.ja};H.jg=function(a){return this.ib.get(a)};H.vi=function(){var a={};a["@db"]={version:this.s[tb]()};a["@rev"]={R:1};this.Ya=1;a["@table"]={};this.s.$a()[F](function(b,c){var d=b[t]();a["@table"][d]=c;this.I.set(d,new Ue);this.ib.set(d,c)},this);return a};
...
function Q(a,b,c,d){this.j=b;this.Ra=c;this.Sa=a;this.ud=d}I("lf.backstore.IndexedDBRawBackStore",Q,void 0);Q[r].Od=G("j");Q[r].getRawDBInstance=Q[r].Od;Q[r].Pd=G("Ra");Q[r].getRawTransaction=Q[r].Pd;Q[r].Nc=function(a){return new M(function(b,c){try{this.j.deleteObjectStore(a)}catch(d){c(d);return}b()},this)};Q[r].dropTable=Q[r].Nc;
Q[r].Gk=function(a,b,c){return new M(function(d,g){var h;try{var l=this.Ra[ub](a);h=l[Ea]()}catch(p){g(p);return}ra(h,function(){var a=h[Eb];a?(b(a),a[fb]()):(c(l),d())});ya(h,g)},this)};function We(a){var b=null;return b=a instanceof ArrayBuffer?jd(a):a instanceof Date?a[Cb]():a}Q[r].sf=function(a,b){function c(a){var c=Sd(a[u]),d=c.xc(),p;for(p in d){var y=hd(d[p]);b(y);d[p]=y.Ja()}a[Ua](c.Ja())}function d(a){var c=hd(a[u]);b(c);a[Ua](c.Ja())}return this.Gk(a,this.ud?c:d,Gb())};
...
Q[r].Rj=function(a){var b=[];return new M(function(c,d){var g;try{g=this.Ra[ub](a)[Ea]()}catch(h){d(h);return}ra(g,J(function(){var a=g[Eb];if(a){if(this.ud){var d=Sd(a[u]).xc(),h;for(h in d)b[x](d[h])}else b[x](a[u]);a[fb]()}else c(b)},this));ya(g,d)},this)};Q[r].Ib=function(a){var b={};xc(a,J(function(a,d){b[d]=We(a)},this));return id(b)};Q[r].createRow=Q[r].Ib;Q[r].ad=G("Sa");Q[r].getVersion=Q[r].ad;
...
H.dc=function(a){return new M(function(b,c){var d;try{d=a()}catch(g){c(g);return}ra(d,b);ya(d,c)},this)};H.put=function(a){if(0==a[C])return Vc();a=a.map(function(a){return this.dc(J(function(){return this.W.put(a.Ja())},this))},this);return Zc(a)};
...
function Ye(a,b,c,d,g){nd[q](this,c,d);this.m=a;this.Ra=b;this.ud=g;this.Ra.oncomplete=J(this.ca[Db],this.ca);this.Ra.onabort=J(this.ca[La],this.ca)}K(Ye,nd);Ye[r].M=function(a,b,c){return this.ud?(c=null!=c?c:0,a=this.Ra[ub](a),new Td(a,b,0==c?Yb(Ud,this.m):Vd)):new Xe(this.Ra[ub](a),b)};Ye[r].Kc=function(){return this.ca.ja};
...
function df(a,b,c){this.Ra=a;this.D=b;this.Ub=c}df[r].get=function(a){var b=this.Ub;this.Ra.Pa("SELECT id, value FROM "+this.D+" "+(0==a[C]?"":"WHERE id IN ("+a[Ka](",")+")"),[],function(a){for(var d=a[Ab][C],g=e(d),h=0;h<d;++h)g[h]=b({id:a[Ab][Na](h).id,value:JSON.parse(a[Ab][Na](h)[u])});return g});return this.Ra.oa()};
df[r].put=function(a){if(0==a[C])return Vc();var b="INSERT OR REPLACE INTO "+this.D+"(id, value) VALUES (?, ?)";a[F](function(a){this.Ra.Pa(b,[a.id(),JSON.stringify(a.w())])},this);return Vc()};ua(df[r],function(a){this.Ra.Pa("DELETE FROM "+this.D+" "+(0==a[C]?"":"WHERE id IN ("+a[Ka](",")+")"),[]);return Vc()});
function ef(a,b,c){nd[q](this,b,c);this.j=a;this.I=new Bd;this.ye=[]}K(ef,nd);ef[r].M=function(a,b){var c=this.I.get(a)||null;null===c&&(c=new df(this,a,b),this.I.set(a,c));return c};ef[r].Pa=function(a,b,c){this.ye[x]({kl:a,Hk:b,transform:c})};
...
function R(a,b,c){this.j=c;this.m=a;this.Sa=b}I("lf.backstore.WebSqlRawBackStore",R,void 0);R[r].Od=G("j");R[r].getRawDBInstance=R[r].Od;R[r].Pd=function(){throw new P(356);};R[r].getRawTransaction=R[r].Pd;R[r].Cd=function(){return new ef(this.j,new fe(this.m,[]),1)};R[r].Nc=function(a){var b=this.Cd();b.Pa("DROP TABLE "+a,[]);return b.oa()};R[r].dropTable=R[r].Nc;
R[r].tc=function(a){var b=this.Cd();b.Pa("SELECT id, value FROM "+a,[]);return b.oa()[z](function(a){for(var b=a[Ab][C],g=e(b),h=0;h<b;++h)g[h]={id:a[Ab][Na](h).id,value:JSON.parse(a[Ab][Na](h)[u])};return Vc(g)})};R[r].rf=function(a,b){var c=this.Cd(),d="UPDATE "+a+" SET value=? WHERE id=?";return this.tc(a)[z](function(a){a[F](function(a){a=b(a);c.Pa(d,[JSON.stringify(a[u]),a.id])});return c.oa()})};R[r].Fc=function(a,b,c){var d=We(c);return this.rf(a,function(a){a[u][b]=d;return a})};
R[r].addTableColumn=R[r].Fc;R[r].Oc=function(a,b){return this.rf(a,function(a){delete a[u][b];return a})};R[r].dropTableColumn=R[r].Oc;R[r].jd=function(a,b,c){return this.rf(a,function(a){a[u][c]=a[u][b];delete a[u][b];return a})};R[r].renameTableColumn=R[r].jd;R[r].Ib=function(a){var b={},c;for(c in a)b[c]=We(a[c]);return id(b)};R[r].createRow=R[r].Ib;R[r].ad=G("Sa");R[r].getVersion=R[r].ad;
...
H.li=function(a){var b=$c(),c=new ef(this.j,this.Hd(),1);c.Pa("CREATE TABLE IF NOT EXISTS __lf_ver(id INTEGER PRIMARY KEY, v INTEGER)",[]);c.Pa("SELECT v FROM __lf_ver WHERE id = 0",[]);c.oa()[z](J(function(c){var g=0;c[Ab][C]&&(g=c[Ab][Na](0).v);g<this.s[tb]()?this.af(a,g)[z](b[Db][E](b)):g>this.s[tb]()?b[La](new P(108)):b[Db]()},this));return b.ja};H.Tb=function(a,b){if(null!=this.j)return new ef(this.j,b,a);throw new P(2);};na(H,Gb());H.Zc=function(){throw new P(512);};
...
H.Kk=function(){var a=this.s.$a(),b=new ef(this.j,this.Hd(),1),c=new ef(this.j,this.Hd(),1);b.Pa("INSERT OR REPLACE INTO __lf_ver VALUES (0, ?)",[this.s[tb]()]);ff(b);return b.oa()[z](function(b){b[Fa](function(a){return-1!=a[Za](".")})[F](function(a){c.Pa("DROP TABLE "+a,[])});var g=b[Fa](function(a){return-1==a[Za](".")});a.map(function(a){return a[t]()})[Fa](function(a){return-1==g[Za](a)})[F](function(a){c.Pa("CREATE TABLE "+a+"(id INTEGER PRIMARY KEY, value TEXT)",[])});return c.oa()})};
H.lf=function(){var a=0,b=$c(),c=J(function(b){var c=new ef(this.j,this.Hd(),0);c.Pa("SELECT MAX(id) FROM "+b,[]);return c.oa()[z](function(b){b=b[Ab][Na](0)[0];a=ba.max(b,a)})},this),d=this.s.$a().map(function(a){return c(a[t]())});Zc(d)[z](function(){b[Db](a)},function(a){b[La](a)});return b.ja};
...
H.ob=function(a,b,c){var d=[],g=ba.min(b,c),h=ba.max(b,c);a=this.Qd(a);if(a[Fb]<h-g)a[F](function(a){a>=g&&a<=h&&(a=this.g.get(a),L(null!=a,"Inconsistent cache"),d[x](a))},this);else for(b=g;b<=h;++b)a.has(b)&&(c=this.g.get(b),L(null!=c,"Inconsistent cache"),d[x](c));return d};ua(H,function(a,b){var c=this.Qd(a);b[F](function(a){this.g[Xa](a);c[Xa](a)},this)});H.ya=function(a){return null!=a?this.Qd(a)[Fb]:this.g[Fb]};
...
function yf(a,b){b&&(b.Eb=a);a&&(a.Ba=b)}function qf(a,b){for(var c=b[C],d=0,g=tf(a),h=g;0<c;){var l=768<=c?511:257<=c&&511>=c?c:257,p=b[m](d,d+l);g.b=p.map(function(a){return a.key});g.A=p.map(function(a){return a[u]});d+=l;c-=l;0<c&&(l=tf(g.C),yf(g,l),g=l)}return h}function zf(a){var b=a[0],c=tf(b.C);c.qb=b.qb+1;c.i=a;for(b=0;b<a[C];++b)a[b].G=c,0<b&&c.b[x](a[b].b[0]);return c}
function rf(a){var b=a,c=[];do c[x](b),b=b.Ba;while(b);if(512>=c[C])b=zf(c);else{var d=c[C],g=0,b=tf(a.C);for(b.qb=a.qb+2;0<d;){a=768<=d?511:257<=d&&511>=d?d:257;var h=c[m](g,g+a),l=zf(h);l.G=b;b.i[C]&&(b.b[x](h[0].b[0]),yf(b.i[b.i[C]-1],l));b.i[x](l);g+=a;d-=a}}return b}H.get=function(a){var b=this.ld(a);if(this.ia()){var c=sf;this.C.Ua(this.b[b],a)&&(c=c[Ra](this.A[b]));return c}b=this.C.Ua(this.b[b],a)?b+1:b;return this.i[b].get(a)};
H.B=function(a){var b=this.ld(a);return this.C.Ua(this.b[b],a)?!0:this.ia()?!1:this.i[b].B(a)};ua(H,function(a,b){this.Vf(a,-1,b);if(this.Ag()){var c=this;1==this.i[C]&&(c=this.i[0],c.G=null);return c}return this});function Af(a){return a.ia()?a.b[0]:Af(a.i[0])}H.Ed=function(){this.b=[];for(var a=1;a<this.i[C];++a)this.b[x](Af(this.i[a]))};
H.Vf=function(a,b,c){var d=this.ld(a),g=this.ia();if(!g){var h=this.C.Ua(this.b[d],a)?d+1:d;if(this.i[h].Vf(a,h,c))this.Ed();else return!1}else if(!this.C.Ua(this.b[d],a))return!1;if(this.b[C]>d&&this.C.Ua(this.b[d],a)){if(Kb(c)&&!this.C.Ma()&&g&&(h=this.A[d],c=sc(h,tc,!1,c),0<=c&&mc(h,c)&&this.C.hb()[w](a,1),this.A[d][C]))return!1;this.b[A](d,1);g&&(g=this.C.Ma()?1:this.A[d][C],this.A[A](d,1),this.C.hb()[w](a,g))}256>this.b[C]&&!this.Ag()&&(this.ll()||this.yk(b));return!0};
...
H.Cb=function(a,b,c){var d=this.ld(a);if(this.ia()){if(this.C.Ua(this.b[d],a)){if(c)this.C.hb()[w](a,this.C.Ma()?1:this.A[d][C]),this.A[d]=this.C.Ma()?b:[b];else{if(this.C.Ma())throw new P(201);if(!uc(this.A[d],b))throw new P(109);}this.C.hb().add(a,1);return this}this.b[A](d,0,a);this.A[A](d,0,this.C.Ma()?b:[b]);this.C.hb().add(a,1);return 512==this.b[C]?this.il():this}d=this.C.Ua(this.b[d],a)?d+1:d;a=this.i[d].Cb(a,b,c);a.ia()||1!=a.b[C]||(this.b[A](d,0,a.b[0]),a.i[1].G=this,a.i[0].G=this,this.i[A](d,
1,a.i[1]),this.i[A](d,0,a.i[0]));return 512==this.b[C]?this.hl():this};H.il=function(){var a=tf(this.C),b=tf(this.C);b.qb=1;b.b=[this.b[256]];b.i=[this,a];b.G=this.G;this.G=b;a.b=this.b[A](256);a.A=this.A[A](256);a.G=b;yf(a,this.Ba);yf(this,a);return b};H.hl=function(){var a=tf(this.C),b=tf(this.C);a.G=this.G;a.qb=this.qb+1;a.b=[this.b[256]];a.i=[this,b];this.b[A](256,1);b.G=a;b.qb=this.qb;b.b=this.b[A](256);b.i=this.i[A](257);b.i[F](function(a){a.G=b});this.G=a;yf(b,this.Ba);yf(this,b);return a};
H.ld=function(a){for(var b=0,c=this.b[C];b<c;){var d=b+c>>1;this.C.Ve(this.b[d],a)?b=d+1:c=d}return b};H.cg=function(a){if(!this.ia()){var b=this.ld(a);this.C.Ua(this.b[b],a)&&b++;return this.i[b].cg(a)}return this};
H.ob=function(a,b,c){function d(a){return a[0]?a[1]?0:1:-1}var g=this.C.Lc(),h=0,l=this.b[C]-1,p=this.b,y=d(g.wb(p[h],a)),wa=d(g.wb(p[l],a));if(1!=y&&(-1!=y||-1!=wa)){var qb=function(a,b){var c=a+b>>1;return c==a?c+1:c},Cc=function(b,c,h){if(b>=c)return 0==h?c:-1;var l=d(g.wb(p[b],a));if(0==l)return b;if(1==l)return-1;l=qb(b,c);if(l==c)return 0==h?c:-1;var y=d(g.wb(p[l],a));return 0==y?Cc(b,l,y):-1==y?Cc(l+1,c,h):Cc(b+1,l,y)},bf=function(b,c){if(b>=c)return b;var h=d(g.wb(p[c],a));if(0==h)return c;
if(-1==h)return b;h=qb(b,c);if(h==c)return b;var l=d(g.wb(p[h],a));return 0==l?bf(h,c):1==l?bf(b,h-1):-1};0!=y&&(h=Cc(h+1,l,wa));-1!=h&&(l=bf(h,l),-1!=l&&l>=h&&this.Fh(b,c,h,l+1))}};H.Fh=function(a,b,c,d){for(;c<d&&(a[eb]||!(a[ab]>=a.ba));++c)if(this.C.Ma())!a[eb]&&a.V?a.V--:b[a.count++]=this.A[c];else for(var g=0;g<this.A[c][C]&&a[ab]<b[C];++g)!a[eb]&&a.V?a.V--:b[a.count++]=this.A[c][g]};
H.fill=function(a,b){if(this.ia())for(var c=0;c<this.A[C]&&0<a[ab];++c)if(0<a[vb]){if(a.offset=a[vb]-(this.C.Ma()?1:this.A[c][C]),0>a[vb])for(var d=this.A[c][C]+a[vb];d<this.A[c][C]&&0<a[ab];++d)b[a.pf++]=this.A[c][d],a.count--}else if(this.C.Ma())b[a.pf++]=this.A[c],a.count--;else for(d=0;d<this.A[c][C]&&0<a[ab];++d)b[a.pf++]=this.A[c][d],a.count--;else for(c=0;c<this.i[C]&&0<a[ab];++c)this.i[c].fill(a,b)};
function vf(a,b){for(var c=b.hb(),d=a.map(function(a){var d=new wf(a.id(),b);d.b=a.w()[0];d.A=a.w()[1];d.b[F](function(a,g){c.add(a,b.Ma()?1:d.A[g][C])});return d}),g=0;g<d[C]-1;++g)yf(d[g],d[g+1]);return 1<d[C]?rf(d[0]):d[0]};
...
H.Qe=function(a){return Ob(this.We(a).c)};H.de=function(a){a=this.We(a);return[a.c,a.u]};f(H,function(){return this.zd==Ef?"SimpleComparator_DESC":"SimpleComparator_ASC"});function Df(a){this.La=a.map(function(a){return new Cf(a)})}K(Df,Wd);H=Df[r];H.De=function(a,b,c){for(var d=0,g=0;g<this.La[C]&&0==d;++g)d=c(this.La[g],a[g],b[g]);return d};H.compare=function(a,b){return this.De(a,b,function(a,b,g){return a[yb](b,g)})};H.min=function(a,b){return this.De(a,b,function(a,b,g){return a.min(b,g)})};
H.max=function(a,b){return this.De(a,b,function(a,b,g){return a.max(b,g)})};H.wb=function(a,b){for(var c=[!0,!0],d=0;d<this.La[C]&&(c[0]||c[1]);++d){var g=this.La[d].wb(a[d],b[d]);c[0]=c[0]&&g[0];c[1]=c[1]&&g[1]}return c};H.Pe=function(a,b){for(var c=!0,d=0;d<this.La[C]&&c;++d)c=this.La[d].Pe(a[d],b[d]);return c};
H.kh=function(a){var b=a[Fa](function(a){return a[Ta](Pb)});a=e(this.La[C]);for(var c=0;c<a[C];c++)a[c]=b.map(function(a){return a[c]});a[F](function(a,b){a[Ya](J(function(a,c){return this.La[b].Ng(a,c)},this))},this);b=e(b[C]);for(c=0;c<b[C];c++)b[c]=a.map(function(a){return a[c]});return b[Ya](J(function(a,b){for(var c=0,l=0;l<this.La[C]&&0==c;++l)c=this.La[l].Ng(a[l],b[l]);return c},this))};H.Qe=function(a){return this.La[0].Qe(a[0])};
H.de=function(a){var b=a.map(function(a,b){return this.La[b].de(a)[0]},this);a=a.map(function(a,b){return this.La[b].de(a)[1]},this);return[b,a]};
function If(a){this.qa=a;this.rb=new O;this.md=new of;this.ub=new of}H=If[r];ma(H,function(){return this.qa[t]()});H.add=function(a,b){null===a?(this.rb.add(b),this.md.add(a,1)):this.qa.add(a,b)};H.set=function(a,b){null===a?(this.rb[v](),this.md[v](),this.add(a,b)):this.qa.set(a,b)};ua(H,function(a,b){if(null===a)b?(this.rb[w](b),this.md[w](a,1)):(this.rb[v](),this.md[v]());else this.qa[w](a,b)});H.get=function(a){return null===a?this.rb.f():this.qa.get(a)};H.Bd=function(a){return this.qa.Bd(a)};
H.hb=function(){this.ub.sl([this.qa.hb(),this.md]);return this.ub};H.ob=function(a,b,c,d){b=this.qa.ob(a,b,c,d);return null!=a?b:b[Ra](this.rb.f())};sa(H,function(){this.rb[v]();this.qa[v]()});H.B=function(a){return null===a?!this.rb.Va():this.qa.B(a)};H.min=function(){return this.qa.min()};H.max=function(){return this.qa.max()};H.Ja=function(){return[new fd(-2,this.rb.f())][Ra](this.qa.Ja())};H.Lc=function(){return this.qa.Lc()};H.Ma=function(){return this.qa.Ma()};
...
H.ed=function(a){if(0==this.Fb[Fb])return null;var b=kf(this.Fb)[Ja](J(function(b,d){return null===b||1==a(d,b)?d:b},this),null);return[b,[b]]};H.Bd=function(){return this.Fb[Fb]};H.ob=function(a,b,c,d){var g=a||[ie()];a=kf(this.Fb)[Fa](function(a){return g[$a](function(b){return this.X.Pe(a,b)},this)},this);return nf(a,b,c,d)};sa(H,function(){this.Fb[v]()});H.B=function(a){return this.Fb.has(a)};H.Ja=function(){return[new fd(0,kf(this.Fb))]};H.Lc=G("X");
function Kf(a,b){var c=new Jf(a);b[0].w()[F](function(a){c.add(a,a)});return c}H.Ma=Ib(!0);H.hb=function(){throw new P(300);};
...
function Of(a){this.fb=[];Kb(a)&&this.add(a)}H=Of[r];f(H,function(){return this.fb.map(function(a){return a[D]()})[Ka](",")});H.B=function(a){return this.fb[$a](function(b){return b[sb](a)})};H.f=G("fb");
H.add=function(a){if(0!=a[C])if(a=this.fb[Ra](a),1==a[C])this.fb=a;else{a[Ya](je);for(var b=[],c=a[0],d=1;d<a[C];++d)if(c.Pg(a[d])){var g=a[d],h=ie();if(null!==c.c&&null!==g.c){var l=he(c.c,g.c,!0);1!=l?(h.c=c.c,h.$=0!=l?c.$:c.$&&g.$):(h.c=g.c,h.$=g.$)}null!==c.u&&null!==g.u&&(l=he(c.u,g.u,!1),-1!=l?(h.u=c.u,h.da=0!=l?c.da:c.da&&g.da):(h.u=g.u,h.da=g.da));c=h}else b[x](c),c=a[d];b[x](c);this.fb=b}};
H.Pc=function(a){return this.fb[C]==a.fb[C]?0==this.fb[C]||this.fb[Ta](function(b,c){return b.Pc(a.fb[c])}):!1};function Pf(a,b){var c=[];a.f().map(function(a){return b.f().map(function(b){var c;if(a.Pg(b)){c=ie();var l=he(a.c,b.c,!0),l=0==l?a.$?a:b:-1!=l?a:b;c.c=l.c;c.$=l.$;null===a.u||null===b.u?b=null===a.u?b:a:(l=he(a.u,b.u,!1),b=0==l?a.da?a:b:-1==l?a:b);c.u=b.u;c.da=b.da}else c=null;return c})})[F](function(a){c=c[Ra](a)});return new Of(c[Fa](function(a){return null!==a}))};
...
function Zf(a){De[q](this);this.bc=a;this.cb=!1}K(Zf,De);H=Zf[r];H.Sb=function(){return Qf(this,function(a){if(a instanceof Zf){var b=new Zf(a.bc);b.cb=a.cb;b.nf(a.fa());return b}return a.Sb()}[E](this))};H.nb=function(a){var b=a||[];this.Cc(function(a){a!=this&&a.nb(b)}[E](this));return(new O(b)).f()};H.he=function(a){this.cb!=a&&(this.cb=a,this.bc="and"==this.bc?"or":"and",this.ea()[F](function(b){return b.he(a)}))};H.eval=function(a){var b=this.ea().map(function(b){return b.eval(a)});return this.oi(b)};
...
ua(H,function(a){this.sd(a);if(this.bd(a))return this.aa--,delete this.g[a],!0;a=gc(this.Ob,a);return 0<=a?(this.aa--,mc(this.Ob,a),mc(this.fe,a),!0):!1});H.addAll=function(a){hc(a.U(),function(b){this.set(b,a.get(b))},this)};H.Va=function(){return!this.aa};H.ya=G("aa");H.B=function(a){this.sd(a);return this.bd(a)||0<=gc(this.Ob,a)};H.Ad=function(a){return yc(this.g,function(b,c){return this.bd(c)&&$f(b,a)},this)||0<=gc(this.fe,a)};
...
function gg(a,b,c){De[q](this);this.Na=a;this.Da=b;this.L=c;this.Xe=null;this.Dd=ve.Ge().Ee(this.Na.Z(),this.L)}K(gg,De);H=gg[r];H.Sb=function(){var a=new gg(this.Na,this.Da,this.L);a.nf(this.fa());return a};H.nb=function(a){return null!=a?(a[x](this.Na),a[x](this.Da),a):[this.Na,this.Da]};H.reverse=function(){var a=this.L;switch(this.L){case "gt":a="lt";break;case "lt":a="gt";break;case "gte":a="lte";break;case "lte":a="gte"}return new gg(this.Da,this.Na,a)};
H.eval=function(a){var b=a[B][Fa](function(a){var b=a.S(this.Na);a=a.S(this.Da);return this.Dd(b,a)},this);return new ke(b,a.Y())};f(H,function(){return"join_pred("+this.Na.l()+", "+this.Da.l()+")"});H.Ef=function(a){return-1!=a.Y()[Za](this.Na.M().pa())};H.Gh=function(a){return-1!=a.Y()[Za](this.Da.M().pa())};H.Ei=function(a,b){var c=null,d=null;this.Ef(a)?(this.Gf(a,b),c=a,d=b):(this.Gf(b,a),c=b,d=a);return[c,d]};
H.Gf=function(a,b){L(this.Ef(a),"Mismatch between join predicate left operand and right relation.");L(this.Gh(b),"Mismatch between join predicate right operand and right relation.")};H.Li=function(a,b,c){var d=[a,b];c||(d=this.Ei(a,b));a=d[0];d=d[1];return"eq"==this.L?this.Mi(a,d,c):this.Ni(a,d,c)};H.wi=function(a){var b={};a.nb()[F](function(a){b[a[t]()]=null});return b};H.Rf=function(a,b){null===this.Xe&&(this.Xe=this.wi(this.Da.M()));var c=new re(new fd(-1,this.Xe),!1);return te(a,b,c,[this.Da.M().pa()])};
H.Ni=function(a,b,c){for(var d=[],g=a.Y(),h=b.Y(),l=0;l<a[B][C];l++){for(var p=!1,y=0;y<b[B][C];y++)if(this.Dd(a[B][l].S(this.Na),b[B][y].S(this.Da))){var p=!0,wa=te(a[B][l],g,b[B][y],h);d[x](wa)}c&&!p&&d[x](this.Rf(a[B][l],g))}a=a.Y()[Ra](b.Y());return new ke(d,a)};
H.Mi=function(a,b,c){var d=a,g=b,h=this.Na,l=this.Da;if(c||a[B][C]>b[B][C])d=b,g=a,h=this.Da,l=this.Na;var p=new fg,y=[];d[B][F](function(a){var b=ga(a.S(h));p.add(b,a)});var wa=d.Y(),qb=g.Y();g[B][F](function(a){var b=ga(a.S(l));p.B(b)?p.get(b)[F](function(b){b=te(a,qb,b,wa);y[x](b)}):c&&y[x](this.Rf(a,qb))}[E](this));a=a.Y()[Ra](b.Y());return new ke(y,a)};
function hg(a,b,c){return null===b?new Fe(a,b,c):Kb(b.l)?new gg(a,b,c):new Fe(a,b,c)};
var ig={};I("lf.schema.DataStoreType",ig,void 0);ig.INDEXED_DB=0;ig.MEMORY=1;ig.LOCAL_STORAGE=2;ig.FIREBASE=3;ig.WEB_SQL=4;ig.OBSERVABLE_STORE=5;function jg(a,b,c,d){this.qf=a;ia(this,b);this.cd=c;this.h=d}jg[r].l=function(){return this.qf+"."+this[n]};jg[r].ng=function(){return this.h[$a](function(a){return a.ga.Yb()})};function S(a,b,c,d){this.D=a;this.ua=c;this.H=b;this.$d=d;this.kb=null}I("lf.schema.Table",S,void 0);ma(S[r],G("D"));ma(S[r],S[r][t]);S[r].bb=G("kb");
S[r].pa=function(){return this.kb||this.D};S[r].Gc=function(a){var b=new this.constructor(this.D);b.kb=a;b.Tk=this.Tk;return b};S[r].as=S[r].Gc;S[r].createRow=S[r].Ib;S[r].deserializeRow=S[r].sc;S[r].za=G("ua");S[r].getIndices=S[r].za;S[r].nb=G("H");S[r].getColumns=S[r].nb;S[r].getConstraint=S[r].Jb;S[r].Lb=G("$d");S[r].persistentIndex=S[r].Lb;S[r].Vb=function(){return this.D+".#"};
function T(a,b){va(this,a);this.lc=b;this.kb=null}H=T[r];ma(H,function(){return this.lc+"("+this[ib][t]()+")"});H.l=function(){return this.lc+"("+this[ib].l()+")"};H.M=function(){return this[ib].M()};f(H,function(){return this.l()});H.Z=function(){return this[ib].Z()};H.bb=G("kb");H.za=function(){return[]};H.Yb=Ib(!1);H.Gc=function(a){this.kb=a;return this};T[r].as=T[r].Gc;T[r].bg=function(){for(var a=[this],b=this;b instanceof T;)a[x](b[ib]),b=b[ib];return a};
function kg(a){this.kb=a||null;this.O=new S("#UnknownTable",[],[],!1)}H=kg[r];ma(H,Ib("*"));H.l=function(){return this[t]()};f(H,function(){return this.l()});H.M=G("O");H.Z=Ib(4);H.bb=G("kb");H.za=function(){return[]};H.Yb=Ib(!1);
...
function mg(a){U[q](this,-1,1);this.Cf=a}K(mg,U);f(mg[r],function(){return"aggregation("+this.Cf.map(function(a){return a.l()})[D]()+")"});mg[r].ma=function(a,b){b[F](function(a){(new ng(a,this.Cf)).Th()},this);return b};function ng(a,b){this.Ia=a;this.H=b}
ng[r].Th=function(){this.H[F](function(a){a=a.bg()[eb]();for(var b=1;b<a[C];b++){var c=a[b],d=c.bg()[m](-1)[0],g=this.Aj(c),h=null;switch(c.lc){case "MIN":h=og(g,d);break;case "MAX":h=pg(g,d);break;case "DISTINCT":h=qg(g,d);break;case "COUNT":h=g[B][C];break;case "SUM":h=rg(g,d);break;case "AVG":0<g[B][C]&&(h=rg(g,d)/g[B][C]);break;case "GEOMEAN":h=sg(g,d);break;default:h=tg(g,d)}this.Ia.bl(c,h)}},this)};ng[r].Aj=function(a){return a[ib]instanceof T?this.Ia.wc(a[ib]):this.Ia};
...
function Vg(a,b){return a.ea().map(function(a){return"("+Wg(a,b)+")"})[Ka]("and"==a.bc?" AND ":" OR ")}function Wg(a,b){if(a instanceof Fe)return[a.K.l(),Tg(a.L),Ug(a[u],a.L,a.K.Z(),b)][Ka](" ");if(a instanceof Zf)return Vg(a,b);if(a instanceof gg)return[a.Na.l(),Tg(a.L),a.Da.l()][Ka](" ");throw new P(357,typeof a);}function Xg(a,b){var c=Wg(a,b);return c?" WHERE "+c:""}
...
gh[r].lb=function(){gh.Pb.lb[q](this);if(null==this.a.set)throw new P(532);if(this.a.set[$a](function(a){return a[u]instanceof ue}))throw new P(501);};
...
H.be=function(a,b){var c=a;if(this.fl(a))c=Vf(a),this.be(a,b);else if(this.el(a)){var d=[],c=Wf(a,b,function(a){a=new zg(a.Ca);d[x](a);return a});d[F](function(a){this.be(a,b)},this)}return c};H.Nk=function(a){var b=new O([a.Ca.K.M().pa()]),c=function(a){return this.Wf(a,b)}[E](this);return this.be(a,c)};H.Mk=function(a){var b=new O([a.Ca.Na.M().pa(),a.Ca.Da.M().pa()]),c=function(a){return this.Wf(a,b)}[E](this);return this.be(a,c)};
...
function wh(a,b){this.J=a;this.Bb=b;this.og=new O;this.og[gb](this.Bb.h.map(function(a){return a.ga[t]()}));this.Ue=this.va=null}H=wh[r];H.Jj=function(){return null===this.va?[]:this.va.f()};H.fg=function(){L(this.va);null===this.Ue&&(this.Ue=new uh(this.Bb,this.va));return this.Ue};H.ti=function(a){a[F](function(a){var c=a.nb()[0][t]();this.og[sb](c)&&(null===this.va&&(this.va=new fg),this.va.add(c,a.fa()))},this)};
...
xh[r].ma=function(a,b,c){a=this.Cg.Jd(c);b=this.J.get(this[lb].l());c=(1==a[C]&&a[0]instanceof ge&&a[0].wg()?nf(b.get(a[0].c),!1,this.qd?c.ba:void 0,this.rd?c.V:void 0):b.ob(a,this.jf,this.qd?c.ba:void 0,this.rd?c.V:void 0)).map(function(a){return new fd(a,{})},this);return[qe(c,[this[lb].qf])]};
...
function Ah(a,b){U[q](this,0,-1);this.ta=a.o(Gd);this.J=a.o(Hd);ha(this,b)}K(Ah,U);f(Ah[r],function(){var a="table_access("+this[k][t]();null===this[k].bb()||(a+=" as "+this[k].bb());return a+")"});Ah[r].ma=function(){var a=this.J.get(this[k].Vb()).ob();return[qe(this.ta.get(a),[this[k].pa()])]};
...
Bh[r].Yk=function(a,b,c){a.Jj().map(function(a){return b.get(a)})[F](Tf);a=new xh(this.m,a.Bb,a.fg(),!1);var d=new zh(this.m,c[k]);d.la(a);Xf(c,c,d,a);return a.pb()};
...
function Ih(a,b){this.Ia=a;this.H=b}Ih[r].kg=function(){return this.H[$a](function(a){return a instanceof T},this)?this.Yj():this.Zj()};
Ih[r].Yj=function(){if(1==this.H[C]&&"DISTINCT"==this.H[0].lc){var a=this.Ia.wc(this.H[0])[B].map(function(a){var b=new re(new fd(-1,{}),this.Ia.Re());b.mf(this.H[0],a.S(this.H[0][ib]));return b},this);return new ke(a,[])}var b=new re(new fd(-1,{}),this.Ia.Re());this.H[F](function(a){var d=a instanceof T?this.Ia.wc(a):this.Ia[B][0].S(a);b.mf(a,d)},this);return new ke([b],this.Ia.Y())};
Ih[r].Zj=function(){var a=e(this.Ia[B][C]),b=this.Ia.Re();this.Ia[B][F](function(c,d){a[d]=new re(new fd(c.wa.id(),{}),b);this.H[F](function(b){a[d].mf(b,c.S(b))},this)},this);return new ke(a,this.Ia.Y())};function Jh(a,b){var c=a.map(function(a){return(new Ih(a,b)).kg()[B][0]});return new ke(c,a[0].Y())};
...
function Mh(){}K(Mh,Jg);Mh[r].Mb=function(a){var b=Sf(a,function(a){return a instanceof Gh||a instanceof Lh});if(0==b[C])return a;var c=this.ej(a);if(null===c)return a;b[F](function(a){this.xk(a,c)},this);return c.pb()};Mh[r].xk=function(a,b){a instanceof Gh?b.qd=!0:b.rd=!0;return Tf(a).parent};Mh[r].ej=function(a){a=Sf(a,function(a){return a instanceof xh},function(a){return a instanceof Kh&&a.ak()||a instanceof Hh||1!=a.xa()||a instanceof yh});return 0<a[C]?a[0]:null};
function Nh(a){this.m=a}K(Nh,Jg);Nh[r].Mb=function(a){var b=Oh(a);if(null===b)return a;a=this.Jh(b);a==b&&(a=this.Ih(b));return a.pb()};Nh[r].Jh=function(a){var b=a,c=Ph(a.yb(0));if(null!==c){var d;d=a.N;for(var g=null,h=c[k].za(),l=0;l<h[C]&&null===g;l++)g=Qh(h[l],d);d=g;if(null===d)return b;b=new xh(this.m,d.Bb,new th(d.Bb),d.zg);d=new zh(this.m,c[k]);d.la(b);Tf(a);b=Xf(c,c,d,b)}return b};
...
function Uh(a,b){U[q](this,1,1);this.O=a;this.wl=b}K(Uh,U);f(Uh[r],function(){return"update("+this.O[t]()+")"});Uh[r].ma=function(a,b){var c=b[0][B].map(function(a){var b=this.O.sc(a.wa.Ja());this.wl[F](function(a){b.w()[a.K[t]()]=a[u]},this);return b},this);a[Ua](this.O,c);return[ne()]};
function Vh(a){this.m=a}Vh[r].create=function(a,b){var c=a.pb();if(c instanceof wg||c instanceof vg)return this.Ae(a,b);if(c instanceof Cg||c instanceof Gg||c instanceof Hg)return this.Ae(a,b,[new Bh(this.m),new Nh(this.m),new Mh]);if(c instanceof xg||c instanceof yg)return this.Ae(a,b,[new Bh(this.m)]);throw new P(8);};Vh[r].Ae=function(a,b,c){var d=Qf(a.pb(),J(this.tk,this));null!=c&&(d=(new Th(d,b,c)).vc());return new Ke(d,a.ha())};
...
function Xh(){this.Ig=new N}H=Xh[r];H.Id=function(a){var b=this.Ig.get(a[t](),null);null===b&&(b=new Yh,this.Ig.set(a[t](),b));return b};H.Vj=function(a,b,c){b[F](function(b){this.Id(b).Uj(a,c)},this)};H.Yh=function(a,b,c){return b[Ta](function(b){return this.Id(b).Xh(a,c)},this)};H.Zg=function(a,b,c){var d=this.Yh(a,b,c);d&&this.Vj(a,b,c);return d};H.releaseLock=function(a,b){b[F](function(b){this.Id(b).releaseLock(a)},this)};H.ni=function(a){a[F](function(a){this.Id(a).gb=null},this)};
function Yh(){this.ic=this.Xa=this.gb=this.Qc=null}Yh[r].releaseLock=function(a){this.Qc==a&&(this.Qc=null);this.gb==a&&(this.gb=null);null===this.Xa||this.Xa[w](a);null===this.ic||this.ic[w](a)};Yh[r].Xh=function(a,b){var c=null===this.Xa||this.Xa.Va();return 0==b?(null===this.ic||this.ic.Va())&&c&&null===this.Qc&&null!==this.gb&&this.gb==a:3==b?null===this.Qc&&null===this.gb&&null!==this.Xa&&this.Xa[sb](a):1==b?null===this.gb:c&&(null===this.gb||this.gb==a)};
Yh[r].Uj=function(a,b){0==b?(this.gb=null,this.Qc=a):3==b?(null===this.ic&&(this.ic=new O),this.ic.add(a),null===this.Xa&&(this.Xa=new O),this.Xa[w](a)):1==b?(null===this.Xa&&(this.Xa=new O),this.Xa.add(a)):2==b&&(this.gb=a)};
...
function ai(a,b){this.Ki=ve.Ge();this.ff=a;this.Xd=b;this.H=this.Di()}ai[r].Di=function(){if(0<this.ff.h[C])return this.ff.h;var a=[];this.ff.c[F](function(b){b.nb()[F](function(b){a[x](b)})});return a};ai[r].X=function(a,b){return this.H[Ta](function(c){return this.Ki.Ee(c.Z(),"eq")(a.S(c),b.S(c))},this)};
...
H.Ph=function(a){a=a.$c();return a.cf.pb()[Pa](this.Wa,a[mb])[z](function(a){return a[0].He()},J(function(a){this.Wa.Nb();var c=new Rc(a[n]);this.Rc[La](c);throw a;},this))};H.oa=function(){this.Hb.Tb(this.Z(),this.Wa).oa()[z](J(function(){this.kd();this.Rc[Db]()},this),J(function(a){this.Wa.Nb();this.Rc[La](a)},this));return this.fc.ja};H.Nb=function(){this.Wa.Nb();this.Rc[Db]();return this.fc.ja};H.kd=function(){var a=this.Kb.Le(this.sa.f());0!=a[C]&&(a=new Ne(this.m,a),this.Za.gc(a))};
function gi(a){this.m=a;this.Za=a.o(Jd);this.od=null;this.Ka=0}I("lf.proc.Transaction",gi,void 0);var hi=new N(0,new O([1,4]),1,new O([2]),2,new O([3,5,6]),3,new O([2,7]),4,new O([7]),5,new O([7]),6,new O([7]));gi[r].Qa=function(a){var b=hi.get(this.Ka,null);if(null===b||!b[sb](a))throw new P(107,this.Ka,a);this.Ka=a};
la(gi[r],function(a){this.Qa(4);var b=[];try{a[F](function(a){a.lb();b[x](a.$c())},this)}catch(c){return this.Qa(7),Wc(c)}a=new Ng(this.m,b);return this.Za.gc(a)[z](J(function(a){this.Qa(7);return a.map(function(a){return a.He()})},this),J(function(a){this.Qa(7);throw a;},this))});la(gi[r],gi[r][Pa]);gi[r].Qh=function(a){this.Qa(1);this.od=new fi(this.m,a);return this.od.xh()[z](J(function(){this.Qa(2)},this))};gi[r].begin=gi[r].Qh;
gi[r].Oh=function(a){this.Qa(3);return this.od.Ph(a)[z](J(function(a){this.Qa(2);return a},this),J(function(a){this.Qa(7);throw a;},this))};gi[r].attach=gi[r].Oh;gi[r].oa=function(){this.Qa(5);return this.od.oa()[z](J(function(){this.Qa(7)},this))};gi[r].commit=gi[r].oa;gi[r].Nb=function(){this.Qa(6);return this.od.Nb()[z](J(function(){this.Qa(7)},this))};gi[r].rollback=gi[r].Nb;
...
function Y(a,b,c,d,g,h){this.O=a;this.D=b;this.Bg=c;this.vg=d;this.sh=g;this.kb=h||null}I("lf.schema.BaseColumn",Y,void 0);H=Y[r];ma(H,G("D"));H.l=function(){return this.O.pa()+"."+this.D};f(H,function(){return this.l()});H.M=G("O");H.Z=G("sh");Y[r].getType=Y[r].Z;Y[r].bb=G("kb");Y[r].za=function(){null==this.ua&&(this.ua=[],this.M().za()[F](function(a){-1!=a.h.map(function(a){return a.ga[t]()})[Za](this.D)&&this.ua[x](a)},this));return this.ua};Y[r].Yb=G("vg");Y[r].isNullable=Y[r].Yb;Y[r].cd=G("Bg");
Y[r].Ua=function(a){return hg(this,a,"eq")};Y[r].eq=Y[r].Ua;Y[r].Jg=function(a){return hg(this,a,"neq")};Y[r].neq=Y[r].Jg;Y[r].Ve=function(a){return hg(this,a,"lt")};Y[r].lt=Y[r].Ve;Y[r].sk=function(a){return hg(this,a,"lte")};Y[r].lte=Y[r].sk;Y[r].Wj=function(a){return hg(this,a,"gt")};Y[r].gt=Y[r].Wj;Y[r].Xj=function(a){return hg(this,a,"gte")};Y[r].gte=Y[r].Xj;Y[r].match=function(a){return hg(this,a,"match")};Y[r].match=Y[r].match;Y[r].Rh=function(a,b){return hg(this,[a,b],"between")};
Y[r].between=Y[r].Rh;Y[r].dk=function(a){return hg(this,a,"in")};Y[r]["in"]=Y[r].dk;Y[r].lk=function(){return this.Ua(null)};Y[r].isNull=Y[r].lk;Y[r].kk=function(){return this.Jg(null)};Y[r].isNotNull=Y[r].kk;Y[r].Gc=function(a){return new Y(this.O,this.D,this.Bg,this.vg,this.sh,a)};Y[r].as=Y[r].Gc;
...
function ki(a){this.s=a;this.gf=new Bd;this.Qg=new Bd;this.Pf=new Bd;this.i=new Bd;this.we=new Bd;this.gk()}H=ki[r];H.gk=function(){this.s.$a()[F](function(a){var b=new jf;a.Jb().Fe()[F](function(c){var d=this.gf.get(c.eb)||[];d[x](c);this.gf.set(c.eb,d);b.add(this.s[k](c.eb));(d=this.i.get(c.eb))||(d=new jf);d.add(a);this.i.set(c.eb,d);this.Pf.set(a[t]()+"."+c.Rb,c.eb);c=c.eb+"."+c.Ac;d=this.we.get(c)||[];d[x](a[t]());this.we.set(c,d)},this);0!=b[Fb]&&this.Qg.set(a[t](),b)},this)};
...
function mi(a,b){var c=a.ref[Ia](".");if(2!=c[C])throw new P(540,b);this.Rb=a.local;this.eb=c[0];this.Ac=c[1];ia(this,b);this.action=a.action;this.timing=a[Ma]};
...
var b=this;K(a,S);a[r].Ib=function(a){return new this.dh(gd++,a)};a[r].createRow=a[r].Ib;a[r].sc=function(a){var b={};this.nb()[F](function(g){var h=g[t]();g=g.Z();var l=a[u][h];if(0==g)if(g=l,null!=g&&""!=g){0!=g[C]%2&&(g="0"+g);for(var l=new ArrayBuffer(g[C]/2),p=new Uint8Array(l),y=0,wa=0;y<g[C];y+=2)p[wa++]=da(g.substr(y,2),16);g=l}else g=null;else g=2==g?null!=l?new Date(l):null:l;b[h]=g},this);return new this.dh(a.id,b)};a[r].deserializeRow=a[r].sc;a[r].Jb=G("si");a[r].getConstraint=a[r].Jb;
return a};
Z[r].qj=function(a,b){function c(c,d){this.H=a;this.ua=b;fd[q](this,c,d)}K(c,fd);c[r].Uf=function(){var a={};this.H[F](function(b){a[b[t]()]=b.Yb()?null:be[b.Z()]});return a};c[r].ph=function(){var a={};this.H[F](function(b){var c=b[t]();b=b.Z();var d=this.w()[c];a[c]=0==b?null!=d?jd(d):null:2==b?null!=d?d[Cb]():null:6==b?null!=d?d:null:d},this);return a};var d=J(function(a){var b=this.H.get(a[t]());return 2==b?function(b){b=b[a[t]()];return a.Yb()&&null===b?null:b[Cb]()}:1==b?function(b){return a.Yb()?(b=
b[a[t]()],null===b?null:b?1:0):b[a[t]()]?1:0}:function(b){return b[a[t]()]}},this),g=J(function(a){var b=a.map(function(a){return d(a.ga)});return function(a){return b.map(function(b){return b(a)})}},this),h={};b[F](function(a){var b=a.l();a=1==a.h[C]?d(a.h[0].ga):g(a.h);h[b]=a});c[r].Zb=function(a){return-1!=a[Za]("#")?this.id():h[rb](a)?h[a](this.w()):null};return c};
function pi(a,b){this.s=new qi(a,b);this.vb=new N;this.Sc=!1}I("lf.schema.Builder",pi,void 0);H=pi[r];H.di=function(a){a.Wc()[F](function(b){var c=b.eb;if(!this.vb.B(c))throw new P(536,b[n]);var c=this.vb.get(c).Ab(),d=b.Ac;if(!c[rb](d))throw new P(537,b[n]);if(a.Ab()[b.Rb].Z()!=c[d].Z())throw new P(538,b[n]);if(!c[d].cd())throw new P(539,b[n]);},this)};H.ci=function(a){a.Wc()[F](function(a){this.vb.get(a.eb).Wc()[F](function(c){if(c.Rb==a.Ac)throw new P(534,a[n]);},this)},this)};
H.aj=function(){this.Sc||(this.vb.f()[F](function(a){this.di(a);this.s.dl(a.Ab())},this),this.vb.f()[F](this.ci,this),this.bi(),this.vb[v](),this.Sc=!0)};H.Kf=function(a,b){a.wf||(a.wf=!0,a.Ze=!0,a.Xf[F](function(c){c=b.get(c);if(!c.wf)this.Kf(c,b);else if(c.Ze&&a!=c)throw new P(533);},this));a.Ze=!1};H.bi=function(){var a=new Bd;this.s.I.U()[F](function(b){a.set(b,new ri(b))},this);this.vb[F](function(b,c){b.Wc()[F](function(b){a.get(b.eb).Xf.add(c)})});Dd(a)[F](function(b){this.Kf(b,a)},this)};
