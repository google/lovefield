...
lf.proc.TableAccessByRowIdStep.prototype.exec=function(a){return this.getChildAt(0).exec(a).then(goog.bind(function(b){return goog.Promise.resolve(lf.proc.Relation.fromRows(a.getTableRows(this.table_,b.getRowIds()),[this.table_.getEffectiveName()]))},this))};lf.proc.IndexRangeScanStep=function(a,b,c){lf.proc.PhysicalQueryPlanNode.call(this);this.index_=a;this.keyRanges_=b;this.order_=c};goog.inherits(lf.proc.IndexRangeScanStep,lf.proc.PhysicalQueryPlanNode);
lf.proc.IndexRangeScanStep.prototype.toString=function(){return"index_range_scan("+this.index_.getNormalizedName()+", "+this.keyRanges_.toString()+", "+(this.order_==lf.Order.ASC?"ASC":"DESC")+")"};lf.proc.IndexRangeScanStep.prototype.exec=function(a){a=a.getIndexRange(this.index_,this.keyRanges_);this.order_==lf.Order.DESC&&a.reverse();a=a.map(function(a){return new lf.Row(a,{})},this);return goog.Promise.resolve(lf.proc.Relation.fromRows(a,[this.index_.tableName]))};
