...
lf.index.BTree.prototype.containsKey=function(a){return this.root_.containsKey(a)};lf.index.BTree.prototype.isUniqueKeyOnly=function(){return this.uniqueKeyOnly_};lf.index.BTree.prototype.getComparator=function(){return this.comparator_};lf.index.BTree.prototype.lt=function(a,b){return goog.isDefAndNotNull(a)?this.comparator_.compare(a,b)==lf.index.FAVOR.RHS:!1};lf.index.BTree.prototype.eq=function(a,b){return goog.isDefAndNotNull(a)?this.comparator_.compare(a,b)==lf.index.FAVOR.TIE:!1};
lf.index.BTree.prototype.serialize=function(){var a=this.root_.getLeftMostNode();return lf.index.BTreeNode_.serialize(a)};lf.index.BTree.deserialize=function(a,b,c,d){a=new lf.index.BTree(c,a,d);b=lf.index.BTreeNode_.deserialize(b,a);a.root_=b;return a};lf.index.BTreeNode_=function(a,b){this.id_=a;this.tree_=b;this.height_=0;this.next_=this.prev_=this.parent_=null;this.keys_=[];this.values_=[];this.children_=[]};lf.index.BTreeNode_.MAX_COUNT_=512;
lf.index.BTreeNode_.MAX_KEY_LEN_=lf.index.BTreeNode_.MAX_COUNT_-1;lf.index.BTreeNode_.MIN_KEY_LEN_=lf.index.BTreeNode_.MAX_COUNT_>>1;lf.index.BTreeNode_.create=function(a){return a=new lf.index.BTreeNode_(lf.Row.getNextId(),a)};lf.index.BTreeNode_.prototype.isLeaf_=function(){return 0==this.height_};lf.index.BTreeNode_.prototype.isRoot_=function(){return null==this.parent_};
...
lf.index.BTreeNode_.prototype.getRange=function(a){var b=0,c=this.keys_.length-1;if(goog.isDefAndNotNull(a)){var d=this.tree_.getComparator(),d=goog.bind(d.compare,d);if(!goog.isNull(a.to)){if(d(this.keys_[0],a.to)==lf.index.FAVOR.LHS)return[];d(this.keys_[c],a.to)!=lf.index.FAVOR.RHS&&(c=this.searchKey_(a.to),(a.excludeUpper&&d(this.keys_[c],a.to)==lf.index.FAVOR.TIE||d(this.keys_[c],a.to)==lf.index.FAVOR.LHS)&&c--)}goog.isNull(a.from)||d(this.keys_[0],a.from)==lf.index.FAVOR.LHS||(b=this.searchKey_(a.from),
a.excludeLower&&d(this.keys_[b],a.from)==lf.index.FAVOR.TIE&&b++)}d=[];c==this.keys_.length-1?(d=d.concat(this.values_.slice(b)),this.next_&&(d=d.concat(this.next_.getRange(a)))):c>=b&&(d=d.concat(this.values_.slice(b,c+1)));this.tree_.isUniqueKeyOnly()||(d=goog.array.flatten(d));return d};lf.index.BTreeNode_.serialize=function(a){for(var b=[];a;){var c=[a.keys_,a.values_];b.push(new lf.Row(a.id_,c));a=a.next_}return b};
...
lf.index.ComparatorFactory={};lf.index.ComparatorFactory.create=function(){return new lf.index.SimpleComparator(lf.Order.ASC)};lf.index.SimpleComparator=function(a){this.compare_=a==lf.Order.DESC?lf.index.SimpleComparator.compareDescending:lf.index.SimpleComparator.compareAscending};lf.index.SimpleComparator.compareAscending=function(a,b){return a>b?lf.index.FAVOR.LHS:a<b?lf.index.FAVOR.RHS:lf.index.FAVOR.TIE};
...
lf.index.SimpleComparator.prototype.isInRange=function(a,b){return lf.index.SimpleComparator.isInRange(this.compare_,a,b)};lf.index.MultiKeyComparator=function(a){this.comparators_=a.map(function(a){return a==lf.Order.DESC?lf.index.SimpleComparator.compareDescending:lf.index.SimpleComparator.compareAscending})};lf.index.MultiKeyComparator.createOrders=function(a,b){for(var c=Array(a),d=0;d<a;++d)c[d]=b;return c};
lf.index.MultiKeyComparator.prototype.compare=function(a,b){for(var c=0,d=0;d<this.comparators_.length&&0==c;++d)c=this.comparators_[d](a[d],b[d]);return c};lf.index.MultiKeyComparator.prototype.isInRange=function(){};
