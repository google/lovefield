...
lf.service.OBSERVER_REGISTRY=new lf.service.ServiceId("observerregistry");lf.service.SCHEMA=new lf.service.ServiceId("schema");
lf.Stream=function(){};
...
lf.query.observe=function(a,b){var c=lf.Global.get().getService(lf.service.OBSERVER_REGISTRY);c.addObserver(a,b)};lf.query.unobserve=function(a,b){var c=lf.Global.get().getService(lf.service.OBSERVER_REGISTRY);c.removeObserver(a,b)};lf.query.Builder=function(){};lf.query.Select=function(){};lf.query.Insert=function(){};lf.query.Update=function(){};lf.query.Delete=function(){};
...
lf.query.BaseBuilder=function(){lf.Global.get().getService(lf.service.QUERY_ENGINE);this.runner_=lf.Global.get().getService(lf.service.RUNNER)};lf.query.BaseBuilder.prototype.exec=function(){try{this.assertExecPreconditions()}catch(a){return goog.Promise.reject(a)}return new goog.Promise(function(a,c){var d=new lf.proc.UserQueryTask(lf.Global.get(),[this.query]);this.runner_.scheduleTask(d).then(function(c){a(c[0].getPayloads())},c)},this)};lf.query.BaseBuilder.prototype.bind=function(){return this};
...
lf.schema={};lf.schema.Column=function(){};lf.schema.Database=function(){};lf.schema.Index=function(a,b,c,d,e){this.tableName=a;this.name=b;this.isUnique=c;this.persistent=d;this.columnNames=e};lf.schema.Index.prototype.getNormalizedName=function(){return this.tableName+"."+this.name};lf.schema.Table=function(){};
...
lf.fn.AggregatedColumn.prototype.getType=function(){return this.child.getType()};lf.fn.AggregatedColumn.prototype.getAlias=function(){return this.alias_};lf.fn.AggregatedColumn.prototype.getColumnChain=function(){for(var a=[this],b=this;b instanceof lf.fn.AggregatedColumn;)a.push(b.child),b=b.child;return a};
...
lf.ObserverRegistry=function(a){this.global_=a;this.entries_=new goog.structs.Map};lf.ObserverRegistry.prototype.getQueryId_=function(a){return goog.getUid(a).toString()};lf.ObserverRegistry.prototype.addObserver=function(a,b){var c=a.getQuery(),d=this.getQueryId_(c),e=this.entries_.get(d,null);goog.isNull(e)&&(e=new lf.ObserverRegistry.Entry_(this.global_,c),this.entries_.set(d,e));e.addObserver(b)};
...
lf.ObserverRegistry.Entry_=function(a,b){this.query_=b;this.observers_=new goog.structs.Set;this.observable_=[];this.lastResults_=null;this.lastResultVersion_=-1;this.diffCalculator_=new lf.DiffCalculator(a,b,this.observable_)};lf.ObserverRegistry.Entry_.prototype.addObserver=function(a){this.observers_.contains(a)?goog.asserts.fail("Attempted to register observer twice."):(Array.observe(this.observable_,a),this.observers_.add(a))};
...
lf.base.init=function(a,b,c,d){lf.Global.reset();var e=lf.Global.get(),f=new lf.cache.DefaultCache;e.registerService(lf.service.CACHE,f);b=b==lf.base.BackStoreType.MEMORY?new lf.backstore.Memory(a):new lf.backstore.IndexedDB(e,a,d);e.registerService(lf.service.BACK_STORE,b);return b.init(c).then(function(){var b=new lf.proc.DefaultQueryEngine(e);e.registerService(lf.service.QUERY_ENGINE,b);b=new lf.proc.Runner;e.registerService(lf.service.RUNNER,b);b=new lf.index.MemoryIndexStore;e.registerService(lf.service.INDEX_STORE,
b);var c=new lf.eval.Registry;e.registerService(lf.service.EVAL_REGISTRY,c);c=new lf.ObserverRegistry(e);e.registerService(lf.service.OBSERVER_REGISTRY,c);return b.init(a)}).then(function(){var b=new lf.cache.Prefetcher(e);return b.init(a)})};lf.base.closeDatabase=function(){var a=lf.Global.get();try{var b=a.getService(lf.service.BACK_STORE);b.close()}catch(c){}};
...
!0;throw a;},this))};lf.proc.Database=function(a){this.schema_=a;this.initialized_=!1};lf.proc.Database.prototype.init=function(a,b){return lf.base.init(this.schema_,b||lf.base.BackStoreType.INDEXED_DB,a,!1).then(goog.bind(function(){this.initialized_=!0;return this},this))};lf.proc.Database.prototype.checkInit_=function(){if(!this.initialized_)throw new lf.Exception(lf.Exception.Type.UNINITIALIZED,"Database is not initialized");};lf.proc.Database.prototype.insert=function(){this.checkInit_();return new lf.query.InsertBuilder};
lf.proc.Database.prototype.insertOrReplace=function(){this.checkInit_();return new lf.query.InsertBuilder(!0)};lf.proc.Database.prototype.update=function(a){this.checkInit_();return new lf.query.UpdateBuilder(a)};lf.proc.Database.prototype.delete=function(){this.checkInit_();return new lf.query.DeleteBuilder};lf.proc.Database.prototype.close=function(){lf.base.closeDatabase(this.schema_);this.initialized_=!1};
...
lf.schema.BaseColumn.prototype.match=function(a){return lf.pred.createPredicate(this,a,lf.eval.Type.MATCH)};lf.schema.BaseColumn.prototype.isNull=function(){return this.eq(null)};
