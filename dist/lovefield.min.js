...
lf.index.FAVOR={RHS:-1,TIE:0,LHS:1};lf.index.hashCode=function(a){for(var b=0,c=0;c<a.length;++c)b=(b<<5)-b+a.charCodeAt(c),b&=b;return b};lf.index.hashArray=function(a){a=a.map(function(a){return goog.isDefAndNotNull(a)?lf.index.hashCode(a.toString()).toString(32):""});return a.join("_")};lf.index.slice=function(a,b,c){if(!goog.isDefAndNotNull(b)&&!goog.isDefAndNotNull(c))return a;b=Math.min(goog.isDef(b)?b:a.length,a.length);if(0==b)return[];c=Math.min(c||0,a.length);return a.slice(c,c+b)};
...
lf.index.BTree.prototype.remove=function(a,b){this.root_=this.root_.remove(a,b)};lf.index.BTree.prototype.get=function(a){return this.root_.get(a)};lf.index.BTree.prototype.cost=function(a){return this.getRange(a).length};lf.index.BTree.prototype.getRange=function(a,b,c,d){b=null;(a=this.comparator_.normalizeKeyRange(a))&&(goog.isNull(a.from)||(b=this.root_.getContainingLeaf(a.from)));null==b&&(b=this.root_.getLeftMostNode());return lf.index.slice(b.getRange(a),c,d)};
lf.index.BTree.prototype.clear=function(){this.root_=lf.index.BTreeNode_.create(this)};lf.index.BTree.prototype.containsKey=function(a){return this.root_.containsKey(a)};lf.index.BTree.prototype.isUniqueKeyOnly=function(){return this.uniqueKeyOnly_};lf.index.BTree.prototype.getComparator=function(){return this.comparator_};lf.index.BTree.prototype.lt=function(a,b){return goog.isDefAndNotNull(a)?this.comparator_.compare(a,b)==lf.index.FAVOR.RHS:!1};
lf.index.BTree.prototype.eq=function(a,b){return goog.isDefAndNotNull(a)?this.comparator_.compare(a,b)==lf.index.FAVOR.TIE:!1};lf.index.BTree.prototype.serialize=function(){var a=this.root_.getLeftMostNode();return lf.index.BTreeNode_.serialize(a)};lf.index.BTree.deserialize=function(a,b,c,d){a=new lf.index.BTree(c,a,d);b=lf.index.BTreeNode_.deserialize(b,a);a.root_=b;return a};
...
lf.index.SimpleComparator=function(a){this.compare_=a==lf.Order.DESC?lf.index.SimpleComparator.compareDescending:lf.index.SimpleComparator.compareAscending;this.normalizeKeyRange_=a==lf.Order.DESC?function(a){return goog.isDefAndNotNull(a)?a.reverse():null}:goog.functions.identity};lf.index.SimpleComparator.compareAscending=function(a,b){return a>b?lf.index.FAVOR.LHS:a<b?lf.index.FAVOR.RHS:lf.index.FAVOR.TIE};
...
lf.index.AATree.prototype.getRange=function(a,b,c,d){b=null;goog.isDefAndNotNull(a)?(b=a,goog.isNull(b.from)&&(b.from=this.findMin_().key),goog.isNull(b.to)&&(b.to=this.findMax_().key)):b=new lf.index.KeyRange(this.findMin_().key,this.findMax_().key,!1,!1);a=[];this.traverse_(this.root_,b,a);return lf.index.slice(a,c,d)};lf.index.AATree.prototype.clear=function(){this.root_=this.nullNode_};lf.index.AATree.prototype.containsKey=function(a){return null!=this.search_(this.root_,a)};
...
lf.proc.OrderByIndexPass.prototype.applyTableAccessFullOptimization_=function(a){var b=a,c=lf.proc.OrderByIndexPass.findTableAccessFullStep_(a.getChildAt(0));if(!goog.isNull(c)){var d=a.orderBy[0],e=d.column.getIndices()[0];e.columns[0].order==d.order&&(b=new lf.proc.IndexRangeScanStep(e,[lf.index.KeyRange.all()],d.order),d=new lf.proc.TableAccessByRowIdStep(c.table),d.addChild(b),lf.tree.removeNode(a),b=lf.tree.replaceNodeWithChain(c,d,b))}return b};
lf.proc.OrderByIndexPass.prototype.applyIndexRangeScanStepOptimization_=function(a){var b=a,c=lf.proc.OrderByIndexPass.findIndexRangeScanStep_(a.orderBy[0],a.getChildAt(0));goog.isNull(c)||(b=lf.tree.removeNode(a));return b};
lf.proc.OrderByIndexPass.findIndexRangeScanStep_=function(a,b){var c=function(b){return b instanceof lf.proc.IndexRangeScanStep&&b.index.columns[0].name==a.column.getName()&&b.index.columns[0].order==a.order},d=function(a){return 1!=a.getChildCount()},c=lf.tree.find(b,c,d);return 0<c.length?c[0]:null};
lf.proc.OrderByIndexPass.findTableAccessFullStep_=function(a){var b=function(a){return a instanceof lf.proc.TableAccessFullStep},c=function(a){return 1!=a.getChildCount()};a=lf.tree.find(a,b,c);return 0<a.length?a[0]:null};
