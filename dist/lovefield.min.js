...
m.put=function(a){if(0==a.length)return w();var b=y();a.forEach(function(a){var d;d=a.id()>>9;var e=b.get(d)||null;null===e&&(e=this.sf(this.Z.name,d));Ac(e,[a]);b.set(d,e)},this);a=z(b).map(function(a){return this.Wb(function(){return this.Z.put(a.Ja())}.bind(this))},this);return eb(a)};
m.remove=function(a){if(0==a.length)return this.Wb(function(){return this.Z.clear()}.bind(this));var b=y();a.forEach(function(a){var d=a>>9,e=b.get(d)||null;null===e&&(e=this.sf(this.Z.name,d));Bc(e,[a]);b.set(d,e)},this);a=z(b).map(function(a){return this.Wb(function(){return 0==Object.keys(a.m).length?this.Z.delete(a.W()):this.Z.put(a.Ja())}.bind(this))},this);return eb(a)};function Fc(a,b,c){a=a.b(mc);var d=[c<<9,(c+1<<9)-1];b=a.Ua(b,d[0],d[1]);c=new yc(c);Ac(c,b);return c}
...
function cd(a,b,c){b=ad(a.g.info(),b.getName(),1);if(null===b)return null;var d=new Sc;bd(a,b,c,function(a,b,c){b=b.get(c);0<b.length&&d.Zb(a.Ie,b)});return d}function dd(a,b,c){var d=new Sc;bd(a,c,b,function(a,b,c,k){b.get(c).forEach(function(b){d.set(b,{Ud:a,Fg:k[1]})})});return d}function bd(a,b,c,d){b.forEach(function(a){var b=this.D.get(a.name),h=Yc(this,a);c.forEach(function(c){if(Zc(c[0],c[1],h.getName())){var n=c[0].pb(h.getName());d(a,b,n,c)}},this)},a)}
...
function ae(a,b){var c=a.h&&a.h[b];return c?(c.F=null,a.h.splice(b,1),0==a.h.length&&(a.h=null),c):null}J.prototype.removeChild=function(a){return ae(this,K(this).indexOf(a))};function be(a,b,c){Zd(a,c).F=null;b.F=a;a.h[c]=b}function ce(a,b,c){!1!==b.call(c,a)&&K(a).forEach(function(a){ce(a,b,c)})};function de(){J.call(this);this.sa=ee++}t(de,J);var ee=0;de.prototype.W=g("sa");function fe(a,b,c){de.call(this);this.H=a;this.value=b;this.C=c;this.yc=Wd(Vd(),this.H.J(),this.C);this.Va=!1;this.fc=b}t(fe,de);m=fe.prototype;m.Pb=function(){var a=new fe(this.H,this.value,this.C);a.fc=this.fc;a.xd(this.Va);var b=this.W();a.sa=b;return a};m.nb=function(a){return null!=a?(a.push(this.H),a):[this.H]};m.s=function(a){a=null!=a?a:C();a.add(this.H.I());return a};m.xd=ba("Va");
function ge(a){var b=!1;a.value instanceof Md||(b="array"==da(a.value)?!a.value.some(function(a){return a instanceof Md}):!0);if(!b)throw new E(501);}m.eval=function(a){ge(this);if("in"==this.C)return he(this,a);var b=a.entries.filter(function(a){return this.yc(I(a,this.H),this.value)!=this.Va},this);return new H(b,a.s())};
m.bind=function(a){if(this.fc instanceof Md){var b=this.fc.Ca();if(a.length<=b)throw new E(510);this.value=a[b]}else"array"==da(this.fc)&&(this.value=this.fc.map(function(b){if(b instanceof Md){var d=b.Ca();if(a.length<=d)throw new E(510);return a[b.Ca()]}return b}))};function he(a,b){var c=C(a.value),d=function(a){return null===a?!1:c.has(a)!=this.Va}.bind(a),e=b.entries.filter(function(a){return d(I(a,this.H))},a);return new H(e,b.s())}
m.toString=function(){return"value_pred("+this.H.j()+" "+this.C+(this.Va?"(complement)":"")+" "+this.value+")"};m.od=function(){ge(this);return null!==this.value&&("between"==this.C||"in"==this.C||"eq"==this.C||"gt"==this.C||"gte"==this.C||"lt"==this.C||"lte"==this.C)};
m.xe=function(){var a=null;if("between"==this.C)a=new F(ie(this,this.value[0]),ie(this,this.value[1]),!1,!1);else{if("in"==this.C)return a=this.value.map(function(a){return new F(a,a,!1,!1)}),new xd(this.Va?wd(a):a);a=ie(this,this.value);a="eq"==this.C?new F(a,a,!1,!1):"gte"==this.C?new F(a,G,!1,!1):"gt"==this.C?new F(a,G,!0,!1):"lte"==this.C?new F(G,a,!1,!1):new F(G,a,!1,!0)}return new xd(this.Va?pd(a):[a])};function ie(a,b){return 2==a.H.J()?b.getTime():b};function je(a){this.ba=a;this.Zc=this.Ga=null}function ke(a,b){null===a.Ga&&null!=a.w&&(a.Ga=le(a.w));return a.Ga.get(b)||null}function le(a){var b=y();ce(a,function(a){b.set(a.W(),a)});return b}function me(a,b){b.w&&(a.w=b.w.Pb());a.Zc=b}je.prototype.bind=function(){return this};function oe(a,b){var c=a.w;null!=c&&ce(c,function(a){a instanceof fe&&a.bind(b)})};function pe(a){je.call(this,a)}t(pe,je);function qe(a){var b="";a.forEach(function(c,d){b+=c.H.j()+" ";b+=1==c.sb?"ASC":"DESC";d<a.length-1&&(b+=", ")});return b}pe.prototype.da=function(){return C(this.from)};pe.prototype.clone=function(){var a=new pe(this.ba);me(a,this);this.f&&(a.f=this.f.slice());this.from&&(a.from=this.from.slice());a.X=this.X;a.L=this.L;this.N&&(a.N=this.N.slice());this.la&&(a.la=this.la.slice());this.Vb&&(a.Vb=this.Vb);this.bc&&(a.bc=this.bc);a.cb=this.cb;return a};
pe.prototype.bind=function(a){pe.hb.bind.call(this,a);null!=this.Vb&&(this.X=a[this.Vb.Ca()]);null!=this.bc&&(this.L=a[this.bc.Ca()]);oe(this,a);return this};function re(a,b){this.Ha=a;this.aa=b}re.prototype.ab=g("Ha");re.prototype.da=g("aa");function se(a){var b=C();a.forEach(function(a){a.da().forEach(b.add.bind(b))});return b};function te(a,b){this.global=a;this.Na=a.b(lc);this.vd=b.map(function(a){return a.context});this.kf=b.map(function(a){return a.ke});this.Od=se(this.kf);this.ye=ue(this);this.fb=fb()}function ue(a){return a.vd.some(function(a){return!(a instanceof pe)})?1:0}m=te.prototype;
m.exec=function(){function a(){var f=d.shift();if(f){var h=e[c.length];return f.ab().exec(b,h).then(function(b){c.push(b[0]);return a()})}return w()}var b=0==this.ye?void 0:new kd(this.global,this.Od),c=[],d=this.kf.slice(),e=this.vd;return a().then(function(){this.ja=this.Na.Hb(this.ye,D(this.Od),b);return this.ja.ka()}.bind(this)).then(function(){this.he(c);return c}.bind(this),function(a){null!=b&&b.Mb();throw a;})};m.J=g("ye");m.da=g("Od");m.Rb=g("fb");m.W=function(){return ka(this)};m.he=aa();
m.Y=function(){var a=null;null!=this.ja&&(a=this.ja.Y());return null===a?new A(!1,0,0,0,0):a};function ve(a,b){te.call(this,a,b);this.Lb=a.b(qc)}t(ve,te);ve.prototype.getPriority=l(0);ve.prototype.he=function(a){this.vd.forEach(function(b,c){we(this.Lb,b,a[c])},this)};function xe(a,b){this.c=a;this.Lb=a.b(qc);this.Ia=a.b(pc);this.kd=new Hc(a);this.ib=b;var c=a.b(rc),d=this.ib.map(function(a){return c.table(a.getName())});this.aa=C(d);this.fb=fb()}m=xe.prototype;m.exec=function(){this.kd.update(this.ib);this.Pc();return w()};m.J=l(1);m.da=g("aa");m.Rb=g("fb");m.W=function(){return ka(this)};m.getPriority=l(1);m.Pc=function(){var a=ye(this.Lb,this.aa);0!=a.length&&(a=new ve(this.c,a),ze(this.Ia,a))};function Ae(a){this.c=a;this.Na=a.b(lc);this.Ia=a.b(pc)}Ae.prototype.fe=function(a){a=new xe(this.c,a);ze(this.Ia,a)};function M(a,b){this.Ta=a;this.i=b;this.Ya=y()}r("lf.backstore.FirebaseRawBackStore",M);M.prototype.fd=g("i");M.prototype.gd=function(){throw new E(351);};function Be(a,b){var c=fb(),d=a;b.length&&(d=a.child(b));d.once("value",function(a){c.resolve(a.val())},function(a){c.reject(a)});return c.ha}function Ce(a,b,c){function d(a){a?e.reject(a):e.resolve()}c=c||!1;var e=fb();c?a.set(b,d):a.update(b,d);return e.ha}
...
M.prototype.dump=M.prototype.dump;function Ee(a,b,c){cc.call(this,b,c);this.i=a}t(Ee,cc);Ee.prototype.I=function(a){return this.i.Dc(a)};
...
Ge.prototype.remove=function(a){Je(this,a);return w()};function Ke(a){return 0==a.Ba.size?0:Wb(a.Ba).reduce(function(a,c){return a>c?a:c},0)};function Le(a,b){this.g=a;this.Gf=b;this.Nc=y();this.Ra=-1;this.M=y();this.Ya=y();this.Ld=null}m=Le.prototype;
m.Ea=function(a){this.i=this.Gf.child(this.g.name());var b=a||function(){return w()};return Be(this.i,"@db/version").then(function(a){return null===a?Ce(this.i,Me(this),!0).then(function(){var a=new M(0,this.i);return b(a)}.bind(this)).then(function(){return this.Ea()}.bind(this)):a==this.g.version()?Be(this.i,"@rev/R").then(function(a){this.Ra=a;return Be(this.i,"@table")}.bind(this)).then(function(a){for(var b in a)this.Ya.set(b,a[b]);a=this.g.pa().map(function(a){return Fe(this,a.getName())},this);
...
function Oe(a){a.i.off();a.i.on("child_removed",a.Cg.bind(a));a.Md&&(a.Md.off(),a.Nc.clear());a.Md=a.i.orderByChild("R").startAt(a.Ra+1);a.Md.on("value",a.fe.bind(a))}function Ne(a){Yb=z(a.M).map(function(a){return Ke(a)}).reduce(function(a,c){return a>c?a:c},0)+1}m.Cg=function(a){var b=a.val(),c=this.Nc.get(b.T)||null;null===c&&(c=C(),this.Nc.set(b.T,c));c.add(parseInt(a.key(),10))};
...
this)};function Ze(a,b,c){var d=c.target.result;c=new N(c.oldVersion,d,c.target.transaction,a.Id);$e(d);a.g.pa().forEach(qa(a.Pf,d),a);return b(c)}function $e(a){for(var b=[],c=0;c<a.objectStoreNames.length;++c){var d=a.objectStoreNames.item(c);-1!=d.indexOf(".")&&b.push(d)}b.forEach(function(b){try{a.deleteObjectStore(b)}catch(c){}})}
...
function If(a,b,c){if(!a.$.Qd(b.a[c]))if(1<b.a[c].length){if(null===b.a[c][0])return null}else return null;return[b.a[c],a.Bf?[b.B[c]]:b.B[c]]}m.Kb=function(a){var b;a:{b=Ff(this.ua);var c=0;do if(c>=b.a.length)b=b.ya,c=0;else{var d=If(this,b,c);if(null!==d){b=d;break a}c++}while(null!==b);b=null}a:{c=Jf(this.ua);d=c.a.length-1;do if(0>d)c=c.tb,d=0;else{var e=If(this,c,d);if(null!==e){c=e;break a}d--}while(null!==c);c=null}return null===b||null===c?null:1==a(b[0],c[0])?b:c};m.La=g("Bf");m.lb=g("$");
m.Pa=function(a,b){return null!=a?0==this.$.compare(a,b):!1};m.Ja=function(){for(var a=[],b=Ff(this.ua);b;)a.push(new Xb(b.sa,[b.a,b.B])),b=b.ya;return a};function Kf(a,b,c,d){a=new Bf(b,a,c);d=Lf(d,a);a.ua=d;return a}function Mf(a,b){this.sa=a;this.u=b;this.ob=0;this.ya=this.tb=this.F=null;this.a=[];this.B=[];this.h=[];this.cg=1==b.lb().ae()?this.Qe:this.Pe}function Hf(a){return new Mf(Yb++,a)}function Q(a){return 0==a.ob}m=Mf.prototype;m.next=g("ya");
...
function Qf(a,b){for(var c=0,d=a.a.length,e=a.u.lb();c<d;){var f=c+d>>1;-1==e.compare(a.a[f],b)?c=f+1:d=f}return c}m.Qe=function(a){if(!Q(this)){var b=Qf(this,a);this.u.Pa(this.a[b],a)&&b++;return this.h[b].Qe(a)}return this};m.Pe=function(a){if(!Q(this)){var b=Qf(this,a);this.u.Pa(this.a[b],a)&&(a.some(function(a){return a==G})||b++);return this.h[b].Pe(a)}return this};
...
function mg(a,b){var c=new lg(a);b[0].m.forEach(function(a){c.add(a,a)});return c}m.La=l(!0);m.Y=function(){var a=new zf;a.ia=this.vb.size;return a};function ng(a){this.Na=a.b(lc);this.D=a.b(nc);this.V=a.b(mc)}ng.prototype.Ea=function(a){var b=a.pa(),c=function(){if(0==b.length)return w();var a=b.shift();return(a.Fb()?og(this,a):pg(this,a)).then(c)}.bind(this);return c()};function pg(a,b){var c=a.Na.Hb(0,[b]),d=c.I(b.getName(),b.mb.bind(b),0).get([]).then(function(a){this.V.Zb(b.getName(),a);qg(this,b,a)}.bind(a));c.ka();return d}
function qg(a,b,c){var d=a.D.oc.get(b.getName())||[];c.forEach(function(a){d.forEach(function(b){var c=a.pb(b.getName());b.add(c,a.id())})})}function og(a,b){var c=a.Na.Hb(0,[b]),d=c.I(b.getName(),b.mb,0).get([]).then(function(a){this.V.Zb(b.getName(),a)}.bind(a)),e=b.Da().map(function(a){return rg(this,a,c)},a).concat(sg(a,b,c));c.ka();return eb(e.concat(d))}
function rg(a,b,c){c=c.I(b.j(),Zb,1);var d=ig(b);return c.get([]).then(function(a){if(0<a.length){if(tg(b)){var c=Kf.bind(void 0,d,b.j(),b.Gc);a=kg(c,a)}else a=Kf(d,b.j(),b.Gc,a);this.D.set(b.pc,a)}}.bind(a))}function sg(a,b,c){return c.I(bf(b),Zb,1).get([]).then(function(a){0<a.length&&(a=mg(bf(b),a),this.D.set(b.getName(),a))}.bind(a))};function ug(){this.Z=y();this.oc=y()}ug.prototype.Ea=function(a){a.pa().forEach(function(a){var c=[];this.oc.set(a.getName(),c);var d=bf(a);if(null===this.get(d)){var e=new lg(d);c.push(e);this.Z.set(d,e)}a.Da().forEach(function(a){var b;b=ig(a);b=new Bf(a.j(),b,a.Gc);b=tg(a)&&1==a.f.length?new jg(b):b;c.push(b);this.Z.set(a.j(),b)},this)},this);return w()};ug.prototype.get=function(a){return this.Z.get(a)||null};
...
function Gg(a){var b=null;return K(a).every(function(a){if(!(a instanceof fe&&a.od()))return!1;null===b&&(b=a.H);return b.j()==a.H.j()})};function Hg(a,b,c){de.call(this);this.ga=a;this.na=b;this.C=c;this.ee=null;a=Vd();this.yc=Wd(a,this.ga.J(),this.C);this.qg=a.$e.get(this.ga.J())||null}t(Hg,de);m=Hg.prototype;m.Pb=function(){var a=new Hg(this.ga,this.na,this.C),b=this.W();a.sa=b;return a};m.nb=function(a){return null!=a?(a.push(this.ga),a.push(this.na),a):[this.ga,this.na]};m.s=function(a){a=null!=a?a:C();a.add(this.ga.I());a.add(this.na.I());return a};
...
function Ig(a,b,c){var d=null,e=null;-1!=b.s().indexOf(Jd(a.ga.I()))?(d=b,e=c):(d=c,e=b);if(d.entries.length>e.entries.length){a:{b=a.ga;a.ga=a.na;a.na=b;b=a.C;switch(a.C){case "gt":b="lt";break;case "lt":b="gt";break;case "gte":b="lte";break;case "lte":b="gte";break;default:break a}a.C=b;a.yc=Wd(Vd(),a.ga.J(),a.C)}return[e,d]}return[d,e]}function Jg(a){var b={};a.nb().forEach(function(a){b[a.getName()]=null});return b}
function Kg(a,b,c){null===a.ee&&(a.ee=Jg(a.na.I()));var d=new Hd(new Xb(-1,a.ee),!1);return Ld(b,c,d,[Jd(a.na.I())])}
...
function bh(a,b){var c=y();a.entries.forEach(function(a){var e=I(a,b);c.set(e,a)});return new H(z(c),a.s())};function gh(a,b){this.Ha=a;this.aa=b}gh.prototype.ab=g("Ha");gh.prototype.da=g("aa");function hh(){J.call(this)}t(hh,J);function ih(a,b){J.call(this);this.table=a;this.values=b}t(ih,hh);function jh(a,b){ih.call(this,a,b)}t(jh,ih);function kh(a){J.call(this);this.table=a}t(kh,hh);kh.prototype.toString=function(){return"delete("+this.table.getName()+")"};function lh(a,b){J.call(this);this.table=a;this.ze=b}t(lh,hh);
lh.prototype.toString=function(){var a=[];this.ze&&(a=this.ze.map(function(a){return a.H.getName()},this));return"update("+this.table.getName()+", ["+a.join(",")+"])"};function mh(a){J.call(this);this.O=a}t(mh,hh);mh.prototype.toString=function(){return"select("+this.O.toString()+")"};function nh(a){J.call(this);this.table=a}t(nh,hh);nh.prototype.toString=function(){var a="table_access("+this.table.getName();null===this.table.$a()||(a+=" as "+this.table.$a());return a+")"};
function oh(){J.call(this)}t(oh,hh);oh.prototype.toString=l("cross_product");function ph(a,b){J.call(this);this.f=a;this.Sb=b}t(ph,hh);ph.prototype.toString=function(){var a="project("+this.f.toString();if(null!==this.Sb)var b=this.Sb.map(function(a){return a.j()}).join(", "),a=a+(", groupBy("+b+")");return a+")"};function qh(a){J.call(this);this.N=a}t(qh,hh);qh.prototype.toString=function(){return"order_by("+qe(this.N)+")"};function rh(a){J.call(this);this.f=a}t(rh,hh);
rh.prototype.toString=function(){return"aggregation("+this.f.toString()+")"};function sh(a){J.call(this);this.f=a}t(sh,hh);sh.prototype.toString=function(){return"group_by("+this.f.toString()+")"};function th(a){J.call(this);this.X=a}t(th,hh);th.prototype.toString=function(){return"limit("+this.X+")"};function uh(a){J.call(this);this.L=a}t(uh,hh);uh.prototype.toString=function(){return"skip("+this.L+")"};function vh(a,b){J.call(this);this.O=a;this.Ub=b}t(vh,hh);
vh.prototype.toString=function(){return"join(type: "+(this.Ub?"outer":"inner")+", "+this.O.toString()+")"};function wh(){};function xh(){}t(xh,wh);xh.prototype.gb=function(a){this.G=a;this.xb(this.G);return this.G};xh.prototype.xb=function(a){if(a instanceof mh){var b=yh(this,a.O),b=zh(this,b);Cg(a,a,b[0],b[1]);a==this.G&&(this.G=b[0]);a=b[0]}K(a).forEach(function(a){this.xb(a)},this)};function yh(a,b){if(0==K(b).length||"and"!=b.rb)return[b];var c=K(b).slice().map(function(a){b.removeChild(a);return yh(this,a)},a);return Ea(c)}
function zh(a,b){var c=null,d=null;b.map(function(a,b){var h=new mh(a);0==b?c=h:L(d,h);d=h},a);return[c,d]};function Ah(){}t(Ah,wh);Ah.prototype.gb=function(a,b){if(3>b.from.length)return a;this.G=a;this.xb(this.G);return this.G};Ah.prototype.xb=function(a){if(a instanceof oh)for(;2<K(a).length;){for(var b=new oh,c=0;2>c;c++){var d=ae(a,0);L(b,d)}$d(a,b,0)}K(a).forEach(function(a){this.xb(a)},this)};function Bh(){T.call(this,0,0)}t(Bh,T);Bh.prototype.toString=l("cross_product");Bh.prototype.ca=function(a){var b=a[0],c=a[1];a=[];for(var d=b.s(),e=c.s(),f=0;f<b.entries.length;f++)for(var h=0;h<c.entries.length;h++){var k=Ld(b.entries[f],d,c.entries[h],e);a.push(k)}b=b.s().concat(c.s());return[new H(a,b)]};function Ch(a,b){te.call(this,a,b);this.Ia=a.b(pc);this.Lb=a.b(qc)}t(Ch,te);Ch.prototype.getPriority=l(2);Ch.prototype.he=function(a){0==this.J()?Dh(this,a):this.Pc()};function Dh(a,b){a.vd.forEach(function(a,d){a instanceof pe&&we(this.Lb,a,b[d])},a)}Ch.prototype.Pc=function(){var a=ye(this.Lb,this.da());0!=a.length&&(a=new ve(this.global,a),ze(this.Ia,a))};function Eh(a){je.call(this,a)}t(Eh,je);Eh.prototype.da=function(){var a=C();a.add(this.from);Fh(this,this.from.getName(),a);return a};function Fh(a,b,c){var d=Gh(a.ba.info(),b,1);Gh(a.ba.info(),b).forEach(c.add.bind(c));d.forEach(function(a){Fh(this,a.getName(),c)},a)}Eh.prototype.clone=function(){var a=new Eh(this.ba);me(a,this);a.from=this.from;return a};Eh.prototype.bind=function(a){Eh.hb.bind.call(this,a);oe(this,a);return this};function Hh(a){je.call(this,a)}t(Hh,je);Hh.prototype.da=function(){var a=C();a.add(this.Ka);var b=this.ba.info();Ih(this.Ka.getName(),b.hf).forEach(a.add.bind(a));this.dc&&Gh(b,this.Ka.getName()).forEach(a.add.bind(a));return a};Hh.prototype.clone=function(){var a=new Hh(this.ba);me(a,this);a.Ka=this.Ka;this.values&&(a.values=this.values instanceof Md?this.values:this.values.slice());a.dc=this.dc;a.ec=this.ec;return a};
Hh.prototype.bind=function(a){Hh.hb.bind.call(this,a);this.ec&&(this.values=this.ec instanceof Md?a[this.ec.Ca()]:this.ec.map(function(b){return b instanceof Md?a[b.Ca()]:b}));return this};function Jh(a){je.call(this,a)}t(Jh,je);Jh.prototype.da=function(){var a=C();a.add(this.table);var b=this.set.map(function(a){return a.H.j()}),c=this.ba.info();Kh(c,b).forEach(a.add.bind(a));Lh(c,b).forEach(a.add.bind(a));return a};Jh.prototype.clone=function(){var a=new Jh(this.ba);me(a,this);a.table=this.table;a.set=this.set?this.set.slice():this.set;return a};Jh.prototype.bind=function(a){Jh.hb.bind.call(this,a);this.set.forEach(function(b){-1!=b.Wc&&(b.value=a[b.Wc])});oe(this,a);return this};function Mh(a,b){if(null==b)return"NULL";switch(a){case 1:return b?1:0;case 3:case 4:return b;case 0:return"'"+ac(b)+"'";default:return"'"+b.toString()+"'"}}function Nh(a,b){var c=a.dc?"INSERT OR REPLACE":"INSERT",d=a.Ka.nb(),c=c+(" INTO "+a.Ka.getName()+"("),c=c+d.map(function(a){return a.getName()}).join(", "),c=c+") VALUES (";return a.values.map(function(a){var f=d.map(function(c){var d=a.m[c.getName()];return b?null!=d?"#":"NULL":Mh(c.J(),d)});return c+f.join(", ")+");"}).join("\n")}
function Oh(a){switch(a){case "between":return"BETWEEN";case "eq":return"=";case "gte":return">=";case "gt":return">";case "in":return"IN";case "lte":return"<=";case "lt":return"<";case "match":return"LIKE";case "neq":return"<>";default:return"UNKNOWN"}}function Ph(a,b,c,d){return a instanceof Md?"?"+a.Ca().toString():d?null!=a?"#":"NULL":"match"==b?"'"+a.toString()+"'":"in"==b?"("+a.map(function(a){return Mh(c,a)}).join(", ")+")":"between"==b?Mh(c,a[0])+" AND "+Mh(c,a[1]):Mh(c,a).toString()}
function Qh(a,b){return K(a).map(function(a){return"("+Rh(a,b)+")"}).join("and"==a.rb?" AND ":" OR ")}function Sh(a){return[a.ga.j(),Oh(a.C),a.na.j()].join(" ")}function Rh(a,b){if(a instanceof fe){var c=a.H.j(),d=Oh(a.C),e=Ph(a.value,a.C,a.H.J(),b);return"="==d&&"NULL"==e?[c,"IS NULL"].join(" "):"<>"==d&&"NULL"==e?[c,"IS NOT NULL"].join(" "):[c,d,e].join(" ")}if(a instanceof Eg)return Qh(a,b);if(a instanceof Hg)return Sh(a);throw new E(357,typeof a);}
function Th(a,b){var c=Rh(a,b);return c?" WHERE "+c:""}function Uh(a,b){var c="UPDATE "+a.table.getName()+" SET ",c=c+a.set.map(function(a){var b=a.H.j()+" = ";return-1!=a.Wc?b+"?"+a.Wc.toString():b+Mh(a.H.J(),a.value).toString()}).join(", ");a.w&&(c+=Th(a.w,b));return c+";"}
function Vh(a,b){var c="*";a.f.length&&(c=a.f.map(function(a){return a.$a()?a.j()+" AS "+a.$a():a.j()}).join(", "));c="SELECT "+c+" FROM ";null!=a.cb&&0!=a.cb.size?c+=Wh(a,b):(c+=a.from.map(Xh).join(", "),a.w&&(c+=Th(a.w,b)));if(a.N)var d=a.N.map(function(a){return a.H.j()+(0==a.sb?" DESC":" ASC")}).join(", "),c=c+(" ORDER BY "+d);a.la&&(d=a.la.map(function(a){return a.j()}).join(", "),c+=" GROUP BY "+d);a.X&&(c+=" LIMIT "+a.X.toString());a.L&&(c+=" SKIP "+a.L.toString());return c+";"}
function Xh(a){return Jd(a)!=a.getName()?a.getName()+" AS "+Jd(a):a.getName()}function Wh(a,b){for(var c=xg(a.w,function(a){return a instanceof Hg}),d=c.map(Sh),e=Xh(a.from[0]),f=1;f<a.from.length;f++)var h=Xh(a.from[f]),e=a.cb.has(c[d.length-f].W())?e+(" LEFT OUTER JOIN "+h):e+(" INNER JOIN "+h),e=e+(" ON ("+d[d.length-f]+")");c=Zd(a.w,0);c instanceof Hg||(e+=" WHERE "+Rh(c,b));return e}
function Yh(a,b){var c=b||!1,d=a.query.clone();if(d instanceof Hh)return Nh(d,c);if(d instanceof Eh){var e="DELETE FROM "+d.from.getName();d.w&&(e+=Th(d.w,c));return e+";"}if(d instanceof Jh)return Uh(d,c);if(d instanceof pe)return Vh(d,c);throw new E(358,typeof d);};function U(a,b){this.global=a;this.Kg=a.b(oc);this.Ia=a.b(pc);this.query=b}r("lf.query.BaseBuilder",U);U.prototype.exec=function(){try{this.kb()}catch(a){return bb(a)}return new v(function(a,b){var c=new Ch(this.global,[this.Ec()]);ze(this.Ia,c).then(function(b){a(zd(b[0]))},b)},this)};U.prototype.exec=U.prototype.exec;U.prototype.$f=function(){var a=function(a){return a.Sc(this.query)+"\n"}.bind(this);return Dg(Zh(this).ab(),a)};U.prototype.explain=U.prototype.$f;
U.prototype.bind=function(a){this.query.bind(a);return this};U.prototype.bind=U.prototype.bind;U.prototype.Sg=function(a){return Yh(this,a)};U.prototype.toSql=U.prototype.Sg;U.prototype.kb=aa();function Zh(a){if(null==a.jf){var b;b=a.Kg;var c=a.query,d=b.tg.create(c);b=b.Hg.create(d,c);a.jf=b}return a.jf}U.prototype.Ec=function(){return{context:this.query.clone(),ke:Zh(this)}};function $h(a){U.call(this,a,new Eh(a.b(rc)))}t($h,U);r("lf.query.DeleteBuilder",$h);$h.prototype.from=function(a){if(null!=this.query.from)throw new E(515);this.query.from=a;return this};$h.prototype.from=$h.prototype.from;$h.prototype.w=function(a){this.Hd();this.query.w=a;return this};$h.prototype.where=$h.prototype.w;$h.prototype.Hd=function(){if(null==this.query.from)throw new E(548);if(null!=this.query.w)throw new E(516);};
$h.prototype.kb=function(){$h.hb.kb.call(this);if(null==this.query.from)throw new E(517);};function ai(a,b){U.call(this,a,new Hh(a.b(rc)));this.query.dc=b||!1}t(ai,U);r("lf.query.InsertBuilder",ai);ai.prototype.kb=function(){ai.hb.kb.call(this);var a=this.query;if(null==a.Ka||null==a.values)throw new E(518);if(a.dc&&null===a.Ka.Jb().ed())throw new E(519);};ai.prototype.Ka=function(a){if(null!=this.query.Ka)throw new E(520);this.query.Ka=a;return this};ai.prototype.into=ai.prototype.Ka;
ai.prototype.values=function(a){if(null!=this.query.values)throw new E(521);a instanceof Md||a.some(function(a){return a instanceof Md})?this.query.ec=a:this.query.values=a;return this};ai.prototype.values=ai.prototype.values;function bi(a){return ci("and",Array.prototype.slice.call(arguments))}r("lf.op.and",bi);r("lf.op.or",function(a){return ci("or",Array.prototype.slice.call(arguments))});function ci(a,b){var c=new Eg(a);b.forEach(function(a){L(c,a)});return c}r("lf.op.not",function(a){a.xd(!0);return a});function V(a,b){U.call(this,a,new pe(a.b(rc)));this.Oe=this.Cd=!1;this.query.f=b;di(this);ei(this)}t(V,U);r("lf.query.SelectBuilder",V);V.prototype.kb=function(){V.hb.kb.call(this);var a=this.query;if(null==a.from)throw new E(522);if(q(a.Vb)&&!q(a.X)||q(a.bc)&&!q(a.L))throw new E(523);null!=this.query.la?fi(this):gi(this)};function di(a){var b=a.query.f.filter(function(a){return a instanceof S&&"DISTINCT"==a.Ob},a);if(0!=b.length&&(1!=b.length||1!=a.query.f.length))throw new E(524);}
function fi(a){var b=a.query.f.filter(function(a){return!(a instanceof S)}).map(function(a){return a.j()}),c=!1;if(0==a.query.la.length||0==a.query.f.length)c=!0;else{var d=a.query.la.map(function(a){return a.j()});(c=b.some(function(a){return-1==d.indexOf(a)}))||(c=a.query.la.some(function(a){a=a.J();return 6==a||0==a}))}if(c)throw new E(525);}
function gi(a){var b=a.query.f.some(function(a){return a instanceof S},a);a=a.query.f.some(function(a){return!(a instanceof S)},a)||0==a.query.f.length;if(b&&a)throw new E(526);}function ei(a){a.query.f.forEach(function(a){if(a instanceof S&&!hi(a.Ob,a.J()))throw new E(527,a.j());},a)}function ii(a,b){if(null==a.query.from)throw new E(b);}
V.prototype.from=function(a){if(this.Oe)throw new E(515);this.Oe=!0;null==this.query.from&&(this.query.from=[]);this.query.from.push.apply(this.query.from,Array.prototype.slice.call(arguments));return this};V.prototype.from=V.prototype.from;V.prototype.w=function(a){ii(this,548);if(this.Cd)throw new E(516);this.Cd=!0;ji(this,a);return this};V.prototype.where=V.prototype.w;function ji(a,b){if(null!=a.query.w){var c=bi(b,a.query.w);a.query.w=c}else a.query.w=b}
V.prototype.kg=function(a,b){ii(this,542);if(this.Cd)throw new E(547);this.query.from.push(a);ji(this,b);return this};V.prototype.innerJoin=V.prototype.kg;V.prototype.rg=function(a,b){ii(this,542);if(!(b instanceof Hg))throw new E(541);if(this.Cd)throw new E(547);this.query.from.push(a);null==this.query.cb&&(this.query.cb=C());var c=b;Jd(a)!=Jd(b.na.I())&&(c=b.reverse());this.query.cb.add(c.W());ji(this,c);return this};V.prototype.leftOuterJoin=V.prototype.rg;
...
V.prototype.N=function(a,b){ii(this,549);null==this.query.N&&(this.query.N=[]);this.query.N.push({H:a,sb:null!=b?b:1});return this};V.prototype.orderBy=V.prototype.N;V.prototype.la=function(a){ii(this,549);if(null!=this.query.la)throw new E(530);null==this.query.la&&(this.query.la=[]);this.query.la.push.apply(this.query.la,Array.prototype.slice.call(arguments));return this};V.prototype.groupBy=V.prototype.la;
function hi(a,b){switch(a){case "COUNT":case "DISTINCT":return!0;case "AVG":case "GEOMEAN":case "STDDEV":case "SUM":return 4==b||3==b;case "MAX":case "MIN":return 4==b||3==b||5==b||2==b}return!1}V.prototype.clone=function(){var a=new V(this.global,this.query.f);a.query=this.query.clone();a.query.Zc=null;return a};V.prototype.clone=V.prototype.clone;function ki(a,b){U.call(this,a,new Jh(a.b(rc)));this.query.table=b}t(ki,U);r("lf.query.UpdateBuilder",ki);ki.prototype.set=function(a,b){var c={Wc:b instanceof Md?b.Ca():-1,H:a,value:b};null!=this.query.set?this.query.set.push(c):this.query.set=[c];return this};ki.prototype.set=ki.prototype.set;ki.prototype.w=function(a){this.Hd();this.query.w=a;return this};ki.prototype.where=ki.prototype.w;ki.prototype.Hd=function(){if(null!=this.query.w)throw new E(516);};
ki.prototype.kb=function(){ki.hb.kb.call(this);if(null==this.query.set)throw new E(532);if(this.query.set.some(function(a){return a.value instanceof Md}))throw new E(501);};function li(a){this.query=a;this.Ha=null}li.prototype.jc=function(){null===this.Ha&&(this.Ha=this.cd());return this.Ha};function mi(a){li.call(this,a)}t(mi,li);mi.prototype.cd=function(){return this.query.dc?new jh(this.query.Ka,this.query.values):new ih(this.query.Ka,this.query.values)};function ni(a){li.call(this,a)}t(ni,li);
ni.prototype.cd=function(){var a=new lh(this.query.table,this.query.set),b=null!=this.query.w?new mh(this.query.w.Pb()):null,c=new nh(this.query.table);null===b?L(a,c):(L(b,c),L(a,b));return a};function oi(a,b,c){this.Ha=a;this.le=b;this.Yb=c}oi.prototype.jc=function(){this.Yb.forEach(function(a){this.Ha=a.gb(this.Ha,this.le)},this);return this.Ha};function pi(a,b){li.call(this,a);this.Yb=b}t(pi,li);pi.prototype.cd=function(){var a=new kh(this.query.from),b=null!=this.query.w?new mh(this.query.w.Pb()):null,c=new nh(this.query.from);null===b?L(a,c):(L(b,c),L(a,b));return(new oi(a,this.query,this.Yb)).jc()};function qi(){}t(qi,wh);qi.prototype.gb=function(a,b){if(2>b.from.length)return a;this.G=a;this.xb(this.G,b);return this.G};qi.prototype.xb=function(a,b){if(a instanceof mh&&a.O instanceof Hg){var c=a.O.W(),d=Zd(a,0);d instanceof oh&&(c=null!=b.cb&&b.cb.has(c),c=new vh(a.O,c),Cg(a,d,c,c),a==this.G&&(this.G=c),a=c)}K(a).forEach(function(a){this.xb(a,b)},this)};function ri(){this.Vc=C()}t(ri,wh);ri.prototype.gb=function(a,b){if(!q(b.w))return a;this.Vc.clear();this.G=a;this.xb(this.G,b);this.Vc.clear();return this.G};ri.prototype.xb=function(a,b){var c=function(a){K(a).forEach(d)}.bind(this),d=function(a){if(!this.Vc.has(a)){if(a instanceof mh){var f=a.O.s(),h=function(a){return si(this,a,f)}.bind(this),h=ti(this,b,a,h);this.Vc.add(a);h!=a&&(fa(h.getParent())&&(this.G=h),d(h))}c(a)}}.bind(this);d(a)};
function ti(a,b,c,d){var e=c;if(ui(b,c))e=Ag(c),ti(a,b,c,d);else if(vi(c)){var f=[],e=Bg(c,d,function(a){a=new mh(a.O);f.push(a);return a});f.forEach(function(a){ti(this,b,a,d)},a)}return e}function si(a,b,c){var d=C();wg(b).forEach(function(a){d.add(a.table)},a);b instanceof nh&&d.add(b.table);return xc(d,c)}function vi(a){a=Zd(a,0);return a instanceof oh||a instanceof vh}
function ui(a,b){var c=Zd(b,0);if(!(c instanceof mh))return!1;if(null==a.cb)return!0;var d=b.O instanceof Hg,c=a.cb.has(c.O.W());return d||!c};function wi(a,b){li.call(this,a);this.Yb=b;this.nf=this.df=this.wf=this.gf=this.Fe=this.Te=this.vf=this.Le=this.yf=null}t(wi,li);
wi.prototype.cd=function(){xi(this);2<=this.query.from.length&&(this.Le=new oh);this.vf=null!=this.query.w?new mh(this.query.w.Pb()):null;this.query.N&&(this.gf=new qh(this.query.N));null!=this.query.L&&0<this.query.L&&(this.wf=new uh(this.query.L));null!=this.query.X&&(this.df=new th(this.query.X));null!=this.query.la&&(this.Te=new sh(this.query.la));yi(this);this.nf=new ph(this.query.f||[],this.query.la||null);var a=zi(this);return(new oi(a,this.query,this.Yb)).jc()};
function zi(a){for(var b=[a.df,a.wf,a.nf,a.gf,a.Fe,a.Te,a.vf,a.Le],c=-1,d=null,e=0;e<b.length;e++){var f=b[e];null!==f&&(null===d?d=f:L(b[c],f),c=e)}a.yf.forEach(function(a){L(b[c],a)});return d}function xi(a){a.yf=a.query.from.map(function(a){return new nh(a)},a)}function yi(a){var b=a.query.f.filter(function(a){return a instanceof S});null!=a.query.N&&a.query.N.forEach(function(a){a.H instanceof S&&b.push(a.H)});0<b.length&&(a.Fe=new rh(b))};function Ai(){this.se=[new xh,new Ah,new ri,new qi];this.Rd=[new xh]}Ai.prototype.create=function(a){var b=null;if(a instanceof Hh)b=new mi(a);else if(a instanceof Eh)b=new pi(a,this.Rd);else if(a instanceof pe)b=new wi(a,this.se);else if(a instanceof Jh)b=new ni(a);else throw new E(513);b=b.jc();return new gh(b,a.da())};function Bi(a){T.call(this,0,1);this.U=a}t(Bi,T);Bi.prototype.toString=function(){return"delete("+this.U.getName()+")"};Bi.prototype.ca=function(a,b){var c=a[0].entries.map(function(a){return a.va});b.remove(this.U,c);return[Dd()]};function Ci(a,b){T.call(this,0,-1);this.table=b;this.D=a.b(nc)}t(Ci,T);Ci.prototype.toString=function(){return"get_row_count("+this.table.getName()+")"};Ci.prototype.ca=function(){var a=this.D.get(bf(this.table)),b=new H([],[this.table.getName()]),c=Sg(),a=a.Y().ia;null===b.Za&&(b.Za=y());b.Za.set(c.j(),a);return[b]};function Di(a,b){T.call(this,0,-1);this.V=a.b(mc);this.D=a.b(nc);this.table=b}t(Di,T);Di.prototype.toString=function(){var a="table_access("+this.table.getName();null===this.table.$a()||(a+=" as "+this.table.$a());return a+")"};Di.prototype.ca=function(){var a=this.D.get(bf(this.table)).Ua();return[Gd(uf(this.V,a),[Jd(this.table)])]};function Ei(a){this.c=a}t(Ei,wh);Ei.prototype.gb=function(a,b){this.G=a;if(!this.Jd(b))return a;var c=xg(a,function(a){return a instanceof Di})[0],d=new Ci(this.c,c.table);Cg(c,c,d,d);return this.G};Ei.prototype.Jd=function(a){return 1==a.f.length&&1==a.from.length&&null==a.w&&null==a.X&&null==a.L&&null==a.la?(a=a.f[0],a instanceof S&&"COUNT"==a.Ob&&a.child instanceof Rg):!1};function Fi(a){T.call(this,0,1);this.Se=a}t(Fi,T);Fi.prototype.toString=function(){return"groupBy("+this.Se.map(function(a){return a.j()}).toString()+")"};Fi.prototype.ca=function(a){return Gi(this,a[0])};function Gi(a,b){var c=new Sc,d=function(a){return this.Se.map(function(b){return I(a,b)},this).join(",")}.bind(a);b.entries.forEach(function(a){c.set(d(a),a)},a);return c.keys().map(function(a){return new H(c.get(a),b.s())},a)};function Hi(a,b,c){T.call(this,0,0);this.D=a.b(nc);this.V=a.b(mc);this.O=b;this.Ub=c;this.Fd="eq"==this.O.C?0:2;this.Ve=null}t(Hi,T);var Ii=["hash","index_nested_loop","nested_loop"];Hi.prototype.toString=function(){return"join(type: "+(this.Ub?"outer":"inner")+", impl: "+Ii[this.Fd]+", "+this.O.toString()+")"};
Hi.prototype.ca=function(a){switch(this.Fd){case 0:return[Lg(this.O,a[0],a[1],this.Ub)];case 1:return[Mg(this.O,a[0],a[1],this.Ve,this.V)];default:var b=this.O,c=a[0];a=a[1];var d=this.Ub,e=[c,a];d||(e=Ig(b,c,a));c=e[0];a=e[1];for(var e=[],f=c.s(),h=a.s(),k=c.entries.length,n=a.entries.length,B=n+256-1>>8,O=0;O<B;){for(var ea=0;ea<k;ea++){var Cb=!1,bg=I(c.entries[ea],b.ga);if(null!==bg)for(var fc=Math.min(O+1<<8,n),Db=O<<8;Db<fc;Db++)if(b.yc(bg,I(a.entries[Db],b.na))){var Cb=!0,Uc=Ld(c.entries[ea],
f,a.entries[Db],h);e.push(Uc)}d&&!Cb&&e.push(Kg(b,c.entries[ea],f))}O++}b=c.s().concat(a.s());return[new H(e,b)]}};function Ji(a,b){a.Fd=1;var c=a.D.get(b.Ca().j());a.Ve={gg:b,zg:b==a.O.ga?a.O.na:a.O.ga,index:c}};function Ki(a){T.call(this,0,-1);this.pf=a}t(Ki,T);Ki.prototype.toString=function(){return"no_op_step("+this.pf[0].s().join(",")+")"};Ki.prototype.ca=g("pf");function Li(){}t(Li,wh);Li.prototype.gb=function(a,b){this.G=a;if(!this.Jd(b))return a;xg(a,function(a){return a instanceof Hi}).forEach(this.Jg,this);return this.G};Li.prototype.Jd=function(a){return 1<a.from.length};
Li.prototype.Jg=function(a){if("eq"==a.O.C&&!a.Ub){var b=function(b){if(!(b instanceof Di))return null;b=Jd(b.table)==Jd(a.O.na.I())?a.O.na:a.O.ga;return fa(b.Ca())?null:b},c=b(Zd(a,0)),b=b(Zd(a,1));if(null!==c||null!==b){b=null===b?c:b;Ji(a,b);var d=new H([],[Jd(b.I())]);be(a,new Ki([d]),b==c?0:1)}}};function Mi(a){a=a.map(function(a){return a.ra()});a=zb.apply(null,a);var b=[];yb(a,function(a){b.push(a)});return b}function Ni(a){this.Tb=a}Ni.prototype.dd=function(){return 1==this.Tb.f.length?[td()]:[this.Tb.f.map(function(){return td()})]};function Oi(a,b){this.Tb=a;this.Ga=b;this.Nd=this.bf=null}
function Pi(a,b){var c=y();a.Ga.keys().forEach(function(a){var e=this.Ga.get(a).map(function(a){return ke(b,a)},this),f=new xd([td()]);e.forEach(function(a){f=yd(f,a.xe())});c.set(a,f)},a);return c}Oi.prototype.dd=function(a){if(this.bf==a)return this.Nd;for(var b=Pi(this,a),c=this.Tb.f.length-1;0<=c;c--){var d=this.Tb.f[c];if(null!==(b.get(d.ba.getName())||null))break;b.set(d.ba.getName(),new xd([td()]))}this.Nd=1==this.Tb.f.length?z(b)[0].ra():Mi(Qi(this,b));this.bf=a;return this.Nd};
function Qi(a,b){var c=y(),d=0;a.Tb.f.forEach(function(a){c.set(a.ba.getName(),d);d++});return Wb(b).sort(function(a,b){return c.get(a)-c.get(b)}).map(function(a){return b.get(a)})};function Ri(a,b){this.zd=b;this.D=a.b(nc)}function Si(a){a=a.D.get(bf(a.zd));return Math.floor(.02*a.Y().ia)}function Ti(a,b,c){c=c.filter(a.ng,a);if(0==c.length)return null;a=Ui(a,c);if(0==a.length)return null;if(1==a.length)return a[0];var d=Number.MAX_VALUE;return a.reduce(function(a,c){var h=Vi(c,b);return h<d?(d=h,c):a},null)}
function Ui(a,b){return a.zd.Da().map(function(a){a=new Wi(this.D,a);Xi(a,b);return a},a).filter(function(a){if(null===a.Ga)a=!1;else{for(var b=!1,e=!0,f=0;f<a.bb.f.length;f++){var h=a.Ga.has(a.bb.f[f].ba.getName());if(b&&h){e=!1;break}h||(b=!0)}a=e}return a})}Ri.prototype.ng=function(a){return a instanceof fe?!a.od()||a.H.I()!=this.zd||"in"==a.C&&a.value.length>Si(this)?!1:!0:a instanceof Eg?a.od()&&Zd(a,0).H.I()==this.zd?K(a).length<=Si(this):!1:!1};
function Wi(a,b){this.D=a;this.bb=b;this.hg=C(this.bb.f.map(function(a){return a.ba.getName()}));this.be=this.Ga=null}function Yi(a){null===a.be&&(a.be=new Oi(a.bb,a.Ga));return a.be}function Xi(a,b){b.forEach(function(a){var b=a.nb()[0].getName();this.hg.has(b)&&(null===this.Ga&&(this.Ga=new Sc),this.Ga.set(b,a.W()))},a)}function Vi(a,b){var c=Yi(a).dd(b),d=a.D.get(a.bb.j());return c.reduce(function(a,b){return a+d.ad(b)},0)};function Zi(a,b,c,d){T.call(this,0,-1);this.D=a.b(nc);this.index=b;this.af=c;this.pe=d;this.Uc=this.Tc=!1}t(Zi,T);Zi.prototype.toString=function(){return"index_range_scan("+this.index.j()+", ?, "+(this.pe?"reverse":"natural")+(this.Tc?", limit:?":"")+(this.Uc?", skip:?":"")+")"};Zi.prototype.Sc=function(a){var b=this.toString(),c=this.af.dd(a),b=b.replace("?",c.toString());this.Tc&&(b=b.replace("?",a.X.toString()));this.Uc&&(b=b.replace("?",a.L.toString()));return b};
Zi.prototype.ca=function(a,b,c){a=this.af.dd(c);b=this.D.get(this.index.j());c=(1==a.length&&a[0]instanceof F&&ud(a[0])?yf(b.get(a[0].from),!1,this.Tc?c.X:void 0,this.Uc?c.L:void 0):b.Ua(a,this.pe,this.Tc?c.X:void 0,this.Uc?c.L:void 0)).map(function(a){return new Xb(a,{})},this);return[Gd(c,[this.index.pc])]};function $i(){T.call(this,0,0)}t($i,T);$i.prototype.toString=l("multi_index_range_scan()");
$i.prototype.ca=function(a){var b=y();a.forEach(function(a){a.entries.forEach(function(a){b.set(a.va.id(),a)})});var c=z(b);return[new H(c,a[0].s())]};function aj(a){T.call(this,0,1);this.mc=a}t(aj,T);aj.prototype.toString=l("select(?)");aj.prototype.Sc=function(a){a=ke(a,this.mc);return this.toString().replace("?",a.toString())};aj.prototype.ca=function(a,b,c){return[ke(c,this.mc).eval(a[0])]};function bj(a,b){T.call(this,0,1);this.V=a.b(mc);this.U=b}t(bj,T);bj.prototype.toString=function(){return"table_access_by_row_id("+this.U.getName()+")"};bj.prototype.ca=function(a){return[Gd(uf(this.V,Ad(a[0])),[Jd(this.U)])]};function cj(a){this.c=a}t(cj,wh);cj.prototype.gb=function(a,b){this.G=a;xg(a,function(a){return a instanceof Di}).forEach(function(a){var d=dj(a);if(0!=d.length){var e=Ti(new Ri(this.c,a.table),b,d.map(function(a){return ke(b,a.mc)}));if(null!==e){var f=y();d.forEach(function(a){f.set(a.mc,a)},this);this.G=ej(this,e,f,a)}}},this);return this.G};function dj(a){var b=[];for(a=a.getParent();a;){if(a instanceof aj)b.push(a);else if(a instanceof Hi)break;a=a.getParent()}return b}
function ej(a,b,c,d){(null===b.Ga?[]:b.Ga.values()).map(function(a){return c.get(a)}).forEach(yg);b=new Zi(a.c,b.bb,Yi(b),!1);a=new bj(a.c,d.table);L(a,b);Cg(d,d,a,b);return b.ab()};function fj(a,b){T.call(this,0,-1);this.D=a.b(nc);this.U=b}t(fj,T);fj.prototype.toString=function(){return"insert("+this.U.getName()+")"};fj.prototype.ca=function(a,b,c){gj(this.U,c.values,this.D);b.Db(this.U,c.values);return[Gd(c.values,[this.U.getName()])]};function gj(a,b,c){a=a.Jb().ed();if(null===a?0:a.f[0].autoIncrement){var d=a.f[0].ba.getName();c=c.get(a.j()).Y().Ic;var e=null===c?0:c;b.forEach(function(a){if(0==a.m[d]||null==a.m[d])e++,a.m[d]=e})}}
function hj(a,b){T.call(this,0,-1);this.D=a.b(nc);this.U=b}t(hj,T);hj.prototype.toString=function(){return"insert_replace("+this.U.getName()+")"};hj.prototype.ca=function(a,b,c){gj(this.U,c.values,this.D);b.Yd(this.U,c.values);return[Gd(c.values,[this.U.getName()])]};function ij(){T.call(this,0,1)}t(ij,T);ij.prototype.toString=l("limit(?)");ij.prototype.Sc=function(a){return this.toString().replace("?",a.X.toString())};ij.prototype.ca=function(a,b,c){a[0].entries.splice(c.X);return a};function jj(a){T.call(this,0,1);this.N=a}t(jj,T);m=jj.prototype;m.toString=function(){return"order_by("+qe(this.N)+")"};m.ca=function(a){if(1==a.length){var b;b=a[0];for(var c=null,d=0;d<this.N.length;d++){var e=Tg(this.N[d].H);if(null!==b.Za&&b.Za.has(e.j())){c=e;break}}b=c;(null===b?a[0]:Bd(a[0],b)).entries.sort(this.Xf.bind(this))}else a.sort(this.Mg.bind(this));return a};
m.$=function(a,b){var c=null,d=null,e=null,f=-1;do f++,e=this.N[f].H,c=this.N[f].sb,d=a(e),e=b(e);while(d==e&&f+1<this.N.length);d=d<e?-1:d>e?1:0;return 1==c?d:-d};m.Mg=function(a,b){return this.$(function(b){return b instanceof S?Bd(a,b):I(a.entries[a.entries.length-1],b)},function(a){return a instanceof S?Bd(b,a):I(b.entries[b.entries.length-1],a)})};m.Xf=function(a,b){return this.$(function(b){return I(a,b)},function(a){return I(b,a)})};function kj(a,b){this.Ma=a;this.K=b}function lj(a){return a.K.some(function(a){return a instanceof S},a)?mj(a):nj(a)}function mj(a){if(1==a.K.length&&"DISTINCT"==a.K[0].Ob)return a=Bd(a.Ma,a.K[0]).entries.map(function(a){var b=new Hd(new Xb(-1,{}),1<this.Ma.M.size);Kd(b,this.K[0],I(a,this.K[0].child));return b},a),new H(a,[]);var b=new Hd(new Xb(-1,{}),1<a.Ma.M.size);a.K.forEach(function(a){var d=a instanceof S?Bd(this.Ma,a):I(this.Ma.entries[0],a);Kd(b,a,d)},a);return new H([b],a.Ma.s())}
function nj(a){var b=Array(a.Ma.entries.length),c=1<a.Ma.M.size;a.Ma.entries.forEach(function(a,e){b[e]=new Hd(new Xb(a.va.id(),{}),c);this.K.forEach(function(c){Kd(b[e],c,I(a,c))},this)},a);return new H(b,a.Ma.s())}function oj(a,b){var c=a.map(function(a){return lj(new kj(a,b)).entries[0]});return new H(c,a[0].s())};function pj(a,b){T.call(this,0,1);this.f=a;this.Sb=b}t(pj,T);pj.prototype.toString=function(){var a="project("+this.f.toString();if(null!==this.Sb)var b=this.Sb.map(function(a){return a.j()}).join(", "),a=a+(", groupBy("+b+")");return a+")"};pj.prototype.ca=function(a){0==a.length?a=[Dd()]:1==a.length?(a=a[0],a=[0==this.f.length?a:lj(new kj(a,this.f))]):a=[oj(a,this.f)];return a};function qj(a){return a.f.some(function(a){return a instanceof S})||null!==a.Sb};function rj(){T.call(this,0,1)}t(rj,T);rj.prototype.toString=l("skip(?)");rj.prototype.Sc=function(a){return this.toString().replace("?",a.L.toString())};rj.prototype.ca=function(a,b,c){return[new H(a[0].entries.slice(c.L),a[0].s())]};function sj(){}t(sj,wh);sj.prototype.gb=function(a,b){if(!q(b.X)&&!q(b.L))return a;var c=tj(a);if(null===c)return a;xg(a,function(a){return a instanceof ij||a instanceof rj}).forEach(function(a){a instanceof ij?c.Tc=!0:c.Uc=!0;yg(a)},this);return c.ab()};function tj(a){a=xg(a,function(a){return a instanceof Zi},function(a){return a instanceof pj&&qj(a)||a instanceof jj||1!=K(a).length||a instanceof aj});return 0<a.length?a[0]:null};function uj(a){this.c=a}t(uj,wh);uj.prototype.gb=function(a,b){this.G=a;var c=vj(this,b);if(0==c.length)return this.G;var d=null,e=null,f=0;do e=c[f++],d=wj(this,e,b);while(null===d&&f<c.length);if(null===d)return this.G;c=xj(this,d[0].bb.pc);return null===c?this.G:this.G=yj(this,e,c,d)};function vj(a,b){return xg(a.G,function(a){if(!(a instanceof aj))return!1;a=ke(b,a.mc);return a instanceof Eg&&"or"==a.rb})}
function xj(a,b){return xg(a.G,function(a){return a instanceof Di&&a.table.getName()==b})[0]||null}function wj(a,b,c){b=ke(c,b.mc);var d=b.s();if(1!=d.size)return null;var d=D(d)[0],e=new Ri(a.c,d),f=null;return K(b).every(function(a){a=Ti(e,c,[a]);null===a||(null===f?f=[a]:f.push(a));return null!==a})?f:null}function yj(a,b,c,d){var e=new bj(a.c,c.table),f=new $i;L(e,f);d.forEach(function(a){a=new Zi(this.c,a.bb,Yi(a),!1);L(f,a)},a);yg(b);Cg(c,c,e,f);return f.ab()};function zj(a){this.c=a}t(zj,wh);zj.prototype.gb=function(a,b){var c=Aj(a,b);if(null===c)return a;var d;a:{var e=c;d=Bj(Zd(c,0));if(null!==d){var f;f=c.N;for(var h=null,k=d.table.Da(),n=0;n<k.length&&null===h;n++)h=Cj(k[n],f);f=h;if(null===f){d=e;break a}e=new Zi(this.c,f.bb,new Ni(f.bb),f.Ye);f=new bj(this.c,d.table);L(f,e);yg(c);e=Cg(d,d,f,e)}d=e}if(d==c)a:if(d=c,e=Dj(Zd(c,0)),null!==e){f=Cj(e.index,c.N);if(null===f)break a;e.pe=f.Ye;d=yg(c).parent}return d.ab()};
function Dj(a){a=xg(a,function(a){return a instanceof Zi},function(a){return 1!=K(a).length});return 0<a.length?a[0]:null}function Bj(a){a=xg(a,function(a){return a instanceof Di},function(a){return 1!=K(a).length});return 0<a.length?a[0]:null}function Aj(a,b){return q(b.N)?xg(a,function(a){return a instanceof jj})[0]:null}function Cj(a,b){if(a.f.length!=b.length||!b.every(function(b,c){return b.H.getName()==a.f[c].ba.getName()}))return null;var c=Ej(b,a);return c[0]||c[1]?{bb:a,Ye:c[1]}:null}
function Ej(a,b){var c=a.reduce(function(a,b){return a<<1|(0==b.sb?0:1)},0),d=b.f.reduce(function(a,b){return a<<1|(0==b.sb?0:1)},0),c=c^d;return[0==c,c==Math.pow(2,Math.max(a.length,b.f.length))-1]};function Fj(a,b,c){this.Ha=a;this.le=b;this.Yb=c}Fj.prototype.jc=function(){this.Yb.forEach(function(a){this.Ha=a.gb(this.Ha,this.le)},this);return this.Ha};function Gj(a,b){T.call(this,0,1);this.U=a;this.Xg=b}t(Gj,T);Gj.prototype.toString=function(){return"update("+this.U.getName()+")"};Gj.prototype.ca=function(a,b){var c=a[0].entries.map(function(a){var b=this.U.mb(a.va.Ja());this.Xg.forEach(function(a){b.m[a.H.getName()]=a.value},this);return b},this);b.update(this.U,c);return[Dd()]};function Hj(a){this.c=a;this.se=[new Li,new cj(this.c),new uj(this.c),new zj(this.c),new sj,new Ei(this.c)];this.Rd=[new cj(this.c)]}Hj.prototype.create=function(a,b){var c=a.ab();if(c instanceof jh||c instanceof ih)return Ij(this,a,b);if(c instanceof ph||c instanceof th||c instanceof uh)return Ij(this,a,b,this.se);if(c instanceof kh||c instanceof lh)return Ij(this,a,b,this.Rd);throw new E(8);};
function Ij(a,b,c,d){a=vg(b.ab(),a.wg.bind(a));null!=d&&(a=(new Fj(a,c,d)).jc());return new re(a,b.da())}
Hj.prototype.wg=function(a){if(a instanceof ph)return new pj(a.f,a.Sb);if(a instanceof sh)return new Fi(a.f);if(a instanceof rh)return new Xg(a.f);if(a instanceof qh)return new jj(a.N);if(a instanceof uh)return new rj;if(a instanceof th)return new ij;if(a instanceof mh)return new aj(a.O.W());if(a instanceof oh)return new Bh;if(a instanceof vh)return new Hi(this.c,a.O,a.Ub);if(a instanceof nh)return new Di(this.c,a.table);if(a instanceof kh)return new Bi(a.table);if(a instanceof lh)return new Gj(a.table,
a.ze);if(a instanceof jh)return new hj(this.c,a.table);if(a instanceof ih)return new fj(this.c,a.table);throw new E(514);};function Jj(a){this.tg=new Ai;this.Hg=new Hj(a)};function Kj(){this.ef=y()}function Lj(a,b){var c=a.ef.get(b.getName())||null;null===c&&(c=new Mj,a.ef.set(b.getName(),c));return c}function Nj(a,b,c,d){c.forEach(function(a){a=Lj(this,a);0==d?(a.eb=null,a.zc=b):3==d?(null===a.ac&&(a.ac=C()),a.ac.add(b),null===a.Xa&&(a.Xa=C()),a.Xa.delete(b)):1==d?(null===a.Xa&&(a.Xa=C()),a.Xa.add(b)):2==d&&(a.eb=b)},a)}
function Oj(a,b,c,d){var e=!0;c.forEach(function(a){if(e){a=Lj(this,a);var c=null===a.Xa||0==a.Xa.size;e=0==d?(null===a.ac||0==a.ac.size)&&c&&null===a.zc&&null!==a.eb&&a.eb==b:3==d?null===a.zc&&null===a.eb&&null!==a.Xa&&a.Xa.has(b):1==d?null===a.eb:c&&(null===a.eb||a.eb==b)}},a);return e}function Pj(a,b,c,d){var e=Oj(a,b,c,d);e&&Nj(a,b,c,d);return e}Kj.prototype.releaseLock=function(a,b){b.forEach(function(b){Lj(this,b).releaseLock(a)},this)};
function Qj(a,b){b.forEach(function(a){Lj(this,a).eb=null},a)}function Mj(){this.ac=this.Xa=this.eb=this.zc=null}Mj.prototype.releaseLock=function(a){this.zc==a&&(this.zc=null);this.eb==a&&(this.eb=null);null===this.Xa||this.Xa.delete(a);null===this.ac||this.ac.delete(a)};function Rj(){this.Xb=new Sj;this.Hc=new Kj}function ze(a,b){(2>b.getPriority()||2>b.getPriority())&&Qj(a.Hc,b.da());a.Xb.Db(b);Tj(a);return b.Rb().ha}function Tj(a){for(var b=a.Xb.ra(),c=0;c<b.length;c++){var d=b[c],e=!1;if(e=0==d.J()?Uj(a,d,1,3):Uj(a,d,2,0))a.Xb.remove(d),e=a,d.exec().then(e.Eg.bind(e,d),e.Dg.bind(e,d))}}function Uj(a,b,c,d){var e=!1;Pj(a.Hc,b.W(),b.da(),c)&&(e=Pj(a.Hc,b.W(),b.da(),d));return e}Rj.prototype.Eg=function(a,b){this.Hc.releaseLock(a.W(),a.da());a.Rb().resolve(b);Tj(this)};
Rj.prototype.Dg=function(a,b){this.Hc.releaseLock(a.W(),a.da());a.Rb().reject(b);Tj(this)};function Sj(){this.Xb=[]}Sj.prototype.Db=function(a){xf(this.Xb,a,function(a,c){var d=a.getPriority()-c.getPriority();return 0==d?a.W()-c.W():d})};Sj.prototype.ra=function(){return this.Xb.slice()};Sj.prototype.remove=function(a){var b=this.Xb;a=xa(b,a);var c;(c=0<=a)&&Array.prototype.splice.call(b,a,1);return c};function Vj(){this.Qc=y()}var Wj;function Xj(){Wj||(Wj=new Vj);return Wj}Vj.prototype.clear=function(){this.Qc.clear()};Vj.prototype.clear=Vj.prototype.clear;Vj.prototype.ub=function(a,b){this.Qc.set(a.toString(),b);return b};Vj.prototype.registerService=Vj.prototype.ub;Vj.prototype.b=function(a){var b=this.Qc.get(a.toString())||null;if(null===b)throw new E(7,a.toString());return b};Vj.prototype.getService=Vj.prototype.b;Vj.prototype.pd=function(a){return this.Qc.has(a.toString())};
Vj.prototype.isRegistered=Vj.prototype.pd;function Yj(){var a=Xj();return Wb(a.Qc)};function Zj(a,b,c,d){return null!=a?null!=b?ak(a,b,c,d):bk(a):ck()}function dk(a){var b="";try{b=JSON.stringify(a)}catch(c){}return b}function ek(a){var b=Xj();a=new kc("ns_"+a);return b.pd(a)?b.b(a):null}function ck(){var a={};Yj().forEach(function(b){"ns_"==b.substring(0,3)&&(b=b.substring(3),a[b]=ek(b).b(rc).version())});return dk(a)}function bk(a){a=ek(a);var b={};if(null!=a){var c=a.b(nc);a.b(rc).pa().forEach(function(a){b[a.getName()]=c.get(bf(a)).Y().ia})}return dk(b)}
function ak(a,b,c,d){var e=ek(a);a=[];if(null!=e){var f=null;try{f=e.b(rc).table(b)}catch(h){}null!=f&&(b=e.b(nc),e=e.b(mc),c=b.get(bf(f)).Ua(void 0,!1,c,d),c.length&&(a=uf(e,c).map(function(a){return a.m})))}return dk(a)};function fk(a,b){this.Sd=Vd();this.me=a;this.rd=b;this.K=gk(this)}function gk(a){if(0<a.me.f.length)return a.me.f;var b=[];a.me.from.forEach(function(a){a.nb().forEach(function(a){b.push(a)})});return b}fk.prototype.$=function(a,b){return this.K.every(function(c){return Wd(this.Sd,c.J(),"eq")(I(a,c),I(b,c))},this)};
function hk(a,b,c){var d=null===b?[]:b.entries,e=qb(d,c.entries,a.$.bind(a),function(a){return d[a]});b=[];for(var f=0,h=0;h<d.length;h++){var k=d[h];e[f]==k?f++:(k=a.rd.splice(f,1),k=ik(h,k,0,a.rd),b.push(k))}e=qb(d,c.entries,a.$.bind(a),function(a,b){return c.entries[b]});for(h=f=0;h<c.entries.length;h++)k=c.entries[h],e[f]==k?f++:(a.rd.splice(h,0,k.va.m),k=ik(h,[],1,a.rd),b.push(k));return b}function ik(a,b,c,d){return{addedCount:c,index:a,object:d,removed:b,type:"splice"}};function jk(){this.ic=y()}jk.prototype.Ed=function(a,b){var c=ka(a.query).toString(),d=this.ic.get(c)||null;null===d&&(d=new kk(a),this.ic.set(c,d));d.Ed(b)};jk.prototype.ne=function(a,b){var c=ka(a.query).toString(),d=this.ic.get(c)||null;d.ne(b);0<d.Kc.size||this.ic.delete(c)};function ye(a,b){var c=C();b.forEach(function(a){c.add(a.getName())});var d=[];a.ic.forEach(function(a){a=a.Ec();a.context.from.some(function(a){return c.has(a.getName())})&&d.push(a)});return d}
function we(a,b,c){b=ka(null!=b.Zc?b.Zc:b).toString();a=a.ic.get(b)||null;null!==a&&lk(a,c)}function kk(a){this.Kf=a;this.Kc=C();this.Bg=[];this.cf=null;this.Vf=new fk(a.query,this.Bg)}kk.prototype.Ed=function(a){this.Kc.has(a)||this.Kc.add(a)};kk.prototype.ne=function(a){return this.Kc.delete(a)};kk.prototype.Ec=function(){var a=this.Kf;return{context:a.query,ke:Zh(a)}};function lk(a,b){var c=hk(a.Vf,a.cf,b);a.cf=b;0<c.length&&a.Kc.forEach(function(a){a(c)})};function mk(a,b){var c=a.b(rc),d=b||{},e=new tf(c);a.ub(mc,e);var e=null,f=!1;null!=d.storeType?e=d.storeType:(e=Ub(),e=e.ig?0:e.Yg?4:1);switch(e){case 0:e=new Ye(a,c);break;case 1:e=new ef(c);break;case 5:e=new gf(c);break;case 4:e=new qf(a,c,d.webSqlDbSize);break;case 3:e=new Le(c,d.firebase);f=!0;break;default:throw new E(300);}a.ub(lc,e);var h=new ug;a.ub(nc,h);return e.Ea(d.onUpgrade).then(function(){var b=new Jj(a);a.ub(oc,b);b=new Rj;a.ub(pc,b);b=new jk;a.ub(qc,b);return h.Ea(c)}).then(function(){if(f){var b=
new Ae(a);b.Na.subscribe(b.fe.bind(b))}d.enableInspector&&(window.top["#lfInspect"]=Zj);return(new ng(a)).Ea(c)})};function nk(a){this.c=a;this.g=a.b(rc);this.aa=C(this.g.pa());this.fb=fb()}function ok(a){var b=a.c.b(nc),c=a.c.b(mc),d={};a.g.pa().forEach(function(a){var f=b.get(bf(a)).Ua(),f=uf(c,f).map(function(a){return a.m});d[a.getName()]=f});return{name:a.g.name(),version:a.g.version(),tables:d}}m=nk.prototype;m.exec=function(){var a=ok(this),a=new Hd(new Xb(-1,a),!0);return w([new H([a],[])])};m.J=l(0);m.da=g("aa");m.Rb=g("fb");m.W=function(){return ka(this)};m.getPriority=l(0);function pk(a,b){this.c=a;this.g=a.b(rc);this.aa=C(this.g.pa());this.fb=fb();this.Ba=b;this.Na=a.b(lc);this.V=a.b(mc);this.D=a.b(nc)}m=pk.prototype;
m.exec=function(){if(!(this.Na instanceof Ye||this.Na instanceof ef||this.Na instanceof qf))throw new E(300);var a;a:{a=this.g.pa();for(var b=0;b<a.length;++b)if(0<this.D.get(bf(a[b])).Y().ia){a=!1;break a}a=!0}if(!a)throw new E(110);if(this.g.name()!=this.Ba.name||this.g.version()!=this.Ba.version)throw new E(111);if(null==this.Ba.tables)throw new E(112);return qk(this)};m.J=l(1);m.da=g("aa");m.Rb=g("fb");m.W=function(){return ka(this)};m.getPriority=l(0);
function qk(a){var b=new kd(a.c,a.aa),b=a.Na.Hb(a.J(),D(a.aa),b),c;for(c in a.Ba.tables){var d=a.g.table(c),e=a.Ba.tables[c].map(function(a){return d.Ab(a)}),f=b.I(c,d.mb,0);a.V.Zb(c,e);var h=a.D.oc.get(c)||[];e.forEach(function(a){h.forEach(function(b){var c=a.pb(b.getName());b.add(c,a.id())})});f.put(e)}return b.ka()};function rk(a,b){this.c=a;this.Na=a.b(lc);this.Ia=a.b(pc);this.Lb=a.b(qc);this.aa=C(b);this.Qa=new kd(this.c,this.aa);this.fb=fb();this.Ac=fb();this.Be=fb()}m=rk.prototype;m.exec=function(){this.Be.resolve();return this.Ac.ha};m.J=l(1);m.da=g("aa");m.Rb=g("fb");m.W=function(){return ka(this)};m.getPriority=l(2);function sk(a){ze(a.Ia,a);return a.Be.ha}
function tk(a,b){var c=b.Ec();return c.ke.ab().exec(a.Qa,c.context).then(function(a){return zd(a[0])},function(a){this.Qa.Mb();var b=new kb(a.name);this.Ac.reject(b);throw a;}.bind(a))}m.ka=function(){this.ja=this.Na.Hb(this.J(),D(this.aa),this.Qa);this.ja.ka().then(function(){this.Pc();this.Ac.resolve()}.bind(this),function(a){this.Qa.Mb();this.Ac.reject(a)}.bind(this));return this.fb.ha};m.Mb=function(){this.Qa.Mb();this.Ac.resolve();return this.fb.ha};
m.Pc=function(){var a=ye(this.Lb,this.aa);0!=a.length&&(a=new ve(this.c,a),ze(this.Ia,a))};m.Y=function(){var a=null;null!=this.ja&&(a=this.ja.Y());return null===a?new A(!1,0,0,0,0):a};function W(a){this.c=a;this.Ia=a.b(pc);this.Nb=null;this.Sa=0;0==uk.size&&(uk.set(0,C([1,4])),uk.set(1,C([2])),uk.set(2,C([3,5,6])),uk.set(3,C([2,7])),uk.set(4,C([7])),uk.set(5,C([7])),uk.set(6,C([7])))}r("lf.proc.Transaction",W);var uk=y();function vk(a,b){var c=uk.get(a.Sa)||null;if(null===c||!c.has(b))throw new E(107,a.Sa,b);a.Sa=b}
W.prototype.exec=function(a){vk(this,4);var b=[];try{a.forEach(function(a){a.kb();b.push(a.Ec())},this)}catch(c){return vk(this,7),bb(c)}this.Nb=new Ch(this.c,b);return ze(this.Ia,this.Nb).then(function(a){vk(this,7);return a.map(function(a){return zd(a)})}.bind(this),function(a){vk(this,7);throw a;}.bind(this))};W.prototype.exec=W.prototype.exec;W.prototype.If=function(a){vk(this,1);this.Nb=new rk(this.c,a);return sk(this.Nb).then(function(){vk(this,2)}.bind(this))};W.prototype.begin=W.prototype.If;
W.prototype.Hf=function(a){vk(this,3);return tk(this.Nb,a).then(function(a){vk(this,2);return a}.bind(this),function(a){vk(this,7);throw a;}.bind(this))};W.prototype.attach=W.prototype.Hf;W.prototype.ka=function(){vk(this,5);return this.Nb.ka().then(function(){vk(this,7)}.bind(this))};W.prototype.commit=W.prototype.ka;W.prototype.Mb=function(){vk(this,6);return this.Nb.Mb().then(function(){vk(this,7)}.bind(this))};W.prototype.rollback=W.prototype.Mb;
W.prototype.Y=function(){if(7!=this.Sa)throw new E(105);return this.Nb.Y()};W.prototype.stats=W.prototype.Y;function X(a){this.c=a;this.g=a.b(rc);this.ld=!1}r("lf.proc.Database",X);X.prototype.Ea=function(a){this.c.ub(rc,this.g);return mk(this.c,a).then(function(){this.ld=!0;this.Ia=this.c.b(pc);return this}.bind(this))};X.prototype.init=X.prototype.Ea;X.prototype.Cb=g("g");X.prototype.getSchema=X.prototype.Cb;function wk(a){if(!a.ld)throw new E(2);}X.prototype.select=function(a){wk(this);return new V(this.c,1!=arguments.length||null!=arguments[0]?Array.prototype.slice.call(arguments):[])};
X.prototype.select=X.prototype.select;X.prototype.Db=function(){wk(this);return new ai(this.c)};X.prototype.insert=X.prototype.Db;X.prototype.Yd=function(){wk(this);return new ai(this.c,!0)};X.prototype.insertOrReplace=X.prototype.Yd;X.prototype.update=function(a){wk(this);return new ki(this.c,a)};X.prototype.update=X.prototype.update;X.prototype.delete=function(){wk(this);return new $h(this.c)};X.prototype["delete"]=X.prototype.delete;
X.prototype.observe=function(a,b){wk(this);this.c.b(qc).Ed(a,b)};X.prototype.observe=X.prototype.observe;X.prototype.unobserve=function(a,b){wk(this);this.c.b(qc).ne(a,b)};X.prototype.unobserve=X.prototype.unobserve;X.prototype.Rf=function(){wk(this);return new W(this.c)};X.prototype.createTransaction=X.prototype.Rf;X.prototype.close=function(){try{this.c.b(lc).close()}catch(a){}this.c.clear();this.ld=!1};X.prototype.close=X.prototype.close;
X.prototype.ag=function(){wk(this);var a=new nk(this.c);return ze(this.Ia,a).then(function(a){return zd(a[0])[0]})};X.prototype["export"]=X.prototype.ag;X.prototype.import=function(a){wk(this);a=new pk(this.c,a);return ze(this.Ia,a).then(l(null))};X.prototype["import"]=X.prototype.import;function Y(a,b,c,d,e,f){this.U=a;this.A=b;this.Ze=c;this.Xe=d;this.Af=e;this.jb=f||null}r("lf.schema.BaseColumn",Y);m=Y.prototype;m.getName=g("A");m.j=function(){return Jd(this.U)+"."+this.A};m.toString=function(){return this.j()};m.I=g("U");m.J=g("Af");Y.prototype.getType=Y.prototype.J;Y.prototype.$a=g("jb");Y.prototype.Da=function(){null==this.ta&&(this.ta=[],this.I().Da().forEach(function(a){-1!=a.f.map(function(a){return a.ba.getName()}).indexOf(this.A)&&this.ta.push(a)},this));return this.ta};
Y.prototype.Ca=function(){if(!q(this.fa)){var a=this.Da().filter(function(a){return 1!=a.f.length?!1:a.f[0].ba.getName()==this.getName()},this);this.fa=0<a.length?a[0]:null}return this.fa};Y.prototype.kc=g("Xe");Y.prototype.isNullable=Y.prototype.kc;Y.prototype.Gc=g("Ze");Y.prototype.Pa=function(a){return Ng(this,a,"eq")};Y.prototype.eq=Y.prototype.Pa;Y.prototype.ff=function(a){return Ng(this,a,"neq")};Y.prototype.neq=Y.prototype.ff;Y.prototype.ug=function(a){return Ng(this,a,"lt")};
Y.prototype.lt=Y.prototype.ug;Y.prototype.vg=function(a){return Ng(this,a,"lte")};Y.prototype.lte=Y.prototype.vg;Y.prototype.dg=function(a){return Ng(this,a,"gt")};Y.prototype.gt=Y.prototype.dg;Y.prototype.eg=function(a){return Ng(this,a,"gte")};Y.prototype.gte=Y.prototype.eg;Y.prototype.match=function(a){return Ng(this,a,"match")};Y.prototype.match=Y.prototype.match;Y.prototype.Jf=function(a,b){return Ng(this,[a,b],"between")};Y.prototype.between=Y.prototype.Jf;
Y.prototype.fg=function(a){return Ng(this,a,"in")};Y.prototype["in"]=Y.prototype.fg;Y.prototype.pg=function(){return this.Pa(null)};Y.prototype.isNull=Y.prototype.pg;Y.prototype.og=function(){return this.ff(null)};Y.prototype.isNotNull=Y.prototype.og;Y.prototype.uc=function(a){return new Y(this.U,this.A,this.Ze,this.Xe,this.Af,a)};Y.prototype.as=Y.prototype.uc;function xk(a){this.g=a;this.Kd=new Sc;this.oe=new Sc;this.hf=new Sc;this.Ke=y();this.h=new Sc;this.Ge=new Sc;this.qf=new Sc;this.Je=new Sc;yk(this)}function yk(a){a.g.pa().forEach(function(a){var c=a.getName();a.Jb().Xd().forEach(function(d){this.hf.set(c,this.g.table(d.Wa));this.h.set(d.Wa,a);0==d.action?(this.oe.set(d.Wa,d),this.qf.set(d.Wa,a)):(this.Kd.set(d.Wa,d),this.Ge.set(d.Wa,a));this.Ke.set(a.getName()+"."+d.yb,d.Wa);this.Je.set(d.Wa+"."+d.Mc,a.getName())},this)},a)}
function ad(a,b,c){if(null!=c)return 1==c?a.Kd.get(b):a.oe.get(b);c=a.Kd.get(b);a=a.oe.get(b);return null===c&&null===a?null:(c||[]).concat(a||[])}function Ih(a,b){var c=b.get(a);return null===c?[]:c}function Kh(a,b){var c=C();b.forEach(function(a){(a=this.Ke.get(a))&&c.add(a)},a);return D(c).map(function(a){return this.g.table(a)},a)}function Gh(a,b,c){return null!=c?0==c?Ih(b,a.qf):Ih(b,a.Ge):Ih(b,a.h)}
function Lh(a,b){var c=C();b.forEach(function(a){(a=this.Je.get(a))&&a.forEach(function(a){c.add(a)})},a);return D(c).map(function(a){return this.g.table(a)},a)};function zk(a,b,c){this.Ig=a;this.Ag=b;this.bg=c}r("lf.schema.Constraint",zk);zk.prototype.ed=g("Ig");zk.prototype.getPrimaryKey=zk.prototype.ed;zk.prototype.Xd=g("bg");zk.prototype.getForeignKeys=zk.prototype.Xd;function Ak(a,b,c){var d=a.ref.split(".");if(2!=d.length)throw new E(540,c);this.Ie=b;this.yb=a.local;this.Wa=d[0];this.Mc=d[1];this.name=b+"."+c;this.action=a.action;this.timing=a.timing};function Z(a){Bk(a);this.Sd=Vd();this.A=a;this.K=y();this.Bd=C();this.qc=C();this.qd=C();this.Fa=null;this.ta=y();this.ud=!1;this.Bb=[]}r("lf.schema.TableBuilder",Z);function Ck(a){this.name=a.name;this.sb=a.order;this.autoIncrement=a.autoIncrement}var Dk=C([0,6]);function Bk(a){if(!/^[A-Za-z_][A-Za-z0-9_]*$/.test(a))throw new E(502,a);}function Ek(a,b){if(b==a.A)throw new E(546,b);if(a.K.has(b)||a.ta.has(b)||a.qc.has(b))throw new E(503,a.A+"."+b);}
function Fk(a,b){var c=!1;b.forEach(function(a){var b=this.K.get(a.name);c=c||a.autoIncrement;if(a.autoIncrement&&3!=b)throw new E(504);},a);if(c&&1<b.length)throw new E(505);}function Gk(a){if(null!==a.Fa){var b=a.ta.get(a.Fa).map(function(a){return a.name}),c=0;if(a.Bb.some(function(a,e){c=e;return-1!=b.indexOf(a.yb)},a))throw new E(543,a.Bb[c].name);}}
function Hk(a){if(null!==a.Fa){var b=function(a){return a.name},c=JSON.stringify(a.ta.get(a.Fa).map(b));a.ta.forEach(function(a,e){if(e!=this.Fa){var f=a.map(b);if(JSON.stringify(f)==c)throw new E(544,this.A+"."+e);}},a)}}function Ik(a){null===a.Fa||a.ta.get(a.Fa).forEach(function(a){if(this.qd.has(a.name))throw new E(545,this.A+"."+a.name);},a)}Z.prototype.Cf=function(a,b){Bk(a);Ek(this,a);this.K.set(a,b);Dk.has(b)&&this.De([a]);return this};Z.prototype.addColumn=Z.prototype.Cf;
Z.prototype.Ef=function(a,b){var c=this.A;this.Fa="pk"+(c[0].toUpperCase()+c.substring(1));Bk(this.Fa);Ek(this,this.Fa);c=Jk(this,a,!0,void 0,b);Fk(this,c);1==c.length&&this.Bd.add(c[0].name);this.qc.add(this.Fa);this.ta.set(this.Fa,c);return this};Z.prototype.addPrimaryKey=Z.prototype.Ef;
Z.prototype.Df=function(a,b){Bk(a);Ek(this,a);var c=new Ak(b,this.A,a);q(c.action)||(c.action=0);q(c.timing)||(c.timing=0);if(1==c.action&&1==c.timing)throw new E(506);if(!this.K.has(c.yb))throw new E(540,a);this.Bb.push(c);this.Ce(a,[c.yb],this.Bd.has(c.yb));return this};Z.prototype.addForeignKey=Z.prototype.Df;Z.prototype.Ff=function(a,b){Bk(a);Ek(this,a);var c=Jk(this,b,!0);1==c.length&&(this.Bd.add(c[0].name),Kk(this,c[0].name));this.ta.set(a,c);this.qc.add(a);return this};
Z.prototype.addUnique=Z.prototype.Ff;function Kk(a,b){a.Bb.forEach(function(a){a.yb==b&&this.qc.add(a.name.split(".")[1])},a)}Z.prototype.De=function(a){Jk(this,a,!1).forEach(function(a){this.qd.add(a.name)},this);return this};Z.prototype.addNullable=Z.prototype.De;Z.prototype.Ce=function(a,b,c,d){Bk(a);Ek(this,a);b=Jk(this,b,!0,d);c&&this.qc.add(a);this.ta.set(a,b);return this};Z.prototype.addIndex=Z.prototype.Ce;Z.prototype.Fb=ba("ud");Z.prototype.persistentIndex=Z.prototype.Fb;
Z.prototype.Cb=function(){Gk(this);Hk(this);Ik(this);return new (Lk(this))};Z.prototype.getSchema=Z.prototype.Cb;function Mk(a){return a.Bb}function Jk(a,b,c,d,e){var f=b,f="string"==typeof b[0]?b.map(function(a){return new Ck({name:a,order:null!=d?d:1,autoIncrement:e||!1})}):b.map(function(a){return new Ck(a)});f.forEach(function(a){if(!this.K.has(a.name))throw new E(508,this.A,a.name);if(c){var b=this.K.get(a.name);if(0==b||6==b)throw new E(509,this.A,a.name);}},a);return f}
function Lk(a){function b(){function b(c){return a.ta.get(c).map(function(a){return{ba:this[a.name],sb:a.sb,autoIncrement:a.autoIncrement}},this)}var d=Wb(a.K).map(function(b){this[b]=new Y(this,b,a.Bd.has(b),a.qd.has(b),a.K.get(b));return this[b]},this),e=Wb(a.ta).map(function(d){return new Pg(a.A,d,a.qc.has(d),b.call(this,d))},this);R.call(this,a.A,d,e,a.ud);var f=null===a.Fa?null:new Pg(a.A,a.Fa,!0,b.call(this,a.Fa)),h=d.filter(function(b){return!a.qd.has(b.getName())});this.Of=new zk(f,h,a.Bb);
this.tf=Nk(a,d,e)}t(b,R);b.prototype.Ab=function(a){return new this.tf(Yb++,a)};b.prototype.createRow=b.prototype.Ab;b.prototype.mb=function(a){var b={};this.nb().forEach(function(e){var f=e.getName();e=e.J();var h=a.value[f];if(0==e)if(e=h,null!=e&&""!=e){0!=e.length%2&&(e="0"+e);for(var h=new ArrayBuffer(e.length/2),k=new Uint8Array(h),n=0,B=0;n<e.length;n+=2)k[B++]=parseInt(e.substr(n,2),16);e=h}else e=null;else e=2==e?null!=h?new Date(h):null:h;b[f]=e},this);return new this.tf(a.id,b)};b.prototype.deserializeRow=
b.prototype.mb;b.prototype.Jb=g("Of");b.prototype.getConstraint=b.prototype.Jb;return b}
function Nk(a,b,c){function d(a,d){this.K=b;this.ta=c;Xb.call(this,a,d)}t(d,Xb);d.prototype.Me=function(){var a={};this.K.forEach(function(b){a[b.getName()]=b.kc()?null:Rc[b.J()]});return a};d.prototype.zf=function(){var a={};this.K.forEach(function(b){var c=b.getName();b=b.J();var d=this.m[c];a[c]=0==b?null!=d?ac(d):null:2==b?null!=d?d.getTime():null:6==b?null!=d?d:null:d},this);return a};var e=function(a){var b=this.K.get(a.getName()),c=this.Sd.$e.get(b)||null;return function(b){return c(b[a.getName()])}}.bind(a),
f=function(a){var b=a.map(function(a){return e(a.ba)});return function(a){return b.map(function(b){return b(a)})}}.bind(a),h={};c.forEach(function(a){var b=a.j();a=1==a.f.length?e(a.f[0].ba):f(a.f);h[b]=a});d.prototype.pb=function(a){return-1!=a.indexOf("#")?this.id():h.hasOwnProperty(a)?h[a](this.m):null};return d};function Ok(a,b){this.g=new Pk(a,b);this.wb=y();this.Bc=!1;this.i=null}r("lf.schema.Builder",Ok);function Qk(a,b){b.Bb.forEach(function(a){var d=a.Wa;if(!this.wb.has(d))throw new E(536,a.name);var d=this.wb.get(d).Cb(),e=a.Mc;if(!d.hasOwnProperty(e))throw new E(537,a.name);if(b.Cb()[a.yb].J()!=d[e].J())throw new E(538,a.name);if(!d[e].Gc())throw new E(539,a.name);},a)}
Ok.prototype.Nf=function(a){a.Bb.forEach(function(a){Mk(this.wb.get(a.Wa)).forEach(function(c){if(c.yb==a.Mc)throw new E(534,a.name);},this)},this)};function Rk(a){a.Bc||(a.wb.forEach(function(a){Qk(this,a);a=a.Cb();this.g.M.set(a.getName(),a)},a),z(a.wb).forEach(a.Nf,a),Sk(a),a.wb.clear(),a.Bc=!0)}function Tk(a,b,c){b.Ae||(b.Ae=!0,b.ge=!0,b.Ne.forEach(function(a){a=c.get(a);if(!a.Ae)Tk(this,a,c);else if(a.ge&&b!=a)throw new E(533);},a));b.ge=!1}
function Sk(a){var b=y();a.g.M.forEach(function(a,d){b.set(d,new Uk(d))},a);a.wb.forEach(function(a,d){a.Bb.forEach(function(a){b.get(a.Wa).Ne.add(d)})});z(b).forEach(function(a){Tk(this,a,b)},a)}function Uk(a){this.ge=this.Ae=!1;this.Ne=C();this.pc=a}Ok.prototype.Cb=function(){this.Bc||Rk(this);return this.g};Ok.prototype.getSchema=Ok.prototype.Cb;Ok.prototype.Re=function(){var a=new kc("ns_"+this.g.name()),b=Xj(),c=null;b.pd(a)?c=b.b(a):(c=new Vj,b.ub(a,c));return c};Ok.prototype.getGlobal=Ok.prototype.Re;
Ok.prototype.connect=function(a){if(null!==this.i&&this.i.ld)throw new E(113);if(null===this.i){var b=this.Re();b.pd(rc)||b.ub(rc,this.Cb());this.i=new X(b)}return this.i.Ea(a)};Ok.prototype.connect=Ok.prototype.connect;Ok.prototype.Qf=function(a){if(this.wb.has(a))throw new E(503,a);if(this.Bc)throw new E(535);this.wb.set(a,new Z(a));return this.wb.get(a)};Ok.prototype.createTable=Ok.prototype.Qf;Ok.prototype.te=function(a){if(this.Bc)throw new E(535);this.g.te(a);return this};
Ok.prototype.setPragma=Ok.prototype.te;function Pk(a,b){this.A=a;this.Ta=b;this.M=y();this.mf={Wf:!1}}r("lf.schema.DatabaseSchema",Pk);Pk.prototype.name=g("A");Pk.prototype.name=Pk.prototype.name;Pk.prototype.version=g("Ta");Pk.prototype.version=Pk.prototype.version;Pk.prototype.pa=function(){return z(this.M)};Pk.prototype.tables=Pk.prototype.pa;Pk.prototype.table=function(a){if(!this.M.has(a))throw new E(101,a);return this.M.get(a)};Pk.prototype.table=Pk.prototype.table;
Pk.prototype.info=function(){this.We||(this.We=new xk(this));return this.We};Pk.prototype.lf=g("mf");Pk.prototype.pragma=Pk.prototype.lf;Pk.prototype.te=ba("mf");r("lf.schema.create",function(a,b){return new Ok(a,b)});v.prototype.catch=v.prototype.we;v.prototype["catch"]=v.prototype.catch;
