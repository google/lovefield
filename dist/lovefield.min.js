...
function Db(a){return function(){return a}}var H,Eb=this;function Fb(a){return void 0!==a}function I(a,b,c){a=a[ab](".");c=c||Eb;a[0]in c||!c.execScript||c.execScript("var "+a[0]);for(var d;a[y]&&(d=a[Ha]());)!a[y]&&Fb(b)?c[d]=b:c=c[d]?c[d]:c[d]={}}function Gb(){}function Hb(a){a.ue=function(){return a.Of?a.Of:a.Of=new a}}
...
function Uc(){var a,b,c=new M(function(c,g){a=c;b=g});return new Vc(c,a,b)}M[z].then=function(a,b,c){null!=a&&Zb(a,"opt_onFulfilled should be a function.");null!=b&&Zb(b,"opt_onRejected should be a function. Did you pass opt_context as the second argument instead of the third?");return this.ff(Nb(a)?a:null,Nb(b)?b:null,c)};M[z].then=M[z][A];M[z].$goog_Thenable=!0;H=M[z];
H.vk=function(a,b,c){null!=a&&Zb(a,"opt_onFulfilled should be a function.");null!=b&&Zb(b,"opt_onRejected should be a function. Did you pass opt_context as the second argument instead of the third?");this.ef(Pc(a||Gb,b||null,c))};function Tc(a,b,c,d){a instanceof M?a.vk(b,c,d):a[A](b,c,d)}H.Gg=function(a,b){return this.ff(null,a,b)};H.ef=function(a){this.mj()||2!=this.ya&&3!=this.ya||this.wg();this.Yj(a)};
H.ff=function(a,b,c){var d=Pc(null,null,null);ta(d,new M(function(g,h){d.Nb=a?function(b){try{var d=a[D](c,b);g(d)}catch(B){h(B)}}:g;d.mc=b?function(a){try{var d=b[D](c,a);!Fb(d)&&a instanceof Mc?h(a):g(d)}catch(B){h(B)}}:h}));d[gb].C=this;this.ef(d);return d[gb]};H.Lg=function(a){L(1==this.ya);this.ya=0;this.oc(2,a)};H.Mg=function(a){L(1==this.ya);this.ya=0;this.oc(3,a)};
H.oc=function(a,b){if(0==this.ya){if(this==b)a=3,b=new TypeError("Promise cannot resolve to itself");else{var c;if(b)try{c=!!b.$goog_Thenable}catch(d){c=!1}else c=!1;if(c){this.ya=1;Tc(b,this.Lg,this.Mg,this);return}c=typeof b;if("object"==c&&null!=b||"function"==c)try{var g=b[A];if(Nb(g)){this.yk(b,g);return}}catch(h){a=3,b=h}}this.tg=b;this.ya=a;this.C=null;this.wg();3!=a||b instanceof Mc||Wc(this,b)}};
H.yk=function(a,b){function c(a){h||(h=!0,g.Mg(a))}function d(a){h||(h=!0,g.Lg(a))}this.ya=1;var g=this,h=!1;try{b[D](a,d,c)}catch(l){c(l)}};H.wg=function(){this.oe||(this.oe=!0,Fc(this.li,this))};H.mj=function(){return!!this.bc};H.Yj=function(a){L(null!=a.Nb);this.ed?qa(this.ed,a):this.bc=a;this.ed=a};H.Rj=function(){var a=null;this.bc&&(a=this.bc,this.bc=a[$a],qa(a,null));this.bc||(this.ed=null);null!=a&&L(null!=a.Nb);return a};
H.li=function(){for(var a=null;a=this.Rj();)this.ki(a,this.ya,this.tg);this.oe=!1};H.ki=function(a,b,c){3==b&&a.mc&&!a.ce&&this.ek();if(a[gb])a[gb].C=null,Xc(a,b,c);else try{a.ce?a.Nb[D](a[Da]):Xc(a,b,c)}catch(d){Yc[D](null,d)}Oc.put(a)};function Xc(a,b,c){2==b?a.Nb[D](a[Da],c):a.mc&&a.mc[D](a[Da],c)}H.$g=Bb();H.ek=function(){var a;for(a=this;a&&a.Cd;a=a.C)a.Cd=!1};function Wc(a,b){a.Cd=!0;Fc(function(){a.Cd&&(a.$g(b),Yc[D](null,b))})}var Yc=zc;function Mc(a){Ub[D](this,a)}K(Mc,Ub);za(Mc[z],"cancel");
function Vc(a,b,c){this.ga=a;this.resolve=b;this.reject=c};
function Zc(a,b){this.va=a;this.Pb=b||this.wf()}var $c=0;H=Zc[z];H.id=G("va");H.ih=Cb("va");H.w=G("Pb");H.wf=function(){return{}};H.Hg=G("Pb");H.Fa=function(){return{id:this.va,value:this.Hg()}};H.Pc=function(a){return"#"==a.substr(-1)?this.va:null};function ad(a){return new Zc(a.id,a[x])}function bd(a){return new Zc($c++,a||{})}function cd(a){if(null==a)return"";a=new Uint8Array(a);for(var b="",c=0;c<a[y];++c)var d=a[c][r](16),b=b+(2>d[y]?"0"+d:d);return b};
...
function gd(a,b){this.Ya=a;this.Ig=b;this.ba=Uc()}H=gd[z];H.Pi=G("Ya");H.U=function(){return(0==this.Ig?Qc():this.Dj())[A](J(function(){this.Ya.U()},this))};H.Dj=function(){this.Ej();this.Cj();return this.ba.ga};H.Ej=function(){var a=this.Ya.Df();a.G()[n](function(b){var c=this.Ya.ca().get(b),c=this.Z(c[k](),J(c.dc,c));b=a.get(b);var d=b.rd().c().map(function(a){return a.id()});0<d[y]&&c[m](d).Gg(this.Be,this);b=b.wd().c().map(function(a){return a[1]})[Ka](b.qd().c());c.put(b).Gg(this.Be,this)},this)};
...
H.put=function(a){if(0==a[y])return Qc();var b=new N;a[n](function(a){var d;d=a.id()>>9;var g=b.get(d,null);null===g&&(g=this.ug(this.O[rb],d));g.zg([a]);b.set(d,g)},this);a=b.c().map(function(a){return this.Qb(J(function(){return this.O.put(a.Fa())},this))},this);return Sc(a)};
ja(H,function(a){if(0==a[y])return this.Qb(J(function(){return this.O[Pa]()},this));var b=new N;a[n](function(a){var d=a>>9,g=b.get(d,null);null===g&&(g=this.ug(this.O[rb],d));g.dk([a]);b.set(d,g)},this);a=b.c().map(function(a){return this.Qb(J(function(){var b;a:{b=a.jc();for(var g in b){b=!1;break a}b=!0}return b?this.O[qb](a.ka()):this.O.put(a.Fa())},this))},this);return Sc(a)});function Jd(a,b,c){a=a.o(vd);var d=[c<<9,(c+1<<9)-1];b=a.Va(b,d[0],d[1]);c=new Fd(c);c.zg(b);return c}
...
function Pd(a,b){this.Sa=new N;b[n](function(a){this.Sa.set(a[k](),a)},this);this.pa=a.o(vd);this.N=a.o(wd);this.jd=new Nd(a);this.Ed=new Md(a);this.Pe=this.Wd=!1;this.Cb=new N}H=Pd[z];H.Df=G("Cb");H.Mi=function(){var a=[];this.Cb.G().map(function(a){return this.Sa.get(a)},this)[n](function(b){b.Rb()&&(b.Ga()[n](function(b){a[v](this.N.get(b.l()))},this),a[v](this.N.get(b[k]()+".#")))},this);return a};H.ca=G("Sa");
...
H.sf=function(){var a=!1;this[x]instanceof ee||(a="array"==Ib(this[x])?!this[x][wb](function(a){return a instanceof ee}):!0);if(!a)throw new P("SyntaxError","Value is not bounded");};H.eval=function(a){this.sf();if("in"==this.V)return this.Yh(a);var b=a[C][Ea](function(a){return this.nd(a.M(this.K),this[x])!=this.Xa},this);return new Vd(b,a.W())};
...
H.Yh=function(a){L("in"==this.V,"ValuePredicate#evalAsIn_() called for wrong predicate type.");var b=new O(this[x]),c=J(function(a){return b[u](a)!=this.Xa},this),d=a[C][Ea](function(a){return c(a.M(this.K))},this);return new Vd(d,a.W())};f(H,function(){return"value_pred("+this.K.l()+" "+this.V+(this.Xa?"(complement)":"")+" "+this[x]+")"});H.Qf=function(){this.sf();return null!==this[x]&&("between"==this.V||"eq"==this.V||"gt"==this.V||"gte"==this.V||"lt"==this.V||"lte"==this.V)};
H.wk=function(){L(this.Qf(),"Could not convert predicate to key range.");var a=null;"between"==this.V?a=new Rd(this[x][0],this[x][1],!1,!1):"eq"==this.V?(a=this[x],a=new Rd(a,a,!1,!1)):a="gte"==this.V?new Rd(this[x],null,!1,!1):"gt"==this.V?new Rd(this[x],null,!0,!1):"lte"==this.V?new Rd(null,this[x],!1,!1):new Rd(null,this[x],!1,!0);return this.Xa?a.Gh():[a]};
...
function we(a){this.Ea=a}we[z].Hb=G("Ea");we[z].zf=Db("plan description");we[z].ca=function(){function a(c){var d=c.ca();d&&b.add(d);c.Y()[n](function(b){a(b)})}var b=new O;a(this.Ea);return b.c()};function xe(a){var b=new O;a[n](function(a){b[lb](a.ca())});return b};

function ye(a,b){this.global=a;this.vb=a.o(ud);this.Pd=b.map(function(a){return a[Da]});this.kg=b.map(function(a){return a.Qe});this.tf=xe(this.kg);this.Jg=this.Uh();this.Tb=Uc()}H=ye[z];H.Uh=function(){return this.Pd[wb](function(a){return!(a instanceof ue)})?1:0};
ha(H,function(){var a=new Pd(this[Ta],this.tf.c()),b=[],c=this.kg[w](),d=J(function(){var g=c[Ha]();if(g){var h=this.Pd[b[y]];return g.Hb()[Ia](a,h)[A](function(a){b[v](a[0]);return d()})}return Qc()},this);return d()[A](J(function(){return this.vb.Fb(this.Jg,a).U()},this))[A](J(function(){this.Ne(b);return b},this),J(function(b){a.Ab();throw b;},this))});H.da=G("Jg");H.ca=G("tf");H.Jc=G("Tb");H.ka=function(){return Ob(this)};H.Ne=Bb();
...
Fe[z].U=function(){Fe.eb.U[D](this);var a=this.Pi().Df();if(0==a.na())this.ba[vb]();else{var b=this.j.Yi()+1;this.j.yg(b);var c={"@rev":{R:b}};a[n](function(a){var g=this.j.If(a[k]());a.qd()[n](function(a,d){c[d]={R:b,T:g,P:a.w()}});a.wd()[n](function(a,d){c[d]={R:b,T:g,P:a[1].w()}});a.rd()[n](function(a,b){c[b]=null})},this);this.j.Wi()[zb](c,function(c){if(null===c)this.ba[vb]();else this.j.yg(b-1),c=a.c().map(function(a){return this.j.pg(a[k]())},this),Sc(c)[A](this.ba[jb][q](this.ba),this.ba[jb][q](this.ba))}[q](this))}return this.ba.ga};
function Ge(){this.ob=new N}H=Ge[z];H.ze=function(a){if(0==a[y])return this.ob.c();var b=[];a[n](function(a){a=this.ob.get(a,null);null===a||b[v](a)},this);return b};H.getData=G("ob");H.get=function(a){return Qc(this.ze(a))};H.Re=function(a){a[n](function(a){this.ob.set(a.id(),a)},this)};H.put=function(a){this.Re(a);return Qc()};H.qg=function(a){0==a[y]||a[y]==this.ob.na()?this.ob[Pa]():a[n](function(a){this.ob[m](a)},this)};ja(H,function(a){this.qg(a);return Qc()});
...
H.Ba=function(a){this.j=this.Zg[gb](this.A[rb]());var b=a||function(){return Qc()};return De(this.j,"@db/version")[A](function(a){return null===a?Ee(this.j,this.Lh(),!0)[A](function(){var a=new Q(0,this.j);return b(a)}[q](this)):a==this.A[Fa]()?De(this.j,"@rev/R")[A](function(a){this.Qa=a;return De(this.j,"@table")}[q](this))[A](function(a){for(var b in a)this.fb.set(b,a[b]);a=this.A.gb().map(function(a){return this.pg(a[k]())},this);return Sc(a)}[q](this))[A](function(){this.pj();this.ag();return Qc()}[q](this)):
this.Oe(a,b)[A](function(){return this.Ba()}[q](this))}[q](this))};H.Oe=function(a,b){var c=new Q(a,this.j);return c.Ba(this.A)[A](function(){return this.Ak()}[q](this))[A](function(){return b(c)})[A](function(){var a=this.j[gb]("@db");return Ee(a,{version:this.A[Fa]()},!0)}[q](this))};H.Ak=function(){return Qc()};H.ag=function(){this.j.off();this.j.on("child_removed",this.Kj[q](this));this.he&&(this.he.off(),this.Vc[Pa]());this.he=this.j[Ma]("R").startAt(this.Qa+1);this.he.on("value",this.Me[q](this))};
H.pj=function(){$c=this.I.c().map(function(a){return a.Qi()})[kb](function(a,b){return a>b?a:b},0)+1};H.Kj=function(a){var b=a.val(),c=this.Vc.get(b.T,null);null===c&&(c=new O,this.Vc.set(b.T,c));c.add(ga(a.key(),10))};H.Me=function(a){var b=a[gb]("@rev/R").val();null!=b&&b!=this.Qa&&(this.Qa=b,a=this.yi(a),a[n](function(a){var b=this.I.get(a[k]()),g=a.rd().G();g[y]&&b.qg(g);var h=a.qd().c();a.wd()[n](function(a){h[v](a[1])});b.Re(h)},this),a[y]&&this.Sc(a),this.ag())};
...
H.pg=function(a){var b=Uc(),c=this.If(a);this.j[Ma]("T").equalTo(c)[db]("value",function(c){var g=new Ge,h=[];c[n](function(a){h[v](new Zc(ga(a.key(),10),a.val().P))});g.Re(h);this.I.set(a,g);b[vb]()}[q](this));return b.ga};H.If=function(a){return this.fb.get(a)};H.Lh=function(){var a={};a["@db"]={version:this.A[Fa]()};a["@rev"]={R:1};this.Qa=1;a["@table"]={};this.A.gb()[n](function(b,c){var d=b[k]();a["@table"][d]=c;this.I.set(d,new Ge);this.fb.set(d,c)},this);return a};
...
function Le(a,b){this.m=a;this.A=b;this.dd=b.lg().Wh||!1}H=Le[z];
...
function Ne(a){this.A=a;this.I=new N}H=Ne[z];H.Ba=function(){this.A.gb()[n](this.qj,this);return Qc()};H.Kc=function(a){var b=this.I.get(a,null);if(null===b)throw new P("DataError","Table "+a+" does not exist.");return b};H.Fb=function(a,b){return new Me(this,a,b)};H.uf=function(a){if(!this.I.s(a)){var b=new Ge;this.I.set(a,b);return b}return null};H.qj=function(a){this.uf(a[k]());a.Rb()&&(a.Ga()[n](function(a){this.Cc(a.l(),"btree")},this),this.Cc(a.Ib(),"rowid"))};
H.Cc=function(a,b){var c=this.uf(a);null===c||c.put([new ed(new dd(b))])};ra(H,Bb());ya(H,Bb());H.Sc=Bb();
...
H.s=function(a){var b=this.Yc(a);return this.X.Na(this.b[b],a)?!0:this.ea()?!1:this.i[b].s(a)};ja(H,function(a,b){this.xf(a,-1,b);if(this.Uf()){var c=this;1==this.i[y]&&(c=this.i[0],c.C=null);return c}return this});function mf(a){return a.ea()?a.b[0]:mf(a.i[0])}H.od=function(){this.b=[];for(var a=1;a<this.i[y];++a)this.b[v](mf(this.i[a]))};
H.xf=function(a,b,c){var d=this.Yc(a);if(!this.ea()){var g=this.X.Na(this.b[d],a)?d+1:d;if(this.i[g].xf(a,g,c))this.od();else return!1}else if(!this.X.Na(this.b[d],a))return!1;if(this.b[y]>d&&this.X.Na(this.b[d],a)){if(Fb(c)&&!this.X.Oc()&&this.ea()&&(a=this.S[d],c=nc(a,oc,!1,c),0<=c&&hc(a,c),this.S[d][y]))return!1;this.b[E](d,1);this.ea()&&this.S[E](d,1)}256>this.b[y]&&!this.Uf()&&(this.uk()||this.Gj(b));return!0};
...
H.Yc=function(a){for(var b=0,c=this.b[y];b<c;){var d=b+c>>1;this.X.Ke(this.b[d],a)?b=d+1:c=d}return b};H.Cf=function(a){if(!this.ea()){var b=this.Yc(a);this.X.Na(this.b[b],a)&&b++;return this.i[b].Cf(a)}return this};
H.Va=function(a,b){var c=-1,d=this.b[y]-1,g=this.X.Bc(),h=J(function(b){for(;b<this.b[y];++b){var h=g.kc(this.b[b],a);if(-1!=c){if(!h){d=b-1;break}}else h&&(c=b)}},this);g.kc(this.b[0],a)?c=0:h(1);if(-1==c)return 0;g.kc(this.b[d],a)||h(c);return d==this.b[y]-1?this.kf(b,this.S[w](c)):d>=c?this.kf(b,this.S[w](c,d+1)):0};H.kf=function(a,b){var c=this.X.Oc()?b:rc(b);a[v][ib](a,c);return c[y]};
...
function nf(a){if(1==a.h[y])return new of(a.h[0].mb);a=a.h.map(function(a){return a.mb});return new pf(a)}function of(a){this.hd=0==a?qf:rf;this.Le=0==a?function(a){return null!=a?a.reverse():null}:function(a){return a||null};this.hg=0==a?sf:tf}K(of,Ld);function rf(a,b){return a>b?1:a<b?-1:0}function qf(a,b){return rf(b,a)}function tf(a,b){return Ud(a,b)}function sf(a,b){return Ud(b,a)}H=of[z];
H.le=function(a,b){var c=this.Le(b),d=[null===c.f,null===c.u];if(!d[0]){var g=this.hd(a,c.f);d[0]=c.aa?1==g:-1!=g}d[1]||(g=this.hd(a,c.u),d[1]=c.fa?-1==g:1!=g);return d};H.compare=function(a,b){return this.hd(a,b)};H.min=function(a,b){return a<b?1:a==b?0:-1};H.max=function(a,b){return a>b?1:a==b?0:-1};H.kc=function(a,b){var c=this.le(a,b);return c[0]&&c[1]};H.re=function(){return Td()};H.gg=function(a,b){return this.hg(a,b)};
H.Bg=function(a){return a[Ea](function(a){return null!==a})[xb](J(function(a,c){return this.hg(a,c)},this))};H.Fe=function(a){return Jb(this.Le(a).f)};H.Qd=function(a){a=this.Le(a);return[a.f,a.u]};f(H,function(){return this.hd==qf?"SimpleComparator_DESC":"SimpleComparator_ASC"});function pf(a){this.za=a.map(function(a){return new of(a)})}K(pf,Ld);H=pf[z];H.qe=function(a,b,c){for(var d=0,g=0;g<this.za[y]&&0==d;++g)d=c(this.za[g],a[g],b[g]);return d};
...
H.Bg=function(a){var b=a[Ea](function(a){return a[yb](Kb)});a=e(this.za[y]);for(var c=0;c<a[y];c++)a[c]=b.map(function(a){return a[c]});a[n](function(a,b){a[xb](J(function(a,c){return this.za[b].gg(a,c)},this))},this);b=e(b[y]);for(c=0;c<b[y];c++)b[c]=a.map(function(a){return a[c]});return b[xb](J(function(a,b){for(var c=0,l=0;l<this.za[y]&&0==c;++l)c=this.za[l].gg(a[l],b[l]);return c},this))};H.Fe=function(a){return this.za[0].Fe(a[0])};
...
H.$j=function(a,b){var c=b.Z(a.l(),ad,1),d=nf(a);return c.get([])[A](J(function(b){L("btree"==b[0].w().type);if(1<b[y]){if(a.Mf()){var c=ef[q](void 0,d,a.l(),a.Fd),l=b[w](1),p=-1;for(b=0;b<l[y];++b)if(-2==l[b].id()){p=b;break}if(-1==p)throw new P("DataError","Data corruption detected");b=l[p].w();l=l[w](0);l[E](p,1);c=c(l);c=new uf(c);c.Za[lb](b)}else c=ef(d,a.l(),a.Fd,b[w](1));this.N.set(c)}},this))};
H.ak=function(a,b){return b.Z(a.Ib(),ad,1).get([])[A](J(function(b){L("rowid"==b[0].w().type);1<b[y]&&(b=wf(a.Ib(),b[w](1)),this.N.set(b))},this))};


function yf(){this.O=new N}yf[z].Ba=function(a){a.gb()[n](function(a){var c=a.Ib();if(null===this.get(c)){var d=new vf(c);this.O.set(c,d)}a.Ga()[n](function(a){this.O.set(a.l(),zf(a))},this)},this);return Qc()};function zf(a){var b=nf(a),b=new $e(a.l(),b,a.Fd);return a.Mf()?new uf(b):b}yf[z].get=function(a){return this.O.get(a,null)};yf[z].set=function(a){return this.O.set(a[k](),a)};yf[z].aj=function(a){var b=[],c=a+".";this.O.G()[n](function(a){0==a[ob](c)&&b[v](this.O.get(a))},this);return b};
...
H.add=function(a){if(0!=a[y])if(a=this.$a[Ka](a),1==a[y])this.$a=a;else{a[xb](Ud);for(var b=[],c=a[0],d=1;d<a[y];++d)if(c.ig(a[d])){var g=a[d],h=Td();if(null!==c.f&&null!==g.f){var l=Sd(c.f,g.f,!0);1!=l?(h.f=c.f,h.aa=0!=l?c.aa:c.aa&&g.aa):(h.f=g.f,h.aa=g.aa)}null!==c.u&&null!==g.u&&(l=Sd(c.u,g.u,!1),-1!=l?(h.u=c.u,h.fa=0!=l?c.fa:c.fa&&g.fa):(h.u=g.u,h.fa=g.fa));c=h}else b[v](c),c=a[d];b[v](c);this.$a=b}};
H.Fc=function(a){return this.$a[y]==a.$a[y]?0==this.$a[y]||this.$a[yb](function(b,c){return b.Fc(a.$a[c])}):!1};function Bf(a,b){var c=[];a.c().map(function(a){return b.c().map(function(b){var c;if(a.ig(b)){c=Td();var l=Sd(a.f,b.f,!0),l=0==l?a.aa?a:b:-1!=l?a:b;c.f=l.f;c.aa=l.aa;null===a.u||null===b.u?b=null===a.u?b:a:(l=Sd(a.u,b.u,!1),b=0==l?a.fa?a:b:-1==l?a:b);c.u=b.u;c.fa=b.fa}else c=null;return c})})[n](function(a){c=c[Ka](a)});return new Af(c[Ea](function(a){return null!==a}))};
function Cf(a,b){var c=[],d=null,g=null;a.qc(function(a){var l=b(a);null==a[Ga]()?g=l:d.ia(l);var p=a[Ga]();null!==p&&p.ua()==d.ua()&&(p=c[ob](d),-1!=p&&c[E](p,1));1<a.ua()&&c[v](l);d=a.Rf()?c[c[y]-1]:l});return g}function Df(a){return Ef(a,function(a){return a.Rf()})}function Ff(a){var b=a[Ga](),c=0;null!==b&&(c=b.Y()[ob](a),b[sb](a));var d=a.Y()[w]();d[n](function(d,h){a[sb](d);null===b||b.tc(d,c+h)});return{parent:b,children:d}}
...
H.lf=function(a){return-1!=a.W()[ob](this.Oa.Z().Aa())};H.ah=function(a){return-1!=a.W()[ob](this.bb.Z().Aa())};H.Th=function(a,b){var c=null,d=null;this.lf(a)?(this.of(a,b),c=a,d=b):(this.of(b,a),c=b,d=a);return[c,d]};H.of=function(a,b){L(this.lf(a),"Mismatch between join predicate left operand and right relation.");L(this.ah(b),"Mismatch between join predicate right operand and right relation.")};H.$h=function(a,b){var c=this.Th(a,b),d=c[0],c=c[1];return"eq"==this.V?this.ai(d,c):this.bi(d,c)};
...
function U(a,b){ne[D](this,"","");this.ji=b;this.eg=a}K(U,ne);H=U[z];H.ca=Db(null);ha(H,function(a,b){switch(this.ji){case 1:return this.ei(a,b);case 0:return this.di(a,b);default:return this.gi(a,b)}});f(H,Db("dummy_node"));H.Zc=function(){return this[r]()};H.mf=function(a){L(-1==this.eg||a[y]==this.eg)};H.gi=function(a,b){return new M(J(function(c){c(this.ja(a,[],b))},this))};H.ei=function(a,b){return this.pb(0)[Ia](a,b)[A](J(function(c){this.mf(c);return this.ja(a,c,b)},this))};
H.di=function(a,b){var c=this.Y().map(function(c){return c[Ia](a,b)});return Sc(c)[A](J(function(c){var g=[];c[n](function(a){for(var b=0;b<a[y];++b)g[v](a[b])});this.mf(g);return this.ja(a,g,b)},this))};
function $f(a){U[D](this,-1,1);this.hf=a}K($f,U);f($f[z],function(){return"aggregation("+this.hf.map(function(a){return a.l()})[r]()+")"});$f[z].ja=function(a,b){b[n](function(a){(new ag(a,this.hf)).oh()},this);return b};function ag(a,b){this.Da=a;this.H=b}
ag[z].oh=function(){this.H[n](function(a){a=a.Bf().reverse();for(var b=1;b<a[y];b++){var c=a[b],d=c.Bf()[w](-1)[0],g=this.Oi(c),h=null;switch(c.Zb){case "MIN":h=bg(g,d);break;case "MAX":h=cg(g,d);break;case "DISTINCT":h=dg(g,d);break;case "COUNT":h=g[C][y];break;case "SUM":h=eg(g,d);break;case "AVG":0<g[C][y]&&(h=eg(g,d)/g[C][y]);break;case "GEOMEAN":h=fg(g,d);break;default:h=gg(g,d)}this.Da.jk(c,h)}},this)};ag[z].Oi=function(a){return a[gb]instanceof T?this.Da.hc(a[gb]):this.Da};
...
function V(){ne[D](this,"","")}K(V,ne);function hg(a,b){V[D](this);oa(this,a);la(this,b)}K(hg,V);function ig(a,b){hg[D](this,a,b)}K(ig,hg);function jg(a){V[D](this);oa(this,a)}K(jg,V);f(jg[z],function(){return"delete("+this[t][k]()+")"});function kg(a,b){V[D](this);oa(this,a);this.cf=b}K(kg,V);f(kg[z],function(){var a=[];this.cf&&(a=this.cf.map(function(a){return a.K[k]()},this));return"update("+this[t][k]()+", ["+a[F](",")+"])"});function lg(a){V[D](this);this.Ca=a}K(lg,V);
...
function vg(){};
function wg(){}K(wg,vg);wg[z].zb=function(a){this.ha=a;this.Ta(this.ha);return this.ha};wg[z].Ta=function(a){if(a instanceof lg){L(1==a.ua(),"SelectNode must have exactly one child.");var b=this.qf(a.Ca),b=this.Nh(b);Jf(a,a,b[0],b[1]);a==this.ha&&(this.ha=b[0]);a=b[0]}a.Y()[n](function(a){this.Ta(a)},this)};wg[z].qf=function(a){if(0==a.ua()||"and"!=a.Ob)return[a];var b=a.Y()[w]().map(function(b){a[sb](b);return this.qf(b)},this);return rc(b)};
...
function Mg(a,b){var c=b||!1,d=a.Gf();if(d instanceof Bg)return Eg(d,c);if(d instanceof Ag){var g="DELETE FROM "+d.f[k]();d.D&&(g+=Jg(d.D,c));return g+";"}if(d instanceof Cg)return Kg(d,c);if(d instanceof ue)return Lg(d,c);throw new P("NotSupportedError","toSql not implemented for "+typeof d);};
function Ng(a,b){this.global=a;this.Xj=a.o(xd);this.Ra=a.o(yd);this.a=b}I("lf.query.BaseBuilder",Ng,void 0);ha(Ng[z],function(){try{this.jb()}catch(a){return Rc(a)}return new M(function(a,c){var d=new zg(this[Ta],[this.Lc()]);this.Ra.Ub(d)[A](function(c){a(c[0].ve())},c)},this)});ha(Ng[z],Ng[z][Ia]);Ng[z].zf=function(){var a=J(function(a){return a.Zc(this.a)+"\n"},this);return Kf(this.we().Hb(),a)};Ng[z].explain=Ng[z].zf;na(Ng[z],function(a){this.a[q](a);return this});na(Ng[z],Ng[z][q]);
Ng[z].xk=function(a){return Mg(this,a)};Ng[z].toSql=Ng[z].xk;H=Ng[z];H.jb=Bb();H.Gf=function(){return this.a.clone()};H.xd=G("a");H.we=function(){null==this.jg&&(this.jg=this.Xj.Ui(this.a));return this.jg};H.Lc=function(){return{context:this.Gf(),Qe:this.we()}};H.Si=function(){return{context:this.xd(),Qe:this.we()}};
...
H.de=function(a,b){if(null!=a)throw new P("SyntaxError",b+"() has already been called.");};H.nf=function(a,b){if(0>a)throw new P("SyntaxError",b+"() does not accept negative values");};H.f=function(a){if(this.Af)throw new P("SyntaxError","from() has already been called.");this.Af=!0;null==this.a.f&&(this.a.f=[]);this.a.f[v][ib](this.a.f,e[z][w][D](arguments));return this};W[z].from=W[z].f;
W[z].D=function(a){if(this.Rg)throw new P("SyntaxError","where() has already been called.");this.Rg=!0;this.pf(a);return this};W[z].where=W[z].D;W[z].pf=function(a){null!=this.a.D&&(a=Qg(a,this.a.D));this.a.D=a};W[z].De=function(a,b){null==this.a.f&&(this.a.f=[]);this.a.f[v](a);this.pf(b);return this};W[z].innerJoin=W[z].De;W[z].xj=function(){throw new P("NotSupportedError","Not implemented yet");};W[z].leftOuterJoin=W[z].xj;
W[z].oa=function(a){this.de(this.a.oa||this.a.Mb,"limit");a instanceof ee?this.a.Mb=a:(this.nf(a,"limit"),this.a.oa=a);return this};W[z].limit=W[z].oa;W[z].ma=function(a){this.de(this.a.ma||this.a.Xb,"skip");a instanceof ee?this.a.Xb=a:(this.nf(a,"skip"),this.a.ma=a);return this};W[z].skip=W[z].ma;W[z].J=function(a,b){null==this.a.J&&(this.a.J=[]);this.a.J[v]({K:a,mb:null!=b?b:1});return this};W[z].orderBy=W[z].J;
...
function $g(){this.be=new O}K($g,vg);H=$g[z];H.zb=function(a){this.ha=a;this.Ta(this.ha);this.be[Pa]();return this.ha};H.Ta=function(a){if(this.Pf(a)){var b=a.Ca instanceof re?this.Vj(a):this.Uj(a);this.be.add(a);b==a&&(b=a.pb(0));null!==b&&(Jb(b[Ga]())&&(this.ha=b),this.Pf(b)&&!this.be[u](b)&&this.Ta(b))}else a.Y()[n](function(a){this.Ta(a)},this)};
H.Od=function(a,b){var c=a;if(this.nk(a))c=Hf(a),this.Od(a,b);else if(this.mk(a)){var d=[],c=If(a,b,function(a){a=new lg(a.Ca);d[v](a);return a});d[n](function(a){this.Od(a,b)},this)}return c};H.Vj=function(a){var b=new O([a.Ca.K.Z().Aa()]),c=function(a){return this.yf(a,b)}[q](this);return this.Od(a,c)};H.Uj=function(a){var b=new O([a.Ca.Oa.Z().Aa(),a.Ca.bb.Z().Aa()]),c=function(a){return this.yf(a,b)}[q](this);return this.Od(a,c)};
H.yf=function(a,b){var c=new O;Df(a)[n](function(a){c.add(a[t].Aa())},this);a instanceof mg&&c.add(a[t].Aa());return c.Kh(b)};H.Pf=function(a){return a instanceof lg&&!(a.Ca instanceof Lf)};H.mk=function(a){a=a.pb(0);return a instanceof ng||a instanceof ug};H.nk=function(a){return a.pb(0)instanceof lg};
function ah(a){Ug[D](this,a);this.og=this.$f=this.Ag=this.fg=this.jf=this.Lf=this.xg=this.vf=this.Cg=null}K(ah,Ug);H=ah[z];H.pd=function(){this.Ci();var a=this.Hh(),b=[new wg,new xg,new $g,new Zg];return(new Xg(a,b)).gc()};H.Ci=function(){this.Ii();this.xi();this.Gi();this.Di();this.Hi();this.Bi();this.zi();this.wi();this.Ei()};
H.Hh=function(){for(var a=[this.$f,this.Ag,this.og,this.fg,this.jf,this.Lf,this.xg,this.vf],b=null,c=null,d=0;d<a[y];d++){var g=a[d];null!==g&&(null===c?c=g:a[b].ia(g),b=d)}this.Cg[n](function(c){a[b].ia(c)});return c};H.Ii=function(){this.Cg=this.a.f.map(function(a){return new mg(a)},this)};H.xi=function(){2<=this.a.f[y]&&(this.vf=new ng)};H.Gi=function(){this.xg=null!=this.a.D?new lg(this.a.D.Eb()):null};H.Di=function(){this.a.J&&(this.fg=new pg(this.a.J))};
H.Bi=function(){null!=this.a.oa&&(this.$f=new sg(this.a.oa))};H.Hi=function(){null!=this.a.ma&&0<this.a.ma&&(this.Ag=new tg(this.a.ma))};H.zi=function(){null!=this.a.la&&(this.Lf=new rg(this.a.la))};H.wi=function(){var a=this.a.h[Ea](function(a){return a instanceof T});null!=this.a.J&&this.a.J[n](function(b){b.K instanceof T&&a[v](b.K)});0<a[y]&&(this.jf=new qg(a))};H.Ei=function(){this.og=new og(this.a.h||[],this.a.la||null)};
...
function eh(a){U[D](this,1,1);this.Kf=a}K(eh,U);f(eh[z],function(){return"groupBy("+this.Kf.map(function(a){return a.l()})[r]()+")"});eh[z].ja=function(a,b){return this.qh(b[0])};eh[z].qh=function(a){var b=new Sf,c=function(a){return this.Kf.map(function(b){return a.M(b)},this)[F](",")}[q](this);a[C][n](function(a){b.add(c(a),a)},this);return b.G().map(function(c){return new Vd(b.get(c),a.W())},this)};
...
function ih(a,b){this.Fg=b;this.N=a.o(wd)}ih[z].Dh=function(a,b){var c=b[Ea](this.rj,this);if(0==c[y])return null;c=this.Ai(c);if(0==c[y])return null;if(1==c[y])return c[0];var d=Number.MAX_VALUE;return c[kb](function(b,c){var l=c.ph(a);return l<d?(d=l,c):b},null)};ih[z].Ai=function(a){return this.Fg.Ga().map(function(b){b=new jh(this.N,b);b.Jh(a);return b},this)[Ea](function(a){return a.wj()})};ih[z].rj=function(a){return a instanceof re&&a.Qf()?a.K.Z()==this.Fg:!1};
function jh(a,b){this.N=a;this.rb=b;this.Nf=new O;this.Nf[lb](this.rb.h.map(function(a){return a.cb[k]()}));this.Je=this.ra=null}H=jh[z];H.Vi=function(){return null===this.ra?[]:this.ra.c()};H.Ff=function(){L(this.ra);null===this.Je&&(this.Je=new hh(this.rb,this.ra));return this.Je};H.Jh=function(a){a[n](function(a){var c=a.xb()[0][k]();this.Nf[u](c)&&(null===this.ra&&(this.ra=new Sf),this.ra.add(c,a.ka()))},this)};
H.wj=function(){if(null===this.ra)return!1;for(var a=!1,b=!0,c=0;c<this.rb.h[y];c++){var d=this.ra.s(this.rb.h[c].cb[k]());if(a&&d){b=!1;break}d||(a=!0)}return b};H.ph=function(a){a=this.Ff().ud(a);var b=this.N.get(this.rb.l());return a[kb](function(a,d){return a+b.ld(d)},0)};
function kh(a,b,c,d){U[D](this,0,-1);this.N=a.o(wd);this.index=b;this.Wf=c;this.Te=d;this.Zd=this.Yd=!1}K(kh,U);f(kh[z],function(){return"index_range_scan("+this[Za].l()+", ?, "+(this.Te?"reverse":"natural")+(this.Yd?", limit:?":"")+(this.Zd?", skip:?":"")+")"});kh[z].Zc=function(a){var b=this[r](),c=this.Wf.ud(a),b=b[Ja]("?",c[r]());this.Yd&&(b=b[Ja]("?",a.oa[r]()));this.Zd&&(b=b[Ja]("?",a.ma[r]()));return b};
kh[z].ja=function(a,b,c){a=this.Wf.ud(c);c=this.N.get(this[Za].l()).Va(a,this.Te,this.Yd?c.oa:void 0,this.Zd?c.ma:void 0).map(function(a){return new Zc(a,{})},this);return[ae(c,[this[Za].Dg])]};
...
oh[z].fk=function(a,b,c){a.Vi().map(function(a){return b.get(a)})[n](Ff);a=new kh(this.m,a.rb,a.Ff(),!1);var d=new mh(this.m,c[t]);d.ia(a);Jf(c,c,d,a);return a.Hb()};
...
function sh(a){U[D](this,2,0);this.ng=a}K(sh,U);f(sh[z],function(){return"join("+this.ng[r]()+")"});sh[z].ja=function(a,b){return[this.ng.$h(b[0],b[1])]};
...
function vh(a,b){this.Da=a;this.H=b}vh[z].Jf=function(){return this.H[wb](function(a){return a instanceof T},this)?this.ij():this.jj()};
...
function Ah(a){this.m=a}K(Ah,vg);Ah[z].zb=function(a){var b=Bh(a);if(null===b)return a;a=this.eh(b);a==b&&(a=this.dh(b));return a.Hb()};Ah[z].eh=function(a){var b=a,c=Ch(a.pb(0));if(null!==c){var d;d=a.J;for(var g=null,h=c[t].Ga(),l=0;l<h[y]&&null===g;l++)g=Dh(h[l],d);d=g;if(null===d)return b;b=new kh(this.m,d.rb,new gh(d.rb),d.Tf);d=new mh(this.m,c[t]);d.ia(b);Ff(a);b=Jf(c,c,d,b)}return b};
Ah[z].dh=function(a){var b=a,c=Eh(a.pb(0));if(null!==c){var d=Dh(c[Za],a.J);if(null===d)return b;c.Te=d.Tf;b=Ff(a).parent}return b};function Eh(a){a=Ef(a,function(a){return a instanceof kh},function(a){return 1!=a.ua()});return 0<a[y]?a[0]:null}function Ch(a){a=Ef(a,function(a){return a instanceof nh},function(a){return 1!=a.ua()});return 0<a[y]?a[0]:null}function Bh(a){a=Ef(a,function(a){return a instanceof uh});return 0<a[y]?a[0]:null}
function Dh(a,b){if(a.h[y]!=b[y]||!b[yb](function(b,c){return b.K[k]()==a.h[c].cb[k]()}))return null;var c=Fh(b,a);return c[0]||c[1]?{rb:a,Tf:c[1]}:null}function Fh(a,b){var c=a[kb](function(a,b){return a<<1|(0==b.mb?0:1)},0),d=b.h[kb](function(a,b){return a<<1|(0==b.mb?0:1)},0),d=c^d,c=0==d,d=d==ea.pow(2,ea.max(a[y],b.h[y]))-1;return[c,d]};
...
Ih[z].Bj=function(a){if(a instanceof og)return new xh(a.h,a.Kb);if(a instanceof rg)return new eh(a.h);if(a instanceof qg)return new $f(a.h);if(a instanceof pg)return new uh(a.J);if(a instanceof tg)return new yh;if(a instanceof sg)return new th;if(a instanceof lg)return new lh(a.Ca.ka());if(a instanceof ng)return new yg;if(a instanceof ug)return new sh(a.Ca);if(a instanceof mg)return new nh(this.m,a[t]);if(a instanceof jg)return new dh(a[t]);if(a instanceof kg)return new Hh(a[t],a.cf);if(a instanceof
...
function Kh(){this.bg=new N}H=Kh[z];H.td=function(a){var b=this.bg.get(a[k](),null);null===b&&(b=new Lh,this.bg.set(a[k](),b));return b};H.fj=function(a,b,c){b[n](function(b){this.td(b).ej(a,c)},this)};H.th=function(a,b,c){return b[yb](function(b){return this.td(b).sh(a,c)},this)};H.rg=function(a,b,c){var d=this.th(a,b,c);d&&this.fj(a,b,c);return d};H.Rd=function(a,b){b[n](function(b){this.td(b).Rd(a)},this)};H.Eh=function(a){a[n](function(a){this.td(a).ab=null},this)};
...
function Mh(){this.Sb=new Nh;this.Qc=new Kh}H=Mh[z];H.Ub=function(a){(2>a[pb]()||2>a[pb]())&&this.Qc.Eh(a.ca().c());this.Sb.sb(a);this.me();return a.Jc().ga};H.me=function(){for(var a=this.Sb.c(),b=0;b<a[y];b++){var c=a[b],d=!1;if(d=0==c.da()?this.sg(c,1,3):this.sg(c,2,0))this.Sb[m](c),this.ii(c)}};H.sg=function(a,b,c){var d=!1,g=a.ca().c();this.Qc.rg(a.ka(),g,b)&&(d=this.Qc.rg(a.ka(),g,c));return d};H.ii=function(a){a[Ia]()[A](J(this.Mj,this,a),J(this.Lj,this,a))};
...
H.Ae=function(a){var b=new O;a[n](function(a){b.add(a[k]())});var c=[];this.fc.c()[n](function(a){a=a.Lc();a[Da].f[wb](function(a){return b[u](a[k]())})&&c[v](a)});return c};H.Og=function(a,b){var c=this.ye(null!=a.Ac?a.Ac:a),c=this.fc.get(c,null);return null!==c?(c.Ck(b),!0):!1};function Rh(a){this.nh=a;this.Tc=new O;this.Jj=[];this.Zf=null;this.Vh=new Oh(a.xd(),this.Jj)}H=Rh[z];H.ae=function(a){this.Tc[u](a)?Yb("Attempted to register observer twice."):this.Tc.add(a)};H.Se=function(a){return this.Tc[m](a)};
H.Lc=function(){return this.nh.Si()};H.nj=function(){return 0<this.Tc.na()};H.Ck=function(a){var b=this.Vh.bh(this.Zf,a);this.Zf=a;0<b[y]&&this.Tc.c()[n](function(a){a(b)})};
...
function Y(a,b,c,d,g,h){this.F=a;this.B=b;this.Vf=c;this.Sf=d;this.Kg=g;this.ib=h||null;this.i=this.C=null}I("lf.schema.BaseColumn",Y,void 0);H=Y[z];ia(H,G("B"));H.l=function(){return this.F.Aa()+"."+this.B};f(H,function(){return this.l()});H.Z=G("F");H.da=G("Kg");H.Ua=G("ib");H.Ga=function(){null==this.qa&&(this.qa=[],this.Z().Ga()[n](function(a){-1!=a.h.map(function(a){return a.cb[k]()})[ob](this.B)&&this.qa[v](a)},this));return this.qa};H.lc=G("Sf");H.Fd=G("Vf");H.Ye=Cb("C");H.getParent=G("C");
H.Y=G("i");H.Na=function(a){return Uf(this,a,"eq")};Y[z].eq=Y[z].Na;Y[z].cg=function(a){return Uf(this,a,"neq")};Y[z].neq=Y[z].cg;Y[z].Ke=function(a){return Uf(this,a,"lt")};Y[z].lt=Y[z].Ke;Y[z].Aj=function(a){return Uf(this,a,"lte")};Y[z].lte=Y[z].Aj;Y[z].gj=function(a){return Uf(this,a,"gt")};Y[z].gt=Y[z].gj;Y[z].hj=function(a){return Uf(this,a,"gte")};Y[z].gte=Y[z].hj;Y[z].match=function(a){return Uf(this,a,"match")};Y[z].match=Y[z].match;Y[z].mh=function(a,b){return Uf(this,[a,b],"between")};
Y[z].between=Y[z].mh;Y[z].oj=function(a){return Uf(this,a,"in")};Y[z]["in"]=Y[z].oj;Y[z].uj=function(){return this.Na(null)};Y[z].isNull=Y[z].uj;Y[z].tj=function(){return this.cg(null)};Y[z].isNotNull=Y[z].tj;Y[z].wc=function(a){return new Y(this.F,this.B,this.Vf,this.Sf,this.Kg,a)};Y[z].as=Y[z].wc;
...
Z[z].Yg=function(a,b){this.yc(a);var c=this.Hd(b,!0);this.qa.set(a,c);this.rc.add(a);return this};Z[z].addUnique=Z[z].Yg;Z[z].gf=function(a){a=this.Hd(a,!1);this.yh(a);a[n](function(a){this.Id.add(a[rb])},this);return this};Z[z].addNullable=Z[z].gf;
...
!0,a[D](this,d))},this);this.Ih=new $h(h,l,[],p);this.vg=b.Fi(d,g)}var b=this;K(a,Xf);a[z].wb=function(a){return new this.vg($c++,a)};a[z].createRow=a[z].wb;a[z].dc=function(a){var b={};this.xb()[n](function(g){var h=g[k]();g=g.da();var l=a[x][h];if(0==g)if(null===l)g=l;else if(g=l,""==g)g=null;else{0!=g[y]%2&&(g="0"+g);for(var l=new ArrayBuffer(g[y]/2),p=new Uint8Array(l),B=0,Ra=0;B<g[y];B+=2)p[Ra++]=ga(g.substr(B,2),16);g=l}else g=2==g?null===l?l:new Date(l):l;b[h]=g},this);return new this.vg(a.id,
b)};a[z].deserializeRow=a[z].dc;a[z].ic=G("Ih");a[z].getConstraint=a[z].ic;return a};
Z[z].Fi=function(a,b){function c(c,d){this.H=a;this.qa=b;Zc[D](this,c,d)}K(c,Zc);c[z].wf=function(){var a={};this.H[n](function(b){a[b[k]()]=b.lc()?null:ge[b.da()]});return a};c[z].Hg=function(){var a={};this.H[n](function(b){var c=b[k]();b=b.da();var d=this.w()[c];a[c]=0==b?null===d?d:cd(d):2==b?null===d?d:d[Qa]():d},this);return a};var d=J(function(a){var b=this.H.get(a[k]());return 2==b?function(b){b=b[a[k]()];return a.lc()&&null===b?null:b[Qa]()}:1==b?function(b){return a.lc()?(b=b[a[k]()],null===
...
function ci(a,b){this.A=new di(a,b);this.pc=new N;this.Ic=!1}I("lf.schema.Builder",ci,void 0);ci[z].pi=function(){this.Ic||(this.pc.G()[n](function(a){a=this.pc.get(a);this.A.lk(a.Jb())},this),this.pc[Pa](),this.Ic=!0)};ci[z].Jb=function(){this.Ic||this.pi();return this.A};ci[z].getSchema=ci[z].Jb;ci[z].Ef=function(){var a=new td("ns_"+this.A[rb]()),b;Xh||(Xh=new Wh);b=Xh;var c=null;b.Ie(a)?c=b.o(a):(c=new Wh,b.nb(a,c));return c};ci[z].getGlobal=ci[z].Ef;
ci[z].connect=function(a){var b=this.Ef();b.Ie(Ad)||b.nb(Ad,this.Jb());return(new X(b)).Ba(a)};ci[z].connect=ci[z].connect;ci[z].Oh=function(a){if(this.pc.s(a)||this.Ic)throw new P("SyntaxError","Table is already created or schema is already finalized.");this.pc.set(a,new Z(a));return this.pc.get(a)};ci[z].createTable=ci[z].Oh;ci[z].Ze=function(a){if(this.Ic)throw new P("SyntaxError","Schema is already finalized.");this.A.Ze(a);return this};ci[z].setPragma=ci[z].Ze;
function di(a,b){this.B=a;this.Ma=b;this.I=new N;this.mg={Wh:!1}}I("lf.schema.DatabaseSchema",di,void 0);za(di[z],G("B"));za(di[z],di[z][rb]);di[z].version=G("Ma");di[z].version=di[z][Fa];di[z].gb=function(){return this.I.c()};di[z].tables=di[z].gb;oa(di[z],function(a){if(!this.I.s(a))throw new P("NotFoundError",a+" is not found in database");return this.I.get(a)});oa(di[z],di[z][t]);di[z].lk=function(a){this.I.set(a[k](),a)};di[z].lg=G("mg");di[z].pragma=di[z].lg;di[z].Ze=Cb("mg");
