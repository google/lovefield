...
function Db(a){return function(){return a}}var H,Eb=this;function Fb(a){return void 0!==a}function I(a,b,c){a=a[ab](".");c=c||Eb;a[0]in c||!c.execScript||c.execScript("var "+a[0]);for(var d;a[y]&&(d=a[Ha]());)!a[y]&&Fb(b)?c[d]=b:c=c[d]?c[d]:c[d]={}}function Gb(){}function Hb(a){a.ue=function(){return a.Nf?a.Nf:a.Nf=new a}}
...
function Uc(){var a,b,c=new M(function(c,g){a=c;b=g});return new Vc(c,a,b)}M[z].then=function(a,b,c){null!=a&&Zb(a,"opt_onFulfilled should be a function.");null!=b&&Zb(b,"opt_onRejected should be a function. Did you pass opt_context as the second argument instead of the third?");return this.ef(Nb(a)?a:null,Nb(b)?b:null,c)};M[z].then=M[z][A];M[z].$goog_Thenable=!0;H=M[z];
H.vk=function(a,b,c){null!=a&&Zb(a,"opt_onFulfilled should be a function.");null!=b&&Zb(b,"opt_onRejected should be a function. Did you pass opt_context as the second argument instead of the third?");this.df(Pc(a||Gb,b||null,c))};function Tc(a,b,c,d){a instanceof M?a.vk(b,c,d):a[A](b,c,d)}H.Gg=function(a,b){return this.ef(null,a,b)};H.df=function(a){this.mj()||2!=this.ya&&3!=this.ya||this.vg();this.Yj(a)};
H.ef=function(a,b,c){var d=Pc(null,null,null);ta(d,new M(function(g,h){d.Nb=a?function(b){try{var d=a[D](c,b);g(d)}catch(B){h(B)}}:g;d.mc=b?function(a){try{var d=b[D](c,a);!Fb(d)&&a instanceof Mc?h(a):g(d)}catch(B){h(B)}}:h}));d[gb].F=this;this.df(d);return d[gb]};H.Lg=function(a){L(1==this.ya);this.ya=0;this.oc(2,a)};H.Mg=function(a){L(1==this.ya);this.ya=0;this.oc(3,a)};
H.oc=function(a,b){if(0==this.ya){if(this==b)a=3,b=new TypeError("Promise cannot resolve to itself");else{var c;if(b)try{c=!!b.$goog_Thenable}catch(d){c=!1}else c=!1;if(c){this.ya=1;Tc(b,this.Lg,this.Mg,this);return}c=typeof b;if("object"==c&&null!=b||"function"==c)try{var g=b[A];if(Nb(g)){this.yk(b,g);return}}catch(h){a=3,b=h}}this.sg=b;this.ya=a;this.F=null;this.vg();3!=a||b instanceof Mc||Wc(this,b)}};
H.yk=function(a,b){function c(a){h||(h=!0,g.Mg(a))}function d(a){h||(h=!0,g.Lg(a))}this.ya=1;var g=this,h=!1;try{b[D](a,d,c)}catch(l){c(l)}};H.vg=function(){this.oe||(this.oe=!0,Fc(this.li,this))};H.mj=function(){return!!this.bc};H.Yj=function(a){L(null!=a.Nb);this.ed?qa(this.ed,a):this.bc=a;this.ed=a};H.Rj=function(){var a=null;this.bc&&(a=this.bc,this.bc=a[$a],qa(a,null));this.bc||(this.ed=null);null!=a&&L(null!=a.Nb);return a};
H.li=function(){for(var a=null;a=this.Rj();)this.ki(a,this.ya,this.sg);this.oe=!1};H.ki=function(a,b,c){3==b&&a.mc&&!a.ce&&this.ek();if(a[gb])a[gb].F=null,Xc(a,b,c);else try{a.ce?a.Nb[D](a[Da]):Xc(a,b,c)}catch(d){Yc[D](null,d)}Oc.put(a)};function Xc(a,b,c){2==b?a.Nb[D](a[Da],c):a.mc&&a.mc[D](a[Da],c)}H.$g=Bb();H.ek=function(){var a;for(a=this;a&&a.Cd;a=a.F)a.Cd=!1};function Wc(a,b){a.Cd=!0;Fc(function(){a.Cd&&(a.$g(b),Yc[D](null,b))})}var Yc=zc;function Mc(a){Ub[D](this,a)}K(Mc,Ub);za(Mc[z],"cancel");
function Vc(a,b,c){this.ga=a;this.resolve=b;this.reject=c};
function Zc(a,b){this.va=a;this.Pb=b||this.vf()}var $c=0;H=Zc[z];H.id=G("va");H.ih=Cb("va");H.w=G("Pb");H.vf=function(){return{}};H.Hg=G("Pb");H.Fa=function(){return{id:this.va,value:this.Hg()}};H.Pc=function(a){return"#"==a.substr(-1)?this.va:null};function ad(a){return new Zc(a.id,a[x])}function bd(a){return new Zc($c++,a||{})}function cd(a){if(null==a)return"";a=new Uint8Array(a);for(var b="",c=0;c<a[y];++c)var d=a[c][r](16),b=b+(2>d[y]?"0"+d:d);return b};
...
function pd(a,b,c){if(Lb(a))try{cc(a,b,c)}catch(d){if(d!==md)throw d;}else{a=od(a);try{for(;;)b[D](c,a[$a](),void 0,a)}catch(g){if(g!==md)throw g;}}}function qd(a){if(fc(arguments,function(a){return!a[y]})||!arguments[y])return new nd;var b=new nd,c=arguments,d=qc(0,c[y]);qa(b,function(){if(d){for(var a=dc(d,function(a,b){return c[b][a]}),b=d[y]-1;0<=b;b--){L(d);if(d[b]<c[b][y]-1){d[b]++;break}if(0==b){d=null;break}d[b]=0}return a}throw md;});return b};function N(a,b){this.g={};this.b=[];this.Ma=this.Z=0;var c=arguments[y];if(1<c){if(c%2)throw fa("Uneven number of arguments");for(var d=0;d<c;d+=2)this.set(arguments[d],arguments[d+1])}else a&&this[lb](a)}H=N[z];H.na=G("Z");H.c=function(){this.zc();for(var a=[],b=0;b<this.b[y];b++)a[v](this.g[this.b[b]]);return a};H.G=function(){this.zc();return this.b[Ka]()};H.s=function(a){return rd(this.g,a)};H.kd=function(a){for(var b=0;b<this.b[y];b++){var c=this.b[b];if(rd(this.g,c)&&this.g[c]==a)return!0}return!1};
H.Fc=function(a,b){if(this===a)return!0;if(this.Z!=a.na())return!1;var c=b||sd;this.zc();for(var d,g=0;d=this.b[g];g++)if(!c(this.get(d),a.get(d)))return!1;return!0};function sd(a,b){return a===b}H.Ha=function(){return 0==this.Z};ma(H,function(){this.g={};Aa(this.b,0);this.Ma=this.Z=0});ja(H,function(a){return rd(this.g,a)?(delete this.g[a],this.Z--,this.Ma++,this.b[y]>2*this.Z&&this.zc(),!0):!1});
H.zc=function(){if(this.Z!=this.b[y]){for(var a=0,b=0;a<this.b[y];){var c=this.b[a];rd(this.g,c)&&(this.b[b++]=c);a++}Aa(this.b,b)}if(this.Z!=this.b[y]){for(var d={},b=a=0;a<this.b[y];)c=this.b[a],rd(d,c)||(this.b[b++]=c,d[c]=1),a++;Aa(this.b,b)}};H.get=function(a,b){return rd(this.g,a)?this.g[a]:b};H.set=function(a,b){rd(this.g,a)||(this.Z++,this.b[v](a),this.Ma++);this.g[a]=b};H.addAll=function(a){var b;a instanceof N?(b=a.G(),a=a.c()):(b=vc(a),a=uc(a));for(var c=0;c<b[y];c++)this.set(b[c],a[c])};
...
H.put=function(a){if(0==a[y])return Qc();var b=new N;a[n](function(a){var d;d=a.id()>>9;var g=b.get(d,null);null===g&&(g=this.tg(this.O[rb],d));g.zg([a]);b.set(d,g)},this);a=b.c().map(function(a){return this.Qb(J(function(){return this.O.put(a.Fa())},this))},this);return Sc(a)};
ja(H,function(a){if(0==a[y])return this.Qb(J(function(){return this.O[Pa]()},this));var b=new N;a[n](function(a){var d=a>>9,g=b.get(d,null);null===g&&(g=this.tg(this.O[rb],d));g.dk([a]);b.set(d,g)},this);a=b.c().map(function(a){return this.Qb(J(function(){var b;a:{b=a.jc();for(var g in b){b=!1;break a}b=!0}return b?this.O[qb](a.ka()):this.O.put(a.Fa())},this))},this);return Sc(a)});function Jd(a,b,c){a=a.o(vd);var d=[c<<9,(c+1<<9)-1];b=a.Va(b,d[0],d[1]);c=new Fd(c);c.zg(b);return c}
...
function Pd(a,b){this.Sa=new N;b[n](function(a){this.Sa.set(a[k](),a)},this);this.pa=a.o(vd);this.N=a.o(wd);this.jd=new Nd(a);this.Ed=new Md(a);this.Pe=this.Wd=!1;this.Cb=new N}H=Pd[z];H.Cf=G("Cb");H.Mi=function(){var a=[];this.Cb.G().map(function(a){return this.Sa.get(a)},this)[n](function(b){b.Rb()&&(b.Ga()[n](function(b){a[v](this.N.get(b.l()))},this),a[v](this.N.get(b[k]()+".#")))},this);return a};H.ca=G("Sa");
...
function Rd(a,b,c,d){this.f=a;this.u=b;this.$=null===this.f?!1:c;this.fa=null===this.u?!1:d}H=Rd[z];f(H,function(){return(this.$?"(":"[")+(null===this.f?"unbound":this.f)+", "+(null===this.u?"unbound":this.u)+(this.fa?")":"]")});H.Gh=function(){if(null===this.f&&null===this.u)return[];var a=null,b=null;null===this.f||(a=new Rd(null,this.f,!1,!this.$));null===this.u||(b=new Rd(this.u,null,!this.fa,!1));return[a,b][Ea](function(a){return null!==a})};
H.reverse=function(){return new Rd(this.u,this.f,this.fa,this.$)};H.hg=function(a){var b=Sd(this.f,a.f,!0,this.$,a.$);if(0==b)return!0;var c=-1==b?this:a;a=1==b?this:a;return null===c.u||c.u>a.f||c.u==a.f&&!c.fa&&!a.$};function Td(){return new Rd(null,null,!1,!1)}H.contains=function(a){var b=null===this.u||a<this.u||a==this.u&&!this.fa;return(null===this.f||a>this.f||a==this.f&&!this.$)&&b};H.Fc=function(a){return this.f==a.f&&this.$==a.$&&this.u==a.u&&this.fa==a.fa};
function Sd(a,b,c,d,g){function h(a){return c?a:1==a?-1:1}d=d||!1;g=g||!1;return null===a?null===b?(d?!g:g)?d?h(1):h(-1):0:h(-1):null===b?h(1):a<b?-1:a==b?(d?!g:g)?d?h(1):h(-1):0:1}function Ud(a,b){var c=Sd(a.f,b.f,!0,a.$,b.$);0==c&&(c=Sd(a.u,b.u,!1,a.fa,b.fa));return c};
...
function je(){return new N("eq",function(a,b){return a==b},"neq",function(a,b){return a!=b})};function me(a,b){this.Wf=a;this.Qg=b}me[z].getKey=G("Wf");me[z].dj=G("Qg");sa(me[z],function(){return new me(this.Wf,this.Qg)});function ne(a,b){me[D](this,a,b);this.j=this.F=null}K(ne,me);var oe=[];H=ne[z];sa(H,function(){return new ne(this.getKey(),this.dj())});H.getParent=G("F");H.Qf=function(){return!this.ua()};H.aa=function(){return this.j||oe};H.pb=function(a){return this.aa()[a]||null};H.ua=function(){return this.aa()[y]};H.Li=function(){for(var a=0,b=this;b[Ga]();)a++,b=b[Ga]();return a};H.Hb=function(){for(var a=this;a[Ga]();)a=a[Ga]();return a};H.contains=function(a){do a=a[Ga]();while(a&&a!=this);return Boolean(a)};
H.qc=function(a,b){if(!1!==a[D](b,this))for(var c=this.aa(),d=0;d<c[y];d++)c[d].qc(a,b)};H.xg=Cb("F");H.ia=function(a){this.tc(a,this.j?this.j[y]:0)};H.tc=function(a,b){L(!a[Ga]());a.xg(this);this.j=this.j||[];L(0<=b&&b<=this.j[y]);lc(this.j,b,0,a)};H.Sd=function(a){var b=this.j&&this.j[a];return b?(b.xg(null),hc(this.j,a),0==this.j[y]&&(this.j=null),b):null};H.removeChild=function(a){return this.Sd(bc(this.aa(),a))};
...
H.rf=function(){var a=!1;this[x]instanceof ee||(a="array"==Ib(this[x])?!this[x][wb](function(a){return a instanceof ee}):!0);if(!a)throw new P("SyntaxError","Value is not bounded");};H.eval=function(a){this.rf();if("in"==this.V)return this.Yh(a);var b=a[C][Ea](function(a){return this.nd(a.M(this.K),this[x])!=this.Xa},this);return new Vd(b,a.W())};
...
H.Yh=function(a){L("in"==this.V,"ValuePredicate#evalAsIn_() called for wrong predicate type.");var b=new O(this[x]),c=J(function(a){return b[u](a)!=this.Xa},this),d=a[C][Ea](function(a){return c(a.M(this.K))},this);return new Vd(d,a.W())};f(H,function(){return"value_pred("+this.K.l()+" "+this.V+(this.Xa?"(complement)":"")+" "+this[x]+")"});H.Pf=function(){this.rf();return null!==this[x]&&("between"==this.V||"eq"==this.V||"gt"==this.V||"gte"==this.V||"lt"==this.V||"lte"==this.V)};
H.wk=function(){L(this.Pf(),"Could not convert predicate to key range.");var a=null;"between"==this.V?a=new Rd(this[x][0],this[x][1],!1,!1):"eq"==this.V?(a=this[x],a=new Rd(a,a,!1,!1)):a="gte"==this.V?new Rd(this[x],null,!1,!1):"gt"==this.V?new Rd(this[x],null,!0,!1):"lte"==this.V?new Rd(null,this[x],!1,!1):new Rd(null,this[x],!1,!0);return this.Xa?a.Gh():[a]};
function se(){this.Ac=this.ra=null}se[z].yd=function(a){null===this.ra&&null!=this.C&&(this.ra=te(this.C));a=this.ra.get(a,null);L(null!==a);return a};function te(a){var b=new N;a.qc(function(a){b.set(a.ka(),a)});return b}se[z].gd=function(a){a.C&&(this.C=a.C.Eb());this.Ac=a};na(se[z],function(){L(null==this.Ac);return this});se[z].fe=function(a){var b=this.C;null!=b&&b.qc(function(b){b instanceof re&&b[q](a)})};
...
function we(a){this.Ea=a}we[z].Hb=G("Ea");we[z].yf=Db("plan description");we[z].ca=function(){function a(c){var d=c.ca();d&&b.add(d);c.aa()[n](function(b){a(b)})}var b=new O;a(this.Ea);return b.c()};function xe(a){var b=new O;a[n](function(a){b[lb](a.ca())});return b};

function ye(a,b){this.global=a;this.vb=a.o(ud);this.Pd=b.map(function(a){return a[Da]});this.jg=b.map(function(a){return a.Qe});this.sf=xe(this.jg);this.Jg=this.Uh();this.Tb=Uc()}H=ye[z];H.Uh=function(){return this.Pd[wb](function(a){return!(a instanceof ue)})?1:0};
ha(H,function(){var a=new Pd(this[Ta],this.sf.c()),b=[],c=this.jg[w](),d=J(function(){var g=c[Ha]();if(g){var h=this.Pd[b[y]];return g.Hb()[Ia](a,h)[A](function(a){b[v](a[0]);return d()})}return Qc()},this);return d()[A](J(function(){return this.vb.Fb(this.Jg,a).U()},this))[A](J(function(){this.Ne(b);return b},this),J(function(b){a.Ab();throw b;},this))});H.da=G("Jg");H.ca=G("sf");H.Jc=G("Tb");H.ka=function(){return Ob(this)};H.Ne=Bb();
...
function Q(a,b){this.Ma=a;this.i=b;this.fb=new N}I("lf.backstore.FirebaseRawBackStore",Q,void 0);H=Q[z];H.zd=G("i");H.Ad=function(){throw new P("NotSupportedError","Firebase does not have raw transaction.");};function De(a,b){var c=Uc(),d=a;b[y]&&(d=a[gb](b));d[db]("value",function(a){c[vb](a.val())},function(a){c[jb](a)});return c.ga}function Ee(a,b,c){function d(a){a?g[jb](a):g[vb]()}c=c||!1;var g=Uc();c?a.set(b,d):a[zb](b,d);return g.ga}
H.Ba=function(a){return De(this.i,"@rev/R")[A](function(a){this.Qa=a;return De(this.i,"@table")}[q](this))[A](function(b){var c=0,d;for(d in b)this.fb.set(d,b[d]),b[d]>c&&(c=b[d]);a.gb()[n](function(a){this.fb.s(a[k]())||(b[a[k]()]=++c)},this);d=this.i[gb]("@table");return Ee(d,b)}[q](this))};
H.Xd=function(a,b){var c=this.fb.get(a);return null!=c?function(){var a={},g=Uc();this.i[Ma]("T").equalTo(c)[db]("value",function(c){c[n](function(c){var g=b(c.val());a[ga(c.key(),10)]=g});g[vb](a)});return g.ga}[D](this)[A](function(a){a["@rev"]={R:++this.Qa};return Ee(this.i,a)}[q](this)):Qc()};H.Dc=function(a){return this.Xd(a,Db(null))[A](function(){this.fb[m](a);return Ee(this.i[gb]("@table/"+a),null,!0)}[q](this))};Q[z].dropTable=Q[z].Dc;
...
Q[z].wb=function(){throw new P("NotSupportedError","Firebase does not have raw transaction.");};Q[z].createRow=Q[z].wb;Q[z].Mc=G("Ma");Q[z].getVersion=Q[z].Mc;Q[z].ec=function(a){var b=Uc();a=this.fb.get(a);this.i[Ma]("T").equalTo(a)[db]("value",function(a){var d=[];a[n](function(a){d[v](a.val().P)});b[vb](d)});return b.ga};pa(Q[z],function(){var a={},b=this.fb.G().map(function(b){return this.ec(b)[A](function(d){a[b]=d})}[q](this));return Sc(b)[A](function(){return a})});pa(Q[z],Q[z].dump);
function Fe(a,b,c){gd[D](this,c,b);this.i=a}K(Fe,gd);Fe[z].Y=function(a){return this.i.Kc(a)};
Fe[z].U=function(){Fe.eb.U[D](this);var a=this.Pi().Cf();if(0==a.na())this.ba[vb]();else{var b=this.i.Yi()+1;this.i.yg(b);var c={"@rev":{R:b}};a[n](function(a){var g=this.i.Hf(a[k]());a.qd()[n](function(a,d){c[d]={R:b,T:g,P:a.w()}});a.wd()[n](function(a,d){c[d]={R:b,T:g,P:a[1].w()}});a.rd()[n](function(a,b){c[b]=null})},this);this.i.Wi()[zb](c,function(c){if(null===c)this.ba[vb]();else this.i.yg(b-1),c=a.c().map(function(a){return this.i.og(a[k]())},this),Sc(c)[A](this.ba[jb][q](this.ba),this.ba[jb][q](this.ba))}[q](this))}return this.ba.ga};
function Ge(){this.ob=new N}H=Ge[z];H.ze=function(a){if(0==a[y])return this.ob.c();var b=[];a[n](function(a){a=this.ob.get(a,null);null===a||b[v](a)},this);return b};H.getData=G("ob");H.get=function(a){return Qc(this.ze(a))};H.Re=function(a){a[n](function(a){this.ob.set(a.id(),a)},this)};H.put=function(a){this.Re(a);return Qc()};H.pg=function(a){0==a[y]||a[y]==this.ob.na()?this.ob[Pa]():a[n](function(a){this.ob[m](a)},this)};ja(H,function(a){this.pg(a);return Qc()});
H.Qi=function(){return this.ob.Ha()?0:this.ob.G()[kb](function(a,b){return a>b?a:b},0)};
function He(a,b){this.A=a;this.Zg=b;this.Vc=new N;this.Qa=-1;this.I=new N;this.fb=new N;this.ge=null}H=He[z];H.Yi=G("Qa");H.yg=Cb("Qa");
H.Ba=function(a){this.i=this.Zg[gb](this.A[rb]());var b=a||function(){return Qc()};return De(this.i,"@db/version")[A](function(a){return null===a?Ee(this.i,this.Lh(),!0)[A](function(){var a=new Q(0,this.i);return b(a)}[q](this)):a==this.A[Fa]()?De(this.i,"@rev/R")[A](function(a){this.Qa=a;return De(this.i,"@table")}[q](this))[A](function(a){for(var b in a)this.fb.set(b,a[b]);a=this.A.gb().map(function(a){return this.og(a[k]())},this);return Sc(a)}[q](this))[A](function(){this.pj();this.$f();return Qc()}[q](this)):
this.Oe(a,b)[A](function(){return this.Ba()}[q](this))}[q](this))};H.Oe=function(a,b){var c=new Q(a,this.i);return c.Ba(this.A)[A](function(){return this.Ak()}[q](this))[A](function(){return b(c)})[A](function(){var a=this.i[gb]("@db");return Ee(a,{version:this.A[Fa]()},!0)}[q](this))};H.Ak=function(){return Qc()};H.$f=function(){this.i.off();this.i.on("child_removed",this.Kj[q](this));this.he&&(this.he.off(),this.Vc[Pa]());this.he=this.i[Ma]("R").startAt(this.Qa+1);this.he.on("value",this.Me[q](this))};
H.pj=function(){$c=this.I.c().map(function(a){return a.Qi()})[kb](function(a,b){return a>b?a:b},0)+1};H.Kj=function(a){var b=a.val(),c=this.Vc.get(b.T,null);null===c&&(c=new O,this.Vc.set(b.T,c));c.add(ga(a.key(),10))};H.Me=function(a){var b=a[gb]("@rev/R").val();null!=b&&b!=this.Qa&&(this.Qa=b,a=this.yi(a),a[n](function(a){var b=this.I.get(a[k]()),g=a.rd().G();g[y]&&b.pg(g);var h=a.qd().c();a.wd()[n](function(a){h[v](a[1])});b.Re(h)},this),a[y]&&this.Sc(a),this.$f())};
...
H.og=function(a){var b=Uc(),c=this.Hf(a);this.i[Ma]("T").equalTo(c)[db]("value",function(c){var g=new Ge,h=[];c[n](function(a){h[v](new Zc(ga(a.key(),10),a.val().P))});g.Re(h);this.I.set(a,g);b[vb]()}[q](this));return b.ga};H.Hf=function(a){return this.fb.get(a)};H.Lh=function(){var a={};a["@db"]={version:this.A[Fa]()};a["@rev"]={R:1};this.Qa=1;a["@table"]={};this.A.gb()[n](function(b,c){var d=b[k]();a["@table"][d]=c;this.I.set(d,new Ge);this.fb.set(d,c)},this);return a};
H.Fb=function(a,b){return new Fe(this,a,b)};H.Kc=function(a){var b=this.I.get(a,null);if(null!==b)return b;throw new P("DataError","Table "+a+" not found");};H.Wi=G("i");ra(H,Bb());ya(H,Cb("ge"));H.Sc=function(a){null!=this.ge&&this.ge(a)};
function R(a,b,c,d){this.i=b;this.La=c;this.Ma=a;this.cd=d}I("lf.backstore.IndexedDBRawBackStore",R,void 0);R[z].zd=G("i");R[z].getRawDBInstance=R[z].zd;R[z].Ad=G("La");R[z].getRawTransaction=R[z].Ad;R[z].Dc=function(a){return new M(function(b,c){try{this.i.deleteObjectStore(a)}catch(d){c(d);return}b()},this)};R[z].dropTable=R[z].Dc;
R[z].Oj=function(a,b,c){return new M(function(d,g){var h;try{var l=this.La[nb](a);h=l[tb]()}catch(p){g(p);return}Ba(h,function(){var a=h[Xa];a?(b(a),a[Sa]()):(c(l),d())});ua(h,g)},this)};function Ie(a){var b=null;return b=a instanceof ArrayBuffer?cd(a):a instanceof Date?a[Qa]():a}R[z].$e=function(a,b){function c(a){var c=Hd(a[x]),d=c.jc(),p;for(p in d){var B=ad(d[p]);b(B);d[p]=B.Fa()}a[zb](c.Fa())}function d(a){var c=ad(a[x]);b(c);a[zb](c.Fa())}return this.Oj(a,this.cd?c:d,Bb())};
R[z].uc=function(a,b,c){var d=Ie(c);return this.$e(a,function(a){a.w()[b]=d})};R[z].addTableColumn=R[z].uc;R[z].Ec=function(a,b){return this.$e(a,function(a){delete a.w()[b]})};R[z].dropTableColumn=R[z].Ec;R[z].Wc=function(a,b,c){return this.$e(a,function(a){a.w()[c]=a.w()[b];delete a.w()[b]})};R[z].renameTableColumn=R[z].Wc;
...
pa(R[z],function(){for(var a=this.i[La],b=[],c=0;c<a[y];++c){var d=a[mb](c);b[v](this.ec(d))}return Sc(b)[A](function(b){var c={};b[n](function(b,d){c[a[mb](d)]=b});return c})});pa(R[z],R[z].dump);R[z].ec=function(a){return this.bj(a)[A](function(a){return a.map(function(a){return a[x]})})};
...
function Ke(a,b,c,d,g){gd[D](this,c,d);this.m=a;this.La=b;this.cd=g;this.La.oncomplete=J(this.ba[vb],this.ba);this.La.onabort=J(this.ba[jb],this.ba)}K(Ke,gd);Ke[z].Y=function(a,b,c){return this.cd?(c=null!=c?c:0,a=this.La[nb](a),new Id(a,b,0==c?Tb(Jd,this.m):Kd)):new Je(this.La[nb](a),b)};
function Le(a,b){this.m=a;this.A=b;this.dd=b.kg().Wh||!1}H=Le[z];
H.Ba=function(a){var b=aa.indexedDB||aa.mozIndexedDB||aa.webkitIndexedDB||aa.msIndexedDB;if(null==b)throw new P("NotSupportedError","IndexedDB not supported by platform.");var c=a||function(){return Qc()};return new M(function(a,g){var h;try{h=b.open(this.A[rb](),this.A[Fa]())}catch(l){g(l);return}ua(h,g);h.onupgradeneeded=J(function(a){this.Nj(c,a)[A](Bb(),g)},this);Ba(h,J(function(b){this.i=b[ub][Xa];this.Ve()[A](J(function(b){$c=b+1;a(this.i)},this))},this))},this)};
...
H.Cc=function(a,b,c,d){a[La][u](c)||(a.createObjectStore(c,{keyPath:"id"}),a=b[nb](c),(this.dd?new Id(a,ad,Kd):new Je(a,ad)).put([new ed(new dd(d))]))};H.Fb=function(a,b){var c=b.ca().c().map(function(a){return a[k]()});b.Ni()[n](function(a){c[v](a)});var d=this.i[fb](c,0==a?"readonly":"readwrite");return new Ke(this.m,d,b,a,this.dd)};
H.Ve=function(a){function b(){if(0==c[y])return Qc();var a=c[Ha]();return l(a)[A](b)}var c=this.A.gb().map(function(a){return a[k]()}),d=this.i,g=0,h=J(function(a){return this.dd?(a=Hd(a[x]),vc(a.jc())[kb](function(a,b){return ea.max(a,b)},0)):a.key},this),l=J(function(b){return new M(function(c,l){var ze;try{ze=(a||d[fb]([b]))[nb](b)[tb](null,"prev")}catch(bh){l(bh);return}Ba(ze,function(a){(a=a[ub][Xa])&&(g=ea.max(g,h(a)));c(g)});ua(ze,function(){c(g)})},this)},this);return new M(function(a){b()[A](function(){a(g)})})};
ra(H,function(){this.i[cb]()});H.Kc=function(){throw new P("SyntaxError","IndexedDB tables needs to be acquired from transactions");};ya(H,Bb());H.Sc=Bb();



function Me(a,b,c){gd[D](this,c,b);this.O=a;0==b&&this.ba[vb]()}K(Me,gd);Me[z].Y=function(a){return this.O.Kc(a)};Me[z].U=function(){Me.eb.U[D](this);this.ba[vb]();return this.ba.ga};
function Ne(a){this.A=a;this.I=new N}H=Ne[z];H.Ba=function(){this.A.gb()[n](this.qj,this);return Qc()};H.Kc=function(a){var b=this.I.get(a,null);if(null===b)throw new P("DataError","Table "+a+" does not exist.");return b};H.Fb=function(a,b){return new Me(this,a,b)};H.tf=function(a){if(!this.I.s(a)){var b=new Ge;this.I.set(a,b);return b}return null};H.qj=function(a){this.tf(a[k]());a.Rb()&&(a.Ga()[n](function(a){this.Cc(a.l(),"btree")},this),this.Cc(a.Ib(),"rowid"))};
H.Cc=function(a,b){var c=this.tf(a);null===c||c.put([new ed(new dd(b))])};ra(H,Bb());ya(H,Bb());H.Sc=Bb();
...
function Qe(a,b,c){gd[D](this,b,c);this.i=a;this.I=new N;this.ke=[]}K(Qe,gd);Qe[z].Y=function(a,b){var c=this.I.get(a,null);null===c&&(c=new Pe(this,a,b),this.I.set(a,c));return c};Qe[z].Ja=function(a,b,c){this.ke[v]({tk:a,Pj:b,transform:c})};
Qe[z].U=function(){Qe.eb.U[D](this);var a,b,c=this.ba[jb][q](this.ba),d=function(a,b){this.ba[jb](b)}[q](this),g=J(function(c,l){a=l;if(this.ke[y]){var p=this.ke[Ha]();b=p.transform;c.executeSql(p.tk,p.Pj,g,d)}else p=a,null!=b&&null!=a&&(p=b(a)),this.ba[vb](p)},this);0==this.Ig?this.i.readTransaction(g,c):this.i[fb](g,c);return this.ba.ga};
function S(a,b,c){this.i=c;this.m=a;this.Ma=b}I("lf.backstore.WebSqlRawBackStore",S,void 0);S[z].zd=G("i");S[z].getRawDBInstance=S[z].zd;S[z].Ad=function(){throw new P("NotSupportedError","Use the raw instance to create transaction instead.");};S[z].getRawTransaction=S[z].Ad;S[z].md=function(){return new Qe(this.i,new Pd(this.m,[]),1)};S[z].Dc=function(a){var b=this.md();b.Ja("DROP TABLE "+a,[]);return b.U()};S[z].dropTable=S[z].Dc;
S[z].ec=function(a){var b=this.md();b.Ja("SELECT id, value FROM "+a,[]);return b.U()[A](function(a){for(var b=a[hb][y],g=e(b),h=0;h<b;++h)g[h]={id:a[hb][mb](h).id,value:JSON.parse(a[hb][mb](h)[x])};return Qc(g)})};S[z].Ze=function(a,b){var c=this.md(),d="UPDATE "+a+" SET value=? WHERE id=?";return this.ec(a)[A](function(a){a[n](function(a){a=b(a);c.Ja(d,[JSON.stringify(a[x]),a.id])});return c.U()})};S[z].uc=function(a,b,c){var d=Ie(c);return this.Ze(a,function(a){a[x][b]=d;return a})};
S[z].addTableColumn=S[z].uc;S[z].Ec=function(a,b){return this.Ze(a,function(a){delete a[x][b];return a})};S[z].dropTableColumn=S[z].Ec;S[z].Wc=function(a,b,c){return this.Ze(a,function(a){a[x][c]=a[x][b];delete a[x][b];return a})};S[z].renameTableColumn=S[z].Wc;S[z].wb=function(a){var b={},c;for(c in a)b[c]=Ie(a[c]);return bd(b)};S[z].createRow=S[z].wb;S[z].Mc=G("Ma");S[z].getVersion=S[z].Mc;
...
function Se(a,b,c){this.m=a;this.A=b;this.pk=c||4194304}H=Se[z];H.sd=function(){return new Pd(this.m,[])};H.Ba=function(a){if(null==aa.openDatabase)throw new P("NotSupportedError","WebSql not supported by platform.");var b=a||function(){return Qc()};return new M(J(function(a,d){try{var g=aa.openDatabase(this.A[rb](),"",this.A[rb](),this.pk);if(null!=g)this.i=g,this.Ch(b)[A](a,d);else throw new P("NotSupportedError","Unable to open database.");}catch(h){d(h)}},this))};
H.Ch=function(a){var b=Uc(),c=new Qe(this.i,this.sd(),1);c.Ja("CREATE TABLE IF NOT EXISTS __lf_ver(id INTEGER PRIMARY KEY, v INTEGER)",[]);c.Ja("SELECT v FROM __lf_ver WHERE id = 0",[]);c.U()[A](J(function(c){var g=0;c[hb][y]&&(g=c[hb][mb](0).v);g<this.A[Fa]()?this.Oe(a,g)[A](b[vb][q](b)):g>this.A[Fa]()?b[jb](new P("DataError","Attempt to open a newer database with old code")):b[vb]()},this));return b.ga};
H.Fb=function(a,b){if(null!=this.i)return new Qe(this.i,b,a);throw new P("DataError","Attempt to create transaction from uninitialized DB");};ra(H,Bb());H.Kc=function(){throw new P("SyntaxError","WebSQL tables needs to be acquired from transactions");};H.cg=function(){throw new P("NotSupportedError","WebSQL does not support change notification");};ya(H,function(){this.cg()});H.Sc=function(){this.cg()};
H.Oe=function(a,b){var c=Uc();this.Sj()[A](J(function(){a(new S(this.m,b,this.i))[A](J(function(){return this.Ve()},this))[A](c[vb][q](c))},this),c[jb][q](c));return c.ga};
H.Sj=function(){var a=this.A.gb(),b=new Qe(this.i,this.sd(),1),c=new Qe(this.i,this.sd(),1);b.Ja("INSERT OR REPLACE INTO __lf_ver VALUES (0, ?)",[this.A[Fa]()]);Re(b);return b.U()[A](function(b){b[Ea](function(a){return-1!=a[ob](".")})[n](function(a){c.Ja("DROP TABLE "+a,[])});var g=b[Ea](function(a){return-1==a[ob](".")});a.map(function(a){return a[k]()})[Ea](function(a){return-1==g[ob](a)})[n](function(a){c.Ja("CREATE TABLE "+a+"(id INTEGER PRIMARY KEY, value TEXT)",[])});return c.U()})};
H.Ve=function(){var a=0,b=Uc(),c=J(function(b){var c=new Qe(this.i,this.sd(),0);c.Ja("SELECT MAX(id) FROM "+b,[]);return c.U()[A](function(b){b=b[hb][mb](0)[0];a=ea.max(b,a)})},this),d=this.A.gb().map(function(a){return c(a[k]())});Sc(d)[A](function(){b[vb](a)},function(a){b[jb](a)});return b.ga};
...
function Ye(){this.g=new Ue;this.Eg=new Ue}H=Ye[z];H.Bd=function(a){var b=this.Eg.get(a);Fb(b)||(b=new We,this.Eg.set(a,b));return b};H.set=function(a,b){var c=this.Bd(a);b[n](J(function(a){this.g.set(a.id(),a);c.add(a.id())},this))};H.get=function(a){return a.map(J(function(a){return this.g.get(a)||null},this))};
...
function $e(a,b,c,d){this.B=a;this.L=b;this.af=c;if(d){a=511;a*=a*a;if(d[y]>=a)throw new P("TooManyRowsError","B-Tree implementation supports at most "+a+" rows.");d=af(this,d);this.sa=d=bf(d)}else this[Pa]()}var cf=[];H=$e[z];ia(H,G("B"));f(H,function(){return this.sa[r]()});H.add=function(a,b){this.sa=this.sa.sb(a,b)};H.set=function(a,b){this.sa=this.sa.sb(a,b,!0)};ja(H,function(a,b){this.sa=this.sa[m](a,b)});H.get=function(a){return this.sa.get(a)};
H.ld=function(a){return null!=a?this.Va([a])[y]:this.Va()[y]};H.Va=function(a,b,c,d){var g=this.sa.vd().b[0];if(!Fb(g)||0==c)return cf;var h=(c||0)+(d||0),h=0<h&&!b?h:Number.POSITIVE_INFINITY,l=[];(Fb(a)?this.L.Bg(a):[this.L.re()])[n](function(a){for(var b=this.L.Qd(a),b=this.L.Fe(a)?g:b[0],b=this.sa.Bf(b),c=0;null!=b&&l[y]<h;)0!=b.Va(a,l)?c=0:c++,b=2==c?null:b[$a]()},this);return Ze(l,b,c,d)};ma(H,function(){this.sa=df(this)});H.s=function(a){return this.sa.s(a)};
H.min=function(){return this.Rc(J(this.L.min,this.L))};H.max=function(){return this.Rc(J(this.L.max,this.L))};H.Rc=function(a){var b=this.sa.vd(),c=this.sa.Gf();if(0==b.b[y]&&0==c.b[y])return[null,null];var d=b.b[0],b=b.S[0],g=c.b[c.b[y]-1],c=c.S[c.b[y]-1];return 1==a(d,g)?[d,this.af?[b]:b]:[g,this.af?[c]:c]};H.Oc=G("af");H.Bc=G("L");H.Ke=function(a,b){return null!=a?-1==this.L[Wa](a,b):!1};H.Na=function(a,b){return null!=a?0==this.L[Wa](a,b):!1};
H.Fa=function(){for(var a=[],b=this.sa.vd();b;)a[v](new Zc(b.va,[b.b,b.S])),b=b.xa;return a};function ef(a,b,c,d){a=new $e(b,a,c);d=ff(d,a);a.sa=d;return a}function gf(a,b){this.va=a;this.X=b;this.lb=0;this.xa=this.tb=this.F=null;this.b=[];this.S=[];this.j=[]}function df(a){return new gf($c++,a)}H=gf[z];H.ea=function(){return 0==this.lb};H.Tf=function(){return null==this.F};qa(H,G("xa"));
function hf(a){function b(a){return null!=a?a.va[r]():"_"}var c=a.va+"["+a.b[F]("|")+"]",d=a.j.map(function(a){return a.va})[F]("|"),g=a.S[F]("/"),h=b(a.tb)+"{",h=a.ea()?h+g:h+d,h=h+"}"+b(a.F);a.xa&&(a=hf(a.xa),c=c+"  "+a[0],h=h+"  "+a[1]);return[c,h]}f(H,function(){var a="",b=hf(this),a=a+(b[0]+"\n"+b[1]+"\n");this.j[y]&&(a+=this.j[0][r]());return a});H.vd=function(){return this.ea()?this:this.j[0].vd()};H.Gf=function(){return this.ea()?this:this.j[this.j[y]-1].Gf()};
function jf(a,b){b&&(b.tb=a);a&&(a.xa=b)}function af(a,b){for(var c=b[y],d=0,g=df(a),h=g;0<c;){var l=768<=c?511:257<=c&&511>=c?c:257,p=b[w](d,d+l);g.b=p.map(function(a){return a.key});g.S=p.map(function(a){return a[x]});d+=l;c-=l;0<c&&(l=df(g.X),jf(g,l),g=l)}return h}function kf(a){var b=a[0],c=df(b.X);c.lb=b.lb+1;c.j=a;for(b=0;b<a[y];++b)a[b].F=c,0<b&&c.b[v](a[b].b[0]);return c}
function bf(a){var b=a,c=[];do c[v](b),b=b.xa;while(b);if(512>=c[y])b=kf(c);else{var d=c[y],g=0,b=df(a.X);for(b.lb=a.lb+2;0<d;){a=768<=d?511:257<=d&&511>=d?d:257;var h=c[w](g,g+a),l=kf(h);l.F=b;b.j[y]&&(b.b[v](h[0].b[0]),jf(b.j[b.j[y]-1],l));b.j[v](l);g+=a;d-=a}}return b}H.get=function(a){var b=this.Yc(a);if(this.ea()){var c=cf;this.X.Na(this.b[b],a)&&(c=c[Ka](this.S[b]));return c}b=this.X.Na(this.b[b],a)?b+1:b;return this.j[b].get(a)};
H.s=function(a){var b=this.Yc(a);return this.X.Na(this.b[b],a)?!0:this.ea()?!1:this.j[b].s(a)};ja(H,function(a,b){this.wf(a,-1,b);if(this.Tf()){var c=this;1==this.j[y]&&(c=this.j[0],c.F=null);return c}return this});function mf(a){return a.ea()?a.b[0]:mf(a.j[0])}H.od=function(){this.b=[];for(var a=1;a<this.j[y];++a)this.b[v](mf(this.j[a]))};
H.wf=function(a,b,c){var d=this.Yc(a);if(!this.ea()){var g=this.X.Na(this.b[d],a)?d+1:d;if(this.j[g].wf(a,g,c))this.od();else return!1}else if(!this.X.Na(this.b[d],a))return!1;if(this.b[y]>d&&this.X.Na(this.b[d],a)){if(Fb(c)&&!this.X.Oc()&&this.ea()&&(a=this.S[d],c=nc(a,oc,!1,c),0<=c&&hc(a,c),this.S[d][y]))return!1;this.b[E](d,1);this.ea()&&this.S[E](d,1)}256>this.b[y]&&!this.Tf()&&(this.uk()||this.Gj(b));return!0};
H.uk=function(){var a=null,b,c,d;if(this.xa&&256<this.xa.b[y])a=this.xa,c=b=0,d=this.b[y]+1;else if(this.tb&&256<this.tb.b[y])a=this.tb,b=this.tb.b[y]-1,c=this.ea()?b:b+1,d=0;else return!1;this.b[E](d,0,a.b[b]);a.b[E](b,1);b=this.ea()?this.S:this.j;var g=null;this.ea()?g=a.S:(g=a.j,g[c].F=this);b[E](d,0,g[c]);g[E](c,1);a.ea()||(a.od(),this.od());return!0};
H.Gj=function(a){var b,c,d;this.xa&&511>this.xa.b[y]?(b=this.xa,d=c=0):this.tb&&(b=this.tb,c=b.b[y],d=b.ea()?b.S[y]:b.j[y]);c=[c,0][Ka](this.b);e[z][E][ib](b.b,c);c=null;this.ea()?c=this.S:(c=this.j,c[n](function(a){a.F=b}));c=[d,0][Ka](c);e[z][E][ib](b.ea()?b.S:b.j,c);jf(this.tb,this.xa);b.ea()||b.od();-1!=a&&(this.F.b[E](a,1),this.F.j[E](a,1))};
H.sb=function(a,b,c){var d=this.Yc(a);if(this.ea()){if(this.X.Na(this.b[d],a)){if(c)return this.S[d]=this.X.Oc()?b:[b],this;if(this.X.Oc())throw new P("ConstraintError","Duplicate key not allowed");if(this.S[d])return pc(this.S[d],b),this;this.S[d]=[b]}this.b[E](d,0,a);this.S[E](d,0,this.X.Oc()?b:[b]);return 512==this.b[y]?this.rk():this}d=this.X.Na(this.b[d],a)?d+1:d;a=this.j[d].sb(a,b,c);a.ea()||1!=a.b[y]||(this.b[E](d,0,a.b[0]),a.j[1].F=this,a.j[0].F=this,this.j[E](d,1,a.j[1]),this.j[E](d,0,a.j[0]));
return 512==this.b[y]?this.qk():this};H.rk=function(){var a=df(this.X),b=df(this.X);b.lb=1;b.b=[this.b[256]];b.j=[this,a];b.F=this.F;this.F=b;a.b=this.b[E](256);a.S=this.S[E](256);a.F=b;jf(a,this.xa);jf(this,a);return b};H.qk=function(){var a=df(this.X),b=df(this.X);a.F=this.F;a.lb=this.lb+1;a.b=[this.b[256]];a.j=[this,b];this.b[E](256,1);b.F=a;b.lb=this.lb;b.b=this.b[E](256);b.j=this.j[E](257);b.j[n](function(a){a.F=b});this.F=a;jf(b,this.xa);jf(this,b);return a};
H.Yc=function(a){for(var b=0,c=this.b[y];b<c;){var d=b+c>>1;this.X.Ke(this.b[d],a)?b=d+1:c=d}return b};H.Bf=function(a){if(!this.ea()){var b=this.Yc(a);this.X.Na(this.b[b],a)&&b++;return this.j[b].Bf(a)}return this};
H.Va=function(a,b){var c=-1,d=this.b[y]-1,g=this.X.Bc(),h=J(function(b){for(;b<this.b[y];++b){var h=g.kc(this.b[b],a);if(-1!=c){if(!h){d=b-1;break}}else h&&(c=b)}},this);g.kc(this.b[0],a)?c=0:h(1);if(-1==c)return 0;g.kc(this.b[d],a)||h(c);return d==this.b[y]-1?this.jf(b,this.S[w](c)):d>=c?this.jf(b,this.S[w](c,d+1)):0};H.jf=function(a,b){var c=this.X.Oc()?b:rc(b);a[v][ib](a,c);return c[y]};
...
function nf(a){if(1==a.h[y])return new of(a.h[0].mb);a=a.h.map(function(a){return a.mb});return new pf(a)}function of(a){this.hd=0==a?qf:rf;this.Le=0==a?function(a){return null!=a?a.reverse():null}:function(a){return a||null};this.gg=0==a?sf:tf}K(of,Ld);function rf(a,b){return a>b?1:a<b?-1:0}function qf(a,b){return rf(b,a)}function tf(a,b){return Ud(a,b)}function sf(a,b){return Ud(b,a)}H=of[z];
H.le=function(a,b){var c=this.Le(b),d=[null===c.f,null===c.u];if(!d[0]){var g=this.hd(a,c.f);d[0]=c.$?1==g:-1!=g}d[1]||(g=this.hd(a,c.u),d[1]=c.fa?-1==g:1!=g);return d};H.compare=function(a,b){return this.hd(a,b)};H.min=function(a,b){return a<b?1:a==b?0:-1};H.max=function(a,b){return a>b?1:a==b?0:-1};H.kc=function(a,b){var c=this.le(a,b);return c[0]&&c[1]};H.re=function(){return Td()};H.fg=function(a,b){return this.gg(a,b)};
H.Bg=function(a){return a[Ea](function(a){return null!==a})[xb](J(function(a,c){return this.gg(a,c)},this))};H.Fe=function(a){return Jb(this.Le(a).f)};H.Qd=function(a){a=this.Le(a);return[a.f,a.u]};f(H,function(){return this.hd==qf?"SimpleComparator_DESC":"SimpleComparator_ASC"});function pf(a){this.za=a.map(function(a){return new of(a)})}K(pf,Ld);H=pf[z];H.qe=function(a,b,c){for(var d=0,g=0;g<this.za[y]&&0==d;++g)d=c(this.za[g],a[g],b[g]);return d};
...
H.Bg=function(a){var b=a[Ea](function(a){return a[yb](Kb)});a=e(this.za[y]);for(var c=0;c<a[y];c++)a[c]=b.map(function(a){return a[c]});a[n](function(a,b){a[xb](J(function(a,c){return this.za[b].fg(a,c)},this))},this);b=e(b[y]);for(c=0;c<b[y];c++)b[c]=a.map(function(a){return a[c]});return b[xb](J(function(a,b){for(var c=0,l=0;l<this.za[y]&&0==c;++l)c=this.za[l].fg(a[l],b[l]);return c},this))};H.Fe=function(a){return this.za[0].Fe(a[0])};
...
function xf(a){this.m=a;this.vb=a.o(ud);this.N=a.o(wd);this.pa=a.o(vd)}H=xf[z];H.Ba=function(a){var b=a.gb(),c=J(function(){if(0==b[y])return Qc();var a=b[Ha]();return(a.Rb()?this.mi(a):this.ni(a))[A](c)},this);return c()};H.ni=function(a){var b=new Pd(this.m,[a]);return this.vb.Fb(0,b).Y(a[k](),J(a.dc,a)).get([])[A](J(function(b){this.pa.set(a[k](),b);this.Zj(a,b)},this))};H.Zj=function(a,b){var c=this.N.aj(a[k]());b[n](function(a){c[n](function(b){var c=a.Pc(b[k]());b.add(c,a.id())})})};
H.mi=function(a){var b=new Pd(this.m,[a]),c=this.vb.Fb(0,b),b=c.Y(a[k](),a.dc).get([])[A](J(function(b){this.pa.set(a[k](),b)},this)),d=a.Ga().map(function(a){return this.$j(a,c)},this)[Ka](this.ak(a,c));return Sc(d[Ka](b))};
H.$j=function(a,b){var c=b.Y(a.l(),ad,1),d=nf(a);return c.get([])[A](J(function(b){L("btree"==b[0].w().type);if(1<b[y]){if(a.Lf()){var c=ef[q](void 0,d,a.l(),a.Fd),l=b[w](1),p=-1;for(b=0;b<l[y];++b)if(-2==l[b].id()){p=b;break}if(-1==p)throw new P("DataError","Data corruption detected");b=l[p].w();l=l[w](0);l[E](p,1);c=c(l);c=new uf(c);c.Za[lb](b)}else c=ef(d,a.l(),a.Fd,b[w](1));this.N.set(c)}},this))};
H.ak=function(a,b){return b.Y(a.Ib(),ad,1).get([])[A](J(function(b){L("rowid"==b[0].w().type);1<b[y]&&(b=wf(a.Ib(),b[w](1)),this.N.set(b))},this))};


function yf(){this.O=new N}yf[z].Ba=function(a){a.gb()[n](function(a){var c=a.Ib();if(null===this.get(c)){var d=new vf(c);this.O.set(c,d)}a.Ga()[n](function(a){this.O.set(a.l(),zf(a))},this)},this);return Qc()};function zf(a){var b=nf(a),b=new $e(a.l(),b,a.Fd);return a.Lf()?new uf(b):b}yf[z].get=function(a){return this.O.get(a,null)};yf[z].set=function(a){return this.O.set(a[k](),a)};yf[z].aj=function(a){var b=[],c=a+".";this.O.G()[n](function(a){0==a[ob](c)&&b[v](this.O.get(a))},this);return b};
...
H.add=function(a){if(0!=a[y])if(a=this.$a[Ka](a),1==a[y])this.$a=a;else{a[xb](Ud);for(var b=[],c=a[0],d=1;d<a[y];++d)if(c.hg(a[d])){var g=a[d],h=Td();if(null!==c.f&&null!==g.f){var l=Sd(c.f,g.f,!0);1!=l?(h.f=c.f,h.$=0!=l?c.$:c.$&&g.$):(h.f=g.f,h.$=g.$)}null!==c.u&&null!==g.u&&(l=Sd(c.u,g.u,!1),-1!=l?(h.u=c.u,h.fa=0!=l?c.fa:c.fa&&g.fa):(h.u=g.u,h.fa=g.fa));c=h}else b[v](c),c=a[d];b[v](c);this.$a=b}};
H.Fc=function(a){return this.$a[y]==a.$a[y]?0==this.$a[y]||this.$a[yb](function(b,c){return b.Fc(a.$a[c])}):!1};function Bf(a,b){var c=[];a.c().map(function(a){return b.c().map(function(b){var c;if(a.hg(b)){c=Td();var l=Sd(a.f,b.f,!0),l=0==l?a.$?a:b:-1!=l?a:b;c.f=l.f;c.$=l.$;null===a.u||null===b.u?b=null===a.u?b:a:(l=Sd(a.u,b.u,!1),b=0==l?a.fa?a:b:-1==l?a:b);c.u=b.u;c.fa=b.fa}else c=null;return c})})[n](function(a){c=c[Ka](a)});return new Af(c[Ea](function(a){return null!==a}))};
function Cf(a,b){var c=[],d=null,g=null;a.qc(function(a){var l=b(a);null==a[Ga]()?g=l:d.ia(l);var p=a[Ga]();null!==p&&p.ua()==d.ua()&&(p=c[ob](d),-1!=p&&c[E](p,1));1<a.ua()&&c[v](l);d=a.Qf()?c[c[y]-1]:l});return g}function Df(a){return Ef(a,function(a){return a.Qf()})}function Ff(a){var b=a[Ga](),c=0;null!==b&&(c=b.aa()[ob](a),b[sb](a));var d=a.aa()[w]();d[n](function(d,h){a[sb](d);null===b||b.tc(d,c+h)});return{parent:b,children:d}}
function Gf(a,b){a.aa()[w]()[n](function(c){a[sb](c);b.ia(c)});a.ia(b)}function Hf(a){L(1==a.ua());var b=a.pb(0);L(1==b.ua());Ff(a);Gf(b,a);return b}function If(a,b,c){L(1==a.ua());var d=a.pb(0);L(1<d.ua());var g=d.aa()[w]();if(!g[wb](function(a){return b(a)}))return a;Ff(a);g[n](function(g,l){if(b(g)){var p=c(a);d.Sd(l);p.ia(g);d.tc(p,l)}});return d}function Jf(a,b,c,d){var g=a[Ga]();null!==g&&(a=g.aa()[ob](a),g.Sd(a),g.tc(c,a));b.aa()[w]()[n](function(a){b[sb](a);d.ia(a)});return c}
function Ef(a,b,c){function d(a){b(a)&&g[v](a);null!=c&&c(a)||a.aa()[n](d)}var g=[];d(a);return g}function Kf(a,b){var c=b||function(a){return a[r]()+"\n"},d="";a.qc(function(a){for(var b=0;b<a.Li();b++)d+="-";d+=c(a)});return d};

function Lf(a){pe[D](this);this.Ob=a;this.Xa=!1}K(Lf,pe);H=Lf[z];H.Eb=function(){return Cf(this,function(a){if(a instanceof Lf){var b=new Lf(a.Ob);b.Xa=a.Xa;b.Xe(a.ka());return b}return a.Eb()}[q](this))};H.xb=function(a){var b=a||[];this.qc(function(a){a!=this&&a.xb(b)}[q](this));return(new O(b)).c()};H.Vd=function(a){this.Xa!=a&&(this.Xa=a,this.Ob="and"==this.Ob?"or":"and",this.aa()[n](function(b){return b.Vd(a)}))};H.eval=function(a){var b=this.aa().map(function(b){return b.eval(a)});return this.Fh(b)};
H.Fh=function(a){return"and"==this.Ob?Zd(a):$d(a)};f(H,function(){return"combined_pred_"+this.Ob[r]()});function Mf(a,b){return a===b?0!==a||1/a===1/b:a!==a&&b!==b};function Nf(){this[Pa]()}var Of=ba[z][Ua],Pf=ba[z][bb];H=Nf[z];H.set=function(a,b){this.ad(a);var c=!this.Nc(a);this.g[a]=b;if("__proto__"==a||!Qf&&!Of[D](this.g,a)){delete this.g[a];var d=bc(this.Bb,a);if(c=0>d)d=this.Bb[y];this.Bb[d]=a;this.Td[d]=b}c&&this.Z++};H.get=function(a,b){this.ad(a);if(this.Nc(a))return this.g[a];var c=bc(this.Bb,a);return 0<=c?this.Td[c]:b};
ja(H,function(a){this.ad(a);if(this.Nc(a))return this.Z--,delete this.g[a],!0;a=bc(this.Bb,a);return 0<=a?(this.Z--,hc(this.Bb,a),hc(this.Td,a),!0):!1});H.addAll=function(a){cc(a.G(),function(b){this.set(b,a.get(b))},this)};H.Ha=function(){return!this.Z};H.na=G("Z");H.s=function(a){this.ad(a);return this.Nc(a)||0<=bc(this.Bb,a)};H.kd=function(a){return tc(this.g,function(b,c){return this.Nc(c)&&Mf(b,a)},this)||0<=bc(this.Td,a)};
H.G=function(){var a;if(Rf)a=jc(ba.keys(this.g));else{a=[];for(var b in this.g)Pf[D](this.g,b)&&a[v](b)}kc(a,this.Bb);return a};H.c=function(){for(var a=[],b=this.G(),c=0;c<b[y];c++)a[v](this.get(b[c]));return a};H.getEntries=function(){for(var a=[],b=this.G(),c=0;c<b[y];c++){var d=b[c];a[v]([d,this.get(d)])}return a};ma(H,function(){this.g=Qf?ba[Va](null):{};this.Bb=[];this.Td=[];this.Z=0});sa(H,function(){var a=new Nf;a[lb](this);return a});
H.Nc=function(a){return"__proto__"==a?!1:Qf?a in this.g:Pf[D](this.g,a)};H.ad=function(a){L(Mb(a),"key must be a string.")};var Qf=!!ba[Va],Rf=!!ba.keys;function Sf(){this[Pa]()}H=Sf[z];H.Z=0;ma(H,function(){this.Z=0;this.g=new Nf});sa(H,function(){var a=new Sf;a.Tg(this);return a});H.add=function(a,b){var c=this.g.get(a);c||this.g.set(a,c=[]);c[v](b);this.Z++};H.Tg=function(a){cc(a.getEntries(),function(a){this.add(a[0],a[1])},this)};H.get=function(a){return(a=this.g.get(a))?jc(a):[]};ja(H,function(a,b){var c=this.g.get(a);if(!c)return!1;var d=ic(c,function(a){return Mf(b,a)});d&&(this.Z--,0==c[y]&&this.g[m](a));return d});H.Ha=function(){return!this.Z};
H.na=G("Z");H.s=function(a){return this.g.s(a)};H.kd=function(a){return fc(this.g.c(),function(b){return fc(b,function(b){return Mf(b,a)})})};H.G=function(){return this.g.G()};H.c=function(){return rc(this.g.c())};H.getEntries=function(){for(var a=this.G(),b=[],c=0;c<a[y];c++)for(var d=a[c],g=this.get(d),h=0;h<g[y];h++)b[v]([d,g[h]]);return b};
...
H.kf=function(a){return-1!=a.W()[ob](this.Oa.Y().Aa())};H.ah=function(a){return-1!=a.W()[ob](this.bb.Y().Aa())};H.Th=function(a,b){var c=null,d=null;this.kf(a)?(this.nf(a,b),c=a,d=b):(this.nf(b,a),c=b,d=a);return[c,d]};H.nf=function(a,b){L(this.kf(a),"Mismatch between join predicate left operand and right relation.");L(this.ah(b),"Mismatch between join predicate right operand and right relation.")};H.$h=function(a,b){var c=this.Th(a,b),d=c[0],c=c[1];return"eq"==this.V?this.ai(d,c):this.bi(d,c)};
...
function T(a,b){ta(this,a);this.Zb=b;this.ib=null}H=T[z];ia(H,function(){return this.Zb+"("+this[gb][k]()+")"});H.l=function(){return this.Zb+"("+this[gb].l()+")"};H.Y=function(){return this[gb].Y()};f(H,function(){return this.l()});H.da=function(){return this[gb].da()};H.Ua=G("ib");H.Ga=function(){return[]};H.lc=Db(!1);H.wc=function(a){this.ib=a;return this};T[z].as=T[z].wc;T[z].Af=function(){for(var a=[this],b=this;b instanceof T;)a[v](b[gb]),b=b[gb];return a};
function Yf(a){this.ib=a||null;this.D=new Xf("#UnknownTable",[],[],!1)}H=Yf[z];ia(H,Db("*"));H.l=function(){return this[k]()};f(H,function(){return this.l()});H.Y=G("D");H.da=Db(4);H.Ua=G("ib");H.Ga=function(){return[]};H.lc=Db(!1);
...
function U(a,b){ne[D](this,"","");this.ji=b;this.dg=a}K(U,ne);H=U[z];H.ca=Db(null);ha(H,function(a,b){switch(this.ji){case 1:return this.ei(a,b);case 0:return this.di(a,b);default:return this.gi(a,b)}});f(H,Db("dummy_node"));H.Zc=function(){return this[r]()};H.lf=function(a){L(-1==this.dg||a[y]==this.dg)};H.gi=function(a,b){return new M(J(function(c){c(this.ja(a,[],b))},this))};H.ei=function(a,b){return this.pb(0)[Ia](a,b)[A](J(function(c){this.lf(c);return this.ja(a,c,b)},this))};
H.di=function(a,b){var c=this.aa().map(function(c){return c[Ia](a,b)});return Sc(c)[A](J(function(c){var g=[];c[n](function(a){for(var b=0;b<a[y];++b)g[v](a[b])});this.lf(g);return this.ja(a,g,b)},this))};
function $f(a){U[D](this,-1,1);this.gf=a}K($f,U);f($f[z],function(){return"aggregation("+this.gf.map(function(a){return a.l()})[r]()+")"});$f[z].ja=function(a,b){b[n](function(a){(new ag(a,this.gf)).oh()},this);return b};function ag(a,b){this.Da=a;this.H=b}
ag[z].oh=function(){this.H[n](function(a){a=a.Af().reverse();for(var b=1;b<a[y];b++){var c=a[b],d=c.Af()[w](-1)[0],g=this.Oi(c),h=null;switch(c.Zb){case "MIN":h=bg(g,d);break;case "MAX":h=cg(g,d);break;case "DISTINCT":h=dg(g,d);break;case "COUNT":h=g[C][y];break;case "SUM":h=eg(g,d);break;case "AVG":0<g[C][y]&&(h=eg(g,d)/g[C][y]);break;case "GEOMEAN":h=fg(g,d);break;default:h=gg(g,d)}this.Da.jk(c,h)}},this)};ag[z].Oi=function(a){return a[gb]instanceof T?this.Da.hc(a[gb]):this.Da};
...
function V(){ne[D](this,"","")}K(V,ne);function hg(a,b){V[D](this);oa(this,a);la(this,b)}K(hg,V);function ig(a,b){hg[D](this,a,b)}K(ig,hg);function jg(a){V[D](this);oa(this,a)}K(jg,V);f(jg[z],function(){return"delete("+this[t][k]()+")"});function kg(a,b){V[D](this);oa(this,a);this.bf=b}K(kg,V);f(kg[z],function(){var a=[];this.bf&&(a=this.bf.map(function(a){return a.K[k]()},this));return"update("+this[t][k]()+", ["+a[F](",")+"])"});function lg(a){V[D](this);this.Ca=a}K(lg,V);
...
function vg(){};
function wg(){}K(wg,vg);wg[z].zb=function(a){this.ha=a;this.Ta(this.ha);return this.ha};wg[z].Ta=function(a){if(a instanceof lg){L(1==a.ua(),"SelectNode must have exactly one child.");var b=this.pf(a.Ca),b=this.Nh(b);Jf(a,a,b[0],b[1]);a==this.ha&&(this.ha=b[0]);a=b[0]}a.aa()[n](function(a){this.Ta(a)},this)};wg[z].pf=function(a){if(0==a.ua()||"and"!=a.Ob)return[a];var b=a.aa()[w]().map(function(b){a[sb](b);return this.pf(b)},this);return rc(b)};
wg[z].Nh=function(a){var b=null,c=null;a.map(function(a,g){var h=new lg(a);0==g?b=h:c.ia(h);c=h},this);return[b,c]};
function xg(){}K(xg,vg);xg[z].zb=function(a){this.ha=a;this.Ta(this.ha);return this.ha};xg[z].Ta=function(a){if(a instanceof ng)for(;2<a.ua();){for(var b=new ng,c=0;2>c;c++){var d=a.Sd(0);b.ia(d)}a.tc(b,0)}a.aa()[n](function(a){this.Ta(a)},this)};
...
function Hg(a,b){return a.aa().map(function(a){return"("+Ig(a,b)+")"})[F]("and"==a.Ob?" AND ":" OR ")}function Ig(a,b){if(a instanceof re)return[a.K.l(),Fg(a.V),Gg(a[x],a.V,a.K.da(),b)][F](" ");if(a instanceof Lf)return Hg(a,b);if(a instanceof Tf)return[a.Oa.l(),Fg(a.V),a.bb.l()][F](" ");throw new P("NotSupportedError","toSql does not support predicate type: "+typeof a);}function Jg(a,b){var c=Ig(a,b);return c?" WHERE "+c:""}
function Kg(a,b){var c="UPDATE "+a[t][k]()+" SET ",c=c+a.set.map(function(a){var b=a.K.l()+" = ";return-1!=a.bd?b+"?"+a.bd[r]():b+Dg(a.K.da(),a[x])[r]()})[F](", ");a.C&&(c+=Jg(a.C,b));return c+";"}
function Lg(a,b){var c="*";a.h[y]&&(c=a.h.map(function(a){return a.Ua()?a.l()+" AS "+a.Ua():a.l()})[F](", "));var d=a.f.map(function(a){return a.Aa()!=a[k]()?a[k]()+" AS "+a.Aa():a[k]()})[F](", "),c="SELECT "+c+" FROM "+d;a.C&&(c+=Jg(a.C,b));a.J&&(d=a.J.map(function(a){return a.K.l()+(0==a.mb?" DESC":" ASC")})[F](", "),c+=" ORDER BY "+d);a.la&&(d=a.la.map(function(a){return a.l()})[F](", "),c+=" GROUP BY "+d);a.oa&&(c+=" LIMIT "+a.oa[r]());a.ma&&(c+=" SKIP "+a.ma[r]());return c+";"}
function Mg(a,b){var c=b||!1,d=a.Ff();if(d instanceof Bg)return Eg(d,c);if(d instanceof Ag){var g="DELETE FROM "+d.f[k]();d.C&&(g+=Jg(d.C,c));return g+";"}if(d instanceof Cg)return Kg(d,c);if(d instanceof ue)return Lg(d,c);throw new P("NotSupportedError","toSql not implemented for "+typeof d);};
function Ng(a,b){this.global=a;this.Xj=a.o(xd);this.Ra=a.o(yd);this.a=b}I("lf.query.BaseBuilder",Ng,void 0);ha(Ng[z],function(){try{this.jb()}catch(a){return Rc(a)}return new M(function(a,c){var d=new zg(this[Ta],[this.Lc()]);this.Ra.Ub(d)[A](function(c){a(c[0].ve())},c)},this)});ha(Ng[z],Ng[z][Ia]);Ng[z].yf=function(){var a=J(function(a){return a.Zc(this.a)+"\n"},this);return Kf(this.we().Hb(),a)};Ng[z].explain=Ng[z].yf;na(Ng[z],function(a){this.a[q](a);return this});na(Ng[z],Ng[z][q]);
Ng[z].xk=function(a){return Mg(this,a)};Ng[z].toSql=Ng[z].xk;H=Ng[z];H.jb=Bb();H.Ff=function(){return this.a.clone()};H.xd=G("a");H.we=function(){null==this.ig&&(this.ig=this.Xj.Ui(this.a));return this.ig};H.Lc=function(){return{context:this.Ff(),Qe:this.we()}};H.Si=function(){return{context:this.xd(),Qe:this.we()}};
function Og(a){Ng[D](this,a,new Ag)}K(Og,Ng);I("lf.query.DeleteBuilder",Og,void 0);Og[z].f=function(a){this.fh();this.a.f=a;return this};Og[z].from=Og[z].f;Og[z].C=function(a){this.ee();this.a.C=a;return this};Og[z].where=Og[z].C;Og[z].fh=function(){if(null!=this.a.f)throw new P("SyntaxError","from() has already been called.");};Og[z].ee=function(){if(null!=this.a.C)throw new P("SyntaxError","where() has already been called.");};
...
H.de=function(a,b){if(null!=a)throw new P("SyntaxError",b+"() has already been called.");};H.mf=function(a,b){if(0>a)throw new P("SyntaxError",b+"() does not accept negative values");};H.f=function(a){if(this.zf)throw new P("SyntaxError","from() has already been called.");this.zf=!0;null==this.a.f&&(this.a.f=[]);this.a.f[v][ib](this.a.f,e[z][w][D](arguments));return this};W[z].from=W[z].f;
W[z].C=function(a){if(this.Rg)throw new P("SyntaxError","where() has already been called.");this.Rg=!0;this.of(a);return this};W[z].where=W[z].C;W[z].of=function(a){null!=this.a.C&&(a=Qg(a,this.a.C));this.a.C=a};W[z].De=function(a,b){null==this.a.f&&(this.a.f=[]);this.a.f[v](a);this.of(b);return this};W[z].innerJoin=W[z].De;W[z].xj=function(){throw new P("NotSupportedError","Not implemented yet");};W[z].leftOuterJoin=W[z].xj;
W[z].oa=function(a){this.de(this.a.oa||this.a.Mb,"limit");a instanceof ee?this.a.Mb=a:(this.mf(a,"limit"),this.a.oa=a);return this};W[z].limit=W[z].oa;W[z].ma=function(a){this.de(this.a.ma||this.a.Xb,"skip");a instanceof ee?this.a.Xb=a:(this.mf(a,"skip"),this.a.ma=a);return this};W[z].skip=W[z].ma;W[z].J=function(a,b){null==this.a.J&&(this.a.J=[]);this.a.J[v]({K:a,mb:null!=b?b:1});return this};W[z].orderBy=W[z].J;
...
function Tg(a,b){Ng[D](this,a,new Cg);oa(this.a,b)}K(Tg,Ng);I("lf.query.UpdateBuilder",Tg,void 0);Tg[z].set=function(a,b){var c={bd:b instanceof ee?b.qb():-1,K:a,value:b};null!=this.a.set?this.a.set[v](c):this.a.set=[c];return this};Tg[z].set=Tg[z].set;Tg[z].C=function(a){this.ee();this.a.C=a;return this};Tg[z].where=Tg[z].C;Tg[z].ee=function(){if(null!=this.a.C)throw new P("SyntaxError","where() has already been called.");};
...
function Ug(a){this.a=a;this.Ea=null}Ug[z].gc=function(){null===this.Ea&&(this.Ea=this.pd());return this.Ea};function Vg(a){Ug[D](this,a)}K(Vg,Ug);Vg[z].pd=function(){return this.a.vc?new ig(this.a.Wa,this.a[Oa]):new hg(this.a.Wa,this.a[Oa])};function Wg(a){Ug[D](this,a)}K(Wg,Ug);Wg[z].pd=function(){var a=new kg(this.a[t],this.a.set),b=null!=this.a.C?new lg(this.a.C.Eb()):null,c=new mg(this.a[t]);null===b?a.ia(c):(b.ia(c),a.ia(b));return a};
function Xg(a,b){this.Ea=a;this.Ue=b}Xg[z].gc=function(){this.Ue[n](function(a){this.Ea=a.zb(this.Ea)},this);return this.Ea};
function Yg(a){Ug[D](this,a)}K(Yg,Ug);Yg[z].pd=function(){var a=new jg(this.a.f),b=null!=this.a.C?new lg(this.a.C.Eb()):null,c=new mg(this.a.f);null===b?a.ia(c):(b.ia(c),a.ia(b));return(new Xg(a,[new wg])).gc()};
function Zg(){}K(Zg,vg);Zg[z].zb=function(a){this.ha=a;this.Ta(this.ha);return this.ha};Zg[z].Ta=function(a){if(a instanceof lg&&a.Ca instanceof Tf){L(1==a.ua(),"SelectNode must have exactly one child.");var b=a.pb(0);if(b instanceof ng){var c=new ug(a.Ca);Jf(a,b,c,c);a==this.ha&&(this.ha=c);a=c}}a.aa()[n](function(a){this.Ta(a)},this)};
function $g(){this.be=new O}K($g,vg);H=$g[z];H.zb=function(a){this.ha=a;this.Ta(this.ha);this.be[Pa]();return this.ha};H.Ta=function(a){if(this.Of(a)){var b=a.Ca instanceof re?this.Vj(a):this.Uj(a);this.be.add(a);b==a&&(b=a.pb(0));null!==b&&(Jb(b[Ga]())&&(this.ha=b),this.Of(b)&&!this.be[u](b)&&this.Ta(b))}else a.aa()[n](function(a){this.Ta(a)},this)};
H.Od=function(a,b){var c=a;if(this.nk(a))c=Hf(a),this.Od(a,b);else if(this.mk(a)){var d=[],c=If(a,b,function(a){a=new lg(a.Ca);d[v](a);return a});d[n](function(a){this.Od(a,b)},this)}return c};H.Vj=function(a){var b=new O([a.Ca.K.Y().Aa()]),c=function(a){return this.xf(a,b)}[q](this);return this.Od(a,c)};H.Uj=function(a){var b=new O([a.Ca.Oa.Y().Aa(),a.Ca.bb.Y().Aa()]),c=function(a){return this.xf(a,b)}[q](this);return this.Od(a,c)};
H.xf=function(a,b){var c=new O;Df(a)[n](function(a){c.add(a[t].Aa())},this);a instanceof mg&&c.add(a[t].Aa());return c.Kh(b)};H.Of=function(a){return a instanceof lg&&!(a.Ca instanceof Lf)};H.mk=function(a){a=a.pb(0);return a instanceof ng||a instanceof ug};H.nk=function(a){return a.pb(0)instanceof lg};
function ah(a){Ug[D](this,a);this.ng=this.Zf=this.Ag=this.eg=this.hf=this.Kf=this.wg=this.uf=this.Cg=null}K(ah,Ug);H=ah[z];H.pd=function(){this.Ci();var a=this.Hh(),b=[new wg,new xg,new $g,new Zg];return(new Xg(a,b)).gc()};H.Ci=function(){this.Ii();this.xi();this.Gi();this.Di();this.Hi();this.Bi();this.zi();this.wi();this.Ei()};
H.Hh=function(){for(var a=[this.Zf,this.Ag,this.ng,this.eg,this.hf,this.Kf,this.wg,this.uf],b=null,c=null,d=0;d<a[y];d++){var g=a[d];null!==g&&(null===c?c=g:a[b].ia(g),b=d)}this.Cg[n](function(c){a[b].ia(c)});return c};H.Ii=function(){this.Cg=this.a.f.map(function(a){return new mg(a)},this)};H.xi=function(){2<=this.a.f[y]&&(this.uf=new ng)};H.Gi=function(){this.wg=null!=this.a.C?new lg(this.a.C.Eb()):null};H.Di=function(){this.a.J&&(this.eg=new pg(this.a.J))};
H.Bi=function(){null!=this.a.oa&&(this.Zf=new sg(this.a.oa))};H.Hi=function(){null!=this.a.ma&&0<this.a.ma&&(this.Ag=new tg(this.a.ma))};H.zi=function(){null!=this.a.la&&(this.Kf=new rg(this.a.la))};H.wi=function(){var a=this.a.h[Ea](function(a){return a instanceof T});null!=this.a.J&&this.a.J[n](function(b){b.K instanceof T&&a[v](b.K)});0<a[y]&&(this.hf=new qg(a))};H.Ei=function(){this.ng=new og(this.a.h||[],this.a.la||null)};
...
function dh(a){U[D](this,1,1);this.D=a}K(dh,U);f(dh[z],function(){return"delete("+this.D[k]()+")"});dh[z].ca=G("D");dh[z].ja=function(a,b){var c=b[0][C].map(function(a){return a.ta});a[m](this.D,c);return[Yd()]};
function eh(a){U[D](this,1,1);this.Jf=a}K(eh,U);f(eh[z],function(){return"groupBy("+this.Jf.map(function(a){return a.l()})[r]()+")"});eh[z].ja=function(a,b){return this.qh(b[0])};eh[z].qh=function(a){var b=new Sf,c=function(a){return this.Jf.map(function(b){return a.M(b)},this)[F](",")}[q](this);a[C][n](function(a){b.add(c(a),a)},this);return b.G().map(function(c){return new Vd(b.get(c),a.W())},this)};
...
function ih(a,b){this.Fg=b;this.N=a.o(wd)}ih[z].Dh=function(a,b){var c=b[Ea](this.rj,this);if(0==c[y])return null;c=this.Ai(c);if(0==c[y])return null;if(1==c[y])return c[0];var d=Number.MAX_VALUE;return c[kb](function(b,c){var l=c.ph(a);return l<d?(d=l,c):b},null)};ih[z].Ai=function(a){return this.Fg.Ga().map(function(b){b=new jh(this.N,b);b.Jh(a);return b},this)[Ea](function(a){return a.wj()})};ih[z].rj=function(a){return a instanceof re&&a.Pf()?a.K.Y()==this.Fg:!1};
function jh(a,b){this.N=a;this.rb=b;this.Mf=new O;this.Mf[lb](this.rb.h.map(function(a){return a.cb[k]()}));this.Je=this.ra=null}H=jh[z];H.Vi=function(){return null===this.ra?[]:this.ra.c()};H.Ef=function(){L(this.ra);null===this.Je&&(this.Je=new hh(this.rb,this.ra));return this.Je};H.Jh=function(a){a[n](function(a){var c=a.xb()[0][k]();this.Mf[u](c)&&(null===this.ra&&(this.ra=new Sf),this.ra.add(c,a.ka()))},this)};
H.wj=function(){if(null===this.ra)return!1;for(var a=!1,b=!0,c=0;c<this.rb.h[y];c++){var d=this.ra.s(this.rb.h[c].cb[k]());if(a&&d){b=!1;break}d||(a=!0)}return b};H.ph=function(a){a=this.Ef().ud(a);var b=this.N.get(this.rb.l());return a[kb](function(a,d){return a+b.ld(d)},0)};
function kh(a,b,c,d){U[D](this,0,-1);this.N=a.o(wd);this.index=b;this.Vf=c;this.Te=d;this.Zd=this.Yd=!1}K(kh,U);f(kh[z],function(){return"index_range_scan("+this[Za].l()+", ?, "+(this.Te?"reverse":"natural")+(this.Yd?", limit:?":"")+(this.Zd?", skip:?":"")+")"});kh[z].Zc=function(a){var b=this[r](),c=this.Vf.ud(a),b=b[Ja]("?",c[r]());this.Yd&&(b=b[Ja]("?",a.oa[r]()));this.Zd&&(b=b[Ja]("?",a.ma[r]()));return b};
kh[z].ja=function(a,b,c){a=this.Vf.ud(c);c=this.N.get(this[Za].l()).Va(a,this.Te,this.Yd?c.oa:void 0,this.Zd?c.ma:void 0).map(function(a){return new Zc(a,{})},this);return[ae(c,[this[Za].Dg])]};
...
function mh(a,b){U[D](this,1,1);this.pa=a.o(vd);this.D=b}K(mh,U);f(mh[z],function(){return"table_access_by_row_id("+this.D[k]()+")"});mh[z].ca=G("D");mh[z].ja=function(a,b){return[ae(this.pa.get(b[0].Zi()),[this.D.Aa()])]};
...
oh[z].fk=function(a,b,c){a.Vi().map(function(a){return b.get(a)})[n](Ff);a=new kh(this.m,a.rb,a.Ef(),!1);var d=new mh(this.m,c[t]);d.ia(a);Jf(c,c,d,a);return a.Hb()};
function ph(a,b){U[D](this,0,-1);this.N=a.o(wd);this.D=b}K(ph,U);f(ph[z],function(){return"insert("+this.D[k]()+")"});ph[z].ca=G("D");ph[z].ja=function(a,b,c){qh(this.D,c[Oa],this.N);a.sb(this.D,c[Oa]);return[ae(c[Oa],[this.D[k]()])]};function qh(a,b,c){a=a.ic().xe();if(null===a?0:a.h[0][Na]){var d=a.h[0].cb[k](),g=c.get(a.l()).max()[0]||0;b[n](function(a){if(0==a.w()[d]||null==a.w()[d])g++,a.w()[d]=g})}}function rh(a,b){U[D](this,0,-1);this.N=a.o(wd);this.D=b}K(rh,U);
f(rh[z],function(){return"insert_replace("+this.D[k]()+")"});rh[z].ca=G("D");rh[z].ja=function(a,b,c){qh(this.D,c[Oa],this.N);a.Ee(this.D,c[Oa]);return[ae(c[Oa],[this.D[k]()])]};
function sh(a){U[D](this,2,0);this.mg=a}K(sh,U);f(sh[z],function(){return"join("+this.mg[r]()+")"});sh[z].ja=function(a,b){return[this.mg.$h(b[0],b[1])]};
...
function vh(a,b){this.Da=a;this.H=b}vh[z].If=function(){return this.H[wb](function(a){return a instanceof T},this)?this.ij():this.jj()};
...
function Ah(a){this.m=a}K(Ah,vg);Ah[z].zb=function(a){var b=Bh(a);if(null===b)return a;a=this.eh(b);a==b&&(a=this.dh(b));return a.Hb()};Ah[z].eh=function(a){var b=a,c=Ch(a.pb(0));if(null!==c){var d;d=a.J;for(var g=null,h=c[t].Ga(),l=0;l<h[y]&&null===g;l++)g=Dh(h[l],d);d=g;if(null===d)return b;b=new kh(this.m,d.rb,new gh(d.rb),d.Sf);d=new mh(this.m,c[t]);d.ia(b);Ff(a);b=Jf(c,c,d,b)}return b};
Ah[z].dh=function(a){var b=a,c=Eh(a.pb(0));if(null!==c){var d=Dh(c[Za],a.J);if(null===d)return b;c.Te=d.Sf;b=Ff(a).parent}return b};function Eh(a){a=Ef(a,function(a){return a instanceof kh},function(a){return 1!=a.ua()});return 0<a[y]?a[0]:null}function Ch(a){a=Ef(a,function(a){return a instanceof nh},function(a){return 1!=a.ua()});return 0<a[y]?a[0]:null}function Bh(a){a=Ef(a,function(a){return a instanceof uh});return 0<a[y]?a[0]:null}
function Dh(a,b){if(a.h[y]!=b[y]||!b[yb](function(b,c){return b.K[k]()==a.h[c].cb[k]()}))return null;var c=Fh(b,a);return c[0]||c[1]?{rb:a,Sf:c[1]}:null}function Fh(a,b){var c=a[kb](function(a,b){return a<<1|(0==b.mb?0:1)},0),d=b.h[kb](function(a,b){return a<<1|(0==b.mb?0:1)},0),d=c^d,c=0==d,d=d==ea.pow(2,ea.max(a[y],b.h[y]))-1;return[c,d]};
...
function Hh(a,b){U[D](this,1,1);this.D=a;this.Dk=b}K(Hh,U);f(Hh[z],function(){return"update("+this.D[k]()+")"});Hh[z].ca=G("D");Hh[z].ja=function(a,b){var c=b[0][C].map(function(a){var b=this.D.dc(a.ta.Fa());this.Dk[n](function(a){b.w()[a.K[k]()]=a[x]},this);return b},this);a[zb](this.D,c);return[Yd()]};
...
Ih[z].Bj=function(a){if(a instanceof og)return new xh(a.h,a.Kb);if(a instanceof rg)return new eh(a.h);if(a instanceof qg)return new $f(a.h);if(a instanceof pg)return new uh(a.J);if(a instanceof tg)return new yh;if(a instanceof sg)return new th;if(a instanceof lg)return new lh(a.Ca.ka());if(a instanceof ng)return new yg;if(a instanceof ug)return new sh(a.Ca);if(a instanceof mg)return new nh(this.m,a[t]);if(a instanceof jg)return new dh(a[t]);if(a instanceof kg)return new Hh(a[t],a.bf);if(a instanceof
...
function Kh(){this.ag=new N}H=Kh[z];H.td=function(a){var b=this.ag.get(a[k](),null);null===b&&(b=new Lh,this.ag.set(a[k](),b));return b};H.fj=function(a,b,c){b[n](function(b){this.td(b).ej(a,c)},this)};H.th=function(a,b,c){return b[yb](function(b){return this.td(b).sh(a,c)},this)};H.qg=function(a,b,c){var d=this.th(a,b,c);d&&this.fj(a,b,c);return d};H.Rd=function(a,b){b[n](function(b){this.td(b).Rd(a)},this)};H.Eh=function(a){a[n](function(a){this.td(a).ab=null},this)};
...
function Mh(){this.Sb=new Nh;this.Qc=new Kh}H=Mh[z];H.Ub=function(a){(2>a[pb]()||2>a[pb]())&&this.Qc.Eh(a.ca().c());this.Sb.sb(a);this.me();return a.Jc().ga};H.me=function(){for(var a=this.Sb.c(),b=0;b<a[y];b++){var c=a[b],d=!1;if(d=0==c.da()?this.rg(c,1,3):this.rg(c,2,0))this.Sb[m](c),this.ii(c)}};H.rg=function(a,b,c){var d=!1,g=a.ca().c();this.Qc.qg(a.ka(),g,b)&&(d=this.Qc.qg(a.ka(),g,c));return d};H.ii=function(a){a[Ia]()[A](J(this.Mj,this,a),J(this.Lj,this,a))};
...
H.Ae=function(a){var b=new O;a[n](function(a){b.add(a[k]())});var c=[];this.fc.c()[n](function(a){a=a.Lc();a[Da].f[wb](function(a){return b[u](a[k]())})&&c[v](a)});return c};H.Og=function(a,b){var c=this.ye(null!=a.Ac?a.Ac:a),c=this.fc.get(c,null);return null!==c?(c.Ck(b),!0):!1};function Rh(a){this.nh=a;this.Tc=new O;this.Jj=[];this.Yf=null;this.Vh=new Oh(a.xd(),this.Jj)}H=Rh[z];H.ae=function(a){this.Tc[u](a)?Yb("Attempted to register observer twice."):this.Tc.add(a)};H.Se=function(a){return this.Tc[m](a)};
H.Lc=function(){return this.nh.Si()};H.nj=function(){return 0<this.Tc.na()};H.Ck=function(a){var b=this.Vh.bh(this.Yf,a);this.Yf=a;0<b[y]&&this.Tc.c()[n](function(a){a(b)})};
...
function Y(a,b,c,d,g,h){this.D=a;this.B=b;this.Uf=c;this.Rf=d;this.Kg=g;this.ib=h||null}I("lf.schema.BaseColumn",Y,void 0);H=Y[z];ia(H,G("B"));H.l=function(){return this.D.Aa()+"."+this.B};f(H,function(){return this.l()});H.Y=G("D");H.da=G("Kg");H.Ua=G("ib");H.Ga=function(){null==this.qa&&(this.qa=[],this.Y().Ga()[n](function(a){-1!=a.h.map(function(a){return a.cb[k]()})[ob](this.B)&&this.qa[v](a)},this));return this.qa};H.lc=G("Rf");H.Fd=G("Uf");H.Na=function(a){return Uf(this,a,"eq")};Y[z].eq=Y[z].Na;
Y[z].bg=function(a){return Uf(this,a,"neq")};Y[z].neq=Y[z].bg;Y[z].Ke=function(a){return Uf(this,a,"lt")};Y[z].lt=Y[z].Ke;Y[z].Aj=function(a){return Uf(this,a,"lte")};Y[z].lte=Y[z].Aj;Y[z].gj=function(a){return Uf(this,a,"gt")};Y[z].gt=Y[z].gj;Y[z].hj=function(a){return Uf(this,a,"gte")};Y[z].gte=Y[z].hj;Y[z].match=function(a){return Uf(this,a,"match")};Y[z].match=Y[z].match;Y[z].mh=function(a,b){return Uf(this,[a,b],"between")};Y[z].between=Y[z].mh;Y[z].oj=function(a){return Uf(this,a,"in")};
Y[z]["in"]=Y[z].oj;Y[z].uj=function(){return this.Na(null)};Y[z].isNull=Y[z].uj;Y[z].tj=function(){return this.bg(null)};Y[z].isNotNull=Y[z].tj;Y[z].wc=function(a){return new Y(this.D,this.B,this.Uf,this.Rf,this.Kg,a)};Y[z].as=Y[z].wc;
...
function Z(a){this.B=a;this.H=new N;this.Ng=new O;this.rc=new O;this.Id=new O;var b=this.B;this.nc="pk"+(b[0].toUpperCase()+b.substring(1));this.qa=new N;this.Md=!1;this.yc(a)}I("lf.schema.TableBuilder",Z,void 0);function ai(a){za(this,a[rb]);this.mb=a.order;this.autoIncrement=a[Na]}var bi=new O([0,6]);
...
Z[z].zh=function(a){var b=!1;a[n](function(a){var d=this.H.get(a[rb]);b=b||a[Na];if(a[Na]&&3!=d)throw new P("SyntaxError","Can not use autoIncrement with a non-integer primary key.");},this);if(b&&1<a[y])throw new P("SyntaxError","Can not use autoIncrement with a cross-column primary key.");};Z[z].Ug=function(a,b){this.yc(a);this.H.set(a,b);bi[u](b)&&this.ff([a]);return this};Z[z].addColumn=Z[z].Ug;
Z[z].Xg=function(a,b){this.yc(this.nc);var c=this.Hd(a,!0,void 0,b);this.zh(c);c[n](function(a){this.Ng.add(a[rb])},this);this.rc.add(this.nc);this.qa.set(this.nc,c);return this};Z[z].addPrimaryKey=Z[z].Xg;Z[z].Vg=function(a,b){Fb(b.action)||(b.action=0);Fb(b.timing)||(b.timing=0);if(1==b.action&&1==b.timing)throw new P("SyntaxError","Lovefield allows only immediate evaluation of cascading constraints");return this};Z[z].addForeignKey=Z[z].Vg;
Z[z].Yg=function(a,b){this.yc(a);var c=this.Hd(b,!0);this.qa.set(a,c);this.rc.add(a);return this};Z[z].addUnique=Z[z].Yg;Z[z].ff=function(a){a=this.Hd(a,!1);this.yh(a);a[n](function(a){this.Id.add(a[rb])},this);return this};Z[z].addNullable=Z[z].ff;
...
Z[z].Ji=function(){function a(){function a(c){return b.qa.get(c).map(function(a){return{cb:this[a[rb]],mb:a.mb,autoIncrement:a[Na]}},this)}var d=b.H.G().map(function(a){this[a]=new Y(this,a,b.Ng[u](a),b.Id[u](a),b.H.get(a));return this[a]},this),g=b.qa.G().map(function(d){return new Wf(b.B,d,b.rc[u](d),a[D](this,d))},this);Xf[D](this,b.B,d,g,b.Md);var h=b.qa.s(b.nc)?new Wf(b.B,b.nc,!0,a[D](this,b.nc)):null,l=d[Ea](function(a){return!b.Id[u](a[k]())}),p=b.rc.c().map(function(d){return new Wf(b.B,d,
!0,a[D](this,d))},this);this.Ih=new $h(h,l,[],p);this.ug=b.Fi(d,g)}var b=this;K(a,Xf);a[z].wb=function(a){return new this.ug($c++,a)};a[z].createRow=a[z].wb;a[z].dc=function(a){var b={};this.xb()[n](function(g){var h=g[k]();g=g.da();var l=a[x][h];if(0==g)if(null===l)g=l;else if(g=l,""==g)g=null;else{0!=g[y]%2&&(g="0"+g);for(var l=new ArrayBuffer(g[y]/2),p=new Uint8Array(l),B=0,Ra=0;B<g[y];B+=2)p[Ra++]=ga(g.substr(B,2),16);g=l}else g=2==g?null===l?l:new Date(l):l;b[h]=g},this);return new this.ug(a.id,
b)};a[z].deserializeRow=a[z].dc;a[z].ic=G("Ih");a[z].getConstraint=a[z].ic;return a};
Z[z].Fi=function(a,b){function c(c,d){this.H=a;this.qa=b;Zc[D](this,c,d)}K(c,Zc);c[z].vf=function(){var a={};this.H[n](function(b){a[b[k]()]=b.lc()?null:ge[b.da()]});return a};c[z].Hg=function(){var a={};this.H[n](function(b){var c=b[k]();b=b.da();var d=this.w()[c];a[c]=0==b?null===d?d:cd(d):2==b?null===d?d:d[Qa]():d},this);return a};var d=J(function(a){var b=this.H.get(a[k]());return 2==b?function(b){b=b[a[k]()];return a.lc()&&null===b?null:b[Qa]()}:1==b?function(b){return a.lc()?(b=b[a[k]()],null===
...
function ci(a,b){this.A=new di(a,b);this.pc=new N;this.Ic=!1}I("lf.schema.Builder",ci,void 0);ci[z].pi=function(){this.Ic||(this.pc.G()[n](function(a){a=this.pc.get(a);this.A.lk(a.Jb())},this),this.pc[Pa](),this.Ic=!0)};ci[z].Jb=function(){this.Ic||this.pi();return this.A};ci[z].getSchema=ci[z].Jb;ci[z].Df=function(){var a=new td("ns_"+this.A[rb]()),b;Xh||(Xh=new Wh);b=Xh;var c=null;b.Ie(a)?c=b.o(a):(c=new Wh,b.nb(a,c));return c};ci[z].getGlobal=ci[z].Df;
ci[z].connect=function(a){var b=this.Df();b.Ie(Ad)||b.nb(Ad,this.Jb());return(new X(b)).Ba(a)};ci[z].connect=ci[z].connect;ci[z].Oh=function(a){if(this.pc.s(a)||this.Ic)throw new P("SyntaxError","Table is already created or schema is already finalized.");this.pc.set(a,new Z(a));return this.pc.get(a)};ci[z].createTable=ci[z].Oh;ci[z].Ye=function(a){if(this.Ic)throw new P("SyntaxError","Schema is already finalized.");this.A.Ye(a);return this};ci[z].setPragma=ci[z].Ye;
function di(a,b){this.B=a;this.Ma=b;this.I=new N;this.lg={Wh:!1}}I("lf.schema.DatabaseSchema",di,void 0);za(di[z],G("B"));za(di[z],di[z][rb]);di[z].version=G("Ma");di[z].version=di[z][Fa];di[z].gb=function(){return this.I.c()};di[z].tables=di[z].gb;oa(di[z],function(a){if(!this.I.s(a))throw new P("NotFoundError",a+" is not found in database");return this.I.get(a)});oa(di[z],di[z][t]);di[z].lk=function(a){this.I.set(a[k](),a)};di[z].kg=G("lg");di[z].pragma=di[z].kg;di[z].Ye=Cb("lg");
