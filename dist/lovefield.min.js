...
function K(a,b){function c(){}c.prototype=b[r];a.Pb=b[r];a.prototype=new c;a[r].constructor=a;a.Bl=function(a,c,h){for(var l=e(arguments[C]-2),p=2;p<arguments[C];p++)l[p-2]=arguments[p];return b[r][c][xb](a,l)}};function ac(a){if(fa.captureStackTrace)fa.captureStackTrace(this,ac);else{var b=fa().stack;b&&(this.stack=b)}a&&(this.message=ha(a))}K(ac,fa);ja(ac[r],"CustomError");function bc(a,b){for(var c=a[Ja]("%s"),d="",g=e[r][m][q](arguments,1);g[C]&&1<c[C];)d+=c[rb]()+g[rb]();return d+c[La]("%s")};function cc(a,b){b.unshift(a);ac[q](this,bc[xb](null,b));b[rb]()}K(cc,ac);ja(cc[r],"AssertionError");function dc(a,b,c,d){var g="Assertion failed";if(c)var g=g+(": "+c),h=d;else a&&(g+=": "+a,h=b);throw new cc(""+g,h||[]);}function L(a,b,c){a||dc("",null,b,e[r][m][q](arguments,2));return a}function ec(a,b){throw new cc("Failure"+(a?": "+a:""),e[r][m][q](arguments,1));}function fc(a,b,c){Ub(a)||dc("Expected function but got %s: %s.",[Pb(a),a],b,e[r][m][q](arguments,2));return a};function gc(a,b,c){this.tk=c;this.Fi=a;this.bl=b;this.$d=0;this.Ud=null}gc[r].get=function(){var a;0<this.$d?(this.$d--,a=this.Ud,this.Ud=a[pb],ya(a,null)):a=this.Fi();return a};gc[r].put=function(a){this.bl(a);this.$d<this.tk&&(this.$d++,ya(a,this.Ud),this.Ud=a)};var hc=e[r],ic=hc[$a]?function(a,b,c){L(null!=a[C]);return hc[$a][q](a,b,c)}:function(a,b,c){c=null==c?0:0>c?ba.max(0,a[C]+c):c;if(Tb(a))return Tb(b)&&1==b[C]?a[$a](b,c):-1;for(;c<a[C];c++)if(c in a&&a[c]===b)return c;return-1},jc=hc[F]?function(a,b,c){L(null!=a[C]);hc[F][q](a,b,c)}:function(a,b,c){for(var d=a[C],g=Tb(a)?a[Ja](""):a,h=0;h<d;h++)h in g&&b[q](c,g[h],h,a)},kc=hc.map?function(a,b,c){L(null!=a[C]);return hc.map[q](a,b,c)}:function(a,b,c){for(var d=a[C],g=e(d),h=Tb(a)?a[Ja](""):a,l=0;l<
...
H.Af=function(a,b,c){var d=Wc(null,null,null);xa(d,new M(function(g,h){d.ac=a?function(b){try{var d=a[q](c,b);g(d)}catch(y){h(y)}}:g;d.yc=b?function(a){try{var d=b[q](c,a);!Mb(d)&&a instanceof Tc?h(a):g(d)}catch(y){h(y)}}:h}));d[jb].G=this;this.zf(d);return d[jb]};H.sl=function(a){L(1==this.La);this.La=0;this.Bc(2,a)};H.tl=function(a){L(1==this.La);this.La=0;this.Bc(3,a)};
...
H.ni=function(a,b){b[F](function(b){if(fe(b[0],b[1],a[n])){b=b[1].w()[a.Rb];var d=this.hg(a);if(null!==b&&!d.C(b))throw new P(203,a[n]);}},this)};H.hg=function(a){var b=this.s[k](a.fb)[a.Ac].za()[Ga](function(b){return 1==b.h[C]&&b.h[0].ga[t]()==a.Ac})[0];return this.J.get(b.l())};function fe(a,b,c){return(null===a?null!==b:null===b)||a.Zb(c)!=b.Zb(c)}
...
function qe(a){if(0==a[C])return pe();for(var b=a[Ka](function(b,c){ne(a[0],c);return b+c[B][C]},0),c=e(b),d=0,b=a.map(function(a){var b=new N;a[B][F](function(a){c[d++]=a;b.set(a.id,a)});return b}),g=new N,h=0;h<c[C];h++)b[Ua](function(a){return a.C(c[h].id)})&&g.set(c[h].id,c[h]);return new me(g.f(),a[0].I.f())}function re(a){if(0==a[C])return pe();var b=new N;a[F](function(c){ne(a[0],c);c[B][F](function(a){b.set(a.id,a)})});return new me(b.f(),a[0].I.f())}
...
function ve(a,b,c,d){function g(a,b){if(a.Te){var c=a.wa.w(),d;for(d in c)h[d]=c[d]}else L(!h[sb](b[0]),"Attempted to join table with itself, without using table alias, or same alias "+b[0]+"is reused for multiple tables."),h[b[0]]=a.wa.w()}var h={};g(a,b);g(c,d);a=new hd(-1,h);return new te(a,!0)};
...
ma(H,function(){var a=new he(this[Wa],this.Rf.f()),b=[],c=this.Tg[m](),d=J(function(){var g=c[rb]();if(g){var h=this.de[b[C]];return g.qb()[Qa](a,h)[z](function(a){b[x](a[0]);return d()})}return Xc()},this);return d()[z](J(function(){return this.Hb.Tb(this.sh,a).pa()},this))[z](J(function(){this.af(b);return b},this),J(function(b){a.Nb();throw b;},this))});H.Z=G("sh");H.ha=G("Rf");H.Zc=G("fc");H.fa=function(){return Vb(this)};H.af=Ib();
...
H.hk=function(){id=this.I.f().map(function(a){return a.Fj()})[Ka](function(a,b){return a>b?a:b},0)+1};H.Fk=function(a){var b=a.val(),c=this.kd.get(b.T,null);null===c&&(c=new O,this.kd.set(b.T,c));c.add(da(a.key(),10))};H.Ze=function(a){var b=a[jb]("@rev/R").val();null!=b&&b!=this.Za&&(this.Za=b,a=this.mj(a),a[F](function(a){var b=this.I.get(a[t]()),g=a.Wc().U();g[C]&&b.Zg(g);var h=a.Uc().f();a.Yc()[F](function(a){h[x](a[1])});b.ef(h)},this),a[C]&&this.gd(a),this.Ig())};
H.mj=function(a){var b=new O,c=new N;this.jb[F](function(a,g){var h=this.I.get(g),l=new ge(g);if(this.kd.C(a)){var p=this.kd.get(a).f();b[hb](p);h.Le(p)[F](function(a){l[Ya](a)})}c.set(a,l)}[E](this));a[F](function(a){if("@rev"!=a.key()){var g=da(a.key(),10);if(!b[tb](g)){a=a.val();var h=c.get(a.T),l=this.I.get(h[t]());l.getData().C(g)?h.modify([l.Le([g])[0],new hd(g,a.P)]):h.add(new hd(g,a.P))}}}[E](this));return c.f()[Ga](function(a){return!a.Wa()})};
H.Yg=function(a){var b=bd(),c=this.kg(a);this.j[cb]("T").equalTo(c)[Ha]("value",function(c){var g=new We,h=[];c[F](function(a){h[x](new hd(da(a.key(),10),a.val().P))});g.ef(h);this.I.set(a,g);b[Fb]()}[E](this));return b.ka};H.kg=function(a){return this.jb.get(a)};H.yi=function(){var a={};a["@db"]={version:this.s[ub]()};a["@rev"]={R:1};this.Za=1;a["@table"]={};this.s.ab()[F](function(b,c){var d=b[t]();a["@table"][d]=c;this.I.set(d,new We);this.jb.set(d,c)},this);return a};
...
Q[r].Jk=function(a,b,c){return new M(function(d,g){var h;try{var l=this.Sa[vb](a);h=l[Fa]()}catch(p){g(p);return}sa(h,function(){var a=h[Gb];a?(b(a),a[gb]()):(c(l),d())});za(h,g)},this)};function Ye(a){var b=null;return b=a instanceof ArrayBuffer?ld(a):a instanceof Date?a[Eb]():a}Q[r].tf=function(a,b){function c(a){var c=Ud(a[u]),d=c.xc(),p;for(p in d){var y=jd(d[p]);b(y);d[p]=y.Ka()}a[Va](c.Ka())}function d(a){var c=jd(a[u]);b(c);a[Va](c.Ka())}return this.Jk(a,this.wd?c:d,Ib())};
...
H.mf=function(a){function b(){if(0==c[C])return Xc();var a=c[rb]();return l(a)[z](b)}var c=this.s.ab().map(function(a){return a[t]()}),d=this.j,g=0,h=J(function(a){return this.xd?(a=Ud(a[u]),Cc(a.xc())[Ka](function(a,b){return ba.max(a,b)},0)):a.key},this),l=J(function(b){return new M(function(c,l){var qb;try{qb=(a||d[lb]([b]))[vb](b)[Fa](null,"prev")}catch(Dc){l(Dc);return}sa(qb,function(a){(a=a[Pa][Gb])&&(g=ba.max(g,h(a)));c(g)});za(qb,function(){c(g)})},this)},this);return new M(function(a){b()[z](function(){a(g)})})};
...
R[r].tc=function(a){var b=this.Ed();b.Qa("SELECT id, value FROM "+a,[]);return b.pa()[z](function(a){for(var b=a[Cb][C],g=e(b),h=0;h<b;++h)g[h]={id:a[Cb][Oa](h).id,value:ga.parse(a[Cb][Oa](h)[u])};return Xc(g)})};R[r].sf=function(a,b){var c=this.Ed(),d="UPDATE "+a+" SET value=? WHERE id=?";return this.tc(a)[z](function(a){a[F](function(a){a=b(a);c.Qa(d,[ga[yb](a[u]),a.id])});return c.pa()})};R[r].Fc=function(a,b,c){var d=Ye(c);return this.sf(a,function(a){a[u][b]=d;return a})};
...
H.pb=function(a,b,c){var d=[],g=ba.min(b,c),h=ba.max(b,c);a=this.Sd(a);if(a[Hb]<h-g)a[F](function(a){a>=g&&a<=h&&(a=this.g.get(a),L(null!=a,"Inconsistent cache"),d[x](a))},this);else for(b=g;b<=h;++b)a.has(b)&&(c=this.g.get(b),L(null!=c,"Inconsistent cache"),d[x](c));return d};va(H,function(a,b){var c=this.Sd(a);b[F](function(a){this.g[Ya](a);c[Ya](a)},this)});H.ya=function(a){return null!=a?this.Sd(a)[Hb]:this.g[Hb]};
...
H.pb=function(a,b,c,d){var g=this.sa.Md().b[0];if(!Mb(g)||0==c)return uf;b=b||!1;c=null!=c?ba.min(c,this.vb.Ga):this.vb.Ga;d=d||0;var h=ba.min(ba.max(this.vb.Ga-d,0),c);if(0==h)return uf;if(!Mb(a)||1==a[C]&&a[0]instanceof ie&&a[0].sg())return this.Vc(h,b,c,d);a=this.X.lh(a);var l=e(b?this.vb.Ga:h),p={count:0,ba:l[C],reverse:b,V:d};a[F](function(a){for(var b=this.X.ee(a),b=this.X.Re(a)?g:b[0],b=this.sa.dg(b),c=p[bb],d=0;null!=b&&p[bb]<p.ba;)b.pb(a,p,l),p[bb]!=c?(d=0,c=p[bb]):d++,b=2==d?null:b[pb]()},
...
function zf(a){function b(a){return null!=a?a.Aa[D]():"_"}var c=a.Aa+"["+a.b[La]("|")+"]",d=a.i.map(function(a){return a.Aa})[La]("|"),g=a.B[La]("/"),h=b(a.Eb)+"{",h=a.ja()?h+g:h+d,h=h+"}"+b(a.G);a.Ba&&(a=zf(a.Ba),c=c+"  "+a[0],h=h+"  "+a[1]);return[c,h]}f(H,function(){var a="",b=zf(this),a=a+(b[0]+"\n"+b[1]+"\n");this.i[C]&&(a+=this.i[0][D]());return a});H.Md=function(){return this.ja()?this:this.i[0].Md()};H.jg=function(){return this.ja()?this:this.i[this.i[C]-1].jg()};
function Af(a,b){b&&(b.Eb=a);a&&(a.Ba=b)}function sf(a,b){for(var c=b[C],d=0,g=vf(a),h=g;0<c;){var l=768<=c?511:257<=c&&511>=c?c:257,p=b[m](d,d+l);g.b=p.map(function(a){return a.key});g.B=p.map(function(a){return a[u]});d+=l;c-=l;0<c&&(l=vf(g.D),Af(g,l),g=l)}return h}function Bf(a){var b=a[0],c=vf(b.D);c.rb=b.rb+1;c.i=a;for(b=0;b<a[C];++b)a[b].G=c,0<b&&c.b[x](a[b].b[0]);return c}
...
H.Wf=function(a,b,c){var d=this.nd(a),g=this.ja();if(!g){var h=this.D.Va(this.b[d],a)?d+1:d;if(this.i[h].Wf(a,h,c))this.Gd();else return!1}else if(!this.D.Va(this.b[d],a))return!1;if(this.b[C]>d&&this.D.Va(this.b[d],a)){if(Mb(c)&&!this.D.Na()&&g&&(h=this.B[d],c=uc(h,vc,!1,c),0<=c&&oc(h,c)&&this.D.ib()[w](a,1),this.B[d][C]))return!1;this.b[A](d,1);g&&(g=this.D.Na()?1:this.B[d][C],this.B[A](d,1),this.D.ib()[w](a,g))}256>this.b[C]&&!this.Bg()&&(this.ol()||this.Bk(b));return!0};
...
H.add=function(a){if(0!=a[C])if(a=this.gb[Sa](a),1==a[C])this.gb=a;else{a[Za](le);for(var b=[],c=a[0],d=1;d<a[C];++d)if(c.Qg(a[d])){var g=a[d],h=ke();if(null!==c.c&&null!==g.c){var l=je(c.c,g.c,!0);1!=l?(h.c=c.c,h.$=0!=l?c.$:c.$&&g.$):(h.c=g.c,h.$=g.$)}null!==c.u&&null!==g.u&&(l=je(c.u,g.u,!1),-1!=l?(h.u=c.u,h.da=0!=l?c.da:c.da&&g.da):(h.u=g.u,h.da=g.da));c=h}else b[x](c),c=a[d];b[x](c);this.gb=b}};
...
function Sf(a,b){var c=[],d=null,g=null;a.Cc(function(a){var l=b(a);null==a[Bb]()?g=l:d.ma(l);var p=a[Bb]();null!==p&&p.xa()==d.xa()&&(p=c[$a](d),-1!=p&&c[A](p,1));1<a.xa()&&c[x](l);d=a.vg()?c[c[C]-1]:l});return g}function Tf(a){return Uf(a,function(a){return a.vg()})}function Vf(a){var b=a[Bb](),c=0;null!==b&&(c=b.ea()[$a](a),b[ib](a));var d=a.ea()[m]();d[F](function(d,h){a[ib](d);null===b||b.Ec(d,c+h)});return{parent:b,children:d}}
...
H.ya=G("aa");H.C=function(a){return this.g.C(a)};H.Cd=function(a){return mc(this.g.f(),function(b){return mc(b,function(b){return bg(b,a)})})};H.U=function(){return this.g.U()};H.f=function(){return yc(this.g.f())};H.getEntries=function(){for(var a=this.U(),b=[],c=0;c<a[C];c++)for(var d=a[c],g=this.get(d),h=0;h<g[C];h++)b[x]([d,g[h]]);return b};
...
H.Qi=function(a,b,c){for(var d=[],g=a.Y(),h=b.Y(),l=0;l<a[B][C];l++){for(var p=!1,y=0;y<b[B][C];y++)if(this.Fd(a[B][l].S(this.Oa),b[B][y].S(this.Ea))){var p=!0,wa=ve(a[B][l],g,b[B][y],h);d[x](wa)}c&&!p&&d[x](this.Sf(a[B][l],g))}a=a.Y()[Sa](b.Y());return new me(d,a)};
H.Pi=function(a,b,c){var d=a,g=b,h=this.Oa,l=this.Ea;if(c||a[B][C]>b[B][C])d=b,g=a,h=this.Ea,l=this.Oa;var p=new hg,y=[];d[B][F](function(a){var b=ha(a.S(h));p.add(b,a)});var wa=d.Y(),qb=g.Y();g[B][F](function(a){var b=ha(a.S(l));p.C(b)?p.get(b)[F](function(b){b=ve(a,qb,b,wa);y[x](b)}):c&&y[x](this.Sf(a,qb))}[E](this));a=a.Y()[Sa](b.Y());return new me(y,a)};
...
function og(a){U[q](this,-1,1);this.Df=a}K(og,U);f(og[r],function(){return"aggregation("+this.Df.map(function(a){return a.l()})[D]()+")"});og[r].na=function(a,b){b[F](function(a){(new pg(a,this.Df)).Uh()},this);return b};function pg(a,b){this.Ja=a;this.H=b}
pg[r].Uh=function(){this.H[F](function(a){a=a.cg()[fb]();for(var b=1;b<a[C];b++){var c=a[b],d=c.cg()[m](-1)[0],g=this.Dj(c),h=null;switch(c.lc){case "MIN":h=qg(g,d);break;case "MAX":h=rg(g,d);break;case "DISTINCT":h=sg(g,d);break;case "COUNT":h=g[B][C];break;case "SUM":h=tg(g,d);break;case "AVG":0<g[B][C]&&(h=tg(g,d)/g[B][C]);break;case "GEOMEAN":h=ug(g,d);break;default:h=vg(g,d)}this.Ja.el(c,h)}},this)};pg[r].Dj=function(a){return a[jb]instanceof T?this.Ja.wc(a[jb]):this.Ja};
...
function wg(a,b){this.Fa=a;this.ta=b}wg[r].qb=G("Fa");wg[r].ha=G("ta");function V(){De[q](this,"","")}K(V,De);function xg(a,b){V[q](this);ia(this,a);ua(this,b)}K(xg,V);function yg(a,b){xg[q](this,a,b)}K(yg,xg);function zg(a){V[q](this);ia(this,a)}K(zg,V);f(zg[r],function(){return"delete("+this[k][t]()+")"});function Ag(a,b){V[q](this);ia(this,a);this.wf=b}K(Ag,V);f(Ag[r],function(){var a=[];this.wf&&(a=this.wf.map(function(a){return a.K[t]()},this));return"update("+this[k][t]()+", ["+a[La](",")+"])"});
function Bg(a){V[q](this);this.Da=a}K(Bg,V);f(Bg[r],function(){return"select("+this.Da[D]()+")"});function Cg(a){V[q](this);ia(this,a)}K(Cg,V);f(Cg[r],function(){var a="table_access("+this[k][t]();null===this[k].cb()||(a+=" as "+this[k].cb());return a+")"});function Dg(){V[q](this)}K(Dg,V);f(Dg[r],Kb("cross_product"));function Eg(a,b){V[q](this);this.h=a;this.Wb=b}K(Eg,V);
...
f(Ig[r],function(){return"limit("+this.ba+")"});function Jg(a){V[q](this);this.V=a}K(Jg,V);f(Jg[r],function(){return"skip("+this.V+")"});function Kg(a,b){V[q](this);this.Da=a;this.yg=b}K(Kg,V);f(Kg[r],function(){return(this.yg?"left_outer_join":"join")+"("+this.Da[D]()+")"});
function Lg(){};
function Mg(){}K(Mg,Lg);Mg[r].Mb=function(a){this.la=a;this.bb(this.la);return this.la};Mg[r].bb=function(a){if(a instanceof Bg){L(1==a.xa(),"SelectNode must have exactly one child.");var b=this.If(a.Da),b=this.Bi(b);Zf(a,a,b[0],b[1]);a==this.la&&(this.la=b[0]);a=b[0]}a.ea()[F](function(a){this.bb(a)},this)};Mg[r].If=function(a){if(0==a.xa()||"and"!=a.bc)return[a];var b=a.ea()[m]().map(function(b){a[ib](b);return this.If(b)},this);return yc(b)};
Mg[r].Bi=function(a){var b=null,c=null;a.map(function(a,g){var h=new Bg(a);0==g?b=h:c.ma(h);c=h},this);return[b,c]};
function Ng(){}K(Ng,Lg);Ng[r].Mb=function(a){this.la=a;this.bb(this.la);return this.la};Ng[r].bb=function(a){if(a instanceof Dg)for(;2<a.xa();){for(var b=new Dg,c=0;2>c;c++){var d=a.fe(0);b.ma(d)}a.Ec(b,0)}a.ea()[F](function(a){this.bb(a)},this)};
...
function Pg(a,b){Oe[q](this,a,b);this.$a=a.o(Ld);this.Kb=a.o(Md)}K(Pg,Oe);Ea(Pg[r],Kb(2));Pg[r].af=function(a){0==this.Z()?this.Dk(a):this.md()};Pg[r].Dk=function(a){this.de[F](function(b,c){b instanceof Ke&&this.Kb.uh(b,a[c])},this)};Pg[r].md=function(){var a=this.Kb.Me(this.ha().f());0!=a[C]&&(a=new Pe(this[Wa],a),this.$a.gc(a))};
function Qg(a){Ie[q](this,a)}K(Qg,Ie);Qg[r].ha=function(){var a=new O([this.c]);a[hb](this.ga[zb]().bg(this.c[t]()));return a};la(Qg[r],function(){var a=new Qg(this.ga);a.Ad(this);a.c=this.c;return a});Ba(Qg[r],function(a){Qg.Pb[E][q](this,a);this.re(a);return this});
function Rg(a){Ie[q](this,a)}K(Rg,Ie);Rg[r].ha=function(){var a=new O([this.Ia]),b=this.ga[zb]();a[hb](b.Jj(this.Ia[t]()));this.mc&&a[hb](b.bg(this.Ia[t]()));return a};la(Rg[r],function(){var a=new Rg(this.ga);a.Ad(this);a.Ia=this.Ia;this[db]&&ua(a,this[db]instanceof we?this[db]:this[db][m]());a.mc=this.mc;a.nc=this.nc;return a});Ba(Rg[r],function(a){Rg.Pb[E][q](this,a);this.nc&&ua(this,this.nc instanceof we?a[this.nc.Ab()]:this.nc.map(function(b){return b instanceof we?a[b.Ab()]:b}));return this});
function Sg(a){Ie[q](this,a)}K(Sg,Ie);Sg[r].ha=function(){var a=new O([this[k]]),b=this.set.map(function(a){return a.K.l()}),c=this.ga[zb]();a[hb](c.Kj(b));a[hb](c.zj(b));return a};la(Sg[r],function(){var a=new Sg(this.ga);a.Ad(this);ia(a,this[k]);a.set=this.set?this.set[m]():this.set;return a});Ba(Sg[r],function(a){Sg.Pb[E][q](this,a);this.set[F](function(b){-1!=b.vd&&pa(b,a[b.vd])});this.re(a);return this});
function Tg(a,b){if(null==b)return"NULL";switch(a){case 1:return b?1:0;case 3:case 4:return b;case 0:return"'"+ld(b)+"'";default:return"'"+b[D]()+"'"}}function Ug(a,b){var c=a.mc?"INSERT OR REPLACE":"INSERT",d=a.Ia.ob(),c=c+(" INTO "+a.Ia[t]()+"("),c=c+d.map(function(a){return a[t]()})[La](", "),c=c+") VALUES (";return a[db].map(function(a){var h=d.map(function(c){var d=a.w()[c[t]()];return b?null!=d?"#":"NULL":Tg(c.Z(),d)});return c+h[La](", ")+");"})[La]("\n")}
...
function Xg(a,b){return a.ea().map(function(a){return"("+Yg(a,b)+")"})[La]("and"==a.bc?" AND ":" OR ")}function Yg(a,b){if(a instanceof He)return[a.K.l(),Vg(a.L),Wg(a[u],a.L,a.K.Z(),b)][La](" ");if(a instanceof ag)return Xg(a,b);if(a instanceof ig)return[a.Oa.l(),Vg(a.L),a.Ea.l()][La](" ");throw new P(357,typeof a);}function Zg(a,b){var c=Yg(a,b);return c?" WHERE "+c:""}
function $g(a,b){var c="UPDATE "+a[k][t]()+" SET ",c=c+a.set.map(function(a){var b=a.K.l()+" = ";return-1!=a.vd?b+"?"+a.vd[D]():b+Tg(a.K.Z(),a[u])[D]()})[La](", ");a.F&&(c+=Zg(a.F,b));return c+";"}
...
function bh(a,b){var c=b||!1,d=a.ig();if(d instanceof Rg)return Ug(d,c);if(d instanceof Qg){var g="DELETE FROM "+d.c[t]();d.F&&(g+=Zg(d.F,c));return g+";"}if(d instanceof Sg)return $g(d,c);if(d instanceof Ke)return ah(d,c);throw new P(358,typeof d);};
function ch(a,b){this.global=a;this.Rk=a.o(Kd);this.$a=a.o(Ld);this.a=b}I("lf.query.BaseBuilder",ch,void 0);ma(ch[r],function(){try{this.mb()}catch(a){return Yc(a)}return new M(function(a,c){var d=new Pg(this[Wa],[this.ad()]);this.$a.gc(d)[z](function(c){a(c[0].Ie())},c)},this)});ma(ch[r],ch[r][Qa]);ch[r].$f=function(){var a=J(function(a){return a.pd(this.a)+"\n"},this);return $f(this.Je().qb(),a)};ch[r].explain=ch[r].$f;Ba(ch[r],function(a){this.a[E](a);return this});Ba(ch[r],ch[r][E]);
ch[r].rl=function(a){return bh(this,a)};ch[r].toSql=ch[r].rl;H=ch[r];H.mb=Ib();H.ig=function(){return this.a.clone()};H.Nd=G("a");H.Je=function(){null==this.Sg&&(this.Sg=this.Rk.Lj(this.a));return this.Sg};H.ad=function(){return{context:this.ig(),df:this.Je()}};H.Hj=function(){return{context:this.Nd(),df:this.Je()}};
function dh(a){ch[q](this,a,new Qg(a.o(Nd)))}K(dh,ch);I("lf.query.DeleteBuilder",dh,void 0);dh[r].c=function(a){this.Lh();this.a.c=a;return this};dh[r].from=dh[r].c;dh[r].F=function(a){this.pe();this.a.F=a;return this};dh[r].where=dh[r].F;dh[r].Lh=function(){if(null!=this.a.c)throw new P(515);};dh[r].pe=function(){if(null!=this.a.F)throw new P(516);};dh[r].mb=function(){dh.Pb.mb[q](this);if(null==this.a.c)throw new P(517);};
function eh(a,b){ch[q](this,a,new Rg(a.o(Nd)));this.a.mc=b||!1}K(eh,ch);I("lf.query.InsertBuilder",eh,void 0);eh[r].mb=function(){eh.Pb.mb[q](this);var a=this.a;if(null==a.Ia||null==a[db])throw new P(518);if(a.mc&&null===a.Ia.Jb().Pd())throw new P(519);};eh[r].Ia=function(a){this.Mh();this.a.Ia=a;return this};eh[r].into=eh[r].Ia;ua(eh[r],function(a){this.Nh();a instanceof we||a[ab](function(a){return a instanceof we})?this.a.nc=a:ua(this.a,a);return this});ua(eh[r],eh[r][db]);
eh[r].Mh=function(){if(null!=this.a.Ia)throw new P(520);};eh[r].Nh=function(){if(null!=this.a[db])throw new P(521);};
function fh(a){return gh("and",e[r][m][q](arguments))}I("lf.op.and",fh,void 0);I("lf.op.or",function(a){return gh("or",e[r][m][q](arguments))},void 0);function gh(a,b){var c=new ag(a);b[F](function(a){c.ma(a)});return c}I("lf.op.not",function(a){a.ie(!0);return a},void 0);
function W(a,b){ch[q](this,a,new Ke(a.o(Nd)));this.ag=this.xh=!1;this.a.h=b;this.bi();this.$h()}K(W,ch);I("lf.query.SelectBuilder",W,void 0);H=W[r];H.mb=function(){W.Pb.mb[q](this);var a=this.a;if(null==a.c)throw new P(522);if(Mb(a.$b)&&!Mb(a.ba)||Mb(a.jc)&&!Mb(a.V))throw new P(523);this.mi()};H.bi=function(){var a=this.a.h[Ga](function(a){return a instanceof T&&"DISTINCT"==a.lc},this);if(0!=a[C]&&(1!=a[C]||1!=this.a.h[C]))throw new P(524);};H.mi=function(){null!=this.a.oa?this.fi():this.li()};
...
W[r].F=function(a){if(this.xh)throw new P(516);this.xh=!0;this.qe(a);return this};W[r].where=W[r].F;W[r].qe=function(a){null!=this.a.F&&(a=fh(a,this.a.F));this.a.F=a};W[r].kk=function(a,b){if(null==this.a.c)throw new P(542);this.a.c[x](a);this.qe(b);return this};W[r].innerJoin=W[r].kk;
...
function hh(a,b){switch(a){case "COUNT":case "DISTINCT":return!0;case "AVG":case "GEOMEAN":case "STDDEV":case "SUM":return 4==b||3==b;case "MAX":case "MIN":return 4==b||3==b||5==b||2==b}return!1}la(W[r],function(){var a=new W(this[Wa],this.a.h);a.a=this.a.clone();a.a.Kc=null;return a});la(W[r],W[r].clone);
function ih(a,b){ch[q](this,a,new Sg(a.o(Nd)));ia(this.a,b)}K(ih,ch);I("lf.query.UpdateBuilder",ih,void 0);ih[r].set=function(a,b){var c={vd:b instanceof we?b.Ab():-1,K:a,value:b};null!=this.a.set?this.a.set[x](c):this.a.set=[c];return this};ih[r].set=ih[r].set;ih[r].F=function(a){this.pe();this.a.F=a;return this};ih[r].where=ih[r].F;ih[r].pe=function(){if(null!=this.a.F)throw new P(516);};
...
function jh(a){this.a=a;this.Fa=null}jh[r].vc=function(){null===this.Fa&&(this.Fa=this.Id());return this.Fa};function kh(a){jh[q](this,a)}K(kh,jh);kh[r].Id=function(){return this.a.mc?new yg(this.a.Ia,this.a[db]):new xg(this.a.Ia,this.a[db])};function lh(a){jh[q](this,a)}K(lh,jh);lh[r].Id=function(){var a=new Ag(this.a[k],this.a.set),b=null!=this.a.F?new Bg(this.a.F.Sb()):null,c=new Cg(this.a[k]);null===b?a.ma(c):(b.ma(c),a.ma(b));return a};
function mh(a,b,c){this.Fa=a;this.ff=b;this.lf=c}mh[r].vc=function(){this.lf[F](function(a){this.Fa=a.Mb(this.Fa,this.ff)},this);return this.Fa};
function nh(a){jh[q](this,a)}K(nh,jh);nh[r].Id=function(){var a=new zg(this.a.c),b=null!=this.a.F?new Bg(this.a.F.Sb()):null,c=new Cg(this.a.c);null===b?a.ma(c):(b.ma(c),a.ma(b));return(new mh(a,this.a,[new Mg])).vc()};
function oh(){}K(oh,Lg);oh[r].Mb=function(a,b){this.la=a;this.bb(this.la,b);return this.la};oh[r].bb=function(a,b){if(a instanceof Bg&&a.Da instanceof ig){L(1==a.xa(),"SelectNode must have exactly one child.");var c=a.Da.fa(),d=a.zb(0);d instanceof Dg&&(c=Mb(b)&&null!=b.zc&&b.zc[tb](c),c=new Kg(a.Da,c),Zf(a,d,c,c),a==this.la&&(this.la=c),a=c)}a.ea()[F](function(a){this.bb(a,b)},this)};
function ph(){this.ne=new O}K(ph,Lg);H=ph[r];H.Mb=function(a){this.la=a;this.bb(this.la);this.ne[v]();return this.la};H.bb=function(a){if(this.tg(a)){var b=a.Da instanceof He?this.Qk(a):this.Pk(a);this.ne.add(a);b==a&&(b=a.zb(0));null!==b&&(Qb(b[Bb]())&&(this.la=b),this.tg(b)&&!this.ne[tb](b)&&this.bb(b))}else a.ea()[F](function(a){this.bb(a)},this)};
H.ce=function(a,b){var c=a;if(this.il(a))c=Xf(a),this.ce(a,b);else if(this.hl(a)){var d=[],c=Yf(a,b,function(a){a=new Bg(a.Da);d[x](a);return a});d[F](function(a){this.ce(a,b)},this)}return c};H.Qk=function(a){var b=new O([a.Da.K.M().qa()]),c=function(a){return this.Xf(a,b)}[E](this);return this.ce(a,c)};H.Pk=function(a){var b=new O([a.Da.Oa.M().qa(),a.Da.Ea.M().qa()]),c=function(a){return this.Xf(a,b)}[E](this);return this.ce(a,c)};
H.Xf=function(a,b){var c=new O;Tf(a)[F](function(a){c.add(a[k].qa())},this);a instanceof Cg&&c.add(a[k].qa());return c.xi(b)};H.tg=function(a){return a instanceof Bg&&!(a.Da instanceof ag)};H.hl=function(a){a=a.zb(0);return a instanceof Dg||a instanceof Kg};H.il=function(a){return a.zb(0)instanceof Bg};
function qh(a){jh[q](this,a);this.Xg=this.Hg=this.kh=this.Ng=this.Ef=this.ng=this.gh=this.Uf=this.mh=null}K(qh,jh);H=qh[r];H.Id=function(){this.qj();var a=this.ui(),b=[new Mg,new Ng,new ph,new oh];return(new mh(a,this.a,b)).vc()};H.qj=function(){this.wj();this.lj();this.uj();this.rj();this.vj();this.pj();this.nj();this.kj();this.sj()};
H.ui=function(){for(var a=[this.Hg,this.kh,this.Xg,this.Ng,this.Ef,this.ng,this.gh,this.Uf],b=null,c=null,d=0;d<a[C];d++){var g=a[d];null!==g&&(null===c?c=g:a[b].ma(g),b=d)}this.mh[F](function(c){a[b].ma(c)});return c};H.wj=function(){this.mh=this.a.c.map(function(a){return new Cg(a)},this)};H.lj=function(){2<=this.a.c[C]&&(this.Uf=new Dg)};H.uj=function(){this.gh=null!=this.a.F?new Bg(this.a.F.Sb()):null};H.rj=function(){this.a.N&&(this.Ng=new Fg(this.a.N))};
H.pj=function(){null!=this.a.ba&&(this.Hg=new Ig(this.a.ba))};H.vj=function(){null!=this.a.V&&0<this.a.V&&(this.kh=new Jg(this.a.V))};H.nj=function(){null!=this.a.oa&&(this.ng=new Hg(this.a.oa))};H.kj=function(){var a=this.a.h[Ga](function(a){return a instanceof T});null!=this.a.N&&this.a.N[F](function(b){b.K instanceof T&&a[x](b.K)});0<a[C]&&(this.Ef=new Gg(a))};H.sj=function(){this.Xg=new Eg(this.a.h||[],this.a.oa||null)};
...
function th(a){U[q](this,1,1);this.mg=a}K(th,U);f(th[r],function(){return"groupBy("+this.mg.map(function(a){return a.l()})[D]()+")"});th[r].na=function(a,b){return this.Wh(b[0])};th[r].Wh=function(a){var b=new hg,c=function(a){return this.mg.map(function(b){return a.S(b)},this)[La](",")}[E](this);a[B][F](function(a){b.add(c(a),a)},this);return b.U().map(function(c){return new me(b.get(c),a.Y())},this)};
function uh(a){L(1<a[C],"Should only be called for cross-column indices.");a=a.map(function(a){return a.f()});a=zd[xb](null,a);var b=[];yd(a,function(a){b[x](a)});return b}function vh(a){this.Xb=a}vh[r].Ld=function(){return 1==this.Xb.h[C]?[ke()]:[this.Xb.h.map(function(){return ke()})]};function wh(a,b){this.Xb=a;this.va=b;this.ye=this.Fg=null}
wh[r].Xh=function(a){var b=new N;this.va.U()[F](function(c){var d=this.va.get(c).map(function(b){return a.Od(b)},this),g=new Qf([ke()]);d[F](function(a){a=new Qf(a.ql());g=Rf(g,a)});b.set(c,g)},this);return b};wh[r].cj=function(a){for(var b=this.Xb.h[C]-1;0<=b;b--){var c=this.Xb.h[b];if(null!==a.get(c.ga[t](),null))break;a.set(c.ga[t](),new Qf([ke()]))}};wh[r].Ld=function(a){if(this.Fg==a)return this.ye;var b=this.Xh(a);this.cj(b);this.ye=1==this.Xb.h[C]?b.f()[0].f():uh(this.Sj(b));this.Fg=a;return this.ye};
wh[r].Sj=function(a){var b=new N,c=0;this.Xb.h[F](function(a){b.set(a.ga[t](),c);c++});return a.U()[Za](function(a,c){return b.get(a)-b.get(c)}).map(function(b){return a.get(b)})};
function xh(a,b){this.oh=b;this.J=a.o(Jd)}xh[r].pi=function(a,b){var c=b[Ga](this.lk,this);if(0==c[C])return null;c=this.oj(c);if(0==c[C])return null;if(1==c[C])return c[0];var d=Number.MAX_VALUE;return c[Ka](function(b,c){var l=c.Vh(a);return l<d?(d=l,c):b},null)};xh[r].oj=function(a){return this.oh.za().map(function(b){b=new yh(this.J,b);b.wi(a);return b},this)[Ga](function(a){return a.rk()})};xh[r].lk=function(a){return a instanceof He&&a.ug()?a.K.M()==this.oh:!1};
function yh(a,b){this.J=a;this.Cb=b;this.pg=new O;this.pg[hb](this.Cb.h.map(function(a){return a.ga[t]()}));this.Ve=this.va=null}H=yh[r];H.Mj=function(){return null===this.va?[]:this.va.f()};H.gg=function(){L(this.va);null===this.Ve&&(this.Ve=new wh(this.Cb,this.va));return this.Ve};H.wi=function(a){a[F](function(a){var c=a.ob()[0][t]();this.pg[tb](c)&&(null===this.va&&(this.va=new hg),this.va.add(c,a.fa()))},this)};
...
function zh(a,b,c,d){U[q](this,0,-1);this.J=a.o(Jd);this.index=b;this.Dg=c;this.kf=d;this.td=this.sd=!1}K(zh,U);f(zh[r],function(){return"index_range_scan("+this[mb].l()+", ?, "+(this.kf?"reverse":"natural")+(this.sd?", limit:?":"")+(this.td?", skip:?":"")+")"});zh[r].pd=function(a){var b=this[D](),c=this.Dg.Ld(a),b=b[eb]("?",c[D]());this.sd&&(b=b[eb]("?",a.ba[D]()));this.td&&(b=b[eb]("?",a.V[D]()));return b};
zh[r].na=function(a,b,c){a=this.Dg.Ld(c);b=this.J.get(this[mb].l());c=(1==a[C]&&a[0]instanceof ie&&a[0].xg()?pf(b.get(a[0].c),!1,this.sd?c.ba:void 0,this.td?c.V:void 0):b.pb(a,this.kf,this.sd?c.ba:void 0,this.td?c.V:void 0)).map(function(a){return new hd(a,{})},this);return[se(c,[this[mb].rf])]};
function Ah(a){U[q](this,1,1);this.be=a}K(Ah,U);f(Ah[r],Kb("select(?)"));Ah[r].pd=function(a){a=a.Od(this.be);return this[D]()[eb]("?",a[D]())};Ah[r].na=function(a,b,c){return[c.Od(this.be).eval(b[0])]};
function Bh(a,b){U[q](this,1,1);this.ua=a.o(Id);this.O=b}K(Bh,U);f(Bh[r],function(){return"table_access_by_row_id("+this.O[t]()+")"});Bh[r].na=function(a,b){return[se(this.ua.get(b[0].Rj()),[this.O.qa()])]};
...
function Dh(a){this.m=a}K(Dh,Lg);Dh[r].Mb=function(a,b){this.la=a;Uf(a,function(a){return a instanceof Ch})[F](function(a){var d=this.ij(a);if(0!=d[C]){var g=(new xh(this.m,a[k])).pi(b,d.map(function(a){return b.Od(a.be)}));if(null!==g){var h=new N;d[F](function(a){h.set(a.be,a)},this);this.la=this.al(g,h,a,b)}}},this);return this.la};Dh[r].ij=function(a){var b=[];for(a=a[Bb]();a;)a instanceof Ah&&b[x](a),a=a[Bb]();return b};
Dh[r].al=function(a,b,c){a.Mj().map(function(a){return b.get(a)})[F](Vf);a=new zh(this.m,a.Cb,a.gg(),!1);var d=new Bh(this.m,c[k]);d.ma(a);Zf(c,c,d,a);return a.qb()};
function Eh(a,b){U[q](this,0,-1);this.J=a.o(Jd);this.O=b}K(Eh,U);f(Eh[r],function(){return"insert("+this.O[t]()+")"});Eh[r].na=function(a,b,c){Fh(this.O,c[db],this.J);a.Db(this.O,c[db]);return[se(c[db],[this.O[t]()])]};function Fh(a,b,c){a=a.Jb().Pd();if(null===a?0:a.h[0][ob]){var d=a.h[0].ga[t]();c=c.get(a.l()).max();var g=null===c?0:c[0];b[F](function(a){if(0==a.w()[d]||null==a.w()[d])g++,a.w()[d]=g})}}function Gh(a,b){U[q](this,0,-1);this.J=a.o(Jd);this.O=b}K(Gh,U);
f(Gh[r],function(){return"insert_replace("+this.O[t]()+")"});Gh[r].na=function(a,b,c){Fh(this.O,c[db],this.J);a.Pe(this.O,c[db]);return[se(c[db],[this.O[t]()])]};
function Hh(a,b){U[q](this,2,0);this.Wg=a;this.zg=b}K(Hh,U);f(Hh[r],function(){return(this.zg?"left_outer_join":"join")+"("+this.Wg[D]()+")"});Hh[r].na=function(a,b){return[this.Wg.Oi(b[0],b[1],this.zg)]};
function Ih(){U[q](this,1,1)}K(Ih,U);f(Ih[r],Kb("limit(?)"));Ih[r].pd=function(a){return this[D]()[eb]("?",a.ba[D]())};Ih[r].na=function(a,b,c){b[0][B][A](c.ba);return b};
function Jh(a){U[q](this,-1,1);this.N=a}K(Jh,U);H=Jh[r];f(H,function(){return"order_by("+Le(this.N)+")"});H.na=function(a,b){if(1==b[C]){var c=this.ej(b[0]);(null===c?b[0]:b[0].wc(c))[B][Za](this.Li[E](this))}else b[Za](this.Xk[E](this));return b};H.ej=function(a){for(var b=null,c=0;c<this.N[C];c++){var d=ng(this.N[c].K);if(a.ck(d)){b=d;break}}return b};
...
function Kh(a,b){this.Ja=a;this.H=b}Kh[r].lg=function(){return this.H[ab](function(a){return a instanceof T},this)?this.ak():this.bk()};
Kh[r].ak=function(){if(1==this.H[C]&&"DISTINCT"==this.H[0].lc){var a=this.Ja.wc(this.H[0])[B].map(function(a){var b=new te(new hd(-1,{}),this.Ja.Se());b.nf(this.H[0],a.S(this.H[0][jb]));return b},this);return new me(a,[])}var b=new te(new hd(-1,{}),this.Ja.Se());this.H[F](function(a){var d=a instanceof T?this.Ja.wc(a):this.Ja[B][0].S(a);b.nf(a,d)},this);return new me([b],this.Ja.Y())};
Kh[r].bk=function(){var a=e(this.Ja[B][C]),b=this.Ja.Se();this.Ja[B][F](function(c,d){a[d]=new te(new hd(c.wa.id(),{}),b);this.H[F](function(b){a[d].nf(b,c.S(b))},this)},this);return new me(a,this.Ja.Y())};function Lh(a,b){var c=a.map(function(a){return(new Kh(a,b)).lg()[B][0]});return new me(c,a[0].Y())};
function Mh(a,b){U[q](this,-1,1);this.h=a;this.Wb=b}K(Mh,U);H=Mh[r];f(H,function(){var a="project("+this.h[D]();if(null!==this.Wb)var b=this.Wb.map(function(a){return a.l()})[La](", "),a=a+(", groupBy("+b+")");return a+")"});H.na=function(a,b){return 0==b[C]?[pe()]:1==b[C]?[this.Wi(b[0])]:[this.Ui(b)]};H.dk=function(){return this.h[ab](function(a){return a instanceof T})||null!==this.Wb};H.Ui=function(a){return Lh(a,this.h)};H.Wi=function(a){return 0==this.h[C]?a:(new Kh(a,this.h)).lg()};
function Nh(){U[q](this,1,1)}K(Nh,U);f(Nh[r],Kb("skip(?)"));Nh[r].pd=function(a){return this[D]()[eb]("?",a.V[D]())};Nh[r].na=function(a,b,c){return[new me(b[0][B][m](c.V),b[0].Y())]};
function Oh(){}K(Oh,Lg);Oh[r].Mb=function(a){var b=Uf(a,function(a){return a instanceof Ih||a instanceof Nh});if(0==b[C])return a;var c=this.hj(a);if(null===c)return a;b[F](function(a){this.Ak(a,c)},this);return c.qb()};Oh[r].Ak=function(a,b){a instanceof Ih?b.sd=!0:b.td=!0;return Vf(a).parent};Oh[r].hj=function(a){a=Uf(a,function(a){return a instanceof zh},function(a){return a instanceof Mh&&a.dk()||a instanceof Jh||1!=a.xa()||a instanceof Ah});return 0<a[C]?a[0]:null};
function Ph(a){this.m=a}K(Ph,Lg);Ph[r].Mb=function(a){var b=Qh(a);if(null===b)return a;a=this.Kh(b);a==b&&(a=this.Jh(b));return a.qb()};Ph[r].Kh=function(a){var b=a,c=Rh(a.zb(0));if(null!==c){var d;d=a.N;for(var g=null,h=c[k].za(),l=0;l<h[C]&&null===g;l++)g=Sh(h[l],d);d=g;if(null===d)return b;b=new zh(this.m,d.Cb,new vh(d.Cb),d.Ag);d=new Bh(this.m,c[k]);d.ma(b);Vf(a);b=Zf(c,c,d,b)}return b};
Ph[r].Jh=function(a){var b=a,c=Th(a.zb(0));if(null!==c){var d=Sh(c[mb],a.N);if(null===d)return b;c.kf=d.Ag;b=Vf(a).parent}return b};function Th(a){a=Uf(a,function(a){return a instanceof zh},function(a){return 1!=a.xa()});return 0<a[C]?a[0]:null}function Rh(a){a=Uf(a,function(a){return a instanceof Ch},function(a){return 1!=a.xa()});return 0<a[C]?a[0]:null}function Qh(a){a=Uf(a,function(a){return a instanceof Jh});return 0<a[C]?a[0]:null}
function Sh(a,b){if(a.h[C]!=b[C]||!b[Ua](function(b,c){return b.K[t]()==a.h[c].ga[t]()}))return null;var c=Uh(b,a);return c[0]||c[1]?{Cb:a,Ag:c[1]}:null}function Uh(a,b){var c=a[Ka](function(a,b){return a<<1|(0==b.tb?0:1)},0),d=b.h[Ka](function(a,b){return a<<1|(0==b.tb?0:1)},0),d=c^d,c=0==d,d=d==ba.pow(2,ba.max(a[C],b.h[C]))-1;return[c,d]};
function Vh(a,b,c){this.Fa=a;this.ff=b;this.lf=c}Vh[r].vc=function(){this.lf[F](function(a){this.Fa=a.Mb(this.Fa,this.ff)},this);return this.Fa};
function Wh(a,b){U[q](this,1,1);this.O=a;this.zl=b}K(Wh,U);f(Wh[r],function(){return"update("+this.O[t]()+")"});Wh[r].na=function(a,b){var c=b[0][B].map(function(a){var b=this.O.sc(a.wa.Ka());this.zl[F](function(a){b.w()[a.K[t]()]=a[u]},this);return b},this);a[Va](this.O,c);return[pe()]};
function Xh(a){this.m=a}Xh[r].create=function(a,b){var c=a.qb();if(c instanceof yg||c instanceof xg)return this.Be(a,b);if(c instanceof Eg||c instanceof Ig||c instanceof Jg)return this.Be(a,b,[new Dh(this.m),new Ph(this.m),new Oh]);if(c instanceof zg||c instanceof Ag)return this.Be(a,b,[new Dh(this.m)]);throw new P(8);};Xh[r].Be=function(a,b,c){var d=Sf(a.qb(),J(this.wk,this));null!=c&&(d=(new Vh(d,b,c)).vc());return new Me(d,a.ha())};
Xh[r].wk=function(a){if(a instanceof Eg)return new Mh(a.h,a.Wb);if(a instanceof Hg)return new th(a.h);if(a instanceof Gg)return new og(a.h);if(a instanceof Fg)return new Jh(a.N);if(a instanceof Jg)return new Nh;if(a instanceof Ig)return new Ih;if(a instanceof Bg)return new Ah(a.Da.fa());if(a instanceof Dg)return new Og;if(a instanceof Kg)return new Hh(a.Da,a.yg);if(a instanceof Cg)return new Ch(this.m,a[k]);if(a instanceof zg)return new sh(a[k]);if(a instanceof Ag)return new Wh(a[k],a.wf);if(a instanceof
yg)return new Gh(this.m,a[k]);if(a instanceof xg)return new Eh(this.m,a[k]);throw new P(514);};

function Yh(a){this.uk=new rh;this.Lk=new Xh(a)}Yh[r].Lj=function(a){var b=this.uk[kb](a);return this.Lk[kb](b,a)};
function Zh(){this.Jg=new N}H=Zh[r];H.Kd=function(a){var b=this.Jg.get(a[t](),null);null===b&&(b=new $h,this.Jg.set(a[t](),b));return b};H.Yj=function(a,b,c){b[F](function(b){this.Kd(b).Xj(a,c)},this)};H.Zh=function(a,b,c){return b[Ua](function(b){return this.Kd(b).Yh(a,c)},this)};H.$g=function(a,b,c){var d=this.Zh(a,b,c);d&&this.Yj(a,b,c);return d};H.releaseLock=function(a,b){b[F](function(b){this.Kd(b).releaseLock(a)},this)};H.ri=function(a){a[F](function(a){this.Kd(a).hb=null},this)};
function $h(){this.ic=this.Ya=this.hb=this.Rc=null}$h[r].releaseLock=function(a){this.Rc==a&&(this.Rc=null);this.hb==a&&(this.hb=null);null===this.Ya||this.Ya[w](a);null===this.ic||this.ic[w](a)};$h[r].Yh=function(a,b){var c=null===this.Ya||this.Ya.Wa();return 0==b?(null===this.ic||this.ic.Wa())&&c&&null===this.Rc&&null!==this.hb&&this.hb==a:3==b?null===this.Rc&&null===this.hb&&null!==this.Ya&&this.Ya[tb](a):1==b?null===this.hb:c&&(null===this.hb||this.hb==a)};
$h[r].Xj=function(a,b){0==b?(this.hb=null,this.Rc=a):3==b?(null===this.ic&&(this.ic=new O),this.ic.add(a),null===this.Ya&&(this.Ya=new O),this.Ya[w](a)):1==b?(null===this.Ya&&(this.Ya=new O),this.Ya.add(a)):2==b&&(this.hb=a)};
function ai(){this.ec=new bi;this.ed=new Zh}H=ai[r];H.gc=function(a){(2>a[Db]()||2>a[Db]())&&this.ed.ri(a.ha().f());this.ec.Db(a);this.Ae();return a.Zc().ka};H.Ae=function(){for(var a=this.ec.f(),b=0;b<a[C];b++){var c=a[b],d=!1;if(d=0==c.Z()?this.ah(c,1,3):this.ah(c,2,0))this.ec[w](c),this.Xi(c)}};H.ah=function(a,b,c){var d=!1,g=a.ha().f();this.ed.$g(a.fa(),g,b)&&(d=this.ed.$g(a.fa(),g,c));return d};H.Xi=function(a){a[Qa]()[z](J(this.Hk,this,a),J(this.Gk,this,a))};
H.Hk=function(a,b){this.ed.releaseLock(a.fa(),a.ha().f());a.Zc()[Fb](b);this.Ae()};H.Gk=function(a,b){this.ed.releaseLock(a.fa(),a.ha().f());a.Zc()[Ma](b);this.Ae()};function bi(){this.ec=[]}bi[r].Db=function(a){wc(this.ec,a,function(a,c){var d=a[Db]()-c[Db]();return 0==d?a.fa()-c.fa():d})};bi[r].f=function(){return this.ec[m]()};va(bi[r],function(a){var b=this.ec;a=ic(b,a);var c;(c=0<=a)&&oc(b,a);return c});

function ci(a,b){this.Ni=xe.He();this.gf=a;this.Yd=b;this.H=this.Gi()}ci[r].Gi=function(){if(0<this.gf.h[C])return this.gf.h;var a=[];this.gf.c[F](function(b){b.ob()[F](function(b){a[x](b)})});return a};ci[r].X=function(a,b){return this.H[Ua](function(c){return this.Ni.Fe(c.Z(),"eq")(a.S(c),b.S(c))},this)};
ci[r].Ih=function(a,b){for(var c=null===a?[]:a[B],d=qd(c,b[B],J(this.X,this),function(a){return c[a]}),g=[],h=0,l=0;l<c[C];l++){var p=c[l];d[h]==p?h++:(p=this.Yd[A](h,1),p=di(l,p,0,this.Yd),g[x](p))}d=qd(c,b[B],J(this.X,this),function(a,c){return b[B][c]});for(l=h=0;l<b[B][C];l++)p=b[B][l],d[h]==p?h++:(this.Yd[A](l,0,p.wa.w()),p=di(l,[],1,this.Yd),g[x](p));return g};function di(a,b,c,d){return{Al:c,index:a,object:d,Cl:b,type:"splice"}};
function ei(){this.uc=new N}H=ei[r];H.Ke=function(a){return Vb(a)[D]()};H.me=function(a,b){var c=this.Ke(a.Nd()),d=this.uc.get(c,null);null===d&&(d=new fi(a),this.uc.set(c,d));d.me(b)};H.jf=function(a,b){var c=this.Ke(a.Nd()),d=this.uc.get(c,null);L(null!=d,"Attempted to unobserve a query that was not observed.");var g=d.jf(b);L(g,"removeObserver: Inconsistent state detected.");d.fk()||this.uc[w](c)};
H.Me=function(a){var b=new O;a[F](function(a){b.add(a[t]())});var c=[];this.uc.f()[F](function(a){a=a.ad();a[nb].c[ab](function(a){return b[tb](a[t]())})&&c[x](a)});return c};H.uh=function(a,b){var c=this.Ke(null!=a.Kc?a.Kc:a),c=this.uc.get(c,null);return null!==c?(c.yl(b),!0):!1};function fi(a){this.Th=a;this.jd=new O;this.Ek=[];this.Gg=null;this.Ji=new ci(a.Nd(),this.Ek)}H=fi[r];H.me=function(a){this.jd[tb](a)?ec("Attempted to register observer twice."):this.jd.add(a)};H.jf=function(a){return this.jd[w](a)};
...
function ii(a){this.m=a;this.$a=a.o(Ld);this.qd=null;this.La=0}I("lf.proc.Transaction",ii,void 0);var ji=new N(0,new O([1,4]),1,new O([2]),2,new O([3,5,6]),3,new O([2,7]),4,new O([7]),5,new O([7]),6,new O([7]));ii[r].Ra=function(a){var b=ji.get(this.La,null);if(null===b||!b[tb](a))throw new P(107,this.La,a);this.La=a};
ma(ii[r],function(a){this.Ra(4);var b=[];try{a[F](function(a){a.mb();b[x](a.ad())},this)}catch(c){return this.Ra(7),Yc(c)}a=new Pg(this.m,b);return this.$a.gc(a)[z](J(function(a){this.Ra(7);return a.map(function(a){return a.Ie()})},this),J(function(a){this.Ra(7);throw a;},this))});ma(ii[r],ii[r][Qa]);ii[r].Rh=function(a){this.Ra(1);this.qd=new hi(this.m,a);return this.qd.yh()[z](J(function(){this.Ra(2)},this))};ii[r].begin=ii[r].Rh;
ii[r].Ph=function(a){this.Ra(3);return this.qd.Qh(a)[z](J(function(a){this.Ra(2);return a},this),J(function(a){this.Ra(7);throw a;},this))};ii[r].attach=ii[r].Ph;ii[r].pa=function(){this.Ra(5);return this.qd.pa()[z](J(function(){this.Ra(7)},this))};ii[r].commit=ii[r].pa;ii[r].Nb=function(){this.Ra(6);return this.qd.Nb()[z](J(function(){this.Ra(7)},this))};ii[r].rollback=ii[r].Nb;
function X(a){this.m=a;this.s=a.o(Nd);this.Oe=!1}I("lf.proc.Database",X,void 0);X[r].Ha=function(a){this.m.ub(Nd,this.s);return gi(this.m,a)[z](J(function(){this.Oe=!0;return this},this))};X[r].init=X[r].Ha;X[r].Bb=G("s");X[r].getSchema=X[r].Bb;X[r].qc=function(){if(!this.Oe)throw new P(2);};X[r].select=function(a){this.qc();return new W(this.m,1!=arguments[C]||null!=arguments[0]?e[r][m][q](arguments):[])};X[r].select=X[r].select;X[r].Db=function(){this.qc();return new eh(this.m)};X[r].insert=X[r].Db;
X[r].Pe=function(){this.qc();return new eh(this.m,!0)};X[r].insertOrReplace=X[r].Pe;qa(X[r],function(a){this.qc();return new ih(this.m,a)});qa(X[r],X[r][Va]);ra(X[r],function(){this.qc();return new dh(this.m)});X[r]["delete"]=X[r][Ya];X[r].observe=function(a,b){this.m.o(Md).me(a,b)};X[r].observe=X[r].observe;X[r].unobserve=function(a,b){this.m.o(Md).jf(a,b)};X[r].unobserve=X[r].unobserve;X[r].Ei=function(){this.qc();return new ii(this.m)};X[r].createTransaction=X[r].Ei;
oa(X[r],function(){try{this.m.o(Hd)[Ra]()}catch(a){}this.m[v]();this.Oe=!1});oa(X[r],X[r][Ra]);
function Y(a,b,c,d,g,h){this.O=a;this.A=b;this.Cg=c;this.wg=d;this.th=g;this.lb=h||null}I("lf.schema.BaseColumn",Y,void 0);H=Y[r];na(H,G("A"));H.l=function(){return this.O.qa()+"."+this.A};f(H,function(){return this.l()});H.M=G("O");H.Z=G("th");Y[r].getType=Y[r].Z;Y[r].cb=G("lb");Y[r].za=function(){null==this.ia&&(this.ia=[],this.M().za()[F](function(a){-1!=a.h.map(function(a){return a.ga[t]()})[$a](this.A)&&this.ia[x](a)},this));return this.ia};Y[r].Yb=G("wg");Y[r].isNullable=Y[r].Yb;Y[r].dd=G("Cg");
...
function ki(){this.he=new N}var li;ta(ki[r],function(){this.he[v]()});ta(ki[r],ki[r][v]);ki[r].ub=function(a,b){this.he.set(a[D](),b);return b};ki[r].registerService=ki[r].ub;ki[r].o=function(a){var b=this.he.get(a[D](),null);if(null==b)throw new P(7,a[D]());return b};ki[r].getService=ki[r].o;ki[r].Ue=function(a){return this.he.C(a[D]())};ki[r].isRegistered=ki[r].Ue;
function mi(a){this.s=a;this.hf=new Dd;this.Rg=new Dd;this.Qf=new Dd;this.i=new Dd;this.xe=new Dd;this.jk()}H=mi[r];H.jk=function(){this.s.ab()[F](function(a){var b=new mf;a.Jb().Ge()[F](function(c){var d=this.hf.get(c.fb)||[];d[x](c);this.hf.set(c.fb,d);b.add(this.s[k](c.fb));(d=this.i.get(c.fb))||(d=new mf);d.add(a);this.i.set(c.fb,d);this.Qf.set(a[t]()+"."+c.Rb,c.fb);c=c.fb+"."+c.Ac;d=this.xe.get(c)||[];d[x](a[t]());this.xe.set(c,d)},this);0!=b[Hb]&&this.Rg.set(a[t](),b)},this)};
H.Oj=function(a){return this.hf.get(a)||null};H.Zf=function(a,b){var c=b.get(a);return c?nf(c):[]};H.Jj=function(a){return this.Zf(a,this.Rg)};H.Kj=function(a){var b=new mf;a[F](function(a){(a=this.Qf.get(a))&&b.add(a)},this);return nf(b).map(function(a){return this.s[k](a)},this)};H.bg=function(a){return this.Zf(a,this.i)};H.zj=function(a){var b=new mf;a[F](function(a){(a=this.xe.get(a))&&a[F](function(a){b.add(a)})},this);return nf(b).map(function(a){return this.s[k](a)},this)};
function ni(a,b,c){this.Ok=a;this.Ck=b;this.jj=c}I("lf.schema.Constraint",ni,void 0);ni[r].Pd=G("Ok");ni[r].getPrimaryKey=ni[r].Pd;ni[r].Gj=G("Ck");ni[r].Ge=G("jj");ni[r].getForeignKeys=ni[r].Ge;
...
Z[r].Xd=function(a,b,c,d){var g=a,g="string"==typeof a[0]?a.map(function(a){return new pi({name:a,order:null!=c?c:1,autoIncrement:d||!1})}):a.map(function(a){return new pi(a)});g[F](function(a){if(!this.H.has(a[n]))throw new P(508,this.A,a[n]);if(b){var c=this.H.get(a[n]);if(0==c||6==c)throw new P(509,this.A,a[n]);}},this);return g};
Z[r].xj=function(){function a(){function a(c){return b.ia.get(c).map(function(a){return{ga:this[a[n]],tb:a.tb,autoIncrement:a[ob]}},this)}var d=Ed(b.H).map(function(a){this[a]=new Y(this,a,b.uf.has(a),b.hd.has(a),b.H.get(a));return this[a]},this),g=Ed(b.ia).map(function(d){return new lg(b.A,d,b.rd.has(d),a[q](this,d))},this);S[q](this,b.A,d,g,b.ae);var h=null===b.Ca?null:new lg(b.A,b.Ca,!0,a[q](this,b.Ca)),l=d[Ga](function(a){return!b.hd.has(a[t]())});this.vi=new ni(h,l,b.Xc());this.eh=b.tj(d,g)}
var b=this;K(a,S);a[r].Ib=function(a){return new this.eh(id++,a)};a[r].createRow=a[r].Ib;a[r].sc=function(a){var b={};this.ob()[F](function(g){var h=g[t]();g=g.Z();var l=a[u][h];if(0==g)if(g=l,null!=g&&""!=g){0!=g[C]%2&&(g="0"+g);for(var l=new ArrayBuffer(g[C]/2),p=new Uint8Array(l),y=0,wa=0;y<g[C];y+=2)p[wa++]=da(g.substr(y,2),16);g=l}else g=null;else g=2==g?null!=l?new Date(l):null:l;b[h]=g},this);return new this.eh(a.id,b)};a[r].deserializeRow=a[r].sc;a[r].Jb=G("vi");a[r].getConstraint=a[r].Jb;
return a};
...
function ri(a,b){this.s=new si(a,b);this.wb=new N;this.Tc=!1}I("lf.schema.Builder",ri,void 0);H=ri[r];H.ei=function(a){a.Xc()[F](function(b){var c=b.fb;if(!this.wb.C(c))throw new P(536,b[n]);var c=this.wb.get(c).Bb(),d=b.Ac;if(!c[sb](d))throw new P(537,b[n]);if(a.Bb()[b.Rb].Z()!=c[d].Z())throw new P(538,b[n]);if(!c[d].dd())throw new P(539,b[n]);},this)};H.di=function(a){a.Xc()[F](function(a){this.wb.get(a.fb).Xc()[F](function(c){if(c.Rb==a.Ac)throw new P(534,a[n]);},this)},this)};
H.dj=function(){this.Tc||(this.wb.f()[F](function(a){this.ei(a);this.s.gl(a.Bb())},this),this.wb.f()[F](this.di,this),this.ci(),this.wb[v](),this.Tc=!0)};H.Lf=function(a,b){a.xf||(a.xf=!0,a.$e=!0,a.Yf[F](function(c){c=b.get(c);if(!c.xf)this.Lf(c,b);else if(c.$e&&a!=c)throw new P(533);},this));a.$e=!1};H.ci=function(){var a=new Dd;this.s.I.U()[F](function(b){a.set(b,new ti(b))},this);this.wb[F](function(b,c){b.Xc()[F](function(b){a.get(b.fb).Yf.add(c)})});Fd(a)[F](function(b){this.Lf(b,a)},this)};
function ti(a){this.$e=this.xf=!1;this.Yf=new mf;this.rf=a}H.Bb=function(){this.Tc||this.dj();return this.s};ri[r].getSchema=ri[r].Bb;ri[r].fg=function(){var a=new Gd("ns_"+this.s[n]()),b;li||(li=new ki);b=li;var c=null;b.Ue(a)?c=b.o(a):(c=new ki,b.ub(a,c));return c};ri[r].getGlobal=ri[r].fg;ri[r].connect=function(a){var b=this.fg();b.Ue(Nd)||b.ub(Nd,this.Bb());return(new X(b)).Ha(a)};ri[r].connect=ri[r].connect;
ri[r].Ci=function(a){if(this.wb.C(a))throw new P(503,a);if(this.Tc)throw new P(535);this.wb.set(a,new Z(a));return this.wb.get(a)};ri[r].createTable=ri[r].Ci;ri[r].pf=function(a){if(this.Tc)throw new P(535);this.s.pf(a);return this};ri[r].setPragma=ri[r].pf;function si(a,b){this.A=a;this.Ta=b;this.I=new N;this.Vg={Ki:!1}}I("lf.schema.DatabaseSchema",si,void 0);ja(si[r],G("A"));ja(si[r],si[r][n]);si[r].version=G("Ta");si[r].version=si[r][ub];si[r].ab=function(){return this.I.f()};si[r].tables=si[r].ab;
ia(si[r],function(a){if(!this.I.C(a))throw new P(101,a);return this.I.get(a)});ia(si[r],si[r][k]);si[r].info=function(){this.qg||(this.qg=new mi(this));return this.qg};si[r].gl=function(a){this.I.set(a[t](),a)};si[r].Ug=G("Vg");si[r].pragma=si[r].Ug;si[r].pf=Jb("Vg");I("lf.schema.create",function(a,b){return new ri(a,b)},void 0);}.bind(window))()
