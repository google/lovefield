...
lf.cache.Journal.prototype.getIndexScope=function(){var a=[],b=this.scope_.getValues();b.forEach(function(b){if(b.persistentIndex()){var d=b.getIndices();d.forEach(function(b){a.push(b.getNormalizedName())});a.push(b.getName()+".#")}});return a};lf.cache.Journal.prototype.getIndexRange=function(a,b,c){var d=new goog.structs.Set,e=this.indexStore_.get(a.getNormalizedName());b.forEach(function(a){d.addAll(e.getRange(a,c))},this);return d.getValues()};
...
lf.index.slice=function(a,b,c,d){if(!goog.isDefAndNotNull(c)&&!goog.isDefAndNotNull(d))return b==lf.Order.DESC&&a.reverse(),a;c=Math.min(goog.isDef(c)?c:a.length,a.length);if(0==c)return[];d=Math.min(d||0,a.length);b==lf.Order.DESC&&a.reverse();return a.slice(d,d+c)};
...
lf.index.BTree.prototype.remove=function(a,b){this.root_=this.root_.remove(a,b)};lf.index.BTree.prototype.get=function(a){return this.root_.get(a)};lf.index.BTree.prototype.cost=function(a){return this.getRange(a).length};lf.index.BTree.prototype.getRange=function(a,b,c,d){var e=null;a&&(goog.isNull(a.from)||(e=this.root_.getContainingLeaf(a.from)));null==e&&(e=this.root_.getLeftMostNode());return lf.index.slice(e.getRange(a),b,c,d)};lf.index.BTree.prototype.clear=function(){this.root_=lf.index.BTreeNode_.create(this)};
...
lf.index.RowId.prototype.get=function(a){return this.containsKey(a)?[a]:[]};lf.index.RowId.prototype.cost=function(){return this.rows_.getCount()};lf.index.RowId.prototype.getRange=function(a,b,c,d){a=a||lf.index.KeyRange.all();if(goog.isDefAndNotNull(a.from)&&"number"!=typeof a.from||goog.isDefAndNotNull(a.to)&&"number"!=typeof a.to)throw new lf.Exception(lf.Exception.Type.DATA,"Row id must be numbers");return lf.index.slice(this.rows_.getValues().filter(a.getComparator()),b,c,d)};
...
lf.index.AATree.prototype.getRange=function(a,b,c,d){var e=null;goog.isDefAndNotNull(a)?(e=a,goog.isNull(e.from)&&(e.from=this.findMin_().key),goog.isNull(e.to)&&(e.to=this.findMax_().key)):e=new lf.index.KeyRange(this.findMin_().key,this.findMax_().key,!1,!1);a=[];this.traverse_(this.root_,e,a);return lf.index.slice(a,b,c,d)};lf.index.AATree.prototype.clear=function(){this.root_=this.nullNode_};lf.index.AATree.prototype.containsKey=function(a){return null!=this.search_(this.root_,a)};
...
lf.index.Map.prototype.get=function(a){a=this.map_.get(a);return goog.isDefAndNotNull(a)?a.getValues():[]};lf.index.Map.prototype.cost=function(a){return this.getRange(a).length};lf.index.Map.prototype.getRange=function(a,b,c,d){var e=[];a=a||lf.index.KeyRange.all();var f=a.getComparator();this.map_.getKeys().sort().forEach(function(a){f(a)&&(e=e.concat(this.get(a)))},this);return lf.index.slice(e,b,c,d)};lf.index.Map.prototype.clear=function(){return this.map_.clear()};
