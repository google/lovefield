...
function hd(a,b){this.Ba=a;this.cc=b||this.Vf()}var id=0;H=hd[r];H.id=G("Ba");H.Oh=Jb("Ba");H.w=G("cc");H.Vf=function(){return{}};H.qh=G("cc");H.Ka=function(){return{id:this.Ba,value:this.qh()}};H.Zb=function(a){return"#"==a.substr(-1)?this.Ba:null};function jd(a){return new hd(a.id,a[u])}function kd(a){return new hd(id++,a||{})}function ld(a){if(null==a)return null;a=new Uint8Array(a);for(var b="",c=0;c<a[C];++c)var d=a[c][D](16),b=b+(2>d[C]?"0"+d:d);return b};
...
function Qd(a,b,c){if("function"==typeof a[Ua])return a[Ua](b,c);if(Sb(a)||Tb(a))return nc(a,b,c);var d;if("function"==typeof a.U)d=a.U();else if("function"!=typeof a.f)if(Sb(a)||Tb(a)){d=[];for(var g=a[C],k=0;k<g;k++)d[x](k)}else d=Cc(a);else d=void 0;for(var g=Pd(a),k=g[C],l=0;l<k;l++)if(!b[q](c,g[l],d&&d[l],a))return!1;return!0};function O(a){this.g=new N;a&&this[hb](a)}function Rd(a){var b=typeof a;return"object"==b&&a||"function"==b?"o"+Vb(a):b.substr(0,1)+a}H=O[r];H.za=function(){return this.g.za()};H.add=function(a){this.g.set(Rd(a),a)};H.addAll=function(a){a=Pd(a);for(var b=a[C],c=0;c<b;c++)this.add(a[c])};va(H,function(a){return this.g[w](Rd(a))});ta(H,function(){this.g[v]()});H.Wa=function(){return this.g.Wa()};H.contains=function(a){return this.g.C(Rd(a))};H.xi=function(a){return Qd(a,this[tb],this)};H.f=function(){return this.g.f()};
la(H,function(){return new O(this)});H.Qc=function(a){return this.za()==Od(a)&&this.qk(a)};H.qk=function(a){var b=Od(a);if(this.za()>b)return!1;!(a instanceof O)&&5<b&&(a=new O(a));return Qd(this,function(b){var d=a;if("function"==typeof d[tb])b=d[tb](b);else if("function"==typeof d.Cd)b=d.Cd(b);else if(Sb(d)||Tb(d))b=0<=ic(d,b);else a:{for(var g in d)if(d[g]==b){b=!0;break a}b=!1}return b})};H.Dc=function(){return this.g.Dc(!1)};
function Sd(a,b){this.Ba=a;this.cc=b||{}}function Td(a){var b=new O;a[F](function(a){b.add(a>>9)});return b.f()}H=Sd[r];H.fa=G("Ba");H.xc=G("cc");H.jh=function(a){a[F](function(a){this.cc[a.id()]=a.Ka()},this)};H.Zk=function(a){a[F](function(a){var c=this.cc;a in c&&delete c[a]},this)};H.Ka=function(){return{id:this.Ba,value:ga[yb](this.cc)}};function Ud(a){return new Sd(a.id,ga.parse(a[u]))};
...
Zd[r].vh=function(a,b){a.Aa().map(function(a){return this.J.get(a.l())},this)[Sa]([this.J.get(a.Vb())])[F](function(a){var d=null===b[1]?void 0:b[1].Zb(a[t]()),g=null===b[0]?void 0:b[0].Zb(a[t]());if(!Mb(g)&&Mb(d))a.add(d,b[1].id());else if(Mb(g)&&Mb(d)){if(null===d||null===g){if(d==g)return}else if(0==a.Mc()[Ab](g,d))return;a.add(d,b[1].id());a[w](g,b[0].id())}else Mb(g)&&!Mb(d)&&a[w](g,b[0].id())})};
...
H.ni=function(a,b){b[F](function(b){if(fe(b[0],b[1],a[n])){b=b[1].w()[a.Rb];var d=this.hg(a);if(null!==b&&!d.C(b))throw new P(203,a[n]);}},this)};H.hg=function(a){var b=this.s[h](a.fb)[a.Ac].Aa()[Ga](function(b){return 1==b.h[C]&&b.h[0].ga[t]()==a.Ac})[0];return this.J.get(b.l())};function fe(a,b,c){return(null===a?null!==b:null===b)||a.Zb(c)!=b.Zb(c)}
...
function he(a,b){this.ta=new N;b[F](function(a){this.ta.set(a[t](),a)},this);this.ua=a.o(Id);this.J=a.o(Jd);this.Ua=new ee(a);this.Vd=new Zd(a);this.cf=this.je=!1;this.Gb=new N}H=he[r];H.eg=G("Gb");H.Bj=function(){var a=[];this.Gb.U().map(function(a){return this.ta.get(a)},this)[F](function(b){b.Lb()&&(b.Aa()[F](function(b){a[x](this.J.get(b.l()))},this),a[x](this.J.get(b[t]()+".#")))},this);return a};H.ha=G("ta");
H.Cj=function(){var a=[];this.ta.f()[F](function(b){b.Lb()&&(b.Aa()[F](function(b){a[x](b.l())}),a[x](b[t]()+".#"))});return a};H.Eb=function(a,b){this.Hc();this.zd(a);this.Ua.we(a,b);this.Ua.ue(a,b,0);for(var c=0;c<b[C];c++)this.Wd(a,[null,b[c]])};
...
function me(a,b){this.entries=a;this.I=new O(b);this.Qb=null}H=me[r];H.mk=function(a){return this.I.Qc(a.I)};function ne(a,b){L(a.mk(b),"Intersection/union operations only apply to compatible relations.")}H.Y=function(){return this.I.f()};H.Se=function(){return 1<this.I.za()};H.Ie=function(){return this[B].map(function(a){return a.wa.w()})};H.Rj=function(){return this[B].map(function(a){return a.wa.id()})};H.el=function(a,b){null===this.Qb&&(this.Qb=new N);this.Qb.set(a.l(),b)};
...
I("lf.bind",function(a){return new we(a)},void 0);function we(a){this.ra=a}I("lf.Binder",we,void 0);we[r].Bb=G("ra");
...
function Fe(){De[q](this,"","");this.Ba=Ge++}K(Fe,De);var Ge=0;Fe[r].fa=G("Ba");Fe[r].of=Jb("Ba");
...
Ba(Ke[r],function(a){Ke.Pb[E][q](this,a);null!=this.$b&&(this.ba=a[this.$b.Bb()]);null!=this.jc&&(this.V=a[this.jc.Bb()]);this.re(a);return this});
function Me(a,b){this.Ga=a;this.ta=b}Me[r].qb=G("Ga");Me[r].$f=Kb("plan description");Me[r].ha=G("ta");function Ne(a){var b=new O;a[F](function(a){b[hb](a.ha())});return b};
...
Ve[r].Lc=function(){var a=this.Ej().eg();if(0==a.za())this.ca[Fb]();else{var b=this.j.Qj()+1;this.j.ih(b);var c={"@rev":{R:b}};a[F](function(a){var g=this.j.kg(a[t]());a.Uc()[F](function(a,d){c[d]={R:b,T:g,P:a.w()}});a.Yc()[F](function(a,d){c[d]={R:b,T:g,P:a[1].w()}});a.Wc()[F](function(a,b){c[b]=null})},this);this.j.Nj()[Va](c,function(c){if(null===c)this.ca[Fb]();else this.j.ih(b-1),c=a.f().map(function(a){return this.j.Yg(a[t]())},this),ad(c)[z](this.ca[Ma][E](this.ca),this.ca[Ma][E](this.ca))}[E](this))}return this.ca.ka};
function We(){this.zb=new Dd}H=We[r];H.Le=function(a){if(0==a[C])return Fd(this.zb);var b=[];a[F](function(a){a=this.zb.get(a)||null;null===a||b[x](a)},this);return b};H.getData=G("zb");H.get=function(a){return Xc(this.Le(a))};H.ef=function(a){a[F](function(a){this.zb.set(a.id(),a)},this)};H.put=function(a){this.ef(a);return Xc()};H.Zg=function(a){0==a[C]||a[C]==this.zb[Hb]?this.zb[v]():a[F](function(a){this.zb[Ya](a)},this)};va(H,function(a){this.Zg(a);return Xc()});
H.Fj=function(){return 0==this.zb[Hb]?0:Ed(this.zb)[Ka](function(a,b){return a>b?a:b},0)};
...
function cf(a){this.s=a;this.I=new Dd}H=cf[r];H.Ha=function(){this.s.ab()[F](this.ik,this);return Xc()};H.$c=function(a){var b=this.I.get(a)||null;if(null===b)throw new P(101,a);return b};H.Tb=function(a,b){return new bf(this,a,b)};H.Tf=function(a){if(!this.I.has(a)){var b=new We;this.I.set(a,b);return b}return null};H.ik=function(a){this.Tf(a[t]());a.Lb()&&(a.Aa()[F](function(a){this.Nc(a.l(),"btree")},this),this.Nc(a.Vb(),"rowid"))};H.Nc=function(a,b){var c=this.Tf(a);null===c||c.put([new nd(new md(b))])};
...
H.pb=function(a,b,c){var d=[],g=ba.min(b,c),k=ba.max(b,c);a=this.Sd(a);if(a[Hb]<k-g)a[F](function(a){a>=g&&a<=k&&(a=this.g.get(a),L(null!=a,"Inconsistent cache"),d[x](a))},this);else for(b=g;b<=k;++b)a.has(b)&&(c=this.g.get(b),L(null!=c,"Inconsistent cache"),d[x](c));return d};va(H,function(a,b){var c=this.Sd(a);b[F](function(a){this.g[Ya](a);c[Ya](a)},this)});H.za=function(a){return null!=a?this.Sd(a)[Hb]:this.g[Hb]};
...
function tf(a){var b=a,c=[];do c[x](b),b=b.Ca;while(b);if(512>=c[C])b=Bf(c);else{var d=c[C],g=0,b=vf(a.D);for(b.rb=a.rb+2;0<d;){a=768<=d?511:257<=d&&511>=d?d:257;var k=c[m](g,g+a),l=Bf(k);l.G=b;b.i[C]&&(b.b[x](k[0].b[0]),Af(b.i[b.i[C]-1],l));b.i[x](l);g+=a;d-=a}}return b}H.get=function(a){var b=this.nd(a);if(this.ja()){var c=uf;this.D.Va(this.b[b],a)&&(c=c[Sa](this.B[b]));return c}b=this.D.Va(this.b[b],a)?b+1:b;return this.i[b].get(a)};
...
H.ol=function(){var a=null,b,c,d;if(this.Ca&&256<this.Ca.b[C])a=this.Ca,c=b=0,d=this.b[C]+1;else if(this.Fb&&256<this.Fb.b[C])a=this.Fb,b=this.Fb.b[C]-1,c=this.ja()?b:b+1,d=0;else return!1;this.b[A](d,0,a.b[b]);a.b[A](b,1);b=this.ja()?this.B:this.i;var g=null;this.ja()?g=a.B:(g=a.i,g[c].G=this);b[A](d,0,g[c]);g[A](c,1);a.ja()||(a.Gd(),this.Gd());return!0};
H.Bk=function(a){var b,c,d;this.Ca&&511>this.Ca.b[C]?(b=this.Ca,d=c=0):this.Fb&&(b=this.Fb,c=b.b[C],d=b.ja()?b.B[C]:b.i[C]);c=[c,0][Sa](this.b);e[r][A][xb](b.b,c);c=null;this.ja()?c=this.B:(c=this.i,c[F](function(a){a.G=b}));c=[d,0][Sa](c);e[r][A][xb](b.ja()?b.B:b.i,c);Af(this.Fb,this.Ca);b.ja()||b.Gd();-1!=a&&(this.G.b[A](a,1),this.G.i[A](a,1))};
H.Eb=function(a,b,c){var d=this.nd(a);if(this.ja()){if(this.D.Va(this.b[d],a)){if(c)this.D.ib()[w](a,this.D.Na()?1:this.B[d][C]),this.B[d]=this.D.Na()?b:[b];else{if(this.D.Na())throw new P(201);if(!wc(this.B[d],b))throw new P(109);}this.D.ib().add(a,1);return this}this.b[A](d,0,a);this.B[A](d,0,this.D.Na()?b:[b]);this.D.ib().add(a,1);return 512==this.b[C]?this.ll():this}d=this.D.Va(this.b[d],a)?d+1:d;a=this.i[d].Eb(a,b,c);a.ja()||1!=a.b[C]||(this.b[A](d,0,a.b[0]),a.i[1].G=this,a.i[0].G=this,this.i[A](d,
1,a.i[1]),this.i[A](d,0,a.i[0]));return 512==this.b[C]?this.kl():this};H.ll=function(){var a=vf(this.D),b=vf(this.D);b.rb=1;b.b=[this.b[256]];b.i=[this,a];b.G=this.G;this.G=b;a.b=this.b[A](256);a.B=this.B[A](256);a.G=b;Af(a,this.Ca);Af(this,a);return b};H.kl=function(){var a=vf(this.D),b=vf(this.D);a.G=this.G;a.rb=this.rb+1;a.b=[this.b[256]];a.i=[this,b];this.b[A](256,1);b.G=a;b.rb=this.rb;b.b=this.b[A](256);b.i=this.i[A](257);b.i[F](function(a){a.G=b});this.G=a;Af(b,this.Ca);Af(this,b);return a};
...
H.aj=function(a){var b=new he(this.m,[a]),c=this.Hb.Tb(0,b),b=c.M(a[t](),a.sc).get([])[z](J(function(b){this.ua.set(a[t](),b)},this)),d=a.Aa().map(function(a){return this.Uk(a,c)},this)[Sa](this.Vk(a,c));return ad(d[Sa](b))};
...
function Sf(a,b){var c=[],d=null,g=null;a.Cc(function(a){var l=b(a);null==a[Bb]()?g=l:d.ma(l);var p=a[Bb]();null!==p&&p.ya()==d.ya()&&(p=c[$a](d),-1!=p&&c[A](p,1));1<a.ya()&&c[x](l);d=a.vg()?c[c[C]-1]:l});return g}function Tf(a){return Uf(a,function(a){return a.vg()})}function Vf(a){var b=a[Bb](),c=0;null!==b&&(c=b.ea()[$a](a),b[ib](a));var d=a.ea()[m]();d[F](function(d,k){a[ib](d);null===b||b.Ec(d,c+k)});return{parent:b,children:d}}
function Wf(a,b){a.ea()[m]()[F](function(c){a[ib](c);b.ma(c)});a.ma(b)}function Xf(a){L(1==a.ya());var b=a.Ab(0);L(1==b.ya());Vf(a);Wf(b,a);return b}function Yf(a,b,c){L(1==a.ya());var d=a.Ab(0);L(1<d.ya());var g=d.ea()[m]();if(!g[ab](function(a){return b(a)}))return a;Vf(a);g[F](function(g,l){if(b(g)){var p=c(a);d.fe(l);p.ma(g);d.Ec(p,l)}});return d}function Zf(a,b,c,d){var g=a[Bb]();null!==g&&(a=g.ea()[$a](a),g.fe(a),g.Ec(c,a));b.ea()[m]()[F](function(a){b[ib](a);d.ma(a)});return c}
...
H.za=G("aa");H.C=function(a){return this.g.C(a)};H.Cd=function(a){return mc(this.g.f(),function(b){return mc(b,function(b){return bg(b,a)})})};H.U=function(){return this.g.U()};H.f=function(){return yc(this.g.f())};H.getEntries=function(){for(var a=this.U(),b=[],c=0;c<a[C];c++)for(var d=a[c],g=this.get(d),k=0;k<g[C];k++)b[x]([d,g[k]]);return b};
function ig(a,b,c){Fe[q](this);this.Oa=a;this.Fa=b;this.L=c;this.Ye=null;this.Fd=xe.He().Fe(this.Oa.Z(),this.L)}K(ig,Fe);H=ig[r];H.Sb=function(){var a=new ig(this.Oa,this.Fa,this.L);a.of(this.fa());return a};H.ob=function(a){return null!=a?(a[x](this.Oa),a[x](this.Fa),a):[this.Oa,this.Fa]};H.reverse=function(){var a=this.L;switch(this.L){case "gt":a="lt";break;case "lt":a="gt";break;case "gte":a="lte";break;case "lte":a="gte"}return new ig(this.Fa,this.Oa,a)};
H.eval=function(a){var b=a[B][Ga](function(a){var b=a.S(this.Oa);a=a.S(this.Fa);return this.Fd(b,a)},this);return new me(b,a.Y())};f(H,function(){return"join_pred("+this.Oa.l()+", "+this.Fa.l()+")"});H.Ff=function(a){return-1!=a.Y()[$a](this.Oa.M().qa())};H.Hh=function(a){return-1!=a.Y()[$a](this.Fa.M().qa())};H.Hi=function(a,b){var c=null,d=null;this.Ff(a)?(this.Hf(a,b),c=a,d=b):(this.Hf(b,a),c=b,d=a);return[c,d]};
H.Hf=function(a,b){L(this.Ff(a),"Mismatch between join predicate left operand and right relation.");L(this.Hh(b),"Mismatch between join predicate right operand and right relation.")};H.Oi=function(a,b,c){var d=[a,b];c||(d=this.Hi(a,b));a=d[0];d=d[1];return"eq"==this.L?this.Pi(a,d,c):this.Qi(a,d,c)};H.zi=function(a){var b={};a.ob()[F](function(a){b[a[t]()]=null});return b};H.Sf=function(a,b){null===this.Ye&&(this.Ye=this.zi(this.Fa.M()));var c=new te(new hd(-1,this.Ye),!1);return ve(a,b,c,[this.Fa.M().qa()])};
H.Qi=function(a,b,c){for(var d=[],g=a.Y(),k=b.Y(),l=0;l<a[B][C];l++){for(var p=!1,y=0;y<b[B][C];y++)if(this.Fd(a[B][l].S(this.Oa),b[B][y].S(this.Fa))){var p=!0,wa=ve(a[B][l],g,b[B][y],k);d[x](wa)}c&&!p&&d[x](this.Sf(a[B][l],g))}a=a.Y()[Sa](b.Y());return new me(d,a)};
H.Pi=function(a,b,c){var d=a,g=b,k=this.Oa,l=this.Fa;if(c||a[B][C]>b[B][C])d=b,g=a,k=this.Fa,l=this.Oa;var p=new hg,y=[];d[B][F](function(a){var b=ha(a.S(k));p.add(b,a)});var wa=d.Y(),qb=g.Y();g[B][F](function(a){var b=ha(a.S(l));p.C(b)?p.get(b)[F](function(b){b=ve(a,qb,b,wa);y[x](b)}):c&&y[x](this.Sf(a,qb))}[E](this));a=a.Y()[Sa](b.Y());return new me(y,a)};
...
S[r].qa=function(){return this.lb||this.A};S[r].Gc=function(a){var b=new this.constructor(this.A);b.lb=a;b.Wk=this.Wk;return b};S[r].as=S[r].Gc;S[r].createRow=S[r].Ib;S[r].deserializeRow=S[r].sc;S[r].Aa=G("ia");S[r].getIndices=S[r].Aa;S[r].ob=G("H");S[r].getColumns=S[r].ob;S[r].getConstraint=S[r].Jb;S[r].Lb=G("ae");S[r].persistentIndex=S[r].Lb;S[r].Vb=function(){return this.A+".#"};
function T(a,b){xa(this,a);this.lc=b;this.lb=null}H=T[r];na(H,function(){return this.lc+"("+this[jb][t]()+")"});H.l=function(){return this.lc+"("+this[jb].l()+")"};H.M=function(){return this[jb].M()};f(H,function(){return this.l()});H.Z=function(){return this[jb].Z()};H.cb=G("lb");H.Aa=function(){return[]};H.Yb=Kb(!1);H.Gc=function(a){this.lb=a;return this};T[r].as=T[r].Gc;T[r].cg=function(){for(var a=[this],b=this;b instanceof T;)a[x](b[jb]),b=b[jb];return a};
function mg(a){this.lb=a||null;this.O=new S("#UnknownTable",[],[],!1)}H=mg[r];na(H,Kb("*"));H.l=function(){return this[t]()};f(H,function(){return this.l()});H.M=G("O");H.Z=Kb(4);H.cb=G("lb");H.Aa=function(){return[]};H.Yb=Kb(!1);
...
f(Jg[r],function(){return"limit("+this.ba+")"});function Kg(a){V[q](this);this.V=a}K(Kg,V);f(Kg[r],function(){return"skip("+this.V+")"});function Lg(a,b){V[q](this);this.Ea=a;this.yg=b}K(Lg,V);f(Lg[r],function(){return(this.yg?"left_outer_join":"join")+"("+this.Ea[D]()+")"});
function Mg(){};
function Ng(){}K(Ng,Mg);Ng[r].Mb=function(a){this.la=a;this.bb(this.la);return this.la};Ng[r].bb=function(a){if(a instanceof Cg){L(1==a.ya(),"SelectNode must have exactly one child.");var b=this.If(a.Ea),b=this.Bi(b);Zf(a,a,b[0],b[1]);a==this.la&&(this.la=b[0]);a=b[0]}a.ea()[F](function(a){this.bb(a)},this)};Ng[r].If=function(a){if(0==a.ya()||"and"!=a.bc)return[a];var b=a.ea()[m]().map(function(b){a[ib](b);return this.If(b)},this);return yc(b)};
Ng[r].Bi=function(a){var b=null,c=null;a.map(function(a,g){var k=new Cg(a);0==g?b=k:c.ma(k);c=k},this);return[b,c]};
function Og(){}K(Og,Mg);Og[r].Mb=function(a){this.la=a;this.bb(this.la);return this.la};Og[r].bb=function(a){if(a instanceof Eg)for(;2<a.ya();){for(var b=new Eg,c=0;2>c;c++){var d=a.fe(0);b.ma(d)}a.Ec(b,0)}a.ea()[F](function(a){this.bb(a)},this)};
...
function Sg(a){Ie[q](this,a)}K(Sg,Ie);Sg[r].ha=function(){var a=new O([this.Ia]),b=this.ga[zb]();a[hb](b.Jj(this.Ia[t]()));this.mc&&a[hb](b.bg(this.Ia[t]()));return a};la(Sg[r],function(){var a=new Sg(this.ga);a.Ad(this);a.Ia=this.Ia;this[db]&&ua(a,this[db]instanceof we?this[db]:this[db][m]());a.mc=this.mc;a.nc=this.nc;return a});Ba(Sg[r],function(a){Sg.Pb[E][q](this,a);this.nc&&ua(this,this.nc instanceof we?a[this.nc.Bb()]:this.nc.map(function(b){return b instanceof we?a[b.Bb()]:b}));return this});
...
function Yg(a,b){return a.ea().map(function(a){return"("+Zg(a,b)+")"})[La]("and"==a.bc?" AND ":" OR ")}function Zg(a,b){if(a instanceof He)return[a.K.l(),Wg(a.L),Xg(a[u],a.L,a.K.Z(),b)][La](" ");if(a instanceof ag)return Yg(a,b);if(a instanceof ig)return[a.Oa.l(),Wg(a.L),a.Fa.l()][La](" ");throw new P(357,typeof a);}function $g(a,b){var c=Zg(a,b);return c?" WHERE "+c:""}
...
W[r].sk=function(a,b){if(!(b instanceof ig))throw new P(541);if(null==this.a.c)throw new P(542);this.a.c[x](a);null==this.a.zc&&(this.a.zc=new O);var c=b;a.qa()!=b.Fa.M().qa()&&(c=b[fb]());this.a.zc.add(c.fa());this.qe(c);return this};W[r].leftOuterJoin=W[r].sk;W[r].ba=function(a){if(null!=(this.a.ba||this.a.$b))throw new P(528);if(a instanceof we)this.a.$b=a;else{if(0>a)throw new P(531);this.a.ba=a}return this};W[r].limit=W[r].ba;
...
function jh(a,b){dh[q](this,a,new Tg(a.o(Nd)));ia(this.a,b)}K(jh,dh);I("lf.query.UpdateBuilder",jh,void 0);jh[r].set=function(a,b){var c={vd:b instanceof we?b.Bb():-1,K:a,value:b};null!=this.a.set?this.a.set[x](c):this.a.set=[c];return this};jh[r].set=jh[r].set;jh[r].F=function(a){this.pe();this.a.F=a;return this};jh[r].where=jh[r].F;jh[r].pe=function(){if(null!=this.a.F)throw new P(516);};
...
function ph(){}K(ph,Mg);ph[r].Mb=function(a,b){this.la=a;this.bb(this.la,b);return this.la};ph[r].bb=function(a,b){if(a instanceof Cg&&a.Ea instanceof ig){L(1==a.ya(),"SelectNode must have exactly one child.");var c=a.Ea.fa(),d=a.Ab(0);d instanceof Eg&&(c=Mb(b)&&null!=b.zc&&b.zc[tb](c),c=new Lg(a.Ea,c),Zf(a,d,c,c),a==this.la&&(this.la=c),a=c)}a.ea()[F](function(a){this.bb(a,b)},this)};
function qh(){this.ne=new O}K(qh,Mg);H=qh[r];H.Mb=function(a){this.la=a;this.bb(this.la);this.ne[v]();return this.la};H.bb=function(a){if(this.tg(a)){var b=a.Ea instanceof He?this.Qk(a):this.Pk(a);this.ne.add(a);b==a&&(b=a.Ab(0));null!==b&&(Qb(b[Bb]())&&(this.la=b),this.tg(b)&&!this.ne[tb](b)&&this.bb(b))}else a.ea()[F](function(a){this.bb(a)},this)};
H.ce=function(a,b){var c=a;if(this.il(a))c=Xf(a),this.ce(a,b);else if(this.hl(a)){var d=[],c=Yf(a,b,function(a){a=new Cg(a.Ea);d[x](a);return a});d[F](function(a){this.ce(a,b)},this)}return c};H.Qk=function(a){var b=new O([a.Ea.K.M().qa()]),c=function(a){return this.Xf(a,b)}[E](this);return this.ce(a,c)};H.Pk=function(a){var b=new O([a.Ea.Oa.M().qa(),a.Ea.Fa.M().qa()]),c=function(a){return this.Xf(a,b)}[E](this);return this.ce(a,c)};
H.Xf=function(a,b){var c=new O;Tf(a)[F](function(a){c.add(a[h].qa())},this);a instanceof Dg&&c.add(a[h].qa());return c.xi(b)};H.tg=function(a){return a instanceof Cg&&!(a.Ea instanceof ag)};H.hl=function(a){a=a.Ab(0);return a instanceof Eg||a instanceof Lg};H.il=function(a){return a.Ab(0)instanceof Cg};
...
function yh(a,b){this.oh=b;this.J=a.o(Jd)}yh[r].pi=function(a,b){var c=b[Ga](this.lk,this);if(0==c[C])return null;c=this.oj(c);if(0==c[C])return null;if(1==c[C])return c[0];var d=Number.MAX_VALUE;return c[Ka](function(b,c){var l=c.Vh(a);return l<d?(d=l,c):b},null)};yh[r].oj=function(a){return this.oh.Aa().map(function(b){b=new zh(this.J,b);b.wi(a);return b},this)[Ga](function(a){return a.rk()})};yh[r].lk=function(a){return a instanceof He&&a.ug()?a.K.M()==this.oh:!1};
function zh(a,b){this.J=a;this.Db=b;this.pg=new O;this.pg[hb](this.Db.h.map(function(a){return a.ga[t]()}));this.Ve=this.va=null}H=zh[r];H.Mj=function(){return null===this.va?[]:this.va.f()};H.gg=function(){L(this.va);null===this.Ve&&(this.Ve=new xh(this.Db,this.va));return this.Ve};H.wi=function(a){a[F](function(a){var c=a.ob()[0][t]();this.pg[tb](c)&&(null===this.va&&(this.va=new hg),this.va.add(c,a.fa()))},this)};
H.rk=function(){if(null===this.va)return!1;for(var a=!1,b=!0,c=0;c<this.Db.h[C];c++){var d=this.va.C(this.Db.h[c].ga[t]());if(a&&d){b=!1;break}d||(a=!0)}return b};H.Vh=function(a){a=this.gg().Ld(a);var b=this.J.get(this.Db.l());return a[Ka](function(a,d){return a+b.Dd(d)},0)};
...
Eh[r].al=function(a,b,c){a.Mj().map(function(a){return b.get(a)})[F](Vf);a=new Ah(this.m,a.Db,a.gg(),!1);var d=new Ch(this.m,c[h]);d.ma(a);Zf(c,c,d,a);return a.qb()};
function Fh(a,b){U[q](this,0,-1);this.J=a.o(Jd);this.O=b}K(Fh,U);f(Fh[r],function(){return"insert("+this.O[t]()+")"});Fh[r].na=function(a,b,c){Gh(this.O,c[db],this.J);a.Eb(this.O,c[db]);return[se(c[db],[this.O[t]()])]};function Gh(a,b,c){a=a.Jb().Pd();if(null===a?0:a.h[0][ob]){var d=a.h[0].ga[t]();c=c.get(a.l()).max();var g=null===c?0:c[0];b[F](function(a){if(0==a.w()[d]||null==a.w()[d])g++,a.w()[d]=g})}}function Hh(a,b){U[q](this,0,-1);this.J=a.o(Jd);this.O=b}K(Hh,U);
...
function Ph(){}K(Ph,Mg);Ph[r].Mb=function(a){var b=Uf(a,function(a){return a instanceof Jh||a instanceof Oh});if(0==b[C])return a;var c=this.hj(a);if(null===c)return a;b[F](function(a){this.Ak(a,c)},this);return c.qb()};Ph[r].Ak=function(a,b){a instanceof Jh?b.sd=!0:b.td=!0;return Vf(a).parent};Ph[r].hj=function(a){a=Uf(a,function(a){return a instanceof Ah},function(a){return a instanceof Nh&&a.dk()||a instanceof Kh||1!=a.ya()||a instanceof Bh});return 0<a[C]?a[0]:null};
function Qh(a){this.m=a}K(Qh,Mg);Qh[r].Mb=function(a){var b=Rh(a);if(null===b)return a;a=this.Kh(b);a==b&&(a=this.Jh(b));return a.qb()};Qh[r].Kh=function(a){var b=a,c=Sh(a.Ab(0));if(null!==c){var d;d=a.N;for(var g=null,k=c[h].Aa(),l=0;l<k[C]&&null===g;l++)g=Th(k[l],d);d=g;if(null===d)return b;b=new Ah(this.m,d.Db,new wh(d.Db),d.Ag);d=new Ch(this.m,c[h]);d.ma(b);Vf(a);b=Zf(c,c,d,b)}return b};
Qh[r].Jh=function(a){var b=a,c=Uh(a.Ab(0));if(null!==c){var d=Th(c[mb],a.N);if(null===d)return b;c.kf=d.Ag;b=Vf(a).parent}return b};function Uh(a){a=Uf(a,function(a){return a instanceof Ah},function(a){return 1!=a.ya()});return 0<a[C]?a[0]:null}function Sh(a){a=Uf(a,function(a){return a instanceof Dh},function(a){return 1!=a.ya()});return 0<a[C]?a[0]:null}function Rh(a){a=Uf(a,function(a){return a instanceof Kh});return 0<a[C]?a[0]:null}
function Th(a,b){if(a.h[C]!=b[C]||!b[Ua](function(b,c){return b.K[t]()==a.h[c].ga[t]()}))return null;var c=Vh(b,a);return c[0]||c[1]?{Db:a,Ag:c[1]}:null}function Vh(a,b){var c=a[Ka](function(a,b){return a<<1|(0==b.tb?0:1)},0),d=b.h[Ka](function(a,b){return a<<1|(0==b.tb?0:1)},0),d=c^d,c=0==d,d=d==ba.pow(2,ba.max(a[C],b.h[C]))-1;return[c,d]};
function Wh(a,b,c){this.Ga=a;this.ff=b;this.lf=c}Wh[r].vc=function(){this.lf[F](function(a){this.Ga=a.Mb(this.Ga,this.ff)},this);return this.Ga};
...
Yh[r].wk=function(a){if(a instanceof Fg)return new Nh(a.h,a.Wb);if(a instanceof Ig)return new uh(a.h);if(a instanceof Hg)return new og(a.h);if(a instanceof Gg)return new Kh(a.N);if(a instanceof Kg)return new Oh;if(a instanceof Jg)return new Jh;if(a instanceof Cg)return new Bh(a.Ea.fa());if(a instanceof Eg)return new Pg;if(a instanceof Lg)return new Ih(a.Ea,a.yg);if(a instanceof Dg)return new Dh(this.m,a[h]);if(a instanceof Ag)return new th(a[h]);if(a instanceof Bg)return new Xh(a[h],a.wf);if(a instanceof
...
H.ad=function(){return this.Th.Hj()};H.fk=function(){return 0<this.jd.za()};H.yl=function(a){var b=this.Ji.Ih(this.Gg,a);this.Gg=a;0<b[C]&&this.jd.f()[F](function(a){a(b)})};
...
function Y(a,b,c,d,g,k){this.O=a;this.A=b;this.Cg=c;this.wg=d;this.th=g;this.lb=k||null}I("lf.schema.BaseColumn",Y,void 0);H=Y[r];na(H,G("A"));H.l=function(){return this.O.qa()+"."+this.A};f(H,function(){return this.l()});H.M=G("O");H.Z=G("th");Y[r].getType=Y[r].Z;Y[r].cb=G("lb");Y[r].Aa=function(){null==this.ia&&(this.ia=[],this.M().Aa()[F](function(a){-1!=a.h.map(function(a){return a.ga[t]()})[$a](this.A)&&this.ia[x](a)},this));return this.ia};Y[r].Yb=G("wg");Y[r].isNullable=Y[r].Yb;Y[r].dd=G("Cg");
...
function Z(a){this.rc(a);this.A=a;this.H=new Dd;this.uf=new mf;this.rd=new mf;this.hd=new mf;this.Da=null;this.ia=new Dd;this.ae=!1;this.Hd=[]}I("lf.schema.TableBuilder",Z,void 0);function qi(a){ja(this,a[n]);this.tb=a.order;this.autoIncrement=a[ob]}var ri=new mf([0,6]);H=Z[r];H.rc=function(a){if(!/^[A-Za-z_][A-Za-z0-9_]*$/.test(a))throw new P(502,a);};H.Ic=function(a){if(a==this.A)throw new P(546,a);if(this.H.has(a)||this.ia.has(a)||this.rd.has(a))throw new P(503,this.A+"."+a);};
H.ki=function(a){var b=!1;a[F](function(a){var d=this.H.get(a[n]);b=b||a[ob];if(a[ob]&&3!=d)throw new P(504);},this);if(b&&1<a[C])throw new P(505);};H.ii=function(){if(null!==this.Da){var a=this.ia.get(this.Da).map(function(a){return a[n]}),b=0;if(this.Hd[ab](function(c,d){b=d;return-1!=a[$a](c.Rb)},this))throw new P(543,this.Hd[b][n]);}};
H.hi=function(){if(null!==this.Da){var a=function(a){return a[n]},b=ga[yb](this.ia.get(this.Da).map(a));this.ia[F](function(c,d){if(d!=this.Da){var g=c.map(a);if(ga[yb](g)==b)throw new P(544,this.A+"."+d);}},this)}};H.ji=function(){null===this.Da||this.ia.get(this.Da)[F](function(a){if(this.hd.has(a[n]))throw new P(545,this.A+"."+a[n]);},this)};H.Ah=function(a,b){this.rc(a);this.Ic(a);this.H.set(a,b);ri.has(b)&&this.Cf([a]);return this};Z[r].addColumn=Z[r].Ah;
Z[r].Ch=function(a,b){var c=this.A;this.Da="pk"+(c[0].toUpperCase()+c.substring(1));this.rc(this.Da);this.Ic(this.Da);c=this.Xd(a,!0,void 0,b);this.ki(c);1==c[C]&&this.uf.add(c[0][n]);this.rd.add(this.Da);this.ia.set(this.Da,c);return this};Z[r].addPrimaryKey=Z[r].Ch;
...
Z[r].Nf=function(a,b){if(1<b[C]){var c=b[Ga](function(a){return this.hd.has(a[n])},this);if(0<c[C])throw new P(507,a,c[La](","));}};Z[r].Lb=Jb("ae");Z[r].persistentIndex=Z[r].Lb;Z[r].Cb=function(){this.ii();this.hi();this.ji();return new (this.xj())};Z[r].getSchema=Z[r].Cb;Z[r].Xc=G("Hd");
...
Z[r].xj=function(){function a(){function a(c){return b.ia.get(c).map(function(a){return{ga:this[a[n]],tb:a.tb,autoIncrement:a[ob]}},this)}var d=Ed(b.H).map(function(a){this[a]=new Y(this,a,b.uf.has(a),b.hd.has(a),b.H.get(a));return this[a]},this),g=Ed(b.ia).map(function(d){return new lg(b.A,d,b.rd.has(d),a[q](this,d))},this);S[q](this,b.A,d,g,b.ae);var k=null===b.Da?null:new lg(b.A,b.Da,!0,a[q](this,b.Da)),l=d[Ga](function(a){return!b.hd.has(a[t]())});this.vi=new oi(k,l,b.Xc());this.eh=b.tj(d,g)}
...
function si(a,b){this.s=new ti(a,b);this.xb=new N;this.Tc=!1}I("lf.schema.Builder",si,void 0);H=si[r];H.ei=function(a){a.Xc()[F](function(b){var c=b.fb;if(!this.xb.C(c))throw new P(536,b[n]);var c=this.xb.get(c).Cb(),d=b.Ac;if(!c[sb](d))throw new P(537,b[n]);if(a.Cb()[b.Rb].Z()!=c[d].Z())throw new P(538,b[n]);if(!c[d].dd())throw new P(539,b[n]);},this)};H.di=function(a){a.Xc()[F](function(a){this.xb.get(a.fb).Xc()[F](function(c){if(c.Rb==a.Ac)throw new P(534,a[n]);},this)},this)};
H.dj=function(){this.Tc||(this.xb.f()[F](function(a){this.ei(a);this.s.gl(a.Cb())},this),this.xb.f()[F](this.di,this),this.ci(),this.xb[v](),this.Tc=!0)};H.Lf=function(a,b){a.xf||(a.xf=!0,a.$e=!0,a.Yf[F](function(c){c=b.get(c);if(!c.xf)this.Lf(c,b);else if(c.$e&&a!=c)throw new P(533);},this));a.$e=!1};H.ci=function(){var a=new Dd;this.s.I.U()[F](function(b){a.set(b,new ui(b))},this);this.xb[F](function(b,c){b.Xc()[F](function(b){a.get(b.fb).Yf.add(c)})});Fd(a)[F](function(b){this.Lf(b,a)},this)};
function ui(a){this.$e=this.xf=!1;this.Yf=new mf;this.rf=a}H.Cb=function(){this.Tc||this.dj();return this.s};si[r].getSchema=si[r].Cb;si[r].fg=function(){var a=new Gd("ns_"+this.s[n]()),b;mi||(mi=new li);b=mi;var c=null;b.Ue(a)?c=b.o(a):(c=new li,b.ub(a,c));return c};si[r].getGlobal=si[r].fg;si[r].connect=function(a){var b=this.fg();b.Ue(Nd)||b.ub(Nd,this.Cb());return(new X(b)).Ha(a)};si[r].connect=si[r].connect;
si[r].Ci=function(a){if(this.xb.C(a))throw new P(503,a);if(this.Tc)throw new P(535);this.xb.set(a,new Z(a));return this.xb.get(a)};si[r].createTable=si[r].Ci;si[r].pf=function(a){if(this.Tc)throw new P(535);this.s.pf(a);return this};si[r].setPragma=si[r].pf;function ti(a,b){this.A=a;this.Ta=b;this.I=new N;this.Vg={Ki:!1}}I("lf.schema.DatabaseSchema",ti,void 0);ja(ti[r],G("A"));ja(ti[r],ti[r][n]);ti[r].version=G("Ta");ti[r].version=ti[r][ub];ti[r].ab=function(){return this.I.f()};ti[r].tables=ti[r].ab;
