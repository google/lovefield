...
function Od(){};
function Pd(a){this.qa=a.o(yd);this.I=a.o(zd);this.s=a.o(Dd)}Da(Pd[z],function(a){a[q](function(a){this.al(a);this.Zk(a)},this)});Pd[z].Zk=function(a){var b=a[m]();a.Sc().c()[q](function(a){this.qa[n](b,[a.id()])},this);a.Rc()[q](function(a){this.qa.set(b,[a])},this);a.Tc()[q](function(a){this.qa.set(b,[a[1]])},this)};Pd[z].al=function(a){var b=this.s[u](a[m]());a.dj()[q](function(a){this.ah(b,a)},this)};
Pd[z].ah=function(a,b){a.Da().map(function(a){return this.I.get(a.l())},this)[Ka]([this.I.get(a.Rb())])[q](function(a){var d=null===b[1]?null:b[1].Ub(a[m]()),g=null===b[0]?null:b[0].Ub(a[m]());null===g&&null!==d?a.add(d,b[1].id()):null===g||null===d?null!==g&&null===d&&a[n](g,b[0].id()):0!=a.Jc()[Wa](g,d)&&(a.add(d,b[1].id()),a[n](g,b[0].id()))})};
...
function Vd(a){this.I=a.o(zd);this.s=a.o(Dd)}H=Vd[z];H.Mi=function(a,b){var c=a.Gb().Be();return null===c?null:this.Li(c,b)};H.Li=function(a,b){var c=a.l(),d=b.Ub(c),c=this.I.get(c).get(d);return 0==c[y]?null:c[0]};H.le=function(a,b){var c=a.Gb().kj();b[q](function(a){c[q](function(b){if(null===a.u()[b[m]()])throw new P(202,b.l());},this)},this)};H.Sh=function(a,b,c){a.Gb().Sf()[q](function(a){a[tb]==c&&this.Rh(a,b)},this)};
H.Rh=function(a,b){b[q](function(b){if(Wd(b[0],b[1],a.rb)&&(b=b[1].u()[a.Db],!this.Vf(a).A(b)))throw new P(203,a.rb);},this)};H.Vf=function(a){var b=this.s[u](a.Yb)[a.Ib].Da()[h](function(b){return 1==b.h[y]&&b.h[0].ma[m]()==a.Ib})[0];return this.I.get(b.l())};function Wd(a,b,c){return(null===a?null!==b:null===b)||a.Ub(c)!=b.Ub(c)}
H.Th=function(a,b,c){a=a.qj();null!=a&&a[q](function(a){if(a[tb]==c){var g=this.I.get(a.rb);b[q](function(b){var c=this.Vf(a);if(Wd(b[0],b[1],c[m]())&&g.A(b[0].u()[a.Ib]))throw new P(203,a.rb);},this)}},this)};H.Df=function(a,b,c){0!=b[y]&&(b=b.map(function(a){return[null,a]}),this.Sh(a,b,c))};H.Cf=function(a,b,c){0!=b[y]&&(b=b.map(function(a){return[a,null]}),this.Th(a,b,c))};
...
function Yd(a,b){this.pa=new N;b[q](function(a){this.pa.set(a[m](),a)},this);this.qa=a.o(yd);this.I=a.o(zd);this.Eb=new Vd(a);this.Jd=new Pd(a);this.Te=this.$d=!1;this.Bb=new N}H=Yd[z];H.Rf=G("Bb");H.fj=function(){var a=[];this.Bb.H().map(function(a){return this.pa.get(a)},this)[q](function(b){b.ac()&&(b.Da()[q](function(b){a[v](this.I.get(b.l()))},this),a[v](this.I.get(b[m]()+".#")))},this);return a};H.fa=G("pa");
H.gj=function(){var a=[];this.pa.c()[q](function(b){b.ac()&&(b.Da()[q](function(b){a[v](b.l())}),a[v](b[m]()+".#"))});return a};H.xb=function(a,b){this.Gc();this.pd(a);this.Eb.le(a,b);this.Eb.Df(a,b,0);for(var c=0;c<b[y];c++)this.Kd(a,[null,b[c]])};
H.Kd=function(a,b){var c=a[m](),d=this.Bb.get(c,null)||new Xd(c);this.Bb.set(c,d);try{this.Jd.ah(a,b)}catch(g){throw this.Te=!0,g;}var k=b[0],l=b[1];null===k&&null!==l?(this.qa.set(c,[l]),d.add(l)):null!==k&&null!==l?(this.qa.set(c,[l]),d.modify(b)):null!==k&&null===l&&(this.qa[n](c,[k.id()]),d[rb](k))};Da(H,function(a,b){this.Gc();this.pd(a);this.Eb.le(a,b);for(var c=0;c<b[y];c++){var d=b[c],g=this.qa.get([d.id()])[0];this.Kd(a,[g,d])}});
H.He=function(a,b){this.Gc();this.pd(a);this.Eb.le(a,b);for(var c=0;c<b[y];c++){var d=b[c],g=null,k=this.Eb.Mi(a,d);null!=k&&(g=this.qa.get([k])[0],d.th(k));this.Kd(a,[g,d])}};ka(H,function(a,b){this.Gc();this.pd(a);this.Eb.Cf(a,b,0);for(var c=0;c<b[y];c++)this.Kd(a,[b[c],null])});H.Gh=function(){this.Bb.c()[q](function(a){var b=this.pa.get(a[m]());this.Eb.Df(b,a.Rc().c(),1);this.Eb.Cf(b,a.Sc().c(),1);a.Tc().c()},this)};H.V=function(){this.Gc();this.$d=!0};
H.Gc=function(){L(!this.Te,"Attemptted to use journal that needs to be rolled back.");L(!this.$d,"Attemptted to commit a terminated journal.")};H.Kb=function(){L(!this.$d,"Attempted to rollback a terminated journal.");var a=this.Bb.c().map(function(a){return a.rj()},this);this.Jd[Bb](a);this.$d=!0;this.Te=!1};H.pd=function(a){if(!this.pa.A(a[m]()))throw new P(106,a[m]());};
...
H.Ea=function(a){return Je(this.j,"@rev/R")[A](function(a){this.Wa=a;return Je(this.j,"@table")}[r](this))[A](function(b){var c=0,d;for(d in b)this.hb.set(d,b[d]),b[d]>c&&(c=b[d]);a.Ya()[q](function(a){this.hb.A(a[m]())||(b[a[m]()]=++c)},this);d=this.j[gb]("@table");return Ke(d,b)}[r](this))};
...
Le[z].V=function(){Le.gb.V[D](this);var a=this.ij().Rf();if(0==a.ra())this.ca[xb]();else{var b=this.j.sj()+1;this.j.Og(b);var c={"@rev":{R:b}};a[q](function(a){var g=this.j.Yf(a[m]());a.Rc()[q](function(a,d){c[d]={R:b,T:g,P:a.u()}});a.Tc()[q](function(a,d){c[d]={R:b,T:g,P:a[1].u()}});a.Sc()[q](function(a,b){c[b]=null})},this);this.j.pj()[Bb](c,function(c){if(null===c)this.ca[xb]();else this.j.Og(b-1),c=a.c().map(function(a){return this.j.Fg(a[m]())},this),Vc(c)[A](this.ca[kb][r](this.ca),this.ca[kb][r](this.ca))}[r](this))}return this.ca.ga};
...
H.Ea=function(a){this.j=this.kh[gb](this.s[sb]());var b=a||function(){return Rc()};return Je(this.j,"@db/version")[A](function(a){return null===a?Ke(this.j,this.di(),!0)[A](function(){var a=new Q(0,this.j);return b(a)}[r](this)):a==this.s[Fa]()?Je(this.j,"@rev/R")[A](function(a){this.Wa=a;return Je(this.j,"@table")}[r](this))[A](function(a){for(var b in a)this.hb.set(b,a[b]);a=this.s.Ya().map(function(a){return this.Fg(a[m]())},this);return Vc(a)}[r](this))[A](function(){this.Kj();this.qg();return Rc()}[r](this)):
...
H.ik=function(a,b){var c=b[wb][Xa],d=b[wb][fb],g=new R(b.oldVersion,c,d,this.nd);this.zk(c,d);this.hi(c,d);return a(g)};H.zk=function(a){for(var b=[],c=0;c<a[La][y];++c){var d=a[La][nb](c);-1!=d[pb](".")&&b[v](d)}b[q](function(b){try{a.deleteObjectStore(b)}catch(c){}})};H.hi=function(a,b){this.s.Ya()[q](Vb(this.ei,a,b),this)};H.ei=function(a,b,c){a[La][ib](c[m]())||a.createObjectStore(c[m](),{keyPath:"id"});c.ac()&&(c.Da()[q](function(c){this.Kc(a,b,c.l(),"btree")},this),this.Kc(a,b,c.Rb(),"rowid"))};
H.Kc=function(a,b,c,d){a[La][ib](c)||(a.createObjectStore(c,{keyPath:"id"}),a=b[ob](c),(this.nd?new Ld(a,dd,Nd):new Pe(a,dd)).put([new hd(new gd(d))]))};H.Ob=function(a,b){var c=b.fa().c().map(function(a){return a[m]()});b.gj()[q](function(a){c[v](a)});var d=this.j[fb](c,0==a?"readonly":"readwrite");return new Qe(this.m,d,b,a,this.nd)};
H.af=function(a){function b(){if(0==c[y])return Rc();var a=c[Ha]();return l(a)[A](b)}var c=this.s.Ya().map(function(a){return a[m]()}),d=this.j,g=0,k=J(function(a){return this.nd?(a=Kd(a[x]),xc(a.uc())[lb](function(a,b){return ea.max(a,b)},0)):a.key},this),l=J(function(b){return new M(function(c,l){var He;try{He=(a||d[fb]([b]))[ob](b)[vb](null,"prev")}catch(hh){l(hh);return}Ca(He,function(a){(a=a[wb][Xa])&&(g=ea.max(g,k(a)));c(g)});va(He,function(){c(g)})},this)},this);return new M(function(a){b()[A](function(){a(g)})})};
...
function Te(a){this.s=a;this.F=new N}H=Te[z];H.Ea=function(){this.s.Ya()[q](this.Lj,this);return Rc()};H.Vc=function(a){var b=this.F.get(a,null);if(null===b)throw new P(101,a);return b};H.Ob=function(a,b){return new Se(this,a,b)};H.Ff=function(a){if(!this.F.A(a)){var b=new Me;this.F.set(a,b);return b}return null};H.Lj=function(a){this.Ff(a[m]());a.ac()&&(a.Da()[q](function(a){this.Kc(a.l(),"btree")},this),this.Kc(a.Rb(),"rowid"))};H.Kc=function(a,b){var c=this.Ff(a);null===c||c.put([new hd(new gd(b))])};
...
H.af=function(){var a=0,b=Wc(),c=J(function(b){var c=new We(this.j,this.yd(),0);c.La("SELECT MAX(id) FROM "+b,[]);return c.V()[A](function(b){b=b[hb][nb](0)[0];a=ea.max(b,a)})},this),d=this.s.Ya().map(function(a){return c(a[m]())});Vc(d)[A](function(){b[xb](a)},function(a){b[kb](a)});return b.ga};
...
H.ab=function(a,b,c,d){var g=this.va.Bd().b[0];if(!Hb(g)||0==c)return mf;var k=(c||0)+(d||0),k=0<k&&!b?k:Number.POSITIVE_INFINITY,l=[];(Hb(a)?this.M.Rg(a):[this.M.ve()])[q](function(a){for(var b=this.M.Ud(a),b=this.M.Ie(a)?g:b[0],b=this.va.Qf(b),c=0;null!=b&&l[y]<k;)0!=b.ab(a,l)?c=0:c++,b=2==c?null:b[$a]()},this);return gf(l,b,c,d)};na(H,function(){this.va=nf(this)});H.A=function(a){return this.va.A(a)};H.min=function(){return this.ad(J(this.M.min,this.M))};
...
function sf(a,b){b&&(b.zb=a);a&&(a.za=b)}function jf(a,b){for(var c=b[y],d=0,g=nf(a),k=g;0<c;){var l=768<=c?511:257<=c&&511>=c?c:257,p=b[w](d,d+l);g.b=p.map(function(a){return a.key});g.U=p.map(function(a){return a[x]});d+=l;c-=l;0<c&&(l=nf(g.Z),sf(g,l),g=l)}return k}function tf(a){var b=a[0],c=nf(b.Z);c.nb=b.nb+1;c.i=a;for(b=0;b<a[y];++b)a[b].C=c,0<b&&c.b[v](a[b].b[0]);return c}
function kf(a){var b=a,c=[];do c[v](b),b=b.za;while(b);if(512>=c[y])b=tf(c);else{var d=c[y],g=0,b=nf(a.Z);for(b.nb=a.nb+2;0<d;){a=768<=d?511:257<=d&&511>=d?d:257;var k=c[w](g,g+a),l=tf(k);l.C=b;b.i[y]&&(b.b[v](k[0].b[0]),sf(b.i[b.i[y]-1],l));b.i[v](l);g+=a;d-=a}}return b}H.get=function(a){var b=this.gd(a);if(this.da()){var c=mf;this.Z.Qa(this.b[b],a)&&(c=c[Ka](this.U[b]));return c}b=this.Z.Qa(this.b[b],a)?b+1:b;return this.i[b].get(a)};
...
function Ff(a){this.m=a;this.Cb=a.o(xd);this.I=a.o(zd);this.qa=a.o(yd)}H=Ff[z];H.Ea=function(a){var b=a.Ya(),c=J(function(){if(0==b[y])return Rc();var a=b[Ha]();return(a.ac()?this.Gi(a):this.Hi(a))[A](c)},this);return c()};H.Hi=function(a){var b=new Yd(this.m,[a]);return this.Cb.Ob(0,b).X(a[m](),J(a.pc,a)).get([])[A](J(function(b){this.qa.set(a[m](),b);this.vk(a,b)},this))};H.vk=function(a,b){var c=this.I.vj(a[m]());b[q](function(a){c[q](function(b){var c=a.Ub(b[m]());b.add(c,a.id())})})};
H.Gi=function(a){var b=new Yd(this.m,[a]),c=this.Cb.Ob(0,b),b=c.X(a[m](),a.pc).get([])[A](J(function(b){this.qa.set(a[m](),b)},this)),d=a.Da().map(function(a){return this.wk(a,c)},this)[Ka](this.xk(a,c));return Vc(d[Ka](b))};
H.wk=function(a,b){var c=b.X(a.l(),dd,1),d=vf(a);return c.get([])[A](J(function(b){L("btree"==b[0].u().type);if(1<b[y]){if(a.bg()){var c=of[r](void 0,d,a.l(),a.Zc),l=b[w](1),p=-1;for(b=0;b<l[y];++b)if(-2==l[b].id()){p=b;break}if(-1==p)throw new P(102);b=l[p].u();l=l[w](0);l[E](p,1);c=c(l);c=new Cf(c);c.Ua[mb](b)}else c=of(d,a.l(),a.Zc,b[w](1));this.I.set(c)}},this))};
H.xk=function(a,b){return b.X(a.Rb(),dd,1).get([])[A](J(function(b){L("rowid"==b[0].u().type);1<b[y]&&(b=Ef(a.Rb(),b[w](1)),this.I.set(b))},this))};


function Gf(){this.S=new N}Gf[z].Ea=function(a){a.Ya()[q](function(a){var c=a.Rb();if(null===this.get(c)){var d=new Df(c);this.S.set(c,d)}a.Da()[q](function(a){this.S.set(a.l(),Hf(a))},this)},this);return Rc()};function Hf(a){var b=vf(a),b=new hf(a.l(),b,a.Zc);return a.bg()?new Cf(b):b}Gf[z].get=function(a){return this.S.get(a,null)};Gf[z].set=function(a){return this.S.set(a[m](),a)};Gf[z].vj=function(a){var b=[],c=a+".";this.S.H()[q](function(a){0==a[pb](c)&&b[v](this.S.get(a))},this);return b};
...
H.add=function(a){if(0!=a[y])if(a=this.cb[Ka](a),1==a[y])this.cb=a;else{a[zb](be);for(var b=[],c=a[0],d=1;d<a[y];++d)if(c.yg(a[d])){var g=a[d],k=ae();if(null!==c.f&&null!==g.f){var l=$d(c.f,g.f,!0);1!=l?(k.f=c.f,k.ba=0!=l?c.ba:c.ba&&g.ba):(k.f=g.f,k.ba=g.ba)}null!==c.w&&null!==g.w&&(l=$d(c.w,g.w,!1),-1!=l?(k.w=c.w,k.ea=0!=l?c.ea:c.ea&&g.ea):(k.w=g.w,k.ea=g.ea));c=k}else b[v](c),c=a[d];b[v](c);this.cb=b}};
H.Nc=function(a){return this.cb[y]==a.cb[y]?0==this.cb[y]||this.cb[Ab](function(b,c){return b.Nc(a.cb[c])}):!1};function Jf(a,b){var c=[];a.c().map(function(a){return b.c().map(function(b){var c;if(a.yg(b)){c=ae();var l=$d(a.f,b.f,!0),l=0==l?a.ba?a:b:-1!=l?a:b;c.f=l.f;c.ba=l.ba;null===a.w||null===b.w?b=null===a.w?b:a:(l=$d(a.w,b.w,!1),b=0==l?a.ea?a:b:-1==l?a:b);c.w=b.w;c.ea=b.ea}else c=null;return c})})[q](function(a){c=c[Ka](a)});return new If(c[h](function(a){return null!==a}))};
function Kf(a,b){var c=[],d=null,g=null;a.Ac(function(a){var l=b(a);null==a[Ga]()?g=l:d.ia(l);var p=a[Ga]();null!==p&&p.xa()==d.xa()&&(p=c[pb](d),-1!=p&&c[E](p,1));1<a.xa()&&c[v](l);d=a.gg()?c[c[y]-1]:l});return g}function Lf(a){return Mf(a,function(a){return a.gg()})}function Nf(a){var b=a[Ga](),c=0;null!==b&&(c=b.N()[pb](a),b[ub](a));var d=a.N()[w]();d[q](function(d,k){a[ub](d);null===b||b.Dc(d,c+k)});return{parent:b,children:d}}
function Of(a,b){a.N()[w]()[q](function(c){a[ub](c);b.ia(c)});a.ia(b)}function Pf(a){L(1==a.xa());var b=a.sb(0);L(1==b.xa());Nf(a);Of(b,a);return b}function Qf(a,b,c){L(1==a.xa());var d=a.sb(0);L(1<d.xa());var g=d.N()[w]();if(!g[yb](function(a){return b(a)}))return a;Nf(a);g[q](function(g,l){if(b(g)){var p=c(a);d.Vd(l);p.ia(g);d.Dc(p,l)}});return d}function Rf(a,b,c,d){var g=a[Ga]();null!==g&&(a=g.N()[pb](a),g.Vd(a),g.Dc(c,a));b.N()[w]()[q](function(a){b[ub](a);d.ia(a)});return c}
...
H.vi=function(a,b){for(var c=[],d=a.Y(),g=b.Y(),k=0;k<a[C][y];k++)for(var l=0;l<b[C][y];l++)if(this.vd(a[C][k].O(this.Ta),b[C][l].O(this.fb))){var p=le(a[C][k],d,b[C][l],g);c[v](p)}d=a.Y()[Ka](b.Y());return new ce(c,d)};
H.ui=function(a,b){var c=a,d=b,g=this.Ta,k=this.fb;a[C][y]>b[C][y]&&(c=b,d=a,g=this.fb,k=this.Ta);var l=new $f,p=[];c[C][q](function(a){var b=ha(a.O(g));l.add(b,a)});var B=c.Y(),Ta=d.Y();d[C][q](function(a){var b=ha(a.O(k));l.A(b)&&l.get(b)[q](function(b){b=le(a,Ta,b,B);p[v](b)})});c=a.Y()[Ka](b.Y());return new ce(p,c)};
...
function T(a,b){ua(this,a);this.ic=b;this.jb=null}H=T[z];ja(H,function(){return this.ic+"("+this[gb][m]()+")"});H.l=function(){return this.ic+"("+this[gb].l()+")"};H.X=function(){return this[gb].X()};f(H,function(){return this.l()});H.$=function(){return this[gb].$()};H.$a=G("jb");H.Da=function(){return[]};H.wc=Fb(!1);H.Fc=function(a){this.jb=a;return this};T[z].as=T[z].Fc;T[z].Pf=function(){for(var a=[this],b=this;b instanceof T;)a[v](b[gb]),b=b[gb];return a};
function fg(a){this.jb=a||null;this.L=new eg("#UnknownTable",[],[],!1)}H=fg[z];ja(H,Fb("*"));H.l=function(){return this[m]()};f(H,function(){return this.l()});H.X=G("L");H.$=Fb(4);H.$a=G("jb");H.Da=function(){return[]};H.wc=Fb(!1);
...
function pg(a,b){this.Aa=a;this.pa=b}pg[z].mb=G("Aa");pg[z].fa=G("pa");function V(){te[D](this,"","")}K(V,te);function qg(a,b){V[D](this);pa(this,a);ma(this,b)}K(qg,V);function rg(a,b){qg[D](this,a,b)}K(rg,qg);function sg(a){V[D](this);pa(this,a)}K(sg,V);f(sg[z],function(){return"delete("+this[u][m]()+")"});function tg(a,b){V[D](this);pa(this,a);this.kf=b}K(tg,V);f(tg[z],function(){var a=[];this.kf&&(a=this.kf.map(function(a){return a.J[m]()},this));return"update("+this[u][m]()+", ["+a[F](",")+"])"});
function ug(a){V[D](this);this.Ga=a}K(ug,V);f(ug[z],function(){return"select("+this.Ga[t]()+")"});function vg(a){V[D](this);pa(this,a)}K(vg,V);f(vg[z],function(){var a="table_access("+this[u][m]();null===this[u].$a()||(a+=" as "+this[u].$a());return a+")"});function wg(){V[D](this)}K(wg,V);f(wg[z],Fb("cross_product"));function xg(a,b){V[D](this);this.h=a;this.Sb=b}K(xg,V);
...
function Ug(a,b){var c="*";a.h[y]&&(c=a.h.map(function(a){return a.$a()?a.l()+" AS "+a.$a():a.l()})[F](", "));var d=a.f.map(function(a){return a.Ca()!=a[m]()?a[m]()+" AS "+a.Ca():a[m]()})[F](", "),c="SELECT "+c+" FROM "+d;a.D&&(c+=Sg(a.D,b));a.K&&(d=a.K.map(function(a){return a.J.l()+(0==a.ob?" DESC":" ASC")})[F](", "),c+=" ORDER BY "+d);a.la&&(d=a.la.map(function(a){return a.l()})[F](", "),c+=" GROUP BY "+d);a.oa&&(c+=" LIMIT "+a.oa[t]());a.na&&(c+=" SKIP "+a.na[t]());return c+";"}
function Vg(a,b){var c=b||!1,d=a.Wf();if(d instanceof Kg)return Ng(d,c);if(d instanceof Jg){var g="DELETE FROM "+d.f[m]();d.D&&(g+=Sg(d.D,c));return g+";"}if(d instanceof Lg)return Tg(d,c);if(d instanceof Ae)return Ug(d,c);throw new P(358,typeof d);};
...
qh[z].Ch=function(a){var b=new N;this.ua.H()[q](function(c){var d=this.ua.get(c).map(function(b){return a.Dd(b)},this),g=new If([ae()]);d[q](function(a){a=new If(a.Vk());g=Jf(g,a)});b.set(c,g)},this);return b};qh[z].Ii=function(a){for(var b=this.Tb.h[y]-1;0<=b;b--){var c=this.Tb.h[b];if(null!==a.get(c.ma[m](),null))break;a.set(c.ma[m](),new If([ae()]))}};qh[z].Ad=function(a){if(this.ng==a)return this.me;var b=this.Ch(a);this.Ii(b);this.me=1==this.Tb.h[y]?b.c()[0].c():oh(this.uj(b));this.ng=a;return this.me};
qh[z].uj=function(a){var b=new N,c=0;this.Tb.h[q](function(a){b.set(a.ma[m](),c);c++});return a.H()[zb](function(a,c){return b.get(a)-b.get(c)}).map(function(b){return a.get(b)})};
function rh(a,b){this.Ug=b;this.I=a.o(zd)}rh[z].Vh=function(a,b){var c=b[h](this.Nj,this);if(0==c[y])return null;c=this.Ui(c);if(0==c[y])return null;if(1==c[y])return c[0];var d=Number.MAX_VALUE;return c[lb](function(b,c){var l=c.Ah(a);return l<d?(d=l,c):b},null)};rh[z].Ui=function(a){return this.Ug.Da().map(function(b){b=new sh(this.I,b);b.bi(a);return b},this)[h](function(a){return a.Sj()})};rh[z].Nj=function(a){return a instanceof xe&&a.fg()?a.J.X()==this.Ug:!1};
function sh(a,b){this.I=a;this.wb=b;this.cg=new O;this.cg[mb](this.wb.h.map(function(a){return a.ma[m]()}));this.Me=this.ua=null}H=sh[z];H.oj=function(){return null===this.ua?[]:this.ua.c()};H.Uf=function(){L(this.ua);null===this.Me&&(this.Me=new qh(this.wb,this.ua));return this.Me};H.bi=function(a){a[q](function(a){var c=a.tb()[0][m]();this.cg[ib](c)&&(null===this.ua&&(this.ua=new $f),this.ua.add(c,a.ka()))},this)};
H.Sj=function(){if(null===this.ua)return!1;for(var a=!1,b=!0,c=0;c<this.wb.h[y];c++){var d=this.ua.A(this.wb.h[c].ma[m]());if(a&&d){b=!1;break}d||(a=!0)}return b};H.Ah=function(a){a=this.Uf().Ad(a);var b=this.I.get(this.wb.l());return a[lb](function(a,d){return a+b.td(d)},0)};
...
function vh(a,b){U[D](this,1,1);this.qa=a.o(yd);this.L=b}K(vh,U);f(vh[z],function(){return"table_access_by_row_id("+this.L[m]()+")"});vh[z].ja=function(a,b){return[ie(this.qa.get(b[0].tj()),[this.L.Ca()])]};
function wh(a,b){U[D](this,0,-1);this.qa=a.o(yd);this.I=a.o(zd);pa(this,b)}K(wh,U);f(wh[z],function(){var a="table_access("+this[u][m]();null===this[u].$a()||(a+=" as "+this[u].$a());return a+")"});wh[z].ja=function(){var a=this.I.get(this[u].Rb()).ab();return[ie(this.qa.get(a),[this[u].Ca()])]};
...
function yh(a,b){U[D](this,0,-1);this.I=a.o(zd);this.L=b}K(yh,U);f(yh[z],function(){return"insert("+this.L[m]()+")"});yh[z].ja=function(a,b,c){zh(this.L,c[Oa],this.I);a.xb(this.L,c[Oa]);return[ie(c[Oa],[this.L[m]()])]};function zh(a,b,c){a=a.Gb().Be();if(null===a?0:a.h[0][Na]){var d=a.h[0].ma[m](),g=c.get(a.l()).max()[0]||0;b[q](function(a){if(0==a.u()[d]||null==a.u()[d])g++,a.u()[d]=g})}}function Ah(a,b){U[D](this,0,-1);this.I=a.o(zd);this.L=b}K(Ah,U);
f(Ah[z],function(){return"insert_replace("+this.L[m]()+")"});Ah[z].ja=function(a,b,c){zh(this.L,c[Oa],this.I);a.He(this.L,c[Oa]);return[ie(c[Oa],[this.L[m]()])]};
...
function Jh(a){this.m=a}K(Jh,Eg);Jh[z].Jb=function(a){var b=Kh(a);if(null===b)return a;a=this.ph(b);a==b&&(a=this.oh(b));return a.mb()};Jh[z].ph=function(a){var b=a,c=Lh(a.sb(0));if(null!==c){var d;d=a.K;for(var g=null,k=c[u].Da(),l=0;l<k[y]&&null===g;l++)g=Mh(k[l],d);d=g;if(null===d)return b;b=new th(this.m,d.wb,new ph(d.wb),d.ig);d=new vh(this.m,c[u]);d.ia(b);Nf(a);b=Rf(c,c,d,b)}return b};
...
function Mh(a,b){if(a.h[y]!=b[y]||!b[Ab](function(b,c){return b.J[m]()==a.h[c].ma[m]()}))return null;var c=Oh(b,a);return c[0]||c[1]?{wb:a,ig:c[1]}:null}function Oh(a,b){var c=a[lb](function(a,b){return a<<1|(0==b.ob?0:1)},0),d=b.h[lb](function(a,b){return a<<1|(0==b.ob?0:1)},0),d=c^d,c=0==d,d=d==ea.pow(2,ea.max(a[y],b.h[y]))-1;return[c,d]};
...
function Qh(a,b){U[D](this,1,1);this.L=a;this.cl=b}K(Qh,U);f(Qh[z],function(){return"update("+this.L[m]()+")"});Qh[z].ja=function(a,b){var c=b[0][C].map(function(a){var b=this.L.pc(a.wa.Ia());this.cl[q](function(a){b.u()[a.J[m]()]=a[x]},this);return b},this);a[Bb](this.L,c);return[fe()]};
...
function ai(a,b){var c=a.o(Dd),d=b||{},g=new ff;a.pb(yd,g);var g=null,k=!1;switch(d.storeType||0){case 1:g=new Te(c);break;case 5:g=new Ue(c);break;case 4:g=new Ye(a,c,d.webSqlDbSize);break;case 3:g=new Ne(c,d.firebase);k=!0;break;default:g=new Re(a,c)}a.pb(xd,g);var l=new Gf;a.pb(zd,l);return g.Ea(d.onUpgrade)[A](function(){a.pb(Ad,new Sh(a));var b=new Vh;a.pb(Bd,b);b=new Zh;a.pb(Cd,b);return l.Ea(c)})[A](function(){k&&(new Ie(a)).Rk();return(new Ff(a)).Ea(c)})};
...
function Y(a,b,c,d,g,k){this.L=a;this.B=b;this.kg=c;this.hg=d;this.Zg=g;this.jb=k||null;this.i=this.C=null}I("lf.schema.BaseColumn",Y,void 0);H=Y[z];ja(H,G("B"));H.l=function(){return this.L.Ca()+"."+this.B};f(H,function(){return this.l()});H.X=G("L");H.$=G("Zg");H.$a=G("jb");H.Da=function(){null==this.ta&&(this.ta=[],this.X().Da()[q](function(a){-1!=a.h.map(function(a){return a.ma[m]()})[pb](this.B)&&this.ta[v](a)},this));return this.ta};H.wc=G("hg");H.Zc=G("kg");H.Zd=Eb("C");H.getParent=G("C");
...
Z[z].cj=function(){function a(){function a(c){return b.ta.get(c).map(function(a){return{ma:this[a[sb]],ob:a.ob,autoIncrement:a[Na]}},this)}var d=af(b.G).map(function(a){this[a]=new Y(this,a,b.hf.has(a),b.Md.has(a),b.G.get(a));return this[a]},this),g=af(b.ta).map(function(d){return new dg(b.B,d,b.Bc.has(d),a[D](this,d))},this);eg[D](this,b.B,d,g,b.Qd);var k=b.ta.has(b.yc)?new dg(b.B,b.yc,!0,a[D](this,b.yc)):null,l=d[h](function(a){return!b.Md.has(a[m]())}),p=ef(b.Bc).map(function(d){return new dg(b.B,
d,!0,a[D](this,d))},this);this.ai=new gi(k,l,b.Qb(),p);this.Lg=b.Zi(d,g)}var b=this;K(a,eg);a[z].Fb=function(a){return new this.Lg(cd++,a)};a[z].createRow=a[z].Fb;a[z].pc=function(a){var b={};this.tb()[q](function(g){var k=g[m]();g=g.$();var l=a[x][k];if(0==g)if(null===l)g=l;else if(g=l,""==g)g=null;else{0!=g[y]%2&&(g="0"+g);for(var l=new ArrayBuffer(g[y]/2),p=new Uint8Array(l),B=0,Ta=0;B<g[y];B+=2)p[Ta++]=ga(g.substr(B,2),16);g=l}else g=2==g?null===l?l:new Date(l):l;b[k]=g},this);return new this.Lg(a.id,
b)};a[z].deserializeRow=a[z].pc;a[z].Gb=G("ai");a[z].getConstraint=a[z].Gb;return a};
Z[z].Zi=function(a,b){function c(c,d){this.G=a;this.ta=b;bd[D](this,c,d)}K(c,bd);c[z].Hf=function(){var a={};this.G[q](function(b){a[b[m]()]=b.wc()?null:Ud[b.$()]});return a};c[z].Wg=function(){var a={};this.G[q](function(b){var c=b[m]();b=b.$();var d=this.u()[c];a[c]=0==b?null===d?d:fd(d):2==b?null===d?d:d[Qa]():d},this);return a};var d=J(function(a){var b=this.G.get(a[m]());return 2==b?function(b){b=b[a[m]()];return a.wc()&&null===b?null:b[Qa]()}:1==b?function(b){return a.wc()?(b=b[a[m]()],null===
