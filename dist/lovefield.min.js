...
W[t].C=function(a){if(this.ph)throw new P(516);this.ph=!0;this.ie(a);return this};W[t].where=W[t].C;W[t].ie=function(a){null!=this.a.C&&(a=$g(a,this.a.C));this.a.C=a};W[t].Zj=function(a,b){if(null==this.a.f)throw new P(543);this.a.f[x](a);this.ie(b);return this};W[t].innerJoin=W[t].Zj;
W[t].gk=function(a,b){if(!(b instanceof bg))throw new P(542);if(a.sa()!=b.Na.O().sa())throw new P(541);if(null==this.a.f)throw new P(543);this.a.f[x](a);null==this.a.vc&&(this.a.vc=new O);this.a.vc.add(b.da());this.ie(b);return this};W[t].leftOuterJoin=W[t].gk;W[t].na=function(a){if(null!=(this.a.na||this.a.Sb))throw new P(528);if(a instanceof oe)this.a.Sb=a;else{if(0>a)throw new P(531);this.a.na=a}return this};W[t].limit=W[t].na;
W[t].ja=function(a){if(null!=(this.a.ja||this.a.cc))throw new P(529);if(a instanceof oe)this.a.cc=a;else{if(0>a)throw new P(531);this.a.ja=a}return this};W[t].skip=W[t].ja;W[t].K=function(a,b){null==this.a.K&&(this.a.K=[]);this.a.K[x]({I:a,ob:null!=b?b:1});return this};W[t].orderBy=W[t].K;W[t].ma=function(a){if(null!=this.a.ma)throw new P(530);null==this.a.ma&&(this.a.ma=[]);this.a.ma[x][ub](this.a.ma,e[t][n][r](arguments));return this};W[t].groupBy=W[t].ma;
function bh(a,b){switch(a){case "COUNT":case "DISTINCT":return!0;case "AVG":case "GEOMEAN":case "STDDEV":case "SUM":return 4==b||3==b;case "MAX":case "MIN":return 4==b||3==b||5==b||2==b}return!1}la(W[t],function(){var a=new W(this[Wa],this.a.h);a.a=this.a.clone();a.a.Hc=null;return a});la(W[t],W[t].clone);
