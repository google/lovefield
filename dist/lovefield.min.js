...
lf.index.RowId.prototype.serialize=function(){return[lf.Row.create(this.rows_.getValues())]};lf.index.RowId.deserialize=function(a){var b=new lf.index.RowId;a=a[0].payload();a.forEach(function(a){b.add(a,a)});return b};
