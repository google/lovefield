...
m.Bb=function(a,b){var c=Ib(b.X());Vc(b).forEach(function(a){c.push(a)});var d=this.j.transaction(c,0==a?"readonly":"readwrite");return new ve(this.h,d,b,a,this.Yc)};
...
function gf(a){function b(a){return null!=a?a.oa.toString():"_"}var c=a.oa+"["+a.b.join("|")+"]",d=a.g.map(function(a){return a.oa}).join("|"),e=a.A.join("/"),g=b(a.zb)+"{",g=P(a)?g+e:g+d,g=g+"}"+b(a.C);a.wa&&(a=gf(a.wa),c=c+"  "+a[0],g=g+"  "+a[1]);return[c,g]}m.toString=function(){var a="",b=gf(this),a=a+(b[0]+"\n"+b[1]+"\n");this.g.length&&(a+=this.g[0].toString());return a};function $e(a){return P(a)?a:$e(a.g[0])}function cf(a){return P(a)?a:cf(a.g[a.g.length-1])}
...
256<a.zb.b.length)b=a.zb,d=a.zb.b.length-1,e=P(a)?d:d+1,g=0;else{b=!1;break a}a.b.splice(g,0,b.b[d]);b.b.splice(d,1);d=P(a)?a.A:a.g;h=null;P(a)?h=b.A:(h=b.g,h[e].C=a);d.splice(g,0,h[e]);h.splice(e,1);P(b)||(of(b),of(a));b=!0}b||pf(a,c)}return!0}
function pf(a,b){var c,d,e;a.wa&&511>a.wa.b.length?(c=a.wa,e=d=0):a.zb&&(c=a.zb,d=c.b.length,e=P(c)?c.A.length:c.g.length);d=[d,0].concat(a.b);Array.prototype.splice.apply(c.b,d);d=null;P(a)?d=a.A:(d=a.g,d.forEach(function(a){a.C=c}));d=[e,0].concat(d);Array.prototype.splice.apply(P(c)?c.A:c.g,d);hf(a.zb,a.wa);P(c)||of(c);-1!=b&&(a.C.b.splice(b,1),a.C.g.splice(b,1))}
m.wb=function(a,b,c){var d=kf(this,a);if(P(this)){if(this.F.Ra(this.b[d],a)){if(c)this.F.Ma().remove(a,this.F.Ga()?1:this.A[d].length),this.A[d]=this.F.Ga()?b:[b];else{if(this.F.Ga())throw new D(201);if(!Se(this.A[d],b))throw new D(109);}this.F.Ma().add(a,1);return this}this.b.splice(d,0,a);this.A.splice(d,0,this.F.Ga()?b:[b]);this.F.Ma().add(a,1);512==this.b.length?(d=bf(this.F),a=bf(this.F),a.hb=1,a.b=[this.b[256]],a.g=[this,d],a.C=this.C,this.C=a,d.b=this.b.splice(256),d.A=this.A.splice(256),d.C=
...
m.fill=function(a,b){if(P(this))for(var c=0;c<this.A.length&&0<a.count;++c)if(0<a.offset){if(a.offset-=this.F.Ga()?1:this.A[c].length,0>a.offset)for(var d=this.A[c].length+a.offset;d<this.A[c].length&&0<a.count;++d)b[a.le++]=this.A[c][d],a.count--}else if(this.F.Ga())b[a.le++]=this.A[c],a.count--;else for(d=0;d<this.A[c].length&&0<a.count;++d)b[a.le++]=this.A[c][d],a.count--;else for(c=0;c<this.g.length&&0<a.count;++c)this.g[c].fill(a,b)};
...
function I(a){return a.cb||a.w}Q.prototype.nc=function(a){var b=new this.constructor(this.w);b.cb=a;b.kg=this.kg;return b};Q.prototype.as=Q.prototype.nc;Q.prototype.createRow=Q.prototype.sb;Q.prototype.deserializeRow=Q.prototype.Lb;Q.prototype.Da=f("ia");Q.prototype.getIndices=Q.prototype.Da;Q.prototype.fb=f("K");Q.prototype.getColumns=Q.prototype.fb;Q.prototype.getConstraint=Q.prototype.Cb;Q.prototype.Fb=f("qd");Q.prototype.persistentIndex=Q.prototype.Fb;function ze(a){return a.w+".#"};function R(a,b){this.child=a;this.Ib=b;this.cb=null}m=R.prototype;m.getName=function(){return this.Ib+"("+this.child.getName()+")"};m.m=function(){return this.Ib+"("+this.child.m()+")"};m.H=function(){return this.child.H()};m.toString=function(){return this.m()};m.I=function(){return this.child.I()};m.Ya=f("cb");m.Da=function(){return[]};m.ua=l(null);m.Dc=l(!1);m.nc=function(a){this.cb=a;return this};R.prototype.as=R.prototype.nc;
...
function nh(a,b){var c="*";a.f.length&&(c=a.f.map(function(a){return a.Ya()?a.m()+" AS "+a.Ya():a.m()}).join(", "));c="SELECT "+c+" FROM ";null!=a.xb&&0!=a.xb.size?c+=oh(a,b):(c+=a.c.map(ph).join(", "),a.B&&(c+=lh(a.B,b)));if(a.N)var d=a.N.map(function(a){return a.M.m()+(0==a.jb?" DESC":" ASC")}).join(", "),c=c+(" ORDER BY "+d);a.ha&&(d=a.ha.map(function(a){return a.m()}).join(", "),c+=" GROUP BY "+d);a.Y&&(c+=" LIMIT "+a.Y.toString());a.O&&(c+=" SKIP "+a.O.toString());return c+";"}
function ph(a){return I(a)!=a.getName()?a.getName()+" AS "+I(a):a.getName()}function oh(a,b){for(var c=Sf(a.B,function(a){return a instanceof bg}),d=c.map(kh),e=ph(a.c[0]),g=1;g<a.c.length;g++)var h=ph(a.c[g]),e=a.xb.has(c[d.length-g].V())?e+(" LEFT OUTER JOIN "+h):e+(" INNER JOIN "+h),e=e+(" ON ("+d[d.length-g]+")");c=Bd(a.B,0);c instanceof bg||(e+=" WHERE "+jh(c,b));return e}
...
function xh(a){a.a.f.forEach(function(a){if(a instanceof R&&!Ah(a.Ib,a.I()))throw new D(527,a.m());},a)}function Bh(a,b){if(null==a.a.c)throw new D(b);}U.prototype.c=function(a){if(this.Be)throw new D(515);this.Be=!0;null==this.a.c&&(this.a.c=[]);this.a.c.push.apply(this.a.c,Array.prototype.slice.call(arguments));return this};U.prototype.from=U.prototype.c;U.prototype.B=function(a){Bh(this,548);if(this.yd)throw new D(516);this.yd=!0;Ch(this,a);return this};U.prototype.where=U.prototype.B;
function Ch(a,b){if(null!=a.a.B){var c=uh(b,a.a.B);a.a.B=c}else a.a.B=b}U.prototype.Qf=function(a,b){Bh(this,542);if(this.yd)throw new D(547);this.a.c.push(a);Ch(this,b);return this};U.prototype.innerJoin=U.prototype.Qf;U.prototype.Vf=function(a,b){Bh(this,542);if(!(b instanceof bg))throw new D(541);if(this.yd)throw new D(547);this.a.c.push(a);null==this.a.xb&&(this.a.xb=C());var c=b;I(a)!=I(b.ka.H())&&(c=b.reverse());this.a.xb.add(c.V());Ch(this,c);return this};U.prototype.leftOuterJoin=U.prototype.Vf;
...
function Oj(a){if(null!==a.xa){var b=function(a){return a.name},c=JSON.stringify(a.ia.get(a.xa).map(b));a.ia.forEach(function(a,e){if(e!=this.xa){var g=a.map(b);if(JSON.stringify(g)==c)throw new D(544,this.w+"."+e);}},a)}}function Pj(a){null===a.xa||a.ia.get(a.xa).forEach(function(a){if(this.Ic.has(a.name))throw new D(545,this.w+"."+a.name);},a)}X.prototype.nf=function(a,b){Ij(a);Lj(this,a);this.K.set(a,b);Kj.has(b)&&this.re([a]);return this};X.prototype.addColumn=X.prototype.nf;
X.prototype.pf=function(a,b){var c=this.w;this.xa="pk"+(c[0].toUpperCase()+c.substring(1));Ij(this.xa);Lj(this,this.xa);c=Qj(this,a,!0,void 0,b);Mj(this,c);1==c.length&&this.xd.add(c[0].name);this.jc.add(this.xa);this.ia.set(this.xa,c);return this};X.prototype.addPrimaryKey=X.prototype.pf;
X.prototype.of=function(a,b){Ij(a);Lj(this,a);var c=new Hj(b,this.w+"."+a);q(c.action)||(c.action=0);q(c.timing)||(c.timing=0);if(1==c.action&&1==c.timing)throw new D(506);if(!this.K.has(c.qb))throw new D(540,a);this.tb.push(c);this.qe(a,[c.qb],this.xd.has(c.qb));return this};X.prototype.addForeignKey=X.prototype.of;X.prototype.qf=function(a,b){Ij(a);Lj(this,a);var c=Qj(this,b,!0);Rj(this,a,c);1==c.length&&(this.xd.add(c[0].name),Sj(this,c[0].name));this.ia.set(a,c);this.jc.add(a);return this};
...
function Uj(a){function b(){function b(c){return a.ia.get(c).map(function(a){return{ga:this[a.name],jb:a.jb,autoIncrement:a.autoIncrement}},this)}var d=Ib(a.K).map(function(b){this[b]=new W(this,b,a.xd.has(b),a.Ic.has(b),a.K.get(b));return this[b]},this),e=Ib(a.ia).map(function(d){return new jg(a.w,d,a.jc.has(d),b.call(this,d))},this);Q.call(this,a.w,d,e,a.qd);var g=null===a.xa?null:new jg(a.w,a.xa,!0,b.call(this,a.xa)),h=d.filter(function(b){return!a.Ic.has(b.getName())});this.xf=new Gj(g,h,a.tb);
