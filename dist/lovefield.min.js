...
lf.index.SimpleComparator=function(a){this.compare_=a==lf.Order.DESC?lf.index.SimpleComparator.compareDescending:lf.index.SimpleComparator.compareAscending};lf.index.SimpleComparator.compareAscending=function(a,b){return a>b?1:a<b?-1:0};lf.index.SimpleComparator.compareDescending=function(a,b){return a>b?-1:a<b?1:0};lf.index.SimpleComparator.prototype.compare=function(a,b){return this.compare_(a,b)};
lf.index.MultiKeyComparator=function(a){this.comparators_=a.map(function(a){return a==lf.Order.DESC?lf.index.SimpleComparator.compareDescending:lf.index.SimpleComparator.compareAscending})};lf.index.MultiKeyComparator.createOrders=function(a,b){for(var c=Array(a),d=0;d<a;++d)c[d]=b;return c};lf.index.MultiKeyComparator.prototype.compare=function(a,b){for(var c=0,d=0;d<this.comparators_.length&&0==c;++d)c=this.comparators_[d](a[d],b[d]);return c};
...
lf.schema.TableBuilder=function(a){this.name_=a;this.columns_=new goog.structs.Map;this.uniqueColumns_=new goog.structs.Set;this.uniqueIndices_=new goog.structs.Set;this.nullable_=new goog.structs.Set;this.pkName_="pk"+lf.schema.TableBuilder.toPascal_(this.name_);this.indices_=new goog.structs.Map;this.persistIndex_=!1;this.checkName_(a)};lf.schema.TableBuilder.toPascal_=function(a){return a[0].toUpperCase()+a.substring(1)};
lf.schema.TableBuilder.prototype.checkName_=function(a){if(!/^[A-Za-z_][A-Za-z0-9_]*$/.test(a))throw new lf.Exception(lf.Exception.Type.SYNTAX,a+" violates naming rule");if(this.columns_.containsKey(a)||this.indices_.containsKey(a)||this.uniqueIndices_.contains(a))throw new lf.Exception(lf.Exception.Type.SYNTAX,this.name_+"."+a+" is already defined");};lf.schema.TableBuilder.prototype.getSchema=function(){var a=this.generateTableClass_();return new a};
lf.schema.TableBuilder.prototype.generateTableClass_=function(){var a=this.indices_.getKeys().map(function(a){return new lf.schema.Index(this.name_,a,this.uniqueIndices_.contains(a),this.indices_.get(a))},this),b=this,c=function(){this.cols_=b.columns_.getKeys().map(function(a){this[a]=new lf.schema.BaseColumn(this,a,b.uniqueColumns_.contains(a),b.columns_.get(a));return this[a]},this);lf.schema.Table.call(this,b.name_,this.cols_,a,b.persistIndex_);var c=b.indices_.containsKey(b.pkName_)?new lf.schema.Index(b.name_,
...
lf.schema.Builder=function(a,b){this.name_=a;this.version_=b;this.tableBuilders_=new goog.structs.Map;this.finalized_=!1;this.tables_=new goog.structs.Map};lf.schema.Builder.prototype.name=function(){return this.name_};lf.schema.Builder.prototype.version=function(){return this.version_};lf.schema.Builder.prototype.tables=function(){if(!this.finalized_)throw new lf.Exception(lf.Exception.Type.SYNTAX,"Attempt to getTables before getSchema is invoked");return this.tables_.getValues()};
lf.schema.Builder.prototype.table=function(a){if(!this.tables_.containsKey(a))throw new lf.Exception(lf.Exception.Type.NOT_FOUND,a+" is not found in database");return this.tables_.get(a)};lf.schema.Builder.prototype.finalize_=function(){this.finalized_||(this.tableBuilders_.getKeys().forEach(function(a){var b=this.tableBuilders_.get(a);this.tables_.set(a,b.getSchema())},this),this.tableBuilders_.clear(),this.finalized_=!0)};
lf.schema.Builder.prototype.getSchema=function(){this.finalized_||this.finalize_();return this};lf.schema.Builder.prototype.getGlobal=function(){var a=new lf.service.ServiceId("ns_"+this.name_),b=lf.Global.get(),c=null;b.isRegistered(a)?c=b.getService(a):(c=new lf.Global,b.registerService(a,c));return c};
lf.schema.Builder.prototype.getInstance=function(a,b){var c=this.getGlobal();this.finalized_||(this.finalize_(),c.isRegistered(lf.service.SCHEMA)||c.registerService(lf.service.SCHEMA,this));c=new lf.proc.Database(c);return c.init(a,b?lf.base.BackStoreType.MEMORY:void 0,!1)};lf.schema.create=function(a,b){return new lf.schema.Builder(a,b)};goog.exportSymbol("lf.schema.create",lf.schema.create);
