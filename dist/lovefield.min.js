...
lf.index.SimpleComparator=function(a){this.compare_=a==lf.Order.DESC?lf.index.SimpleComparator.compareDescending:lf.index.SimpleComparator.compareAscending};lf.index.SimpleComparator.compareAscending=function(a,b){return a>b?lf.index.FAVOR.LHS:a<b?lf.index.FAVOR.RHS:lf.index.FAVOR.TIE};lf.index.SimpleComparator.compareDescending=function(a,b){return a>b?lf.index.FAVOR.RHS:a<b?lf.index.FAVOR.LHS:lf.index.FAVOR.TIE};
lf.index.SimpleComparator.isInRange=function(a,b,c){var d=goog.isNull(c.from);if(!d)var e=a(b,c.from),d=c.excludeLower?e==lf.index.FAVOR.LHS:e!=lf.index.FAVOR.RHS;e=goog.isNull(c.to);e||(e=a(b,c.to),e=c.excludeUpper?e==lf.index.FAVOR.RHS:e!=lf.index.FAVOR.LHS);return d&&e};lf.index.SimpleComparator.prototype.compare=function(a,b){return this.compare_(a,b)};lf.index.SimpleComparator.prototype.isInRange=function(a,b){return lf.index.SimpleComparator.isInRange(this.compare_,a,b)};
lf.index.MultiKeyComparator=function(a){this.comparators_=a.map(function(a){return a==lf.Order.DESC?lf.index.SimpleComparator.compareDescending:lf.index.SimpleComparator.compareAscending})};lf.index.MultiKeyComparator.createOrders=function(a,b){for(var c=Array(a),d=0;d<a;++d)c[d]=b;return c};lf.index.MultiKeyComparator.prototype.compare=function(a,b){for(var c=0,d=0;d<this.comparators_.length&&0==c;++d)c=this.comparators_[d](a[d],b[d]);return c};lf.index.MultiKeyComparator.prototype.isInRange=function(){};
...
lf.index.RowId.prototype.get=function(a){return this.containsKey(a)?[a]:[]};lf.index.RowId.prototype.cost=function(){return this.rows_.getCount()};
lf.index.RowId.prototype.getRange=function(a,b,c,d){var e=a||lf.index.KeyRange.all();if(goog.isDefAndNotNull(e.from)&&"number"!=typeof e.from||goog.isDefAndNotNull(e.to)&&"number"!=typeof e.to)throw new lf.Exception(lf.Exception.Type.DATA,"Row id must be numbers");a=this.rows_.getValues().filter(function(a){return this.comparator_.isInRange(a,e)},this);return lf.index.slice(a,b,c,d)};lf.index.RowId.prototype.clear=function(){this.rows_.clear()};lf.index.RowId.prototype.containsKey=function(a){return this.rows_.contains(a)};
lf.index.RowId.prototype.serialize=function(){return[new lf.Row(lf.index.RowId.ROW_ID,this.rows_.getValues())]};lf.index.RowId.deserialize=function(a,b){var c=new lf.index.RowId(a),d=b[0].payload();d.forEach(function(a){c.add(a,a)});return c};
...
lf.index.AANode_=function(){this.level=0;this.left=this;this.right=this};lf.index.AANode_.create=function(a,b,c){var d=new lf.index.AANode_;d.level=1;d.left=c;d.right=c;d.key=a;d.value=b;return d};lf.index.AATree=function(a){this.name_=a;this.nullNode_=new lf.index.AANode_;this.deleted_=null;this.root_=this.nullNode_;this.comparator_=new lf.index.SimpleComparator(lf.Order.ASC)};lf.index.AATree.prototype.getName=function(){return this.name_};
...
lf.index.AATree.prototype.insert_=function(a,b,c){if(a==this.nullNode_)return lf.index.AANode_.create(b,c,this.nullNode_);if(b<a.key)a.left=this.insert_(a.left,b,c);else if(b>a.key)a.right=this.insert_(a.right,b,c);else throw new lf.Exception(lf.Exception.Type.CONSTRAINT,"AA index does not support duplicate keys");a=this.skew_(a);return a=this.split_(a)};lf.index.AATree.prototype.add=function(a,b){this.root_=this.insert_(this.root_,a,b)};
lf.index.AATree.prototype.set=function(a,b){var c=this.search_(this.root_,a);null==c?this.add(a,b):c.value=b};
...
lf.index.AATree.prototype.findMin_=function(){for(var a=this.root_;a.left!=this.nullNode_;)a=a.left;return a};lf.index.AATree.prototype.findMax_=function(){for(var a=this.root_;a.right!=this.nullNode_;)a=a.right;return a};lf.index.AATree.prototype.traverse_=function(a,b,c){a!=this.nullNode_&&(a.key>b.from&&this.traverse_(a.left,b,c),this.comparator_.isInRange(a.key,b)&&c.push(a.value),a.key<b.to&&this.traverse_(a.right,b,c))};
...
lf.index.Map.prototype.remove=function(a,b){var c=this.map_.get(a);goog.isDefAndNotNull(c)&&(goog.isDefAndNotNull(b)?c.remove(b):c.clear(),0==c.getCount()&&this.map_.remove(a))};lf.index.Map.prototype.get=function(a){a=this.map_.get(a);return goog.isDefAndNotNull(a)?a.getValues():[]};lf.index.Map.prototype.cost=function(a){return this.getRange(a).length};
lf.index.Map.prototype.getRange=function(a,b,c,d){var e=[],f=a||lf.index.KeyRange.all();this.map_.getKeys().sort().forEach(function(a){this.comparator_.isInRange(a,f)&&(e=e.concat(this.get(a)))},this);return lf.index.slice(e,b,c,d)};lf.index.Map.prototype.clear=function(){return this.map_.clear()};lf.index.Map.prototype.containsKey=function(a){return this.map_.containsKey(a)};lf.index.Map.prototype.serialize=function(){goog.asserts.fail("Map index serialization is not supported.");return[]};
...
lf.schema.Builder.prototype.getGlobal=function(){var a=new lf.service.ServiceId("ns_"+this.schema_.name()),b=lf.Global.get(),c=null;b.isRegistered(a)?c=b.getService(a):(c=new lf.Global,b.registerService(a,c));return c};lf.schema.Builder.prototype.getInstance=function(a,b){var c=this.getGlobal();c.isRegistered(lf.service.SCHEMA)||c.registerService(lf.service.SCHEMA,this.getSchema());c=new lf.proc.Database(c);return c.init(a,b?lf.base.BackStoreType.MEMORY:void 0,!1)};
lf.schema.DatabaseSchema_=function(a,b){this.name_=a;this.version_=b;this.tables_=new goog.structs.Map};lf.schema.DatabaseSchema_.prototype.name=function(){return this.name_};lf.schema.DatabaseSchema_.prototype.version=function(){return this.version_};lf.schema.DatabaseSchema_.prototype.tables=function(){return this.tables_.getValues()};
lf.schema.DatabaseSchema_.prototype.table=function(a){if(!this.tables_.containsKey(a))throw new lf.Exception(lf.Exception.Type.NOT_FOUND,a+" is not found in database");return this.tables_.get(a)};lf.schema.DatabaseSchema_.prototype.setTable=function(a){this.tables_.set(a.getName(),a)};lf.schema.create=function(a,b){return new lf.schema.Builder(a,b)};goog.exportSymbol("lf.schema.create",lf.schema.create);
