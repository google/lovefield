...
lf.cache.Prefetcher.prototype.reconstructPersistentIndex_=function(a,b){var c=b.getTable(a.getNormalizedName(),lf.Row.deserialize,lf.backstore.TableType.INDEX);return c.get([]).then(goog.bind(function(b){goog.asserts.assert(b[0].payload().type==lf.index.IndexMetadata.Type.BTREE);1<b.length&&(b=lf.index.BTree.deserialize(b.slice(1),a.getNormalizedName(),a.isUnique),this.indexStore_.set(b))},this))};
