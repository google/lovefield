...
a.ze);if(a instanceof hh)return new ej(this.f,a.table);if(a instanceof gh)return new cj(this.f,a.table);throw new E(514);};function Fj(a){this.mg=new xi;this.Ag=new Dj(a)};function Gj(){this.ef=z()}function Hj(a,b){var c=a.ef.get(b.getName())||null;null===c&&(c=new Ij,a.ef.set(b.getName(),c));return c}function Jj(a,b,c,d){c.forEach(function(a){a=Hj(this,a);0==d?(a.fb=null,a.Ac=b):3==d?(null===a.ac&&(a.ac=C()),a.ac.add(b),null===a.Va&&(a.Va=C()),a.Va.delete(b)):1==d?(null===a.Va&&(a.Va=C()),a.Va.add(b)):2==d&&(a.fb=b)},a)}
function Kj(a,b,c,d){var e=!0;c.forEach(function(a){if(e){a=Hj(this,a);var c=null===a.Va||0==a.Va.size;e=0==d?(null===a.ac||0==a.ac.size)&&c&&null===a.Ac&&null!==a.fb&&a.fb==b:3==d?null===a.Ac&&null===a.fb&&null!==a.Va&&a.Va.has(b):1==d?null===a.fb:c&&(null===a.fb||a.fb==b)}},a);return e}function Lj(a,b,c,d){var e=Kj(a,b,c,d);e&&Jj(a,b,c,d);return e}Gj.prototype.releaseLock=function(a,b){b.forEach(function(b){Hj(this,b).releaseLock(a)},this)};
function Mj(a,b){b.forEach(function(a){Hj(this,a).fb=null},a)}function Ij(){this.ac=this.Va=this.fb=this.Ac=null}Ij.prototype.releaseLock=function(a){this.Ac==a&&(this.Ac=null);this.fb==a&&(this.fb=null);null===this.Va||this.Va.delete(a);null===this.ac||this.ac.delete(a)};function Nj(){this.Xb=new Oj;this.Ic=new Gj}function xe(a,b){(2>b.getPriority()||2>b.getPriority())&&Mj(a.Ic,b.ea());a.Xb.Eb(b);Pj(a);return b.Rb().fa}function Pj(a){for(var b=a.Xb.qa(),c=0;c<b.length;c++){var d=b[c],e=!1;if(e=0==d.L()?Qj(a,d,1,3):Qj(a,d,2,0))a.Xb.remove(d),e=a,d.exec().then(e.xg.bind(e,d),e.wg.bind(e,d))}}function Qj(a,b,c,d){var e=!1;Lj(a.Ic,b.aa(),b.ea(),c)&&(e=Lj(a.Ic,b.aa(),b.ea(),d));return e}
Nj.prototype.xg=function(a,b){this.Ic.releaseLock(a.aa(),a.ea());a.Rb().resolve(b);Pj(this)};Nj.prototype.wg=function(a,b){this.Ic.releaseLock(a.aa(),a.ea());a.Rb().reject(b);Pj(this)};function Oj(){this.Xb=[]}Oj.prototype.Eb=function(a){vf(this.Xb,a,function(a,c){var d=a.getPriority()-c.getPriority();return 0==d?a.aa()-c.aa():d})};Oj.prototype.qa=function(){return this.Xb.slice()};Oj.prototype.remove=function(a){var b=this.Xb;a=xa(b,a);var c;(c=0<=a)&&Array.prototype.splice.call(b,a,1);return c};function Rj(a,b){this.Qd=Td();this.le=a;this.qd=b;this.M=Sj(this)}function Sj(a){if(0<a.le.g.length)return a.le.g;var b=[];a.le.c.forEach(function(a){a.nb().forEach(function(a){b.push(a)})});return b}Rj.prototype.$=function(a,b){return this.M.every(function(c){return Ud(this.Qd,c.L(),"eq")(I(a,c),I(b,c))},this)};
function Tj(a,b,c){var d=null===b?[]:b.entries,e=pb(d,c.entries,a.$.bind(a),function(a){return d[a]});b=[];for(var f=0,h=0;h<d.length;h++){var k=d[h];e[f]==k?f++:(k=a.qd.splice(f,1),k=Uj(h,k,0,a.qd),b.push(k))}e=pb(d,c.entries,a.$.bind(a),function(a,b){return c.entries[b]});for(h=f=0;h<c.entries.length;h++)k=c.entries[h],e[f]==k?f++:(a.qd.splice(h,0,k.ua.s),k=Uj(h,[],1,a.qd),b.push(k));return b}function Uj(a,b,c,d){return{Pg:c,index:a,object:d,Rg:b,type:"splice"}};function Vj(){this.ic=z()}Vj.prototype.Cd=function(a,b){var c=ka(a.a).toString(),d=this.ic.get(c)||null;null===d&&(d=new Wj(a),this.ic.set(c,d));d.Cd(b)};Vj.prototype.me=function(a,b){var c=ka(a.a).toString(),d=this.ic.get(c)||null;d.me(b);0<d.Kc.size||this.ic.delete(c)};function we(a,b){var c=C();b.forEach(function(a){c.add(a.getName())});var d=[];a.ic.forEach(function(a){a=a.Fc();a.context.c.some(function(a){return c.has(a.getName())})&&d.push(a)});return d}
function ue(a,b,c){b=ka(null!=b.Zc?b.Zc:b).toString();a=a.ic.get(b)||null;null!==a&&Xj(a,c)}function Wj(a){this.Jf=a;this.Kc=C();this.ug=[];this.cf=null;this.Qf=new Rj(a.a,this.ug)}Wj.prototype.Cd=function(a){this.Kc.has(a)||this.Kc.add(a)};Wj.prototype.me=function(a){return this.Kc.delete(a)};Wj.prototype.Fc=function(){var a=this.Jf;return{context:a.a,je:Xh(a)}};function Xj(a,b){var c=Tj(a.Qf,a.cf,b);a.cf=b;0<c.length&&a.Kc.forEach(function(a){a(c)})};function Yj(a,b){var c=a.l(qc),d=b||{},e=new rf(c);a.ub(lc,e);var e=null,f=!1;null!=d.storeType?e=d.storeType:(e=Tb(),e=e.dg?0:e.Og?4:1);switch(e){case 0:e=new We(a,c);break;case 1:e=new cf(c);break;case 5:e=new ef(c);break;case 4:e=new of(a,c,d.webSqlDbSize);break;case 3:e=new Je(c,d.firebase);f=!0;break;default:throw new E(300);}a.ub(kc,e);var h=new sg;a.ub(mc,h);return e.Da(d.onUpgrade).then(function(){var b=new Fj(a);a.ub(nc,b);b=new Nj;a.ub(oc,b);b=new Vj;a.ub(pc,b);return h.Da(c)}).then(function(){if(f){var b=
new ye(a);b.Na.subscribe(b.ee.bind(b))}return(new lg(a)).Da(c)})};function Zj(a){this.f=a;this.h=a.l(qc);this.ba=C(this.h.va());this.gb=x()}m=Zj.prototype;m.exec=function(){var a=this.f.l(mc),b=this.f.l(lc),c={};this.h.va().forEach(function(d){var f=a.get($e(d)).bb(),f=sf(b,f).map(function(a){return a.s});c[d.getName()]=f});var d={name:this.h.name(),version:this.h.version(),tables:c},d=new Gd(new Wb(-1,d),!0);return w([new H([d],[])])};m.L=l(0);m.ea=g("ba");m.Rb=g("gb");m.aa=function(){return ka(this)};m.getPriority=l(0);function ak(a,b){this.f=a;this.h=a.l(qc);this.ba=C(this.h.va());this.gb=x();this.za=b;this.Na=a.l(kc);this.W=a.l(lc);this.G=a.l(mc)}m=ak.prototype;
m.exec=function(){if(!(this.Na instanceof We||this.Na instanceof cf||this.Na instanceof of))throw new E(300);var a;a:{a=this.h.va();for(var b=0;b<a.length;++b)if(0<this.G.get($e(a[b])).Ma().ma){a=!1;break a}a=!0}if(!a)throw new E(110);if(this.h.name()!=this.za.name||this.h.version()!=this.za.version)throw new E(111);if(null==this.za.tables)throw new E(112);return bk(this)};m.L=l(1);m.ea=g("ba");m.Rb=g("gb");m.aa=function(){return ka(this)};m.getPriority=l(0);
function bk(a){var b=new jd(a.f,a.ba),b=a.Na.Jb(a.L(),D(a.ba),b),c;for(c in a.za.tables){var d=a.h.table(c),e=a.za.tables[c].map(function(a){return d.Bb(a)}),f=b.K(c,d.mb,0);a.W.Zb(c,e);var h=a.G.pc.get(c)||[];e.forEach(function(a){h.forEach(function(b){var c=a.pb(b.getName());b.add(c,a.id())})});f.put(e)}return b.ja()};function ck(a,b){this.f=a;this.Na=a.l(kc);this.Ha=a.l(oc);this.Nb=a.l(pc);this.ba=C(b);this.Ta=new jd(this.f,this.ba);this.gb=x();this.Bc=x();this.Be=x()}m=ck.prototype;m.exec=function(){this.Be.resolve();return this.Bc.fa};m.L=l(1);m.ea=g("ba");m.Rb=g("gb");m.aa=function(){return ka(this)};m.getPriority=l(2);function dk(a){xe(a.Ha,a);return a.Be.fa}
function ek(a,b){var c=b.Fc();return c.je.cb().exec(a.Ta,c.context).then(function(a){return yd(a[0])},function(a){this.Ta.Ob();var b=new jb(a.name);this.Bc.reject(b);throw a;}.bind(a))}m.ja=function(){this.Na.Jb(this.L(),D(this.ba),this.Ta).ja().then(function(){this.Pc();this.Bc.resolve()}.bind(this),function(a){this.Ta.Ob();this.Bc.reject(a)}.bind(this));return this.gb.fa};m.Ob=function(){this.Ta.Ob();this.Bc.resolve();return this.gb.fa};
m.Pc=function(){var a=we(this.Nb,this.ba);0!=a.length&&(a=new te(this.f,a),xe(this.Ha,a))};function fk(a){this.f=a;this.Ha=a.l(oc);this.Sc=null;this.Wa=0;0==gk.size&&(gk.set(0,C([1,4])),gk.set(1,C([2])),gk.set(2,C([3,5,6])),gk.set(3,C([2,7])),gk.set(4,C([7])),gk.set(5,C([7])),gk.set(6,C([7])))}r("lf.proc.Transaction",fk);var gk=z();function hk(a,b){var c=gk.get(a.Wa)||null;if(null===c||!c.has(b))throw new E(107,a.Wa,b);a.Wa=b}
fk.prototype.exec=function(a){hk(this,4);var b=[];try{a.forEach(function(a){a.kb();b.push(a.Fc())},this)}catch(c){return hk(this,7),bb(c)}a=new Ah(this.f,b);return xe(this.Ha,a).then(function(a){hk(this,7);return a.map(function(a){return yd(a)})}.bind(this),function(a){hk(this,7);throw a;}.bind(this))};fk.prototype.exec=fk.prototype.exec;fk.prototype.Hf=function(a){hk(this,1);this.Sc=new ck(this.f,a);return dk(this.Sc).then(function(){hk(this,2)}.bind(this))};fk.prototype.begin=fk.prototype.Hf;
fk.prototype.Gf=function(a){hk(this,3);return ek(this.Sc,a).then(function(a){hk(this,2);return a}.bind(this),function(a){hk(this,7);throw a;}.bind(this))};fk.prototype.attach=fk.prototype.Gf;fk.prototype.ja=function(){hk(this,5);return this.Sc.ja().then(function(){hk(this,7)}.bind(this))};fk.prototype.commit=fk.prototype.ja;fk.prototype.Ob=function(){hk(this,6);return this.Sc.Ob().then(function(){hk(this,7)}.bind(this))};fk.prototype.rollback=fk.prototype.Ob;function W(a){this.f=a;this.h=a.l(qc);this.ld=!1}r("lf.proc.Database",W);W.prototype.Da=function(a){this.f.ub(qc,this.h);return Yj(this.f,a).then(function(){this.ld=!0;this.Ha=this.f.l(oc);return this}.bind(this))};W.prototype.init=W.prototype.Da;W.prototype.Db=g("h");W.prototype.getSchema=W.prototype.Db;function ik(a){if(!a.ld)throw new E(2);}W.prototype.select=function(a){ik(this);return new V(this.f,1!=arguments.length||null!=arguments[0]?Array.prototype.slice.call(arguments):[])};
W.prototype.select=W.prototype.select;W.prototype.Eb=function(){ik(this);return new Zh(this.f)};W.prototype.insert=W.prototype.Eb;W.prototype.Wd=function(){ik(this);return new Zh(this.f,!0)};W.prototype.insertOrReplace=W.prototype.Wd;W.prototype.update=function(a){ik(this);return new ii(this.f,a)};W.prototype.update=W.prototype.update;W.prototype.delete=function(){ik(this);return new Yh(this.f)};W.prototype["delete"]=W.prototype.delete;
W.prototype.observe=function(a,b){ik(this);this.f.l(pc).Cd(a,b)};W.prototype.observe=W.prototype.observe;W.prototype.unobserve=function(a,b){ik(this);this.f.l(pc).me(a,b)};W.prototype.unobserve=W.prototype.unobserve;W.prototype.Of=function(){ik(this);return new fk(this.f)};W.prototype.createTransaction=W.prototype.Of;W.prototype.close=function(){try{this.f.l(kc).close()}catch(a){}this.f.clear();this.ld=!1};W.prototype.close=W.prototype.close;
W.prototype.Wf=function(){ik(this);var a=new Zj(this.f);return xe(this.Ha,a).then(function(a){return yd(a[0])[0]})};W.prototype["export"]=W.prototype.Wf;W.prototype.import=function(a){ik(this);a=new ak(this.f,a);return xe(this.Ha,a).then(l(null))};W.prototype["import"]=W.prototype.import;function X(a,b,c,d,e,f){this.V=a;this.C=b;this.Ze=c;this.Xe=d;this.zf=e;this.jb=f||null}r("lf.schema.BaseColumn",X);m=X.prototype;m.getName=g("C");m.m=function(){return Id(this.V)+"."+this.C};m.toString=function(){return this.m()};m.K=g("V");m.L=g("zf");X.prototype.getType=X.prototype.L;X.prototype.ab=g("jb");X.prototype.Ca=function(){null==this.sa&&(this.sa=[],this.K().Ca().forEach(function(a){-1!=a.g.map(function(a){return a.ca.getName()}).indexOf(this.C)&&this.sa.push(a)},this));return this.sa};
...
X.prototype.ag=function(a){return Lg(this,a,"in")};X.prototype["in"]=X.prototype.ag;X.prototype.ig=function(){return this.Pa(null)};X.prototype.isNull=X.prototype.ig;X.prototype.hg=function(){return this.ff(null)};X.prototype.isNotNull=X.prototype.hg;X.prototype.vc=function(a){return new X(this.V,this.C,this.Ze,this.Xe,this.zf,a)};X.prototype.as=X.prototype.vc;function jk(){this.wd=z()}var kk;jk.prototype.clear=function(){this.wd.clear()};jk.prototype.clear=jk.prototype.clear;jk.prototype.ub=function(a,b){this.wd.set(a.toString(),b);return b};jk.prototype.registerService=jk.prototype.ub;jk.prototype.l=function(a){var b=this.wd.get(a.toString())||null;if(null===b)throw new E(7,a.toString());return b};jk.prototype.getService=jk.prototype.l;jk.prototype.Zd=function(a){return this.wd.has(a.toString())};jk.prototype.isRegistered=jk.prototype.Zd;function lk(a){this.h=a;this.Id=new Rc;this.ne=new Rc;this.hf=new Rc;this.Ke=z();this.i=new Rc;this.Ge=new Rc;this.pf=new Rc;this.Je=new Rc;mk(this)}function mk(a){a.h.va().forEach(function(a){var c=a.getName();a.Lb().Vd().forEach(function(d){this.hf.set(c,this.h.table(d.Ua));this.i.set(d.Ua,a);0==d.action?(this.ne.set(d.Ua,d),this.pf.set(d.Ua,a)):(this.Id.set(d.Ua,d),this.Ge.set(d.Ua,a));this.Ke.set(a.getName()+"."+d.zb,d.Ua);this.Je.set(d.Ua+"."+d.Mc,a.getName())},this)},a)}
...
function Jh(a,b){var c=C();b.forEach(function(a){(a=this.Je.get(a))&&a.forEach(function(a){c.add(a)})},a);return D(c).map(function(a){return this.h.table(a)},a)};function nk(a,b,c){this.Bg=a;this.tg=b;this.Xf=c}r("lf.schema.Constraint",nk);nk.prototype.ed=g("Bg");nk.prototype.getPrimaryKey=nk.prototype.ed;nk.prototype.Vd=g("Xf");nk.prototype.getForeignKeys=nk.prototype.Vd;function ok(a,b,c){var d=a.ref.split(".");if(2!=d.length)throw new E(540,c);this.Ie=b;this.zb=a.local;this.Ua=d[0];this.Mc=d[1];this.name=b+"."+c;this.action=a.action;this.timing=a.timing};function Y(a){pk(a);this.Qd=Td();this.C=a;this.M=z();this.zd=C();this.rc=C();this.pd=C();this.Ea=null;this.sa=z();this.td=!1;this.Cb=[]}r("lf.schema.TableBuilder",Y);function qk(a){this.name=a.name;this.sb=a.order;this.autoIncrement=a.autoIncrement}var rk=C([0,6]);function pk(a){if(!/^[A-Za-z_][A-Za-z0-9_]*$/.test(a))throw new E(502,a);}function sk(a,b){if(b==a.C)throw new E(546,b);if(a.M.has(b)||a.sa.has(b)||a.rc.has(b))throw new E(503,a.C+"."+b);}
function tk(a,b){var c=!1;b.forEach(function(a){var b=this.M.get(a.name);c=c||a.autoIncrement;if(a.autoIncrement&&3!=b)throw new E(504);},a);if(c&&1<b.length)throw new E(505);}function uk(a){if(null!==a.Ea){var b=a.sa.get(a.Ea).map(function(a){return a.name}),c=0;if(a.Cb.some(function(a,e){c=e;return-1!=b.indexOf(a.zb)},a))throw new E(543,a.Cb[c].name);}}
function vk(a){if(null!==a.Ea){var b=function(a){return a.name},c=JSON.stringify(a.sa.get(a.Ea).map(b));a.sa.forEach(function(a,e){if(e!=this.Ea){var f=a.map(b);if(JSON.stringify(f)==c)throw new E(544,this.C+"."+e);}},a)}}function wk(a){null===a.Ea||a.sa.get(a.Ea).forEach(function(a){if(this.pd.has(a.name))throw new E(545,this.C+"."+a.name);},a)}Y.prototype.Bf=function(a,b){pk(a);sk(this,a);this.M.set(a,b);rk.has(b)&&this.De([a]);return this};Y.prototype.addColumn=Y.prototype.Bf;
Y.prototype.Df=function(a,b){var c=this.C;this.Ea="pk"+(c[0].toUpperCase()+c.substring(1));pk(this.Ea);sk(this,this.Ea);c=xk(this,a,!0,void 0,b);tk(this,c);1==c.length&&this.zd.add(c[0].name);this.rc.add(this.Ea);this.sa.set(this.Ea,c);return this};Y.prototype.addPrimaryKey=Y.prototype.Df;
Y.prototype.Cf=function(a,b){pk(a);sk(this,a);var c=new ok(b,this.C,a);q(c.action)||(c.action=0);q(c.timing)||(c.timing=0);if(1==c.action&&1==c.timing)throw new E(506);if(!this.M.has(c.zb))throw new E(540,a);this.Cb.push(c);this.Ce(a,[c.zb],this.zd.has(c.zb));return this};Y.prototype.addForeignKey=Y.prototype.Cf;Y.prototype.Ef=function(a,b){pk(a);sk(this,a);var c=xk(this,b,!0);1==c.length&&(this.zd.add(c[0].name),yk(this,c[0].name));this.sa.set(a,c);this.rc.add(a);return this};
Y.prototype.addUnique=Y.prototype.Ef;function yk(a,b){a.Cb.forEach(function(a){a.zb==b&&this.rc.add(a.name.split(".")[1])},a)}Y.prototype.De=function(a){xk(this,a,!1).forEach(function(a){this.pd.add(a.name)},this);return this};Y.prototype.addNullable=Y.prototype.De;Y.prototype.Ce=function(a,b,c,d){pk(a);sk(this,a);b=xk(this,b,!0,d);c&&this.rc.add(a);this.sa.set(a,b);return this};Y.prototype.addIndex=Y.prototype.Ce;Y.prototype.Hb=ca("td");Y.prototype.persistentIndex=Y.prototype.Hb;
Y.prototype.Db=function(){uk(this);vk(this);wk(this);return new (zk(this))};Y.prototype.getSchema=Y.prototype.Db;function Ak(a){return a.Cb}function xk(a,b,c,d,e){var f=b,f="string"==typeof b[0]?b.map(function(a){return new qk({name:a,order:null!=d?d:1,autoIncrement:e||!1})}):b.map(function(a){return new qk(a)});f.forEach(function(a){if(!this.M.has(a.name))throw new E(508,this.C,a.name);if(c){var b=this.M.get(a.name);if(0==b||6==b)throw new E(509,this.C,a.name);}},a);return f}
function zk(a){function b(){function b(c){return a.sa.get(c).map(function(a){return{ca:this[a.name],sb:a.sb,autoIncrement:a.autoIncrement}},this)}var d=Vb(a.M).map(function(b){this[b]=new X(this,b,a.zd.has(b),a.pd.has(b),a.M.get(b));return this[b]},this),e=Vb(a.sa).map(function(d){return new Ng(a.C,d,a.rc.has(d),b.call(this,d))},this);R.call(this,a.C,d,e,a.td);var f=null===a.Ea?null:new Ng(a.C,a.Ea,!0,b.call(this,a.Ea)),h=d.filter(function(b){return!a.pd.has(b.getName())});this.Lf=new nk(f,h,a.Cb);
this.sf=Bk(a,d,e)}t(b,R);b.prototype.Bb=function(a){return new this.sf(Xb++,a)};b.prototype.createRow=b.prototype.Bb;b.prototype.mb=function(a){var b={};this.nb().forEach(function(e){var f=e.getName();e=e.L();var h=a.value[f];if(0==e)if(e=h,null!=e&&""!=e){0!=e.length%2&&(e="0"+e);for(var h=new ArrayBuffer(e.length/2),k=new Uint8Array(h),n=0,B=0;n<e.length;n+=2)k[B++]=parseInt(e.substr(n,2),16);e=h}else e=null;else e=2==e?null!=h?new Date(h):null:h;b[f]=e},this);return new this.sf(a.id,b)};b.prototype.deserializeRow=
b.prototype.mb;b.prototype.Lb=g("Lf");b.prototype.getConstraint=b.prototype.Lb;return b}
function Bk(a,b,c){function d(a,d){this.M=b;this.sa=c;Wb.call(this,a,d)}t(d,Wb);d.prototype.Me=function(){var a={};this.M.forEach(function(b){a[b.getName()]=b.lc()?null:Qc[b.L()]});return a};d.prototype.yf=function(){var a={};this.M.forEach(function(b){var c=b.getName();b=b.L();var d=this.s[c];a[c]=0==b?null!=d?$b(d):null:2==b?null!=d?d.getTime():null:6==b?null!=d?d:null:d},this);return a};var e=function(a){var b=this.M.get(a.getName()),c=this.Qd.$e.get(b)||null;return function(b){return c(b[a.getName()])}}.bind(a),
f=function(a){var b=a.map(function(a){return e(a.ca)});return function(a){return b.map(function(b){return b(a)})}}.bind(a),h={};c.forEach(function(a){var b=a.m();a=1==a.g.length?e(a.g[0].ca):f(a.g);h[b]=a});d.prototype.pb=function(a){return-1!=a.indexOf("#")?this.id():h.hasOwnProperty(a)?h[a](this.s):null};return d};function Ck(a,b){this.h=new Z(a,b);this.xb=z();this.Cc=!1;this.j=null}r("lf.schema.Builder",Ck);function Dk(a,b){b.Cb.forEach(function(a){var d=a.Ua;if(!this.xb.has(d))throw new E(536,a.name);var d=this.xb.get(d).Db(),e=a.Mc;if(!d.hasOwnProperty(e))throw new E(537,a.name);if(b.Db()[a.zb].L()!=d[e].L())throw new E(538,a.name);if(!d[e].Hc())throw new E(539,a.name);},a)}
Ck.prototype.Kf=function(a){a.Cb.forEach(function(a){Ak(this.xb.get(a.Ua)).forEach(function(c){if(c.zb==a.Mc)throw new E(534,a.name);},this)},this)};function Ek(a){a.Cc||(a.xb.forEach(function(a){Dk(this,a);a=a.Db();this.h.O.set(a.getName(),a)},a),A(a.xb).forEach(a.Kf,a),Fk(a),a.xb.clear(),a.Cc=!0)}function Gk(a,b,c){b.Ae||(b.Ae=!0,b.fe=!0,b.Ne.forEach(function(a){a=c.get(a);if(!a.Ae)Gk(this,a,c);else if(a.fe&&b!=a)throw new E(533);},a));b.fe=!1}
function Fk(a){var b=z();a.h.O.forEach(function(a,d){b.set(d,new Hk(d))},a);a.xb.forEach(function(a,d){a.Cb.forEach(function(a){b.get(a.Ua).Ne.add(d)})});A(b).forEach(function(a){Gk(this,a,b)},a)}function Hk(a){this.fe=this.Ae=!1;this.Ne=C();this.qc=a}Ck.prototype.Db=function(){this.Cc||Ek(this);return this.h};Ck.prototype.getSchema=Ck.prototype.Db;Ck.prototype.Re=function(){var a=new jc("ns_"+this.h.name()),b;kk||(kk=new jk);b=kk;var c=null;b.Zd(a)?c=b.l(a):(c=new jk,b.ub(a,c));return c};
Ck.prototype.getGlobal=Ck.prototype.Re;Ck.prototype.connect=function(a){if(null!==this.j&&this.j.ld)throw new E(113);if(null===this.j){var b=this.Re();b.Zd(qc)||b.ub(qc,this.Db());this.j=new W(b)}return this.j.Da(a)};Ck.prototype.connect=Ck.prototype.connect;Ck.prototype.Nf=function(a){if(this.xb.has(a))throw new E(503,a);if(this.Cc)throw new E(535);this.xb.set(a,new Y(a));return this.xb.get(a)};Ck.prototype.createTable=Ck.prototype.Nf;
Ck.prototype.se=function(a){if(this.Cc)throw new E(535);this.h.se(a);return this};Ck.prototype.setPragma=Ck.prototype.se;function Z(a,b){this.C=a;this.Ra=b;this.O=z();this.mf={Rf:!1}}r("lf.schema.DatabaseSchema",Z);Z.prototype.name=g("C");Z.prototype.name=Z.prototype.name;Z.prototype.version=g("Ra");Z.prototype.version=Z.prototype.version;Z.prototype.va=function(){return A(this.O)};Z.prototype.tables=Z.prototype.va;Z.prototype.table=function(a){if(!this.O.has(a))throw new E(101,a);return this.O.get(a)};
Z.prototype.table=Z.prototype.table;Z.prototype.info=function(){this.We||(this.We=new lk(this));return this.We};Z.prototype.lf=g("mf");Z.prototype.pragma=Z.prototype.lf;Z.prototype.se=ca("mf");r("lf.schema.create",function(a,b){return new Ck(a,b)});v.prototype.catch=v.prototype.ve;v.prototype["catch"]=v.prototype.catch;
