...
lf.index.MemoryIndexStore.createIndex_=function(a){return new lf.index.BTree(a.getNormalizedName(),a.isUnique)};lf.index.MemoryIndexStore.prototype.get=function(a){return this.store_.get(a,null)};lf.index.MemoryIndexStore.prototype.getTableIndices=function(a){var b=[],c=a+".";this.store_.getKeys().forEach(function(a){-1!=a.indexOf(c)&&b.push(this.store_.get(a))},this);return b};
