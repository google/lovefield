...
lf.backstore.IndexedDBTx.prototype.getTable=function(a){return this.bundleMode_?new lf.backstore.BundledObjectStore(this.global_,this.tx_.objectStore(a.getName()),a.deserializeRow):new lf.backstore.ObjectStore(this.tx_.objectStore(a.getName()),a.deserializeRow)};
...
lf.backstore.MemoryTx=function(a,b,c){lf.backstore.BaseTx.call(this,c,b);this.store_=a;this.logger_=goog.log.getLogger("lf.backstore.MemoryTx");b==lf.TransactionType.READ_ONLY&&this.resolver.resolve()};goog.inherits(lf.backstore.MemoryTx,lf.backstore.BaseTx);lf.backstore.MemoryTx.prototype.getLogger=function(){return this.logger_};lf.backstore.MemoryTx.prototype.getTable=function(a){return this.store_.getTableInternal(a.getName())};
...
lf.proc.PhysicalPlanFactory=function(a){this.global_=a};lf.proc.PhysicalPlanFactory.prototype.create=function(a){if(a instanceof lf.proc.InsertOrReplaceNode||a instanceof lf.proc.InsertNode||a instanceof lf.proc.UpdateNode)return this.createPlan_(a);if(a instanceof lf.proc.DeleteNode||a instanceof lf.proc.ProjectNode)return this.createPlan_(a,[new lf.proc.IndexRangeScanPass(this.global_)]);goog.asserts.fail("Unknown query type.");a=new lf.proc.PhysicalQueryPlanNode;return new lf.proc.PhysicalQueryPlan(a)};
