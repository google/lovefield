...
lf.ObserverRegistry=function(){this.entries_=new goog.structs.Map};lf.ObserverRegistry.prototype.getQueryId_=function(a){return goog.getUid(a).toString()};lf.ObserverRegistry.prototype.getQueriesForTables=function(a){var b=new goog.structs.Set;a.forEach(function(a){b.add(a.getName())});var c=[];this.entries_.getValues().forEach(function(a){a=a.getQuery();var e=a.from.some(function(a){return b.contains(a.getName())});e&&c.push(a)});return c};
lf.ObserverRegistry.prototype.updateResultsForQuery=function(a,b){var c=this.getQueryId_(a),c=this.entries_.get(c,null);return goog.isNull(c)||c.lastResultVersion_==a.currentVersion?!1:(c.updateResults(b),!0)};lf.ObserverRegistry.Entry_=function(a){this.query_=a;new goog.structs.Set;this.observable_=[];this.lastResults_=null;this.lastResultVersion_=-1;this.diffCalculator_=new lf.DiffCalculator(a,this.observable_)};lf.ObserverRegistry.Entry_.prototype.getQuery=function(){return this.query_};
lf.ObserverRegistry.Entry_.prototype.updateResults=function(a){this.diffCalculator_.applyDiff(this.lastResults_,a);this.lastResults_=a;this.lastResultVersion_=this.query_.currentVersion};
