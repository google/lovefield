...
H.of=function(a,b,c){var d=Qc(null,null,null);ua(d,new M(function(g,k){d.Vb=a?function(b){try{var d=a[D](c,b);g(d)}catch(B){k(B)}}:g;d.wc=b?function(a){try{var d=b[D](c,a);!Hb(d)&&a instanceof Nc?k(a):g(d)}catch(B){k(B)}}:k}));d[gb].C=this;this.nf(d);return d[gb]};H.Uk=function(a){L(1==this.Ia);this.Ia=0;this.yc(2,a)};H.Vk=function(a){L(1==this.Ia);this.Ia=0;this.yc(3,a)};
H.yc=function(a,b){0==this.Ia&&(this==b&&(a=3,b=new TypeError("Promise cannot resolve to itself")),this.Ia=1,Uc(b,this.Uk,this.Vk,this)||(this.Ig=b,this.Ia=a,this.C=null,this.Lg(),3!=a||b instanceof Nc||Yc(this,b)))};
...
function bd(a,b){this.ya=a;this.Yb=b||this.Hf()}var cd=0;H=bd[z];H.id=G("ya");H.sh=Eb("ya");H.u=G("Yb");H.Hf=function(){return{}};H.Vg=G("Yb");H.Ha=function(){return{id:this.ya,value:this.Vg()}};H.Yc=function(a){return"#"==a.substr(-1)?this.ya:null};function dd(a){return new bd(a.id,a[x])}function ed(a){return new bd(cd++,a||{})}function fd(a){if(null==a)return"";a=new Uint8Array(a);for(var b="",c=0;c<a[y];++c)var d=a[c][t](16),b=b+(2>d[y]?"0"+d:d);return b};
...
function Id(a,b){this.ya=a;this.Yb=b||{}}function Jd(a){var b=new O;a[q](function(a){b.add(a>>9)});return b.c()}H=Id[z];H.ka=G("ya");H.tc=G("Yb");H.Og=function(a){a[q](function(a){this.Yb[a.id()]=a.Ha()},this)};H.xk=function(a){a[q](function(a){var c=this.Yb;a in c&&delete c[a]},this)};H.Ha=function(){return{id:this.ya,value:JSON.stringify(this.Yb)}};function Kd(a){return new Id(a.id,JSON.parse(a[x]))};
...
H.put=function(a){if(0==a[y])return Rc();var b=new N;a[q](function(a){var d;d=a.id()>>9;var g=b.get(d,null);null===g&&(g=this.Jg(this.S[sb],d));g.Og([a]);b.set(d,g)},this);a=b.c().map(function(a){return this.Zb(J(function(){return this.S.put(a.Ha())},this))},this);return Vc(a)};
...
H.Qh=function(a,b){var c=this.s[u](a.Xb)[a.Ib].Da()[h](function(b){return 1==b.h[y]&&b.h[0].ma[l]()==a.Ib})[0],d=this.I.get(c.l());b[q](function(b){if(!d.A(b.u()[a.Bb]))throw new P(203,a.Eb);})};H.Df=function(a,b,c){a=a.nj();null!=a&&a[q](function(a){if(a[tb]==c){var g=this.I.get(a.Eb);b[q](function(b){if(g.A(b.u()[a.Ib]))throw new P(203,a.Eb);})}},this)};
...
function Xd(a,b){this.pa=new N;b[q](function(a){this.pa.set(a[l](),a)},this);this.qa=a.o(yd);this.I=a.o(zd);this.Cb=new Vd(a);this.Jd=new Pd(a);this.Te=this.$d=!1;this.zb=new N}H=Xd[z];H.Rf=G("zb");H.cj=function(){var a=[];this.zb.H().map(function(a){return this.pa.get(a)},this)[q](function(b){b.$b()&&(b.Da()[q](function(b){a[v](this.I.get(b.l()))},this),a[v](this.I.get(b[l]()+".#")))},this);return a};H.fa=G("pa");
H.dj=function(){var a=[];this.pa.c()[q](function(b){b.$b()&&(b.Da()[q](function(b){a[v](b.l())}),a[v](b[l]()+".#"))});return a};H.wb=function(a,b){this.Fc();this.od(a);this.Cb.le(a,b);this.Cb.Cf(a,b,0);for(var c=0;c<b[y];c++)this.Kd(a,null,b[c])};
H.Kd=function(a,b,c){var d=a[l](),g=this.zb.get(d,null)||new Wd(d);this.zb.set(d,g);var k=[b,c];try{this.Jd.$g(a,k)}catch(m){throw this.Te=!0,m;}null===b&&null!==c?(this.qa.set(d,[c]),g.add(c)):null!==b&&null!==c?(this.qa.set(d,[c]),g.modify(k)):null!==b&&null===c&&(this.qa[n](d,[b.id()]),g[rb](b))};Da(H,function(a,b){this.Fc();this.od(a);this.Cb.le(a,b);for(var c=0;c<b[y];c++){var d=b[c],g=this.qa.get([d.id()])[0];this.Kd(a,g,d)}});
H.He=function(a,b){this.Fc();this.od(a);this.Cb.le(a,b);for(var c=0;c<b[y];c++){var d=b[c],g=null,k=this.Cb.Ji(a,d);null!=k&&(g=this.qa.get([k])[0],d.sh(k));this.Kd(a,g,d)}};ka(H,function(a,b){this.Fc();this.od(a);this.Cb.Df(a,b,0);for(var c=0;c<b[y];c++)this.Kd(a,b[c],null)});H.Fh=function(){this.zb.c()[q](function(a){var b=this.pa.get(a[l]());this.Cb.Cf(b,a.Qc().c(),1);this.Cb.Df(b,a.Rc().c(),1)},this)};H.V=function(){this.Fc();this.$d=!0};
H.Fc=function(){L(!this.Te,"Attemptted to use journal that needs to be rolled back.");L(!this.$d,"Attemptted to commit a terminated journal.")};H.Kb=function(){L(!this.$d,"Attempted to rollback a terminated journal.");var a=this.zb.c().map(function(a){return a.oj()},this);this.Jd[Bb](a);this.$d=!0;this.Te=!1};H.od=function(a){if(!this.pa.A(a[l]()))throw new P(106,a[l]());};
...
function he(a,b){var c=1<b[y],d=a.map(function(a){return new ie(a,c)});return new be(d,b)}function ie(a,b){this.wa=a;this.id=je++;this.Ke=b}var je=0;ie[z].O=function(a){var b=a.Za();return null!==b&&this.wa.u()[bb](b)?this.wa.u()[b]:this.Ke?this.wa.u()[a.X().Ca()][a[l]()]:this.wa.u()[a[l]()]};ie[z].bf=function(a,b){var c=a.Za();if(null!=c)this.wa.u()[c]=b;else if(this.Ke){var c=a.X().Ca(),d=this.wa.u()[c];null==d&&(d={},this.wa.u()[c]=d);d[a[l]()]=b}else this.wa.u()[a[l]()]=b};
...
function we(a,b,c){ue[D](this);this.J=a;wa(this,b);this.W=c;this.ud=me.ye().xe(this.J.$(),this.W);this.ab=!1;this.kc=b}K(we,ue);H=we[z];H.Nb=function(){var a=new we(this.J,this[x],this.W);a.Ek(this.kc);a.Yd(this.ab);a.cf(this.ka());return a};H.sb=function(a){return null!=a?(a[v](this.J),a):[this.J]};H.Yd=Eb("ab");H.Ek=Eb("kc");H.Af=function(){var a=!1;this[x]instanceof le||(a="array"==Kb(this[x])?!this[x][yb](function(a){return a instanceof le}):!0);if(!a)throw new P(501);};
H.eval=function(a){this.Af();if("in"==this.W)return this.ni(a);var b=a[C][h](function(a){return this.ud(a.O(this.J),this[x])!=this.ab},this);return new be(b,a.Y())};oa(H,function(a){if(this.kc instanceof le){var b=this.kc.tb();if(a[y]<=b)throw new P(510);wa(this,a[b])}else"array"==Kb(this.kc)&&wa(this,this.kc.map(function(b){if(b instanceof le){if(a[y]<=b.tb())throw new P(510);return a[b.tb()]}return b}))});
...
function xe(a){this.ma=a;this.Hc=this.ua=null}H=xe[z];H.Dd=function(a){null===this.ua&&null!=this.D&&(this.ua=ye(this.D));a=this.ua.get(a,null);L(null!==a);return a};function ye(a){var b=new N;a.zc(function(a){b.set(a.ka(),a)});return b}H.pd=function(a){a.D&&(this.D=a.D.Nb());this.Hc=a};H.Lf=function(a,b){var c=new O;a.c()[q](function(a){a.Fb().Sf()[q](function(g){if(!b||b[ib](a[g.Bb]))g=this.ma[u](g.Xb),c.add(g)},this)},this);return c};
...
function De(a,b){this.global=a;this.Ab=a.o(xd);this.Td=b.map(function(a){return a[Ea]});this.zg=b.map(function(a){return a.Ue});this.Ef=Ce(this.zg);this.Xg=this.ji();this.bc=Wc()}H=De[z];H.ji=function(){return this.Td[yb](function(a){return!(a instanceof ze)})?1:0};
ia(H,function(){var a=new Xd(this[Sa],this.Ef.c()),b=[],c=this.zg[w](),d=J(function(){var g=c[Ha]();if(g){var k=this.Td[b[y]];return g.mb()[Ia](a,k)[A](function(a){b[v](a[0]);return d()})}return Rc()},this);return d()[A](J(function(){return this.Ab.Ob(this.Xg,a).V()},this))[A](J(function(){this.Re(b);return b},this),J(function(b){a.Kb();throw b;},this))});H.$=G("Xg");H.fa=G("Ef");H.Sc=G("bc");H.ka=function(){return Qb(this)};H.Re=Db();
...
function Fe(a,b){this.m=a;this.Hb=a.o(Cd);this.Wa=a.o(Bd);this.Jd=new Pd(a);this.zb=b;var c=a.o(Dd),d=this.zb.map(function(a){return c[u](a[l]())});this.pa=new O(d);this.bc=Wc()}H=Fe[z];ia(H,function(){this.Jd[Bb](this.zb);this.ed();return Rc()});H.$=Fb(1);H.fa=G("pa");H.Sc=G("bc");H.ka=function(){return Qb(this)};xa(H,Fb(1));H.ed=function(){var a=this.Hb.Ee(this.pa.c());0!=a[y]&&(a=new Ee(this.m,a),this.Wa.cc(a))};
function Ge(a){this.m=a;this.Ab=a.o(xd);this.Wa=a.o(Bd)}Ge[z].Ok=function(){this.Ab.subscribe(this.Pe[r](this))};Ge[z].Pe=function(a){a=new Fe(this.m,a);this.Wa.cc(a)};
...
H.ae=function(a,b){var c=this.hb.get(a);return null!=c?function(){var a={},g=Wc();this.j[Ma]("T").equalTo(c)[db]("value",function(c){c[q](function(c){var g=b(c.val());a[ga(c.key(),10)]=g});g[xb](a)});return g.ga}[D](this)[A](function(a){a["@rev"]={R:++this.Va};return Je(this.j,a)}[r](this)):Rc()};H.Kc=function(a){return this.ae(a,Fb(null))[A](function(){this.hb[n](a);return Je(this.j[gb]("@table/"+a),null,!0)}[r](this))};Q[z].dropTable=Q[z].Kc;
Q[z].Dc=function(a,b,c){return this.ae(a,function(a){var g=a.P;g[b]=c;return{R:this.Va+1,T:a.T,P:g}}[r](this))};Q[z].addTableColumn=Q[z].Dc;Q[z].Lc=function(a,b){return this.ae(a,function(a){var d=a.P;delete d[b];return{R:this.Va+1,T:a.T,P:d}}[r](this))};Q[z].dropTableColumn=Q[z].Lc;Q[z].dd=function(a,b,c){return this.ae(a,function(a){var g=a.P;g[c]=g[b];delete g[b];return{R:this.Va+1,T:a.T,P:g}}[r](this))};Q[z].renameTableColumn=Q[z].dd;Q[z].Db=function(){throw new P(351);};Q[z].createRow=Q[z].Db;
...
R[z].gk=function(a,b,c){return new M(function(d,g){var k;try{var m=this.Oa[ob](a);k=m[vb]()}catch(p){g(p);return}Ca(k,function(){var a=k[Xa];a?(b(a),a[Ra]()):(c(m),d())});va(k,g)},this)};function Ne(a){var b=null;return b=a instanceof ArrayBuffer?fd(a):a instanceof Date?a[Qa]():a}R[z].gf=function(a,b){function c(a){var c=Kd(a[x]),d=c.tc(),p;for(p in d){var B=dd(d[p]);b(B);d[p]=B.Ha()}a[Bb](c.Ha())}function d(a){var c=dd(a[x]);b(c);a[Bb](c.Ha())}return this.gk(a,this.ld?c:d,Db())};
...
H.Zb=function(a){return new M(function(b,c){var d;try{d=a()}catch(g){c(g);return}Ca(d,b);va(d,c)},this)};H.put=function(a){if(0==a[y])return Rc();a=a.map(function(a){return this.Zb(J(function(){return this.S.put(a.Ha())},this))},this);return Vc(a)};
...
S[z].addTableColumn=S[z].Dc;S[z].Lc=function(a,b){return this.ff(a,function(a){delete a[x][b];return a})};S[z].dropTableColumn=S[z].Lc;S[z].dd=function(a,b,c){return this.ff(a,function(a){a[x][c]=a[x][b];delete a[x][b];return a})};S[z].renameTableColumn=S[z].dd;S[z].Db=function(a){var b={},c;for(c in a)b[c]=Ne(a[c]);return ed(b)};S[z].createRow=S[z].Db;S[z].Vc=G("Pa");S[z].getVersion=S[z].Vc;
...
H.If=function(a,b,c){var d=this.fd(a);if(!this.da()){var g=this.Z.Qa(this.b[d],a)?d+1:d;if(this.i[g].If(a,g,c))this.vd();else return!1}else if(!this.Z.Qa(this.b[d],a))return!1;if(this.b[y]>d&&this.Z.Qa(this.b[d],a)){if(Hb(c)&&!this.Z.Gb()&&this.da()&&(a=this.U[d],c=pc(a,qc,!1,c),0<=c&&jc(a,c),this.U[d][y]))return!1;this.b[E](d,1);this.da()&&this.U[E](d,1)}256>this.b[y]&&!this.ig()&&(this.Qk()||this.Zj(b));return!0};
...
H.wb=function(a,b,c){var d=this.fd(a);if(this.da()){if(this.Z.Qa(this.b[d],a)){if(c)return this.U[d]=this.Z.Gb()?b:[b],this;if(this.Z.Gb())throw new P(201);if(this.U[d])return rc(this.U[d],b),this;this.U[d]=[b]}this.b[E](d,0,a);this.U[E](d,0,this.Z.Gb()?b:[b]);return 512==this.b[y]?this.Nk():this}d=this.Z.Qa(this.b[d],a)?d+1:d;a=this.i[d].wb(a,b,c);a.da()||1!=a.b[y]||(this.b[E](d,0,a.b[0]),a.i[1].C=this,a.i[0].C=this,this.i[E](d,1,a.i[1]),this.i[E](d,0,a.i[0]));return 512==this.b[y]?this.Mk():this};
...
function Bf(a){this.sa=a;this.bb=new O}H=Bf[z];ja(H,function(){return this.sa[l]()});H.add=function(a,b){null===a?this.bb.add(b):this.sa.add(a,b)};H.set=function(a,b){null===a?(this.bb[Pa](),this.bb.add(b)):this.sa.set(a,b)};ka(H,function(a,b){null===a?b?this.bb[n](b):this.bb[Pa]():this.sa[n](a,b)});H.get=function(a){return null===a?this.bb.c():this.sa.get(a)};H.sd=function(a){return this.sa.sd(a)};H.$a=function(a,b,c,d){b=this.sa.$a(a,b,c,d);return null!=a?b:b[Ka](this.bb.c())};
na(H,function(){this.bb[Pa]();this.sa[Pa]()});H.A=function(a){return null===a?!this.bb.Ja():this.sa.A(a)};H.min=function(){return this.sa.min()};H.max=function(){return this.sa.max()};H.Ha=function(){return[new bd(-2,this.bb.c())][Ka](this.sa.Ha())};H.Ic=function(){return this.sa.Ic()};H.Gb=function(){return this.sa.Gb()};
...
H.$c=function(a){if(0==this.yb[Ya])return[null,null];var b=df(this.yb)[lb](J(function(b,d){return null===b||1==a(d,b)?d:b},this),null);return[b,[b]]};H.sd=function(){return this.yb[Ya]};H.$a=function(a,b,c,d){var g=a||[$d()];a=df(this.yb)[h](function(a){return g[yb](function(b){return this.M.uc(a,b)},this)},this);return ff(a,b,c,d)};na(H,function(){this.yb[Pa]()});H.A=function(a){return this.yb.has(a)};H.Ha=function(){return[new bd(0,df(this.yb))]};H.Ic=G("M");
function Df(a,b){var c=new Cf(a);b[0].u()[q](function(a){c.add(a,a)});return c}H.Gb=Fb(!0);
function Ef(a){this.m=a;this.Ab=a.o(xd);this.I=a.o(zd);this.qa=a.o(yd)}H=Ef[z];H.Ea=function(a){var b=a.Xa(),c=J(function(){if(0==b[y])return Rc();var a=b[Ha]();return(a.$b()?this.Di(a):this.Ei(a))[A](c)},this);return c()};H.Ei=function(a){var b=new Xd(this.m,[a]);return this.Ab.Ob(0,b).X(a[l](),J(a.oc,a)).get([])[A](J(function(b){this.qa.set(a[l](),b);this.sk(a,b)},this))};H.sk=function(a,b){var c=this.I.sj(a[l]());b[q](function(a){c[q](function(b){var c=a.Yc(b[l]());b.add(c,a.id())})})};
H.Di=function(a){var b=new Xd(this.m,[a]),c=this.Ab.Ob(0,b),b=c.X(a[l](),a.oc).get([])[A](J(function(b){this.qa.set(a[l](),b)},this)),d=a.Da().map(function(a){return this.tk(a,c)},this)[Ka](this.uk(a,c));return Vc(d[Ka](b))};
H.tk=function(a,b){var c=b.X(a.l(),dd,1),d=uf(a);return c.get([])[A](J(function(b){L("btree"==b[0].u().type);if(1<b[y]){if(a.ag()){var c=nf[r](void 0,d,a.l(),a.Xc),m=b[w](1),p=-1;for(b=0;b<m[y];++b)if(-2==m[b].id()){p=b;break}if(-1==p)throw new P(102);b=m[p].u();m=m[w](0);m[E](p,1);c=c(m);c=new Bf(c);c.bb[mb](b)}else c=nf(d,a.l(),a.Xc,b[w](1));this.I.set(c)}},this))};
H.uk=function(a,b){return b.X(a.Rb(),dd,1).get([])[A](J(function(b){L("rowid"==b[0].u().type);1<b[y]&&(b=Df(a.Rb(),b[w](1)),this.I.set(b))},this))};


function Ff(){this.S=new N}Ff[z].Ea=function(a){a.Xa()[q](function(a){var c=a.Rb();if(null===this.get(c)){var d=new Cf(c);this.S.set(c,d)}a.Da()[q](function(a){this.S.set(a.l(),Gf(a))},this)},this);return Rc()};function Gf(a){var b=uf(a),b=new gf(a.l(),b,a.Xc);return a.ag()?new Bf(b):b}Ff[z].get=function(a){return this.S.get(a,null)};Ff[z].set=function(a){return this.S.set(a[l](),a)};Ff[z].sj=function(a){var b=[],c=a+".";this.S.H()[q](function(a){0==a[pb](c)&&b[v](this.S.get(a))},this);return b};
...
function Sf(a){ue[D](this);this.Wb=a;this.ab=!1}K(Sf,ue);H=Sf[z];H.Nb=function(){return Jf(this,function(a){if(a instanceof Sf){var b=new Sf(a.Wb);b.ab=a.ab;b.cf(a.ka());return b}return a.Nb()}[r](this))};H.sb=function(a){var b=a||[];this.zc(function(a){a!=this&&a.sb(b)}[r](this));return(new O(b)).c()};H.Yd=function(a){this.ab!=a&&(this.ab=a,this.Wb="and"==this.Wb?"or":"and",this.N()[q](function(b){return b.Yd(a)}))};H.eval=function(a){var b=this.N().map(function(b){return b.eval(a)});return this.Uh(b)};
...
dg[z].Ec=function(a){var b=new this.constructor(this.B);b.jb=a;b.Xe=this.Xe;return b};dg[z].as=dg[z].Ec;dg[z].nj=G("Xe");dg[z].Hk=Eb("Xe");dg[z].createRow=dg[z].Db;dg[z].deserializeRow=dg[z].oc;dg[z].Da=G("ta");dg[z].sb=G("G");dg[z].getConstraint=dg[z].Fb;dg[z].$b=G("Qd");dg[z].Rb=function(){return this.B+".#"};
function T(a,b){ua(this,a);this.hc=b;this.jb=null}H=T[z];ja(H,function(){return this.hc+"("+this[gb][l]()+")"});H.l=function(){return this.hc+"("+this[gb].l()+")"};H.X=function(){return this[gb].X()};f(H,function(){return this.l()});H.$=function(){return this[gb].$()};H.Za=G("jb");H.Da=function(){return[]};H.vc=Fb(!1);H.Ec=function(a){this.jb=a;return this};T[z].as=T[z].Ec;T[z].Pf=function(){for(var a=[this],b=this;b instanceof T;)a[v](b[gb]),b=b[gb];return a};
function eg(a){this.jb=a||null;this.L=new dg("#UnknownTable",[],[],!1)}H=eg[z];ja(H,Fb("*"));H.l=function(){return this[l]()};f(H,function(){return this.l()});H.X=G("L");H.$=Fb(4);H.Za=G("jb");H.Da=function(){return[]};H.vc=Fb(!1);
...
function tg(a){V[D](this);this.Fa=a}K(tg,V);f(tg[z],function(){return"select("+this.Fa[t]()+")"});function ug(a){V[D](this);pa(this,a)}K(ug,V);f(ug[z],function(){var a="table_access("+this[u][l]();null===this[u].Za()||(a+=" as "+this[u].Za());return a+")"});function vg(){V[D](this)}K(vg,V);f(vg[z],Fb("cross_product"));function wg(a,b){V[D](this);this.h=a;this.Sb=b}K(wg,V);
...
function Dg(){};
function Eg(){}K(Eg,Dg);Eg[z].Jb=function(a){this.ha=a;this.Ya(this.ha);return this.ha};Eg[z].Ya=function(a){if(a instanceof tg){L(1==a.xa(),"SelectNode must have exactly one child.");var b=this.yf(a.Fa),b=this.ci(b);Qf(a,a,b[0],b[1]);a==this.ha&&(this.ha=b[0]);a=b[0]}a.N()[q](function(a){this.Ya(a)},this)};Eg[z].yf=function(a){if(0==a.xa()||"and"!=a.Wb)return[a];var b=a.N()[w]().map(function(b){a[ub](b);return this.yf(b)},this);return tc(b)};
Eg[z].ci=function(a){var b=null,c=null;a.map(function(a,g){var k=new tg(a);0==g?b=k:c.ia(k);c=k},this);return[b,c]};
function Fg(){}K(Fg,Dg);Fg[z].Jb=function(a){this.ha=a;this.Ya(this.ha);return this.ha};Fg[z].Ya=function(a){if(a instanceof vg)for(;2<a.xa();){for(var b=new vg,c=0;2>c;c++){var d=a.Vd(0);b.ia(d)}a.Cc(b,0)}a.N()[q](function(a){this.Ya(a)},this)};
...
function Hg(a,b){De[D](this,a,b);this.Wa=a.o(Bd);this.Hb=a.o(Cd)}K(Hg,De);xa(Hg[z],Fb(2));Hg[z].Re=function(a){0==this.$()?this.ak(a):this.ed()};Hg[z].ak=function(a){this.Td[q](function(b,c){b instanceof ze&&this.Hb.Zg(b,a[c])},this)};Hg[z].ed=function(){var a=this.Hb.Ee(this.fa().c());0!=a[y]&&(a=new Ee(this[Sa],a),this.Wa.cc(a))};
...
function Vg(a,b){this.global=a;this.qk=a.o(Ad);this.Wa=a.o(Bd);this.a=b}I("lf.query.BaseBuilder",Vg,void 0);ia(Vg[z],function(){try{this.kb()}catch(a){return Sc(a)}return new M(function(a,c){var d=new Hg(this[Sa],[this.Uc()]);this.Wa.cc(d)[A](function(c){a(c[0].ze())},c)},this)});ia(Vg[z],Vg[z][Ia]);Vg[z].Mf=function(){var a=J(function(a){return a.gd(this.a)+"\n"},this);return Rf(this.Ae().mb(),a)};Vg[z].explain=Vg[z].Mf;oa(Vg[z],function(a){this.a[r](a);return this});oa(Vg[z],Vg[z][r]);
...
function hh(){}K(hh,Dg);hh[z].Jb=function(a){this.ha=a;this.Ya(this.ha);return this.ha};hh[z].Ya=function(a){if(a instanceof tg&&a.Fa instanceof $f){L(1==a.xa(),"SelectNode must have exactly one child.");var b=a.rb(0);if(b instanceof vg){var c=new Cg(a.Fa);Qf(a,b,c,c);a==this.ha&&(this.ha=c);a=c}}a.N()[q](function(a){this.Ya(a)},this)};
function ih(){this.fe=new O}K(ih,Dg);H=ih[z];H.Jb=function(a){this.ha=a;this.Ya(this.ha);this.fe[Pa]();return this.ha};H.Ya=function(a){if(this.dg(a)){var b=a.Fa instanceof we?this.nk(a):this.mk(a);this.fe.add(a);b==a&&(b=a.rb(0));null!==b&&(Lb(b[Ga]())&&(this.ha=b),this.dg(b)&&!this.fe[ib](b)&&this.Ya(b))}else a.N()[q](function(a){this.Ya(a)},this)};
...
function vh(a,b){U[D](this,0,-1);this.qa=a.o(yd);this.I=a.o(zd);pa(this,b)}K(vh,U);f(vh[z],function(){var a="table_access("+this[u][l]();null===this[u].Za()||(a+=" as "+this[u].Za());return a+")"});vh[z].ja=function(){var a=this.I.get(this[u].Rb()).$a();return[he(this.qa.get(a),[this[u].Ca()])]};
...
Dh[z].Aj=function(){if(1==this.G[y]&&"DISTINCT"==this.G[0].hc){var a=this.Ga.sc(this.G[0])[C].map(function(a){var b=new ie(new bd(-1,{}),this.Ga.Je());b.bf(this.G[0],a.O(this.G[0][gb]));return b},this);return new be(a,[])}var b=new ie(new bd(-1,{}),this.Ga.Je());this.G[q](function(a){var d=a instanceof T?this.Ga.sc(a):this.Ga[C][0].O(a);b.bf(a,d)},this);return new be([b],this.Ga.Y())};
Dh[z].Bj=function(){var a=e(this.Ga[C][y]),b=this.Ga.Je();this.Ga[C][q](function(c,d){a[d]=new ie(new bd(c.wa.id(),{}),b);this.G[q](function(b){a[d].bf(b,c.O(b))},this)},this);return new be(a,this.Ga.Y())};function Eh(a,b){var c=a.map(function(a){return(new Dh(a,b)).Yf()[C][0]});return new be(c,a[0].Y())};
...
function Ph(a,b){U[D](this,1,1);this.L=a;this.$k=b}K(Ph,U);f(Ph[z],function(){return"update("+this.L[l]()+")"});Ph[z].ja=function(a,b){var c=b[0][C].map(function(a){var b=this.L.oc(a.wa.Ha());this.$k[q](function(a){b.u()[a.J[l]()]=a[x]},this);return b},this);a[Bb](this.L,c);return[ee()]};
...
Qh[z].Uj=function(a){if(a instanceof wg)return new Fh(a.h,a.Sb);if(a instanceof zg)return new mh(a.h);if(a instanceof yg)return new gg(a.h);if(a instanceof xg)return new Ch(a.K);if(a instanceof Bg)return new Gh;if(a instanceof Ag)return new Bh;if(a instanceof tg)return new th(a.Fa.ka());if(a instanceof vg)return new Gg;if(a instanceof Cg)return new Ah(a.Fa);if(a instanceof ug)return new vh(this.m,a[u]);if(a instanceof rg)return new lh(a[u]);if(a instanceof sg)return new Ph(a[u],a.kf);if(a instanceof
...
function Th(){this.ec=this.Ua=this.eb=this.Nc=null}Th[z].releaseLock=function(a){this.Nc==a&&(this.Nc=null);this.eb==a&&(this.eb=null);null===this.Ua||this.Ua[n](a);null===this.ec||this.ec[n](a)};Th[z].Ch=function(a,b){var c=null===this.Ua||this.Ua.Ja();return 0==b?(null===this.ec||this.ec.Ja())&&c&&null===this.Nc&&null!==this.eb&&this.eb==a:3==b?null===this.Nc&&null===this.eb&&null!==this.Ua&&this.Ua[ib](a):1==b?null===this.eb:c&&(null===this.eb||this.eb==a)};
Th[z].wj=function(a,b){0==b?(this.eb=null,this.Nc=a):3==b?(null===this.ec&&(this.ec=new O),this.ec.add(a),null===this.Ua&&(this.Ua=new O),this.Ua[n](a)):1==b?(null===this.Ua&&(this.Ua=new O),this.Ua.add(a)):2==b&&(this.eb=a)};
...
function Y(a,b,c,d,g,k){this.L=a;this.B=b;this.jg=c;this.gg=d;this.Yg=g;this.jb=k||null;this.i=this.C=null}I("lf.schema.BaseColumn",Y,void 0);H=Y[z];ja(H,G("B"));H.l=function(){return this.L.Ca()+"."+this.B};f(H,function(){return this.l()});H.X=G("L");H.$=G("Yg");H.Za=G("jb");H.Da=function(){null==this.ta&&(this.ta=[],this.X().Da()[q](function(a){-1!=a.h.map(function(a){return a.ma[l]()})[pb](this.B)&&this.ta[v](a)},this));return this.ta};H.vc=G("gg");H.Xc=G("jg");H.Zd=Eb("C");H.getParent=G("C");
...
function gi(a,b){var c=a.ref[ab](".");if(2!=c[y])throw new P(540,b);this.Bb=a.local;this.Xb=c[0];this.Ib=c[1];this.Eb=b;this.action=a.action;this.timing=a[tb]};
