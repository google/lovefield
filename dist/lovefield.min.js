...
goog.iter.combinationsWithReplacement=function(a,b){function c(a){return d[a]}var d=goog.iter.toArray(a),e=goog.array.range(d.length),e=goog.array.repeat(e,b),e=goog.iter.product.apply(void 0,e),f=goog.iter.filter(e,function(a){return goog.array.isSorted(a)}),e=new goog.iter.Iterator;e.next=function(){return goog.array.map(f.next(),c)};return e};goog.object={};goog.object.forEach=function(a,b,c){for(var d in a)b.call(c,a[d],d,a)};goog.object.filter=function(a,b,c){var d={},e;for(e in a)b.call(c,a[e],e,a)&&(d[e]=a[e]);return d};goog.object.map=function(a,b,c){var d={},e;for(e in a)d[e]=b.call(c,a[e],e,a);return d};goog.object.some=function(a,b,c){for(var d in a)if(b.call(c,a[d],d,a))return!0;return!1};goog.object.every=function(a,b,c){for(var d in a)if(!b.call(c,a[d],d,a))return!1;return!0};
...
lf.backstore.IndexedDB.prototype.createObjectStoresForTable_=function(a,b,c){a.objectStoreNames.contains(c.getName())||a.createObjectStore(c.getName(),{keyPath:"id"});if(c.persistentIndex()){var d=c.getIndices();d.forEach(function(c){this.createIndexTable_(a,b,c.getNormalizedName(),lf.index.IndexMetadata.Type.BTREE)},this);this.createIndexTable_(a,b,c.getName()+".#",lf.index.IndexMetadata.Type.ROW_ID)}};
...
lf.backstore.Memory.prototype.initTable_=function(a){this.createTable_(a.getName());if(a.persistentIndex()){var b=a.getIndices();b.forEach(function(a){this.createIndexTable_(a.getNormalizedName(),lf.index.IndexMetadata.Type.BTREE)},this);this.createIndexTable_(a.getName()+".#",lf.index.IndexMetadata.Type.ROW_ID)}};lf.backstore.Memory.prototype.createIndexTable_=function(a,b){var c=this.createTable_(a);if(!goog.isNull(c)){var d=new lf.index.IndexMetadata(b),d=new lf.index.IndexMetadataRow(d);c.put([d])}};
...
lf.cache.Journal.prototype.updateTableIndicesForRow_=function(a,b){var c=a.getIndices().map(function(a){return this.indexStore_.get(a.getNormalizedName())},this).concat([this.indexStore_.getRowIdIndex(a.getName())]);c.forEach(function(a){var c=goog.isNull(b[1])?null:b[1].keyOfIndex(a.getName()),f=goog.isNull(b[0])?null:b[0].keyOfIndex(a.getName());c!=f&&(goog.isNull(f)&&!goog.isNull(c)?a.add(c,b[1].id()):goog.isNull(f)||goog.isNull(c)?!goog.isNull(f)&&goog.isNull(c)&&a.remove(f,b[0].id()):(a.add(c,
...
lf.index.MemoryIndexStore=function(){this.store_=new goog.structs.Map};lf.index.MemoryIndexStore.prototype.init=function(a){a=a.getTables();a.forEach(function(a){this.getRowIdIndex(a.getName());a.getIndices().forEach(function(c){this.store_.set(c.getNormalizedName(),lf.index.MemoryIndexStore.createIndex_(a,c))},this)},this);return goog.Promise.resolve()};
...
lf.index.MemoryIndexStore.prototype.getRowIdIndex=function(a){a+=".#";var b=this.store_.get(a,null);goog.isNull(b)&&(b=new lf.index.RowId(a),this.store_.set(a,b));return b};
...
lf.schema.Table.prototype.getColumns=function(){return this.columns_};lf.schema.Table.prototype.persistentIndex=function(){return this.persistentIndex_};
