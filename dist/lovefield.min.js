...
lf.index={};lf.index.IndexMetadata=function(a){this.type=a};lf.index.IndexMetadata.Type={ROW_ID:"rowid",BTREE:"btree"};lf.index.IndexMetadataRow=function(a){lf.Row.call(this,0,a)};goog.inherits(lf.index.IndexMetadataRow,lf.Row);
...
lf.backstore.MemoryTable.prototype.remove=function(a){a.forEach(function(a){this.data_.remove(a)},this);return goog.Promise.resolve()};
...
lf.index.BTreeNode_.prototype.getRange=function(a){var b=0,c=this.keys_.length-1;if(goog.isDefAndNotNull(a)){if(!goog.isNull(a.to)){if(this.keys_[0]>a.to)return[];this.keys_[c]>=a.to&&(c=this.searchKey_(a.to),a.excludeUpper&&this.keys_[c]==a.to&&c--)}!goog.isNull(a.from)&&this.keys_[0]<=a.from&&(b=this.searchKey_(a.from),a.excludeLower&&this.keys_[b]==a.from&&b++)}var d=[];c==this.keys_.length-1?(d=d.concat(this.values_.slice(b)),this.next_&&(d=d.concat(this.next_.getRange(a)))):c>=b&&(d=d.concat(this.values_.slice(b,
c+1)));this.tree_.isUniqueKeyOnly()||(d=goog.array.flatten(d));return d};lf.index.BTreeNode_.serialize=function(a){for(var b=[];a;){var c=[a.keys_,a.values_];b.push(new lf.Row(a.id_,c));a=a.next_}return b};
