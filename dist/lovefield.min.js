...
function bf(a,b,c,d){function f(a,b){if(a.Td){var c=a.ua.o,d;for(d in c)h[d]=c[d]}else h[b[0]]=a.ua.o}var h={};f(a,b);f(c,d);a=new dd(-1,h);return new Xe(a,!0)};J("lf.bind",function(a){return new cf(a)});function cf(a){this.da=a}J("lf.Binder",cf);cf[t].va=H("da");function df(){this.Pe=ef();var a=ff();this.fc=M();this.fc.set(1,gf());this.fc.set(2,hf());this.fc.set(4,a);this.fc.set(3,a);this.fc.set(5,jf())}df.fd=function(){return df.Le?df.Le:df.Le=new df};function kf(a,b,c){return(a.fc.get(b)||null).get(c)||null}function ef(){function a(a){return a}var b=M();b.set(1,function(a){return null===a?null:a?1:0});b.set(2,function(a){return null===a?null:a[Fb]()});b.set(3,a);b.set(4,a);b.set(5,a);return b}
...
c[Fb]()});a.set("lt",function(a,c){return null===a||null===c?!1:a[Fb]()<c[Fb]()});a.set("neq",function(a,c){return(null===a?-1:a[Fb]())!=(null===c?-1:c[Fb]())});return a};function mf(a,b){this.Re=a;this.rf=b}mf[t].getKey=H("Re");la(mf[t],function(){return new mf(this.Re,this.rf)});function nf(a,b){mf[r](this,a,b);this.h=this.C=null}K(nf,mf);var of=[];I=nf[t];la(I,function(){return new nf(this.getKey(),this.rf)});I.getParent=H("C");function R(a){return a.h||of}function pf(a,b){return R(a)[b]||null}function qf(a){for(var b=0;a[Cb]();)b++,a=a[Cb]();return b}I.gb=function(){for(var a=this;a[Cb]();)a=a[Cb]();return a};I.contains=function(a){do a=a[Cb]();while(a&&a!=this);return Boolean(a)};function rf(a,b,c){if(!1!==b[r](c,a)){a=R(a);for(var d=0;d<a[C];d++)rf(a[d],b,c)}}
...
function ag(a){return 0==a.rb[G]?0:yd(a.rb)[Ja](function(a,c){return a>c?a:c},0)};function bg(a,b){this.s=a;this.wf=b;this.Kc=M();this.Ja=-1;this.J=M();this.Ua=M();this.Ed=null}I=bg[t];
I.Da=function(a){this.i=this.wf[kb](this.s[p]());var b=a||function(){return Nc()};return Sf(this.i,"@db/version")[z](function(a){return null===a?Tf(this.i,cg(this),!0)[z](function(){var a=new S(0,this.i);return b(a)}[E](this)):a==this.s[vb]()?Sf(this.i,"@rev/R")[z](function(a){this.Ja=a;return Sf(this.i,"@table")}[E](this))[z](function(a){for(var b in a)this.Ua.set(b,a[b]);a=this.s.Va().map(function(a){return Wf(this,a[u]())},this);return Rc(a)}[E](this))[z](function(){dg(this);eg(this);return Nc()}[E](this)):
...
ma(pl[t],function(a){rl(this,4);var b=[];try{a[F](function(a){a.cb();b[x](a.zc())},this)}catch(c){return rl(this,7),Oc(c)}a=new Ri(this.j,b);return Qf(this.Ra,a)[z](function(a){rl(this,7);return a.map(function(a){return Pe(a)})}[E](this),function(a){rl(this,7);throw a;}[E](this))});ma(pl[t],pl[t][Pa]);pl[t].yf=function(a){rl(this,1);this.Rc=new ml(this.j,a);return nl(this.Rc)[z](function(){rl(this,2)}[E](this))};pl[t].begin=pl[t].yf;
pl[t].xf=function(a){rl(this,3);return ol(this.Rc,a)[z](function(a){rl(this,2);return a}[E](this),function(a){rl(this,7);throw a;}[E](this))};pl[t].attach=pl[t].xf;pl[t].ma=function(){rl(this,5);return this.Rc.ma()[z](function(){rl(this,7)}[E](this))};pl[t].commit=pl[t].ma;pl[t].Db=function(){rl(this,6);return this.Rc.Db()[z](function(){rl(this,7)}[E](this))};pl[t].rollback=pl[t].Db;function Y(a){this.j=a;this.s=a.m(Od);this.Pd=!1}J("lf.proc.Database",Y);Y[t].Da=function(a){this.j.kb(Od,this.s);return ll(this.j,a)[z](function(){this.Pd=!0;return this}[E](this))};Y[t].init=Y[t].Da;Y[t].sb=H("s");Y[t].getSchema=Y[t].sb;function sl(a){if(!a.Pd)throw new P(2);}Y[t].select=function(a){sl(this);return new X(this.j,1!=arguments[C]||null!=arguments[0]?e[t][n][r](arguments):[])};Y[t].select=Y[t].select;Y[t].ub=function(){sl(this);return new oj(this.j)};Y[t].insert=Y[t].ub;
Y[t].Qd=function(){sl(this);return new oj(this.j,!0)};Y[t].insertOrReplace=Y[t].Qd;qa(Y[t],function(a){sl(this);return new xj(this.j,a)});qa(Y[t],Y[t][Wa]);ra(Y[t],function(){sl(this);return new nj(this.j)});Y[t]["delete"]=Y[t][Za];Y[t].observe=function(a,b){this.j.m(Nd).zd(a,b)};Y[t].observe=Y[t].observe;Y[t].unobserve=function(a,b){this.j.m(Nd).he(a,b)};Y[t].unobserve=Y[t].unobserve;Y[t].Ff=function(){sl(this);return new pl(this.j)};Y[t].createTransaction=Y[t].Ff;
oa(Y[t],function(){try{this.j.m(Id)[Qa]()}catch(a){}this.j[w]();this.Pd=!1});oa(Y[t],Y[t][Qa]);function Z(a,b,c,d,f,h){this.O=a;this.u=b;this.Oe=c;this.Me=d;this.qf=f;this.bb=h||null}J("lf.schema.BaseColumn",Z);I=Z[t];na(I,H("u"));I.l=function(){return $e(this.O)+"."+this.u};g(I,function(){return this.l()});I.I=H("O");I.S=H("qf");Z[t].getType=Z[t].S;Z[t].Ya=H("bb");Z[t].Ca=function(){null==this.ha&&(this.ha=[],this.I().Ca()[F](function(a){-1!=a.f.map(function(a){return a.ea[u]()})[ab](this.u)&&this.ha[x](a)},this));return this.ha};
Z[t].va=function(){if(!Mb(this.da)){var a=this.Ca()[Fa](function(a){return 1!=a.f[C]?!1:a.f[0].ea[u]()==this[u]()},this);this.da=0<a[C]?a[0]:null}return this.da};Z[t].Bc=H("Me");Z[t].isNullable=Z[t].Bc;Z[t].Cc=H("Oe");Z[t].Na=function(a){return ai(this,a,"eq")};Z[t].eq=Z[t].Na;Z[t].We=function(a){return ai(this,a,"neq")};Z[t].neq=Z[t].We;Z[t].Wd=function(a){return ai(this,a,"lt")};Z[t].lt=Z[t].Wd;Z[t].ag=function(a){return ai(this,a,"lte")};Z[t].lte=Z[t].ag;Z[t].Nf=function(a){return ai(this,a,"gt")};
Z[t].gt=Z[t].Nf;Z[t].Of=function(a){return ai(this,a,"gte")};Z[t].gte=Z[t].Of;Z[t].match=function(a){return ai(this,a,"match")};Z[t].match=Z[t].match;Z[t].zf=function(a,b){return ai(this,[a,b],"between")};Z[t].between=Z[t].zf;Z[t].Pf=function(a){return ai(this,a,"in")};Z[t]["in"]=Z[t].Pf;Z[t].Wf=function(){return this.Na(null)};Z[t].isNull=Z[t].Wf;Z[t].Vf=function(){return this.We(null)};Z[t].isNotNull=Z[t].Vf;Z[t].nc=function(a){return new Z(this.O,this.u,this.Oe,this.Me,this.qf,a)};Z[t].as=Z[t].nc;function tl(){this.vd=M()}var ul;ta(tl[t],function(){this.vd[w]()});ta(tl[t],tl[t][w]);tl[t].kb=function(a,b){this.vd.set(a[D](),b);return b};tl[t].registerService=tl[t].kb;tl[t].m=function(a){var b=this.vd.get(a[D]())||null;if(null===b)throw new P(7,a[D]());return b};tl[t].getService=tl[t].m;tl[t].Ud=function(a){return this.vd.has(a[D]())};tl[t].isRegistered=tl[t].Ud;function vl(a){this.s=a;this.ge=M();this.Ye=M();this.ze=M();this.h=M();this.Gd=M();wl(this)}function wl(a){a.s.Va()[F](function(a){var c=N();a.Ab().Nd()[F](function(d){var f=this.ge.get(d.$a)||[];f[x](d);this.ge.set(d.$a,f);c.add(this.s[k](d.$a));(f=this.h.get(d.$a))||(f=N());f.add(a);this.h.set(d.$a,f);this.ze.set(a[u]()+"."+d.Hb,d.$a);d=d.$a+"."+d.Jc;f=this.Gd.get(d)||[];f[x](a[u]());this.Gd.set(d,f)},this);0!=c[G]&&this.Ye.set(a[u](),c)},a)}function we(a,b){return a.ge.get(b)||null}
...
zl[t].uf=function(a,b){var c=this.u;this.xa="pk"+(c[0].toUpperCase()+c.substring(1));Al(this.xa);Dl(this,this.xa);c=Il(this,a,!0,void 0,b);El(this,c);1==c[C]&&this.pe.add(c[0][p]);this.Sc.add(this.xa);this.ha.set(this.xa,c);return this};zl[t].addPrimaryKey=zl[t].uf;
zl[t].tf=function(a,b){Al(a);Dl(this,a);var c=new yl(b,this.u+"."+a);Mb(c.action)||(c.action=0);Mb(c[La])||(c.timing=0);if(1==c.action&&1==c[La])throw new P(506);if(!this.H.has(c.Hb))throw new P(540,a);this.zb[x](c);this.ue(a,[c.Hb],!1);return this};zl[t].addForeignKey=zl[t].tf;zl[t].vf=function(a,b){Al(a);Dl(this,a);var c=Il(this,b,!0);Jl(this,a,c);1==c[C]&&this.pe.add(c[0][p]);this.ha.set(a,c);this.Sc.add(a);return this};zl[t].addUnique=zl[t].vf;
