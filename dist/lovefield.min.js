...
lf.index.AATree.prototype.findMin_=function(){for(var a=this.root_;a.left!=this.nullNode_;)a=a.left;return a};lf.index.AATree.prototype.findMax_=function(){for(var a=this.root_;a.right!=this.nullNode_;)a=a.right;return a};
