...
d=-1==d?c.length:d;if("base.js"==c.substr(d-7,7)){goog.basePath=c.substr(0,d-7);break}}},goog.importScript_=function(a,b){var c=goog.global.CLOSURE_IMPORT_SCRIPT||goog.writeScriptTag_;c(a,b)&&(goog.dependencies_.written[a]=!0)},goog.IS_OLD_IE_=goog.global.document&&goog.global.document.all&&!goog.global.atob,goog.importModule_=function(a){var b='goog.retrieveAndExecModule_("'+a+'");';goog.importScript_("",b)&&(goog.dependencies_.written[a]=!0)},goog.queuedModules_=[],goog.wrapModule_=function(a,b){return goog.LOAD_MODULE_USING_EVAL&&
...
goog.array.defaultCompareEquality=function(a,b){return a===b};goog.array.binaryInsert=function(a,b,c){c=goog.array.binarySearch(a,b,c);return 0>c?(goog.array.insertAt(a,b,-(c+1)),!0):!1};goog.array.binaryRemove=function(a,b,c){b=goog.array.binarySearch(a,b,c);return 0<=b?goog.array.removeAt(a,b):!1};goog.array.bucket=function(a,b,c){for(var d={},e=0;e<a.length;e++){var f=a[e],g=b.call(c,f,e,a);goog.isDef(g)&&(g=d[g]||(d[g]=[]),g.push(f))}return d};
...
goog.html.SafeStyle.checkStyle_(b);return goog.html.SafeStyle.createSafeStyleSecurityPrivateDoNotAccessOrElse(b)};goog.html.SafeStyle.VALUE_RE_=/^[-.%_!# a-zA-Z0-9]+$/;goog.html.SafeStyle.concat=function(a){var b="",c=function(a){goog.isArray(a)?goog.array.forEach(a,c):b+=goog.html.SafeStyle.unwrap(a)};goog.array.forEach(arguments,c);return b?goog.html.SafeStyle.createSafeStyleSecurityPrivateDoNotAccessOrElse(b):goog.html.SafeStyle.EMPTY};goog.html.SafeUrl=function(){this.privateDoNotAccessOrElseSafeHtmlWrappedValue_="";this.SAFE_URL_TYPE_MARKER_GOOG_HTML_SECURITY_PRIVATE_=goog.html.SafeUrl.TYPE_MARKER_GOOG_HTML_SECURITY_PRIVATE_};goog.html.SafeUrl.INNOCUOUS_STRING="about:invalid#zClosurez";goog.html.SafeUrl.prototype.implementsGoogStringTypedString=!0;goog.html.SafeUrl.prototype.getTypedStringValue=function(){return this.privateDoNotAccessOrElseSafeHtmlWrappedValue_};
...
e+=">"+goog.html.SafeHtml.unwrap(d)+"</"+a+">",d=d.getDirection());(a=b&&b.dir)&&(d=/^(ltr|rtl|auto)$/i.test(a)?goog.i18n.bidi.Dir.NEUTRAL:null);return goog.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(e,d)};goog.html.SafeHtml.EMPTY=goog.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse("",goog.i18n.bidi.Dir.NEUTRAL);goog.html.SafeScript=function(){this.privateDoNotAccessOrElseSafeScriptWrappedValue_="";this.SAFE_SCRIPT_TYPE_MARKER_GOOG_HTML_SECURITY_PRIVATE_=goog.html.SafeScript.TYPE_MARKER_GOOG_HTML_SECURITY_PRIVATE_};goog.html.SafeScript.prototype.implementsGoogStringTypedString=!0;goog.html.SafeScript.TYPE_MARKER_GOOG_HTML_SECURITY_PRIVATE_={};goog.html.SafeScript.fromConstant=function(a){a=goog.string.Const.unwrap(a);return 0===a.length?goog.html.SafeScript.EMPTY:goog.html.SafeScript.createSafeScriptSecurityPrivateDoNotAccessOrElse(a)};
...
goog.structs.Set.prototype.equals=function(a){return this.getCount()==goog.structs.getCount(a)&&this.isSubsetOf(a)};goog.structs.Set.prototype.isSubsetOf=function(a){var b=goog.structs.getCount(a);if(this.getCount()>b)return!1;!(a instanceof goog.structs.Set)&&5<b&&(a=new goog.structs.Set(a));return goog.structs.every(this,function(b){return goog.structs.contains(a,b)})};goog.structs.Set.prototype.__iterator__=function(){return this.map_.__iterator__(!1)};goog.labs={};goog.labs.userAgent={};goog.labs.userAgent.util={};goog.labs.userAgent.util.getNativeUserAgentString_=function(){var a=goog.labs.userAgent.util.getNavigator_();return a&&(a=a.userAgent)?a:""};goog.labs.userAgent.util.getNavigator_=function(){return goog.global.navigator};goog.labs.userAgent.util.userAgent_=goog.labs.userAgent.util.getNativeUserAgentString_();goog.labs.userAgent.util.setUserAgent=function(a){goog.labs.userAgent.util.userAgent_=a||goog.labs.userAgent.util.getNativeUserAgentString_()};
...
var lf={TransactionType:{READ_ONLY:0,READ_WRITE:1},Transaction:function(){}};
...
lf.backstore.BaseTx.prototype.mergeIntoBackstore_=function(){var a=this.journal_.getDiff();a.getKeys().forEach(function(b){var c=this.journal_.getScope().get(b),c=this.getTable(c.getName(),c.deserializeRow);b=a.get(b);var d=b.getDeleted().getValues().map(function(a){return a.id()});0<d.length&&c.remove(d).thenCatch(this.handleError_,this);b=b.getModified().getValues().map(function(a){return a[1]}).concat(b.getAdded().getValues());c.put(b).thenCatch(this.handleError_,this)},this);return this.resolver.promise};
...
lf.backstore.BundledObjectStore=function(a,b,c){this.cache_=a.getService(lf.service.CACHE);this.store_=b;this.deserializeFn_=c;this.logger_=goog.log.getLogger("lf.backstore.BundledObjectStore")};
...
this))},this);return goog.Promise.all(a)};
...
lf.index={};lf.index.IndexMetadata=function(a){this.type=a};lf.index.IndexMetadata.Type={ROW_ID:"rowid",BTREE:"btree"};lf.index.IndexMetadataRow=function(a){lf.Row.call(this,lf.index.IndexMetadataRow.ROW_ID,a)};goog.inherits(lf.index.IndexMetadataRow,lf.Row);lf.index.IndexMetadataRow.ROW_ID=-1;
lf.BackStore=function(){};
lf.raw={};lf.raw.BackStore=function(){};
lf.backstore.IndexedDBRawBackStore=function(a,b,c,d){this.db_=b;this.tx_=c;this.version_=a;this.bundleMode_=d};lf.backstore.IndexedDBRawBackStore.convert=function(a){var b=null;return b=a instanceof ArrayBuffer?lf.Row.binToHex(a):a instanceof Date?a.getTime():a};lf.backstore.IndexedDBRawBackStore.prototype.getVersion=function(){return this.version_};
...
lf.backstore.IndexedDBTx.prototype.getTable=function(a,b){return this.bundleMode_?new lf.backstore.BundledObjectStore(this.global_,this.tx_.objectStore(a),b):new lf.backstore.ObjectStore(this.tx_.objectStore(a),b)};
...
lf.backstore.IndexedDB.prototype.createIndexTable_=function(a,b,c,d){a.objectStoreNames.contains(c)||(a.createObjectStore(c,{keyPath:"id"}),a=b.objectStore(c),d=new lf.index.IndexMetadata(d),d=new lf.index.IndexMetadataRow(d),a.put(d.serialize()))};
lf.backstore.IndexedDB.prototype.createTx=function(a,b){var c=b.getScope().getValues().map(function(a){return a.getName()}),c=this.db_.transaction(c,a==lf.TransactionType.READ_ONLY?"readonly":"readwrite");return new lf.backstore.IndexedDBTx(this.global_,c,b,a,this.bundleMode_)};
lf.backstore.IndexedDB.prototype.scanRowId_=function(a){var b=this.schema_.getTables().map(function(a){return a.getName()}),c=this.db_,d=0,e=goog.bind(function(a){return this.bundleMode_?(a=lf.backstore.Page.deserialize(a.value),goog.object.getKeys(a.getPayload()).reduce(function(a,b){return Math.max(a,b)},0)):a.key},this),f=goog.bind(function(b){return new goog.Promise(function(f,g){var p;try{var n=a||c.transaction([b]);p=n.objectStore(b).openCursor(null,"prev")}catch(m){goog.log.error(this.logger_,
"scanRowId failed: "+m);g(m);return}p.onsuccess=function(a){if(a=a.target.result)d=Math.max(d,e(a)),a.continue();f(d)};p.onerror=function(){f(d)}},this)},this),g=function(){if(0==b.length)return goog.Promise.resolve();var a=b.shift();return f(a).then(g)};return new goog.Promise(function(a){g().then(function(){a(d)})})};lf.backstore.IndexedDB.prototype.close=function(){this.db_.close()};
...
lf.backstore.Memory=function(a){this.schema_=a;this.tables_=new goog.structs.Map};lf.backstore.Memory.prototype.init=function(){this.schema_.getTables().forEach(this.initTable_,this);return goog.Promise.resolve()};lf.backstore.Memory.prototype.getTableInternal=function(a){var b=this.tables_.get(a,null);if(goog.isNull(b))throw new lf.Exception(lf.Exception.Type.DATA,"Table "+a+" does not exist.");return b};
lf.backstore.Memory.prototype.createTx=function(a,b){return new lf.backstore.MemoryTx(this,a,b)};lf.backstore.Memory.prototype.createTable_=function(a){if(!this.tables_.containsKey(a)){var b=new lf.backstore.MemoryTable;this.tables_.set(a,b);return b}return null};
lf.backstore.Memory.prototype.initTable_=function(a){this.createTable_(a.getName());if(a.persistentIndex()){var b=a.getIndices();b.forEach(function(a){this.createIndexTable_(a.getNormalizedName(),lf.index.IndexMetadata.Type.BTREE)},this);this.createIndexTable_(a.getRowIdIndexName(),lf.index.IndexMetadata.Type.ROW_ID)}};
lf.backstore.Memory.prototype.createIndexTable_=function(a,b){var c=this.createTable_(a);if(!goog.isNull(c)){var d=new lf.index.IndexMetadata(b),d=new lf.index.IndexMetadataRow(d);c.put([d])}};lf.backstore.Memory.prototype.close=function(){};
...
lf.cache.Prefetcher=function(a){this.global_=a;this.backStore_=a.getService(lf.service.BACK_STORE);this.indexStore_=a.getService(lf.service.INDEX_STORE);this.cache_=a.getService(lf.service.CACHE)};lf.cache.Prefetcher.prototype.init=function(a){var b=a.getTables(),c=goog.bind(function(){if(0==b.length)return goog.Promise.resolve();var a=b.shift();return this.fetch_(a).then(c)},this);return c()};
lf.cache.Prefetcher.prototype.fetch_=function(a){var b=new lf.cache.Journal(this.global_,[a]),b=this.backStore_.createTx(lf.TransactionType.READ_ONLY,b),b=b.getTable(a.getName(),a.deserializeRow);return b.get([]).then(goog.bind(function(b){this.cache_.set(a.getName(),b);var d=this.indexStore_.getTableIndices(a.getName());b.forEach(function(a){d.forEach(function(b){var c=a.keyOfIndex(b.getName());b.set(c,a.id())})})},this))};
lf.index.Index=function(){};
lf.index.KeyRange=function(a,b,c,d){this.from=a;this.to=b;this.excludeLower=goog.isNull(this.from)?!1:c;this.excludeUpper=goog.isNull(this.to)?!1:d};
...
lf.index.AATree.prototype.serialize=function(){goog.asserts.fail("AATree index serialization is not supported.");return[]};lf.index.AATree.prototype.dump_=function(a,b){if(a!=this.nullNode_){var c=a.left==this.nullNode_?0:a.left.key,d=a.right==this.nullNode_?0:a.right.key,c="["+a.key+"-"+c+"/"+d+"]";b[a.level-1].push(c);this.dump_(a.left,b);this.dump_(a.right,b)}};
lf.index.AATree.prototype.toString=function(){for(var a=[],b=0;b<this.root_.level;++b)a.push([]);this.dump_(this.root_,a);for(var b="",c=a.length-1;0<=c;--c)b=b+a[c].join("")+"\n";return b};
lf.index.BTree=function(a,b,c){this.name_=a;this.uniqueKeyOnly_=b;c?this.root_=lf.index.BTreeNode_.fromData(this,c):this.clear()};lf.index.BTree.prototype.getName=function(){return this.name_};lf.index.BTree.prototype.toString=function(){return this.root_.toString()};lf.index.BTree.prototype.add=function(a,b){this.root_=this.root_.insert(a,b)};lf.index.BTree.prototype.set=function(a,b){this.root_=this.root_.insert(a,b,!0)};
lf.index.BTree.prototype.remove=function(a,b){this.root_=this.root_.remove(a,b)};lf.index.BTree.prototype.get=function(a){return this.root_.get(a)};lf.index.BTree.prototype.cost=function(a){return this.getRange(a).length};lf.index.BTree.prototype.getRange=function(a){var b=null;a&&(goog.isNull(a.from)||(b=this.root_.getContainingLeaf(a.from)));null==b&&(b=this.root_.getLeftMostNode());return b.getRange(a)};lf.index.BTree.prototype.clear=function(){this.root_=lf.index.BTreeNode_.create(this)};
lf.index.BTree.prototype.containsKey=function(a){return this.root_.containsKey(a)};lf.index.BTree.prototype.isUniqueKeyOnly=function(){return this.uniqueKeyOnly_};lf.index.BTree.prototype.serialize=function(){var a=this.root_.getLeftMostNode();return lf.index.BTreeNode_.serialize(a)};lf.index.BTree.deserialize=function(a,b,c){b=new lf.index.BTree(b,c);a=lf.index.BTreeNode_.deserialize(a,b);b.root_=a;return b};
...
lf.index.BTreeNode_.prototype.toString=function(){var a="",b=lf.index.BTreeNode_.dumpLevel_(this),a=a+(b[0]+"\n"+b[1]+"\n");this.children_.length&&(a+=this.children_[0].toString());return a};lf.index.BTreeNode_.prototype.getLeftMostNode=function(){return this.isLeaf_()?this:this.children_[0].getLeftMostNode()};lf.index.BTreeNode_.associate_=function(a,b){b&&(b.prev_=a);a&&(a.next_=b)};
lf.index.BTreeNode_.calcNodeLen_=function(a){var b=lf.index.BTreeNode_.MAX_KEY_LEN_,c=lf.index.BTreeNode_.MIN_KEY_LEN_+1;return a>=b+c?b:a>=c&&a<=b?a:c};
...
lf.index.BTreeNode_.prototype.get=function(a){var b=this.searchKey_(a);if(this.isLeaf_()){var c=[];this.keys_[b]==a&&(c=c.concat(this.values_[b]));return c}b=this.keys_[b]==a?b+1:b;return this.children_[b].get(a)};lf.index.BTreeNode_.prototype.containsKey=function(a){var b=this.searchKey_(a);return this.keys_[b]==a?!0:this.isLeaf_()?!1:this.children_[b].containsKey(a)};
...
lf.index.BTreeNode_.prototype.delete_=function(a,b,c){var d=this.searchKey_(a);if(!this.isLeaf_()){var e=this.keys_[d]==a?d+1:d;if(this.children_[e].delete_(a,e,c))this.fix_();else return!1}else if(this.keys_[d]!=a)return!1;if(this.keys_.length>d&&this.keys_[d]==a){if(goog.isDef(c)&&!this.tree_.isUniqueKeyOnly()&&this.isLeaf_()&&(goog.array.binaryRemove(this.values_[d],c),this.values_[d].length))return!1;this.keys_.splice(d,1);this.isLeaf_()&&this.values_.splice(d,1)}this.keys_.length<lf.index.BTreeNode_.MIN_KEY_LEN_&&
!this.isRoot_()&&(this.steal_()||this.merge_(b));return!0};
...
lf.index.BTreeNode_.prototype.insert=function(a,b,c){var d=this.searchKey_(a);if(this.isLeaf_()){if(this.keys_[d]==a){if(c)return this.values_[d]=this.tree_.isUniqueKeyOnly()?b:[b],this;if(this.tree_.isUniqueKeyOnly())throw new lf.Exception(lf.Exception.Type.CONSTRAINT,"Duplicate key not allowed");if(this.values_[d])return goog.array.binaryInsert(this.values_[d],b),this;this.values_[d]=[b]}this.keys_.splice(d,0,a);this.values_.splice(d,0,this.tree_.isUniqueKeyOnly()?b:[b]);return this.keys_.length==
lf.index.BTreeNode_.MAX_COUNT_?this.splitLeaf_():this}d=this.keys_[d]==a?d+1:d;a=this.children_[d].insert(a,b,c);a.isLeaf_()||1!=a.keys_.length||(this.keys_.splice(d,0,a.keys_[0]),a.children_[1].parent_=this,a.children_[0].parent_=this,this.children_.splice(d,1,a.children_[1]),this.children_.splice(d,0,a.children_[0]));return this.keys_.length==lf.index.BTreeNode_.MAX_COUNT_?this.splitInternal_():this};
...
lf.index.BTreeNode_.associate_(this,c);return b};lf.index.BTreeNode_.prototype.searchKey_=function(a){for(var b=0,c=this.keys_.length;b<c;){var d=b+c>>1,e=this.keys_[d];e<a?b=d+1:c=d}return b};lf.index.BTreeNode_.prototype.getContainingLeaf=function(a){if(!this.isLeaf_()){var b=this.searchKey_(a);this.keys_[b]==a&&b++;return this.children_[b].getContainingLeaf(a)}return this};
lf.index.BTreeNode_.prototype.getRange=function(a){var b=0,c=this.keys_.length-1;if(goog.isDefAndNotNull(a)){if(!goog.isNull(a.to)){if(this.keys_[0]>a.to)return[];this.keys_[c]>=a.to&&(c=this.searchKey_(a.to),(a.excludeUpper&&this.keys_[c]==a.to||this.keys_[c]>a.to)&&c--)}!goog.isNull(a.from)&&this.keys_[0]<=a.from&&(b=this.searchKey_(a.from),a.excludeLower&&this.keys_[b]==a.from&&b++)}var d=[];c==this.keys_.length-1?(d=d.concat(this.values_.slice(b)),this.next_&&(d=d.concat(this.next_.getRange(a)))):
c>=b&&(d=d.concat(this.values_.slice(b,c+1)));this.tree_.isUniqueKeyOnly()||(d=goog.array.flatten(d));return d};lf.index.BTreeNode_.serialize=function(a){for(var b=[];a;){var c=[a.keys_,a.values_];b.push(new lf.Row(a.id_,c));a=a.next_}return b};
...
lf.index.hashCode=function(a){for(var b=0,c=0;c<a.length;++c)b=(b<<5)-b+a.charCodeAt(c),b&=b;return b};lf.index.hashArray=function(a){a=a.map(function(a){return goog.isDefAndNotNull(a)?lf.index.hashCode(a.toString()).toString(32):""});return a.join("_")};
...
lf.index.Map.prototype.get=function(a){a=this.map_.get(a);return goog.isDefAndNotNull(a)?a.getValues():[]};lf.index.Map.prototype.cost=function(a){return this.getRange(a).length};lf.index.Map.prototype.getRange=function(a){var b=[];a=a||lf.index.KeyRange.all();var c=a.getComparator();this.map_.getKeys().sort().forEach(function(a){c(a)&&(b=b.concat(this.get(a)))},this);return b};lf.index.Map.prototype.clear=function(){return this.map_.clear()};lf.index.Map.prototype.containsKey=function(a){return this.map_.containsKey(a)};
lf.index.Map.prototype.serialize=function(){goog.asserts.fail("Map index serialization is not supported.");return[]};
lf.index.RowId=function(a){this.name_=a;this.rows_=new goog.structs.Set};lf.index.RowId.ROW_ID=0;lf.index.RowId.prototype.getName=function(){return this.name_};lf.index.RowId.prototype.add=function(a){if("number"!=typeof a)throw new lf.Exception(lf.Exception.Type.DATA,"Row id must be numbers");this.rows_.add(a)};lf.index.RowId.prototype.set=function(a,b){this.add(a,b)};lf.index.RowId.prototype.remove=function(a){this.rows_.remove(a)};
lf.index.RowId.prototype.get=function(a){return this.containsKey(a)?[a]:[]};lf.index.RowId.prototype.cost=function(){return this.rows_.getCount()};lf.index.RowId.prototype.getRange=function(a){a=a||lf.index.KeyRange.all();if(goog.isDefAndNotNull(a.from)&&"number"!=typeof a.from||goog.isDefAndNotNull(a.to)&&"number"!=typeof a.to)throw new lf.Exception(lf.Exception.Type.DATA,"Row id must be numbers");return this.rows_.getValues().filter(a.getComparator())};lf.index.RowId.prototype.clear=function(){this.rows_.clear()};
lf.index.RowId.prototype.containsKey=function(a){return this.rows_.contains(a)};lf.index.RowId.prototype.serialize=function(){return[new lf.Row(lf.index.RowId.ROW_ID,this.rows_.getValues())]};lf.index.RowId.deserialize=function(a,b){var c=new lf.index.RowId(a),d=b[0].payload();d.forEach(function(a){c.add(a,a)});return c};
lf.index.MemoryIndexStore=function(){this.store_=new goog.structs.Map};lf.index.MemoryIndexStore.prototype.init=function(a){a=a.getTables();a.forEach(function(a){var c=a.getRowIdIndexName(),d=this.get(c);goog.isNull(d)&&(d=new lf.index.RowId(c),this.store_.set(c,d));a.getIndices().forEach(function(c){this.store_.set(c.getNormalizedName(),lf.index.MemoryIndexStore.createIndex_(a,c))},this)},this);return goog.Promise.resolve()};
lf.index.MemoryIndexStore.createIndex_=function(a,b){var c=b.getNormalizedName();return a.persistentIndex()?new lf.index.BTree(c,b.isUnique):b.isUnique?new lf.index.AATree(c):new lf.index.Map(c)};lf.index.MemoryIndexStore.prototype.get=function(a){return this.store_.get(a,null)};lf.index.MemoryIndexStore.prototype.getTableIndices=function(a){var b=[],c=a+".";this.store_.getKeys().forEach(function(a){-1!=a.indexOf(c)&&b.push(this.store_.get(a))},this);return b};
...
goog.structs.TreeNode.prototype.isLastChild=function(){var a=this.getParent();return Boolean(a&&this==goog.array.peek(a.getChildren()))};goog.structs.TreeNode.prototype.getChildren=function(){return this.children_||goog.structs.TreeNode.EMPTY_ARRAY_};goog.structs.TreeNode.prototype.getChildAt=function(a){return this.getChildren()[a]||null};goog.structs.TreeNode.prototype.getChildCount=function(){return this.getChildren().length};
goog.structs.TreeNode.prototype.getDepth=function(){for(var a=0,b=this;b.getParent();)a++,b=b.getParent();return a};goog.structs.TreeNode.prototype.getRoot=function(){for(var a=this;a.getParent();)a=a.getParent();return a};goog.structs.TreeNode.prototype.contains=function(a){do a=a.getParent();while(a&&a!=this);return Boolean(a)};
goog.structs.TreeNode.findCommonAncestor=function(a){var b=arguments[0];if(!b)return null;for(var c=b.getDepth(),d=1;d<arguments.length;d++)for(var e=arguments[d],f=e.getDepth();e!=b;)f<=c&&(b=b.getParent(),c--),f>c&&(e=e.getParent(),f--);return b};goog.structs.TreeNode.prototype.forEachDescendant=function(a,b){goog.array.forEach(this.getChildren(),function(c){a.call(b,c);c.forEachDescendant(a,b)})};
...
lf.query={};lf.query.SelectContext=function(){this.currentVersion=0};lf.query.SelectContext.orderByToString=function(a){var b="";a.forEach(function(c,d){b+=c.column.getNormalizedName();d>a.length-1&&(b+=", ")});return b};
...
lf.proc.PhysicalQueryPlan=function(a){this.rootNode_=a};lf.proc.PhysicalQueryPlan.prototype.getRoot=function(){return this.rootNode_};lf.proc.PhysicalQueryPlan.prototype.getScope=function(){var a=new goog.structs.Set,b=function(c){var d=c.getScope();d&&a.add(d);c.getChildren().forEach(function(a){b(a)})};b(this.rootNode_);return a.getValues()};lf.proc.PhysicalQueryPlan.getCombinedScope=function(a){var b=new goog.structs.Set;a.forEach(function(a){b.addAll(a.getScope())});return b};
...
goog.inherits(lf.proc.TableAccessFullStep,lf.proc.PhysicalQueryPlanNode);lf.proc.TableAccessFullStep.prototype.toString=function(){return"table_access("+this.table.getName()+")"};lf.proc.TableAccessFullStep.prototype.getScope=function(){return this.table};lf.proc.TableAccessFullStep.prototype.exec=function(a){return goog.Promise.resolve(lf.proc.Relation.fromRows(a.getTableRows(this.table),[this.table.getName()]))};
...
lf.proc.TableAccessByRowIdStep.prototype.exec=function(a){return this.getChildAt(0).exec(a).then(goog.bind(function(b){return goog.Promise.resolve(lf.proc.Relation.fromRows(a.getTableRows(this.table_,b.getRowIds()),[this.table_.getName()]))},this))};lf.proc.IndexRangeScanStep=function(a,b){lf.proc.PhysicalQueryPlanNode.call(this);this.index_=a;this.keyRanges_=b};goog.inherits(lf.proc.IndexRangeScanStep,lf.proc.PhysicalQueryPlanNode);
lf.proc.IndexRangeScanStep.prototype.toString=function(){return"index_range_scan("+this.index_.getNormalizedName()+", "+this.keyRanges_.toString()+")"};lf.proc.IndexRangeScanStep.prototype.exec=function(a){a=a.getIndexRange(this.index_,this.keyRanges_);a=a.map(function(a){return new lf.Row(a,{})},this);return goog.Promise.resolve(lf.proc.Relation.fromRows(a,[this.index_.tableName]))};lf.proc.SelectStep=function(a){lf.proc.PhysicalQueryPlanNode.call(this);this.predicate=a};
...
lf.proc.QueryTask.prototype.getType=function(){return this.txType_};lf.proc.QueryTask.prototype.getScope=function(){return this.combinedScope_};lf.proc.QueryTask.prototype.getResolver=function(){return this.resolver_};lf.proc.QueryTask.prototype.onSuccess=function(){};
...
lf.query.insertToSql_=function(a){var b=a.allowReplace?"INSERT OR REPLACE":"INSERT",c=a.into.getColumns(),b=b+(" INTO "+a.into.getName()+"("),b=b+c.map(function(a){return a.getName()}).join(", "),b=b+") VALUES (";a=a.values.map(function(a){var e=c.map(function(b){var c=a.payload()[b.getName()];return lf.query.escapeSqlValue_(b.getType(),c)});return b+e.join(", ")+");"});return a.join("\n")};lf.query.toSql=function(a){a=a.query;return a instanceof lf.query.InsertContext?lf.query.insertToSql_(a):"Not implemented"};
lf.query.BaseBuilder=function(a){this.global_=a;a.getService(lf.service.QUERY_ENGINE);this.runner_=a.getService(lf.service.RUNNER)};lf.query.BaseBuilder.prototype.exec=function(){try{this.assertExecPreconditions()}catch(a){return goog.Promise.reject(a)}return new goog.Promise(function(a,c){var d=new lf.proc.UserQueryTask(this.global_,[this.query]);this.runner_.scheduleTask(d).then(function(c){a(c[0].getPayloads())},c)},this)};lf.query.BaseBuilder.prototype.bind=function(){return this};
lf.query.BaseBuilder.prototype.toSql=function(){return lf.query.toSql(this)};lf.query.BaseBuilder.prototype.assertExecPreconditions=function(){};lf.query.BaseBuilder.prototype.getQuery=function(){return this.query};lf.query.BaseBuilder.bindValuesInSearchCondition=function(a,b){var c=a.where;goog.isDefAndNotNull(c)&&c.traverse(function(a){a instanceof lf.pred.ValuePredicate&&a.bind(b)})};
...
lf.schema={};lf.schema.Column=function(){};lf.schema.Database=function(){};lf.schema.Index=function(a,b,c,d){this.tableName=a;this.name=b;this.isUnique=c;this.columnNames=d};lf.schema.Index.prototype.getNormalizedName=function(){return this.tableName+"."+this.name};lf.schema.Table=function(a,b,c,d){this.name_=a;this.indices_=c;this.columns_=b;this.persistentIndex_=d};lf.schema.Table.prototype.getName=function(){return this.name_};lf.schema.Table.prototype.getIndices=function(){return this.indices_};
lf.schema.Table.prototype.getColumns=function(){return this.columns_};lf.schema.Table.prototype.persistentIndex=function(){return this.persistentIndex_};lf.schema.Table.ROW_ID_INDEX_PATTERN="#";lf.schema.Table.prototype.getRowIdIndexName=function(){return this.name_+"."+lf.schema.Table.ROW_ID_INDEX_PATTERN};
...
lf.query.SelectBuilder=function(a,b){lf.query.BaseBuilder.call(this,a);this.query=new lf.query.SelectContext;this.query.columns=b;this.checkDistinctColumn_();this.checkAggregations_()};goog.inherits(lf.query.SelectBuilder,lf.query.BaseBuilder);
...
lf.query.SelectBuilder.prototype.bind=function(a){lf.query.BaseBuilder.bindValuesInSearchCondition(this.query,a);this.query.currentVersion++;return this};
...
lf.proc.IndexRangeScanPass=function(a){this.indexStore_=a.getService(lf.service.INDEX_STORE)};goog.inherits(lf.proc.IndexRangeScanPass,lf.proc.RewritePass);lf.proc.IndexRangeScanPass.prototype.rewrite=function(a){this.rootNode=a;a=this.findTableAccessFullSteps_();a.forEach(function(a){var c=this.findSelectStepCandidates_(a);0!=c.length&&(c=this.chooseSelectStep_(c),a=lf.proc.IndexRangeScanPass.replaceWithIndexRangeScanStep_(c,a),c==this.rootNode&&(this.rootNode=a.getRoot()))},this);return this.rootNode};
...
lf.proc.PhysicalPlanFactory=function(a){this.global_=a};lf.proc.PhysicalPlanFactory.prototype.create=function(a){if(a instanceof lf.proc.InsertOrReplaceNode||a instanceof lf.proc.InsertNode)return this.createPlan_(a);if(a instanceof lf.proc.DeleteNode||a instanceof lf.proc.ProjectNode||a instanceof lf.proc.UpdateNode)return this.createPlan_(a,[new lf.proc.IndexRangeScanPass(this.global_)]);goog.asserts.fail("Unknown query type.");a=new lf.proc.PhysicalQueryPlanNode;return new lf.proc.PhysicalQueryPlan(a)};
...
lf.DiffCalculator.prototype.applyDiff=function(a,b){for(var c=goog.isNull(a)?[]:a.entries,d=goog.math.longestCommonSubsequence(c,b.entries,goog.bind(this.comparator_,this),function(a){return c[a]}),e=0,f=0;f<c.length;f++){var g=c[f];d[e]==g?e++:this.observableResults_.splice(f,1)}d=goog.math.longestCommonSubsequence(c,b.entries,goog.bind(this.comparator_,this),function(a,c){return b.entries[c]});for(f=e=0;f<b.entries.length;f++)g=b.entries[f],d[e]==g?e++:this.observableResults_.splice(f,0,g.row.payload())};
...
lf.ObserverRegistry.prototype.getQueriesForTables=function(a){var b=new goog.structs.Set;a.forEach(function(a){b.add(a.getName())});var c=[];this.entries_.getValues().forEach(function(a){a=a.getQuery();var e=a.from.some(function(a){return b.contains(a.getName())});e&&c.push(a)});return c};lf.ObserverRegistry.prototype.updateResultsForQuery=function(a,b){var c=this.getQueryId_(a),c=this.entries_.get(c,null);return goog.isNull(c)||c.lastResultVersion_==a.currentVersion?!1:(c.updateResults(b),!0)};
lf.ObserverRegistry.Entry_=function(a){this.query_=a;this.observers_=new goog.structs.Set;this.observable_=[];this.lastResults_=null;this.lastResultVersion_=-1;this.diffCalculator_=new lf.DiffCalculator(a,this.observable_)};lf.ObserverRegistry.Entry_.prototype.addObserver=function(a){this.observers_.contains(a)?goog.asserts.fail("Attempted to register observer twice."):(Array.observe(this.observable_,a),this.observers_.add(a))};
lf.ObserverRegistry.Entry_.prototype.removeObserver=function(a){Array.unobserve(this.observable_,a);return this.observers_.remove(a)};lf.ObserverRegistry.Entry_.prototype.getQuery=function(){return this.query_};lf.ObserverRegistry.Entry_.prototype.hasObservers=function(){return 0<this.observers_.getCount()};lf.ObserverRegistry.Entry_.prototype.updateResults=function(a){this.diffCalculator_.applyDiff(this.lastResults_,a);this.lastResults_=a;this.lastResultVersion_=this.query_.currentVersion};
...
lf.proc.Transaction=function(a){this.global_=a;this.runner_=a.getService(lf.service.RUNNER);this.completed_=!1};
lf.proc.Transaction.prototype.exec=function(a){if(this.completed_)throw new lf.Exception(lf.Exception.Type.TRANSACTION,"Transaction already commited/failed");var b=[];try{a.forEach(function(a){a.assertExecPreconditions();a=a.getQuery();b.push(a)},this)}catch(c){return this.completed_=!0,goog.Promise.reject(c)}a=new lf.proc.UserQueryTask(this.global_,b);return this.runner_.scheduleTask(a).then(goog.bind(function(a){this.completed_=!0;return a.map(function(a){return a.getPayloads()})},this),goog.bind(function(a){this.completed_=
!0;throw a;},this))};lf.proc.Database=function(a){this.global_=a;this.schema_=a.getService(lf.service.SCHEMA);this.initialized_=!1};lf.proc.Database.prototype.init=function(a,b){this.global_.registerService(lf.service.SCHEMA,this.schema_);return lf.base.init(this.global_,b||lf.base.BackStoreType.INDEXED_DB,a,!1).then(goog.bind(function(){this.initialized_=!0;return this},this))};goog.exportSymbol("lf.proc.Database.prototype.init",lf.proc.Database.prototype.init);lf.proc.Database.prototype.getSchema=function(){return this.schema_};
...
goog.exportSymbol("lf.schema.BaseColumn.prototype.eq",lf.schema.BaseColumn.prototype.eq);lf.schema.BaseColumn.prototype.neq=function(a){return lf.pred.createPredicate(this,a,lf.eval.Type.NEQ)};goog.exportSymbol("lf.schema.BaseColumn.prototype.neq",lf.schema.BaseColumn.prototype.neq);lf.schema.BaseColumn.prototype.lt=function(a){return lf.pred.createPredicate(this,a,lf.eval.Type.LT)};goog.exportSymbol("lf.schema.BaseColumn.prototype.lt",lf.schema.BaseColumn.prototype.lt);
lf.schema.BaseColumn.prototype.lte=function(a){return lf.pred.createPredicate(this,a,lf.eval.Type.LTE)};goog.exportSymbol("lf.schema.BaseColumn.prototype.lte",lf.schema.BaseColumn.prototype.lte);lf.schema.BaseColumn.prototype.gt=function(a){return lf.pred.createPredicate(this,a,lf.eval.Type.GT)};goog.exportSymbol("lf.schema.BaseColumn.prototype.gt",lf.schema.BaseColumn.prototype.gt);lf.schema.BaseColumn.prototype.gte=function(a){return lf.pred.createPredicate(this,a,lf.eval.Type.GTE)};
goog.exportSymbol("lf.schema.BaseColumn.prototype.gte",lf.schema.BaseColumn.prototype.gte);lf.schema.BaseColumn.prototype.match=function(a){return lf.pred.createPredicate(this,a,lf.eval.Type.MATCH)};goog.exportSymbol("lf.schema.BaseColumn.prototype.match",lf.schema.BaseColumn.prototype.match);lf.schema.BaseColumn.prototype.between=function(a,b){return lf.pred.createPredicate(this,[a,b],lf.eval.Type.BETWEEN)};goog.exportSymbol("lf.schema.BaseColumn.prototype.between",lf.schema.BaseColumn.prototype.between);
lf.schema.BaseColumn.prototype.in=function(a){return lf.pred.createPredicate(this,a,lf.eval.Type.IN)};goog.exportSymbol("lf.schema.BaseColumn.prototype.in",lf.schema.BaseColumn.prototype.in);lf.schema.BaseColumn.prototype.isNull=function(){return this.eq(null)};goog.exportSymbol("lf.schema.BaseColumn.prototype.isNull",lf.schema.BaseColumn.prototype.isNull);lf.schema.BaseColumn.prototype.isNotNull=function(){return this.neq(null)};goog.exportSymbol("lf.schema.BaseColumn.prototype.isNotNull",lf.schema.BaseColumn.prototype.isNotNull);
lf.schema.BaseColumn.prototype.as=function(a){return new lf.schema.BaseColumn(this.table_,this.name_,this.isUnique_,this.type_,a)};goog.exportSymbol("lf.schema.BaseColumn.prototype.as",lf.schema.BaseColumn.prototype.as);
...
lf.op={};lf.op.and=function(a,b){var c=new lf.pred.CombinedPredicate(lf.pred.Operator.AND);c.addChild(a);c.addChild(b);return c};goog.exportSymbol("lf.op.and",lf.op.and);lf.op.or=function(a,b){var c=new lf.pred.CombinedPredicate(lf.pred.Operator.OR);c.addChild(a);c.addChild(b);return c};goog.exportSymbol("lf.op.or",lf.op.or);lf.op.not=function(a){a.setComplement(!0);return a};goog.exportSymbol("lf.op.not",lf.op.not);
