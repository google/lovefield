...
lf.ObserverRegistry.Entry_=function(a){this.query_=a;this.observers_=new goog.structs.Set;this.observable_=[];this.lastResults_=null;this.diffCalculator_=new lf.DiffCalculator(a,this.observable_);this.hasNativeSupport_=lf.ObserverRegistry.Entry_.hasNativeSupport_()};lf.ObserverRegistry.Entry_.prototype.addObserver=function(a){this.observers_.contains(a)?goog.asserts.fail("Attempted to register observer twice."):(this.hasNativeSupport_&&Array.observe(this.observable_,a),this.observers_.add(a))};
lf.ObserverRegistry.Entry_.prototype.removeObserver=function(a){this.hasNativeSupport_&&Array.unobserve(this.observable_,a);return this.observers_.remove(a)};lf.ObserverRegistry.Entry_.prototype.getQuery=function(){return this.query_};lf.ObserverRegistry.Entry_.prototype.hasObservers=function(){return 0<this.observers_.getCount()};
lf.ObserverRegistry.Entry_.prototype.updateResults=function(a){var b=this.diffCalculator_.applyDiff(this.lastResults_,a,!this.hasNativeSupport_);this.lastResults_=a;this.hasNativeSupport_||0<b.length&&this.observers_.getValues().forEach(function(a){a(b)})};lf.ObserverRegistry.Entry_.hasNativeSupport_=function(){return"function"==typeof Array.observe&&"function"==typeof Array.unobserve};
