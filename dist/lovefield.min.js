...
va(H,function(a){if(0==a[C])return this.ec(J(function(){return this.$[w]()},this));var b=N();a[F](function(a){var d=a>>9,g=b.get(d)||null;null===g&&(g=this.kh(this.$[q],d));g.fl([a]);b.set(d,g)},this);a=Fd(b).map(function(a){return this.ec(J(function(){var b;a:{b=a.zc();for(var g in b){b=!1;break a}b=!0}return b?this.$[Xa](a.fa()):this.$.put(a.Ja())},this))},this);return ad(a)});function Zd(a,b,c){a=a.o(Id);var d=[c<<9,(c+1<<9)-1];b=a.pb(b,d[0],d[1]);c=new Vd(c);c.rh(b);return c}
...
H.$i=function(a,b,c){for(var d=[],g=a.W(),k=b.W(),l=0;l<a[B][C];l++){for(var p=!1,y=0;y<b[B][C];y++)if(this.Hd(a[B][l].V(this.Oa),b[B][y].V(this.Da))){var p=!0,xa=ye(a[B][l],g,b[B][y],k);d[x](xa)}c&&!p&&d[x](this.Xf(a[B][l],g))}a=a.W()[Ra](b.W());return new pe(d,a)};
H.Zi=function(a,b,c){var d=a,g=b,k=this.Oa,l=this.Da;if(c||a[B][C]>b[B][C])d=b,g=a,k=this.Da,l=this.Oa;var p=new hg,y=[];d[B][F](function(a){var b=ha(a.V(k));p.add(b,a)});var xa=d.W(),sb=g.W();g[B][F](function(a){var b=ha(a.V(l));p.K(b)?p.get(b)[F](function(b){b=ye(a,sb,b,xa);y[x](b)}):c&&y[x](this.Xf(a,sb))}[E](this));a=a.W()[Ra](b.W());return new pe(y,a)};
...
function Qg(){U[r](this,2,0)}K(Qg,U);f(Qg[t],Kb("cross_product"));Qg[t].ha=function(a,b){for(var c=b[0],d=b[1],g=[],k=c.W(),l=d.W(),p=0;p<c[B][C];p++)for(var y=0;y<d[B][C];y++){var xa=ye(c[B][p],k,d[B][y],l);g[x](xa)}c=c.W()[Ra](d.W());return[new pe(g,c)]};
