...
function Zc(a,b){null===a.dd&&(a.dd=B());var c=a.dd.get(b.name)||null;null===c&&(c=a.i.table(b.Sa)[b.mc].za(),c=a.F.get(c.m()),a.dd.set(b.name,c));return c}function $c(a,b,c){return(null===a?null!==b:null===b)||a.Hb(c)!=b.Hb(c)}function ad(a,b,c,d){b=bd(a.i.info(),b.getName(),0);null!==b&&(b=b.filter(function(a){return a.timing==d}),0!=b.length&&cd(a,b,c,function(a,b,c){if(b.Ma(c))throw new F(203,a.name);}))}
...
function Lc(a){var b=[];a.ua.forEach(function(a){b.push([null,a])});a.ma.forEach(function(a){b.push(a)});a.ya.forEach(function(a){b.push([a,null])});return b}m.toString=function(){return"["+bc(this.ua).toString()+"], ["+bc(this.ma).toString()+"], ["+bc(this.ya).toString()+"]"};function kd(a){var b=new jd(a.w);a.ua.forEach(function(a){b.delete(a)});a.ya.forEach(function(a){b.add(a)});a.ma.forEach(function(a){b.modify([a[1],a[0]])});return b}
m.od=function(){return 0==this.ua.size&&0==this.ya.size&&0==this.ma.size};function ld(a,b){this.aa=B();b.forEach(function(a){this.aa.set(a.getName(),a)},this);this.i=a.l(rc);this.W=a.l(mc);this.F=a.l(nc);this.wa=new Uc(a);this.md=new Ic(a);this.tb=B()}function jc(a){var b=[];bc(a.tb).map(function(a){return this.aa.get(a)},a).forEach(function(a){a.Bb()&&(a.Aa().forEach(function(a){b.push(this.F.get(a.m()))},this),b.push(this.F.get(a.getName()+".#")))},a);return b}m=ld.prototype;m.ca=g("aa");
m.zb=function(a,b){md(this,a);Wc(this.wa,a,b);fd(this.wa,a,b,0);for(var c=0;c<b.length;c++)nd(this,a,[null,b[c]])};function nd(a,b,c){var d=b.getName(),e=a.tb.get(d)||new jd(d);a.tb.set(d,e);try{Mc(a.md,b,c)}catch(h){throw h;}b=c[0];var f=c[1];null===b&&null!==f?(a.W.set(d,f),e.add(f)):null!==b&&null!==f?(a.W.set(d,f),e.modify(c)):null!==b&&null===f&&(a.W.remove(d,b.id()),e.delete(b))}
m.update=function(a,b){md(this,a);Wc(this.wa,a,b);var c=b.map(function(a){return[this.W.get(a.id()),a]},this);od(this,a,c);gd(this.wa,a,c,0);c.forEach(function(b){nd(this,a,b)},this)};m.Vd=function(a,b){md(this,a);Wc(this.wa,a,b);for(var c=0;c<b.length;c++){var d=b[c],e=null,f,h=a.Gb().gd();if(null===h)f=null;else{f=this.wa;var h=h.m(),k=d.Hb(h);f=f.F.get(h).get(k);f=0==f.length?null:f[0]}null!=f?(e=this.W.get(f),d.oa=f,gd(this.wa,a,[[e,d]],0)):fd(this.wa,a,[d],0);nd(this,a,[e,d])}};
m.remove=function(a,b){md(this,a);pd(this,a,b);hd(this.wa,a,b,0);for(var c=0;c<b.length;c++)nd(this,a,[b[c],null])};function od(a,b,c){b=bd(a.i.info(),b.getName(),1);if(null!==b){var d=ed(a.wa,c,b);d.keys().forEach(function(a){d.get(a).forEach(function(b){var c=this.i.table(b.Qd.Ge),d=this.W.get(a),n=c.Fb(d.Ga());n.s[b.Qd.hb]=b.tg.s[b.Qd.mc];nd(this,c,[d,n])},this)},a)}}
function pd(a,b,c){if(null!==bd(a.i.info(),b.getName(),1)){b=id(a.wa,b,c);var d=b.pf;b.te.forEach(function(a){var b=this.i.table(a);a=d.get(a).map(function(a){return this.W.get(a)},this);hd(this.wa,b,a,0);a.forEach(function(a){nd(this,b,[a,null])},this)},a)}}function fc(a){a.tb.forEach(function(a){var c=this.aa.get(a.getName());fd(this.wa,c,C(a.ua),1);hd(this.wa,c,C(a.ya),1);gd(this.wa,c,C(a.ma),1)},a)}m.ia=aa();m.Kb=function(){var a=C(this.tb).map(function(a){return kd(a)});this.md.update(a)};
...
m.de=function(a){var b=a.child("@rev/R").val();null!=b&&b!=this.Na&&(this.Na=b,a=Ne(this,a),a.forEach(function(a){var b=this.M.get(a.getName()),e=bc(a.ya);0<e.length&&He(b,e);var f=C(a.ua);a.ma.forEach(function(a){f.push(a[1])});Ge(b,f)},this),0<a.length&&this.Jc(a),Me(this))};
...
m.sf=function(a){var b=a.filter(function(a){return a.every(ga)});a=Array(this.va.length);for(var c=0;c<a.length;c++)a[c]=b.map(function(a){return a[c]});a.forEach(function(a,b){a.sort(function(a,c){return this.va[b].he(a,c)}.bind(this))},this);b=Array(b.length);for(c=0;c<b.length;c++)b[c]=a.map(function(a){return a[c]});return b.sort(function(a,b){for(var c=0,h=0;h<this.va.length&&0==c;++h)c=this.va[h].he(a[h],b[h]);return c}.bind(this))};m.Wd=function(a){return this.va[0].Wd(a[0])};
...
function ug(a,b){var c=[];a.Ba().map(function(a){return b.Ba().map(function(b){var c;if(td(a,b)){c=vd();var h=ud(a.c,b.c,!0),h=0==h?a.ea?a:b:-1!=h?a:b;c.c=h.c;c.ea=h.ea;a.A==G||b.A==G?b=a.A==G?b:a:(h=ud(a.A,b.A,!1),b=0==h?a.la?a:b:-1==h?a:b);c.A=b.A;c.la=b.la}else c=null;return c})}).forEach(function(a){c=c.concat(a)});return new tg(c.filter(function(a){return null!==a}))};function vg(a,b){var c=[],d=null,e=null;Zd(a,function(a){var h=b(a);null==a.getParent()?e=h:Wd(d,h);var k=a.getParent();null!==k&&M(k).length==M(d).length&&(k=c.indexOf(d),-1!=k&&c.splice(k,1));1<M(a).length&&c.push(h);d=null===a.g?c[c.length-1]:h});return e}function wg(a){return xg(a,function(a){return null===a.g})}
...
W.prototype.clone=function(){var a=new W(this.global,this.a.f);a.a=this.a.clone();a.a.$c=null;return a};W.prototype.clone=W.prototype.clone;function ji(a,b){V.call(this,a,new Ih(a.l(rc)));this.a.table=b}t(ji,V);r("lf.query.UpdateBuilder",ji);ji.prototype.set=function(a,b){var c={Wc:b instanceof Kd?b.za():-1,N:a,value:b};null!=this.a.set?this.a.set.push(c):this.a.set=[c];return this};ji.prototype.set=ji.prototype.set;ji.prototype.u=function(a){this.Fd();this.a.u=a;return this};ji.prototype.where=ji.prototype.u;ji.prototype.Fd=function(){if(null!=this.a.u)throw new F(516);};
...
f,a.entries[$a],h);e.push(re)}d&&!Eb&&e.push(Jg(b,c.entries[da],f))}O++}b=I(c).concat(I(a));return[new H(e,b)]}};function Ki(a,b){a.Dd=1;var c=a.F.get(b.za().m());a.Qe={Yf:b,ng:b==a.J.ha?a.J.ka:a.J.ha,index:c}};function Li(a){U.call(this,0,-1);this.kf=a}t(Li,U);Li.prototype.toString=function(){return"no_op_step("+I(this.kf[0]).join(",")+")"};Li.prototype.fa=g("kf");function Mi(){}t(Mi,vh);Mi.prototype.pb=function(a,b){this.$=a;if(!this.Gd(b))return a;xg(a,function(a){return a instanceof Ii}).forEach(this.xg,this);return this.$};Mi.prototype.Gd=function(a){return 1<a.c.length};
Mi.prototype.xg=function(a){if("eq"==a.J.G&&!a.Rb){var b=function(b){if(!(b instanceof Ei))return null;b=K(b.table)==K(a.J.ka.I())?a.J.ka:a.J.ha;return fa(b.za())?null:b},c=b(Ud(a,0)),b=b(Ud(a,1));if(null!==c||null!==b){b=null===b?c:b;Ki(a,b);var d=new H([],[K(b.I())]);Yd(a,new Li([d]),b==c?0:1)}}};function Ni(a){a=a.map(function(a){return a.Ba()});a=Hb.apply(null,a);var b=[];Gb(a,function(a){b.push(a)});return b}function Oi(a){this.Pb=a}Oi.prototype.fd=function(){return 1==this.Pb.f.length?[vd()]:[this.Pb.f.map(function(){return vd()})]};function Pi(a,b){this.Pb=a;this.Da=b;this.Kd=this.Ye=null}
...
X.prototype.Tf=function(){gk(this);var a=new Xj(this.h);return xe(this.Fa,a).then(function(a){return yd(a[0])[0]})};X.prototype["export"]=X.prototype.Tf;X.prototype.import=function(a){gk(this);a=new Yj(this.h,a);return xe(this.Fa,a).then(l(null))};X.prototype["import"]=X.prototype.import;function Y(a,b,c,d,e,f){this.V=a;this.w=b;this.Ve=c;this.Te=d;this.wf=e;this.fb=f||null}r("lf.schema.BaseColumn",Y);m=Y.prototype;m.getName=g("w");m.m=function(){return K(this.V)+"."+this.w};m.toString=function(){return this.m()};m.I=g("V");m.H=g("wf");Y.prototype.getType=Y.prototype.H;Y.prototype.Za=g("fb");Y.prototype.Aa=function(){null==this.pa&&(this.pa=[],this.I().Aa().forEach(function(a){-1!=a.f.map(function(a){return a.ba.getName()}).indexOf(this.w)&&this.pa.push(a)},this));return this.pa};
Y.prototype.za=function(){if(!q(this.ga)){var a=this.Aa().filter(function(a){return 1!=a.f.length?!1:a.f[0].ba.getName()==this.getName()},this);this.ga=0<a.length?a[0]:null}return this.ga};Y.prototype.kc=g("Te");Y.prototype.isNullable=Y.prototype.kc;Y.prototype.Hc=g("Ve");Y.prototype.Qa=function(a){return Mg(this,a,"eq")};Y.prototype.eq=Y.prototype.Qa;Y.prototype.bf=function(a){return Mg(this,a,"neq")};Y.prototype.neq=Y.prototype.bf;Y.prototype.$d=function(a){return Mg(this,a,"lt")};
