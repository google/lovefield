...
lf.index.KeyRange.lowerBound=function(a,b){return new lf.index.KeyRange(a,null,b||!1,!1)};lf.index.KeyRange.only=function(a){return new lf.index.KeyRange(a,a,!1,!1)};lf.index.KeyRange.all=function(){return new lf.index.KeyRange(null,null,!1,!1)};/*
 ...
 limitations under the License.
*/
lf.pred.ValuePredicate=function(a,b,c){lf.pred.PredicateNode.call(this);this.column=a;this.value=b;this.evaluatorType=c;this.evaluatorFn_=lf.Global.get().getService(lf.service.EVAL_REGISTRY).getEvaluator(this.column.getType(),this.evaluatorType);this.isComplement_=!1};goog.inherits(lf.pred.ValuePredicate,lf.pred.PredicateNode);lf.pred.ValuePredicate.prototype.copy=function(){var a=new lf.pred.ValuePredicate(this.column,this.value,this.evaluatorType);a.setComplement(this.isComplement_);return a};
lf.pred.ValuePredicate.prototype.setComplement=function(a){this.isComplement_=a};lf.pred.ValuePredicate.prototype.eval=function(a){if(this.evaluatorType==lf.eval.Type.IN)return this.evalAsIn_(a);var b=a.entries.filter(function(a){return this.evaluatorFn_(a.getField(this.column),this.value)!=this.isComplement_},this);return new lf.proc.Relation(b,a.getTables())};
...
movie.db.schema.Movie.prototype.createRow=function(a){return new movie.db.row.Movie(lf.Row.getNextId(),a)};movie.db.schema.Movie.prototype.deserializeRow=function(a){return new movie.db.row.Movie(a.id,a.value)};movie.db.schema.Movie.prototype.getIndices=function(){this.indices_||(this.indices_=[new lf.schema.Index("Movie","pkMovie",!0,!1,["id"])]);return this.indices_};
...
movie.db.schema.Actor.prototype.getName=function(){return"Actor"};movie.db.schema.Actor.prototype.createRow=function(a){return new movie.db.row.Actor(lf.Row.getNextId(),a)};movie.db.schema.Actor.prototype.deserializeRow=function(a){var b=a.value,c=new movie.db.row.ActorType;c.id=b.id;c.lastName=b.lastName;c.firstName=b.firstName;c.sex=b.sex;c.dateOfBirth=new Date(b.dateOfBirth);c.dateOfDeath=goog.isNull(b.dateOfDeath)?null:new Date(b.dateOfDeath);return new movie.db.row.Actor(a.id,c)};
movie.db.schema.Actor.prototype.getIndices=function(){this.indices_||(this.indices_=[new lf.schema.Index("Actor","pkActor",!0,!1,["id"])]);return this.indices_};movie.db.schema.Actor.prototype.getConstraint=function(){var a=new lf.schema.Index("Actor","pkActor",!0,!1,["id"]);return new lf.schema.Constraint(a,[this.id,this.lastName,this.firstName,this.sex,this.dateOfBirth],[],[])};movie.db.row.ActorType=function(){};movie.db.row.ActorDbType=function(){};
movie.db.row.Actor=function(a,b){lf.Row.call(this,a,b)};goog.inherits(movie.db.row.Actor,lf.Row);movie.db.row.Actor.prototype.defaultPayload=function(){var a=new movie.db.row.ActorType;a.id=0;a.lastName="";a.firstName="";a.sex="";a.dateOfBirth=new Date(0);a.dateOfDeath=null;return a};
...
movie.db.schema.Director.prototype.getName=function(){return"Director"};movie.db.schema.Director.prototype.createRow=function(a){return new movie.db.row.Director(lf.Row.getNextId(),a)};movie.db.schema.Director.prototype.deserializeRow=function(a){var b=a.value,c=new movie.db.row.DirectorType;c.id=b.id;c.lastName=b.lastName;c.firstName=b.firstName;c.dateOfBirth=new Date(b.dateOfBirth);c.dateOfDeath=goog.isNull(b.dateOfDeath)?null:new Date(b.dateOfDeath);return new movie.db.row.Director(a.id,c)};
movie.db.schema.Director.prototype.getIndices=function(){this.indices_||(this.indices_=[new lf.schema.Index("Director","pkDirector",!0,!1,["id"])]);return this.indices_};movie.db.schema.Director.prototype.getConstraint=function(){var a=new lf.schema.Index("Director","pkDirector",!0,!1,["id"]);return new lf.schema.Constraint(a,[this.id,this.lastName,this.firstName,this.dateOfBirth],[],[])};movie.db.row.DirectorType=function(){};movie.db.row.DirectorDbType=function(){};
movie.db.row.Director=function(a,b){lf.Row.call(this,a,b)};goog.inherits(movie.db.row.Director,lf.Row);movie.db.row.Director.prototype.defaultPayload=function(){var a=new movie.db.row.DirectorType;a.id=0;a.lastName="";a.firstName="";a.dateOfBirth=new Date(0);a.dateOfDeath=null;return a};
...
movie.db.schema.MovieGenre=function(){this.movieId=new lf.schema.BaseColumn(this,"movieId",!1,lf.Type.INTEGER);this.genre=new lf.schema.BaseColumn(this,"genre",!1,lf.Type.STRING)};movie.db.schema.MovieGenre.prototype.getName=function(){return"MovieGenre"};movie.db.schema.MovieGenre.prototype.createRow=function(a){return new movie.db.row.MovieGenre(lf.Row.getNextId(),a)};movie.db.schema.MovieGenre.prototype.deserializeRow=function(a){return new movie.db.row.MovieGenre(a.id,a.value)};
movie.db.schema.MovieGenre.prototype.getIndices=function(){this.indices_||(this.indices_=[]);return this.indices_};movie.db.schema.MovieGenre.prototype.getConstraint=function(){return new lf.schema.Constraint(null,[this.movieId,this.genre],[],[])};movie.db.row.MovieGenreType=function(){};movie.db.row.MovieGenreDbType=function(){};movie.db.row.MovieGenre=function(a,b){lf.Row.call(this,a,b)};goog.inherits(movie.db.row.MovieGenre,lf.Row);
movie.db.row.MovieGenre.prototype.defaultPayload=function(){var a=new movie.db.row.MovieGenreType;a.movieId=0;a.genre="";return a};movie.db.row.MovieGenre.prototype.toDbPayload=function(){var a=new movie.db.row.MovieGenreDbType;a.movieId=this.payload().movieId;a.genre=this.payload().genre;return a};movie.db.row.MovieGenre.prototype.keyOfIndex=function(a){switch(a){case "##row_id##":return this.id()}return null};movie.db.row.MovieGenre.prototype.getMovieId=function(){return this.payload().movieId};
movie.db.row.MovieGenre.prototype.setMovieId=function(a){this.payload().movieId=a;return this};movie.db.row.MovieGenre.prototype.getGenre=function(){return this.payload().genre};movie.db.row.MovieGenre.prototype.setGenre=function(a){this.payload().genre=a;return this};movie.db.schema.MovieDirector=function(){this.movieId=new lf.schema.BaseColumn(this,"movieId",!1,lf.Type.INTEGER);this.directorId=new lf.schema.BaseColumn(this,"directorId",!1,lf.Type.INTEGER)};
movie.db.schema.MovieDirector.prototype.getName=function(){return"MovieDirector"};movie.db.schema.MovieDirector.prototype.createRow=function(a){return new movie.db.row.MovieDirector(lf.Row.getNextId(),a)};movie.db.schema.MovieDirector.prototype.deserializeRow=function(a){return new movie.db.row.MovieDirector(a.id,a.value)};movie.db.schema.MovieDirector.prototype.getIndices=function(){this.indices_||(this.indices_=[]);return this.indices_};
movie.db.schema.MovieDirector.prototype.getConstraint=function(){return new lf.schema.Constraint(null,[this.movieId,this.directorId],[],[])};movie.db.row.MovieDirectorType=function(){};movie.db.row.MovieDirectorDbType=function(){};movie.db.row.MovieDirector=function(a,b){lf.Row.call(this,a,b)};goog.inherits(movie.db.row.MovieDirector,lf.Row);movie.db.row.MovieDirector.prototype.defaultPayload=function(){var a=new movie.db.row.MovieDirectorType;a.movieId=0;a.directorId=0;return a};
movie.db.row.MovieDirector.prototype.toDbPayload=function(){var a=new movie.db.row.MovieDirectorDbType;a.movieId=this.payload().movieId;a.directorId=this.payload().directorId;return a};movie.db.row.MovieDirector.prototype.keyOfIndex=function(a){switch(a){case "##row_id##":return this.id()}return null};movie.db.row.MovieDirector.prototype.getMovieId=function(){return this.payload().movieId};movie.db.row.MovieDirector.prototype.setMovieId=function(a){this.payload().movieId=a;return this};
movie.db.row.MovieDirector.prototype.getDirectorId=function(){return this.payload().directorId};movie.db.row.MovieDirector.prototype.setDirectorId=function(a){this.payload().directorId=a;return this};movie.db.schema.MovieActor=function(){this.movieId=new lf.schema.BaseColumn(this,"movieId",!1,lf.Type.INTEGER);this.actorId=new lf.schema.BaseColumn(this,"actorId",!1,lf.Type.INTEGER);this.role=new lf.schema.BaseColumn(this,"role",!1,lf.Type.STRING)};movie.db.schema.MovieActor.prototype.getName=function(){return"MovieActor"};
movie.db.schema.MovieActor.prototype.createRow=function(a){return new movie.db.row.MovieActor(lf.Row.getNextId(),a)};movie.db.schema.MovieActor.prototype.deserializeRow=function(a){return new movie.db.row.MovieActor(a.id,a.value)};movie.db.schema.MovieActor.prototype.getIndices=function(){this.indices_||(this.indices_=[]);return this.indices_};movie.db.schema.MovieActor.prototype.getConstraint=function(){return new lf.schema.Constraint(null,[this.movieId,this.actorId,this.role],[],[])};
movie.db.row.MovieActorType=function(){};movie.db.row.MovieActorDbType=function(){};movie.db.row.MovieActor=function(a,b){lf.Row.call(this,a,b)};goog.inherits(movie.db.row.MovieActor,lf.Row);movie.db.row.MovieActor.prototype.defaultPayload=function(){var a=new movie.db.row.MovieActorType;a.movieId=0;a.actorId=0;a.role="";return a};
...
goog.Promise.setUnhandledRejectionHandler=function(a){goog.Promise.handleRejection_=a};goog.Promise.CancellationError=function(a){goog.debug.Error.call(this,a)};goog.inherits(goog.Promise.CancellationError,goog.debug.Error);goog.Promise.CancellationError.prototype.name="cancel";goog.Promise.Resolver_=function(a,b,c){this.promise=a;this.resolve=b;this.reject=c};/*
 ...
 limitations under the License.
*/
lf.query={};lf.query.Context=function(){};lf.query.Select=function(){};lf.query.Insert=function(){};lf.query.Update=function(){};lf.query.Delete=function(){};/*
...
b);var c=new lf.eval.Registry;f.registerService(lf.service.EVAL_REGISTRY,c);return b.init(a)}).then(function(){return(new lf.cache.Prefetcher).init(a)})};lf.base.closeDatabase=function(a){a=lf.Global.get();try{a.getService(lf.service.BACK_STORE).close()}catch(b){}};/*
...
lf.Database=function(){};/*
 ...
 limitations under the License.
*/
lf.query.SelectBuilder=function(a){lf.query.QueryBuilder.call(this);this.query=new lf.query.SelectContext;this.query.columns=a;this.checkDistinctColumn_();this.checkAggregations_()};goog.inherits(lf.query.SelectBuilder,lf.query.QueryBuilder);lf.query.SelectBuilder.prototype.assertExecPreconditions=function(){lf.query.SelectBuilder.superClass_.assertExecPreconditions.call(this);if(!goog.isDefAndNotNull(this.query.from))throw new lf.Exception(lf.Exception.Type.SYNTAX,"Invalid usage of select()");this.checkProjectionList_()};
