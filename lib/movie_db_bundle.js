...
*/
var lf={schema:{}};lf.schema.Column=function(){};lf.schema.Database=function(){};lf.schema.Index=function(a,b,c,d){this.tableName=a;this.name=b;this.isUnique=c;this.columnNames=d};lf.schema.Index.prototype.getNormalizedName=function(){return this.tableName+"."+this.name};lf.schema.Table=function(){};/*
 ...
 limitations under the License.
*/
lf.Row=function(a,b){this.id_=a;this.payload_=b||this.defaultPayload()};lf.Row.nextId_=0;lf.Row.getNextId=function(){return lf.Row.nextId_++};lf.Row.setNextId=function(a){lf.Row.nextId_=a};lf.Row.prototype.id=function(){return this.id_};lf.Row.prototype.setRowId=function(a){this.id_=a};lf.Row.prototype.payload=function(){return this.payload_};lf.Row.prototype.defaultPayload=function(){return{}};lf.Row.prototype.toDbPayload=function(){return this.payload_};
...
lf.Row.hexToBin=function(a){if(""==a)return null;0!=a.length%2&&(a="0"+a);for(var b=new ArrayBuffer(a.length/2),c=new Uint8Array(b),d=0,e=0;d<a.length;d+=2)c[e++]=parseInt(a.substr(d,2),16);return b};lf.Row.combineRows=function(a,b,c,d){var e={};e[b]=a.payload();e[d]=c.payload();return new lf.Row(-1,e)};/*
 ...
 limitations under the License.
*/
lf.schema.Constraint=function(a,b,c,d){this.primaryKey_=a;this.nullable_=b;this.foreignKeys_=c;this.unique_=d};lf.schema.Constraint.prototype.getPrimaryKey=function(){return this.primaryKey_};lf.schema.Constraint.prototype.getNullable=function(){return this.nullable_};lf.schema.Constraint.prototype.getForeignKeys=function(){return this.foreignKeys_};lf.schema.Constraint.prototype.getUnique=function(){return this.unique_};/*
 ...
 limitations under the License.
*/
lf.Type={ARRAY_BUFFER:0,BOOLEAN:1,DATE_TIME:2,INTEGER:3,NUMBER:4,STRING:5};/*
...
goog.structs.TreeNode.prototype.removeChildAt=function(a){var b=this.children_&&this.children_[a];return b?(b.setParent(null),goog.array.removeAt(this.children_,a),0==this.children_.length&&delete this.children_,b):null};goog.structs.TreeNode.prototype.removeChild=function(a){return this.removeChildAt(goog.array.indexOf(this.getChildren(),a))};goog.structs.TreeNode.prototype.removeChildren=function(){this.children_&&goog.array.forEach(this.children_,function(a){a.setParent(null)});delete this.children_};/*
 ...
 limitations under the License.
*/
lf.Predicate=function(){};lf.Predicate.prototype.eval=function(a){};lf.Predicate.prototype.evalRow=function(a){};lf.Predicate.prototype.setComplement=function(a){};/*
 ...
 limitations under the License.
*/
lf.pred={};lf.pred.PredicateNode=function(){goog.structs.TreeNode.call(this,"","")};goog.inherits(lf.pred.PredicateNode,goog.structs.TreeNode);goog.structs.Collection=function(){};goog.structs.getCount=function(a){return"function"==typeof a.getCount?a.getCount():goog.isArrayLike(a)||goog.isString(a)?a.length:goog.object.getCount(a)};goog.structs.getValues=function(a){if("function"==typeof a.getValues)return a.getValues();if(goog.isString(a))return a.split("");if(goog.isArrayLike(a)){for(var b=[],c=a.length,d=0;d<c;d++)b.push(a[d]);return b}return goog.object.getValues(a)};
...
lf.proc.RelationEntry.prototype.setField=function(a,b){if(this.isPrefixApplied_){var c=this.row.payload()[a.getTable().getName()];goog.isDefAndNotNull(c)||(c={},this.row.payload()[a.getTable().getName()]=c);c[a.getName()]=b}else this.row.payload()[a.getName()]=b};/*
 ...
 limitations under the License.
*/
lf.pred.JoinPredicate=function(a,b,c){lf.pred.PredicateNode.call(this);this.leftColumn=a;this.rightColumn=b;this.evaluatorType=c;this.evaluatorFn_=lf.Global.get().getService(lf.service.EVAL_REGISTRY).getEvaluator(this.leftColumn.getType(),this.evaluatorType)};goog.inherits(lf.pred.JoinPredicate,lf.pred.PredicateNode);lf.pred.JoinPredicate.prototype.eval=function(a){var b=a.entries.filter(function(a){return this.evalRow(a.row)},this);return new lf.proc.Relation(b,a.getTables())};
lf.pred.JoinPredicate.prototype.evalRow=function(a){var b=this.leftColumn.getTable().getName(),c=this.rightColumn.getTable().getName();return this.evaluatorFn_(a.payload()[b][this.leftColumn.getName()],a.payload()[c][this.rightColumn.getName()])};lf.pred.JoinPredicate.prototype.toString=function(){return"join_pred("+this.leftColumn.getNormalizedName()+", "+this.rightColumn.getNormalizedName()+")"};lf.pred.JoinPredicate.prototype.appliesToLeft_=function(a){return-1!=a.getTables().indexOf(this.leftColumn.getTable().getName())};
lf.pred.JoinPredicate.prototype.appliesToRight_=function(a){return-1!=a.getTables().indexOf(this.rightColumn.getTable().getName())};lf.pred.JoinPredicate.prototype.evalPayloads_=function(a,b,c,d){return this.evaluatorFn_(a.payload()[this.leftColumn.getName()],c.payload()[this.rightColumn.getName()])};lf.pred.JoinPredicate.prototype.detectLeftRight_=function(a,b){var c=null,d=null;this.appliesToLeft_(a)?(this.assertRelationsApply_(a,b),c=a,d=b):(this.assertRelationsApply_(b,a),c=b,d=a);return[c,d]};
...
lf.pred.JoinPredicate.prototype.evalRelationsNestedLoopJoin_=function(a,b){for(var c=[],d=a.getTables()[0],e=b.getTables()[0],f=0;f<a.entries.length;f++)for(var g=0;g<b.entries.length;g++)if(this.evalPayloads_(a.entries[f].row,d,b.entries[g].row,e)){var h=lf.Row.combineRows(a.entries[f].row,d,b.entries[g].row,e);c.push(h)}d=a.getTables().concat(b.getTables());return lf.proc.Relation.fromRows(c,d)};
lf.pred.JoinPredicate.prototype.evalRelationsHashJoin_=function(a,b){var c=a,d=b,e=this.leftColumn,f=this.rightColumn;a.entries.length>b.entries.length&&(c=b,d=a,e=this.rightColumn,f=this.leftColumn);var g=c.getTables()[0],h=d.getTables()[0],k=new goog.labs.structs.Multimap,l=[];c.entries.forEach(function(a){var b=a.row.payload()[e.getName()].toString();k.add(b,a)});d.entries.forEach(function(a){var b=a.row.payload()[f.getName()].toString();k.containsKey(b)&&k.get(b).forEach(function(b){b=lf.Row.combineRows(a.row,
h,b.row,g);l.push(b)})});c=a.getTables().concat(b.getTables());return lf.proc.Relation.fromRows(l,c)};/*
...
lf.index.KeyRange.lowerBound=function(a,b){return new lf.index.KeyRange(a,null,b||!1,!1)};lf.index.KeyRange.only=function(a){return new lf.index.KeyRange(a,a,!1,!1)};lf.index.KeyRange.all=function(){return new lf.index.KeyRange(null,null,!1,!1)};/*
 ...
 limitations under the License.
*/
lf.pred.ValuePredicate=function(a,b,c){lf.pred.PredicateNode.call(this);this.column=a;this.value=b;this.evaluatorType=c;this.evaluatorFn_=lf.Global.get().getService(lf.service.EVAL_REGISTRY).getEvaluator(this.column.getType(),this.evaluatorType);this.isComplement_=!1};goog.inherits(lf.pred.ValuePredicate,lf.pred.PredicateNode);lf.pred.ValuePredicate.prototype.setComplement=function(a){this.isComplement_=a};
lf.pred.ValuePredicate.prototype.eval=function(a){if(this.evaluatorType==lf.eval.Type.IN)return this.evalAsIn_(a);var b=a.isPrefixApplied()?this.column.getNormalizedName():this.column.getName(),c=a.entries.filter(function(a){return this.evaluatorFn_(a.row.payload()[b],this.value)!=this.isComplement_},this);return new lf.proc.Relation(c,a.getTables())};
lf.pred.ValuePredicate.prototype.evalAsIn_=function(a){goog.asserts.assert(this.evaluatorType==lf.eval.Type.IN,"ValuePredicate#evalAsIn_() called for wrong predicate type.");var b=a.isPrefixApplied()?this.column.getNormalizedName():this.column.getName(),c=new goog.structs.Set(this.value),d=goog.bind(function(a){return c.contains(a)!=this.isComplement_},this),e=a.entries.filter(function(a){return d(a.row.payload()[b])},this);return new lf.proc.Relation(e,a.getTables())};
lf.pred.ValuePredicate.prototype.evalRow=function(a){return this.evaluatorFn_(a.payload()[this.column.getName()],this.value)!=this.isComplement_};lf.pred.ValuePredicate.prototype.toString=function(){return"value_pred("+this.column.getNormalizedName()+")"};
lf.pred.ValuePredicate.prototype.isKeyRangeCompatible=function(){return!goog.isNull(this.value)&&(this.evaluatorType==lf.eval.Type.BETWEEN||this.evaluatorType==lf.eval.Type.EQ||this.evaluatorType==lf.eval.Type.GT||this.evaluatorType==lf.eval.Type.GTE||this.evaluatorType==lf.eval.Type.LT||this.evaluatorType==lf.eval.Type.LTE)};
...
lf.eval.Type.LTE?lf.index.KeyRange.upperBound(this.value):lf.index.KeyRange.upperBound(this.value,!0);return this.isComplement_?a.complement():[a]};/*
 ...
 limitations under the License.
*/
lf.pred.createPredicate=function(a,b,c){return!goog.isNull(b)&&goog.isDef(b.getNormalizedName)?new lf.pred.JoinPredicate(a,b,c):new lf.pred.ValuePredicate(a,b,c)};/*
 ...
 limitations under the License.
*/
lf.schema.BaseColumn=function(a,b,c,d){this.table_=a;this.name_=b;this.isUnique_=c;this.type_=d};lf.schema.BaseColumn.prototype.getName=function(){return this.name_};lf.schema.BaseColumn.prototype.getNormalizedName=function(){return this.table_.getName()+"."+this.name_};lf.schema.BaseColumn.prototype.toString=function(){return this.getNormalizedName()};lf.schema.BaseColumn.prototype.getTable=function(){return this.table_};lf.schema.BaseColumn.prototype.getType=function(){return this.type_};
lf.schema.BaseColumn.prototype.getIndices=function(){goog.isDefAndNotNull(this.indices_)||(this.indices_=[],this.getTable().getIndices().forEach(function(a){-1!=a.columnNames.indexOf(this.name_)&&this.indices_.push(a)},this));return this.indices_};lf.schema.BaseColumn.prototype.isUnique=function(){return this.isUnique_};lf.schema.BaseColumn.prototype.eq=function(a){return lf.pred.createPredicate(this,a,lf.eval.Type.EQ)};
...
movie.db.schema.Movie=function(){this.id=new lf.schema.BaseColumn(this,"id",!0,lf.Type.INTEGER);this.title=new lf.schema.BaseColumn(this,"title",!1,lf.Type.STRING);this.year=new lf.schema.BaseColumn(this,"year",!1,lf.Type.INTEGER);this.rating=new lf.schema.BaseColumn(this,"rating",!1,lf.Type.STRING);this.company=new lf.schema.BaseColumn(this,"company",!1,lf.Type.STRING)};movie.db.schema.Movie.prototype.getName=function(){return"Movie"};
movie.db.schema.Movie.prototype.createRow=function(a){return new movie.db.row.Movie(lf.Row.getNextId(),a)};movie.db.schema.Movie.prototype.deserializeRow=function(a){var b=a.id;a=a.value;var c=new movie.db.row.MovieType;c.id=a.id;c.title=a.title;c.year=a.year;c.rating=a.rating;c.company=a.company;return new movie.db.row.Movie(b,c)};movie.db.schema.Movie.prototype.getIndices=function(){return[new lf.schema.Index("Movie","pkMovie",!0,["id"])]};
movie.db.schema.Movie.prototype.getConstraint=function(){var a=new lf.schema.Index("Movie","pkMovie",!0,["id"]);return new lf.schema.Constraint(a,[],[],[])};movie.db.row.MovieType=function(){};movie.db.row.MovieDbType=function(){};movie.db.row.Movie=function(a,b){lf.Row.call(this,a,b)};goog.inherits(movie.db.row.Movie,lf.Row);movie.db.row.Movie.prototype.defaultPayload=function(){var a=new movie.db.row.MovieType;a.id=0;a.title="";a.year=0;a.rating="";a.company="";return a};
movie.db.row.Movie.prototype.toDbPayload=function(){var a=new movie.db.row.MovieDbType;a.id=this.payload().id;a.title=this.payload().title;a.year=this.payload().year;a.rating=this.payload().rating;a.company=this.payload().company;return a};movie.db.row.Movie.prototype.keyOfIndex=function(a){switch(a){case "Movie.pkMovie":return this.payload().id;case "##row_id##":return this.id()}return null};movie.db.row.Movie.prototype.getId=function(){return this.payload().id};
movie.db.row.Movie.prototype.setId=function(a){this.payload().id=a;return this};movie.db.row.Movie.prototype.getTitle=function(){return this.payload().title};movie.db.row.Movie.prototype.setTitle=function(a){this.payload().title=a;return this};movie.db.row.Movie.prototype.getYear=function(){return this.payload().year};movie.db.row.Movie.prototype.setYear=function(a){this.payload().year=a;return this};movie.db.row.Movie.prototype.getRating=function(){return this.payload().rating};
movie.db.row.Movie.prototype.setRating=function(a){this.payload().rating=a;return this};movie.db.row.Movie.prototype.getCompany=function(){return this.payload().company};movie.db.row.Movie.prototype.setCompany=function(a){this.payload().company=a;return this};
movie.db.schema.Actor=function(){this.id=new lf.schema.BaseColumn(this,"id",!0,lf.Type.INTEGER);this.lastName=new lf.schema.BaseColumn(this,"lastName",!1,lf.Type.STRING);this.firstName=new lf.schema.BaseColumn(this,"firstName",!1,lf.Type.STRING);this.sex=new lf.schema.BaseColumn(this,"sex",!1,lf.Type.STRING);this.dateOfBirth=new lf.schema.BaseColumn(this,"dateOfBirth",!1,lf.Type.DATE_TIME);this.dateOfDeath=new lf.schema.BaseColumn(this,"dateOfDeath",!1,lf.Type.DATE_TIME)};
movie.db.schema.Actor.prototype.getName=function(){return"Actor"};movie.db.schema.Actor.prototype.createRow=function(a){return new movie.db.row.Actor(lf.Row.getNextId(),a)};movie.db.schema.Actor.prototype.deserializeRow=function(a){var b=a.id;a=a.value;var c=new movie.db.row.ActorType;c.id=a.id;c.lastName=a.lastName;c.firstName=a.firstName;c.sex=a.sex;c.dateOfBirth=new Date(a.dateOfBirth);c.dateOfDeath=goog.isNull(a.dateOfDeath)?null:new Date(a.dateOfDeath);return new movie.db.row.Actor(b,c)};
movie.db.schema.Actor.prototype.getIndices=function(){return[new lf.schema.Index("Actor","pkActor",!0,["id"])]};movie.db.schema.Actor.prototype.getConstraint=function(){var a=new lf.schema.Index("Actor","pkActor",!0,["id"]);return new lf.schema.Constraint(a,[this.dateOfDeath],[],[])};movie.db.row.ActorType=function(){};movie.db.row.ActorDbType=function(){};movie.db.row.Actor=function(a,b){lf.Row.call(this,a,b)};goog.inherits(movie.db.row.Actor,lf.Row);
...
movie.db.row.Actor.prototype.setDateOfDeath=function(a){this.payload().dateOfDeath=a;return this};movie.db.schema.Director=function(){this.id=new lf.schema.BaseColumn(this,"id",!0,lf.Type.INTEGER);this.lastName=new lf.schema.BaseColumn(this,"lastName",!1,lf.Type.STRING);this.firstName=new lf.schema.BaseColumn(this,"firstName",!1,lf.Type.STRING);this.dateOfBirth=new lf.schema.BaseColumn(this,"dateOfBirth",!1,lf.Type.DATE_TIME);this.dateOfDeath=new lf.schema.BaseColumn(this,"dateOfDeath",!1,lf.Type.DATE_TIME)};
movie.db.schema.Director.prototype.getName=function(){return"Director"};movie.db.schema.Director.prototype.createRow=function(a){return new movie.db.row.Director(lf.Row.getNextId(),a)};
movie.db.schema.Director.prototype.deserializeRow=function(a){var b=a.id;a=a.value;var c=new movie.db.row.DirectorType;c.id=a.id;c.lastName=a.lastName;c.firstName=a.firstName;c.dateOfBirth=new Date(a.dateOfBirth);c.dateOfDeath=goog.isNull(a.dateOfDeath)?null:new Date(a.dateOfDeath);return new movie.db.row.Director(b,c)};movie.db.schema.Director.prototype.getIndices=function(){return[new lf.schema.Index("Director","pkDirector",!0,["id"])]};
movie.db.schema.Director.prototype.getConstraint=function(){var a=new lf.schema.Index("Director","pkDirector",!0,["id"]);return new lf.schema.Constraint(a,[this.dateOfDeath],[],[])};movie.db.row.DirectorType=function(){};movie.db.row.DirectorDbType=function(){};movie.db.row.Director=function(a,b){lf.Row.call(this,a,b)};goog.inherits(movie.db.row.Director,lf.Row);
...
movie.db.schema.MovieGenre=function(){this.movieId=new lf.schema.BaseColumn(this,"movieId",!1,lf.Type.INTEGER);this.genre=new lf.schema.BaseColumn(this,"genre",!1,lf.Type.STRING)};movie.db.schema.MovieGenre.prototype.getName=function(){return"MovieGenre"};movie.db.schema.MovieGenre.prototype.createRow=function(a){return new movie.db.row.MovieGenre(lf.Row.getNextId(),a)};
movie.db.schema.MovieGenre.prototype.deserializeRow=function(a){var b=a.id;a=a.value;var c=new movie.db.row.MovieGenreType;c.movieId=a.movieId;c.genre=a.genre;return new movie.db.row.MovieGenre(b,c)};movie.db.schema.MovieGenre.prototype.getIndices=function(){return[]};movie.db.schema.MovieGenre.prototype.getConstraint=function(){return new lf.schema.Constraint(null,[],[],[])};movie.db.row.MovieGenreType=function(){};movie.db.row.MovieGenreDbType=function(){};
movie.db.row.MovieGenre=function(a,b){lf.Row.call(this,a,b)};goog.inherits(movie.db.row.MovieGenre,lf.Row);movie.db.row.MovieGenre.prototype.defaultPayload=function(){var a=new movie.db.row.MovieGenreType;a.movieId=0;a.genre="";return a};movie.db.row.MovieGenre.prototype.toDbPayload=function(){var a=new movie.db.row.MovieGenreDbType;a.movieId=this.payload().movieId;a.genre=this.payload().genre;return a};movie.db.row.MovieGenre.prototype.keyOfIndex=function(a){switch(a){case "##row_id##":return this.id()}return null};
...
movie.db.schema.MovieDirector=function(){this.movieId=new lf.schema.BaseColumn(this,"movieId",!1,lf.Type.INTEGER);this.directorId=new lf.schema.BaseColumn(this,"directorId",!1,lf.Type.INTEGER)};movie.db.schema.MovieDirector.prototype.getName=function(){return"MovieDirector"};movie.db.schema.MovieDirector.prototype.createRow=function(a){return new movie.db.row.MovieDirector(lf.Row.getNextId(),a)};
movie.db.schema.MovieDirector.prototype.deserializeRow=function(a){var b=a.id;a=a.value;var c=new movie.db.row.MovieDirectorType;c.movieId=a.movieId;c.directorId=a.directorId;return new movie.db.row.MovieDirector(b,c)};movie.db.schema.MovieDirector.prototype.getIndices=function(){return[]};movie.db.schema.MovieDirector.prototype.getConstraint=function(){return new lf.schema.Constraint(null,[],[],[])};movie.db.row.MovieDirectorType=function(){};movie.db.row.MovieDirectorDbType=function(){};
movie.db.row.MovieDirector=function(a,b){lf.Row.call(this,a,b)};goog.inherits(movie.db.row.MovieDirector,lf.Row);movie.db.row.MovieDirector.prototype.defaultPayload=function(){var a=new movie.db.row.MovieDirectorType;a.movieId=0;a.directorId=0;return a};movie.db.row.MovieDirector.prototype.toDbPayload=function(){var a=new movie.db.row.MovieDirectorDbType;a.movieId=this.payload().movieId;a.directorId=this.payload().directorId;return a};movie.db.row.MovieDirector.prototype.keyOfIndex=function(a){switch(a){case "##row_id##":return this.id()}return null};
movie.db.row.MovieDirector.prototype.getMovieId=function(){return this.payload().movieId};movie.db.row.MovieDirector.prototype.setMovieId=function(a){this.payload().movieId=a;return this};movie.db.row.MovieDirector.prototype.getDirectorId=function(){return this.payload().directorId};movie.db.row.MovieDirector.prototype.setDirectorId=function(a){this.payload().directorId=a;return this};
movie.db.schema.MovieActor=function(){this.movieId=new lf.schema.BaseColumn(this,"movieId",!1,lf.Type.INTEGER);this.actorId=new lf.schema.BaseColumn(this,"actorId",!1,lf.Type.INTEGER);this.role=new lf.schema.BaseColumn(this,"role",!1,lf.Type.STRING)};movie.db.schema.MovieActor.prototype.getName=function(){return"MovieActor"};movie.db.schema.MovieActor.prototype.createRow=function(a){return new movie.db.row.MovieActor(lf.Row.getNextId(),a)};
movie.db.schema.MovieActor.prototype.deserializeRow=function(a){var b=a.id;a=a.value;var c=new movie.db.row.MovieActorType;c.movieId=a.movieId;c.actorId=a.actorId;c.role=a.role;return new movie.db.row.MovieActor(b,c)};movie.db.schema.MovieActor.prototype.getIndices=function(){return[]};movie.db.schema.MovieActor.prototype.getConstraint=function(){return new lf.schema.Constraint(null,[],[],[])};movie.db.row.MovieActorType=function(){};movie.db.row.MovieActorDbType=function(){};
movie.db.row.MovieActor=function(a,b){lf.Row.call(this,a,b)};goog.inherits(movie.db.row.MovieActor,lf.Row);movie.db.row.MovieActor.prototype.defaultPayload=function(){var a=new movie.db.row.MovieActorType;a.movieId=0;a.actorId=0;a.role="";return a};movie.db.row.MovieActor.prototype.toDbPayload=function(){var a=new movie.db.row.MovieActorDbType;a.movieId=this.payload().movieId;a.actorId=this.payload().actorId;a.role=this.payload().role;return a};movie.db.row.MovieActor.prototype.keyOfIndex=function(a){switch(a){case "##row_id##":return this.id()}return null};
movie.db.row.MovieActor.prototype.getMovieId=function(){return this.payload().movieId};movie.db.row.MovieActor.prototype.setMovieId=function(a){this.payload().movieId=a;return this};movie.db.row.MovieActor.prototype.getActorId=function(){return this.payload().actorId};movie.db.row.MovieActor.prototype.setActorId=function(a){this.payload().actorId=a;return this};movie.db.row.MovieActor.prototype.getRole=function(){return this.payload().role};
movie.db.row.MovieActor.prototype.setRole=function(a){this.payload().role=a;return this};/*
...
lf.pred.CombinedPredicate.prototype.eval=function(a){var b=this.getChildren().map(function(b){return b.eval(a)});return this.combineResults_(b)};lf.pred.CombinedPredicate.prototype.combineResults_=function(a){return this.operator==lf.pred.Operator.AND?lf.proc.Relation.intersect(a):this.operator==lf.pred.Operator.OR?lf.proc.Relation.union(a):lf.proc.Relation.createEmpty()};
lf.pred.CombinedPredicate.prototype.evalRow=function(a){var b=this.getChildren().map(function(b){return b.evalRow(a)});return this.operator==lf.pred.Operator.AND?b.every(function(a){return a}):this.operator==lf.pred.Operator.OR?-1!=b.indexOf(function(a){return 1==a}):!1};lf.pred.CombinedPredicate.prototype.toString=function(){return"combined_pred_"+this.operator.toString()};/*
 ...
 limitations under the License.
*/
lf.op={};lf.op.and=function(a,b){var c=new lf.pred.CombinedPredicate(lf.pred.Operator.AND);c.addChild(a);c.addChild(b);return c};lf.op.or=function(a,b){var c=new lf.pred.CombinedPredicate(lf.pred.Operator.OR);c.addChild(a);c.addChild(b);return c};lf.op.not=function(a){a.setComplement(!0);return a};goog.promise={};goog.promise.Resolver=function(){};goog.testing={};goog.testing.watchers={};goog.testing.watchers.resetWatchers_=[];goog.testing.watchers.signalClockReset=function(){for(var a=goog.testing.watchers.resetWatchers_,b=0;b<a.length;b++)goog.testing.watchers.resetWatchers_[b]()};goog.testing.watchers.watchClockReset=function(a){goog.testing.watchers.resetWatchers_.push(a)};goog.debug.entryPointRegistry={};goog.debug.EntryPointMonitor=function(){};goog.debug.entryPointRegistry.refList_=[];goog.debug.entryPointRegistry.monitors_=[];goog.debug.entryPointRegistry.monitorsMayExist_=!1;goog.debug.entryPointRegistry.register=function(a){goog.debug.entryPointRegistry.refList_[goog.debug.entryPointRegistry.refList_.length]=a;if(goog.debug.entryPointRegistry.monitorsMayExist_)for(var b=goog.debug.entryPointRegistry.monitors_,c=0;c<b.length;c++)a(goog.bind(b[c].wrap,b[c]))};
...
goog.labs.userAgent.browser.matchAndroidBrowser_=function(){return!goog.labs.userAgent.browser.isChrome()&&goog.labs.userAgent.util.matchUserAgent("Android")};goog.labs.userAgent.browser.isOpera=goog.labs.userAgent.browser.matchOpera_;goog.labs.userAgent.browser.isIE=goog.labs.userAgent.browser.matchIE_;goog.labs.userAgent.browser.isFirefox=goog.labs.userAgent.browser.matchFirefox_;goog.labs.userAgent.browser.isSafari=goog.labs.userAgent.browser.matchSafari_;goog.labs.userAgent.browser.isChrome=goog.labs.userAgent.browser.matchChrome_;
...
goog.labs.userAgent.browser.getIEVersion_=function(a){var b=/rv: *([\d\.]*)/.exec(a);if(b&&b[1])return b[1];var b="",c=/MSIE +([\d\.]+)/.exec(a);if(c&&c[1])if(a=/Trident\/(\d.\d)/.exec(a),"7.0"==c[1])if(a&&a[1])switch(a[1]){case "4.0":b="8.0";break;case "5.0":b="9.0";break;case "6.0":b="10.0";break;case "7.0":b="11.0"}else b="7.0";else b=c[1];return b};goog.async={};goog.async.throwException=function(a){goog.global.setTimeout(function(){throw a;},0)};goog.async.nextTick=function(a,b){var c=a;b&&(c=goog.bind(a,b));c=goog.async.nextTick.wrapCallback_(c);!goog.isFunction(goog.global.setImmediate)||goog.global.Window&&goog.global.Window.prototype.setImmediate==goog.global.setImmediate?(goog.async.nextTick.setImmediate_||(goog.async.nextTick.setImmediate_=goog.async.nextTick.getSetImmediateEmulator_()),goog.async.nextTick.setImmediate_(c)):goog.global.setImmediate(c)};
goog.async.nextTick.getSetImmediateEmulator_=function(){var a=goog.global.MessageChannel;"undefined"===typeof a&&"undefined"!==typeof window&&window.postMessage&&window.addEventListener&&(a=function(){var a=document.createElement("iframe");a.style.display="none";a.src="";document.documentElement.appendChild(a);var b=a.contentWindow,a=b.document;a.open();a.write("");a.close();var c="callImmediate"+Math.random(),d="file:"==b.location.protocol?"*":b.location.protocol+"//"+b.location.host,a=goog.bind(function(a){if(a.origin==
...
goog.Promise.prototype.executeCallbacks_=function(){for(;this.callbackEntries_&&this.callbackEntries_.length;){var a=this.callbackEntries_;this.callbackEntries_=[];for(var b=0;b<a.length;b++)goog.Promise.LONG_STACK_TRACES&&this.currentStep_++,this.executeCallback_(a[b],this.state_,this.result_)}this.executing_=!1};goog.Promise.prototype.executeCallback_=function(a,b,c){if(b==goog.Promise.State_.FULFILLED)a.onFulfilled(c);else this.removeUnhandledRejection_(),a.onRejected(c)};
...
goog.Promise.setUnhandledRejectionHandler=function(a){goog.Promise.handleRejection_=a};goog.Promise.CancellationError=function(a){goog.debug.Error.call(this,a)};goog.inherits(goog.Promise.CancellationError,goog.debug.Error);goog.Promise.CancellationError.prototype.name="cancel";goog.Promise.Resolver_=function(a,b,c){this.promise=a;this.resolve=b;this.reject=c};/*
 ...
 limitations under the License.
*/
lf.query={};lf.query.Context=function(){};lf.query.Select=function(){};lf.query.Insert=function(){};lf.query.Update=function(){};lf.query.Delete=function(){};lf.query.Alter=function(){};/*
 ...
 limitations under the License.
*/
lf.tree={};lf.tree.map=function(a,b){var c=[],d=null;a.traverse(function(a){var f=b(a);null==a.getParent()?d=f:c[c.length-1].addChild(f);a.isLeaf()?a.isLastChild()&&c.pop():c.push(f)});return d};lf.tree.removeNode=function(a){var b=a.getParent();goog.isNull(b)||b.removeChild(a);a.getChildren().slice().forEach(function(c){a.removeChild(c);goog.isNull(b)||b.addChild(c)})};lf.tree.insertNodeAt=function(a,b){a.getChildren().slice().forEach(function(c){a.removeChild(c);b.addChild(c)});a.addChild(b)};
...
lf.tree.replaceChainWithChain=function(a,b,c,d){var e=a.getParent();goog.isNull(e)||(e.removeChild(a),e.addChild(c));b.getChildren().slice().forEach(function(a){b.removeChild(a);d.addChild(a)});return c};lf.tree.replaceNodeWithChain=function(a,b,c){return lf.tree.replaceChainWithChain(a,a,b,c)};lf.tree.replaceChainWithNode=function(a,b,c){return lf.tree.replaceChainWithChain(a,b,c,c)};
lf.tree.toString=function(a,b){var c=b||function(a){return a.toString()+"\n"},d="";a.traverse(function(a){for(var b=0;b<a.getDepth();b++)d+="-";d+=c(a)});return d};/*
 ...
 limitations under the License.
*/
lf.query.QueryBuilder=function(){this.queryEngine_=lf.Global.get().getService(lf.service.QUERY_ENGINE);this.runner_=lf.Global.get().getService(lf.service.RUNNER)};lf.query.QueryBuilder.prototype.exec=function(){try{this.assertExecPreconditions()}catch(a){return goog.Promise.reject(a)}return new goog.Promise(function(a,c){this.runner_.exec([this.queryEngine_.getPlan(this.query)]).then(function(c){a(c[0].getPayloads())},c)},this)};lf.query.QueryBuilder.prototype.explain=function(){return lf.tree.toString(this.queryEngine_.getPlan(this.query).getRoot())};
lf.query.QueryBuilder.prototype.assertExecPreconditions=function(){};lf.query.QueryBuilder.prototype.getQuery=function(){return this.query};/*
...
lf.query.UpdateContext=function(){};/*
 ...
 limitations under the License.
*/
lf.query.UpdateBuilder=function(a){lf.query.QueryBuilder.call(this);this.query=new lf.query.UpdateContext;this.query.table=a};goog.inherits(lf.query.UpdateBuilder,lf.query.QueryBuilder);lf.query.UpdateBuilder.prototype.set=function(a,b){goog.isDefAndNotNull(this.query.set)||(this.query.set=[]);this.query.set.push({column:a,value:b});return this};lf.query.UpdateBuilder.prototype.where=function(a){this.assertWherePreconditions_();this.query.where=a;return this};
lf.query.UpdateBuilder.prototype.assertWherePreconditions_=function(){if(goog.isDefAndNotNull(this.query.where))throw new lf.Exception(lf.Exception.Type.SYNTAX,"where() has already been called.");};lf.query.UpdateBuilder.prototype.assertExecPreconditions=function(){lf.query.UpdateBuilder.superClass_.assertExecPreconditions.call(this);if(!goog.isDefAndNotNull(this.query.set))throw new lf.Exception(lf.Exception.Type.SYNTAX,"Invalid usage of update()");};/*
 ...
 limitations under the License.
*/
lf.Observer=function(){};movie.db.Observer=function(){};movie.db.Observer.prototype.start=function(a){};movie.db.Observer.prototype.stop=function(){};/*
...
lf.query.InsertContext=function(){this.allowReplace=!1};/*
 ...
 limitations under the License.
*/
lf.query.InsertBuilder=function(a){lf.query.QueryBuilder.call(this);this.query=new lf.query.InsertContext;this.query.allowReplace=a||!1};goog.inherits(lf.query.InsertBuilder,lf.query.QueryBuilder);
...
lf.query.InsertBuilder.prototype.assertValuesPreconditions_=function(){if(goog.isDefAndNotNull(this.query.values))throw new lf.Exception(lf.Exception.Type.SYNTAX,"values() has already been called.");};/*
 ...
 limitations under the License.
*/
lf.TransactionType={READ_ONLY:0,READ_WRITE:1};lf.Transaction=function(){};movie.db.Transaction=function(){this.completed_=!1};
movie.db.Transaction.prototype.exec=function(a){if(this.completed_)throw new lf.Exception(lf.Exception.Type.TRANSACTION,"Transaction already commited/failed");var b=lf.Global.get().getService(lf.service.QUERY_ENGINE),c=[];try{a.forEach(function(a){a.assertExecPreconditions();c.push(b.getPlan(a.getQuery()))},this)}catch(d){return this.completed_=!0,goog.Promise.reject(d)}return lf.Global.get().getService(lf.service.RUNNER).exec(c).then(goog.bind(function(){this.completed_=!0},this),goog.bind(function(a){this.completed_=
!0;throw a;},this))};/*
 ...
 limitations under the License.
*/
lf.query.SelectContext=function(){};lf.query.SelectContext.orderByToString=function(a){var b="";a.forEach(function(c,d){b+=c.column.getNormalizedName();d>a.length-1&&(b+=", ")});return b};/*
...
lf.proc.DeleteNode=function(a){lf.proc.LogicalQueryPlanNode.call(this);this.table=a};goog.inherits(lf.proc.DeleteNode,lf.proc.LogicalQueryPlanNode);lf.proc.UpdateNode=function(a,b){lf.proc.LogicalQueryPlanNode.call(this);this.table=a;this.updates=b};goog.inherits(lf.proc.UpdateNode,lf.proc.LogicalQueryPlanNode);lf.proc.SelectNode=function(a){lf.proc.LogicalQueryPlanNode.call(this);this.predicate=a};goog.inherits(lf.proc.SelectNode,lf.proc.LogicalQueryPlanNode);
lf.proc.SelectNode.prototype.toString=function(){return"select("+this.predicate.toString()+")"};lf.proc.TableAccessNode=function(a){lf.proc.LogicalQueryPlanNode.call(this);this.table=a};goog.inherits(lf.proc.TableAccessNode,lf.proc.LogicalQueryPlanNode);lf.proc.TableAccessNode.prototype.toString=function(){return"table_access("+this.table.getName()+")"};lf.proc.CrossProductNode=function(){lf.proc.LogicalQueryPlanNode.call(this)};goog.inherits(lf.proc.CrossProductNode,lf.proc.LogicalQueryPlanNode);
lf.proc.CrossProductNode.prototype.toString=function(){return"cross_product"};lf.proc.ProjectNode=function(a){lf.proc.LogicalQueryPlanNode.call(this);this.columns=a};goog.inherits(lf.proc.ProjectNode,lf.proc.LogicalQueryPlanNode);lf.proc.ProjectNode.prototype.toString=function(){return"project("+this.columns.toString()+")"};lf.proc.OrderByNode=function(a){lf.proc.LogicalQueryPlanNode.call(this);this.orderBy=a};goog.inherits(lf.proc.OrderByNode,lf.proc.LogicalQueryPlanNode);
...
lf.Order={DESC:0,ASC:1};/*
 ...
 limitations under the License.
*/
lf.fn={};lf.fn.AggregatedColumn=function(a,b){this.child=a;this.aggregatorType=b};lf.fn.AggregatedColumn.prototype.getName=function(){return this.aggregatorType+"_"+this.child.getName()};lf.fn.AggregatedColumn.prototype.getNormalizedName=function(){return this.aggregatorType+"_"+this.child.getNormalizedName()};lf.fn.AggregatedColumn.prototype.getTable=function(){return this.child.getTable()};lf.fn.AggregatedColumn.prototype.toString=function(){return this.getNormalizedName()};
lf.fn.AggregatedColumn.prototype.getType=function(){return this.child.getType()};lf.fn.AggregatedColumn.prototype.getColumnChain=function(){for(var a=[this],b=this;b instanceof lf.fn.AggregatedColumn;)a.push(b.child),b=b.child;return a};/*
...
lf.fn.stddev=function(a){return new lf.fn.AggregatedColumn(a,lf.fn.Type.STDDEV)};lf.fn.sum=function(a){return new lf.fn.AggregatedColumn(a,lf.fn.Type.SUM)};/*
 ...
 limitations under the License.
*/
lf.proc.RelationTransformer=function(a,b){this.relation_=a;this.columns_=b};lf.proc.RelationTransformer.prototype.getTransformed=function(){var a=this.calculateAggregators_();return this.columns_.reduce(function(a,c){return a&&c instanceof lf.fn.AggregatedColumn},!0)?this.handleAggregationsOnly_(a):this.handleMixedColumns_(a)};
lf.proc.RelationTransformer.prototype.handleAggregationsOnly_=function(a){if(1==this.columns_.length&&this.columns_[0].aggregatorType==lf.fn.Type.DISTINCT){var b=a.get(this.columns_[0].getNormalizedName(),null).entries.map(function(a){var b=new lf.proc.RelationEntry(lf.Row.create(),this.relation_.isPrefixApplied());b.setField(this.columns_[0],a.getField(this.columns_[0].child));return b},this);return new lf.proc.Relation(b,[])}var c=new lf.proc.RelationEntry(lf.Row.create(),this.relation_.isPrefixApplied());
this.columns_.forEach(function(b){var e=a.get(b.getNormalizedName(),null);c.setField(b,e)},this);return new lf.proc.Relation([c],this.relation_.getTables())};
lf.proc.RelationTransformer.prototype.handleMixedColumns_=function(a){var b=Array(this.relation_.entries.length),c=this.relation_.isPrefixApplied();this.relation_.entries.forEach(function(d,e){b[e]=new lf.proc.RelationEntry(new lf.Row(d.row.id(),{}),c);this.columns_.forEach(function(c){var g=c instanceof lf.fn.AggregatedColumn?a.get(c.getNormalizedName(),null):d.getField(c);b[e].setField(c,g)},this)},this);return new lf.proc.Relation(b,this.relation_.getTables())};
...
lf.proc.OrderByStep.prototype.comparatorFn_=function(a,b,c){var d=null,e=null,f=null,g=-1;do g++,d=this.orderBy[g].column,e=a?d.getNormalizedName():d.getName(),f=this.orderBy[g].order,d=b.row.payload()[e],e=c.row.payload()[e];while(d==e&&g+1<this.orderBy.length);return d<e?f==lf.Order.ASC?-1:1:d>e?f==lf.Order.ASC?1:-1:0};lf.proc.ProjectStep=function(a){lf.proc.PhysicalQueryPlanNode.call(this);this.columns=a};goog.inherits(lf.proc.ProjectStep,lf.proc.PhysicalQueryPlanNode);
lf.proc.ProjectStep.prototype.toString=function(){return"project("+this.columns.toString()+")"};lf.proc.ProjectStep.prototype.exec=function(a){return this.getChildAt(0).exec(a).then(goog.bind(function(a){return 0==this.columns.length?a:(new lf.proc.RelationTransformer(a,this.columns)).getTransformed()},this))};/*
...
lf.proc.CrossProductStep.crossProduct_=function(a,b){for(var c=[],d=a.getTables()[0],e=b.getTables()[0],f=0;f<a.entries.length;f++)for(var g=0;g<b.entries.length;g++){var h=lf.Row.combineRows(a.entries[f].row,d,b.entries[g].row,e);c.push(h)}d=a.getTables().concat(b.getTables());return lf.proc.Relation.fromRows(c,d)};/*
...
lf.proc.JoinStep.prototype.exec=function(a){goog.asserts.assert(2==this.getChildCount(),"Only joins of 2 relations are currently supported.");var b=this.getChildren().map(function(b){return b.exec(a)});return goog.Promise.all(b).then(goog.bind(function(a){return this.predicate_.evalRelations(a[0],a[1])},this))};/*
...
lf.proc.IndexRangeScanPass.replaceWithIndexRangeScanStep_=function(a,b){var c=a.predicate,d=lf.proc.IndexRangeScanPass.getIndexForPredicate_(c);if(goog.isNull(d))return a;c=new lf.proc.IndexRangeScanStep(d,c.toKeyRange());d=new lf.proc.TableAccessByRowIdStep(b.table);d.addChild(c);var e=b.getParent();e!=a&&(lf.tree.removeNode(a),lf.tree.insertNodeAt(e,a));return lf.tree.replaceChainWithChain(a,b,d,c)};/*
...
lf.proc.InsertOrReplaceStep=function(a,b){lf.proc.PhysicalQueryPlanNode.call(this);this.values_=b;this.table_=a};goog.inherits(lf.proc.InsertOrReplaceStep,lf.proc.PhysicalQueryPlanNode);lf.proc.InsertOrReplaceStep.prototype.toString=function(){return"insert_replace("+this.table_.getName()+")"};lf.proc.InsertOrReplaceStep.prototype.getScope=function(){return this.table_};lf.proc.InsertOrReplaceStep.prototype.exec=function(a){a.insertOrReplace(this.table_,this.values_);return goog.Promise.resolve(lf.proc.Relation.createEmpty())};/*
 ...
 limitations under the License.
*/
lf.proc.PhysicalPlanFactory=function(){};lf.proc.PhysicalPlanFactory.prototype.create=function(a){if(a instanceof lf.proc.InsertOrReplaceNode)return this.createInsertOrReplacePlan_(a);if(a instanceof lf.proc.InsertNode)return this.createInsertPlan_(a);if(a instanceof lf.proc.UpdateNode)return this.createUpdatePlan_(a);if(a instanceof lf.proc.DeleteNode)return this.createDeletePlan_(a);if(a instanceof lf.proc.ProjectNode)return this.createSelectPlan_(a);a=new lf.proc.PhysicalQueryPlanNode;return new lf.proc.PhysicalQueryPlan(a)};
lf.proc.PhysicalPlanFactory.prototype.createInsertPlan_=function(a){a=new lf.proc.InsertStep(a.table,a.values);return new lf.proc.PhysicalQueryPlan(a)};lf.proc.PhysicalPlanFactory.prototype.createInsertOrReplacePlan_=function(a){a=new lf.proc.InsertOrReplaceStep(a.table,a.values);return new lf.proc.PhysicalQueryPlan(a)};
lf.proc.PhysicalPlanFactory.prototype.createUpdatePlan_=function(a){var b=a.table,c=new lf.proc.TableAccessFullStep(b),b=new lf.proc.UpdateStep(b,a.updates);a=a.getChildAt(0);a instanceof lf.proc.SelectNode?(a=new lf.proc.SelectStep(a.predicate),a.addChild(c),b.addChild(a)):b.addChild(c);return new lf.proc.PhysicalQueryPlan(b)};
lf.proc.PhysicalPlanFactory.prototype.createDeletePlan_=function(a){var b=a.table,c=new lf.proc.TableAccessFullStep(b),b=new lf.proc.DeleteStep(b);a=a.getChildAt(0);a instanceof lf.proc.SelectNode?(a=new lf.proc.SelectStep(a.predicate),a.addChild(c),b.addChild(a)):b.addChild(c);c=(new lf.proc.PhysicalPlanRewriter(b,[new lf.proc.IndexRangeScanPass])).generate();return new lf.proc.PhysicalQueryPlan(c)};
lf.proc.PhysicalPlanFactory.prototype.createSelectPlan_=function(a){a=lf.tree.map(a,goog.bind(this.mapFn_,this));a=(new lf.proc.PhysicalPlanRewriter(a,[new lf.proc.IndexRangeScanPass])).generate();return new lf.proc.PhysicalQueryPlan(a)};
lf.proc.PhysicalPlanFactory.prototype.mapFn_=function(a){return a instanceof lf.proc.ProjectNode?new lf.proc.ProjectStep(a.columns):a instanceof lf.proc.OrderByNode?new lf.proc.OrderByStep(a.orderBy):a instanceof lf.proc.SkipNode?new lf.proc.SkipStep(a.skip):a instanceof lf.proc.LimitNode?new lf.proc.LimitStep(a.limit):a instanceof lf.proc.SelectNode?new lf.proc.SelectStep(a.predicate):a instanceof lf.proc.CrossProductNode?new lf.proc.CrossProductStep:a instanceof lf.proc.JoinNode?new lf.proc.JoinStep(a.predicate):
a instanceof lf.proc.TableAccessNode?new lf.proc.TableAccessFullStep(a.table):new lf.proc.PhysicalQueryPlanNode};/*
 ...
 limitations under the License.
*/
lf.proc.LogicalPlanGenerator=function(){};lf.proc.LogicalPlanGenerator.prototype.generate=function(){};lf.proc.BaseLogicalPlanGenerator=function(a){this.query=a;this.rootNode_=null};lf.proc.BaseLogicalPlanGenerator.prototype.generate=function(){goog.isNull(this.rootNode_)&&(this.rootNode_=this.generateInternal());return this.rootNode_};lf.proc.DummyLogicalPlanGenerator=function(a){lf.proc.BaseLogicalPlanGenerator.call(this,a)};goog.inherits(lf.proc.DummyLogicalPlanGenerator,lf.proc.BaseLogicalPlanGenerator);
lf.proc.DummyLogicalPlanGenerator.prototype.generateInternal=function(){return new lf.proc.LogicalQueryPlanNode};lf.proc.InsertLogicalPlanGenerator=function(a){lf.proc.BaseLogicalPlanGenerator.call(this,a)};goog.inherits(lf.proc.InsertLogicalPlanGenerator,lf.proc.BaseLogicalPlanGenerator);lf.proc.InsertLogicalPlanGenerator.prototype.generateInternal=function(){return this.query.allowReplace?new lf.proc.InsertOrReplaceNode(this.query.into,this.query.values):new lf.proc.InsertNode(this.query.into,this.query.values)};
lf.proc.UpdateLogicalPlanGenerator=function(a){lf.proc.BaseLogicalPlanGenerator.call(this,a)};goog.inherits(lf.proc.UpdateLogicalPlanGenerator,lf.proc.BaseLogicalPlanGenerator);
lf.proc.UpdateLogicalPlanGenerator.prototype.generateInternal=function(){var a=new lf.proc.UpdateNode(this.query.table,this.query.set),b=goog.isDefAndNotNull(this.query.where)?new lf.proc.SelectNode(this.query.where):null,c=new lf.proc.TableAccessNode(this.query.table);goog.isNull(b)?a.addChild(c):(b.addChild(c),a.addChild(b));return a};/*
...
lf.proc.PushDownSelectionsPass.prototype.traverse_=function(a){if(this.isCandidateNode_(a)){var b=this.pushDownNodeRec_(a);this.alreadyPushedDown_.add(a);b==a&&(b=a.getChildAt(0));goog.isNull(b)||(goog.isNull(b.getParent())&&(this.rootNode=b),this.isCandidateNode_(b)&&!this.alreadyPushedDown_.contains(b)&&this.traverse_(b))}else a.getChildren().forEach(function(a){this.traverse_(a)},this)};
lf.proc.PushDownSelectionsPass.prototype.pushDownNodeRec_=function(a){var b=function(a){return new lf.proc.SelectNode(a.predicate)},c=function(b){var c=a.predicate.column.getTable().getName(),d=b instanceof lf.proc.TableAccessNode&&b.table.getName()==c;b=b instanceof lf.proc.SelectNode&&b.predicate.column.getTable().getName()==c;return d||b},d=a;this.shouldSwapWithChild_(a)?(d=lf.tree.swapNodeWithChild(a),this.pushDownNodeRec_(a)):this.shouldPushBelowChild_(a)&&(d=lf.tree.pushNodeBelowChild(a,c,b));
return d};lf.proc.PushDownSelectionsPass.prototype.isCandidateNode_=function(a){return a instanceof lf.proc.SelectNode&&a.predicate instanceof lf.pred.ValuePredicate};lf.proc.PushDownSelectionsPass.prototype.shouldPushBelowChild_=function(a){a=a.getChildAt(0);return a instanceof lf.proc.CrossProductNode||a instanceof lf.proc.JoinNode};lf.proc.PushDownSelectionsPass.prototype.shouldSwapWithChild_=function(a){return a.getChildAt(0)instanceof lf.proc.SelectNode};/*
...
lf.proc.SelectLogicalPlanGenerator.prototype.generateInternal=function(){this.generateNodes_();this.connectNodes_();var a=[new lf.proc.AndPredicatePass,new lf.proc.PushDownSelectionsPass,new lf.proc.ImplicitJoinsPass];return(new lf.proc.LogicalPlanRewriter(this.projectNode_,a)).generate()};
...
lf.proc.DeleteLogicalPlanGenerator.prototype.generateInternal=function(){var a=new lf.proc.DeleteNode(this.query.from),b=goog.isDefAndNotNull(this.query.where)?new lf.proc.SelectNode(this.query.where):null,c=new lf.proc.TableAccessNode(this.query.from);goog.isNull(b)?a.addChild(c):(b.addChild(c),a.addChild(b));b=[new lf.proc.AndPredicatePass];return(new lf.proc.LogicalPlanRewriter(a,b)).generate()};/*
 ...
 limitations under the License.
*/
lf.proc.LogicalPlanFactory=function(){};lf.proc.LogicalPlanFactory.prototype.create=function(a){var b=null,b=a instanceof lf.query.InsertContext?new lf.proc.InsertLogicalPlanGenerator(a):a instanceof lf.query.DeleteContext?new lf.proc.DeleteLogicalPlanGenerator(a):a instanceof lf.query.SelectContext?new lf.proc.SelectLogicalPlanGenerator(a):a instanceof lf.query.UpdateContext?new lf.proc.UpdateLogicalPlanGenerator(a):new lf.proc.DummyLogicalPlanGenerator(a);return b.generate()};/*
...
lf.cache={};lf.cache.Cache=function(){};/*
 ...
 limitations under the License.
*/
lf.cache.DefaultCache=function(a){this.map=new goog.structs.Map;this.limit_=a||Number.MAX_VALUE};lf.cache.DefaultCache.prototype.set=function(a){a.forEach(goog.bind(function(a){this.map.set(a.id(),a)},this));this.map.getCount()};lf.cache.DefaultCache.prototype.get=function(a){return a.map(goog.bind(function(a){return this.map.get(a,null)},this))};lf.cache.DefaultCache.prototype.remove=function(a){a.forEach(function(a){this.map.remove(a)},this)};lf.cache.DefaultCache.prototype.getCount=function(){return this.map.getCount()};/*
...
goog.log.removeHandler=function(a,b){return goog.log.ENABLED&&a?a.removeHandler(b):!1};goog.log.log=function(a,b,c,d){goog.log.ENABLED&&a&&a.log(b,c,d)};goog.log.error=function(a,b,c){goog.log.ENABLED&&a&&a.severe(b,c)};goog.log.warning=function(a,b,c){goog.log.ENABLED&&a&&a.warning(b,c)};goog.log.info=function(a,b,c){goog.log.ENABLED&&a&&a.info(b,c)};goog.log.fine=function(a,b,c){goog.log.ENABLED&&a&&a.fine(b,c)};/*
 ...
 limitations under the License.
*/
lf.backstore={};lf.backstore.ObjectStore=function(a,b){this.store_=a;this.deserializeFn_=b;this.logger_=goog.log.getLogger("lf.backstore.ObjectStore")};
...
lf.backstore.ObjectStore.prototype.remove=function(a){if(0==a.length)return this.performWriteOp_(goog.bind(function(){return this.store_.clear()},this));a=a.map(function(a){return this.performWriteOp_(goog.bind(function(){return this.store_.delete(a)},this))},this);return goog.Promise.all(a)};lf.backstore.ObjectStore.prototype.pipe=function(a){throw new lf.Exception(lf.Exception.Type.SYNTAX,"ObjectStore should be the last in chain");};/*
...
lf.backstore.BaseTx.prototype.mergeIntoBackstore_=function(){var a=this.journal_.getDiff();a.getKeys().forEach(function(b){var c=this.journal_.getScope().get(b),d=this.getTable(c);b=a.get(b);b.getDeleted().getValues().forEach(function(a){d.remove([a.id()]).thenCatch(this.handleError_,this)},this);b.getAdded().getValues().forEach(function(a){d.put([a]).thenCatch(this.handleError_,this)},this);b.getModified().getValues().forEach(function(a){d.put([a[1]]).thenCatch(this.handleError_,this)},this)},this);
return this.resolver.promise};lf.backstore.BaseTx.prototype.handleError_=function(a){goog.log.error(this.getLogger(),"DB error",a);this.resolver.reject(a)};/*
 ...
 limitations under the License.
*/
lf.backstore.IndexedDBTx=function(a,b,c){lf.backstore.BaseTx.call(this,b,c);this.tx_=a;this.logger_=goog.log.getLogger("lf.backstore.IndexedDBTx");this.tx_.oncomplete=goog.bind(this.resolver.resolve,this.resolver);this.tx_.onabort=goog.bind(this.resolver.reject,this.resolver)};goog.inherits(lf.backstore.IndexedDBTx,lf.backstore.BaseTx);lf.backstore.IndexedDBTx.prototype.getLogger=function(){return this.logger_};
lf.backstore.IndexedDBTx.prototype.getTable=function(a){return new lf.backstore.ObjectStore(this.tx_.objectStore(a.getName()),a.deserializeRow)};lf.backstore.IndexedDBTx.prototype.abort=function(){this.tx_.abort()};/*
...
lf.raw={};lf.raw.BackStore=function(){};/*
 ...
 limitations under the License.
*/
lf.backstore.IndexedDBRawBackStore=function(a,b,c){this.db_=b;this.tx_=c;this.version_=a};lf.backstore.IndexedDBRawBackStore.prototype.getRawDBInstance=function(){return this.db_};lf.backstore.IndexedDBRawBackStore.prototype.getRawTransaction=function(){return this.tx_};lf.backstore.IndexedDBRawBackStore.prototype.dropTable=function(a){return new goog.Promise(function(b,c){try{this.db_.deleteObjectStore(a)}catch(d){c(d);return}b()},this)};
...
lf.backstore.IndexedDBRawBackStore.prototype.addTableColumn=function(a,b,c){var d=lf.backstore.IndexedDBRawBackStore.convert(c);return this.openCursorForWrite_(a,function(a){var c=lf.Row.deserialize(a.value);c.payload()[b]=d;a.update(c.serialize())},function(){})};lf.backstore.IndexedDBRawBackStore.prototype.dropTableColumn=function(a,b){return this.openCursorForWrite_(a,function(a){var d=lf.Row.deserialize(a.value);delete d.payload()[b];a.update(d.serialize())},function(){})};
lf.backstore.IndexedDBRawBackStore.prototype.getTableRows_=function(a){var b=[];return new goog.Promise(function(c,d){var e;try{e=this.tx_.objectStore(a).openCursor()}catch(f){d(f);return}e.onsuccess=function(a){(a=e.result)?(b.push(a.value),a.continue()):c(b)};e.onerror=d},this)};lf.backstore.IndexedDBRawBackStore.prototype.createRow=function(a){var b={};goog.object.forEach(a,goog.bind(function(a,d){b[d]=lf.backstore.IndexedDBRawBackStore.convert(a)},this));return lf.Row.create(b)};
lf.backstore.IndexedDBRawBackStore.prototype.getVersion=function(){return this.version_};lf.backstore.IndexedDBRawBackStore.prototype.dump=function(){for(var a=this.db_.objectStoreNames,b=[],c=0;c<a.length;++c){var d=a.item(c);b.push(this.dumpTable_(d))}return goog.Promise.all(b).then(function(b){var c={};b.forEach(function(b,d){c[a.item(d)]=b});return c})};lf.backstore.IndexedDBRawBackStore.prototype.dumpTable_=function(a){return this.getTableRows_(a).then(function(a){return a.map(function(a){return a.value})})};/*
 ...
 limitations under the License.
*/
lf.backstore.IndexedDB=function(a){this.schema_=a;this.logger_=goog.log.getLogger("lf.backstore.IndexedDB")};
...
lf.cache.TableDiff.prototype.toString=function(){return"["+this.added_.getKeys().toString()+"], ["+this.modified_.getKeys().toString()+"], ["+this.deleted_.getKeys().toString()+"]"};lf.cache.TableDiff.prototype.getReverse=function(){var a=new lf.cache.TableDiff;this.added_.getValues().forEach(function(b){a.delete(b)},this);this.deleted_.getValues().forEach(function(b){a.add(b)},this);this.modified_.getValues().forEach(function(b){a.modify([b[1],b[0]])},this);return a};/*
...
lf.cache.ConstraintChecker.prototype.getUniqueIndices_=function(a){var b=[],c=a.getConstraint().getPrimaryKey();goog.isNull(c)||b.push(c);return b.concat(a.getConstraint().getUnique())};lf.cache.ConstraintChecker.prototype.checkUniqueKeysUnique=function(a,b){for(var c=this.getUniqueIndices_(a),d=0;d<c.length;d++)this.checkUniqueKeyUnique_(c[d],b)};
lf.cache.ConstraintChecker.prototype.checkUniqueKeysInsert=function(a,b){for(var c=this.getUniqueIndices_(a),d=0;d<c.length;d++)this.checkUniqueKeyInsert_(c[d],b)};lf.cache.ConstraintChecker.prototype.checkUniqueKeysUpdate=function(a,b){for(var c=this.getUniqueIndices_(a),d=0;d<c.length;d++)this.checkUniqueKeyUpdate_(c[d],b)};
lf.cache.ConstraintChecker.prototype.checkUniqueKeyInsert_=function(a,b){var c=null;if(b.some(function(b){var e=this.findExistingRowIdInIndex_(a,b);return goog.isNull(e)?!1:(c=b.keyOfIndex(a.getNormalizedName()),!0)},this))throw new lf.Exception(lf.Exception.Type.CONSTRAINT,"A row with key "+c+" already exists  in "+a.getNormalizedName());};
lf.cache.ConstraintChecker.prototype.checkUniqueKeyUnique_=function(a,b){var c=new goog.structs.Set;b.forEach(function(b){b=b.keyOfIndex(a.getNormalizedName());c.add(b)});if(c.getCount()<b.length)throw new lf.Exception(lf.Exception.Type.CONSTRAINT,"Unique key violation when inserting rows to "+a.getNormalizedName());};
lf.cache.ConstraintChecker.prototype.checkUniqueKeyUpdate_=function(a,b){if(b.some(function(b){return this.findExistingRowIdInIndex_(a,b)!=b.id()},this)){if(1<b.length)throw new lf.Exception(lf.Exception.Type.CONSTRAINT,"Unique key violation when updating rows for "+a.getNormalizedName());this.checkUniqueKeyInsert_(a,[b[0]])}};/*
...
lf.cache.Journal.prototype.insert=function(a,b){this.checkScope_(a);this.contstraintChecker_.checkUniqueKeysUnique(a,b);this.contstraintChecker_.checkUniqueKeysInsert(a,b);var c=new lf.cache.TableDiff;b.forEach(function(a){c.add(a)});this.applyTableDiff_(a,c)};
lf.cache.Journal.prototype.update=function(a,b){this.checkScope_(a);this.contstraintChecker_.checkUniqueKeysUpdate(a,b);var c=new lf.cache.TableDiff;b.forEach(function(a){var b=this.cache_.get([a.id()])[0];c.modify([b,a])},this);this.applyTableDiff_(a,c)};
lf.cache.Journal.prototype.insertOrReplace=function(a,b){this.checkScope_(a);var c=new lf.cache.TableDiff;b.forEach(function(b){var e=this.contstraintChecker_.findExistingRowIdInPkIndex(a,b);if(goog.isDefAndNotNull(e)){var f=this.cache_.get([e])[0];b.setRowId(e);c.modify([f,b])}else c.add(b)},this);this.applyTableDiff_(a,c)};lf.cache.Journal.prototype.remove=function(a,b){this.checkScope_(a);var c=new lf.cache.TableDiff;b.forEach(function(a){c.delete(a)},this);this.applyTableDiff_(a,c)};
lf.cache.Journal.prototype.commit=function(){goog.asserts.assert(!this.terminated_,"Attemptted to commit a terminated journal.");this.terminated_=!0};lf.cache.Journal.prototype.rollback=function(){goog.asserts.assert(!this.terminated_,"Attempted to rollback a terminated journal.");this.tableDiffs_.forEach(function(a,b){var c=this.scope_.get(b),d=a.getReverse();this.updateTableIndices_(c,d);this.updateCache_(d)},this);this.terminated_=!0};
lf.cache.Journal.prototype.applyTableDiff_=function(a,b){this.updateTableIndices_(a,b);this.updateCache_(b);var c=this.tableDiffs_.get(a.getName(),null)||new lf.cache.TableDiff;this.tableDiffs_.set(a.getName(),c);c.merge(b)};lf.cache.Journal.prototype.updateCache_=function(a){a.getDeleted().getValues().forEach(function(a){this.cache_.remove([a.id()])},this);a.getAdded().forEach(function(a,c){this.cache_.set([a])},this);a.getModified().forEach(function(a,c){this.cache_.set([a[1]])},this)};
lf.cache.Journal.prototype.updateTableIndices_=function(a,b){var c=[];b.getDeleted().getValues().forEach(function(a){c.push([null,a])},this);b.getModified().getValues().forEach(function(a){c.push([a[1],a[0]])},this);b.getAdded().getValues().forEach(function(a){c.push([a,null])},this);a.getIndices().map(function(a){return this.indexStore_.get(a.getNormalizedName())},this).concat([this.indexStore_.getRowIdIndex(a.getName())]).forEach(function(a){c.forEach(function(b){var c=goog.isNull(b[0])?null:b[0].keyOfIndex(a.getName()),
g=goog.isNull(b[1])?null:b[1].keyOfIndex(a.getName());c!=g&&(goog.isNull(g)||a.remove(g,b[1].id()),goog.isNull(c)||a.set(c,b[0].id()))})})};lf.cache.Journal.prototype.checkScope_=function(a){if(!this.scope_.containsKey(a.getName()))throw new lf.Exception(lf.Exception.Type.SCOPE_ERROR,a.getName()+" is not in the journal's scope.");};/*
 ...
 limitations under the License.
*/
lf.proc.Runner=function(){this.usedScopes_=new goog.structs.Set;this.queue_=[]};lf.proc.Runner.prototype.scheduleTask_=function(a){return this.usedScopes_.intersection(a.combinedScope).isEmpty()?this.execTask_(a):(this.queue_.push(a),a.resolver.promise)};lf.proc.Runner.prototype.consumePending_=function(){for(var a=this.queue_.slice(),b=0;b<a.length;b++){var c=a[b];this.usedScopes_.intersection(c.combinedScope).isEmpty()&&(this.queue_.splice(b,1),this.scheduleTask_(c))}};
lf.proc.Runner.prototype.execTask_=function(a){a.txType==lf.TransactionType.READ_WRITE&&this.usedScopes_.addAll(a.combinedScope);var b=new lf.cache.Journal(a.combinedScope.getValues()),c=[],d=a.plans.slice(),e=goog.bind(function(){var a=d.shift();return a?a.getRoot().exec(b).then(function(a){c.push(a);return e()}):goog.Promise.resolve()},this),f=goog.bind(function(){a.txType==lf.TransactionType.READ_WRITE&&this.usedScopes_.removeAll(a.combinedScope)},this);return e().then(function(){return lf.Global.get().getService(lf.service.BACK_STORE).createTx(a.txType,
b).commit()}).then(goog.bind(function(){f();a.resolver.resolve(c);this.consumePending_();return a.resolver.promise},this),goog.bind(function(c){b.rollback();f();this.consumePending_();a.resolver.reject(c);return a.resolver.promise},this))};lf.proc.Runner.prototype.exec=function(a,b){var c=lf.proc.PhysicalQueryPlan.getCombinedScope(a),d=b||this.getTxType_(a),c=new lf.proc.RunnerTask_(a,c,d);return this.scheduleTask_(c)};
lf.proc.Runner.prototype.getTxType_=function(a){return a.some(function(a){return!(a.getRoot()instanceof lf.proc.ProjectStep)})?lf.TransactionType.READ_WRITE:lf.TransactionType.READ_ONLY};lf.proc.RunnerTask_=function(a,b,c){this.plans=a;this.combinedScope=b;this.txType=c;this.resolver=goog.Promise.withResolver()};/*
...
lf.base.init=function(a,b,c){var d=b==lf.base.BackStoreType.MEMORY?new lf.backstore.Memory(a):new lf.backstore.IndexedDB(a);lf.Global.reset();var e=lf.Global.get();return d.init(c).then(function(){e.registerService(lf.service.BACK_STORE,d);var b=new lf.proc.DefaultQueryEngine;e.registerService(lf.service.QUERY_ENGINE,b);b=new lf.proc.Runner;e.registerService(lf.service.RUNNER,b);b=new lf.cache.DefaultCache;e.registerService(lf.service.CACHE,b);b=new lf.index.MemoryIndexStore;e.registerService(lf.service.INDEX_STORE,
b);var c=new lf.eval.Registry;e.registerService(lf.service.EVAL_REGISTRY,c);return b.init(a)}).then(function(){return(new lf.cache.Prefetcher).init(a)})};lf.base.closeDatabase=function(a){a=lf.Global.get();try{a.getService(lf.service.BACK_STORE).close()}catch(b){}};/*
 ...
 limitations under the License.
*/
lf.query.DeleteBuilder=function(){lf.query.QueryBuilder.call(this);this.query=new lf.query.DeleteContext};goog.inherits(lf.query.DeleteBuilder,lf.query.QueryBuilder);lf.query.DeleteBuilder.prototype.from=function(a){this.assertFromPreconditions_();this.query.from=a;return this};lf.query.DeleteBuilder.prototype.where=function(a){this.assertWherePreconditions_();this.query.where=a;return this};
...
lf.Database=function(){};/*
 ...
 limitations under the License.
*/
lf.query.SelectBuilder=function(a){lf.query.QueryBuilder.call(this);this.query=new lf.query.SelectContext;this.query.columns=a;this.checkColumnCombination_();this.checkAggregations_()};goog.inherits(lf.query.SelectBuilder,lf.query.QueryBuilder);
lf.query.SelectBuilder.prototype.assertExecPreconditions=function(){lf.query.SelectBuilder.superClass_.assertExecPreconditions.call(this);if(!goog.isDefAndNotNull(this.query.from))throw new lf.Exception(lf.Exception.Type.SYNTAX,"Invalid usage of select()");};
lf.query.SelectBuilder.prototype.checkColumnCombination_=function(){var a=this.query.columns.filter(function(a){return a instanceof lf.fn.AggregatedColumn&&a.aggregatorType==lf.fn.Type.DISTINCT},this);if(0!=a.length&&(1!=a.length||1!=this.query.columns.length))throw new lf.Exception(lf.Exception.Type.SYNTAX,"Invalid usage of lf.fn.distinct()");};
...
lf.query.SelectBuilder.isAggregationValid_=function(a,b){switch(a){case lf.fn.Type.COUNT:case lf.fn.Type.DISTINCT:return!0;case lf.fn.Type.AVG:case lf.fn.Type.STDDEV:case lf.fn.Type.SUM:return b==lf.Type.NUMBER||b==lf.Type.INTEGER;case lf.fn.Type.MAX:case lf.fn.Type.MIN:return b==lf.Type.NUMBER||b==lf.Type.INTEGER||b==lf.Type.STRING||b==lf.Type.DATE_TIME}return!1};movie.db.getInstance=function(a,b){return(new movie.db.Database).init(a,b?lf.base.BackStoreType.MEMORY:void 0)};movie.db.Database=function(){this.schema_=new movie.db.schema.Database;this.initialized_=!1};movie.db.Database.prototype.init=function(a,b){return lf.base.init(this.schema_,b||lf.base.BackStoreType.INDEXED_DB,a).then(goog.bind(function(){this.initialized_=!0;return this},this))};movie.db.Database.prototype.getSchema=function(){return this.schema_};
