...
/**
 * Power factor of bundle size, e.g. 10 means 2^10 = 1024.
 * @const {number}
 */
lf.backstore.Page.BUNDLE_EXPONENT = 10;
...
lf.backstore.Page.prototype.serialize = function() {
  return {'id': this.id_, 'value': this.payload_};
};
...
lf.backstore.Page.deserialize = function(data) {
  return new lf.backstore.Page(data['id'], data['value']);
};
