...
/**
 * Alter query shall only be provided by @code {lf.RawDb}. @code {lf.Db} shall
 * not provide it.
 * @extends {lf.query.Context}
 * @interface
 */
lf.query.Alter = function() {};
 ...
 * @param {lf.Type} type
 * @param {*} defaultValue
 * @return {!lf.query.Alter}
 * @throws {DOMException}
 */
lf.query.Alter.prototype.addColumn;
 ...
 * @throws {DOMException}
 */
lf.query.Alter.prototype.dropColumn;
