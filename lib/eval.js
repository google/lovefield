...
lf.eval.buildCommonEvaluatorMap_ = function() {
  ...
  map.set(lf.eval.Type.GTE, function(a, b) { return a >= b; });
  map.set(lf.eval.Type.GT, function(a, b) { return a > b; });
  map.set(lf.eval.Type.IN, function(rowValue, values) {
    return values.indexOf(rowValue) != -1;
  });
  map.set(lf.eval.Type.LTE, function(a, b) { return a <= b; });
  map.set(lf.eval.Type.LT, function(a, b) { return a < b; });
  return map;
};
