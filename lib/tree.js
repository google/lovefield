 ...
 * @template T1, T2
 */
exports.map = function(original, mapFn) {
 ...
 */
exports.getLeafNodes = function(node) {
 ...
 */
exports.insertNodeAt = function(existingNode, newNode) {
 ...
 */
exports.swapNodeWithChild = function(node) {
  asserts.assert(node.getChildCount() == 1);
  var child = node.getChildAt(0);
  asserts.assert(child.getChildCount() == 1);
 ...
 */
exports.pushNodeBelowChild = function(node, shouldPushDownFn, cloneFn) {
  asserts.assert(node.getChildCount() == 1);
  var child = node.getChildAt(0);
  asserts.assert(child.getChildCount() > 1);
 ...
 *     "newHead".
 */
exports.replaceChainWithChain = function(oldHead, oldTail, newHead, newTail) {
 ...
 */
exports.replaceNodeWithChain = function(node, head, tail) {
 ...
 */
exports.replaceChainWithNode = function(head, tail, node) {
 ...
 * @return {!Array<!goog.structs.TreeNode>}
 */
exports.find = function(root, filterFn, opt_stopFn) {
  var results = [];
 ...
 *     testing/debugging.
 */
exports.toString = function(rootNode, opt_stringFn) {
