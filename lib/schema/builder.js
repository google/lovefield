...
/**
 * Perform foreign key checks like validity of names of parent and
  ...
  fkSpecArray.forEach(function(specs) {
    ...
    if (!this.tableBuilders_.containsKey(parentTableName)) {
      throw new lf.Exception(
          ...
          'Foreign Key {' + specs.fkName +
          '} refers to invalid table');
