...
goog.requireType('lf.Order');
goog.requireType('lf.Row');
goog.requireType('lf.Type');
goog.requireType('lf.raw.BackStore');
goog.requireType('lf.schema.Constraint');
goog.requireType('lf.schema.Info');
