...
lf.proc.PhysicalPlanFactory = function(global) {
  ...
  this.selectOptimizationPasses_ = [
    // TODO(dpapad): Uncomment the following line to enable index-join, when a
    // good policy is implemented to choose between hash vs index-join.
...
lf.proc.PhysicalPlanFactory.prototype.createPlan_ = function(
  ...
  var rootStep = lf.tree.map(
      logicalPlan.getRoot(), goog.bind(this.mapFn_, this));
