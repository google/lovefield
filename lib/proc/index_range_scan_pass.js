 ...
 */
lf.proc.IndexRangeScanPass = function() {
  lf.proc.IndexRangeScanPass.base(this, 'constructor');

  this.indexStore_ = /** @type {!lf.index.IndexStore} */ (
...
lf.proc.IndexRangeScanPass.replaceWithIndexRangeScanStep_ = function(
  ...
  if (tableAccessFullStepParent != selectStep) {
    ...
    lf.tree.insertNodeAt(
        /** @type {!goog.structs.TreeNode} */ (tableAccessFullStepParent),
        selectStep);
  }
