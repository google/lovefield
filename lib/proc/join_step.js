...
lf.proc.JoinStep.prototype.execInternal = function(journal, relations) {
  switch (this.algorithm_) {
    case lf.proc.JoinStep.Algorithm_.HASH:
      return [this.predicate_.evalRelationsHashJoin(
          relations[0], relations[1], this.isOuterJoin_)];
    default: // lf.proc.JoinStep.Algorithm_.NESTED_LOOP
      return [this.predicate_.evalRelationsNestedLoopJoin(
          relations[0], relations[1], this.isOuterJoin_)];
  }
};
