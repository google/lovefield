...
goog.provide('lf.proc.DummyLogicalPlanGenerator');
...
goog.require('lf.proc.LogicalQueryPlanNode');
...
/**
 * TODO(dpapad): Dummy generator to be used until generators have been
 * implemented for all query types.
 * @constructor
 * @struct
 * @extends {lf.proc.BaseLogicalPlanGenerator.<!lf.query.Query>}
 *
 * @param {!lf.query.Query} query
 */
lf.proc.DummyLogicalPlanGenerator = function(query) {
  lf.proc.DummyLogicalPlanGenerator.base(this, 'constructor', query);
};
goog.inherits(lf.proc.DummyLogicalPlanGenerator,
    lf.proc.BaseLogicalPlanGenerator);


/** @override */
lf.proc.DummyLogicalPlanGenerator.prototype.generateInternal = function() {
  return new lf.proc.LogicalQueryPlanNode();
};
