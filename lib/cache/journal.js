...
lf.cache.Journal.prototype.insert = function(table, rows) {
  ...
  this.contstraintChecker_.checkPrimaryKeysUnique(table, rows);
  this.contstraintChecker_.checkPrimaryKeyExistence(table, rows);
...
lf.cache.Journal.prototype.update = function(table, rows) {
  this.checkScope_(table);
  this.contstraintChecker_.checkPrimaryKeyUpdate(table, rows);
