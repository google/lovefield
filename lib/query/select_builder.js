...
/**
 * Checks that the column combination that is requested is a valid one.
 * Specifically if a lf.fn.distinct() column is requested, then it can't be
 * combined with any other column.
 * @private
 * @throws {!lf.Exception}
 */
lf.query.SelectBuilder.prototype.checkColumnCombination_ = function() {
