...
lf.query.SelectBuilder.prototype.assertExecPreconditions = function() {
  ...
  if ((context.limitBinder !== undefined && context.limit === undefined) ||
      (context.skipBinder !== undefined && context.skip === undefined)) {
...
lf.query.SelectBuilder.prototype.checkProjectionList_ = function() {
  this.query.groupBy != null ? this.checkGroupByColumns_() :
                               this.checkProjectionListNotMixed_();
};
...
lf.query.SelectBuilder.prototype.limit = function(numberOfRows) {
  if ((this.query.limit || this.query.limitBinder) != null) {
...
lf.query.SelectBuilder.prototype.skip = function(numberOfRows) {
  if ((this.query.skip || this.query.skipBinder) != null) {
...
lf.query.SelectBuilder.prototype.orderBy = function(column, opt_order) {
  ...
  this.query.orderBy.push(
      {column: column, order: opt_order != null ? opt_order : lf.Order.ASC});
...
lf.query.SelectBuilder.prototype.clone = function() {
  ...
  builder.query = /** @type {!lf.query.SelectContext} */ (this.query.clone());
