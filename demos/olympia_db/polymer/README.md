Lovefield + Polymer demo using a database of Olympic medals.
...
* Step 7: Navigate to [http://localhost:8000/demo-angular.html](http://localhost:8000/demo_polymer.html),
