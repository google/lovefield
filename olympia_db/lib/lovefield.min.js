...
lf.schema.Builder.prototype.table=function(a){if(!this.tables_.containsKey(a))throw new lf.Exception(lf.Exception.Type.NOT_FOUND,a+" is not found in database");return this.tables_.get(a)};lf.schema.Builder.prototype.getSchema=function(){this.tableBuilders_.getKeys().forEach(function(a){var b=this.tableBuilders_.get(a);this.tables_.set(a,b.getSchema())},this);this.tableBuilders_.clear();this.finalized_=!0;return this};lf.schema.create=function(a,b){return new lf.schema.Builder(a,b)};
